...
const CSCourseIDs = [ // eslint-disable-line no-unused-vars
  courseIDs.CHAPTER_ONE,
  courseIDs.CHAPTER_TWO,
  courseIDs.CHAPTER_THREE,
  courseIDs.CHAPTER_FOUR
]
const WDCourseIDs = [] // eslint-disable-line no-unused-vars
const orderedCourseIDs = [ // eslint-disable-line no-unused-vars
  courseIDs.CHAPTER_ONE,
  courseIDs.CHAPTER_TWO,
  courseIDs.CHAPTER_THREE,
  courseIDs.CHAPTER_FOUR
...
const hourOfCodeOptions = { // eslint-disable-line no-unused-vars
