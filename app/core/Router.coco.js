    ...
    static initClass() {
      ...
      this.prototype.routes = {
        ''() {
          ...
          if (!utils.isOzaria && !me.isAnonymous() && !me.isStudent() && !me.isTeacher() && !me.isAdmin() && !me.hasSubscription() && !me.isAPIClient() && !paymentUtils.hasTemporaryPremiumAccess() && !me.isParentHome()) {
            delete window.alreadyLoadedView;
