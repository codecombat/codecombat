...
arenas = [
  ...
  {season: 6, slug: 'magma-mountain'   , type: 'regular',      start: new Date("2022-09-05T00:00:00.000-07:00"), end: new Date("2023-01-01T00:00:00.000-08:00"), results: new Date("2023-01-10T07:00:00.000-08:00"), levelOriginal: ''}
