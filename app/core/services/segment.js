...
// eslint-disable-next-line no-unused-vars, multiline-ternary
module.exports = (loadSegmentio = !me.useSocialSignOn() ? () => Promise.resolve([]) : _.once(() => new Promise(function (resolve, reject) {
  ...
  for (const method of Array.from(analytics.methods)) {
