...
const Application = {
  ...
  featureMode: {
    useChina() { return admin.setFeatureMode('china').then(() => document.location.reload()); },
    usePicoCtf() { return admin.setFeatureMode('pico-ctf').then(() => document.location.reload()); },
    useBrainPop() { return admin.setFeatureMode('brain-pop').then(() => document.location.reload()); },
    clear() { return admin.clearFeatureMode().then(() => document.location.reload()); }
  },
