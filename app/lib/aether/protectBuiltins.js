...
export const builtinObjectNames = [
  // Built-in Objects
...
export const builtinNames = builtinObjectNames.concat([
  // Math-related
...
export const addedGlobals = {};

export const addGlobal = function(name, value) {
...
export const replaceBuiltin = function(name, value) {};
//NOOP
