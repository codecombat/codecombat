...
export const Default = (args) => ({
  ...
  template: `
    <content-box :main-image-original="mainImageOriginal" :arrangement="arrangement" :has-padding="hasPadding" :main-image-bg="mainImageBg">
...
export const WithFadingImages = (args) => ({
  ...
  props: Object.keys(args),
  template: `
      <content-box :arrangement="arrangement" :has-padding="hasPadding" :main-image-bg="mainImageBg">
        <template v-slot:image v-if="image">
            <FadingImages
