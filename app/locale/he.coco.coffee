...
#    request_quote: "Request a Quote"
    ...
    educator: "מחנך"
    student: "תלמיד"
    our_coding_programs: "תוכניות התכנות שלנו"
    codecombat: "קודקומבט"
    ozaria: "אוזריה"
...
#    ozaria_blurb: "An adventure game and Computer Science program where students master the lost magic of coding to save their world. Recommended for educators and students."
    try_codecombat: "נסה את קודקומבט"
    try_ozaria: "נסה את אוזריה"
    explore_codecombat: "גלה את קודקומבט"
    explore_ai_league: "גלה את ליגת AI"
    explore_ozaria: "גלה את אוזריה"
    explore_online_classes: "גלה קורסי אונליין"
...
#    online_classes_blurb: "Our online coding classes combine the power of gameplay and personalized instruction for an experience your child will love. With both private or group options available, this is remote learning that works."
    for_educators: "למחנכים"
    for_parents: "להורים"
    for_everyone: "לכולם"
    for_students: "לתלמידים"
    for_individuals: "לפרטיים"
    what_our_customers_are_saying: "מה הלקוחות מספרים"
    game_based_learning: "לימוד מבוסס משחק"
#    unique_approach_blurb: "With our unique approach, students embrace learning as they play and write code from the very start of their adventure, promoting active learning and a growth mindset."
    text_based_coding: "תכנות מבוסס טקסט"
...
#  new_home_faq:
    what_programming_languages: "אילו שפות תכנות זמינות?"
    python_and_javascript: "כרגע אנו תומכים בפייתון וגאוהסקריפט."
    why_python: "למה כדאי לך לבחור בפייתון?"
...
#    why_javascript: "למה כדאי לך לבחור בגאוהסקריפט?"
...
#    how_do_i_get_started: "How do I get started?"
    getting_started_1: "צור את חשבון המורה שלך"
    getting_started_2: "צור כתה"
#    getting_started_3: "הוסף תלמידים"
...
#    confirm_individual_blurb_without_email: "Write down your login information in case you need it later."
    ...
    want_codecombat_in_school: "רוצה לשחק קודקומבט כל הזמן?"
...
#    eu_confirmation_individual: "If you do not want us to store your data on US servers, you can always keep playing anonymously without saving your code."
    password_requirements: "8 עד 64 תווים ללא חזרות"
    invalid: "לא חוקי"
    invalid_password: "סיסמה לא חוקית"
    with: "עם"
    want_to_play_codecombat: "No, I don't have one but want to play CodeCombat!"
    have_a_classcode: "יש לך קוד כתה?"
    yes_i_have_classcode: "כן, יש לי קוד כתה!"
    enter_it_here: "הכנס אותו כאן:"
...
#    sec: "sec"
  ...
  play_level:
    ...
    level_complete_at: "רמה הושלמה"
    completed_level: "שלב הושלם:"
    course: "קורס:"
    done: "סיום"
    next_level: "השלב הבא"
    combo_challenge: "אתגר משולב"
    concept_challenge: "אתגר רעיוני"
    challenge_unlocked: "אתגר נפתח"
    combo_challenge_unlocked: "אתגר משולב נפתח"
    concept_challenge_unlocked: "אתגר רעיוני נפתח"
    concept_challenge_complete: "אתגר רעיוני הושלם!"
    combo_challenge_complete: "אתגר משולב הושלם!"
#    combo_challenge_complete_body: "Great job, it looks like you're well on your way to understanding __concept__!"
    replay_level: "שחק רמה שוב"
