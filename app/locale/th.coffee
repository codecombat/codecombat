...
#    required: "You need to log in before you can go that way."
  ...
  home:
    slogan: "เรียนรู้การเขียนโปรแกรมผ่านการเล่นเกม"
    no_ie: "CodeCombat ไม่สามารถทำงานบนเว็บ Internet Explorer 9 หรือเวอร์ชั่นที่เก่ากว่าได้"
    no_mobile: "CodeCombat ไม่ได้ถูกออกแบบมาเพื่อใช้งานกับมือถือ คุณอาจจะเล่นกับมือถือของคุณไม่ได้"

    play: "เล่น"
    old_browser: "โอ๊ะ! เบราเซอร์ของคุณเป็นเวอร์ชั่นที่เก่าเกินที่จะสามารถเล่น CodeCombat ได้ ต้องขอโทษด้วย"
    old_browser_suffix: "คุณจะลองเล่นดูก็ได้ แต่มันอาจจะเล่นไม่ได้นะ"

    campaign: "แคมเปญ"
    for_beginners: "สำหรับผู้เล่นใหม่"
    multiplayer: "เล่นหลายคน"
    for_developers: "สำหรับนักพัฒนา"
    javascript_blurb: "ภาษาที่ใช้พัฒนาเว็บนี้ เหมาะที่จะนำไปใช้ในการพัฒนาเว็บไซต์ เว็บแอพพลิเคชัน รวมทั้งเกมที่พัฒนาด้วย HTML5 และเซิฟเวอร์"
...
#    title: "Help translate CodeCombat!"
    ...
    pitch_body: "พวกเราพัฒนาเกม CodeCombat เป็นภาษาอังกฤษ แต่มีผู้เล่นหลากหลายจากทั่วโลกเข้ามาเล่นเกมนี้ ซึ่งผู้เล่นบางคนมีความต้องการที่จะเล่นเกมที่เป็นภาษาไทย และพวกเขาก็ไม่ใช้ภาษาอังกฤษด้วย ดังนั้นถ้าหากคุณสามารถใช้ทั้งสองภาษา โปรดพิจารณาสมัครมาเป็น Diplomat ร่วมกับเรา เพื่อช่วยกันแปลเพื่อใช้ทั้งในหน้าเว็บของ CodeCombat และในส่วนของเกมในทุกๆ ด่านให้เป็นภาษาไทยทั้งหมด"
    missing_translations: "จนกว่าเราจะแปลทุกส่วนๆ เสร็จ คุณอาจจะยังคงเห็นข้อความบางส่วนยังคงเป็นภาษาอังกฤษอยู่"
