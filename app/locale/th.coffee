...
#  new_home_faq:
    what_programming_languages: "ภาษาโปรแกรมใดบ้างที่มีให้บริการ?"
    python_and_javascript: "เรารองรับ Python และ JavaScript ในปัจจุบัน"
    why_python: "ทำไมคุณควรเลือก Python?"
    why_python_blurb: "Python เป็นภาษาการเขียนโปรแกรมที่ง่ายต่อการเรียนรู้สำหรับผู้เริ่มต้น แม้แต่เด็ก ๆ ก็ยังสามารถเรียนรู้ Python ได้ นอกจากนี้ Python ยังถูกใช้โดยบริษัทใหญ่ ๆ หลายแห่ง เช่น Google ดังนั้นหากคุณกำลังมองหาภาษาการเขียนโปรแกรมที่จะสอนให้กับเด็ก ๆ หรือผู้เริ่มต้น Python เป็นตัวเลือกที่ดี"
    why_javascript: "ทำไมคุณควรเลือก JavaScript?"
    why_javascript_blurb: "JavaScript เป็นภาษาที่ใช้สร้างเว็บไซต์ เกือบทุกเว็บไซต์ที่เราเห็นใช้ JavaScript ดังนั้น หากคุณวางแผนที่จะเรียนรู้การพัฒนาเว็บไซต์(web development) ด้วย JavaScript เป็นตัวเลือกที่ดี นอกจากนี้ CodeCombat ยังทำให้ง่ายสำหรับนักเรียนในการเปลี่ยนจาก Python ไปเป็น JavaScript หากคุณเคยเรียนรู้ Python แล้ว การเปลี่ยนไปใช้ JavaScript จะเป็นเรื่องง่าย"
    javascript_versus_python: "ไวยากรณ์ของ JavaScript ยากกว่า Python เล็กน้อยสำหรับมือใหม่ ดังนั้นหากคุณไม่สามารถตัดสินใจได้ระหว่างสองภาษานี้ เราขอแนะนำ Python"
    how_do_i_get_started: "ฉันจะเริ่มต้นอย่างไร?"
    getting_started_1: "สร้างบัญชีครู"
    getting_started_2: "สร้างชั้นเรียน"
    getting_started_3: "เพิ่มนักเรียน"
    getting_started_4: "ปล่อยให้นักเรียนของคุณสนุกกับการเรียนรู้การเขียนโปรแกรม นั่งดูพวกเขาสร้างสิ่งใหม่ๆ เรียนรู้ทักษะใหม่ๆ และค้นพบความเป็นไปได้ใหม่ๆ"
    main_curriculum: "ฉันสามารถใช้ CodeCombat หรือ Ozaria เป็นหลักสูตรหลักของฉันได้หรือไม่?"
    main_curriculum_blurb: "อย่างแน่นอน! เราทำงานร่วมกับผู้เชี่ยวชาญด้านการศึกษาเพื่อพัฒนาหลักสูตรและสื่อการสอนที่เหมาะสำหรับครูที่ไม่มีประสบการณ์ด้านวิทยาการคอมพิวเตอร์มาก่อน โรงเรียนหลายแห่งใช้ CodeCombat หรือ Ozaria เป็นหลักสูตรหลักด้านวิทยาการคอมพิวเตอร์"
    clever_instant_login: "CodeCombat และ Ozaria รองรับการเข้าสู่ระบบด้วย Clever Instant หรือไม่?"
    clever_instant_login_blurb: "ใช่! โปรดดู คู่มือ Clever ของเราสำหรับรายละเอียดเพิ่มเติมเกี่ยวกับวิธีการเริ่มต้นใช้งาน"
    clever_integration_faq: "คำถามที่พบบ่อยเกี่ยวกับการรวม Clever (Clever Integration FAQ)"
    google_classroom: "แล้ว Google Classroom ล่ะ?"
    google_classroom_blurb1: "ใช่! โปรดใช้ Google Single Sign-On (SSO) Modal เพื่อลงทะเบียนสำหรับบัญชีครูของคุณ หากคุณมีบัญชีอยู่แล้วโดยใช้อีเมล Google ของคุณ ให้ใช้ Google SSO modal เพื่อลงชื่อเข้าใช้ครั้งถัดไป ใน Create Class modal คุณจะเห็นตัวเลือกในการเชื่อมโยง Google Classroom เรารองรับการโรสเตอร์ผ่าน Google Classroom เท่านั้นในเวลานี้"
    google_classroom_blurb2: "หมายเหตุ: คุณต้องลงชื่อเข้าใช้หรือลงชื่อเข้าใช้ด้วย Google SSO อย่างน้อยหนึ่งครั้งจึงจะเห็นตัวเลือกการรวม Google Classroom"
    how_much_does_it_cost: "การเข้าใช้หลักสูตรและทรัพยากรที่มีอยู่ทั้งหมดมีค่าใช้จ่ายเท่าไร?"
    how_much_does_it_cost_blurb: "เราปรับแต่งโซลูชันสำหรับโรงเรียนและเขตการศึกษา และทำงานร่วมกับคุณเพื่อทำความเข้าใจในกรณีการใช้งาน บริบท และงบประมาณของคุณ โปรดติดต่อเราเพื่อขอข้อมูลเพิ่มเติม! เรายังสนับสนุนแหล่งเงินทุนของ CARES Act เช่น ESSER และ GEER อีกด้วย"
    recommended_systems: "มีเบราว์เซอร์และระบบปฏิบัติการที่แนะนำหรือไม่?"
    recommended_systems_blurb: "CodeCombat และ Ozaria ทำงานได้ดีที่สุดบนคอมพิวเตอร์ที่มีแรมอย่างน้อย 4GB โดยใช้เบราว์เซอร์สมัยใหม่ เช่น Chrome, Safari, Firefox หรือ Edge  Chromebooks ที่มีแรม 2GB อาจมีปัญหาด้านกราฟิกเล็กน้อยในหลักสูตรต่อๆ ไป นักเรียนต้องใช้แบนด์วิดท์อย่างน้อย 200 Kbps แต่เราแนะนำ 1+ Mbps"
    other_questions: "หากมีคำถามอื่น ๆ โปรด ติดต่อเรา"
    see_faq_prefix: "ดูเพิ่มเติม"
    see_faq_link: "คำถามที่พบบ่อยในศูนย์ช่วยเหลือของเรา"
#    see_faq_suffix: "."
...
#    awaiting_levels_adventurer_prefix: "เราจะเปิดตัวระดับใหม่ทุกสัปดาห์ครับ/ค่ะ"
...
#    optional: "optional"
#    connected_gplus_header: "คุณได้เชื่อมต่อกับ Google+ สำเร็จแล้ว!"
