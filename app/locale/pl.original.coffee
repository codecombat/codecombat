...
#    code_line_number: "1 Billion"
  ...
  new_home:
    title_coco: "CodeCombat - Gra koderska do nauki Pythona i JavaScriptu"
    title_ozar: "CodeCombat - Gra koderska do nauki Pythona i JavaScriptu"
#    title_cn_home: "CodeCombat|Python, Javascript"
    ...
    meta_description_coco: "Naucz się pisać kod poprzez programowanie gry. Naucz się Pythona, JavaScript i HTMLa w trakcie rozwiązywania zagadek i naucz soę tworzenia twoich własnych gier i stron internetowych"
    meta_description_ozar: "Naucz się pisać kod poprzez programowanie gry. Naucz się Pythona, JavaScript i HTMLa w trakcie rozwiązywania zagadek i naucz soę tworzenia twoich własnych gier i stron internetowych"
    meta_og_url: "https://codecombat.com"
    become_investor: "Zostań inwestorem w CodeCombat"
    built_for_teachers_title: "Gra koderska zbudowana z myślą o nauczycielach"
    built_for_teachers_blurb: "Uczenie dzieci programowania często może być przytłaczające. CodeCombat pomaga wszystkim nauczycielom nauczyć uczniów jak kodować albo w JavaScripcie albo w Pythonie, dwóch z najbardziej popularnych języków programowania. Z kompleskowym programem nauczania, który zawiera sześć lekcji informatyki i który wspomaga naukę poprzez projektowe umiejętności gamedevowe i webdevowe, dzieci będą poczyniać postępy w podróży od podstawowej składni do rekurencji!"
    built_for_teachers_subtitle1: "Informatyka"
    built_for_teachers_subblurb1: "Rozpoczynając z naszym darmowym kursem Wprowadzenia do Informatyki, uczniowie doskonalą podstawowe znajomości programistyczne takie jak pętle while/for, funkcje i algorytmy."
    built_for_teachers_subtitle2: "Tworzenie gier"
    built_for_teachers_subblurb2: "Uczniowie konstruują labirynty i używają podstawowej obsługi wejścia aby programować własne gry, które mogą udostęnić rodzinie i przyjaciołom."
    ...
    century_skills_title: "Umiejętności na miarę 21 wieku"
    century_skills_blurb1: "Uczniowie nie tylko rozwijają swojego bohatera, ale również i siebie."
    century_skills_quote1: "Zepsułeś...więc myślisz o wszystkich możliwych drogach aby to naprawić i wtedy próbujesz ponownie. Nie byłbym w stanie tutaj dotrzeć bez starań"
    century_skills_subtitle1: "Krytyczne myślenie"
    century_skills_subblurb1: "Z zagadkami koderskimi, które są naturalnie rozstawione na coraz trudniejszych pozomach, gra koderska CodeCombaya zapewnia, że dzieciaki zawsze praktykuja krytyczne myślenie."
    century_skills_quote2: "Każdy inny robił labirynty, więc pomyślałem sobie 'znajdź flagę' i to wlaśnie zrobiłem."
    century_skills_subtitle2: "Kreatywność"
    century_skills_subblurb2: "CodeCombat zachęca uczniów do ukazania swojej kreatywności poprzez budowanie i udostępnianie swoich gier i stron."
    century_skills_quote3: "Jeżeli utknę w poziomie, mogę pracować z ludźmi wokół mnie dopóki będziemy w stanie wymyślić rozwiązanie."
    century_skills_subtitle3: "Współpraca"
    century_skills_subblurb3: "Poprzez grę, są tu możliwości dla uczniów, aby współpracować kiedy utkną, używając naszego przewodnika po pair programmingu."
    century_skills_quote4: "Zawsze miałem  aspiracje do projektowania gier i nauka programowania... daje mi świetny start."
    century_skills_quote4_author: "Joey, Klasa 10"
    century_skills_subtitle4: "Komunikacja"
    century_skills_subblurb4: "Kodowanie wymaga od dzieci użycia nowych form komunikacji, wliczając komunikację z samym konputerem i przeniesienie swoich pomysłów używając najbardziej efektywnego kodu."
    classroom_in_box_title: "Dążymy do:"
...
#    classroom_in_box_blurb4: "" # only for koudashijie.com
    ...
    creativity_rigor_blurb1: "Uczniowie używają prawdziwego Pythona i JavaScriptu podczas grania w gry które zachęcają do prób i błędów, krytycznego myślenia i kreatywności. Uczniowie stosują umoejętności, których się nauczyli poprzez tworzenie swoich gier i stron w kursach bazowanych o projekty."
    creativity_rigor_subtitle2: "Dotrzyj do uczniów na ich poziomie"
    creativity_rigor_blurb2: "Każdy poziom CodeCombat jest oparty na milionach punktów danych i zoptymalizowany pod kątem dostosowania do każdego ucznia. Poziomy ćwiczeń i wskazówki pomagają uczniom, gdy utkną, a poziomy wyzwań oceniają naukę uczniów w trakcie gry."
    creativity_rigor_subtitle3: "Zbudowany dla wszystkich nauczycieli, niezależnie od doświadczenia."
    creativity_rigor_blurb3: "Samodzielny, dostosowany do standardów program CodeCombat sprawia, że ​​nauczanie informatyki jest możliwe dla każdego. CodeCombat wyposaża nauczycieli w szkolenia, zasoby instruktażowe i dedykowane wsparcie, aby czuć się pewnie i odnosić sukcesy w klasie."
    featured_partners_title1: "Jesteśmy wyróżnieni w:"
    ...
    for_leaders_title: "Dla dyrektorów: "
    for_leaders_blurb: "Kompleksowy, zgodny ze standardami program informatyczny"
    for_leaders_subtitle1: "Łatwa implementacja"
    for_leaders_subblurb1: "Program internetowy, który nie wymaga wsparcia IT. Rozpocznij w mniej niż 5 minut, korzystając z Google lub Clever Single Sign-On (SSO)."
    for_leaders_subtitle2: "Pełny program nauczania"
    for_leaders_subblurb2: "Zgodny ze standardami program nauczania z zasobami instruktażowymi i rozwojem zawodowym, aby umożliwić każdemu nauczycielowi nauczanie informatyki."
    for_leaders_subtitle3: "Elastyczne przypadki użycia"
    for_leaders_subblurb3: "Niezależnie od tego, czy chcesz stworzyć fakultatywne zajęcia z programowania w gimnazjum, ścieżkę CTE, czy prowadzić zajęcia wprowadzające do informatyki, CodeCombat jest dostosowany do Twoich potrzeb."
    for_leaders_subtitle4: "Umiejętności w świecie rzeczywistym"
    for_leaders_subblurb4: "Uczniowie budują wytrwałość i rozwijają nastawienie na rozwój poprzez wyzwania związane z kodowaniem, które przygotowują ich do ponad 500 000 zadań związanych z otwartym komputerem."
    for_teachers_title: "Dla nauczycieli"
    for_teachers_blurb: "Narzędzia do odblokowania potencjału ucznia"
    for_teachers_subtitle1: "Nauczanie oparte na projekty"
    for_teachers_subblurb1: "Promuj kreatywność, rozwiązywanie problemów i pewność siebie na kursach opartych na projektach, podczas których uczniowie tworzą własne gry i strony internetowe."
    for_teachers_subtitle2: "Dashboard dla nauczyciela"
    for_teachers_subblurb2: "Przeglądaj dane o postępach uczniów, odkrywaj zasoby programowe i korzystaj ze wsparcia w czasie rzeczywistym, aby wzmocnić naukę uczniów."
    for_teachers_subtitle3: "Wbudowane oceny"
    for_teachers_subblurb3: "Spersonalizuj instrukcje i upewnij się, że uczniowie rozumieją podstawowe pojęcia dzięki ocenom formatywnym i podsumowującym."
    for_teachers_subtitle4: "Automatyczne różnicowanie"
    for_teachers_subblurb4: "Zaangażuj wszystkich uczniów w zróżnicowanej klasie z poziomami ćwiczeń, które dostosowują się do potrzeb edukacyjnych każdego ucznia."
    game_based_blurb: "CodeCombat to program informatyczny oparty na grach, w którym uczniowie wpisują prawdziwy kod i widzą, jak ich postacie reagują w czasie rzeczywistym."
    get_started: "Zacznij tutaj"
    global_title: "Dołącz do naszej globalnej społeczności uczniów i nauczycieli"
    global_subtitle1: "Uczniowie"
    global_subtitle2: "Linie kodu"
    global_subtitle3: "Nauczyciele"
    global_subtitle4: "Kraje"
    go_to_my_classes: "Przejdź do moich klas"
    go_to_my_courses: "Przejdź do moich kursów"
    quotes_quote1: "Nazwij dowolny program online, próbowałem go. Żaden z nich nie pasuje do CodeCombat i Ozarii. Każdy nauczyciel, który chce, aby jego uczniowie nauczyli się kodować... zacznij tutaj!"
    quotes_quote2: " Zaskoczyło mnie, jak CodeCombat sprawia, że ​​nauka informatyki jest łatwa i intuicyjna. Wyniki na egzaminie AP były znacznie wyższe niż się spodziewałem i uważam, że CodeCombat jest powodem, dla którego tak się stało."
    quotes_quote3: "CodeCombat był najbardziej korzystny w nauczaniu moich uczniów umiejętności kodowania w prawdziwym życiu. Mój mąż jest inżynierem oprogramowania i przetestował wszystkie moje programy. Uznał to za swój najlepszy wybór."
    quotes_quote4: "Odzew… był tak pozytywny, że organizujemy zajęcia z informatyki wokół CodeCombat. Program naprawdę angażuje uczniów dzięki platformie w stylu gier, która jest jednocześnie zabawna i pouczająca. Tak trzymaj, CodeCombat!"
    ...
    teachers_love_codecombat_blurb1: "Zgłaszają, że ich uczniowie lubią używać CodeCombat, aby nauczyć się kodować"
    teachers_love_codecombat_blurb2: "Poleciliby CodeCombat innym nauczycielom informatyki"
    teachers_love_codecombat_blurb3: "Mówią, że CodeCombat pomaga im wspierać umiejętności rozwiązywania problemów uczniów"
...
#    check_it_out: "Check it out!"
    ...
    forgot_learning: "Myślę, że zapomnieli już, że się czegokolwiek uczyli."
    ...
    computer_science: "Nasze kursy można wykonywać we własnym tempie i obejmują podstawoą składnię i zaawansowane koncepcje " # {change}
...
#    go_to_my_dashboard: "Go to My Dashboard"
    our_coding_programs: "Nasze programy kodowania"
    codecombat: "CodeCombat"
    ozaria: "Ozaria"
    codecombat_blurb: "Nasza oryginalna gra w kodowanie. Polecany rodzicom, osobom indywidualnym, nauczycielom i uczniom, którzy chcą doświadczyć jednej z najbardziej lubianych gier kodowania na świecie."
    ozaria_blurb: "Gra przygodowa i program informatyczny, w którym uczniowie opanowują zagubioną magię kodowania, aby ocalić swój świat. Polecany dla nauczycieli i uczniów."
#    ozaria_china_blurb: ""
    try_codecombat: "Wypróbuj CodeCombata"
    try_ozaria: "Wypróbuj Ozarię"
    explore_codecombat: "Poznaj CodeCombat"
    explore_ai_league: "Poznaj Ligę AI"
    ...
    codecombat_live_online_classes: "Zajęcia online CodeCombat"
    learning_technology_blurb: "Nasza oryginalna gra uczy rzeczywistych umiejętności poprzez moc zabawy. Program nauczania oparty na rusztowaniach systematycznie opiera się na doświadczeniach i wiedzy uczniów w miarę ich postępów."
    learning_technology_blurb_short: "Nasza innowacyjna technologia nauczania oparta na grach zmieniła sposób, w jaki studenci uczą się programować"
    online_classes_blurb: "Nasze zajęcia z kodowania online łączą w sobie moc gry i spersonalizowanych instrukcji, dzięki czemu Twoje dziecko pokocha to doświadczenie. Dzięki dostępnym opcjom prywatnym lub grupowym, jest to nauka zdalna, która działa."
    for_educators: "Dla nauczycieli"
    for_parents: "Dla rodziców"
    for_everyone: "Dla wszystkich"
#    for_students: "For Students"
#    for_individuals: "For Individuals"
    what_our_customers_are_saying: "Co mówią nasi klienci"
    game_based_learning: "Uczenie się w oparciu o gry"
    unique_approach_blurb: "Dzięki naszemu unikalnemu podejściu, uczniowie uczą się bawiąc i pisząc kod od samego początku swojej przygody, promując aktywne uczenie się i nastawienie na rozwój."
    text_based_coding: "Kodowanie oparte na tekście"
    custom_code_engine_blurb: "Nasz niestandardowy silnik kodu i interpreter jest zaprojektowany dla początkujących, ucząc prawdziwych języków programowania Python, JavaScript i C++ używając ludzkich, przyjaznych dla początkujących terminów."
    student_impact: "Wpływ studentów"
    help_enjoy_learning_blurb: "Nasze produkty pomogły ponad 20 milionów studentów cieszyć się nauką informatyki, ucząc ich być krytycznym, pewnym siebie i kreatywnym uczniem. Angażujemy wszystkich uczniów, niezależnie od doświadczenia, pomagając im zrealizować ścieżkę do sukcesu w dziedzinie informatyki."
    global_community: "Dołącz do naszej globalnej społeczności"
    million: "__num__ Milion"
    billion: "__num__ Bilion"
...
#    related_urls: "Related Links"
    ...
    resource_hub: "Baza Wiedzy" # {change}
    apcsp: "Zasady AP CS"
    parent: "Rodzice"
#    faq: "FAQ"
...
#    term_of_service: "Terms of Service"
    esports: "E-sporty"
    browser_recommendation: "Dla lepszego dośwadczenia zachęcamy do skorzystania z najnowszej wersji Chrome'a. Poberz przeglądarkę tutaj!"
    ozaria_classroom: "Klasa Ozarii"
    codecombat_classroom: "Klasa CodeCombat"
...
#    codecombat_admin_dashboard: "CodeCombat Admin Dashboard"
    professional_development: "Doskonalenie zawodowe"
    new: "New!"
    admin: "Administrator"
#    api: "API"
    api_dashboard: "API Dashboard"
    funding_resources_guide: "Przewodnik po źródłach finansowania"
...
#    try_again: "Try Again"
  ...
  new_home_faq:
    ...
    why_javascript_blurb: "JavaScript jest językiem sieci i jest używany na prawie każdej stronie internetowej. Możesz wybrać JavaScript, jeśli planujesz studiować także tworzenie stron internetowych. Ułatwiliśmy także studentom przejście z Pythona na tworzenie stron internetowych w JavaScript."
    javascript_versus_python: "Składnia JavaScriptu jest nieco trudniejsza dla początkujących niż Pythona, więc jeśli nie możesz się zdecydować między tymi dwoma programami, polecamy Pythona."
    how_do_i_get_started: "Jak mogę zacząć?"
    getting_started_1: "Utwórz swoje Konto Nauczyciela"
    getting_started_2: "Stwórz klasę"
    getting_started_3: "Dodaj uczniów"
    getting_started_4: "Usiądź wygodnie i patrz, jak Twoi uczniowie dobrze się bawią, ucząc się kodowania."
    main_curriculum: "Czy mogę używać CodeCombat lub Ozarii jako mojego głównego programu nauczania?"
    main_curriculum_blurb: "Oczywiście! Spędziliśmy sporo czasu na konsultacjach ze specjalistami w dziedzinie edukacji, aby opracować program nauczania i materiały specjalnie dla nauczycieli, którzy używają CodeCombat lub Ozarii bez wcześniejszego doświadczenia w nauczaniu informatyki. Wiele szkół wdraża CodeCombat i/lub Ozarię jako główny program nauczania informatyki."
    clever_instant_login: "Czy CodeCombat i Ozaria wspierają Clever Instant Login?"
    clever_instant_login_blurb: "Tak! Sprawdź nasze __clever__, aby uzyskać więcej szczegółów na temat tego, jak zacząć."
    clever_integration_faq: "FAQ dot. integracji"
    google_classroom: " Co z Google Classroom?"
    google_classroom_blurb1: "Tak! Pamiętaj, aby użyć trybu pojedynczego logowania Google (SSO) do zarejestrowania się na konto nauczyciela. Jeśli masz już konto przy użyciu swojego adresu e-mail Google, użyj modułu SSO Google, aby zalogować się następnym razem. W oknie dialogowym Utwórz klasę zobaczysz opcję Połącz klasę Google. W tym momencie obsługujemy tylko rostering przez Google Classroom."
    google_classroom_blurb2: "Uwaga: musisz użyć Google SSO do zarejestrowania się lub zalogowania się co najmniej raz, aby zobaczyć opcję integracji z Google Classroom."
    how_much_does_it_cost: "Ile kosztuje dostęp do wszystkich dostępnych kursów i zasobów?"
    how_much_does_it_cost_blurb: "Dostosowujemy rozwiązania dla szkół i okręgów i pracujemy z Tobą, aby zrozumieć Twój przypadek użycia, kontekst i budżet. Skontaktuj się z nami, aby uzyskać więcej szczegółów! Zobacz również nasze __funding__, aby dowiedzieć się, jak wykorzystać źródła finansowania ustawy CARES, takie jak ESSER i GEER."
...
#    confirm_individual_blurb_without_email: "Write down your login information in case you need it later."
    ...
    teacher_students_can_start_now_coco: "Twoi uczniowie będą mogli od razu zacząć grać w pierwszy kurs, Wprowadzenie do informatyki."
    teacher_students_can_start_now_ozar: "Twoi uczniowie będą mogli od razu zacząć grać w pierwszy kurs, Wprowadzenie do informatyki."
    ...
    teacher_list_resource_hub_2_coco: "Przewodników kursu"
    teacher_list_resource_hub_2_ozar: "Przewodników kursu"
    teacher_list_resource_hub_3: "po rozwiązania dla każdego z poziomów, oraz do"
    teacher_list_resource_hub_4: "Bazy wiedzy" # {change}
...
#    description_coming_soon: "Description coming soon"
  ...
  options:
    ...
    editor_config_title_coco: "Konfiguracja edytora"
    editor_config_title_ozar: "Konfiguracja edytora"
...
#    bdm_title: "Business Development Manager"
    community_subtitle: "Ponad 500 kontrybutorów pomogło stworzyć CodeCombat i liczba ta cały czas rośnie!" # {change}
    ...
    number_contributors: "Ponad 500 kontrybutorów poświęciło swoją wiedzę i czas, aby wspomóc nasz projekt." # {change}
...
#    license_code_used: "License Code used."
  ...
  teachers_quote:
    subtitle_coco: "Twoi uczniowie mogą zacząć nukę w mniej niż godzinę. Będziesz mógł <strong>utworzyć klasy, dodać uczniów, doglądać ich postępy</strong> w nauce programowania."
    subtitle_ozar: "Twoi uczniowie mogą zacząć nukę w mniej niż godzinę. Będziesz mógł <strong>utworzyć klasy, dodać uczniów, doglądać ich postępy</strong> w nauce programowania."
...
#    anything_else_helper: ""
    ...
    thanks_sub_header_coco: "Dziękujemy za okazanie zainteresowania stroną CodeCombat."
    thanks_sub_header_ozar: "Dziękujemy za okazanie zainteresowania stroną CodeCombat."
...
#    hoc_blurb3: "activity! Construct four different minigames to learn the basics of game development, then make your own!"
    ...
    back_courses_coco: "Wróć do moich kursów"
    back_courses_ozar: "Wróć do moich kursów"
    ...
    practice: "trenuj"
    required: "wymagany"
    welcome_to_courses_coco: "Witamy w kursach podróżniku!"
    welcome_to_courses_ozar: "Witamy w kursach podróżniku!"
...
#    view_videos: "view videos"
    ...
    ask_teacher_for_code_coco: "Poproś nauczyciela o kod klasy z CodeCombat! Jeśli już go masz, wpisz go poniżej:"
    ask_teacher_for_code_ozar: "Poproś nauczyciela o kod klasy z CodeCombat! Jeśli już go masz, wpisz go poniżej:"
    enter_c_code_coco: "<Wpisz kod klasy>"
    enter_c_code_ozar: "<Wpisz kod klasy>"
    join: "Dołącz"
...
#    current_hero_female: "Current Hero:"
    ...
    license_required_to_play_coco: "Poproś nauczyciela o przydzielenie ci licencji, abyś mógł kontynuować rozgrywkę w CodeCombat!"
    license_required_to_play_ozar: "Poproś nauczyciela o przydzielenie ci licencji, abyś mógł kontynuować rozgrywkę w CodeCombat!"
...
#    student_code: "__name__'s Student Code"
    ...
    my_classes: "Moje klasy"
    courses_coco: "Przewodniki"
    courses_ozar: "Przewodniki"
...
#    view_student_code: "Click to view student code"
    select_course_coco: "Wybierz kurs do wyświetlenia"
    select_course_ozar: "Wybierz kurs do wyświetlenia"
...
#    push_projects: "We recommend assigning Web Development 1 or Game Development 1 after students have finished Introduction to Computer Science! See our {{resource_hub}} for more details on those courses."
    ...
    teacher_quest_teach_methods_step1: "Niech przynajmniej 75% jednej klasy przejdzie pierwszy poziom, Dungeons of Kithgard"
    teacher_quest_teach_methods_step2: "Wydrukuj [Krótki przewodnik ucznia](https://files.codecombat.com/docs/resources/StudentQuickStartGuide.pdf) z [Bazy wiedzy](/teachers/resources)." # {change}
    teacher_quest_teach_strings: "Naucz uczniów jak budować `stringi`."
    teacher_quest_teach_strings_step1: "Niech przynajmniej 75% jednej klasy dotrze do True Names"
    teacher_quest_teach_strings_step2: "Użyj przeglądarki poziomów w [Przewodnikach po kursach](/teachers/courses) i przeglądnij poziom True Names."
    teacher_quest_teach_loops: "Niech uczniowie się zapętlą. Naucz ich konstrukcji `loop`."
    teacher_quest_teach_loops_step1: "Niech przynajmniej 75% jednej klasy dotrze do Fire Dancing."
#    teacher_quest_teach_loops_step2: "Use the Loops Activity in the [CS1 Curriculum guide](/teachers/resources/cs1) to reinforce this concept."
    ...
    teacher_quest_teach_variables_step1: "Niech przynajmniej 75% jednej klasy dotrze do Known Enemy."
    ...
    teacher_quest_kithgard_gates_100_step1: "Niech przynajmniej 75% jednej klasy dotrze do Kithgard Gates."
#    teacher_quest_kithgard_gates_100_step2: "Guide students to think through hard problems using the [Engineering Cycle Worksheet](https://files.codecombat.com/docs/resources/EngineeringCycleWorksheet.pdf)."
    ...
    teacher_quest_wakka_maul_100_step1: "Niech przynajmniej 75% jednej klasy dotrze do Wakka Maul."
    teacher_quest_wakka_maul_100_step2: "Przeczytaj [Przewodnik po Arenie](/teachers/resources/arenas) w [Bazie wiedzy](/teachers/resources) aby dowiedzieć się jak prowadzić lekcje na Arenie." # {change}
...
#    bd_help: "For any help, contact"
  ...
  form_validation_errors:
    ...
    numberGreaterThanZero: "Powinno być liczbą większą od 0"
