...
#    code_line_number: "1 Billion"
  ...
  new_home:
    title: "CodeCombat - Programmeringsspill som lærer deg Python og JavaScript"
    meta_keywords: "CodeCombat, python, javascript, programmeringsspill"
...
#    auth_sign_up: "New to Ozaria? Create an Account"
    sign_up: "Lag konto"
    email_or_username: "Epost eller brukernavn" # {change}
#    or: "or"
    log_in: "Logg inn"
#    sign_in: "Sign In"
    ...
    finishing: "Fullfører"
    sign_in_with_facebook: "Logg på med Facebook" # {change}
    sign_in_with_gplus: "Logg på med G+" # {change}
...
#    parent_email_blurb: "We know you can't wait to learn programming &mdash; we're excited too! Your parents will receive an email with further instructions on how to create an account for you. Email {{email_link}} if you have any questions."
    ...
    signup_as_teacher: "Registrer deg som lærer" # {change}
    ...
    signup_as_student: "Registrer deg som elev" # {change}
...
#    confirm_individual_blurb: "Write down your login information in case you need it later. Verify your email so you can recover your account if you ever forget your password - check your inbox!"
    write_this_down: "Skriv dette ned:" # {change}
...
#    description_coming_soon: "Description coming soon"
  ...
  options:
    ...
    editor_config_title: "Editor Oppsett" # {change}
    editor_config_livecompletion_label: "Autofullfør" # {change}
    ...
    editor_config_behaviors_label: "Smart oppførsel" # {change}
...
#    view_project_gallery: "view my classmates' projects"
    join_class: "Bli med i en klasse" # {change}
