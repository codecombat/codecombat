...
#    click_here: "Click here"
    ...
    for_leaders_subblurb3: "CodeCombat은 여러분의 필요에 맞게 조정됩니다. 중학교 코딩 선택 과목을 만들든, CTE Pathway나 AP Computer Science Principle 클래스를 만들든 말이죠." # {change}
    ...
    quotes_quote1: "인터넷 상에는 많은 교육 프로그램들이 있죠. 다 시도해 봤지만, CodeCombat만한 것은 없습니다. 학생들이 코드를 배우길 원하는 선생님이라면... 여기서 시작하세요!" # {change}
...
#    score_display: "__scoreType__: __score__"
  ...
  subscribe:
    ...
    comparison_blurb: "코드컴뱃을 구독하셔서 당신의 기술을 갈고닦으세요!" # {change}
    ...
    year_subscription: "연간 구독" # {change}
    year_price: "$__price__/년" # {change}
  ...
  announcement:
    ...
    coming_soon: "곧 출시됩니다"
    ritic: "냉기의 Ritic" # Ritic Announcement Modal
...
#    select_avatar_title: "Choose Player Avatar"
  ...
  choose_hero:
    ...
    speed: "속도"
    regeneration: "자동 회복"
    range: "사정거리 및 시야" # As in "attack or visual range"
    blocks: "데미지 방어" # As in "this shield blocks this much damage"
    backstab: "기습" # As in "this dagger does this much backstab damage"
    skills: "스킬"
    attack_1: "타격"
    attack_2: "정렬됨"
    attack_3: "무기 데미지."
    ...
    speed_1: "에 이동"
    speed_2: "초당 미터."
    available_for_purchase: "구매 필요" # Shows up when you have unlocked, but not purchased, a hero in the hero store
    level_to_unlock: "잠금 해제를 위해 레벨 클리어 필요:" # Label for which level you have to beat to unlock a particular hero (click a locked hero in the store to see)
...
#    bdm_title: "Business Development Manager"
    community_subtitle: "500명이 넘는 Contributor분들이 CodeCombat 개발을 도와주고 계십니다, 매주 새로운 분들이 저희 프로젝트에 참여해주시고 계십니다!!" # {change}
    ...
    number_contributors: "450명이 넘는 contributor들이 이 프로젝트를 위해 아낌없는 지원과 시간을 내주시고 있습니다." # {change}
