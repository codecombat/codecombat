...
#  new_home:
slogan: "Det roligaste sättet att lära sig programmering"
#    classroom_edition: "Classroom Edition:"
learn_to_code: "Lär dig att koda:"
play_now: "Spela Nu"
im_a_teacher: "Jag är en lärare"
im_a_student: "Jag är en elev"
learn_more: "Läs mer"
#    classroom_in_a_box: "A classroom in-a-box for teaching computer science."
codecombat_is: "CodeCombat är en plattform <strong>för elever</strong> att lära sig datavetenskap genom att spela ett riktigt spel."
our_courses: "Våra kurser har blivit speltestade specifikt för att <string>fungera utmärkt i klassrum</strong>, även för lärare med liten eller ingen tidigare erfarenhet av programmering"
watch_how: "Se hur CodeCombat förändrar hur människor lär sig datavetenskap"
top_screenshots_hint: "Elever skriver kod och ser sina ändringar uppdateras i realtid"
designed_with: "Designad med lärare i åtanken"
real_code: "Riktig, skriven kod"
from_the_first_level: "från första nivån"
getting_students: "Att få elever att börja skriva kod så snabbt som möjligt är viktigt för att lära sig programmeringssyntax och korrekt struktur."
educator_resources: "Lärarresurser"
course_guides: "och kursguider"
teaching_computer_science: "Att lära ut datavetenskap kräver ingen examen, eftersom vi bidrar med verktyg för att stödja lärare med alla bakgrunder"
accessible_to: "Tillgängligt för"
everyone: "alla"
democratizing: "Att demokratisera processen för att lära sig koda är kärnan av får filosofi. Alla borde få lära sig att koda."
forgot_learning: "Jag tror att de faktiskt glömde att de faktiskt lärde sig något"
wanted_to_do: " Kodning är något som jag alltid velat testa, och jag trodde aldrig att jag skulle få lära mig det i skolan."
why_games: "Varför är det viktigt att lära sig genom spel?"
games_reward: "Spel belönar ansträgning." #Games reward the productive struggle
encourage: "Spel som media uppmuntrar till interaktion, upptäckter och trial-and-error. Ett bra spel utmanar spelaren till att bemästra kunskaper över tid, vilket är samma viktiga process som elever går igenom när de studerar" # Gaming is a medium that encourages interaction, discovery, and trial-and-error. A good game challenges the player to master skills over time, which is the same critical process students go through as they learn."
excel: "Spel är utmärkta på att belöna" #Games excel at rewarding"
struggle: "produktiv ansträgning" #productive struggle"
kind_of_struggle: "den ansträgning som resulterar i inlärning som är engagerande och" # the kind of struggle that results in learning that’s engaging and"
motivating: "motiverande"
not_tedious: "inte tråkig."
gaming_is_good: "Studier visar på att spel är bra för barns hjärnor. (det är sant!)" #Studies suggest gaming is good for children’s brains. (it’s true!)"
game_based: "När spelbaserade system " # When game-based learning systems are"
compared: "jämförs med" 
conventional: "klassiska utvärderande metoder, skillnaden är tydlig: Spel hjälper eleven att behålla sin kunskap, koncentrera sig och" #"against conventional assessment methods, the difference is clear: games are better at helping students retain knowledge, concentrate and"
#    perform_at_higher_level: "perform at a higher level of achievement"
feedback: "Spel ger också återkoppling som gör att eleven kan anpassa sin lösning och förstå andra koncept holistiskt, istället för att vara begränsade till “rätta” eller “fel” svar" #"Games also provide real-time feedback that allows students to adjust their solution path and understand concepts more holistically, instead of being limited to just “correct” or “incorrect” answers."
real_game: "Ett riktigt spel, som spelas genom att skriva riktig kod."
great_game: "Ett bra spel är mer än bara märken och prestationer - det är om en spelares resa, väldesignade pussel, och förmågan att anta utmaningar aktivt och med säkerhet."
#    agency: "CodeCombat is a game that gives players that agency and confidence with our robust typed code engine, which helps beginner and advanced students alike write proper, valid code."
request_demo_title: "Låt dina elever börja redan idag!"
request_demo_subtitle: "Be om en demo och dina elever kan börja inom en timma"
...
computer_science: "Våra kurser tas i sin egna takt och täcker allt ifrån grundläggande syntax till mer avancerade koncept."
ffa: "Gratis för alla elever"
coming_soon: "Mer kommer snart!"
...
run_class: "Allt du behöver för att hålla en lektion i Datavetenskap på din skola redan idag, ingen datavetenskaplig bakgrund krävs."
goto_classes: "Gå till mina klasser"
view_profile: "Visa min profil"
view_progress: "Visa mina framsteg"
go_to_courses: "Gå till mina kurser"
want_coco: "Vill du ha CodeCombat på sin skola?"
...
#    support: "Support"
#    faqs: "FAQs"
help_pref: "Behöver du hjälp? Mejla"
help_suff: "så hör vi av oss!"
...
#    subscriber_gems: "Subscribe today to purchase this hero with gems!"
    ...
    brain_pop_challenge: "Utmana dig själv genom att spela igen med ett annat programmeringsspråk!"
    replay: "Spela igen"
...
#    level_complete: "Level Complete"
    ...
    start_challenge: "Starta Utmaning"
    next_game: "Nästa spel"
    languages: "Språk"
    programming_language: "Programmeringspråk"
    ...
    goals: "Mål"
    goal: "Mål"
    challenge_level_goals: "Utmaningsmål"
    challenge_level_goal: "Utmaningsmål"
    running: "Kör..."
    success: "Du lyckades!"
...
#    tip_mistakes_proof_of_trying: "Mistakes in your code are just proof that you are trying."
    tip_adding_orgres: "Samlar troll."
    tip_sharpening_swords: "Slipar svärden."
...
#    tip_programming_not_about_computers: "Computer Science is no more about computers than astronomy is about telescopes. - Edsger Dijkstra"
    tip_mulan: "Tro på att du kan, så kommer du att kunna. - Mulan"
...
#    goal_collect_amount: "Collect __amount__ items."
  ...
  leaderboard:
    ...
    defeated: "Besegrade Fienden"
    code_length: "Rader med kod"
