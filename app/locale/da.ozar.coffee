...
#    sign_in: "Sign In"
    ...
    sign_in_with_facebook: "Log ind med Facebook" # {change}
    sign_in_with_gplus: "Log ind med G+" # {change}
...
#    description_coming_soon: "Description coming soon"
  ...
  options:
    ...
    editor_config_title: "Editor Konfiguration" # {change}
    editor_config_livecompletion_label: "Live Autocompletion" # {change}
    ...
    editor_config_behaviors_label: "Intelligent Opførelse" # {change}
...
#    learn_more: "Learn More"
    ...
    story_link: "Baggrund"
    press_link: "Pressen"
    mission_title: "Vores mission: At gøre programmering tilgængelig for alle elever på Jorden." # {change}
...
#    mission_desc_3: "Over the last five years, over twelve million people have learned to write Python and JavaScript using CodeCombat, making it one of the most popular coding games in history. Now, we are excited to launch Ozaria and expand on our commitment to inspire a new generation of students to learn computer science. Ozaria is an adventure game that places each learner at the center of a legendary story where they must save the world of Ozaria from impending darkness by mastering the lost magic of coding. As the narrative unfolds, a powerful student-centered learning experience is created - each student’s investment in Ozaria’s story paralleling the investment they are making in their own learning journey."
    ...
    team_values: "Vi værdsætter åben og respektfuld dialog, hvor den bedste idé vinder. Vores beslutninger er funderet med undersøgelser af kundernes oplevelser og vores proces er fokuseret på at levere konkrete resultater til dem. Alle er inddraget, fra vores CEO til vores GitHub bidragsydere, fordi vi værdsætter vækst og læring i vores team." # {change}
...
#    community_description_link_2: "community project"
    ...
    story_statistic_1c: "har startet deres programmeringsrejse med CodeCombat" # {change}
    ...
    jobs_title: "Kom og arbejd hos os og hjælp med at skrive CodeCombat historie!" # {change}
...
#    back_classroom: "Back to classroom"
    back_courses: "Tilbage til mine klasser" # {change}
...
#    view_project_gallery: "view my classmates' projects"
    join_class: "Følg En Klasse" # {change}
#    join_class_2: "Join class"
    ask_teacher_for_code: "Spørg din lærer om du har en CodeCombat-klassekode! Hvis det er tilfældet, angiv den nedenfor:" # {change}
    enter_c_code: "<Indtast klassekode>" # {change}
    join: "Følg"
