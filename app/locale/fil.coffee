module.exports = nativeDescription: "Tagalog", englishDescription: "Filipino (Philippines)", translation:
  new_home:
    ...
    codecombat_is: "Ang CodeCombat ay isang platforma para matuto ang <strong>mga estudyante</strong> ng computer science habang naglalaro ng tunay na laro"
...
#    watch_how: "Watch how CodeCombat is transforming the way people learn computer science."
    ...
    agency: "Ang CodeCombat ay laro na nagbibigay sa mga manlalaro ng tamang-gawa at tiwala gamit ang aming pulidong 'typed code engine', na tumutulong sa mga baguhan at bihasang estudyante magsulat ng tama at maayos na code."
    ...
    computer_science: "Mga kursong \"Computer Science\" para sa lahat ng edad" # {change}
    show_me_lesson_time: "Ipakita ang guguguling oras para sa:"
    curriculum: "Kabuuang oras :"
    ffa: "Libre sa lahat ng estudyante"
    lesson_time: "Oras na gugugulin:"
    coming_soon: "Marami pang darating!"
    courses_available_in: "Mga kurso ay meron sa JavaScript at Python. Mga kursong pang-Web Development  ay gumagamit ng HTML, CSS, jQuery, at Bootstrap." # {change}
...
#    no_changes: "No Changes"
  ...
  legal:
    page_title: "Legal"
    opensource_intro: "Ang CodeCombat ay 'open source' para sa lahat."
    opensource_description_prefix: "Tignan ang "
    github_url: "aming GitHub"
    opensource_description_center: "at tumulong kung gusto nyo! Ang CodeCombat ay gawa sa samutsaring proyekto na 'open source' at mahal namin ang mga ito. Tignan ang "
    ...
    code_title: "Code - MIT"
    code_description_prefix: "Lahat ng code na Pagmamay-ari ng CodeCombat o nakalathala sa codecombat.com, mapa-sa GitHub repository o sa codecombat.com database, ay lisensyado sa ilalim ng"
    mit_license_url: "MIT license"
    code_description_suffix: "Kabilang dito ang lahat ng code sa 'Systems' at 'Components' na ibinabahagi ng CodeCombat na ang layunin ay pag-gawa ng mga Level sa laro."
    art_title: "Art/Music - Creative Commons "
    art_description_prefix: "Lahat ng 'common content' ay pwedeng gamitin sa ilalim ng"
    cc_license_url: "Creative Commons Attribution 4.0 International License"
    art_description_suffix: "Ang 'Common content' ay kahit anong ginawang pwedeng kunin mula sa CodeCombat para pang-gawa ng mga Level. Kabilang dito ay:"
    ...
    use_list_2: "Kung ginamit sa website, maglagay ng link malapit sa pinag-gamitan, halimbawa sa ilalim ng imahe, o isama sa isang 'attributions page' kung saan magpapasalamat sa iba pang 'Creative Commons' at 'Open Source Software' na ginamit sa site. Anumang bagay na malinaw na pinapatukuyan ang CodeCombat, gawa ng mga blog post na binabanggit ang CodeCombat, ay hindi na kelangan gumawa ng hiwalay na pag-ngalan."
    art_paragraph_2: "Kung ang content na ginagamit ay gawa hindi ng CodeCombat ngunit ng isang miyembro ng codecombat.com, pangalanan sila at sundin ang anumang panunturin sa pag ngalan, kung meron man."
