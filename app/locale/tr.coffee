...
#    century_skills_subblurb4: "Coding requires kids to practice new forms of communication, including communicating with the computer itself and conveying their ideas using the most efficient code."
    classroom_in_box_title: "Çabalıyoruz:"
    classroom_in_box_blurb1: "Her öğrencinin katılımını sağlayın ki kodlamanın kendileri için olduğuna inansınlar."
    classroom_in_box_blurb2: "Bir eğitimciye kodlama öğretirken kendinden emin hissetmesini sağlayın."
    classroom_in_box_blurb3: "Tüm okul liderlerine dünya standartlarında bir bilgisayar bilimi programı oluşturma konusunda ilham verin."
...
#    featured_partners_blurb6: "Hour of Code Activity Partner"
    ...
    for_leaders_subblurb1: "BT desteği gerektirmeyen web tabanlı bir program. Google veya Clever Single Sign-On'u (TOA) kullanarak 5 dakikadan kısa sürede başlayın."
    for_leaders_subtitle2: "Tam Kodlama Müfredatı"
    for_leaders_subblurb2: "Herhangi bir öğretmenin bilgisayar bilimi öğretmesini sağlamak için eğitim kaynakları ve mesleki gelişim ile standartlara uygun bir müfredat."
...
#    for_leaders_subblurb3: "Whether you want to build a Middle School coding elective, a CTE pathway, or are teaching an Intro to CS class, CodeCombat is tailored to suit your needs."
    ...
    for_leaders_subblurb4: "Öğrenciler, kendilerini 500 binden fazla açık bilgi işlem işlerine hazırlayan kodlama zorluklarıyla cesaret kazanır ve büyüme zihniyeti geliştirir."
    for_teachers_title: "Öğretmenler İçin"
    for_teachers_blurb: "Öğrencinin Potansiyelini Ortaya Çıkarmak İçin Araçlar"
    ...
    for_teachers_subtitle3: "Mevcut Görevler"
...
#    for_teachers_subtitle4: "Automatic Differentiation"
    for_teachers_subblurb4: "Her öğrencinin öğrenme ihtiyaçlarına göre uyarlanan uygulama seviyeleri ile tüm öğrencilerin katılımını farklı bir sınıfta yapın."
    game_based_blurb: "CodeCombat, öğrencilerin gerçek kod yazdıkları ve karakterlerinin gerçek zamanlı olarak tepkilerini gördükleri oyun tabanlı bir bilgisayar bilimi programıdır."
    get_started: "Başlayalım"
    global_title: "Küresel Öğrenci ve Eğitimci Topluluğumuza Katılın"
...
#    run_class: "Everything you need to run a computer science class in your school today, no CS background required."
    ...
    want_coco: "Okulunuzda CodeCombat ister misiniz?"
    educator: "Öğretmen"
    student: "Öğrenci"
    our_coding_programs: "Kodlama Programlarımız"
...
#    ozaria_blurb: "An adventure game and Computer Science program where students master the lost magic of coding to save their world. Recommended for educators and students."
    try_codecombat: "CodeCombat'ı deneyin"
    try_ozaria: "Ozaria'yı deneyin"
    explore_codecombat: "CodeCombat'ı Keşfet"
#    explore_ai_league: "Explore AI League"
#    explore_ozaria: "Explore Ozaria"
    explore_online_classes: "Online Sınıfları Keşfedin"
...
#    online_classes_blurb: "Our online coding classes combine the power of gameplay and personalized instruction for an experience your child will love. With both private or group options available, this is remote learning that works."
    for_educators: "Eğitmenler İçin"
    for_parents: "Ebeveynler İçin"
    for_everyone: "Herkes İçin"
    what_our_customers_are_saying: "Müşterilerimiz Ne Diyor?"
    game_based_learning: "Oyun Tabanlı Öğrenme"
#    unique_approach_blurb: "With our unique approach, students embrace learning as they play and write code from the very start of their adventure, promoting active learning and a growth mindset."
    text_based_coding: "Yazı Tabanlı Öğrenme"
#    custom_code_engine_blurb: "Our custom code engine and interpreter is designed for beginners, teaching true Python, JavaScript, and C++ programming languages using human, beginner-friendly terms."
    student_impact: "Öğrenci Etkisi"
    help_enjoy_learning_blurb: "Ürünlerimiz, 20 milyondan fazla öğrencinin bilgisayar bilimi öğrenmekten zevk almasına yardımcı olarak, onlara eleştirel, kendine güvenen ve yaratıcı öğrenciler olmayı öğretti. Deneyimlerinden bağımsız olarak tüm öğrencileri bağlayarak bilgisayar bilimlerinde başarıya giden bir yolda ilerlemelerine yardımcı oluyoruz."
    global_community: "Küresel Topluluğumuza Katılın"
    million: "__num__ Milyon"
    billion: "__num__ Milyar"
...
#    browser_recommendation: "For the best experience we recommend using the latest version of Chrome. Download the browser here!"
    ozaria_classroom: "Ozaria Sınıfı"
    codecombat_classroom: "CodeCombat Sınıfı"
    ozaria_dashboard: "Ozaria Paneli"
    codecombat_dashboard: "CodeCombat Paneli"
    professional_development: "Profesyönel Geliştirme"
    new: "Yeni!"
    admin: "Yönetici"
    api_dashboard: "API Paneli"
...
#    nil: "nil"
  ...
  login:
    ...
    accounts_merge_confirmation: "Bu Google hesabına bağlı e-postayla ilişkili bir hesap var. Bu hesapları birleştirmek ister misiniz?"
  ...
  signup:
    ...
    sign_in_to_continue: "Devam etmek için oturum açın veya bir hesap oluşturun"
#    create_account_to_submit_multiplayer: "Create a free account to rank your multiplayer AI and explore the whole game!"
    teacher_email_announcements: "Yeni öğretmen kaynakları, müfredat ve kurslar hakkında beni güncel tut!"
...
#    classroom_not_found: "No classes exist with this Class Code. Check your spelling or ask your teacher for help."
    ...
    account_exists: "Bu email zaten kullanımda:"
    sign_in: "Oturum aç"
...
#    with: "with"
    chat: "Sohbet"
    chat_with_us: "Bizle sohbet et"
    email_us: "Bize bir e-posta gönder"
#    sales: "Sales"
    support: "Destek"
#    here: "here"
  ...
  play_level:
    ...
    explore_codecombat: "CodeCombat'ı Keşfet"
    finished_hoc: "Kodlama Saatimi Bitirdim"
...
#    restart_really: "Seviyeyi yeniden başlatmak istediğinizden emin misiniz? Yazdığınız tüm kodu kaybedeceksiniz."
    restart_confirm: "Evet, Tekrar Başlat"
    ...
    victory_new_hero: "Yeni Kahraman"
...
#    victory_no_progress_for_teachers: "Progress is not saved for teachers. But, you can add a student account to your classroom for yourself."
    ...
    tome_cast_button_update: "Güncelle"
...
#    tip_extrapolation: "There are only two kinds of people: those that can extrapolate from incomplete data..."
    ...
    tip_no_code: "Hiçbir kod, kod olmamasından daha hızlı değildir."
...
#    tip_lines_of_code: "Measuring programming progress by lines of code is like measuring aircraft building progress by weight. — Bill Gates"
    ...
    tip_hate_computers: "Bilgisayarlardan nefret ettiğini sanan insanların olayı bu. Gerçekten nefret ettikleri şey berbat programcılar. - Larry Niven"
...
#    tip_recurse: "To iterate is human, to recurse divine. - L. Peter Deutsch"
    ...
    tip_solve_then_write: "Önce problemi çöz. Kodu sonra yaz. - John Johnson"
    tip_compiler_ignores_comments: "Bazı zamanlar derleyicinin yorumlarımı görmezden geldiğini düşünüyorum.."
#    tip_understand_recursion: "The only way to understand recursion is to understand recursion."
#    tip_life_and_polymorphism: "Open Source is like a totally polymorphic heterogeneous structure: All types are welcome."
    tip_mistakes_proof_of_trying: "Kodunuzdaki hatalar sadece denediğinizin kanıtıdır."
...
#    vega_character: "Vega Character"
    click_to_continue: "Devam Etmek İçin Tıkla"
...
#  amazon_hoc:
    title: "Amazon ile Öğrenmeye Devam Edin!"
    congrats: "Bu zorlu Kodlama Saatini tamamladığınız için tebrikler!"
    educate_1: "Şimdi, Amazon'un hem öğrenciler hem de öğretmenler için sunduğu heyecan verici ve ücretsiz bir program olan AWS Educate ile kodlama ve bulut bilişim hakkında bilgi edinmeye devam edin. AWS Educate ile bulutun ve oyun, sanal gerçeklik ve Alexa gibi en son teknolojilerin temelleri hakkında bilgi edindikçe harika rozetler kazanabilirsiniz."
    educate_2: "Daha fazla bilgi edinin ve buradan kaydolun"
    future_eng_1: "Ayrıca Alexa için kendi okul gerçekleri becerinizi oluşturmaya çalışabilirsiniz."
    future_eng_2: "buraya"
    future_eng_3: "(cihaz gerekli değildir). Bu Alexa etkinliği size"
#    future_eng_4: "Amazon Geleceğin Mühendisi"
#    future_eng_5: "ABD'de bilgisayar bilimleri ile ilgilmek isteyen tüm K-12 öğrencileri için öğrenme ve çalışma fırsatları yaratan program."

#  live_class:
    title: "Teşekkürler!"
    content: "İnanılmaz! Canlı çevrimiçi dersleri yeni başlattık."
    link: "Kodlamanızda ilerlemeye hazır mısınız?"

#  code_quest:
    great: "Harika!"
    join_paragraph: "Her yaş için en büyük uluslararası Python Yapay Zeka kodlama turnuvasına katılın ve lider panosunun zirvesi için yarışın! Bu ay sürecek küresel savaş 1 Ağustos'ta başlıyor ve 5 bin dolarlık ödül ve kazananları açıklayacağımız ve kodlama becerilerinizi tanıyacağımız sanal bir ödül töreni içeriyor."
    link: "Kayıt olmak ve daha fazlasını öğrenmek için buraya tıklayın"
    global_tournament: "Dünya Geneli Turnuva"
    register: "Kayıt Ol"
    date: "Ağustos 1 - Ağustos 31"
...
#    goal_collect_amount: "Collect __amount__ items."
  ...
  leaderboard:
    ...
    survival_time: "Hayatta Kaldı"
    defeated: "Düşmanlar Yenildi"
    code_length: "Kod Satırları"
#    score_display: "__scoreType__: __score__"
  ...
  inventory:
    ...
    equip: "Giy"
    unequip: "Çıkar"
    warrior_only: "Sadece Savaşçı"
#    ranger_only: "Ranger Only"
    wizard_only: "Sadece Büyücü"
...
#  subscribe_for_gems:
    prompt_title: "Yetersiz Taş!"
    prompt_body: "Değerli taşlar almak ve daha da fazla seviyeye erişmek için Premium'a abone olun!"

#  earn_gems:
    prompt_title: "Yetersiz Taş"
    prompt_body: "Daha fazlasını kazanmak için oynamaya devam edin!"
