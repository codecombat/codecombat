module.exports = nativeDescription: "Türkçe", englishDescription: "Turkish", translation:
  ...
  new_home:
    ...
    meta_description: "Bir programlama oyunu aracılığıyla yazılan kodu öğrenin. Bulmacaları çözerken Python, JavaScript ve HTML öğrenin ve kendi kodlama oyunlarınızı ve web sitelerinizi yapmayı öğrenin."
    meta_og_url: "https://codecombat.com"
    become_investor: "CodeCombat'ta yatırımcı olmak için"
    ...
    built_for_teachers_subblurb2: "Öğrenciler labirentler oluşturur ve arkadaşları ve aileleri ile paylaşabilecekleri kendi oyunlarını kodlamak için temel girdi işlemeyi kullanırlar."
    built_for_teachers_subtitle3: "Web Geliştirme"
    built_for_teachers_subblurb3: "Öğrenciler HTML, CSS ve jQuery kullanarak, sınıf arkadaşlarıyla paylaşmak üzere kendi web sayfalarını özel bir URL ile programlamak için yaratıcı güçlerini esnetirler."
    ...
    century_skills_quote1: "Her şeyi batırırsın… o zaman onu düzeltmenin tüm olası yollarını düşünürsün ve sonra tekrar denersin. Çok çabalamadan buraya gelemezdim."
    century_skills_subtitle1: "Eleştirel Düşünme"
    century_skills_subblurb1: "CodeCombat'ın programlama oyunu, doğal olarak giderek daha zorlu seviyelere dönüştürülen kodlama bulmacalarıyla çocukların her zaman eleştirel düşünme pratiği yapmalarını sağlar."
    century_skills_quote2: "Diğer herkes labirent yapıyordu, ben de 'bayrağı ele geçir' diye düşündüm ve öyle yaptım."
    ...
    century_skills_quote3: "Eğer bir seviyede takılıp kalırsam. Hepimiz anlayana kadar çevremdeki insanlarla çalışırdım."
    century_skills_subtitle3: "İş Birliği"
    century_skills_subblurb3: "Oyun boyunca, öğrencilerin sıkıştıklarında işbirliği yapma ve ikili programlama kılavuzumuzu kullanarak birlikte çalışma fırsatları vardır."
    century_skills_quote4: "Her zaman video oyunları tasarlama ve kodlamayı öğrenme hayalim vardı... bu bana harika bir başlangıç noktası sağlıyor."
    century_skills_quote4_author: "Joey, 10. Sınıf"
    century_skills_subtitle4: "İletişim"
    century_skills_subblurb4: "Kodlama, çocukların bilgisayarla iletişim kurmak ve fikirlerini en verimli kodu kullanarak iletmek de dahil olmak üzere yeni iletişim biçimlerini uygulamalarını gerektirir."
    classroom_in_box_title: "Çalışıyoruz:"
    classroom_in_box_blurb1: "Kodlamanın kendileri için olduğuna inanmaları için her öğrenciyle etkileşime geçin"
    classroom_in_box_blurb2: "Bir eğitimciye kodlama öğretirken kendinden emin hissetmesini sağlayın."
    classroom_in_box_blurb3: "Tüm okul liderlerine birinci sınıf bir bilgisayar bilimleri programı oluşturmaları için ilham verin."
#    classroom_in_box_blurb4: ""
    click_here: "Buraya tıklayın"
    creativity_rigor_title: "Yaratıcılığın Titizlikle Buluştuğu Yer"
    creativity_rigor_subtitle1: "Kodlamayı eğlenceli hale getirin ve gerçek dünya becerilerini öğretin"
    creativity_rigor_blurb1: "Öğrenciler deneme yanılma, eleştirel düşünme ve yaratıcılığı teşvik eden oyunlar oynarken gerçek Python ve JavaScript yazar. Öğrenciler daha sonra proje tabanlı kurslarda kendi oyunlarını ve web sitelerini geliştirerek öğrendikleri kodlama becerilerini uygularlar."
    creativity_rigor_subtitle2: "Öğrencilere kendi seviyelerinde ulaşın"
    creativity_rigor_blurb2: "Her CodeCombat seviyesi milyonlarca veri noktasına göre iskeleye sahiptir ve her öğrenciye uyum sağlamak için optimize edilmiştir. Uygulama seviyeleri ve ipuçları, öğrencilerin sıkıştıklarında yardımcı olur ve meydan okuma seviyeleri öğrencilerin oyun boyunca öğrenmelerini değerlendirir."
    creativity_rigor_subtitle3: "Deneyimden bağımsız olarak tüm öğretmenler için üretilmiştır"
    creativity_rigor_blurb3: "CodeCombat'ın kendi kendine tempolu, standartlara uygun müfredatı, bilgisayar bilimi öğretimi herkes için mümkün kılar. CodeCombat, öğretmenleri sınıfta güvende ve başarılı hissetmek için eğitim, öğretim kaynakları ve özel destek ile donatır."
    featured_partners_title1: "Öne Çıkanlar"
    featured_partners_title2: "Ödüller & Ortaklar"
    featured_partners_blurb1: "Akıllı ortak"
    featured_partners_blurb2: "Öğrenciler için En İyi Yaratıcılık Aracı"
    featured_partners_blurb3: "Öğrenme için En İyi Seçim"
    featured_partners_blurb4: "Code.org Resmi Ortağı"
    featured_partners_blurb5: "CSforAll Resmi Üyesi"
    featured_partners_blurb6: "Kod Saati Etkinlik Ortağı"
    for_leaders_title: "Okul Liderleri için"
    for_leaders_blurb: "Kapsamlı, Standartlara Uygun Bir Bilgisayar Bilimi Programı"
    for_leaders_subtitle1: "Kolay Uygulama"
    for_leaders_subblurb1: "BT desteği gerektirmeyen web tabanlı bir program. Google veya Clever Single Sign-On'u (SSO) kullanarak 5 dakikadan kısa sürede başlayın."
    for_leaders_subtitle2: "Tam Kodlama Müfredatı"
    for_leaders_subblurb2: "Herhangi bir öğretmenin bilgisayar bilimi öğretmesini sağlamak için öğretim kaynakları ve mesleki gelişim ile standartlara uygun bir müfredat."
    for_leaders_subtitle3: "Esnek Kullanım Durumları"
    for_leaders_subblurb3: "Bir Ortaokul kodlama seçmeli dersi, bir CTE yolu oluşturmak veya CS'ye Giriş sınıfı öğretmek istiyorsanız, CodeCombat ihtiyaçlarınıza göre uyarlanmıştır."
    for_leaders_subtitle4: "Gerçek Dünya Becerileri"
    for_leaders_subblurb4: "Öğrenciler, kendilerini 500K'dan fazla açık bilgi işlem işlerine hazırlayan kodlama zorluklarıyla cesaret kazanır ve büyüme zihniyeti geliştirir."
    for_teachers_title: "Öğretmenler İçin"
    for_teachers_blurb: "Öğrenci Potansiyelinin Kilidini Açacak Araçlar"
    for_teachers_subtitle1: "Proje Tabanlı Öğrenme"
    for_teachers_subblurb1: "Öğrencilerin kendi oyunlarını ve web sayfalarını geliştirdikleri proje tabanlı kurslarda yaratıcılığı, problem çözmeyi ve güveni teşvik edin."
    for_teachers_subtitle2: "Öğretmen Paneli"
    for_teachers_subblurb2: "Öğrenci ilerlemesine ilişkin verileri görüntüleyin, müfredat kaynaklarını keşfedin ve öğrencilerin öğrenimini güçlendirmek için gerçek zamanlı desteğe erişin."
    for_teachers_subtitle3: "Yerleşik Değerlendirmeler"
    for_teachers_subblurb3: "Öğretimi kişiselleştirin ve öğrencilerin biçimlendirici ve özetleyici değerlendirmelerle temel kavramları anlamalarını sağlayın."
    for_teachers_subtitle4: "Otomatik Farklılaşma"
    for_teachers_subblurb4: "Her öğrencinin öğrenme ihtiyaçlarına uyum sağlayan uygulama düzeyleriyle tüm öğrencilerin ilgisini farklı bir sınıfta çekin."
    game_based_blurb: "CodeCombat, öğrencilerin gerçek kod yazdığı ve karakterlerinin gerçek zamanlı olarak tepki verdiğini gördüğü, oyun tabanlı bir bilgisayar bilimi programıdır."
    get_started: "Başlayalım"
    global_title: "Küresel Öğrenciler ve Eğitimciler Topluluğumuza Katılın"
    ...
    quotes_quote1: "Çevrimiçi herhangi bir program adlandırın, denedim. Hiçbiri CodeCombat ve Ozaria ile eşleşmiyor. Öğrencilerinin kodlamayı öğrenmesini isteyen herhangi bir öğretmen... buradan başlayın!"
    quote_quote2: " CodeCombat'ın bilgisayar bilimi öğrenmeyi ne kadar kolay ve sezgisel hale getirdiğine şaşırdım. AP sınavındaki puanlar beklediğimden çok daha yüksekti ve bunun böyle olmasının nedeninin CodeCombat olduğuna inanıyorum."#    quotes_quote3: "CodeCombat has been the most beneficial for teaching my students real-life coding capabilities. My husband is a software engineer and he has tested out all of my programs. He put this as his top choice."
    quote_quote4: "Geri bildirimler… o kadar olumluydu ki, CodeCombat etrafında bir bilgisayar bilimi dersi yapılandırıyoruz. Program, öğrencilerin hem eğlenceli hem de öğretici olan bir oyun stili platformuyla gerçekten ilgisini çekiyor. İyi çalışmalar, CodeCombat! "
    quotes_quote5: "Dersler her cumartesi sabah 7'de başlasa da oğlum o kadar heyecanlı ki benden önce uyanıyor! CodeCombat, oğlumun kodlama becerilerini geliştirmesi için bir yol oluşturuyor."
    quotes_quote5_author: "Latthaphon Pohpon, Ebeveyn"
    see_example: "Örneğe bakın"
    slogan: "Programlama öğrenmek için en çekici oyun." # {change}
    slogan_power_of_play: "Oyunun Gücüyle Kodlamayı Öğrenin"
    teach_cs1_free: "CS1'i Ücretsiz Öğretin"
    teachers_love_codecombat_title: "Öğretmenler CodeCombat'ı Sever"
    teachers_love_codecombat_blurb1: "Öğrencilerinin kod yazmayı öğrenmek için CodeCombat'ı kullanmaktan keyif aldıklarını bildirin"
    teachers_love_codecombat_blurb2: "CodeCombat'ı diğer bilgisayar bilimleri öğretmenlerine tavsiye ederim"
    teachers_love_codecombat_blurb3: "CodeCombat'ın öğrencilerin problem çözme yeteneklerini desteklemelerine yardımcı olduğunu söyleyin"
    teachers_love_codecombat_subblurb: "Eğitim teknolojisinin araştırmaya dayalı rehberlik ve değerlendirmelerinde lider olan McREL International ile ortaklaşa."
    top_banner_blurb: "Ebeveynler, canlı öğretmenlerimizle çocuğunuza kodlama ve kişiselleştirilmiş eğitim hediye edin!"
    top_banner_summer_camp: "Yaz kodlama kamplarımız için kayıtlar başladı - bize sadece 199 dolardan başlayan bir haftalık sanal oturumlarımızı sorun."
    top_banner_blurb_funding: "Yeni: CARES Yasası finansman kaynakları kılavuzu, CS programlarınız için ESSER ve GEER fonlarına yöneliktir."
    ...
    builds_concepts_up: "CodeCombat'ın kavramları oluşturma şeklini seviyorum. Anlaması gerçekten kolay ve çözmesi eğlenceli."
...
#    game_based: "Oyun tabanlı öğrenme sistemleri olduğunda"
#    compared: "karşılaştırılan"
#    conventional: "geleneksel değerlendirme yöntemlerine karşı, fark açıktır: oyunlar öğrencilerin bilgiyi muhafaza etmelerine, konsantre olmalarına ve
#    perform_at_higher_level: "daha yüksek bir başarı seviyesinde performans göster"
