module.exports = nativeDescription: "русский", englishDescription: "Russian", translation:
  ...
  new_home:
    ...
    meta_keywords: "CodeCombat, Python, JavaScript, Игры для программирования"
    meta_description: "LИзучай написанный код в игре о программировании. Изучай Python, JavaScript, и HTML когда решаешь задачи и учись делать свои собственные игры для изучения программирования и сайты."
    meta_og_url: "https://codecombat.com"
    built_for_teachers_title: "Кодовая игра, созданная с учителями в уме"
    ...
    century_skills_quote4: "Я всегда стремился создавать видеоигры и учиться кодировать ... это дает мне отличную отправную точку."
    ...
    for_teachers_subblurb2: Просмотр данных по успеваемости студентов, выявлять ресурсы программы, и доступ в режиме реального времени поддержку обучения студентов."
    for_teachers_subtitle3: "Встроенные оценки"
    for_teachers_subblurb3: "Индивидуализировать обучение и обеспечить студентам понять основные понятия с формативного и суммативного оценивания."
    for_teachers_subtitle4: "Автоматическое Дифференцирование "
    for_teachers_subblurb4: "Вовлечь всех учащихся в различных классах с уровнями обучения, которые адаптируются к потребностям обучения каждого студента."
    game_based_blurb: "CodeCombat-игра-на основе программы информатики, где студенты типа Real код и увидеть своих персонажей реагировать в режиме реального времени."
    get_started: "Начать"
    global_title: "Присоединяйтесь к нашему глобальному сообществу учащихся и педагогов"
  ...
  nav:
    ...
    parent: "Родителям"
    browser_recommendation: "Для лучшего опыта мы рекомендуем использовать последнюю версию Chrome. Скачать браузер можно здесь!"
  ...
  play:
    title: "Уровни CodeCombat играть - изучать Python, JavaScript и HTML"
    meta_description: "Научиться программированию с игрой программирования для начинающих. Изучать Python или JavaScript, как вы решите лабиринты, сделать свои собственные игры, и уровень вверх. Бросьте вызов своим друзьям в уровнях многопользовательской боевой арене!"
    level_title: "__уровень__ - Научиться программировать на Python, JavaScript и HTML-код"
    video_title: "__видео__ |Видео уровень"
    game_development_title: "__уровень__ | Разработка игр"
    web_development_title: "__уровень__ | Пазработка сайтов"
    anon_signup_title_1: "CodeCombat имеет"
    anon_signup_title_2: "Версия для класса!"
    anon_signup_enter_code: "Введите код класса:"
    anon_signup_ask_teacher: "У вас его нет? Спросите его у учителя!"
    anon_signup_create_class: "Хотите создать класс?"
    anon_signup_setup_class: "Создайте класс, добавьте своих учеников и следите за прогрессом!"
    anon_signup_creat_teacher: "Создать бесплатный аккаунт для учителя"
  ...
  play_level:
    ...
    learn_new_concepts: "Изучите новые концепты"
    watch_a_video: "Смотреть видео на __концепт_имя__"
    concept_unlocked: "Концепт разблокирован"
    use_at_least_one_concept: "Используйте как минимум 1 концепт: "
    command_bank: "Коммандный банк"
    learning_goals: "Цели обучения"
    start: "Старт"
    vega_character: "Вега персонаж"
  ...
  choose_hero:
    ...
    cpp_blurb: "(Только для подписчиков) Разработка игр и высокопроизводительные вычисления."
    status: "Статус"
    weapons: "Оружие"
  ...
  about:
    title: "О CodeCombat - привлечение студентов, расширение возможностей преподавателей, вдохновляющее творчество"
    meta_description: "Наша миссия - выровнять информатику с помощью игрового обучения и сделать кодирование доступным для каждого учащегося. Мы верим, что программирование - это волшебство, и хотим, чтобы учащиеся имели возможность создавать вещи из чистого воображения."
    learn_more: "Узнать больше"
    ...
    sean_title: "Старший бухгалтер"
    liz_title: "Старший бухгалтер"
    jane_title: "Делопроизводитель"
    shan_title: "Руководитель отдела маркетинга, CodeCombat Большой Китай"
    run_title: "Руководитель операций, CodeCombat Большой Китай"
    lance_title: "Руководитель отдела технологий, CodeCombat, Большой Китай"
    zhiran_title: "Глава учебного плана, CodeCombat Большой Китай"
    yuqiang_title: "Руководитель отдела инноваций, CodeCombat Большой Китай"
    matias_title: "Старший инженер-программист"
    ryan_title: "Специалист службы поддержки"
    maya_title: "Старший разработчик учебных программ"
    bill_title: "Генеральный директор, CodeCombat Большой Китай"
    shasha_title: "Продукт и визуальный дизайнер"
    daniela_title: "Менеджер по маркетингу"
    chelsea_title: "Операционный менеджер"
  ...
  courses:
    ...
    remove_description1: "Студент потеряет доступ к этому классу и назначенным классам. Прогресс и игровой процесс НЕ теряются, и ученик может быть добавлен обратно в класс в любое время."
    remove_description2: "Активированную оплаченную лицензию нельзя вернуть."
    license_will_revoke: "Оплаченная лицензия этого студента будет аннулирована и предоставлена для назначения другому студенту."
    ...
    estimated_class_dates_label: "Предполагаемые даты занятий"
    estimated_class_frequency_label: "Расчетная частота класса"
    classes_per_week: "Уроков в неделю"
    minutes_per_class: "Минут в урок"
    create_class: "Создать класс"
    class_name: "Название класса"
    teacher_account_restricted: "Ваша учетная запись является учетной записью учителя и не может получить доступ к содержимому ученика."
    ...
    update_account_update_teacher: "Обновление для учителя"
    ...
    update_account_students_warning: "Предупреждение. Вы не сможете управлять ранее созданными классами или создавать новые классы."
    unsubscribe_warning: "Предупреждение: вы будете отписаны от вашей ежемесячной подписки."
    update_account_remain_student: "Остаться учеником"
    update_account_update_student: "Обновление для студентов"
    ...
    update_account_confirm_update_student: "Вы уверены, что хотите обновить свой аккаунт до уровня «Студент»?"
    update_account_confirm_update_student2: "Вы не сможете управлять ранее созданными классами или создавать новые классы. Ваши ранее созданные классы будут удалены из CodeCombat и не могут быть восстановлены."
    ...
    by_joining_1: "Присоединяясь"
    by_joining_2: "сможет помочь сбросить пароль, если вы забудете или потеряете его. Вы также можете подтвердить свой адрес электронной почты, чтобы вы могли сбросить пароль самостоятельно!"
    ...
    web_dev_language_transition: "Все классы программы на HTML / JavaScript для этого курса. Классы, которые использовали Python, начнут с дополнительных вступительных уровней JavaScript, чтобы облегчить переход. Классы, которые уже используют JavaScript, пропустят вступительные уровни."
    ...
    update_old_classroom_detail: "Чтобы убедиться, что вы получаете самые современные уровни, убедитесь, что вы создали новый класс для этого семестра, нажав кнопку Создать новый класс на своем"
    teacher_dashboard: "приборная панель учиетля"
    update_old_classroom_detail_2: "и давая студентам новый код класса, который появляется."
    view_assessments: "Посмотреть оценки"
    view_challenges: "просматривать уровни вызовов"
    ...
    start_challenge: "Начать испытание"
    locked: "Заблокировано"
    concepts_used: "Применённые концепты:"
    show_change_log: "Показать изменения в уровнях этого курса"
    hide_change_log: "Спрятать изменения в уровнях этого курса"
    concept_videos: "Концептуальные видео"
    concept: "Крнцепт:"
    basic_syntax: "Базовый синтакс"
    while_loops: "Пока петли"
    variables: "Переменные"
    basic_syntax_desc: "Синтаксис - это то, как мы пишем код. Так же как правописание и грамматика важны при написании повествований и очерков, так и синтаксис важны при написании кода. Люди хорошо понимают, что что-то значит, даже если это не совсем правильно, но компьютеры не настолько умны, и им нужно, чтобы вы писали очень точно."
    while_loops_desc: "Цикл - это способ повторения действий в программе. Вы можете использовать их, чтобы вам не приходилось писать повторяющийся код, а также когда вы точно не знаете, сколько раз потребуется выполнить действие для выполнения задачи."
...
#    more_info: "More info"
  ...
  ladder:
    ...
    arena_title: "__арена__ | Многопользовательские арены"
  ...
  account:
    ...
    payments_title: "Оплата"
    subscription_title: "Подписка"
    invoices_title: "Счет"
    prepaids_title: "Предоплата"
    payments: "Платежи"
...
#    teacher_school_3: "Ruby Bridges Elementary"
    teacher_location_3: "Аламида, Калифорния"
    spotlight_3: "Сьюзен Джонс-Сабо способствует равноправной атмосфере в классе, где каждый может найти успех по-своему. Ошибки и борьба приветствуются, потому что каждый учится на вызов, даже учитель."
    continue_reading_blog: "Продолжить чтение на блоге..."
...
#    teacher_email: "Teacher's email address"
  ...
  school_administrator:
    title: "Прборная панель школьного администратора"
    my_teachers: "Мои учителя"
    last_login: "Прошлый логин"
    licenses_used: "Лицензия использована"
    total_students: "Всего студентов"
    active_students: "Активные студенты"
    projects_created: "созданные проекты"
    other: "Прочее"
...
#    no_teachers: "You are not administrating any teachers."
  ...
  interactives:
    phenomenal_job: "Прекрасная работа!"
    try_again: "Упс, попробуй снова!"
    select_statement_left: "Упс, выберите утверждение слева, прежде чем нажать \\ 'Отправить. \\'"
    fill_boxes: "Упс, убедитесь, что заполнили все поля перед нажатием \\ 'Отправить. \\'"

  browser_recommendation:
    title: "CodeCombat работает лучше в Chrome!"
    pitch_body: "Для лучшего опыта от CodeCombat мы рекомендуем использовать последнюю версию Chrome. Скачать последнюю версию Chrome можно нажав по кнопке ниже!"
