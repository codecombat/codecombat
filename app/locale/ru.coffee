...
#    forgot_learning: "I think they actually forgot that they were actually learning something."
   wanted_to_do: "Кодинг- это то, чем я всегда хотел заниматься, но никогда не думал, что у меня будет возможность учить его в школе"
   why_games: "Почему обучение с помощью игр так важно??"
...
#    not_tedious: "not tedious."
   gaming_is_good: "Научные исследования показывают, что игры хороши для умственного развития детей(это правда!)"
...
#    get_started_subtitle: "Set up a class, add your students, and monitor their progress as they learn computer science."
    ...
    coming_soon: "Скоро!"
    courses_available_in: "Курсы доступны на JavaScript, Python, и Java (скоро выходит!)"
...
#    tip_programming_not_about_computers: "Computer Science is no more about computers than astronomy is about telescopes. - Edsger Dijkstra"
   tip_mulan: "Верь в себя и тогда всё получится - Мулан"
...
#    java_blurb: "(Subscriber Only) Android and enterprise."
    ...
    attack: "Урон"  "Так же может переводиться как: атаковать. "
    health: "Жизнь"
    speed: "Скорость"
...
#    please_explain: "(please explain)"
   ...
   college_plus: "Колледж или выше"
   anything_else: "Что-нибудь ещё, что мы должны знать?"
...
#    avg_student_exp_desc: "This will help us understand how to pace courses better."
    avg_student_exp_select: "Выберите наилучшую опцию"
