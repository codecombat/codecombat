...
#    future_eng_5: "program which creates learning and work opportunities for all K-12 students in the United States who wish to pursue computer science."
  ...
  subscribe:
    ...
    you_will_be_charged: "К оплате: $__priceString__"
    choose_payment_method: "Выберите способ оплаты"
    pay_with_credit_card_or_bitcoin: "Заплатить с помощью: Банковская карта / Bitcoin"
    paypal_payment_error: "Мы столкнулись с ошибкой при оплате PayPal."
...
#    removing_course: "Removing course"
    ...
    changed: "Изменено"
    available_credits: "Доступные лицензии"Да. Перейдите на вкладку «Статус лицензии» в своем классе и нажмите «Применить лицензию» на любого учащегося, у которого нет активной лицензии.
    ...
    project: "Проект"Загрузите руководство по началу работы с учителем, чтобы настроить свою учетную запись, создать свой первый класс и пригласить студентов на первый курс.
