...
#    top_banner_blurb: "New: join our mission!"
  ...
  play:
    ...
    meta_description: "Учи программирование с помощью обучающей игры для начинающих.
    Учи Python или JavaScript пока решаешь лабиринты, делаешь свои игры и прокачиваешься.
    Брось вызов своим друзьям в многопользовательских аренах."
