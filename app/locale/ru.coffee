...
#    game_based_blurb: "CodeCombat is a game-based computer science program where students type real code and see their characters react in real time."
    ...
    top_banner_blurb: "Родители, запишитесь на первый онлайн-курс программирования для вашего ребенка бесплатно!"
...
#    our_coding_programs: "Our Coding Programs"
    ...
    ozaria: "Ozaria"
    codecombat_blurb: "Наша оригинальная игра по кодированию. Рекомендуется для родителей, взрослых, преподавателей и студентов, которые хотят испытать одну из самых занимательных игр по программированию в мире."
    ozaria_blurb: "Приключенческая игра и курс по информатике, в которой учащиеся осваивают утерянную магию программирования, чтобы спасти свой мир. Рекомендуется для преподавателей и студентов."
    try_codecombat: "Попробуй CodeCombat"
...
#    vega_character: "Vega Character"
  ...
  live_class:
    title: "Спасибо!"
    content: "Великолепно! Мы только что запустили класс online."
...
#    join_paragraph: "Join the largest international Python AI coding tournament for all ages and compete for the top of the leaderboard! This month-long global battle starts August 1st and includes $5k worth of prizes and a virtual awards ceremony where we'll announce winners and recognize your coding skills."
    link: "Зарегистрируйтесь и узнайте больше!"
    global_tournament: "Глобальный Турнир"
    register: "Зарегистрироваться"
    date: "Август 1 - Август 31"
...
#    stripe_yearly_description: "Annual Subscription"
  ...
  about:
    title: "О CodeCombat - привлечение студентов, расширение возможностей учителей, вдохновляющее творчество"
...
#    license_will_revoke: "This student's paid license will be revoked and made available to assign to another student."
    ...
    estimated_class_dates_label: "Ожидаемые даты уроков"
    estimated_class_frequency_label: "Ожидаемая частота уроков"
    classes_per_week: "уроков в неделю"
    minutes_per_class: "минут за урок" # need reprase - нужно перефразировать - в оригинале "minutes per class"
    create_class: "Создать класс"
    class_name: "Название класса"
    teacher_account_restricted: "Ваша учетная запись является учетной записью учителя и не имеет доступа к материалам учащихся." # Your account is a teacher account and cannot access student content.
...
#    update_account_teachers_can2: "Assign/enroll students in courses"
    ...
    update_account_update_teacher: "Стать учителем"
    ...
    update_account_update_student: "Стать учеником"
    ...
    update_account_confirm_update_student: "Вы уверены, что хотите обновить свою учетную запись до Ученического аккаунта?"
...
#    by_joining_2: "will be able to help reset your password if you forget or lose it. You can also verify your email address so that you can reset the password yourself!"
    ...
    current_hero_female: "Текщая героиня:"
...
#    update_old_classroom_detail: "To make sure you're getting the most up-to-date levels, make sure you create a new class for this semester by clicking Create a New Class on your"
    teacher_dashboard: "доска учителя"
...
#    ranking_position: "Position"
    ...
    ranking_completed_leves: "Пройденные уровни"
    challenge: "Испытание:"
...
#    continue_reading_blog: "Continue Reading on Blog..."
  ...
  loading_error:
    ...
    too_many_login_failures: "Слишком много неудачных попыток входа в систему. Пожалуйста, попробуйте позже."
