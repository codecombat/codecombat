...
#    remove_description1: "Student will lose access to this classroom and assigned classes. Progress and gameplay is NOT lost, and the student can be added back to the classroom at any time."
    ...
    avg_student_exp_intermediate: "Средний уровень - некоторый опыт программирования типизированного кода"
    avg_student_exp_advanced: "Продвинутый - обширный опыт программирования типизированного кода"
