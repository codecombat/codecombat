...
#  teacher:
#    assigning_course: "Назначение курса"
#    course_solution: "Разрешение на курс"
#    level_overview_solutions: "Обзор уровня и решения"
#    no_student_assigned: "Ни один студент не назначен на этот курс."
#    paren_new: "(new)"
#    teacher_dashboard: "Панель учителя" # Navbar
#    my_classes: "Мои классы"
#    courses: "Руководство по курсу"
#    enrollments: "Лицензия студента"
#    resources: "Ресурсы"
#    help: "Помощь"
#    language: "Язык"
#    edit_class_settings: "Изменить настройки класса"
#    access_restricted: "Требуется обновление учётной записи"
...
#    what_is_a_teacher_account: "Что такая учётная запись Учитель?"
#    teacher_account_explanation: "Учётная запись Учителя CodeCombat позволяет вам создавать классы,следить за прогрессом студентов, поскольку они работают по курсам,управлять лицензиями студентов и доступом к ресурсам для оказания помощи в вашем учебном плане."
