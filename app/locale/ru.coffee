module.exports = nativeDescription: "русский", englishDescription: "Russian", translation:
  new_home:
    ...
    builds_concepts_up: "Мне нравиться, как CodeCombat преподносит концепции программирования. Эти концпеции легки для понимания, и при этом являются развлекательными"
  ...
  nav:
    ...
    apcsp: "Принципы продвинутой информатики"
  ...
  play:
    ...
    get_course_for_class: "Предоставьте доступ к разработке игр и другому своим классам!"
    request_licenses: "Свяжитесь с нашими школьными специалистами для уточнения деталей"
...
#    track_concepts4b: "See your members'"
  ...
  courses:
    ...
    solutions_require_licenses: "Решения уровней доступны для учителей, имеющих лицензию."
...
#    by_joining_2: "will be able to help reset your password if you forget or lose it. You can also verify your email address so that you can reset the password yourself!"
    ...
    current_hero_female: "Текущая героиня:"
...
#    concept_checked: "Concept checked:"
    ...
    view_student_code: "Нажмите, чтобы увидеть код ученика"
...
#    more_info: "More info"
  ...
  sharing:
    ...
    victory_share_prefix: "Поделитесь этой ссылкой, чтобы пригласить своих друзей и семью"
    victory_share_prefix_short: "Пригласить людей"
    victory_share_game: "играть в твои собственные уровни"
    victory_share_web: "просмотр твоей веб-страницы"
    victory_share_suffix: "."
    victory_course_share_prefix: "Эта ссылка позволит вашим друзьям и семье"
    victory_course_share_game: "сыграть в игру"
    victory_course_share_web: "просмотреть веб-страницу"
    victory_course_share_suffix: "которую ты только что создал."
...
#    certificate_for: "For"
  ...
  account:
    ...
    purchased: "Куплено"
    subscribe_for_gems: "Подпишитесь для получения самоцветов"
    ...
    unsubscribe_from_marketing: "Отписатся ото всех маркетинговых сообщениях CodeCombat на ваш электронный адрес __email__ ?"
    unsubscribe_button: "Да, отписаться"
...
#    missing_semicolon: "Missing semicolon."’
    missing_quotes: "Пропущены ковычки. Попробуй `$1`"
