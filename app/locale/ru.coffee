module.exports = nativeDescription: "русский", englishDescription: "Russian", translation:
  new_home:
    ...
    encourage: "Игровой процесс побуждает к взаимодействию, исследованию методом проб. В увлекательной игре человек легче и быстрее формирует свои навыки."
    excel: "Игры особенно хороши своим соревновательным элементом."
    gaming_is_good: "Исследования показывают, что игры необходимы и полезны для развития детского ума!"
    game_based: "Когда игровые системы обучения"
    compared: "сравниваются"
    conventional: "с традиционными оценочными методиками, то разница очевидна: игры помогают ученикам быстрее и легче получать знания, концентрироваться и"
    perform_at_higher_level: "достигать высоких результатов."
    feedback: "Игры предоставляют мгновенную обратную связь, что позволяет ученикам более гибко искать решения и целостно понимать идеи. Вместо того, чтобы быть ограниченными ответами “правильно” и “неправильно”."
    real_game: "Настоящая игра, которую проходишь с помощью настоящего программирования."
    great_game: "Отличная игра - это больше, чем бейджики и достижения. Это приключение для игрока, качественно продуманные головоломки и возможность преодолевать проблемы с уверенностью в своей победе."
    agency: "CodeCombat - это игра, поддерживающая у игроков уверенность в своих силах, что помогает как начинающим, так и опытным ученикам писать надёжные, качественные программы."
    request_demo_title: "Занимайтесь с вашими учениками уже сегодня!"
    request_demo_subtitle: "Запросите демо-версию и сразу начинайте обучение."
    get_started_title: "Создайте ваш класс уже сегодня"
    get_started_subtitle: "Добавьте учеников и наблюдайте за их прогрессом в обучении информатики."
...
#    sign_in_to_continue: "Sign in or create an account to continue"
    ...
    hey_students: "Введите код класса, полученный от учителя."
...
#    eu_confirmation_individual: "If you do not want us to store your data on US servers, you can always keep playing anonymously without saving your code."
  ...
  general:
    ...
    version_history_for: "История изменений для: "
...
#    loading_start_concept: "Start Concept Challenge"
    ...
    infinite_loop_title: "Обнаружен бесконечный повтор"
    infinite_loop_description: "Код сотворения мира не завершил выполнение. Это могло случиться из-за очень медленного кода или наличия бесконечного повтора. Или там может быть баг. Вы можете попробовать повторно запустить этот код или сбросить его в состояние по умолчанию. Если проблема не будет решена, дайте нам знать."
