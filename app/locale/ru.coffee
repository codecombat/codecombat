...
#    oreilly: "ebook of your choice"
  ...
  account_profile:
    ...
    basics_country_help: "Страна, в которой вы бы хотели работать (или живете сейчас)."
    basics_visa: "Статус работы в США"
    basics_visa_help: "Можете ли вы находиться и работать в США, или вам нужна помощь с визой? (Если вы живете в Канаде или в Австралии, пишите, что можете.)"
    basics_looking_for: "Ищет работу с..."
...
#    basics_looking_for_help: "What kind of developer position do you want?"
    name_header: "Введите ваше имя"
    name_anonymous: "Разработчк-аноним"
    name_help: "Имя, которое увидят работодатели, например, 'Nick Winter'."
...
#    player_code: "Player Code"
  ...
  employers:
    deprecation_warning_title: "Простите, CodeCombat сейчас не набирает работников."
    deprecation_warning: "Мы концентрируем наше внимание на начальных уровнях, а не ищем разработчиков-экспертов на данный момент."
#    hire_developers_not_credentials: "Нанимайте разработчиков, а не анкеты." # We are not actively recruiting right now, so there's no need to add new translations for the rest of this section.
    get_started: "Начнем"
#    already_screened: "We've already technically screened all our candidates"
#    filter_further: ", but you can also filter further:"
    filter_visa: "Visa"
    filter_visa_yes: "Может работать в Америке"
    filter_visa_no: "Не может работать в Америке"
...
#    av_espionage: "Espionage" # Really not important to translate /admin controls.
    av_espionage_placeholder: "Электронная почта или никнейм"
