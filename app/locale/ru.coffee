module.exports = nativeDescription: "русский", englishDescription: "Russian", translation:
  ...
  new_home:
    title: "Ozaria - это увлекательная Информатика."
    meta_keywords: "CodeCombat, python, javascript, Приключение, Информатика, Обучающая игра, Эпичная игра, программирование для детей"
    meta_description: "Ozaria - это курс информатики, приключенческая игра и сказочная история, в которой ученики овладеют потерянной магией программирования, чтобы спасти сказочный мир"
    become_investor: "стать инвестором в CodeCombat"
    built_for_teachers_title: "Обучающая программированию игра сделаная для учителей."
    ...
    built_for_teachers_subblurb1: "Начиная с нашего бесплатного Введения в Информатику, ученики освоят базовые концепты, такие как while/for циклы, функции и алгоритмы."
    built_for_teachers_subtitle2: "Разработка игр"
    built_for_teachers_subblurb2: "Ученики строят свои лабиринты и используют базовую обработку ввода, чтобы создавать их собственные игры, которыми они смогут поделится с семьей и друзьями."
    built_for_teachers_subtitle3: "Веб разработка"
    built_for_teachers_subblurb3: "Используя HTML, CSS, и jQuery, ученики смогут дать волю воображению и создать собственные веб страницы с уникальным URL, чтобы поделиться с друзьями"
    ...
    classroom_in_box_title: "Мы хотим:"
    classroom_in_box_blurb1: "Вовлечь каждого ученика, чтобы он поверил, что программирование доступно каждому."
    classroom_in_box_blurb2: "Дать возможность любому преподавателю чувствовать себя уверенно при обучении программированию."
    classroom_in_box_blurb3: "Вдохновите всех школьных руководителей создать программу программирования мирового класса."
    click_here: "Кликните сюда"
    creativity_rigor_title: "Где творчество встречается со строгостью"
    creativity_rigor_subtitle1: "Сделайте программирование веселым и обучайтесь реальным навыкам"
    creativity_rigor_blurb1: "Ученики исполъзуют Python и JavaScript, играя в игры, которые поощряют метод проб и ошибок, критическое мышление и творческий подход. Затем стуученикиденты применяют приобретенные навыки программирования, разрабатывая свои собственные игры и веб-сайты на курсах, основанных на проектах."
    creativity_rigor_subtitle2: "Подберите уровень для учеников"
    creativity_rigor_blurb2: "Каждый уровень CodeCombat создается на основе миллионов данных и оптимизируется для адаптации к каждому учащемуся. Уровни практики и советы помогают учащимся, когда они застряли, и уровни сложности оценивают обучение студентов на протяжении всей игры."
    ...
    featured_partners_blurb5: "Официальный челн CSforAll"
    featured_partners_blurb6: "Партнер Hour of Code"
    for_leaders_title: "Для руководителей школ"
    for_leaders_blurb: "Комплексная стандартизированная программа по Информатике"
    ...
    for_leaders_subtitle2: "Полный учебный план"
    ...
    for_leaders_subblurb3: "Независимо от того, хотите ли вы создать факультатив по программированию в средней школе, курс CTE или класс AP Computer Science Principles, CodeCombat разработан с учетом ваших потребностей."
    for_leaders_subtitle4: "Навыки реального мира"
    for_leaders_subblurb4: "Ученики выстраивают навыки и систему мышления с помощью задач по программированию, которые готовят их к работе на 500K+ открытых позициях."
    ...
    for_teachers_subtitle2: "Панель управления для учителя"
    for_teachers_subblurb2: "ледите за прогрессом учеников, просматривайте учебнуе материалы и получите доступ к поддержке в реальном времени, чтобы улучшить учебный процесс."
    for_teachers_subtitle3: "Встроенные системы оценки"
    for_teachers_subblurb3: "Персонализируйте подход и убедитесь что ученики понимают ключевые концепты с помощью оценок для уроков и модулей."
    for_teachers_subtitle4: "Автоматическая дифференциация"
    for_teachers_subblurb4: "Мотивируйте учеников в разнообразных классах с уровнями, которые можно адаптировать для разных задач."
    game_based_blurb: "CodeCombat - это игровая программа по информатике, где ученики используют настоящий код и видят как персонажи реагируют на него."
    get_started: "Начать"
    global_title: "Присоединяйтесь к нашему глобальному сообществу учеников и учителей"
    global_subtitle1: "Учащихся"
    global_subtitle2: "Строк кода"
    global_subtitle3: "Учителей"
    global_subtitle4: "Стран"
    go_to_my_classes: "Перейти в мои классы"
    go_to_my_courses: "Перейти к моим курсам"
    ...
    teach_cs1_free: "Обучать Введению в Информатику бесплатно"
...
#    teacher: "Teacher"
  ...
  play:
    title: "Играть уровни CodeCombat - Учи Python, JavaScript и HTML"
    meta_description: "Учи программирование с помощью обучающей игры для начинающих. Учи Python или JavaScript пока решаешь лабиринты, делаешь свои игры и прокачиваешься. Брось вызов своим друзьям в многопользовательских аренах."
    level_title: "__level__ - Учись программировать на Python, JavaScript, HTML"
    ...
    anon_signup_title_1: "У CodeCombat есть "
    anon_signup_title_2: "Версия для классов!"
    anon_signup_enter_code: "Введите код класса:"
    anon_signup_ask_teacher: "Не знаете код? Спросите учителя!"
    anon_signup_create_class: "Хотите создать класс?"
    anon_signup_setup_class: "Настройте класс, добавьте учеников и отслеживайте прогресс!"
    anon_signup_create_teacher: "Создайте бесплатный учительский аккаунт"
...
#    teacher_vega_message: "Students are guided by these tutorial messages. In order to view these messages and to save your progress as you play through the game, please create a student account and play Ozaria as a student."
  ...
  login:
    ...
    email_or_username: "E-mail или имя пользователя" # {change}
    or: "или"
    log_in: "Войти"
    sign_in: "Войти"
    logging_in: "Входим..."
    ...
    sign_in_with_facebook: "Войти через Facebook" # {change}
    sign_in_with_gplus: "Войти через G+" # {change}
    ...
    accounts_merge_confirmation: "Существует аккаунт связанный с e-mail с данного Google аккаунта. Хотите их обьединить?"
  ...
  signup:
    ...
    signup_as_teacher: "Зарегистрироваться как Учитель" # {change}
    ...
    signup_as_student: "Зарегистрироваться как Ученик" # {change}
    ...
    write_this_down: "Запишите это:" # {change}
    ...
    teacher_students_can_start_now: "Ваши ученики могут пройти свой первый курс обучения, Введение в информатику, прямо сейчас." # {change}
    ...
    teacher_list_resource_hub_2: "Руководство по курсу" # {change}
...
#    invalid_password: "Invalid password"
  ...
  common:
    default_title: "Ozaria - Увлекательная Информатика"
    ozaria: "Ozaria"
    default_meta_description: "Ozaria - это курс информатики, приключенческая игра и сказочная история, в которой ученики овладеют потерянной магией программирования, чтобы спасти сказочный мир"
...
#    locked: "Locked"
  ...
  play_level:
    ...
    restart_really: "Вы уверены что хотите сбросить уровень? Все изменения в коде будут потеряны."
    ...
    tome_cast_button_update: "Обновить"
    ...
    learn_new_concepts: "Изучать новую тему"
    watch_a_video: "Смотреть видео на тему __concept_name__"
    concept_unlocked: "Тема разблокирована"
    use_at_least_one_concept: "Используйте хотя бы одну тему: "
    command_bank: "Справочник"
    learning_goals: "Учебные цели"
    start: "Начать"
    vega_character: "Персонаж Vega"
  ...
  avatar_selection:
    pick_an_avatar: "Выберите аватар, который будет представлять вас в игре."
  ...
  options:
    ...
    editor_config_title: "Настройки редактора" # {change}
    editor_config_livecompletion_label: "Автозаполнение" # {change}
    ...
    editor_config_behaviors_label: "Умное поведение" # {change}
    editor_config_behaviors_description: "Автозавершение кавычек, квадратных и фигурных скобок."

  about:
    title: "О CodeCombat - Вдохновляем учеников, Помогаем Учителям, Поощряем творчество."
    meta_description: "Наша задача повысить уровень компьютерной граммотности с помощью игрового обучения и сделать обучение программированию доступным любому учащемуся. Мы верим что программирование это магия и хотим чтобы ученики получили возможность создавать новое с помощью воображения."
    learn_more: "Узнать больше"
    ...
    mission_title: "Наша задача: сделать программирование доступным для каждого учащегося на Земле." # {change}
    mission_teach: "Обучайте через приключение"
    mission_desc_1: "В современном мире, дети перенасыщены развлечениями, которые ростут с каждым годом. Каждое приложение, каждое видео, каждая игра, каждая реклама сделана чтобы завладеть и удерживать ваше внимание. Чтобы конкурировать в таком окружении, образование должно найти способ удерживать внимание учеников и давать волю их воображению."
    mission_desc_2: "Мы верим что обучение информатике может быть увлекательным. Оно должно ощущаться как волшебство. В конце концов, программирование помогает творить новые идей, делать что то новое силой воображения и взаимодействовать новыми способами. Наша цель поддержать связь между творчеством и воображением так свойственным информатике, делая обучающие игры построенные на творчестве и воображении."
    mission_desc_3: "За последние 5 лет более 20 миллионов человек обучались программировать на Python и Javascript с помощью CodeCombat, тем самым превратив ее в одну из самых популярных игр по обучению программированию в истории. Теперь мы с гордостью запускаем Ozaria и расширяем наш охват по вдохновлению нового поколения учеников к программированию. Ozaria - это приключенческая игра, которая помещает каждого учащегося в круговорот легендарной истории где они спасут сказочный мир  от надвигающейся тьмы при помощи утерянной магии программирования. По мере того как сюжет раскрывается, ученики будут в центре истории параллельно обучаясь. Каждый вклад ученика в историю Озарии будет их вкладом в их обучение."
    team_title: "Присоединяйтесь к команде CodeCombat"
    team_values: "Мы ценим открытый и вежливый диалог, где побеждают лучшие идеи. Наши решения основаны на исследовании пожеланий клиентов, а наш процесс направлен на то, чтобы приносить осязаемые результаты. У нас все при деле, от CEO до контрибьютеров на GitHub, потому что мы ценим рост и обучение в своей команде." # {change}
    nick_title: "Сооснователь, CEO"
    matt_title: "Сооснователь, CTO"
    lawrence_title: "Менеджер по работе с клиентами"
    shan_title: "Директор по маркетингу, CodeCombat Китай"
    run_title: "Операционный директор, CodeCombat Китай"
    lance_title: "Тех директор, CodeCombat Китай"
    zhiran_title: "Директор по обучению, CodeCombat Китай"
    yuqiang_title: "Директор по инновациям, CodeCombat Китай"
    matias_title: "Старший инженер программист"
    ryan_title: "Специалист по работе с клиентами"
    maya_title: "Старший Методист"
    bill_title: "Директор филиала, CodeCombat Китай"
    shasha_title: "Продакт дизайнер"
    daniela_title: "Менеджер по маркетингу"
    bobby_title: "Игровой дизайнер"
    brian_title: "Старшйи менеджер по игровому дизайну"
    stephanie_title: "Специалист поддержки клиентов"
    ...
    story_statistic_1c: "начали путешествие в мир программирования с помощью CodeCombat" # {change}
    ...
    jobs_title: "Сотрудничайте с нами и помогайте писать историю CodeCombat!" # {change}
...
#    actionable_insights_desc: "Empower educators with intuitive student progress and assessment data that makes differentiating instruction possible."
  ...
  teachers_quote:
    ...
    referrer_default: "Выберите из"
    referrer_conference: "Конференция"
    referrer_hoc: "Code.org/Hour of Code"
    referrer_teacher: "От учителя"
    referrer_admin: "От руководителя"
    referrer_student: "От учеников"
    ...
    thanks_sub_header: "Спасибо, что проявили интерес к CodeCombat для вашей школы." # {change}
    ...
    not: "Нет"
    full_name_required: "Необходимо имя и фамилия"
...
#    instructional_tooltip: "Click these arrow buttons to go backwards and forwards. You can also use the arrow keys on your keyboard to do the same."
  ...
  clans:
    title: "Присоединяйтесь к кланам CodeCombat - Учите Python, JavaScript, и HTML"
    clan_title: "__clan__ - Присоединяйтесь к кланам CodeCombat и учитесь программированию."
    meta_description: "Присоеденитесь к клану или постройте свое сообщество. Играйте многопользовательское уровни и прокачивайте сцой уровень вместе с навыками программирования"
    clan: "Клан"
    clans: "Кланы"
  ...
  courses:
    ...
    hoc_blurb1: "Попробовать"
    hoc_blurb2: "Пиши, Играй, Делись"
    hoc_blurb3: "активность! Построй 4 разные мини-игры чтобы научится основам игровой разработки, а затем сделай свою игру"
    ...
    back_classroom: "Вернуться к классу" # {change}
    back_courses: "Назад к моим курсам" # {change}
    ...
    welcome_to_page: "Моя панель ученика" # {change}
    my_classes: "Мои классы"
    class_added: "Класс успешно добавлен!"
    view_map: "перейти к карте"
    view_videos: "смотреть видео"
    view_project_gallery: "посмотреть проекты моих одноклассников"
    join_class: "Присоединиться к классу" # {change}
    join_class_2: "Присоединиться к классу"
    ask_teacher_for_code: "Спросите у вашего учителя код класса для CodeCombat! Введите его ниже:" # {change}
    enter_c_code: "Введите Код Класса" # {change}
    join: "Присоединиться"
...
#    license_will_revoke: "This student's paid license will be revoked and made available to assign to another student."
    ...
    subtitle: "Посмотреть описание и уровни курса" # {change}
...
#    web_dev_language_transition: "All classes program in HTML / JavaScript for this course.  Classes that have been using Python will start with extra JavaScript intro levels to ease the transition.  Classes that are already using JavaScript will skip the intro levels."
    ...
    license_required_to_play: "Попроси своего учителя назначить тебе лицензию для продолжения игры на CodeCombat!" # {change}
...
#    students_code_blurb: "A correct solution to each level is provided where appropriate. In some cases, it’s possible for a student to solve a level using different code. Solutions are not shown for levels the student has not started."
    ...
    my_classes: "Мои классы"
    courses: "Руководства курсов" # {change}
    ...
    create_teacher_account: "Создать аккаунт учителя" # {change}
...
#    view_student_code: "Click to view student code"
    select_course: "Выберите курс для просмотра" # {change}
    ...
    bulk_assign: "Выбор курса" # {change}
    ...
    assign_course: "Назначить курс" # {change}
    removed_course_msg: "{{numberRemoved}} учеников были исключены с курса {{courseName}}."
    remove_course: "Удалить курс" # {change}
    not_assigned_modal_title: "Курсы не были назначены" # {change}
    ...
    not_assigned_modal_full_body_1: "Этот курс требует Полную Лицензию. У Вас нет Полной Лицензии для назначения всех __selected__ выбранных учеников на курс." # {change}
    ...
    enrollments_blurb: "Ученики должны иметь лицензию для доступа ко всему контенту после первого курса." # {change}
    ...
    how_to_apply_licenses_blurb_1: "Когда учитель назначает ученика на курс впервые, мы автоматически выдадим лицензию. Используйте выпадающий список \"Назначение учеников\" в классной комнате, чтобы назначить на курс выбранных студентов:" # {change}
    how_to_apply_licenses_blurb_2: "Могу ли я применить лицензию без назначения на курс?" # {change}
    ...
    educator_faq_desc: "Часто задаваемые вопросы об использовании CodeCombat в Вашем классе или школе." # {change}
    teacher_getting_started: "Учительское руководство начинающего"
    teacher_getting_started_desc: "Вы новичок на CodeCombat? Загрузите учительское руководство начинающего, чтобы настроить свою учетную запись, создать свой первый класс и пригласить учеников на первый курс." # {change}
