...
#    sent_verification: "We've sent a verification email to:"
    ...
    account_settings: "Настройках акаунта"
...
#    lookup_code: "Lookup prepaid code"
    apply_account: "Применить к вашему акаунту"
...
#    redeemed: "Redeemed"
    ...
    you_can3: "который можно применить к вашему акаунту или передать другому."
  ...
  loading_error:
    ...
    login_required_desc: "Для доступа к этой странице нужно войти под своим акаунтом."
...
#    event_concurrency: "Event Concurrency"
    ...
    for_loops: "Циклы \"for\""
    for_loops_nested: "Вложенные петли \"for\""
    for_loops_range: "Диапазон петель \"for\""
    functions: "Функции"
#    game_ai: "Game AI"
...
#    input_handling_flags: "Input Handling - Flags"
    ...
    vectors: "Векторы"
    while_condition_loops: "Петли \"while\" c условиями"
    while_loops_simple: "Петли \"while\""
    while_loops_nested: "Вложенные петли \"while\""
