module.exports = nativeDescription: "русский", englishDescription: "Russian", translation:
  new_home:
    ...
    builds_concepts_up: "Мне нравиться, как CodeCombat преподносит концепции программирования. Эти концепции легки для понимания, и при этом являются развлекательными."
