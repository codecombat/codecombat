...
#    global_title: "Join Our Global Community of Learners and Educators"
  ...
  nav:
    ...
    parent: "Родителям"
    browser_recommendation: "Для лучшего и стабильного результат, рекомендуем использовать последнюю версию Google Chrome браузер. Перейдите по ссылке для скачивания!"
