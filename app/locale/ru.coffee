...
#    more_info: "More info"
  ...
  sharing:
    ...
    share_ladder_link: "Поделиться ссылкой для многопользовательской игры" # {change}
    ladder_link_title: "Поделитесь ссылкой На свой многопользовательский матч" # {change}
    ladder_link_blurb: "Поделитесь ссылкой на битву с искусственным интеллектом, чтобы ваши друзья и семья могли играть против вашего кода:" # {change}
...
#    continue_reading_blog: "Continue Reading on Blog..."
  ...
  loading_error:
    ...
    user_not_found: "Пользователь не найден" # {change}
    ...
    too_many_login_failures: "Слишком много неудачных попыток входа. Пожалуйста, попробуйте еще раз позже." # {change}
...
#    victory_sign_up: "Sign up & be entered to <strong>win $2,500</strong>"
  ...
  server_error:
    ...
    easy_password: "Пароль слишком легко угадать" # {change}
    reused_password: "Пароль не может быть использован повторно" # {change}
...
#    back_to_coco: "Back to CodeCombat"
  ...
  hoc_2018:
    ...
    page_heading_ai_league: "Ваши ученики научатся создавать свой собственный многопользовательский искусственный интеллект!" # {change}
