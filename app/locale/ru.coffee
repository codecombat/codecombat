module.exports = nativeDescription: "русский", englishDescription: "Russian", translation:
  ...
  play:
    ...
    awaiting_levels_adventurer_prefix: "Мы выпускаем по 5 уровней в неделю." # {change}
  ...
  subscribe:
    ...
    feature3: "50+ дополнительных уровней" # {change}
...
#    feature7: "Private <strong>Clans</strong>"
  ...
  teachers:
    ...
    cost_china: "Первые 5 уровней CodeCombat бесплатны в Китае. При оплате $9.99 в месяц вы получите доступ к последующим более чем 120 уровням на наших эксклюзивных серверах в Китае." # {change}
    free_1: "CodeCombat (его базовая часть) бесплатен! В наличии более 70 уровней, которые покрывают каждый концепт." # {change}
    ...
    sub_includes_2: "Более 50 уровней для дополнительной практики" # {change}
...
#    sub_includes_7: "Private Clans"
    ...
    material_china: "Около 22 часов игрового процесса, распределенного более чем на 120 уровней для подписчиков с добавлением 5 уровней каждую неделю." # {change}
    material_1: "Около 8 часов бесплатного контента и 14 часов дополнительного контента для подписчиков с добавлением 5 уровней каждую неделю." # {change}
