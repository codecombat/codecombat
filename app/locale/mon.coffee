...
#    authenticate_gplus: "G+ баталгаажуулах"
#    load_profile: "G+ дансаа уншуулах"
...
#    social_signup: "эсвэл фэйсбүүкээр юмуу G+-аар нэвтрэх арга бий:"
...
#    action_timeline: "Үйлдлийн цагалбар"
#    click_to_select: "Нэгж дээр хулганаар дарж сонго."
#    control_bar_multiplayer: "Олон тоглогчид"
#    control_bar_join_game: "Тоглоомд элсэх"
...
#    victory_rate_the_level: "Энэ үеийг үнэлэх: " # Only in old-style levels.
#    victory_return_to_ladder: "Шат руу буцах"
#    victory_play_continue: "Үргэлжлүүл"
...
#    guide_title: "Хөтөч"
#    tome_minion_spells: "Чиний туслахын шившлэгүүд " # Only in old-style levels.
#    tome_read_only_spells: "Уншиж л болдог шившлэгүүд" # Only in old-style levels.
#    tome_other_units: "Бусад нэгжүүд" # Only in old-style levels.
...
#    tome_reload_method: "Энэ аргад оригинал кодыг дахин ачаалах" # Title text for individual method reload button.
#    tome_select_method: "Аргаа сонгох"
#    tome_see_all_methods: "Өөрчилж болох бүх аргаа харах" # Title text for method list selector (shown when there are multiple programmable methods).
#    tome_select_a_thang: "Хэн нэгнийг үүнд зориулан сонгох: "
#    tome_available_spells: "Боломжтой шившлэгүүд"
#    tome_your_skills: "Чиний чадварууд"
#    tome_current_method: "Одоогийн аргууд"
#    hud_continue_short: "Үргэлжлүүлэх"
#    code_saved: "Хадгалсан код"
#    skip_tutorial: "Алгасах (esc)"
#    keyboard_shortcuts: "Гол шорткатууд"
#    loading_ready: "Бэлдээд!"
...
#    save_load_caption: "... бас түүхэн тэмдэглэлээ үзэх"
...
#  inventory:
#    choose_inventory: "Агуурсыг өмсгөх"
...
#    feature1: "4 ертөнц даяар 110+ үндсэн үе шат бий"
#    feature2: "10 хүчирхэг, өвөрмөц ур чадвартай <strong>шинэ баатрууд</strong>!"
#    feature3: "80+ бонус үе шат"
#    feature4: "<strong>3500 бонус үнэт чулууг</strong> сар бүр авна!"
#    feature5: "Видео хичээл"
#    feature6: "Төлбөртэй имэйлээр Premium email support"
#    feature7: "Хувийн <strong>омгууд</strong>"
#    free: "Үнэгүй"
#    month: "сар"
#    must_be_logged: "Та эхлээд нэвтрэх хэрэгтэй. Дээрх цэснээс нэвтэрнэ үү, эсвэл шинээр бүртгэл нээнэ үү."
#    subscribe_title: "Захиалах"
...
#    parent_button:   "Эцэг эхээсээ асуу"
#    parent_email_description:   "Тэднээр CodeCombat захиалгыг худалдаж авхуулахын тулд бид тэдэнд имэйл илгээх болно."
#    parent_email_input_invalid:   "Имэйл хаяг буруу байна."
#    parent_email_input_label:   "Эцэг эхийн имэйл хаяг"
#    parent_email_input_placeholder:   "Эцэг эхийн имэйл оруулна уу"
#    parent_email_send:   "И-мэйл илгээх"
#    parent_email_sent:   "Имэйл илгээсэн!"
#    parent_email_title:   "Таны эцэг эхийн имэйл юу вэ?"
#    parents:   "Эцэг эхчүүдэд зориулсан"
#    parents_title:   "Эрхэм хүндэт эцэг эх: Таны хүүхэд код бичиж сурч байна. Үргэлжлүүлэхэд нь туслах уу?"
#    parents_blurb1:   "Таны хүүхэд __nLevels__ түвшинд тоглож, програмчлалын үндсийг эзэмшсэн. Тэдний сонирхлыг хөгжүүлэхэд нь тусалж, захиалга худалдаж аваарай. Ингэснээр тэд үргэлжлүүлэн тоглодог."
#    parents_blurb1a:   "Компьютерийн програмчлал бол таны хүүхэд насанд хүрсэн хойноо ашиглах зайлшгүй шаардлагатай чадвар юм. 2020 он гэхэд програм хангамжийн анхан шатны мэдлэг чадвар нь ажлын байрны 77% -д шаардагдаж буй бөгөөд програм хангамжийн инженерүүд дэлхий даяар эрэлт ихтэй байна. Компьютерийн шинжлэх ухаан нь хамгийн өндөр цалинтай их сургуулийн диплом гэдгийг та мэдэх үү? "
#    parents_blurb2:   "Сар бүр 9.99 ам доллараар таны хүүхэд долоо хоног бүр шинэ сорилттой тулгарч, мэргэжлийн програмистуудаас хувийн имэйлийн дэмжлэг авах болно."
#    parents_blurb3:   "Эрсдэлгүй: 100% мөнгийг буцааж өгөх баталгаа, 1 товшилтоор захиалгаа цуцлах хялбар боломжтой."
#    payment_methods:   "Төлбөрийн арга"
#    payment_methods_title:   "Хүлээн зөвшөөрөгдсөн төлбөрийн арга"
#    payment_methods_blurb1:   "Бид одоогоор кредит карт болон Alipay-г хүлээн авч байна."
#    payment_methods_blurb2:   "Хэрэв танд өөр төлбөрийн хэлбэр шаардлагатай бол бидэнтэй холбоо барина уу"
#    sale_already_subscribed:   "Та аль хэдийн захиалсан байна!"
#    sale_blurb1:   "35% хэмнэх"
#    sale_blurb2:   "бүтэн жилийн турш тогтмол захиалгын үнэ $ 120-оос!"
#    sale_button:   "Хямдрал!"
#    sale_button_title:   "1 жилийн захиалга худалдаж авахдаа 35% хэмнээрэй"
#    sale_click_here:   "Энд дар"
#    sale_ends:   "Төгсгөл"
#    sale_extended:   "* Одоо байгаа захиалгын хугацааг 1 жилээр сунгана."
#    sale_feature_here:   "Эндээс таны авах зүйлс:"
#    sale_feature2:   "Өвөрмөц ур чадвартай 9 хүчирхэг <strong> шинэ баатар </strong>  сонгох боломжтой болох!"
#    sale_feature4:   "<strong> 42,000 үнэт чулуу </strong> -г нэн даруй шагнал болгон авна!"
#    sale_continue:   "Адал явдлаа үргэлжлүүлэхэд бэлэн үү?"
#    sale_limited_time:   "Хязгаарлагдмал хугацааны санал!"
#    sale_new_heroes:   "Шинэ баатрууд!"
#    sale_title:   "Есөн сарын нэгний хямдрал"
#    sale_view_button:   "1 жилийн захиалга худалдаж авах"
...
#    managed_subs_desc:   "Бусад тоглогчид (оюутнууд, хүүхдүүд гэх мэт) захиалга нэмэх."
#    managed_subs_desc_2:   "Хүлээн авагчид таны оруулсан имэйл хаяг дээр CodeCombat данстай байх ёстой."
#    group_discounts:   "Бүлгийн хөнгөлөлт"
#    group_discounts_1:   "Мөн бид бөөнөөр захиалвал бүлгийн хөнгөлөлт үзүүлдэг."
#    group_discounts_1st:   "1-р захиалга"
#    group_discounts_full:   "Бүрэн үнэ"
#    group_discounts_2nd:   "Захиалга 2-11"
#    group_discounts_20:   "20% хямдралтай"
#    group_discounts_12th:   "12+ захиалга"
#    group_discounts_40:   "40% хямдралтай"
#    subscribing:   "Бүртгүүлж байна ..."
#    recipient_emails_placeholder:   "Захиалахын тулд имэйл хаягаа мөр тутамд нэг нэгээр оруулна уу."
#    subscribe_users:   "Хэрэглэгчдэд захиалга авах"
#    users_subscribed:   "Захиалсан хэрэглэгчид:"
#    no_users_subscribed:   "Хэрэглэгч захиалаагүй байна, имэйл хаягаа давхар шалгана уу."
...
#    clojure_blurb:   "Орчин үеийн Лисп."
#    lua_blurb:   "Тоглоомын скриптийн хэл."
#    io_blurb:   "Энгийн боловч түгээмэл бус."
#    status:   "Статус"
#    hero_type:    "Төрөл"
#    weapons:    "Зэвсэг"
...
#    editor_config_keybindings_label:    "Түлхүүр холболт"
#    editor_config_keybindings_default:    "Анхдагч сонголт (Ace)"
#    editor_config_keybindings_description:    "Нийтлэг эдитор программуудаас нэмэлт товчлолуудыг нэмж оруулна."
...
#  about: 
#    why_codecombat:    "Яагаад CodeCombat гэж?"
#    why_paragraph_1:    "Хэрэв та програмчилж сурахыг хүсч байвал танд хичээл хэрэггүй. Та маш олон код бичиж, цагийг сайхан өнгөрөөх хэрэгтэй."
#    why_paragraph_2_prefix:    "Програмчлалын ямар байх ёстой вэ гэхээр. Хөгжилтэй байх ёстой. Хөгжилтэй гэхээрээ"
#    why_paragraph_2_italic:    "тиймээ энгэрийн тэмдэг авлаа"
#    why_paragraph_2_center:    "гэхийг биш харин"
#    why_paragraph_2_italic_caps:    "ҮГҮЙ ЭЭ ЭЭЖ ЭЭ БИ ТҮВШНИЙГ ДУУСГАХ ЁСТОЙ! гэмээр"
#    why_paragraph_2_suffix:    "Тийм учраас CodeCombat бол тоглоомчилсон хичээл биш олон тоглогчийн тоглоом юм. Чамайг болъё гэхээс нааш бид зогсоохгүй. Гэхдээ энэ удаа энэ бол сайн хэрэг."
#    why_paragraph_3:    "Хэрэв та ямар нэгэн тоглоомонд донтох гэж байгаа бол энэ тоглоомонд донтож, технологийн эрин үеийн шидтэнүүдийн нэг болоорой."
#    press_title:    "Блогчид / Хэвлэл мэдээлэл"
#    press_paragraph_1_prefix:    "Бидний тухай бичмээр байна уу? Манай сайтын тухай бүх мэдээллийг багтаасан хэвлэлийн багцыг"
#    press_paragraph_1_link:    "эндээс татаарай"
#    press_paragraph_1_suffix:    ". Бүх лого, зургийг бидэнтэй шууд холбоо барихгүйгээр ашиглаж болно."
#    team:    "Баг"
#    george_title:    "Хамтран байгуулагч"
#    george_blurb:    "Бизнес эрхлэгч"
#    scott_title:    "Хамтран байгуулагч"
#    scott_blurb:    "Боломжийн нэгэн"
#    nick_title:    "Хамтран байгуулагч"
#    nick_blurb:    "Мотивацийн ухааны гүрү"
#    michael_title:    "Программист"
#    michael_blurb:    "Сис админ"
#    matt_title:    "Хамтран байгуулагч"
#    matt_blurb:    "Дугуйчин"
#    cat_title:    "Ерөнхий урлаач"
#    cat_blurb:    "Airbender"
#    josh_title:    "Тоглоомын дизайнер"
#    josh_blurb:    "Шал бол Лава"
#    jose_title:    "Хөгжим"
#    jose_blurb:    "Хөөрөх"
