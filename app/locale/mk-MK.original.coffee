...
#    check_dev_console_link: "(instructions)"
    ...
    tip_open_source: "CodeCombat е 100% open source!" # {change}
...
#    must_be_logged: "You must be logged in first. Please create an account or log in from the menu above."
    subscribe_title: "Зачлени се" # Actually used in subscribe buttons, too
...
#    description_coming_soon: "Description coming soon"
  ...
  options:
    ...
    editor_config_title_coco: "Подесувања на едитор"
    editor_config_title_ozar: "Подесувања на едитор"
