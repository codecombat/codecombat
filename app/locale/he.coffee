module.exports = nativeDescription: "עברית", englishDescription: "Hebrew", translation:
  ...
  new_home:
    title: "CodeCombat - משחקי תכנות ללימוד Python ו- JavaScript"
    meta_description: "למדו לכתוב קוד באמצעות משחק תכנות. למדו Python, JavaScript ו- HTML כשאתם פותרים חידות ולמדו כיצד ליצור משחקי תכנות ואתרים משלכם."

    built_for_teachers_title: "משחק תכנות שנבנה במחשבה על מורים"
    built_for_teachers_blurb: "לפעמים, ללמד ילדים לתכנת נראה כמו משימה קשה למדי. CodeCombat עוזר לכל אנשי החינוך ללמד תלמידים כיצד לתכנת ב-Python או JavaScript, שתיים משפות התכנות הפופולריות ביותר. עם מערך שיעורים מקיף שכולל שש יחידות במדעי המחשב ומתרגל למידה באמצעות פרויקטים של פיתוח משחקים ופיתוח אתרים, ילדים יתקדמו במסע החל מדקדוק בסיסי ועד לרקורסיה!"
    built_for_teachers_subtitle1: "מדעי המחשב"
    built_for_teachers_subblurb1: "יחד עם קורס המבוא החינמי שלנו למדעי המחשב, התלמידים ישלטו בעקרונות תכנות חשובים כמו לולאות, פונקציות ואלגוריתמים."
    built_for_teachers_subtitle2: "פיתוח משחקים"
    built_for_teachers_subblurb2: "התלמידים בונים מבוכים ומשתמשים בניהול קלטים בסיסי כדי לפתח משחקים משלהם, אותם הם יכולים לשתף עם חברים ומשפחה."
    built_for_teachers_subtitle3: "פיתוח אתרי אינטרנט"
    built_for_teachers_subblurb3: "באמצעות HTML, CSS ו- JQuery, התלמידים מאמנים את שרירי היצירתיות שלהם כדי לפתח עמודי אינטרנט משלהם עם כתובת ייחודית לשיתוף עם חבריהם לכיתה."
    century_skills_title: "מיומנויות של המאה ה-21"
    century_skills_blurb1: "התלמידים לא רק מעלים את הגיבור שלהם שלב, הם מעלים את עצמם שלב."
    century_skills_quote1: "אתם מפשלים... אז אתם חושבים על כל הדרכים לתקן את זה, ואז אתם מנסים שוב. לא הייתי יכול להגיע לכאן לולא עבדתי קשה."
    century_skills_subtitle1: "מחשבה ביקורתית"
    century_skills_subblurb1: "עם חידות תכנות שרמת הקושי שלהן עולה באופן טבעי, המשחק CodeCombat מוודא שהילדים תמיד משתמשים בחשיבה ביקורתית."
    century_skills_quote2: "כשכולם בנו משחקי מבוכים, אני חשבתי לבנות משחק 'תפוס את הדגל', וכך עשיתי."
    century_skills_subtitle2: "יצירתיות"
    century_skills_subblurb2: "CodeCombat מעודד תלמידים להציג את היצירתיות שלהם על ידי בניה ושיתוף של האתרים והמשחקים שהם יצרו."
    century_skills_quote3: "אם אני נתקע על שלב, אני מדבר עם החברים שלי וביחד אנחנו פותרים אותו."
    century_skills_subtitle3: "שיתוף פעולה"
    century_skills_subblurb3: "במהלך המשחק יש לתלמידים הזדמנויות לשתף פעולה כשהם נתקעים, ולעבוד יחד באמצעות המדריך שלנו לעבודה בזוגות."
    century_skills_quote4: "תמיד היו לי שאיפות לפתח משחקים וללמוד לתכנת... המשחק הוא נקודת התחלה טובה עבורי."
    century_skills_subtitle4: "תקשורת"
    century_skills_subblurb4: "תכנות דורש מילדים להשתמש בצורות חדשות של תקשורת, כולל תקשורת עם המחשב ומימוש הרעיונות שלהם באמצעות הקוד היעיל ביותר."
    classroom_in_box_title: "אנחנו מתאמצים:"
    classroom_in_box_blurb1: "לשתף כל תלמיד עד שיאמין שתכנות מתאים לו."
    classroom_in_box_blurb2: "להעצים כל איש חינוך עד שירגיש ביטחון ללמד תכנות"
    classroom_in_box_blurb3: "לתת השראה לכל מנהל בית ספר כדי ליצור תוכנית כלל עולמית ללימוד מדעי המחשב."
    creativity_rigor_title: "כשהיצירתיות פוגשת ריגורוזיות"
    creativity_rigor_subtitle1: "עשו את התכנות לכיף ולמדו מיומנויות של העולם האמיתי"
#    creativity_rigor_blurb1: "Students type real Python and JavaScript while playing games that encourage trial-and-error, critical thinking, and creativity. Students then apply the coding skills they’ve learned by developing their own games and websites in project-based courses."
    creativity_rigor_subtitle2: "פנה לתלמידים ברמה שלהם"
#    creativity_rigor_blurb2: "Every CodeCombat level is scaffolded based on millions of data points and optimized to adapt to each learner. Practice levels and hints help students when they get stuck, and challenge levels assess students' learning throughout the game."
    creativity_rigor_subtitle3: "בנוי לכל המורים, ללא קשר לניסיון שלהם"
#    creativity_rigor_blurb3: "CodeCombat’s self-paced, standards-aligned curriculum makes teaching computer science possible for everyone. CodeCombat equips teachers with the training, instructional resources, and dedicated support to feel confident and successful in the classroom."
    featured_partners_title1: "הופיע ב:"
    featured_partners_title2: "פרסים ושותפים"
...
#    for_leaders_subblurb2: "A standards-aligned curriculum with instructional resources and professional development to enable any teacher to teach computer science."
    for_leaders_subtitle3: "תרחישי שימוש גמישים"
#    for_leaders_subblurb3: "Whether you want to build a Middle School coding elective, a CTE pathway, or an AP Computer Science Principles class, CodeCombat is tailored to suit your needs."
    for_leaders_subtitle4: "מיומנויות של העולם האמיתי"
#    for_leaders_subblurb4: "Students build grit and develop a growth mindset through coding challenges that prepare them for the 500K+ open computing jobs."
    for_teachers_title: "למורים"
    for_teachers_blurb: "כלים למימוש פוטנציאל התלמיד"
    for_teachers_subtitle1: "למידה מבוססת פרויקטים"
#    for_teachers_subblurb1: "Promote creativity, problem-solving, and confidence in project-based courses where students develop their own games and webpages."
    for_teachers_subtitle2: "לוח המורה"
...
#    for_teachers_subblurb3: "Personalize instruction and ensure students understand core concepts with formative and summative assessments."
    for_teachers_subtitle4: "הבדלה אוטומטית"
...
#    game_based_blurb: "CodeCombat is a game-based computer science program where students type real code and see their characters react in real time."
    get_started: "התחילו"
    global_title: "הצטרפו לקהילה העולמית של תלמידים ואנשי חינוך"
    global_subtitle1: "תלמידים"
    global_subtitle2: "שורות קוד"
    global_subtitle3: "מורים"
    global_subtitle4: "מדינות"
    go_to_my_classes: "לשיעורים שלי"
    go_to_my_courses: "לקורסים שלי"
...
#    try_the_game: "Try the game"
    ...
    watch_how: "צפו כיצד CodeCombat משנה את הדרך בה תלמידים לומדים מדעי המחשב."
    ...
    builds_concepts_up: "אהבתי כיצד CodeCombat בונה את המושגים בהדרגה. המושגים קלים ומהנים להבנה."
    why_games: "למה חשוב ללמוד באמצעות משחקים?"
    games_reward: "משחקים נותנים סיפוק על מאמץ פרודוקטיבי."
    encourage: "משחקים הם מדיום שמעודד אינטראקציה, גילויים וניסוי וטעייה. משחק טוב דוחף את השחקן ללמוד כישורים לאורך זמן, וזהו אותו תהליך קריטי שהסטודנטים חווים כשהם לומדים."
  ...
  nav:
    ...
    support: "תמיכה"
    faqs: "שאלות נפוצות"
    copyright_prefix: "זכויות יוצרים"
...
#    get_more_codecombat: "Get More CodeCombat"
  ...
  signup:
    complete_subscription: "השלם מינוי"
    ...
    want_codecombat_in_school: "רוצה לשחק ב- CodeCombat בכל זמן?"
    eu_confirmation: "אני מסכים ל- CodeCombat לשמור את הנתונים שלי בשרתים בארצות הברית."
    eu_confirmation_place_of_processing: "למד עוד על הסיכונים האפשריים"
    eu_confirmation_student: "אם אתה לא בטוח, תשאל את המורה שלך"
    eu_confirmation_individual: "אם אתר לא רוצה לשמור את הנתונים שלך בשרתים בארצות הברית, אתה יכול להמשיך לשחק באנונימיות בלי לשמור את ההתקדמות שלך."
...
#    combo_challenge_goal: "Challenge Level Goal"
    ...
    restart_really: "האם אתה בטוח שאתה רוצה להתחיל את השלב מחדש? אתה תאבד את כל הקוד שכתבת."
    restart_confirm: "כן, התחל מחדש"
...
#    loading_start_concept: "Start Concept Challenge"
    ...
    learn_new_concepts: "למד מושגים חדשים"
    watch_a_video: "צפה בסרטון על: __concept_name__"
    concept_unlocked: "מושג נפתח"
    use_at_least_one_concept: "השתמש במושג אחד לפחות: "
    command_bank: "בנק הפקודות"
...
#    future_eng_5: "program which creates learning and work opportunities for all K-12 students in the United States who wish to pursue computer science."
  ...
  play_game_dev_level:
    ...
    created_during_hoc: "נוצר בזמן /"שעת קוד/""
    ...
    goal_survive: "שרוד."
    goal_survive_time: "שרוד למשך __seconds__ שניות."
    goal_defeat: "הבס את כל האויבים."
    goal_defeat_amount: "הבס __amount__ אוייבים."
    goal_move: "זוז לכל סימני ה- X האדומים"
    goal_collect: "אסוף את כל הפריטים."
    goal_collect_amount: "אסוף __amount__ פריטים."
  ...
  leaderboard:
    ...
    survival_time: "שרדת"
    defeated: "אויבים הובסו"
    code_length: "שורות קוד"
  ...
  inventory:
    ...
    equip: "צייד"
    unequip: "הסר"
    warrior_only: "ללוחמים בלבד"
    ranger_only: "לסיירים בלבד"
    wizard_only: "לקוסמים בלבד"
...
#    prompt_body: "Subscribe to Premium to get gems and access to even more levels!"
  ...
  subscribe:
    best_deal: "המבצע הטוב ביותר!"
    confirmation: "מזל טוב! יש לך מנוי פרימיום ל- CodeeCombat!"
    ...
    feature_level_access: "קבל גישה ל- 300+ שלבים"
    feature_heroes: "פתיחה של גיבורים בלעדיים" # {change}
    feature_learn: "למד לפתח משחקים ולבנות אתרים"
    month_price: "$__price__ לחודש" # {change}
    first_month_price: "רק $__price__ לחודש הראשון!"
...
#    pick_an_avatar: "Pick an avatar that will represent you as a player"
  ...
  premium_features:
    ...
    paypal_redirect: "אתה תועבד ל- Paypal כדי להשלים את תהליך המינוי."
...
#    skin_label: "Skin Color"
  ...
  skill_docs:
    ...
    returns: "מחזיר"
    granted_by: "מתקבל מ:"
    still_undocumented: "עדיין לא תועד, מצטערים."
...
#    meta_description: "Our mission is to level computer science through game-based learning and make coding accessible to every learner. We believe programming is magic and want learners to be empowered to to create things from pure imagination."
    ...
    david_title: "מנהל שיווק"
    titles_csm: "מנהל הצלחה לקוחות"
    titles_territory_manager: "מנהל טריטוריה"
    lawrence_title: "מנהלת שירות לקוחות"
    sean_title: "תקציבאי ותיק"
    liz_title: "תקציבאית ותיקה"
    jane_title: "תקציבאית"
#    shan_title: "Partnership Development Lead, China"
    run_title: "Head of Operations, China"
    lance_title: "מתמחה בהנדסת תוכנה, סין"
    matias_title: "מהנדס תוכנה ותיק"
    ryan_title: "מומחה בשחירות לקוחות"
    maya_title: "מפתחת מערכי שיעור ותיקה"
    bill_title: "מנהל כללי, סין"
    shasha_title: "מעצבת מוצר"
    daniela_title: "מנהלת שיווק"
    chelsea_title: "מנהלת אסטרטגיה תפעולית"
    claire_title: "עוזרת אישית"
    bobby_title: "מעצב משחקים"
    brian_title: "מעצב משחקים ראשי"
    andrew_title: "מהנדס תוכנה"
    stephanie_title: "מומחית בשירות לקוחות"
#    rob_title: "Sales Development Representative"
    shubhangi_title: "מהנדסת תוכנה ותיקה"
    bryukh_title: "מעצב משחקים" # {change}
