...
#    quotes_quote4: "The feedback … has been so positive that we are structuring a computer science class around CodeCombat. The program really engages the students with a gaming style platform that is entertaining and instructional at the same time. Keep up the good work, CodeCombat!"
    see_example: "ראה דוגמה"
    slogan: "המשחק הכי מלהיב ללימוד תכנות." # {change}
    teach_cs1_free: "ללמד יסודות מדעי המחשב חינם"
...
#    educator: "Educator"
    student: "תלמיד"
    our_coding_programs: "תכניות הקוד שלנו"
...
#    default_meta_description: "Learn typed code through a programming game. Learn Python, JavaScript, and HTML as you solve puzzles and learn to make your own coding games and websites."
  ...
  general:
    ...
    with: "עם"
    chat: "צ'אט"
    chat_with_us: "דבר איתנו (צ'אט)"
    email_us: "שלח לנו דואל"
    sales: "מכירות"
    support: "תמיכה"
...
#    start_challenge: "Start Challenge"
    ...
    goals: "יעדים"
    goal: "יעד"
    challenge_level_goals: "מטרות השלב"
    challenge_level_goal: "מטרת השלב"
...
#    loading_start_concept: "Start Concept Challenge"
   ...
   learn_new_concepts: "למד רעיונות חדשים"
...
#    date: "Aug 1 - Aug 31"
  ...
  play_game_dev_level:
    ...
    created_during_hoc: "נוצר במהלך 'שעת הקוד'"
...
#  subscribe_for_gems:
    prompt_title: "אין מספיק יהלומים!"
...
#    confirmation: "Congratulations! You now have a CodeCombat Premium Subscription!"
    ...
    stripe_yearly_description: "מנוי שנתי"
    buy_now: "קנה כעת"
...
#  avatar_selection:
    pick_an_avatar: "בחר דמות לשחק איתה"
...
#    paypal_redirect: "You will be redirected to PayPal to complete the subscription process."
    ...
    pet_blurb_1: "חיות המחמד הן יותר מאשר בני לוויה חמודים - הן גם מספקות פונקציות ושיטות ייחודיות. גור הגריפונים מסוגל לשאת יחידות באוויר, גור הזאבים משחק תופסת עם חצי האויבים,  אוהב לרדוף אחרי ענקים, והחקיין מושך מטבעות כמו מגנט!" # {change}
...
#    cpp_blurb: "(Subscriber Only) Game development and high performance computing."
    ...
    attack: "תקיפה" # Can also translate as "Attack"
    health: "בריאות"
    speed: "מהירות"
...
#  char_customization_modal:
    heading: "לשנות את הגיבור שלך"
    body: "גוף"
    name_label: "שם הגיבור"
    hair_label: "צבע שיער"
    skin_label: "צבע עור"
...
#    anything_else_helper: ""
    ...
    not: "לא"
    full_name_required: "נדרש שם מלא"
...
#  cinematic:
   click_anywhere_continue: "להמשך לחץ במקום כלשהו"
...
#    revoke_all_confirm: "Are you sure you want to revoke Full Licenses from all students in this class?"
    ...
    teacher_quest_teach_methods: "עזרו לתלמידים שלכם ללמוד כיצד 'לקרוא לשיטות'."
