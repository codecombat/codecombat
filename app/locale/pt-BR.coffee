...
#    create_account_subtitle: "Get access to teacher-only tools for using CodeCombat in the classroom.  <strong>Set up a class</strong>, add your students, and <strong>monitor their progress</strong>!"
  ...
  courses:
    ...
    view_guide_online: "Overview dos Níveis e Soluções"
    ...
    update_account_students_can2: "Jogas nos cursos cadastrados e monitorar seu progresso"
...
#    students_code_blurb: "A correct solution to each level is provided where appropriate. In some cases, it’s possible for a student to solve a level using different code. Solutions are not shown for levels the student has not started."
    ...
    level_overview_solutions: "Visão Geral dos Níveis e Soluções"
    no_student_assigned: "Nenhum aluno cadastrado neste curso."
    paren_new: "(novo)"
    ...
    teacher_account_required: "Uma conta de professor é necessário para acessar este conteúdo."
    create_teacher_account: "Criar Conta de Professor"
    what_is_a_teacher_account: "O que é uma conta do professor?"
    teacher_account_explanation: "Uma conta de professor do CodeCombat permite que você configure salas de aula, monitore o progresso dos alunos enquanto eles trabalham através dos cursos, gerenciar licenças e acessar conteúdos para ajudar na preparação das aulas."
    current_classes: "Turmas Atuais"
    archived_classes: "Turmas Arquivadas"
    archived_classes_blurb: "Turmas podem ser arquivadas para futura referência. Desarquivar uma classe para visualizá-la na lista de Turmas Atuais novamente."
    ...
    no_students_yet_view_class: "Visualizar turma para adicionar alunos."
    try_refreshing: "(Você deve atualizar esta página!)"
    create_new_class: "Criar Nova Turma"
    class_overview: "Visão Geral da Turma" # View Class page
    avg_playtime: "Tempo médio de jogo do nível"
    total_playtime: "Tempo total de jogo"
    avg_completed: "Média de Níveis completados"
    total_completed: "Total de Níveis Completados"
    created: "Criado"
...
#    wd2_quizlet_worksheet_desc: "Before your students build their personality quiz project at the end of Web Development 2, they should plan out their quiz questions, outcomes and responses using this worksheet. Teachers can distribute the instructions and examples for students to refer to."
    ...
    student_details: "Detalhes dos Alunos"
...
#    hoc_self_led_desc: "Students can play through two Hour of Code CodeCombat tutorials on their own"
    hoc_game_dev: "Desenvolvimento de Jogo"
#    hoc_and: "and"
