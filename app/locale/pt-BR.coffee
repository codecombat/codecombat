module.exports = nativeDescription: "Português (Brasil)", englishDescription: "Portuguese (Brazil)", translation:
  ...
  nav:
    ...
    my_classrooms: "Minhas Salas de Aula"
  ...
  play_level:
    ...
    finished_hoc: "Eu terminei minha Hora do Código"
    get_certificate: "Pegue seu certificado!"
  ...
  subscribe:
    ...
    premium_pricing_prefix: "Adquira Premium por apenas"
    premium_pricing_suffix: "e se torne um Programador Mestre."
    ...
    feature4: "<strong>{{gems}} gemas bônus</strong> todo mês!" # {change}
    feature6: "Suporte via e-mail Premium"
    feature7: "<strong>Clãs</strong> Privados"
    feature8: "<strong>Sem anúncios!</strong>"
    feature_game_dev: "Faça jogos para os seus amigos jogarem em nossos <strong>Mundos de Desenvolvimento de Jogos</strong>"
    feature_web_dev: "Crie sites e aplicativos com HTML, CSS e jQuery em nossos <strong>Mundo de Desenvolvimento de Websites</strong>"
    free: "Grátis"
    month: "mês"
  ...
  choose_hero:
    ...
    java_blurb: "(Somente Assinante) Android e empresa."
    status: "Status"
    weapons: "Armas"
  ...
  about:
    ...
    mission_description_2: "Como se vê, isso lhes permite aprender mais rápido também. Muito mais rápido. É como ter uma conversa em vez de ler um manual. Queremos trazer essa conversa para todas as escolas e para <strong> todos os alunos </strong>, porque todos devem ter a oportunidade de aprender a magia da programação."
    team_title: "Conheça o time do CodeCombat"
    team_values: "Valorizamos o diálogo aberto e respeitoso, onde ganha a melhor ideia. Nossas decisões são fundamentadas na pesquisa do cliente e nosso processo é focado em entregar resultados tangíveis para eles. Todos são hands-on, de nosso CEO a nossos colaboradores de GitHub, porque nós valorizamos o crescimento e a aprendizagem em nossa equipe."
    ...
    maka_title: "Advogado do Cliente"
    ...
    lisa_title: "Especialista Escolar"
    ...
    community_title: "...e nossa comunidade de código aberto"
    community_subtitle: "Mais de 500 contribuidores ajudaram a construir CodeCombat, com mais adesão todas as semanas!"
    community_description_3: "CodeCombat é um"
    community_description_link_2: "projeto comunitário"
    community_description_1: "Com centenas de jogadores voluntários para criar níveis, contribuir para o nosso código para adicionar recursos, corrigir bugs, teste de níveis, e até mesmo traduzir o jogo em 50 línguas até agora. Empregados, colaboradores e o ganho do site compartilhando idéias e esforços de agrupamento, assim como a comunidade de código aberto em geral. O site é construído em vários projetos de código aberto e estamos abertos para dar à comunidade e fornecer aos jogadores curiosos de código um projeto familiar para explorar e experimentar. Qualquer um pode participar da comunidade CodeCombat! Confira nosso"
    community_description_link: "página de contribuição"
    community_description_2: "para mais informações."
    number_contributors: "Mais de 450 colaboradores deram seu apoio e tempo para este projeto."
    story_title: "Nossa história até agora"
    story_subtitle: "Desde 2013, CodeCombat cresceu de um mero conjunto de esboços para um jogo vivo e próspero."
    story_statistic_1a: "5,000,000+"
    story_statistic_1b: "total de jogadores"
    story_statistic_1c: "começaram a sua jornada de programação através do CodeCombat"
    story_statistic_2a: "Foram traduzidos para mais de 50 idiomas - os nossos jogadores são"
    ...
    story_sketch_caption: "O primeiro esboço de Nick mostrando um jogo de programação em ação."
    story_long_way_2: "ainda temos muito a fazer antes de completar nossa missão, então..."
    jobs_title: "Venha trabalhar com a gente e ajudar a escrever a história de CodeCombat!"
    jobs_subtitle: "Não vê um bom ajuste, mas interessado em manter contato? Consulte a nossa lista de \"Criar sua Própria\"."
    ...
    jobs_benefit_6: "Médico (ouro), dental, visão, assinante"
    jobs_benefit_7: "Mesas de estar para todos"
    jobs_benefit_9: "Janela de exercício de opção de 10 anos"
    jobs_benefit_10: "Licença maternidade: 10 semanas pagas, mais 6 @ 55% de salário"
    jobs_benefit_11: "Licença paternidade: 10 semanas pagas"
    learn_more: "Aprenda Mais"
    jobs_custom_title: "Crie seu próprio"
    jobs_custom_description: "Você é apaixonado por CodeCombat, mas não vê um emprego listado que corresponde às suas qualificações? Escreva-nos e mostre como acha que pode contribuir para a nossa equipe. Gostaríamos muito de ouvir de você!"
    jobs_custom_contact_1: "Envie-nos uma nota em"
    jobs_custom_contact_2: "apresentando-se e poderemos entrar em contato no futuro!"
    ...
    downloads_title: "Download de Assets e informações"
...
#  teachers:
    licenses_needed: "Certificados necessários"

#  special_offer:
    special_offer: "Oferta Especial"
    project_based_title: "Cursos Baseados em Projetos"
    project_based_description: "Cursos de Web e Desenvolvimento de Jogos apresentam projetos finais compartilháveis."
    great_for_clubs_title: "Ótimo para clubes e seletivas"
    great_for_clubs_description: "Os professores podem comprar até __maxQuantityStarterLicenses__ Licenças iniciais por ano."
    low_price_title: "Somente __starterLicensePrice__ por aluno"
    low_price_description: "Licenças Iniciais ficam ativas por __starterLicenseLengthMonths__ meses a partir da compra."
    three_great_courses: "Três grandes cursos incluídos na Licença Inicial:"
...
#    if_statements_nested: "Nested If Statemnts"
  ...
  legal:
    ...
    cost_title: "Custo"
    cost_description: "CodeCombat é livre para jogar em todos os seus níveis principais, com uma assinatura USD/m de ${{price}} para acesso a locais de nível extra e {{gems}} gemas de bônus por mês. Você pode cancelar com um clique, e nós oferecemos uma garantia de reembolso de 100%."
