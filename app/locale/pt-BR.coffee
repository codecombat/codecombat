module.exports = nativeDescription: "Português (Brasil)", englishDescription: "Portuguese (Brazil)", translation:
  new_home:
    ...
    getting_students: "Fazer os estudantes escrevam código é fundamental para aprender a sintaxe de programação e estrutura apropriada."
    ...
    forgot_learning: "Eu acho que eles realmente esqueceram que estavam aprendendo de verdade algo."
    ...
    agency: "CodeCombat é um jogo que fornece aos jogadores essa ação e confiança com nosso robusto mecanismo de digitação de código, que ajuda alunos iniciantes e avançados tanto na escrita quanto na validação do código."
    ...
    get_started_subtitle: "Crie sua turma, adicione seus alunos e acompanhe o progresso deles no aprendizado de ciência da computação."
    ...
    run_class: "Tudo o que você precisa para criar uma turma de ciência da computação em sua escola hoje, nenhuma conhecimento técnicos é necessário."
  ...
  nav:
    ...
    facebook: "Facebook"
    twitter: "Twitter"
    create_a_class: "Criar um Classe"
    other: "Outro"
    learn_to_code: "Aprenda a programar!"
...
#    replay: "Replay"
  ...
  signup:
    ...
    finish: "Fim"
    teacher_ready_to_create_class: "Você está pronto para criar sua primeira classe!"
    ...
    teacher_list_create_class: "Na próxima tela você poderá criar uma nova classe"
    teacher_list_add_students: "Adicione estudantes à classe clicando no link Ver Classe, então envie para os estudantes o Código de Classe ou URL. Você também pode convidá-los por email se eles tiverem endereços de email."
    teacher_list_resource_hub_1: "Confira o"
    teacher_list_resource_hub_2: "Guias de Curso"
    teacher_list_resource_hub_3: "para soluções de todo nível, e o"
    ...
    dont_use_our_email_silly: "Não coloque o nosso email aqui! Use o email do seus pais."
...
#    subscribe_to_play: "Subscribe to Play"
    ...
    valid_phone: "Preencha um número de telefone válido."
...
#    back_to_map: "Back to Map"
    ...
    reload_really: "Você tem certeza que quer reiniciar a fase?"
    reload_confirm: "Recarregar Tudo"
    test_level: "Nível de Tese"
    victory: "Vitória"
...
#    latest: "Latest"
  ...
  buy_gems:
    few_gems: "Algumas jóias"
    pile_gems: "Pilha de jóias"
    chest_gems: "Baú de jóias"
    ...
    prompt_body: "Você quer adquirir mais jóias?"
    prompt_button: "Entrar na loja"
    recovered: "jóias das compras anteriores recuperadas. Por favor atualize a pagina."
    price: "x{{gems}} / mês"
...
#    free_subscription: "Free subscription"
    ...
    kids_message_1: "Crianças! Nós vamos enviar um email para seus pais para que eles possam pagar a inscrição para vocês."
    kids_message_2: "Peça ao seus pais"
