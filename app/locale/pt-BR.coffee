...
#    great_for_clubs_title: "Great for clubs and electives"
    great_for_clubs_description: "Professores podem adquirir até __maxQuantityStarterLicenses__ Licenças Inicias." #
    low_price_title: "Apenas __starterLicensePrice__ por estudante"
    low_price_description: "Licenças Iniciais ficam ativas por __starterLicenseLengthMonths__ meses após a compra."
    three_great_courses: "Três exceletes cursos estão inclusos na Licença Inicial:"
    license_limit_description: "Professores podem adquirir até __maxQuantityStarterLicenses__"
    "Teachers can purchase up to __maxQuantityStarterLicenses__ Starter Licenses. You have already purchased __quantityAlreadyPurchased__. If you need more, contact __supportEmail__. Starter Licenses are valid for __starterLicenseLengthMonths__ months."
...
#    starter_licenses_can_be_used: "Starter Licenses can be used to assign additional courses immediately after purchase."
    pay_now: "Pague Agora"
    we_accept_all_major_credit_cards: "Nós aceitamos todos os principais cartões de crédito."
...
#    gd1_description: "uses syntax students are already familiar with to show them how to build and share their own playable game levels."
    see_an_example_project: "veja um projeto de exemplo"
