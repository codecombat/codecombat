...
#    ball_description: "ball.squeak()"
  ...
  about:
    ...
    community_subtitle: "Mais de 600 colaboradores ajudaram a construir o CodeCombat, com mais se juntando toda semana!"
    ...
    number_contributors: "Mais de 600 colaboradores deram o seu apoio e tempo a este projeto."
...
#    properties: "Properties"
  ...
  legal:
    ...
    cost_title: "Custo"
#    cost_description: "CodeCombat é grátis para jogar em todos os seus níveis principais, with a ${{price}} USD/mo subscription for access to extra level branches and {{gems}} bonus gems per month. You can cancel with a click, and we offer a 100% money-back guarantee."
