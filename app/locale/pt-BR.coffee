module.exports = nativeDescription: "Português (Brasil)", englishDescription: "Portuguese (Brazil)", translation:
  ...
  common:
    ...
    subscribe_to_play: "Inscreva-se para Jogar"
    ...
    valid_phone: "Preencha com um número de telefone válido."
  ...
  subscribe:
    ...
    parent_button: "Pergunte aos seus pais ou responsável"
    ...
    parent_email_input_label: "Endereço de e-mail dos pais ou responsável"
    parent_email_input_placeholder: "Informe o e-mail do responsável"
    parent_email_send: "Enviar Email"
    parent_email_sent: "Email enviado!"
    parent_email_title: "Qual é o e-mail dos seus pais ou responsável?"
    parents: "Para os pais ou responsáveis"
    parents_title: "Seu filho está aprendendo a programar. Você irá ajudá-lo a continuar?" # {change}
    parents_blurb1: "Seu filho(a) jogou __nLevels__ e aprendeu alguns conceitos básicos de programação. Ajude a cultivar seu interesse fazendo uma assinatura para que ele possa continuar jogando."
    ...
    parents_blurb2: "Por apenas ${{price}} USD/mês, eles receberão novos desafios todo mês e suporte via email de programadores profissionais." # {change}
    parents_blurb3: "Sem risco: devolução do dinheiro 100% garantida, basta um simples clique em desinscrever-se."
    ...
    payment_methods_blurb2: "Se desejar usar outra forma de pagamento, por favor entre em contato"
    sale_button: "Venda!"
    ...
    feature_levels: "Acesse __premiumLevelsCount__ níveis disponíveis"
    feature_gems: "Receba __gems__ gemas por mês"
    feature_heroes: "Desbloqueie heróis exclusivos"
    feature_games: "Faça jogos para seus amigos"
    feature_websites: "Construa websites e apps"
    feature_items: "Equipe itens mais poderosos"
    month_price: "$__price__/mês"
    lifetime: "Inscrição para vida toda"
    lifetime_price: "$__price__"
    year_subscription: "Inscrição Anual"
    year_price: "$__price__/ano"
    kids_message_1: "Crianças! Nós vamos enviar um email para seus pais ou responsável para que eles possam pagar a inscrição para vocês."
    kids_message_2: "Peça ao seus pais ou responsáveis"
    support_part1: "Precisa de ajuda com as opções de pagamento? Envie um email para"
    support_part2: "support@codecombat.com"
    support_part3: "se tiver qualquer pergunta."
    you_are_purchasing_year_sub: "Você está comprando uma assinatura premium anual!"
    you_are_purchasing_lifetime_sub: "Você está comprando uma assinatura premium para vida toda!"
    you_will_be_charged: "Será cobrado $__priceString__ apenas uma vez."
    choose_payment_method: "Escolha o Método de Pagamento"
    pay_with_credit_card_or_bitcoin: "Pague com Cartão de Crédito / Bitcoin"
    paypal_payment_error: "Encontramos um erro ao carregar o PayPal."
...
#    ball_description: "ball.squeak()"
  ...
  premium_features:
    ...
    hero_blurb_1: "Ganhe acesso a __premiumHeroesCount__ heróis exclusivos para assinantes! Apoveite o poder imparável de Okar Stompfoot, a precisão mortal Naria of the Leaf, ou convoque esqueletos \"adoráveis\" com Nalfar Cryptor."
    ...
    pet_blurb_1: "Os animais de estimação não são apenas companheiros adoráveis, eles também oferecem funcionalidades e métodos únicos. O Grifo bebê pode transportar unidades através do ar, o Lobo Filhote pega as flechas inimigas, o Puma gosta de perseguir ogros e o Mimic atrai moedas como um ímã!"
    pet_blurb_2: "Colecione todos os animais de estimação para descobrir suas habilidades únicas!"
    pet_caption: "Adote animais de estimação para acompanhar o seu herói!"
