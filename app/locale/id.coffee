module.exports = nativeDescription: "Bahasa Indonesia", englishDescription: "Indonesian", translation:
  ...
  new_home:
    ...
    slogan: "Game untuk belajar pemrograman paling menyenangkan." # {ubah}
    teach_cs1_free: "Ajarkan CS1 Gratis"
    teacher_love_codecombat_title: "Guru Suka CodeCombat"
    teacher_love_codecombat_blurb1: "Laporkan bahwa siswanya senang menggunakan CodeCombat untuk mempelajari cara membuat kode"
    teacher_love_codecombat_blurb2: "Akan merekomendasikan CodeCombat kepada guru ilmu komputer lainnya"
    teacher_love_codecombat_blurb3: "Katakan bahwa CodeCombat membantu mereka mendukung kemampuan pemecahan masalah siswa"
    teacher_love_codecombat_subblurb: "Bekerja sama dengan McREL International, pemimpin dalam panduan berbasis penelitian dan evaluasi teknologi pendidikan."
    ...
    forgot_learning: "Saya pikir mereka benar-benar lupa bahwa mereka sebenarnya belajar tentang sesuatu." # {ubah}
    ...
    builds_concepts_up: "Saya suka bagaimana CodeCombat membangun konsep. Sangat mudah dipahami dan menyenangkan untuk memahaminya."
    ...
    feedback: "Permainan juga memberikan umpan balik langsung yang memungkinkan siswa untuk menyesuaikan solusi jalan mereka dan memahami konsep-konsep yang lebih holistik, hanya terbatas dengan jawaban “benar” atau “salah” saja."
    ...
    winning: "Kombinasi yang unggul dari permainan RPG dan pemograman pekerjaan rumah yang berhasil membuat pendidikan ramah anak yang pasti menyenangkan."
  ...
  ladder:
    ...
    turnamen_selesai: "Turnamen berakhir"
  ...
  esper:
    ...
    empty_while: "Empty while statement. Letakkan 4 spasi di depan pernyataan di dalam pernyataan while."
    ...
    expected_end_of_input: "Akhir input tak terduga"
    ...
    attack_argument_enemy_has: "Argumen `$1` `$2` bermasalah."
  ...
  parents_landing_2:
    ...
    small_group_classes_detail: "4 Sesi Grup / Mo."
