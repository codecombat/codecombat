...
#    pass: "pass"
    ...
    "=": "додели"
    "==": "дали е еднакво на"
    "===": "дали е строго еднакво на"
    "!=": "дали е различно од"
    "!==": "дали е строго различно од"
    ">": "е поголемо од"
...
#    teacher_email_announcements: "Keep me updated on new teacher resources, curriculum, and courses!"
    ...
    school_name: "Име на школо и град"
    optional: "не е задолжително"
    school_name_placeholder: "Пример Средно Школо, Пример Град"
    ...
    gplus_exists: "Веќе имаш сметка поврзана со Google+!"
    ...
    facebook_exists: "Веќе имаш сметка поврзана со Facebook!"
