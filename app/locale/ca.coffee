...
contact:
  ...
  diplomat_suggestion:
    title: "Ajudans a traduir CodeCombat!"
    sub_heading: "Necessitem les teves habilitats d'idiomes."
    pitch_body: "Desenvolupem CodeCombat en Anglès, però ja tenim jugadors arreu del món. Molts d'ells volen jugar en Català, però no parlen Anglès, així que si tu pots parlar els dos idiomes, si us plau, considera apuntar-te com un Diplomàtic i ajudar-nos a traduir tant la pàgina web de CodeCombat com tots els seus nivells al Català."
    missing_translations: "Fins que no puguem traduir-ho tot en Català, ho hauràs de veure tot en Anglès."
    learn_more: "Aprèn més sobre com convertir-te en Diplomàtic"
    subscribe_as_diplomat: "Subscriu-res com a Diplomàtic"
