module.exports = nativeDescription: "français", englishDescription: "French", translation:
  ...
  announcement:
    ...
    pugicorn_name: "Carlicorne" #carlicorne est la fusion de carlin (pug en anglais), et licorne (unicorn en anglais)
  ...
  account_settings:
    ...
    use_gravatar: "Changez votre image de profil en s'enregistrant sur Gravatar"
...
#    teacher_quest_teach_strings_step1: "Get 75% of at least one class through __True Names__"
    teacher_quest_teach_strings_step2: "Positionnez le sélecteur de niveaux des professeurs sur la page [Guide des cours]("+'''/teachers/'''"+"cou"+"rses)pour prévisualiser __True Names__."
