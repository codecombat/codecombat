...
#    check_it_out: "Check it out!"
   ...
   educator: "Educateur"
   student: "Étudiant"
   go_to_my_dashboard: "Aller sur mon tableau de bord"
...
#    term_of_service: "Terms of Service"
   esports: "Esports"
   browser_recommendation: "Pour une meilleur expérience, nous recommandons d'utiliser la dernière version de Chrome. Téléchargez le navigateur ici!"
   ozaria_classroom: "Salle de classe Ozaria"
   codecombat_classroom: "Salle de classe CodeCombat"
   ozaria_dashboard: "Tableau de bord Ozaria"
#    ozaria_teacher_dashboard: "Ozaria Teacher Dashboard"
#    ozaria_admin_dashboard: "Ozaria Admin Dashboard"
   codecombat_dashboard: "Salle de classe CodeCombat"
...
#  new_home_faq:
   what_programming_languages: "Quels languages de programmation sont disponibles ?"
   python_and_javascript: "Nous supportons actuelement le python et le javascript."
   why_python: "Pourquoi apprendre le Python ?"
#    why_python_blurb: "Python is both beginner-friendly and currently used by major corporations (such as Google). If you have younger or first-time learners, we strongly recommend Python."
   why_javascript: "Pourquoi apprendre le JavaScript?"
...
#    javascript_versus_python: "JavaScript’s syntax is a little more difficult for beginners than Python, so if you cannot decide between the two, we recommend Python."
   how_do_i_get_started: "Comment puis-je commencer ?"
   getting_started_1: "Créez un compte de Professeur."
   getting_started_2: "Créez une classe."
   getting_started_3: "Ajouter un étudiant."
   getting_started_4: "Assis toi et regarde tes étudiants apprendre !"
#    main_curriculum: "Can I use CodeCombat or Ozaria as my main curriculum?"
   main_curriculum: "Puis-je utiliser CodeCombat et Ozeria dans mon CV ?"
...
#    simulate_all: "Simulate All"
    ...
    locked: "Verrouillé"
    locked_by_teacher: "Vérouiller par le professeur"
   ...
   back_to_ozaria: "Retour à ozaria.com"
   customize_hero: "Personnaliser votre Héro"
   account_settings: "Paramètres du compte"
   back_to_tutorial: "Retour au tutoriel"
...
#    confirm_m7_off: "Are you sure to turn beta levels off?"
  ...
  login:
   auth_sign_up: "Nouvau sur Ozaria? Créer un compte"
...
#    confirm_individual_blurb_without_email: "Write down your login information in case you need it later."
   ...
   request_class_code: "Réclamez un code auprès de votre professeur"
