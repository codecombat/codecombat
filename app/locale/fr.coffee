module.exports = nativeDescription: "français", englishDescription: "French", translation:
  ...
  new_home:
    ...
    meta_description: "Apprenez le code saisi à travers un jeu de programmation. Apprenez Python, JavaScript et HTML en résolvant des énigmes et apprenez à créer vos propres jeux et sites de codage."
    built_for_teachers_title: "Un jeu de codage conçu pour les enseignants"
    built_for_teachers_blurb: "Enseigner aux enfants à coder peut souvent sembler écrasant. CodeCombat aide tous les enseignants à enseigner aux étudiants comment coder en JavaScript ou en Python, deux des langages de programmation les plus populaires. Avec un programme complet comprenant six unités informatiques et renforçant l’apprentissage grâce à des unités de développement de jeux et de développement Web basées sur des projets, les enfants s’engagent sur la voie de la syntaxe de base à la récursion!"
    built_for_teachers_subtitle1: "Informatique"
    built_for_teachers_subblurb1: "À partir de notre cours gratuit d’introduction à l’informatique, les étudiants maîtrisent les concepts de base du codage, tels que les boucles while / for, les fonctions et les algorithmes."
    built_for_teachers_subtitle2: "Développement de jeux"
    built_for_teachers_subblurb2: "Les apprenants construisent des labyrinthes et utilisent le traitement de base des entrées pour coder leurs propres jeux pouvant être partagés avec leurs amis et leur famille."
    built_for_teachers_subtitle3: "Développement Web"
    built_for_teachers_subblurb3: "En utilisant HTML, CSS et jQuery, les apprenants font preuve de créativité pour programmer leurs propres pages Web avec une URL personnalisée à partager avec leurs camarades de classe."
    century_skills_title: "Compétences du 21e siècle"
    century_skills_blurb1: "Les étudiants ne se contentent pas de faire évoluer leur héros, ils se montent de niveau"
    century_skills_quote1: "Vous vous trompez ... afin que vous réfléchissiez à tous les moyens possibles pour y remédier, puis essayez à nouveau. Je ne pourrais pas arriver ici sans faire de gros efforts."
    century_skills_subtitle1: "Pensée critique"
    century_skills_subblurb1: "Avec des énigmes de codage naturellement intégrées à des niveaux de plus en plus difficiles, le jeu de programmation de CodeCombat garantit aux enfants de toujours pratiquer la pensée critique."
    century_skills_quote2: "Tous les autres fabriquaient des labyrinthes, alors j’ai pensé: ‘capture the flag’ (capturer le drapeau) et c’est ce que j’ai fait."
    century_skills_subtitle2: "Créativité"
    century_skills_subblurb2: "CodeCombat encourage les étudiants à démontrer leur créativité en construisant et en partageant leurs propres jeux et pages Web."
    century_skills_quote3: "Si je me suis retrouvé coincé dans un niveau. Je travaillais avec les gens autour de moi jusqu'à ce que nous soyons tous capables de le comprendre."
    century_skills_subtitle3: "Collaboration"
    century_skills_subblurb3: "Tout au long du jeu, les élèves ont la possibilité de collaborer en cas de blocage et de travailler ensemble à l'aide de notre guide de programmation en binôme."
    century_skills_quote4: "J'ai toujours aspiré à concevoir des jeux vidéo et à apprendre à coder ... cela me donne un excellent point de départ."
    century_skills_subtitle4: "Communication"
    century_skills_subblurb4: "Le codage oblige les enfants à pratiquer de nouvelles formes de communication, notamment la communication avec l'ordinateur lui-même et la transmission de leurs idées à l'aide du code le plus efficace."
    classroom_in_box_title: "Nous nous efforçons de:"
    classroom_in_box_blurb1: "Faites participer chaque élève afin qu’il croie que le codage leur convient."
    classroom_in_box_blurb2: "Donnez à tout éducateur le moyen de se sentir confiant lors de l’enseignement du codage."
    classroom_in_box_blurb3: "Inciter tous les chefs d’établissement à créer un programme informatique de calibre mondial."
    creativity_rigor_title: "Où la créativité rencontre la rigueur"
    creativity_rigor_subtitle1: "Rendez le codage amusant et enseignez les compétences du monde réel"
    creativity_rigor_blurb1: "Les élèves saisissent du vrai Python et du JavaScript lorsqu'ils jouent à des jeux qui encouragent les essais et les erreurs, la pensée critique et la créativité. Les étudiants appliquent ensuite les compétences de codage acquises en développant leurs propres jeux et sites Web dans le cadre de cours basés sur des projets."
    creativity_rigor_subtitle2: "Atteindre les étudiants à leur niveau"
    creativity_rigor_blurb2: "Chaque niveau CodeCombat est échafaudé sur la base de millions de points de données et optimisé pour s’adapter à chaque apprenant. Les niveaux de pratique et les conseils aident les élèves à rester bloqués, et les niveaux de difficulté évaluent leur apprentissage tout au long du jeu."
    creativity_rigor_subtitle3: "Construit pour tous les enseignants, peu importe l'expérience"
    creativity_rigor_blurb3: "Le programme personnalisé de CodeCombat, adapté aux normes, permet d’enseigner l’informatique à tout le monde. CodeCombat fournit aux enseignants la formation, les ressources pédagogiques et un soutien dédié pour qu'ils se sentent en confiance et qu'ils réussissent en classe."
    featured_partners_title1: "En vedette dans"
    ...
    featured_partners_blurb3: "Meilleur choix pour l'apprentissage"
    featured_partners_blurb4: "Code.org Partenaire Officiel"
    featured_partners_blurb5: "CSforAll Membre Officiel"
...
#    quotes_quote4: "The feedback … has been so positive that we are structuring a computer science class around CodeCombat. The program really engages the students with a gaming style platform that is entertaining and instructional at the same time. Keep up the good work, CodeCombat!"
    see_example: "Voir exemple"
    slogan: "La manière la plus attrayante d'apprendre le vrai code." # {change}
    teach_cs1_free: "Enseigner CS1 Gratuitement"
    teachers_love_codecombat_title: "Les enseignants aiment CodeCombat"
    teachers_love_codecombat_blurb1: "Signalez que leurs étudiants aiment utiliser CodeCombat pour apprendre à coder"
    teachers_love_codecombat_blurb2: "Recommanderais CodeCombat à d'autres professeurs d'informatique"
    teachers_love_codecombat_blurb3: "Dire que CodeCombat les aide à soutenir les capacités de résolution de problèmes des étudiants"
    teachers_love_codecombat_subblurb: "En partenariat avec McREL International, un leader de l'orientation et de l'évaluation des technologies éducatives fondées sur la recherche."
  ...
  play:
    title: "Jouer les niveaux de CodeCombat - Apprendre Python, JavaScript et HTML"
    meta_description: "Apprenez à programmer avec un jeu de codage pour les débutants. Apprenez Python ou JavaScript en résolvant des labyrinthes, créez vos propres jeux et montez de niveau. Défiez vos amis dans les niveaux d'arène multijoueur!"
    level_title: "__level__ - Apprendre Python, JavaScript et HTML"
    video_title: "__video__ | Vidéo de niveau"
    game_development_title: "__level__ | Développement De Jeu "
    web_development_title: "__level__ | Développement Web"
  ...
  common:
    default_title: "CodeCombat - Jeux de codage pour apprendre Python et JavaScript"
    default_meta_description: "Apprenez le code saisi à travers un jeu de programmation. Apprenez Python, JavaScript et HTML en résolvant des énigmes et apprenez à créer vos propres jeux et sites de codage."
  ...
  play_level:
    ...
    restart_really: "Vous êtes sûr que vous voulez redémarrer le niveau? Vous perdrez tout le code que vous avez écrit."
    restart_confirm: "Oui, redémarrer"
    ...
    tome_cast_button_update: "Mise à jour"
    ...
    learn_new_concepts: "Apprendre de nouveaux concepts"
    watch_a_video: "Regarder une vidéo sur __concept_name__"
    concept_unlocked: "Concept débloqué"
    use_at_least_one_concept: "Utilisez au moins un concept: "
    command_bank: "Banque de commandement"
    learning_goals: "Buts d'apprentissage"
    start: "Début"
    vega_character: "Caractère Vega"
  ...
  avatar_selection:
    pick_an_avatar: "Choisissez un avatar qui vous représentera en tant que joueur"
  ...
  choose_hero:
    ...
    cpp_blurb: "(Réservé aux abonnés) Développement de jeux et calcul haute performance."
    status: "Statut"
    weapons: "Arme"
  ...
  char_customization_modal:
    heading: "Personnalisez votre héros"
    body: "Corps"
    name_label: "Nom du héros"
    hair_label: "Couleur de cheveux"
    skin_label: "Couleur de peau"
  ...
  skill_docs:
    ...
    still_undocumented: "Toujours non documenté, désolé."
  ...
  about:
    title: "A propos de CodeCombat - Mobiliser les étudiants, responsabiliser les enseignants, inspirer la création"
    meta_description: "Notre mission est de niveler l'informatique par le biais d'un apprentissage basé sur le jeu et de rendre le codage accessible à chaque apprenant. Nous croyons que la programmation est magique et souhaitons que les apprenants soient habilités à créer des choses à partir d’imagination pure."
    ...
    lawrence_title: "Responsable De La Réussite Client"
    sean_title: "Chargé De Compte Senior"
    liz_title: "Chargé De Compte Senior"
    jane_title: "Chargé Du Compte"
    shan_title: "Responsable Du Développement Des Partenariats, Chine"
    run_title: "Chef Des Opérations, Chine"
    lance_title: "Stagiaire Ingénieur Logiciel, Chine"
    matias_title: "Ingénieur Logiciel Senior"
    ryan_title: "Spécialiste Du Support Client"
    maya_title: "Développeur De Programmes D'études Senior"
    bill_title: "Directeur Général, Chine"
    shasha_title: "Produit Et Concepteur Visuel"
    daniela_title: "Responsable Marketing"
    chelsea_title: "directeur Des Opérations"
    claire_title: "Assistant Exécutif"
    bobby_title: "Designer De Jeu"
    brian_title: "Concepteur De Jeu Principal"
    andrew_title: "Ingénieur Logiciel"
    stephanie_title: "Spécialiste Du Support Client"
    rob_title: "Représentant Du développement Des Ventes"
    shubhangi_title: "Ingénieur Logiciel Senior"
  ...
  teachers_quote:
    ...
    referrer_conference: "Conférence (e.g. ISTE)"
    ...
    not: "Non"
    full_name_required: "Prénom et nom requis"
  ...
  cinematic:
    click_anywhere_continue: "cliques n'importe où pour continuer"
  ...
  clans:
    title: "Rejoindre les clans CodeCombat - Apprenez à coder en Python, JavaScript et HTML"
    clan_title: "__clan__ - Rejoindre les clans CodeCombat et apprenez à Coder"
    meta_description: "Rejoignez un clan ou construisez votre propre communauté de codeurs. Jouez à des niveaux d'arène multijoueurs et améliorez votre héros et vos compétences en matière de codage."
    clan: "Clan"
    clans: "Clans"
  ...
  courses:
    ...
    estimated_class_dates_label: "Dates de cours estimées"
    estimated_class_frequency_label: "Fréquence de classe estimée"
    ...
    ranking_players: "Joueurs"
    ranking_completed_leves: "Niveaux terminés"
    challenge: "Défi:"
    ...
    concept_videos: "Vidéos de concept"
    concept: "Concept:"
    basic_syntax: "Syntaxe de base"
    while_loops: "Boucle While"
    variables: "Variables"
    basic_syntax_desc: "La syntaxe est la façon dont nous écrivons le code. Tout comme l'orthographe et la grammaire sont importantes pour la rédaction de récits et d'essais, la syntaxe est importante pour l'écriture de code. Les humains savent bien ce que signifie quelque chose, même si ce n'est pas tout à fait correct, mais les ordinateurs ne sont pas si intelligents et ils ont besoin de votre part pour écrire très précisément."
    while_loops_desc: "Une boucle est un moyen de répéter des actions dans un programme. Vous pouvez les utiliser pour ne plus avoir à écrire de code répétitif et lorsque vous ne savez pas exactement combien de fois une action devra être exécutée pour accomplir une tâche."
    variables_desc: "Travailler avec des variables, c'est comme organiser des choses dans des boîtes à chaussures. Vous donnez un nom à la boîte à chaussures, comme \ "Fournitures scolaires \", puis vous placez des objets à l'intérieur. Le contenu exact de la boîte peut changer avec le temps, mais ce qui se trouve à l'intérieur sera toujours appelé \ "Fournitures scolaires". En programmation, les variables sont des symboles utilisés pour stocker des données qui changeront au cours du programme. Les variables peuvent contenir divers types de données, notamment des nombres et des chaînes."
    locked_videos_desc: "Continuez à jouer pour déverrouiller le video du concept __concept_name__."
    unlocked_videos_desc: "Revoir la vidéo du concept __concept_name__."
    video_shown_before: "Montré avant __level__"
    link_google_classroom: "Lien de salle de classe Google "
    select_your_classroom: "Sélectionnez votre salle de classe"
    no_classrooms_found: "Aucune salle de classe trouvée"
    create_classroom_manually: "Créer une salle de classe manuellement"
    classes: "Classes"
    certificate_btn_print: "Imprimer"
    certificate_btn_toggle: "Basculer"
    ask_next_course: "Voulez-vous jouer plus? Demandez à votre professeur d’avoir accès au prochain cours."
    set_start_locked_level: "Définir le niveau de démarrage bloqué"
    no_level_limit: "Pas de limit"
  ...
  teacher:
    ...
    appreciation_week_blurb1: "Pour <strong>Semaine d'appréciation des enseignants 2019</strong>, nous offrons des licences gratuites d'une semaine!<br />Envoyer un courriel à Rob Arevalo (<a href=\"mailto:robarev@codecombat.com?subject=Teacher Appreciation Week\">robarev@codecombat.com</a>) avec ligne d'objet \"<strong>Teacher Appreciation Week</strong>\", et inclure:"
    appreciation_week_blurb2: "le nombre de licences d'une semaine que vous souhaitez (1 par élève)"
    appreciation_week_blurb3: "l'adresse e-mail de votre compte enseignant CodeCombat"
    appreciation_week_blurb4: "si vous souhaitez des licences pour la semaine 1 (du 6 au 10 mai) ou la semaine 2 (du 13 au 17 mai)"
    ...
    open_ended_level: "Niveau ouvert"
    partial_solution: "Solution partielle"
    capstone_solution: "Solution Capstone"
    ...
    paren_new: "(nouveau)"
    student_code: "Code d'étudiant de __name__"
...
#    teacher_quest_reach_gamedev_step1: "[Get licenses](/teachers/licenses) so that your students can explore new worlds, like Game Development and Web Development!"
    ...
    concept: "Concept"
    sync_google_classroom: "Synchroniser Google Classroom"
    try_ozaria_footer: "Essayez notre nouveau jeu d'aventure, Ozaria!"

  teacher_ozaria_encouragement_modal:
    title: "Développer des compétences en informatique pour sauver Ozaria"
    sub_title: "Vous êtes invités à essayer le nouveau jeu d'aventure de CodeCombat"
    cancel: "Retour à CodeCombat"
    accept: "Essayez la première unité gratuitement"
    bullet1: "Approfondissez la connexion des étudiants à l'apprentissage à travers une histoire épique et un gameplay immersif"
    bullet2: "Enseigner les bases de l'informatique, Python ou JavaScript et les compétences du 21e siècle"
    bullet3: "Libérez votre créativité grâce à des projets clés"
    bullet4: "Instructions de support via des ressources pédagogiques dédiées"
    you_can_return: "Vous pouvez toujours revenir à CodeCombat"
  ...
  ladder:
    title: "Arènes multijoueurs"
    arena_title: "__arena__ | Arènes multijoueurs"
    ...
    ogres: "Bleue"
    live_tournament: "Tournoi en direct"
    awaiting_tournament_title: "Tournoi inactif"
    awaiting_tournament_blurb: "L'arène du tournoi n'est pas actif pour le moment."
    tournament_end_desc: "Le tournoi est terminé, merci d'avoir joué"

  user:
    user_title: "__name__ - Apprenez à coder avec CodeCombat"
    stats: "Stats"
  ...
  ozaria_chrome:
    sound_off: "Désactiver Son"
    sound_on: "Activer Son"
    back_to_map: "Retour À La Carte"
    level_options: "Options De Niveau"
...
#    continue_reading_blog: "Continue Reading on Blog..."
  ...
  concepts:
    ...
    event_spawn: "Frayer Un Événement"
    for_loops: "Boucles Pour"
    for_loops_nested: "Imbriqué pour les boucles"
    ...
    if_statements_nested: "Déclarations Conditionnelles Si imbriquées"
    indexing: "Index des tableaux"
    input_handling_flags: "Traitement des entrées - Drapeaux"
    input_handling_keyboard: "Traitement des entrées - Clavier"
    input_handling_mouse: "Traitement des entrées - Souris"
...
#    heap: "pour six mois d'accès \ "Startup \""
    credits: "Crédits"
...
#    unit_9: "Unité 9: AP Review"
#    unit_10: "Unité 10: Post-AP"
  ...
  hoc_2018_interstitial:
    welcome: "Bienvenue dans Hour de Code 2018 de CodeCombat!"
  ...
  school_administrator:
    title: "Tableau de bord de l'administrateur de l'école"
    my_teachers: "Mes Enseignants"
    last_login: "Dernière Connexion"
    licenses_used: "licences utilisées"
    total_students: "total des étudiants"
    active_students: "étudiants actifs"
    projects_created: "projets créés"
    other: "Autre"
    notice: "Les administrateurs d'école suivants ont un accès en lecture seulement aux données de votre classe:"
    add_additional_teacher: "Besoin d'ajouter un enseignant supplémentaire? Contactez votre responsable de compte CodeCombat ou envoyez un courriel support@codecombat.com. "
    license_stat_description: "Licences disponibles représente le nombre total de licences disponibles pour l'enseignant, y compris les licences partagées."
    students_stat_description: "Le nombre total d'élèves représente tous les élèves de toutes les classes, qu'ils aient ou non des licences appliquées."
    active_students_stat_description: "Les étudiants actifs comptent le nombre d'étudiants qui se sont connectés à CodeCombat au cours des 60 derniers jours."
    project_stat_description: "Les projets créés comptent le nombre total de projets de développement Web et de jeux créés."
    no_teachers: "Vous n'administrez aucun enseignant."

  interactives:
    phenomenal_job: "Travail phénoménal!"
    try_again: "Whoops, essayez à nouveau!"
    select_statement_left: "Whoops, select a statement from the left before hittingsélectionnez une déclaration à gauche avant de cliquer sur \"Soumettre.\""
    fill_boxes: "Whoops, assurez-vous de remplir toutes les cases avant de cliquer sur \"Soumettre.\""
