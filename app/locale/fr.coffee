...
#    teacher_quest_reach_gamedev_step1: "[Get licenses](/teachers/licenses) so that your students can explore new worlds, like Game Development and Web Development!"
  ...
  sharing:
    game: "Jeu"
    webpage: "Page web"
    your_students_preview: "Vos élèves cliqueront ici pour voir leurs projets terminés ! Non disponible dans l'aperçu du enseignant."
    unavailable: "Le partage de liens n'est pas disponible dans l'aperçu du enseignant."
  ...
  account:
    ...
    verify_error: "Quelque chose a mal tourné lors de la vérification de votre email :("
