...
#  school_administrator:
    title: "Tableau de bord de l'administrateur scolaire"
    my_teachers: "Mes professeurs"
    last_login: "Dernière connexion"
    licenses_used: "les licences utilisées"
    total_students: "total des étudiants"
    active_students: "étudiants actifs"
    projects_created: "projets créés"
    other: "Autres"
    notice: "Les administrateurs scolaires suivants ont accès aux données de votre classe en mode lecture seule :"
    add_additional_teacher: "Besoin d'ajouter un enseignant supplémentaire ? Contactez votre responsable de compte CodeCombat ou envoyez un courriel à support@codecombat.com. "
    license_stat_description: "Les licences disponibles représentent le nombre total de licences dont dispose l'enseignant, y compris les licences partagées."
    students_stat_description: "Le total des étudiants représente tous les étudiants de toutes les classes, qu'ils aient ou non une licence."
    ...
    project_stat_description: "Les projets créés comptent le nombre total de projets de développement de jeux et de sites web qui ont été créés."
    no_teachers: "Vous n'administrez aucun professeur."
    totals_calculated: "Comment ces totaux sont-ils calculés ?"
    totals_explanation_1: "Comment ces totaux sont-ils calculés ?"
    totals_explanation_2: "Licences utilisées"
    totals_explanation_3: "Compte le nombre total de licences appliquées aux étudiants sur le nombre total de licences disponibles."
    totals_explanation_4: "Total des étudiants"
    totals_explanation_5: "Recense les élèves des enseignants dans toutes leurs classes actives. Pour voir le nombre total d'étudiants inscrits dans les classes actives et les classes archivées, rendez-vous sur la page des licences des étudiants."
    totals_explanation_6: "Des étudiants actifs"
    totals_explanation_7: "Comptez tous les étudiants qui ont été actifs au cours des 60 derniers jours."
    totals_explanation_8: "Projets créés"
    totals_explanation_9: "Compte le nombre total de jeux et de pages web créés."
#    date_thru_date: "__startDateRange__ thru __endDateRange__"

#  interactives:
    phenomenal_job: "Un travail phénoménal !"
    try_again: "Oups, essayez encore !"
    select_statement_left: "Oups, sélectionnez une déclaration à gauche avant de cliquer sur \"Submit.\""
    fill_boxes: "Oups, assurez-vous de remplir toutes les cases avant de cliquer sur \"Submit.\""

#  browser_recommendation:
    title: "CodeCombat fonctionne mieux sur Chrome !"
    pitch_body: "Pour une expérience optimale de CodeCombat, nous vous recommandons d'utiliser la dernière version de Chrome. Téléchargez la dernière version de Chrome en cliquant sur le bouton ci-dessous !"
    download: "Télécharger Chrome"
    ignore: "Ignorer"

#  admin:
    license_type_full: "Cours complets"
    license_type_customize: "Personnaliser les cours"
