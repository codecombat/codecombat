module.exports = nativeDescription: "français", englishDescription: "French", translation:
  ...
  new_home:
    ...
    become_investor: "pour devenir investisseur de CodeCombat"
...
#    for_leaders_subblurb4: "Students build grit and develop a growth mindset through coding challenges that prepare them for the 500K+ open computing jobs."
    for_teachers_title: "Pour les Professeurs"
    for_teachers_blurb: "Outils pour libérer le potentiel des étudiants"
    for_teachers_subtitle1: "Apprentissage par projet"
...
#    quotes_quote5_author: "Latthaphon Pohpon, Parent"
    ...
    slogan_power_of_play: "Apprenez à coder grâce au pouvoir du jeu"
    teach_cs1_free: "Enseignez CS1 gratuitement"
    teachers_love_codecombat_title: "Les enseignants adorent CodeCombat"
...
#    ozaria_blurb: "An adventure game and Computer Science program where students master the lost magic of coding to save their world. Recommended for educators and students."
    try_codecombat: "Essayer CodeCombat"
    try_ozaria: "Essayer Ozaria"
...
#    for_educators: "For Educators"
    ...
    for_everyone: "Pour tout le monde"
...
#    what_our_customers_are_saying: "What Our Customers Are Saying"
    game_based_learning: "Apprentissage basé sur le jeu"
...
#    help_enjoy_learning_blurb: "Our products have helped over 20 million students enjoy learning Computer Science, teaching them to be critical, confident, and creative learners. We engage all students, regardless of experience, helping them to realize a pathway to success in Computer Science."
    global_community: "Rejoignez notre communauté mondiale"
    million: "__num__ Million"
    billion: "__num__ Milliard"
...
#    impact: "Impact"
    ...
    parent: "Parents"
#    esports: "Esports"
    browser_recommendation: "Pour une expérience optimale, nous vous recommandons d'utiliser la dernière version de Chrome. Téléchargez le navigateur ici !"
...
#    funding_resources_guide: "Funding Resources Guide"
  ...
  new_home_faq:
    ...
    python_and_javascript: "Nous prenons actuellement en charge Python et JavaScript."
    why_python: "Pourquoi choisir Python ?"
...
#    javascript_versus_python: "JavaScript’s syntax is a little more difficult for beginners than Python, so if you cannot decide between the two, we recommend Python."
    how_do_i_get_started: "Comment démarrer?"
    getting_started_1: "Créer votre compte Enseignant"
    getting_started_2: "Créer une classe"
    getting_started_3: "Ajouter des étudiants"
    getting_started_4: "Asseyez-vous et regardez vos élèves s'amuser en apprenant à coder"
...
#    clever_integration_faq: "Clever Integration FAQ"
    google_classroom: "Qu'en est-il de la salle de classe Google ?"
    google_classroom_blurb1: "Ouais! Assurez-vous d'utiliser le mode d'authentification unique de Google pour vous inscrire à votre compte d'enseignant. Si vous avez déjà un compte utilisant votre e-mail Google, utilisez le mode d'authentification unique de Google pour vous connecter la prochaine fois. Dans la fenêtre Créer une classe, vous verrez une option pour lier Google Classroom. Nous ne prenons en charge que l'inscription via Google Classroom pour le moment."
...
#    how_much_does_it_cost_blurb: "We customize solutions for schools and districts and work with you to understand your use case, context, and budget. __contact__ for further details! See also our __funding__ for how to leverage CARES Act funding sources like ESSER and GEER."
    recommended_systems: "Existe-t-il un navigateur et un système d'exploitation recommandés ?"
    recommended_systems_blurb: "CodeCombat et Ozaria fonctionnent mieux sur des ordinateurs avec au moins 4 Go de RAM, sur un navigateur moderne tel que Chrome, Safari, Firefox ou Edge. Les Chromebooks avec 2 Go de RAM peuvent avoir des problèmes graphiques mineurs dans les cours ultérieurs. Un minimum de 200 Kbps de bande passante par étudiant est requis, bien que 1+ Mbps soit recommandé."
    other_questions: "Si vous avez d'autres questions, merci __contact__."
    see_faq_prefix: "Voir plus"
    see_faq_link: "questions fréquemment posées dans notre centre d'aide"
#    see_faq_suffix: "."
...
#    simulate_all: "Simulate All"
  ...
  login:
    ...
    accounts_merge_confirmation: "Un compte est déja associé à l'e-mail de ce compte Google. Souhaitez-vous fusionner ces comptes ?"
...
#    create_account_to_submit_multiplayer: "Create a free account to rank your multiplayer AI and explore the whole game!"
    ...
    activation_code_used: "Le code d'activation a été utilisé. Vérifiez l'orthographe ou demandez de l'aide à votre professeur."
    ...
    confirm_individual_blurb_without_email: "Notez vos informations de connexion au cas où vous en auriez besoin plus tard."
    ...
    password_requirements: "8 à 64 caractères sans répétition"
    invalid: "Invalide"
...
#    complete: "Complete"
  ...
  play_level:
    ...
    restart_really: "Voulez-vous vraiment recommencer le niveau ? Vous perdrez tout le code que vous avez écrit."
    restart_confirm: "Oui, Recommencer"
...
#    vega_character: "Vega Character"
    ...
    fill_in_solution: "Remplir la solution"
    play_as_humans: "Jouer en tant que Rouge"
    play_as_ogres: "Jouer en tant que Bleu"
...
#    cpp_blurb: "(Subscriber Only) Game development and high performance computing."
  ...
  skill_docs:
    ...
    still_undocumented: "Pas encore documenté, désolé."
...
#    anything_else_helper: ""
  ...
  cinematic:
    click_anywhere_continue: "cliquez n'importe où pour continuer"
...
#    meta_description: "Join a Clan or build your own community of coders. Play multiplayer arena levels and level up your hero and your coding skills."
  ...
  courses:
    ...
    lesson_slides: "Diapositives de cours"
...
#    estimated_class_frequency_label: "Estimated Class Frequency"
    classes_per_week: "classes par semaine"
    ...
    license_required_to_play: "Demandez à votre enseignant de vous attribuer une licence pour que vous puissiez continuer à jouer à CodeCombat !"
...
#    link_google_classroom: "Link Google Classroom"
    select_your_classroom: "Selectionnez votre salle de classe"
...
#    no_level_limit: "-- (no levels locked)"
    ask_teacher_to_unlock: "Demander à l'enseignant de déverrouiller"
#    ask_teacher_to_unlock_instructions: "To play the next level, ask your teacher to unlock it on their Course Progress screen"
    play_next_level: "Jouer le Niveau suivant"
    play_tournament: "Jouer au Tournoi"
    levels_completed: "Niveaux terminés: __count__"
#    ai_league_team_rankings: "AI League Team Rankings"
    view_standings: "Voir le classement"
    view_winners: "Voir les gagnants"
...
#    engineering_cycle_worksheet_desc: "Use this worksheet to teach students the basics of the engineering cycle: Assess, Design, Implement and Debug. Refer to the completed example worksheet as a guide."
    ...
    customized_license: "Licence personnalisée"
    trial: "Essai"
...
#    hoc_meta_description: "Make your own game or code your way out of a dungeon! CodeCombat has four different Hour of Code activities and over 60 levels to learn code, play, and create."
    hoc_intro: "Il y a trois façons pour votre classe de participer à l'heure de code avec CodeCombat"
...
#    revoke_confirm: "Are you sure you want to revoke a Full License from {{student_name}}? The license will become available to assign to another student."
    revoke_alert_no_student: "Veuillez d'abord selectionner les étudiants."
    revoke_selected_confirm: "Êtes-vous sûr de vouloir révoquer les licences de tous les étudiants selectionnés ?"
...
#    sync_google_classroom: "Sync Google Classroom"
    ...
    try_ozaria_free: "Essayez Ozaria gratuitement"
...
#    description3: "All the actionable insights educators need at a glance, such as student progress and concept understanding."
  ...
  share_licenses:
    ...
    have_not_shared: "Vous n'avez pas partagé ces licences avec cet enseignant."
  ...
  sharing:
    game: "Jeu"
    webpage: "Page web"
    your_students_preview: "Vos élèves cliqueront ici pour voir leurs projets terminés ! Non disponible dans l'aperçu de l'enseignant(e)."
    unavailable: "Le partage de liens n'est pas disponible dans l'aperçu de l'enseignant(e)."
    ...
    share_ladder_link: "Partager le lien multijoueur"
    ladder_link_title: "Partagez votre lien de match multijoueur"
    ladder_link_blurb: "Partagez votre lien de combat IA pour que vos amis et votre famille puissent jouer contre votre code:"
...
#    resource_edit_title: "Edit Resource"
    ...
    new_course_title: "Créer un nouveau cours"
    new_course_title_login: "Connectez-vous pour créer un nouveau cours"
...
#    new_resource_title_login: "Log In to Create a New Resource"
    ...
    course_search_title: "Rechercher des cours"
#    resource_search_title: "Search Resources"
  ...
  contribute:
    ...
    diplomat_introduction_url: "communauté open source"
    ...
    ambassador_join_step1: "Lire la documentation."
    ambassador_join_step2: "Retrouvez-nous sur notre chaîne publique Slack."
    ambassador_join_step3: "Aidez les autres dans la catégorie Ambassadeur."
  ...
  ladder:
    ...
    tournament_starts: "Le tournoi commence __timeElapsed__"
    tournament_started: ", a démarré"
    tournament_ends: "Fin du tournoi"
    tournament_ended: "Tournoi terminé"
    tournament_results_published: ", résultats publiés"
  ...
  user:
    user_title: "__name__ - Apprendre à corder avec CodeCombat"
    stats: "Stats"
    ...
    heroes_unlocked: "Héros débloqués"
    current_items: "Objets équipés"
    contributor_badges: "Badges de contributeur"
    contributions_title: "Contributions"
#    type_stat: "Type" # As in, which type of contribution
    patches_submit: "Correctifs soumis"
    patches_approved: "Correctifs approuvés"
    patches_accepted: "Correctifs acceptés"
...
#    continue_reading_blog: "Continuer la lecture sur le Blog..."
  ...
  loading_error:
    ...
    too_many_login_failures: "Il y a eu trop de tentatives de connexion infructueuses. Veuillez réessayer plus tard."
...
#    event_spawn: "Spawn Event"
    for_loops: "Boucles for"
    for_loops_nested: "Boucles for imbriquées"
...
#    input_handling_flags: "Input Handling - Flags"
  ...
  anonymous_teacher:
    ...
    teacher_notified: "Nous avons informé votre enseignant(e) que vous voulez jouer plus de CodeCombat dans votre classe"
  ...
  legal:
    ...
    cookies_allow: "Autoriser les cookies"
  ...
  server_error:
    ...
    easy_password: "Le mot de passe est trop simple à deviner"
    reused_password: "Le mot de passe ne peut être réutilisé"
...
#    type_error: "TypeError: "
    ...
    x_not_defined: "$1 n'est pas définie"
    spelling_issues: "Attention aux problèmes d'orthographe: voulez-vous dire `$1` à la place de `$2`?"
    capitalization_issues: "Attention aux majuscules: `$1` doit être `$2`."
#    py_empty_block: "Empty $1. Put 4 spaces in front of statements inside the $2 statement."
    fx_missing_paren: "Si vous souhaitez appeler `$1` comme une fonction, vous devez ajouter `()`"
...
#    unterminated_string: "Unterminated string. Add a matching `\"` at the end of your string."
    ...
    missing_quotes: "Guillemets manquants. Essayez `$1`"
...
#    target_a_unit: "Target a unit."
    attack_capitalization: "Attaquer $1, et non $2. (Les majuscules sont importantes.)"
...
#    too_much_indentation: "Too much indentation at the beginning of this line."
    missing_hero: "Le mot-clé `$1` est manquant; devrait être `$2`."
...
#    unexpected_end_of: "Unexpected end of input"
    unnecessary_semicolon: "Point-virgule inutile."
...
#    attacks_argument_enemy_has: "`$1`'s argument `$2` has a problem."
    ...
    target_is_null_is: "La cible est $1. Y a-t-il toujours une cible à attaquer? (Use $2?)"
...
#    did_you_mean: "Did you mean $1? You do not have an item equipped with that skill."
    missing_a_quotation_mark: "Il manque des guillemets. "
    missing_var_use_var: "Il manque `$1`. Utilisez `$2` pour créer une nouvelle variable."
    you_do_not_have: " Vous n'êtes pas équipé d'objet pour la compétence $1."
    put_each_command_on: "Ecrire chaque commande sur une ligne séparée"
...
#    paragraph_5: "Thank you for choosing CodeCombat and good luck on your computer science journey!"
    back_to_coco: "Retour à CodeCombat"
  ...
  hoc_2018:
    ...
    page_heading_ai_league: "Vos élèves apprendront à coder leur propre IA multijoueur !"
