...
#    become_investor: "to become an investor in CodeCombat"
    ...
    century_skills_quote2: "Tout le monde faisait des labyrinthes, alors moi j'ai pensé ‘capture de drapeau’ et c'est ce que j'ai fait."
    ...
    century_skills_subblurb3: "Durant le jeu, il y a des opportunités pour les étudiants de collaborer losqu'ils sont coincés et de travailler ensemble en utilisant notre guide de programmation en duo."
    century_skills_quote4: "J'ai toujours eu envie de concevoir des jeux vidéos et d'apprendre à coder ... ça me donne un vrai point de départ."
...
#    top_banner_summer_camp: "Enrollment now open for our summer coding camps–ask us about our week-long virtual sessions starting at just $199."
    ...
    forgot_learning: "Je crois qu'ils ont oublié qu'ils étaient en train d'apprendre quelque chose." # {change}
    wanted_to_do: "Programmer est quelque chose que j'ai toujours voulu faire, et je n'ai jamais pensé pouvoir l'apprendre à l'école."
    builds_concepts_up: "J'aime la façon dont CodeCombat construit les concepts. C'est vraiment facile et amusant à comprendre."
    why_games: "Pourquoi est-ce qu'apprendre en jouant est-il important?"
    games_reward: "Les jeux récompensent l'effort productif."
    encourage: "Le jeu est un moyen qui encourage l'interaction, la découverte, l'essai et l'erreur. Un bon jeu met le joueur au défi d'apprendre à maîtriser de nouvelles compétences au fil du temps, ce qui correspond au même processus critique que l'on retrouve au niveau de l'éducation."
    ...
    great_game: "Un bon jeu c'est plus qu'une série d'insignes et d'accomplissements - celà relève de l'aventure d'un joueur, d'énigmes bien conçues et de la capacité d'entreprendre des défis avec confiance et détermination."
    agency: "CodeCombat est un jeu qui donne aux joueurs cette confiance et détermination avec l'aide de notre interprèteur de lignes de code, qui aide les étudiants débutants ainsi qu'avancés à concevoir des programmes bien écrits et valides."
    ...
    logged_in_as: "Vous êtes actuellement engistré en tant que"
    computer_science: "Des cours d'informatique pour tout âge" # {change}
    ffa: "Gratuit pour tous les étudiants"
    ...
    winning: "Une combinaison gagnante d'éléments de jeux de rôles et de programmation qui permet aux enfants d'apprendre de façon réellement plaisante."
    run_class: "Tout ce dont vous avez besoin pour enseigner l'informatique dans votre classe aujourd'hui, sans expérience préalable en informatique."
    goto_classes: "Aller à Mes Classes"
    view_profile: "Voir Mon Profil"
    view_progress: "Voir Progrès"
    go_to_courses: "Aller à Mes Cours"
    want_coco: "Voulez-vous CodeCombat pour votre école?"
#    educator: "Educator"
#    student: "Student"
