...
#    revoke_selected_confirm: "Are you sure you want to revoke Licenses from all selected students?"
    ...
    teacher_quest_teach_methods_step2: "Print de [Snelle Startgids voor Studenten](https://files.codecombat.com/docs/resources/StudentQuickStartGuide.pdf) in de Resource Hub." # {change}
