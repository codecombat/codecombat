...
#    my_units: "My Units"
    ...
    parent: "Rodiče"
#    faq: "FAQ"
    return_coco: "Vrátit se do CodeCombat"
#    classes: "Classes"
...
#  new_home_faq:
    what_programming_languages: "Jaké programovací jaziky jsou k dispozici?"
    python_and_javascript: "V současné době podporujeme  Python a JavaScript."
    why_python: "Proč jsme si vybrali Python?"
    why_python_blurb: "Python je vhodný i pro záčátečníky a v sooučasné době ho používají velké společnosti(stejně jako GOogle). Když jsi menší nebo se poprvé setkáváš s kódem, doporučujeme Python."
    why_javascript: "Proč jsme si vybrali JavaScript?"
#    why_javascript_blurb: "JavaScript is the language of the web and is used across nearly every website. You may prefer to choose JavaScript if you are planning to also study web development. We’ve also made it easy for students to transition from Python to JavaScript-based web development."
    javascript_versus_python: "JavaScriptí synte je o něco složitější než Python, takže když se rozhodujete mezi těmato dvouma my doporučujeme Python."
    how_do_i_get_started: "Jak můžu začít?"
    getting_started_1: "Vytvořte Teacher Account"
    getting_started_2: "Vytvořte třídu"
    getting_started_3: "Přidjte studenty"
    getting_started_4: "Sedněte si stranou a pozorujte vaše studenty jakse hravou formou učí programovat."
    main_curriculum: "Mohu použít CodeCombat nebo Ozaria jako můj současný program na studio ?"
...
#    sign_in: "Sign In"
    ...
    already_have_account1: "Máte již účet studenta nebo učitele(y)?"
