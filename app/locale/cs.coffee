module.exports = nativeDescription: "čeština", englishDescription: "Czech", translation:
  home:
    ...
    play_campaign_version: "Hrát Kampaň" # Shows up under big play button if you only play /courses
...
#    compete: "Compete!" # Course details page
    ...
    play_classroom_version: "Hrát školní verzi" # Choose a level in campaign version that you also can play in one of your courses
...
#    campaign_old_multiplayer_description: "Relics of a more civilized age. No simulations are run for these older, hero-less multiplayer arenas."
  ...
  signup:
    ...
    school_name: "Jméno školy a město"
    optional: "nepovinné"
    school_name_placeholder: "Příklad SPŠ Purkyňova, Brno"
  ...
  play_level:
    completed_level: "Dokončena úroveň:"
#    course: "Course:"
    done: "Hotovo"
    ...
    victory_review_placeholder: "Jak se ti líbila úroveň?"
    ...
    victory_viking_code_school: "No to mě podrž, tohle byla zatraceně těžká úroveň! Pokud ještě nejsi softwarový vývojář, tak bys to měl zkusit. Právě jsi byl urychleně přijat na Vikingskou Školu Kódování, kde se můžeš své schopnosti ještě zvýšit a stát se profesionálním webovým vývojářem za 14 týdnů."
    victory_become_a_viking: "Staň se Vikingem"
    ...
    time_total: "Max:"
    time_goto: "Jít na:"
    non_user_code_problem_title: "Úroveň nejde nahrát"
    infinite_loop_title: "Detekován nekonečný cyklus"
    infinite_loop_description: "Počáteční kód pro vybudování světa nikdy nedoběhl. Je pravděpodobně buď opravdu pomalý nebo obsahuje nekonečný cyklus. Nebo v něm může být chyba. Můžeš ho zkusit spustit ještě jednou nebo resetovat do původního stavu. Pokud ani to nepomůže, dej nám vědět."
    check_dev_console: "Taky si můžeš otevžít vývojářskou konzoli a pojívat se, co by mohlo být špatně."
    ...
    tip_tell_friends: "Líbí se ti CodeCombat? Řekni o něm svým kamarádům!"
    ...
    tip_hate_computers: "S lidmi, kteří si myslí, že nenávidí počítače, je to tak, že ve skutečnosti nenávidí mizerné programátory. - Larry Niven"
    tip_open_source_contribute: "I ty můžeš pomoci s vylepšením CodeCombat!"
    tip_recurse: "Opakovat se je lidské, cyklit rekurzivně je bežské. - L. Peter Deutsch"
    tip_free_your_mind: "Musíš to nechat všechno být, Neo. Strach, pochybnosti a nedůvěru. Osvobod' svou mysl. - Morpheus"
    tip_strong_opponents: "I ti nejsilnější protivníci mají vždycky nějakou slabinu. - Itachi Uchiha"
    tip_paper_and_pen: "Než začneš programovat, můžeš si vždycky napsat plán tužkou na papír."
    tip_solve_then_write: "Nejdřív vyřeš problém. Teprve pak napiš kód. - John Johnson"
  ...
  leaderboard:
    ...
    scores: "Skóre"
    top_players: "Nejlepší hráči podle"
    day: "Den"
    week: "Tento týden"
    all: "Celkově"
    time: "Času"
  ...
  subscribe:
    comparison_blurb: "Vylepši své schopnosti s předplatným CodeCombat!"
    feature1: "110+ základních úrovní napříč 4 světy"
    feature2: "10 silných <strong>nových hrdinů</strong> s jedinečnými dovednostmi!"
    feature3: "80+ bonusových úrovní"
    ...
    unsubscribe_feedback_placeholder: "Oh, copak jsme provedli?"
    ...
    parents_blurb1a: "Programování je základní dovednost, kterou vaše dítě zaručeně využije jako dospělý. V roce 2020 budou základní softwarové dovednosti potřebné pro 77% zaměstnání, a softwarový inženýři jsou vysoce žádaní po celém světě. Věděli jste, že informatika je nejlépe placený vysokoškolský obor?"
    ...
    payment_methods_title: "Přijímané platební metody"
    payment_methods_blurb1: "V současnosti přijímáme kraditní karty a Alipay. Také můžete zaplatit přes PayPal {{three_month_price}} USD na účet nick@codecombat.com, v poznámce uveďte email svého účtu, za tříměsíční předplatné nebo ${{year_price}} za celý rok."
    payment_methods_blurb2: "Pokud vyžadujete jinou formu platby, kontaktujte nás prosím"
    sale_button: "Výprodej!"
    sale_button_title: "Ušetřete $21 při koupi ročního předplatného"
    stripe_description: "Měsíční předplatné"
    stripe_description_year_sale: "1 roční předplatné (${{discount}} sleva)"
    ...
    personal_sub: "Osobní předplatné"  # Accounts Subscription View below
    loading_info: "Nahrávám informace o předplatném..."
    managed_by: "Managed by"
    will_be_cancelled: "Skončí k"
    currently_free: "V současnosti máte volné předplatné"
    currently_free_until: "V současnosti máte předplatné do"
    was_free_until: "Měli jste volné předplatné do"
    managed_subs: "Spravované předplatné"
    subscribing: "Prihlašuji..."
    current_recipients: "Současní adresáti"
    unsubscribing: "Odhlašuji"
    subscribe_prepaid: "Pro použití předplaceného kódu klikněte na Předplatné"
    using_prepaid: "Používáte předplacený kód pro měsíční předplatné"
  ...
  choose_hero:
    ...
    skills: "Dovednosti"
    attack_1: "Způsobuje"
    attack_2: "poškození uvedeného u zbraně pro hrdiny typu"
    attack_3: "."
    health_1: "Dostává"
    health_2: "zdraví uvedeného u brnění pro hrdiny typu"
    health_3: "."
    speed_1: "Pohybuje se rychlostí"
    speed_2: "metrů za sekundu."
  ...
  skill_docs:
    ...
    action_specific_cooldown: "Odpočinek"
  ...
  about:
    ...
    team: "Tým"
    nick_title: "Spoluzakladatel, CEO"
    nick_blurb: "Motivační guru"
    matt_title: "Spoluzakladatel, CTO"
    matt_blurb: "Cyklista"
    cat_title: "Herní návrhář"
#    cat_blurb: "Airbender"
    scott_title: "Spoluzakladatel, Softwarový inženýr"
    scott_blurb: "Ten rozumný"
    maka_title: "Obhájce zákazníků"
    maka_blurb: "Vypravěč příběhů"
    rob_title: "Softwarový inženýr"
    rob_blurb: "Kóduje tohle a tamto"
    josh_c_title: "Herní návrhář"
    josh_c_blurb: "Navrhuje hry"
#    robin_title: "UX Design & Research"
#    robin_blurb: "Scaffolding"
    josh_title: "Herní návrhář"
    josh_blurb: "Podlaha je láva"
    retrostyle_title: "Ilustrátor"
    retrostyle_blurb: "RetroStyle Games"
    jose_title: "Hudba"
    jose_blurb: "Vzlétám"
    carlos_title: "Reginální Manager, Brazílie"
...
#    god_mode: "God Mode"
    ...
    type_in_email: "Napiš svůj email pro potvrzení smazání."
    type_in_email_progress: "Napiš svůj email pro potvrzení smazání progresu."
    type_in_password: "Ještě napiš své heslo."
  ...
  community:
    ...
    social_github: "Stáhněte si všechen náš kód z GitHubu"
...
#    length: "Length:"
  ...
  editor:
    ...
    level_tab_thangs_search: "Hledej Thangy"
    ...
    new_poll_title: "Vytvoř novou Anketu"
    new_poll_title_login: "Přihlas se, abys mohl vytvořit novou Anketu"
    ...
    poll_search_title: "Hledej Ankety"
    ...
    pop_i18n: "Nahraj I18N"
    tasks: "Úkoly"
    clear_storage: "Smaž své lokální změny"
    add_system_title: "Přidej systémy do úrovně"
    done_adding: "Přidávání dokončeno"
  ...
  contribute:
    ...
    teacher_subscribe_desc: "Dostávat emailem oznámení a informace pro učitele"
...
#    simulation_explanation_leagues: "You will mainly help simulate games for allied players in your clans and courses."
    ...
    games_in_queue: "Hry, které jsou momentálně ve frontě:"
    ...
    defeat_the: "Poraženo"
    watch_battle: "Sleduj bitvu"
    tournament_started: ", začal"
...
#    tournament_blurb_ace_of_coders: "Battle it out in the frozen glacier in this domination-style mirror match! The tournament began on Wednesday, September 16 and will run until Wednesday, October 14 at 5PM PDT. Check out the details"
    ...
    winners: "Vítězové"
    league: "Liga"
    red_ai: "Červení CPU" # "Red AI Wins", at end of multiplayer match playback
    blue_ai: "Modří CPU"
    wins: "vyhráli" # At end of multiplayer match playback
    humans: "Červení" # Ladder page display team name
    ogres: "Modří"
...
#    you_can3: "that can be applied to your own account or given to others."
  ...
  loading_error:
    ...
    connection_failure_desc: "Vypadá to, že nejste připojeni k internetu! Zkontrolujte své síťové připojení a poté obnovte stránku."
    login_required: "Vyžadováno přihlášení"
    login_required_desc: "Musíte se přihlásit, abyste měli přístup k této stránce."
    unauthorized: "Musíte se přihlásit. Máte zapnuté cookies?"
    forbidden: "Nemáte oprávnění."
    forbidden_desc: "Ale ne, tady není nic, co bychom vám mohli ukázat! Ujistěte se, že jste přihlášeni ke správnému účtu nebo navštivte jeden z následujících odkazů, který vás dovede zpět k programování!"
    not_found: "Nenalezeno."
    not_found_desc: "Hm, tady nic není. Navštivte jeden z následujících odkazů, který vás dovede zpět k programování!"
    ...
    error: "CHYBA"
    general_desc: "Něco je špatně a je to nejspíš naše chyba. Zkuste chvilku počkat a pak obnovit stránku nebo navštivte jeden z následujících odkazů, který vás dovede zpět k programování!"
  ...
  concepts:
    ...
    boolean_logic: "Boolovská logika"
    break_statements: "Příkazy pro ukončení"
    classes: "Třídy"
    continue_statements: "Příkazy pro pokračování"
    for_loops: "For cykly"
    functions: "Funkce"
    graphics: "Grafika"
  ...
  legal:
    ...
    cost_title: "Cena"
    cost_description: "CodeCombat nabízí zdarma hraní všech základních úrovní, s předplatným ${{price}} USD/měsíc přístup k dalším úrovním a větvím a {{gems}} bonusových drahokamů měsíčně. Zrušit ho můžete jediným kliknutím a nabízíme záruku vrácení 100% ceny."
    ...
    third_party_title: "Služby třetích stran"
    third_party_description: "CodeCombat využívá následující služby třetích stran (mimo jiné):"
