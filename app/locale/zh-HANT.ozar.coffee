...
#    anon_signup_create_teacher: "Create free teacher account"
    ...
    get_more_codecombat: "取得更多 CodeCombat" # "Get More CodeCombat"
    back_to_dashboard: "返回管理介面"
    back_to_ozaria: "返回 ozaria.com"
    customize_hero: "自訂英雄角色"
    account_settings: "帳號設定"
    back_to_tutorial: "返回入門教學"
    teacher_vega_message: "這些入門教學資訊將指導學生, 為了不影響您原本的遊戲進度與查看這些教學資訊, 請創建一個學生帳戶並利用它來玩 Ozaria" # "Students are guided by these tutorial messages. In order to view these messages and to save your progress as you play through the game, please create a student account and play Ozaria as a student."
  ...
  login:
    auth_sign_up: "剛到 Ozaria? 建立一個帳號吧" # "New to Ozaria? Create an Account"
    sign_up: "註冊"
...
#    sign_in: "Sign In"
    ...
    already_have_account1: "已經有 CodeCombat 教師或學生帳號了嗎?" # "Already have a CodeCombat Teacher or Student account?"
    already_have_account2: "您能使用這些帳號登入 Ozaria.com" # "You can sign into Ozaria.com using that account."
    sign_into_ozaria: "登入 Ozaria.com"
    individual_users_not_supported: "Ozaria 是教室模式! 請到 CodeCombat 繼續遊戲!" # "Ozaria is for classrooms only!  Please visit CodeCombat to continue playing!"
    accounts_merge_confirmation: "已經有帳號與這個 Google Email關聯. 您想合併這些帳號嗎?" # "There is an account associated with the email from this Google account. Would you like to merge these accounts?"
  ...
  signup:
    ...
    teacher_email_announcements: "讓我持續獲得新的教材與教學資源等資訊!" # "Keep me updated on new teacher resources, curriculum, and courses!"
    creating: "帳號建立中…"
    sign_up: "註冊"
    log_in: "登入"
    login: "登入"
