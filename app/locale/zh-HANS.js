module.exports = {
  ...
  translation: {
    ...
    new_home: {
      ...
      hackstack_china_blurb: '支持生成式人工智能全球热门大语言模型GPT-4, Claude 3.5, Stability, Dall-E-3等学习课程和项目开发实践, 是编程进阶学习人工智能的优秀平台，支持斯坦福大学等世界名校研学活动。',
    ...
    play: {
      ...
      // ai_league_button_hover: "参加 AI 联盟电竞赛事",
    ...
    hackstack_page: {
      ...
      remix_description: '通过自定义 AI HackStack **社区库**中的众多项目，为创作过程注入强劲动力。“再创作”功能不仅加速了个人进度，还培育了一个想法快速演进的**协作生态系统**。随着学生对彼此的作品进行再创作和改进，课堂的集体产出将达到新的创意高度，呈现出令人惊叹的学生驱动型创新成果。',
      privacy_title: '安全与隐私',
      ...
      faq_3_answer_1: 'ChatGPT-4：专为自然语言理解和生成任务设计的模型。',
      faq_3_answer_2: 'Claude：专注于 AI 交互性能与安全性的语言模型。',
      faq_3_answer_3: 'Stable Diffusion：根据文本描述生成图像的模型。',
      faq_3_answer_4: 'DALL-E：根据文本提示创作视觉内容的图像生成模型。',
      ...
      learn_2_text: '跨学科课程',
      learn_3_text: '提示工程',
      learn_4_text: '人工智能[NEWLINE]再创作项目',
