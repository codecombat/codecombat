module.exports = {
  ...
  translation: {
    ...
    subscribe: {
      ...
      monthly_inspire: '每天仅需3.3元',
      seasonly_inspire: '一顿火锅的费用',
      yearly_inspire: '全年8.3折',
    },
    ...
    account_prepaid: {
      purchase_code: '购买激活码',
      purchase_code1: '激活码可以为一个或多个 CodeCombat 账号兑换额外的会员时间。',
      purchase_code2: '每个 CodeCombat 账号每次只能兑换一个激活码。',
      purchase_code3: '激活码对应的时长会在账号现有的会员时间基础上延长。',
      purchase_code4: '激活码适用于玩个人版CodeCombat的账号，不能代替“课堂”版本的学生许可。',
