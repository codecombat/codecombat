module.exports = {
  ...
  translation: {
    ...
    ozaria_home: {
      ...
      faq_row3_p_part1: '我们根据学校或培训机构的使用情况、学生规模和预算情况为你提供定制化方案，具体费用请联系扣哒世界/奥佳睿负责人陈老师 [联系方式 - 13811610675/电话同微信号]，我们将和分布在全国各地的合作伙伴一起为你提供优质的教学内容和服务，开发编程竞赛挑战活动，并保证平台使用费用非常合理。',
    ...
    new_home: {
      ...
      title_cn_home: 'CodeCombat - 玩游戏学编程',
      ...
      meta_keywords_cn_home: '玩游戏学编程,CodeCombat,CodeCombat官网,CodeCombat中文,零基础学编程,编程学习,编程自学, Python学习, C++学习, 大学生学习, AI编程, 游戏化学编程,  游戏化学习,零基础转码,零基础Python, Javascript入门,成人零基础,玩游戏学Python,边玩边学,DeepSeek,斯坦福教育科技, 代码地牢,扣哒世界',
      ...
      meta_description_cn_home: '源自硅谷，CodeCombat将枯燥的代码语法转化为沉浸式英雄史诗游戏。集成 AI导师与真实代码实时编译引擎，助力大学生通关即攒出实战项目，赋能职场人碎片化掌握Python。5分钟写出真实代码，让编写程序像玩游戏一样上瘾。',
      ...
      game_based_blurb: '像玩游戏一样学编程。在闯关冒险中，你可以通过写代码指挥角色行动，逐步掌握 Python、C++ 等编程语言，把抽象的代码学习变成看得见、玩得动、能完成任务的学习体验。',
      get_started: '开启编程',
      global_title: '加入我们的全球学习者和教育者社区',
      global_subtitle1: '学习者',
      global_subtitle2: '行代码',
      ...
      see_example: '查看示例',
      slogan: '从玩开始，学会编程，玩转AI',
      slogan_power_of_play: '玩游戏 学编程',
      slogan_subtitle: '从零基础到编程高手',
      ...
      hackstack_china_blurb: '用AI把想法做成作品。从提示词、AI绘画、AI写作到项目创作，你可以在真实任务中学习如何使用大模型工具，把自己的创意变成故事、图片、网站、应用和项目成果。',
      try_codecombat: '试用扣哒世界',
      try_ozaria: '试试奥佳睿',
      try_hackstack: '试用人工智能',
      ...
      promo_modal_title: 'CodeCombat',
      promo_modal_subtitle: '通过史诗级游戏体验学习真正的编程',
      promo_modal_text: '使用 **Python** 和 **JavaScript** 深入学习实际编程，解决精彩的谜题，与敌人战斗，并打下坚实的编程基础。在此过程中，您将学习如何**创建自己的游戏**和**网站**——所有操作都在浏览器中完成，无需下载任何内容。',
    },
    ...
    new_home_faq: {
      ...
      python_and_javascript: '目前CodeCombat支持Python和JavaScript，Lua, Java，html/css 语言， 会员支持 C++。',
      why_python: '为什么选择Python作为编程学习语言?',
      why_python_blurb: 'Python对初学者非常友好，现在是人工智能的基础语言，AI写代码默认的语言就是python，所以想要学习AI编程和AI协作编程，推荐学习python。如果你是零基础第一次学习代码编程，我们强烈推荐你学习Python。',
      why_javascript: '为什么选择JavaScript作为编程学习语言?',
      why_javascript_blurb: 'JavaScript是互联网非常常见的语言，几乎每一个网站都会用到JavaScript。如果你计划学习网页开发，最好从JavaScript开始。我们做了很多技术改进，让Python可以轻松过度到基于JavaScript的网页开发课程上。',
      ...
      getting_started_3: '有问题直接问AI助手',
      getting_started_4: '你可以轻松坐下来观察学生闯关，体验编程学习的乐趣',
      mobile_question: '是否有app下载或者手机版？',
      mobile_question_blurb: 'CodeCombat目前没有手机版app下载，手机端可以通过浏览器访问。我们推荐使用笔记本电脑或台式机学习，学习写代码需要使用键盘，这样学习体验会更顺畅。如果你有Pad，也可以尝试搭配蓝牙键盘使用。手机端也可以把网页图标添加到手机桌面，体验和app类似。 ',
    ...
    play: {
      ...
      locked_campaign: '完成上一个地图以解锁',
      locked_campaign_forest: '完成暗影地牢以解锁该地图',
      locked_campaign_desert: '完成边际森林以解锁该地图',
      locked_campaign_mountain: '完成流金沙漠以解锁该地图',
      locked_campaign_glacier: '完成安息云峰以解锁该地图',
      ...
      change_language: '代码语言/编码类型',
      buy_gems: '购买宝石',
      subscribers_only: '仅会员可用！',
      subscribe_unlock: '加入会员解锁！',
      subscriber_heroes: '现在加入会员，马上解锁Amara、Hushbaum和Hattori吧！',
      subscriber_gems: '现在加入会员，用宝石购买这些英雄吧！',
      practice_license_required: '(练习关卡需要许可证)',
      anonymous: '匿名玩家',
      level_difficulty: '难度：',
      ...
      age_description_codecombat: '人人都能学的实用代码编程',
      age_description_codecombat_junior: '专为低龄孩子设计的图形化编程',
      ...
      home_campaign_redirect_student: '请从您的学生页面访问课程地图。',
      blockly_error_msg: '哎呀！加载代码块时出了点问题。请尝试刷新页面以恢复您的工作区。',
    },
    ...
    login: {
      ...
      login_failed: '登录失败，你可能需要先注册账号。',
    },

    signup: {
      complete_subscription: '继续加入会员',
      ...
      classroom_not_found: '班级码不正确。请检查是否拼写错误或寻求老师帮助。',
      activation_code_used: '兑换码已被使用。请检查是否拼写错误或寻求老师帮助。',
      checking: '检查中...',
      ...
      teacher_list_add_students: '通过点击‘查看班级’按钮来增加学生，之后将班级码或者URL发送给学生。如果他们有邮箱，也可通过邮箱邀请。',
      ...
      already_have_account_q: '已有账号？',
      choose_account_title: '创建账号',
      choose_account_subtitle: '请选择你的账号身份',
      ...
      have_a_classcode: '有班级码吗？',
      yes_i_have_classcode: '是的，我有一个班级码！',
      enter_it_here: '在这里输入你的班级码：',
    ...
    play_level: {
      ...
      victory_sign_up: '立即保存奖励',
      victory_sign_up_poke: '别弄丢你的战利品!注册即可永久保存。',
      ...
      chat_fix_hide: '隐藏',
      chat_fix_show_code: '显示代码',
      chat_fix_hide_code: '隐藏代码',
      apply_code: '应用 =>',
      ...
      not_enough_credits_bot: '[AI_TRANSLATION]哎呀！看起来你的查询次数不够。现在加入会员，获取你需要的 AI 支持查询次数！',
      ...
      ask_teacher_for_credits: '[AI_TRANSLATION]向你的老师请求一个 扣哒宇宙 许可证。',
      get_credits: '[AI_TRANSLATION]获取积分',
      get_ai_hs_license: '[AI_TRANSLATION]获取 扣哒宇宙 许可证',
      use: '创建',
      learn_to_use: '[AI_TRANSLATION]学会使用  ',
      navigate_to_previous_page: '上一页',
      navigate_to_next_page: '下一页',
    ...
    subscribe: {
      best_deal: '最佳优惠!',
      confirmation: '恭喜你！你已经成为 CodeCombat 会员',
      premium_already_subscribed: '你已经是会员了',
      subscribe_modal_title: '加入 CodeCombat 会员',
      comparison_blurb: '亲，想要成为编程高手，那么现在就加入 CodeCombat 会员!',
      must_be_logged: '您需要先登入。请先注册或者在上方的目录中点击登入。',
      subscribe_title: '加入会员',
      unsubscribe: '取消会员',
      confirm_unsubscribe: '确认取消会员',
      ...
      stripe_description: '月度会员',
      stripe_yearly_description: '年度会员',
      buy_now: '立即购买',
      subscription_required_to_play: '成为会员后才可开始本关',
      unlock_help_videos: '成为会员后才可以解锁视频教学哦！',
      personal_sub: '个人会员',
      loading_info: '正在读入会员内容...',
      managed_by: '管理',
      will_be_cancelled: '将被取消',
      currently_free: '您目前是会员',
      currently_free_until: '您的会员有效期到 __date__',
      free_subscription: '免费会员',
      was_free_until: '您有过一个会员，直到',
      managed_subs: '管理会员',
      subscribing: '加入会员中...',
      current_recipients: '当前收件人',
      unsubscribing: '取消会员中',
      subscribe_prepaid: '会员兑换码',
      using_prepaid: '使用兑换码激活会员',
      ...
      feature_level_chat: '🤖 24小时AI老师答疑讲解',
      feature_aiyouth: '🏆 国内国际赛事和夏令营通道',
      feature_gems: '💎 3000宝石/季度(年付尊享16000宝石)',
      //    feature_all_products: "4-in-1: CodeCombat Home, CodeCombat Junior, CodeCombat Worlds on Roblox, and CodeCombat AI HackStack",
      feature_products: '解锁图形化和代码编程所有关卡',
      ...
      season_subscription: '季度会员',
      year_subscription: '年度会员',
      ...
      go_prepaid: '付款后请点这里',
      forever: '终生',
      subscription_status: '你的会员状态',
      currently_not_free: '您目前还不是会员',
      ...
      having_activation_code: '已有会员兑换码？ <a href="/account/prepaid">点击这里使用</a>',
    },

    announcement: {
      now_available: '现在会员可以获得更多内容',
      subscriber: '会员',
    ...
    premium_features: {
      get_premium: '加入<br>CodeCombat<br>会员',
      master_coder: '加入会员成为编程高手！',
      paypal_redirect: '页面将要跳转到PayPal界面以完成加入会员。',
      subscribe_now: '现在加入',
      hero_blurb_1: '会员可使用 __premiumHeroesCount__ 个超级英雄，利用Okar Stompfoot不可阻挡的力量，叶之Naria的致命精度，或Nalfar Cryptor的"可爱"骷髅！',
      ...
      everything_in_premium: '成为CodeCombat会员可获得的内容:',
      ...
      list_support: '获取24小时AI支持，以帮助您调试代码',
      list_clans: '参加AI世青赛和夏令营',
      ai_bot_learning: '[AI_TRANSLATION]AI 提供的支持加速了学习成果！',
      ai_bot_description: '[AI_TRANSLATION]CodeCombat 的 AI 老师可以评估代码，指出错误并解释如何修复它们。最重要的是，它提供了所有理解"为什么"所需的背景信息，而不会提供完整的解决方案。在当前代码问题帮助的情况下，小朋友们仍需完成每一关的编程挑战。会员用户每天可获得 10 个 AI 提示额度，确保他们始终能获得所需支持。',
      list_ai_bot: '会员每天可获得10个 AI 提示额度',
      ai_bot_notice: '[AI_TRANSLATION]* AI老师的提示额度可能会变动。\n',
    },

    choose_hero: {
      choose_hero: '请选择您的英雄',
      choose_junior_hero: '选择你的小英雄',
      sign_up_to_unlock: '注册以解锁!',
      sign_up_pet_blurb: '注册一个账号来使用这个宠物!',
      programming_language: '编程语言',
      ...
      lua_blurb: '一种游戏脚本语言。',
      java_blurb: '(仅会员) Android 和企业的选择。',
      cpp_blurb: '（仅会员）游戏开发和高性能计算。',
      code_format: '编码类型',
      text_code: '真实代码',
      blocks_and_code: '图形化和代码',
      blocks_text: '图形化',
      blocks_icons: '图形化（仅图标）',
      blocks_icons_helptext: '仅少年版',
      ...
      code_language_subscriber_only: '[AI_TRANSLATION]仅限会员  ',
    ...
    teachers: {
      ...
      class_code: '班级码',
      class_code_desc: '学生注册的时候可以输入班级码',
      ...
      'free_course_blurb_intro-to-ai': '利用 AI HackStack 的学习场景，结合 ChatGPT、Claude 和 DALL-E 等热门 AI 模型，在多个学科领域掌握核心的提示词工程（prompt engineering）技能。',
      'free_course_blurb_chapter-1-sky-mountain': '专为 6-8 年级学生设计，这是一场建立计算机科学基础的叙事性编程冒险之旅。',
      start_teaching_ai_today: '[AI_TRANSLATION]今天就开始教授AI！  ',
      hackstack_beta_release: '[AI_TRANSLATION]扣哒宇宙测试版发布',
      introducing_ai_hackstack: '隆重推出 AI HackStack——一款面向初学者的生成式 AI 教学工具。它让用户能够安全地使用 ChatGPT、Claude 和 DALL-E 等顶尖 AI 模型。',
      ...
      ai_algebra_promotion_title: '由教师主导的代数与人工智能（AI）融合课程',
      ai_algebra_promotion_description: '这是一套结构严谨、为期一学年且可直接用于课堂教学的课程方案。它既巩固了代数核心技能，又将人工智能作为加速学习的工具融入其中。该课程坚持以传统教学法为核心，由教师主导教学，学生则通过数学建模、设计思维及有意义的评估活动来应用数学知识。',
      ...
      hackstack_no_code_language_format: 'AI HackStack 无需编程语言或代码格式',
      licenses_activated_success: '许可证已成功激活！',
      license_code_used: '许可证代码已使用。',
      ai_hs_remix: '扣哒宇宙学生间二创',
      ai_hs_remix_blurb: '学生是否可以使用其他同学的项目来获取灵感。',
      and_more: '以及更多',
      ...
      near_end_trial: '您的学生即将用完试用内容',
      schedule_demo_subheading: '预约演示，让学生的编程之旅继续……',
      schedule_demo_description: '预约我们的团队进行演示，解锁更多免费内容，并探索我们的产品、课程和资源。让我们协助您为班级、学校或学区量身定制解决方案。',
      practice_and_application: '练习与应用体验',
      roster_via_csv: '通过 CSV 导入名单',
      roster_sub_text: '支持包含电子邮件、名字（firstName）和姓氏（lastName）的列。必填项：电子邮件和名字。',
      roster_sub_text_3: '班级中现有的学生不会被移除。',
      roster_download_example: '下载 CSV 示例',
      roster_completed: '同步完成，请刷新页面以查看更改。',
    },
    ...
    contact: {
      ...
      subscribe: '加入 CodeCombat 会员',
      subscribe_suffix: '并且我们很乐意给您提供代码相关的帮助',
      subscriber_support: '我们将给会员提供优先帮助',
    ...
    clans: {
      ...
      private: '(私人)',
      summary: '综述',
      average_rank: '[AI_TRANSLATION]平均段位',
    ...
    courses: {
      ...
      add_students: '添加学生',
      stats: '统计',
      student_email_invite_blurb: '您的学生在创建学生账号时也可以直接使用班级码 <strong>__classCode__</strong> ,不需要电子邮件.',
      total_students: '学生人数：',
      average_time: '平均游戏时间：',
      total_time: '总计游戏时间：',
      ...
      join_class: '加入班级',
      join_class_2: '加入班级',
      ask_teacher_for_code_coco: '从你的老师那里领取CodeCombat班级码！领取后请在下方输入：',
      ask_teacher_for_code_ozar: '从你的老师那里领取CodeCombat班级码！领取后请在下方输入：',
      enter_c_code_coco: '<输入班级码>',
      enter_c_code_ozar: '<输入班级码>',
      join: '加入',
      joining: '加入课程中',
      ...
      unsubscribe_warning: '警告：您的月度会员将被取消。',
      update_account_remain_student: '保持学生身份',
      update_account_update_student: '升级为学生账号',
      update_account_am_individual: '[AI_TRANSLATION]我是个人用户',
      ...
      update_old_classroom_detail_2: '创建新班级，并为学生提供出现的新班级码。',
      ...
      classroom_disable_paste: '班级中禁止粘贴代码: ',
    ...
    teacher: {
      ...
      copy_class_code: '复制班级码',
      class_code_blurb: '未加入的学生可以在自己的功能页面输入该班级码，或者访问网址加入。',
      ...
      regenerate_class_code_tooltip: '[AI_TRANSLATION]生成一个新的班级码',
      ...
      dashboard_deprecation_message: '此旧版仪表板即将停用。为确保您能持续使用所有功能及优质教学工具，请迁移至我们全新升级的教师仪表板。',
      partially_complete: '部分完成',
      INTRO_short: 'AI入门',
      ELA_short: '英语语言艺术',
      ALG_short: '数学与统计学',
      ALGEBRA_short: '数学与统计学',
      CR1_short: '职业规划1',
      CR2_short: '职业规划2',
      AI1_short: '人工智能1',
      AI2_short: '人工智能2',
    ...
    account: {
      title: '账户',
      settings_title: '账户设置',
      unsubscribe_title: '取消会员',
      payments_title: '支付',
      subscription_title: 'CodeCombat 会员',
      invoices_title: '发票',
      prepaids_title: '预付款',
      payments: '支付方式',
      prepaid_codes: '会员兑换',
      purchased: '已购买',
      subscribe_for_gems: '会员以获得额外宝石',
      subscription: '会员兑换',
      invoices: '票据',
      service_apple: '设备：苹果',
      service_web: '设备：网页',
      ...
      subscribed: '已是会员',
      unsubscribed: '取消会员',
      active_until: '已激活会员直到',
      cost: '花费',
      next_payment: '下次付款',
      card: '银行卡',
      status_unsubscribed_active: '您还不是会员所以不会被收费，但您的账号还可以正常使用',
      status_unsubscribed: '只要加入 CodeCombat 会员，您就可以玩转全部新关卡，用遍全部英雄，物品，以及获得更多的宝石哦！',
      ...
      create_a_free_account: '创建新账号',
      individual_inspiration: '在最爱的新游戏中，掌握真实代码。',
      //    parent_inspiration: "Safe, teacher-backed coding games that build real skills",
      individual_completion: '请查看您的电子邮件以开始体验！建议在电脑上打开链接，这样既能边写代码边学习，又能享受乐趣。',
      ...
      all_set: '注册成功！',
      date_of_birth: '生日',
      unlock_next_level_with_sign_up: '创建免费账户以保存进度，继续您的编程之旅。',
    },
    ...
    account_prepaid: {
      purchase_code: '购买兑换码',
      purchase_code1: '兑换码可以为一个或多个 CodeCombat 账号兑换额外的会员时间。',
      purchase_code2: '每个 CodeCombat 账号每次只能使用一个兑换码。',
      purchase_code3: '兑换码对应的时长会在账号现有的会员时间基础上延长。',
      purchase_code4: '兑换码适用于玩个人版CodeCombat的账号，不能代替“课堂”版本的学生许可。',
      ...
      prepaid_add_months: '该激活码将为您的账号提供<strong> __months__ 个月</strong>的会员',
    ...
    legal: {
      ...
      cost_title: '花费',
      cost_description: '[AI_TRANSLATION]CodeCombat 的入门关卡是免费的，额外关卡和每月 __gems__ 额外宝石的会员费用为 $__price__ 美元/月。你可以一键取消，并且我们提供 100% 的退款保证。  ',
    ...
    esper: {
      line_no: '第$1行有情况：',
      uncaught: '嘎！有个错误没抓到：$1',
      reference_error: '引用出错了，',
      argument_error: '函数括号里的参数不对劲，',
      type_error: '代码的类型或拼写错了，手滑啦？',
      syntax_error: '语法不合规，代码有点乱，快瞅瞅！',
      error: '出小差啦，',
      x_not_a_function: '`$1` 只是个变量，不要让它当函数呀！',
      x_not_defined: '`$1` 还没定义就想用？先声明再说。',
      spelling_issues: '拼写翻车啦：你想说的是 `$1`，不是 `$2`，对吧？',
      capitalization_issues: '大小写搞错了：`$1` 应该写成 `$2`？',
      py_empty_block: '`$1` 里面空落落的？在 `$2` 后面的语句前加4个空格缩进呀。',
      fx_missing_paren: '想把 `$1` 当函数用？后面加上 `()` 才能跑起来鸭！',
      unmatched_token: '`$1` 落单了！每个 `$2` 都需要一个 `$3` 配对才完整哟。',
      unterminated_string: '字符串没结尾，末尾再加一个 `"` 收工~',
      missing_semicolon: '嘎！分号呢？快补上 `;`。',
      missing_quotes: '嘎！引号跑丢了，试试 `$1`。',
      argument_type: '`$1` 的参数 `$2` 要 `$3` 类型，你却塞了个 `$4`：`$5`，鸭鸭看不懂哦。',
      argument_type2: '`$1` 的参数 `$2` 需要 `$3` 类型，现在是个 `$4`，类型，对不上呀。',
      target_a_unit: '攻击一个目标呀，别光看戏。',
      attack_capitalization: '攻击 `$1`，不是 `$2`！大小写很重要，别搞混。',
      empty_while: 'while 循环里空荡荡？在里面写代码，前面加4个空格。',
      line_of_site: '`$1` 的参数 `$2` 有问题，你视线里真的有敌人吗？',
      need_a_after_while: '`$2` 后面漏了 `$1`，赶紧补上。',
      too_much_indentation: '这行缩进太多了，往左挪挪。',
      missing_hero: '缺了 `$1` 关键字，要写 `$2` 才对。',
      takes_no_arguments: '`$1` 不需要括号里的参数，删掉多余的。',
      no_one_named: '没有叫 "$1" 的目标，是不是记错名字了？',
      separated_by_comma: '函数括号里的参数要用逗号隔开，`,` 别忘了。',
      protected_property: '动不得！受保护的属性：$1，它不让改的。',
      need_parens_to_call: '想把 `$1` 当函数调用？后面加上 `()` 才能跑起来！',
      expected_an_identifier: '这里该写个‘名字’（比如变量名或函数名），结果却看到了不该有的符号或错字 `$1` 。检查一下是不小心多打了符号，还是拼错了词？',
      unexpected_identifier: '嘎！这里有个不该出现的单词，是不是打错字了？',
      unexpected_end_of: '输入突然结束了？鸭鸭还没读完呢。',
      unnecessary_semicolon: '分号多余啦，删掉删掉。',
      unexpected_token_expected: '符号用混啦：在 $3 这个地方，你需要写 `$1`，却写成了 `$2`。检查一下标点符号。',
      unexpected_token: '居然冒出了 `$1` 这个符号，完全不对路。',
      unexpected_token2: '有个不该出现的字符冒出来了。',
      unexpected_number: '数字来得不是时候。',
      unexpected: "突然冒出来个 '$1'，检查一下是不是多打了符号？",
      escape_pressed_code: '按了ESC键？代码跑路，鸭鸭下班。',
      target_an_enemy: '瞄准敌人名字，像 `$1`，而不是字符串 `$2`，嘎！',
      target_an_enemy_2: '攻击用敌人名字，比如 `$1`，别乱写。',
      cannot_read_property: "读不到属性 '$1'，它可能根本不存在哦。",
      attempted_to_assign: '想改只读属性？改不了哦，换个思路试试。',
      unexpected_early_end: '程序怎么提前停了？是不是漏写了结尾的花括号 `}`？',
      you_need_a_string: '构建需要字符串，从 $1 里挑一个吧。',
      unable_to_get_property: "拿不到属性 '$1'，它可能根本不存在。",
      code_never_finished_its: '代码死机了！要么卡在无限循环里，要么跑得太慢。快检查一下！',
      unclosed_string: '字符串门没关，漏风了。',
      unmatched: "不匹配的 '$1'，缺个伴儿了。",
      error_you_said_achoo: '你说的密码是 $1，实际是 $2，大小写很关键哦。',
      indentation_error_unindent_does: '缩进错乱了：代码前面的空格没对齐，检查一下退格或空格数量。',
      indentation_error: '缩进（前面空出来的格数）错了。',
      need_a_on_the: '在 `$1` 后面加上冒号 `:`，别忘。',
      attempt_to_call_undefined: '想调用 `$1`？但它是空的（没值）。是不是前面的步骤没给这个变量赋值？',
      unterminated: '`$1` 没关门，还敞着呢。',
      target_an_enemy_variable: '用变量 `$1` 攻击，别用字符串 `$2`。试试 `$3`。',
      error_use_the_variable: '用变量名 `$1`，别用字符串 `$2`，鸭鸭拜托。',
      indentation_unindent_does_not: '缩进（开头空出的格数）没对齐外层，检查空格数。',
      unclosed_paren_in_function_arguments: '函数括号里的 $1 没关上，漏风。',
      unexpected_end_of_input: '输入又中断了？鸭鸭还没看完呢。',
      there_is_no_enemy: '根本没 `$1` 这个敌人，先用 `$2` 试试。',
      try_herofindnearestenemy: '试一试 `$1`，也许能行。',
      there_is_no_function: '`$1` 函数不存在，但 `$2` 有 `$3` 函数，用那个。',
      attacks_argument_enemy_has: '`$1` 括号里的参数 `$2` 不对劲儿。',
      is_there_an_enemy: '你视野里到底有敌人没？嘎？',
      target_is_null_is: '目标 `$1` 可能是个空（null），这里一定有敌人吗？试试 `$2`。',
      hero_has_no_method: '`$1` 压根没 `$2` 这招，别白费劲。',
      there_is_a_problem: '你的代码不太对劲，嘎。',
      did_you_mean: '你是说 $1 吗？可惜没装备对应的道具。',
      missing_a_quotation_mark: '引号丢了，快找找。',
      missing_var_use_var: '`$1` 没声明，用 `$2` 新建一个变量吧。',
      you_do_not_have: '你没有装备 $1 技能的道具，用不了。',
      put_each_command_on: '每条命令单独一行，别挤一起。',
      are_you_missing_a: '`$2` 后面是不是少了个 `$1`？',
      your_parentheses_must_match: '括号要成双成对，检查一下。',
      missing_parentheses: '漏了括号？试试 `__suggestion__`。',
      do_nothing_without_parentheses: '不加 `()`，`__code__` 就是在摸鱼。',
      error_index_empty: '读不到 `__specTypeName__` 里面的 `__name__`，它是空的吗？',
      error_call_non_function: '`__name__` 不是函数，别当函数使。',
      error_not_iterable: '`__var__` 不能像列表一样被轮询遍历，嘎。',
      error_assignment_invalid: '赋值写错了，这啥操作？',
      error_invalid_array_length: '列表（数组）长度不对劲，鸭鸭皱眉。',
      error_didnt_make_generator: '`__name__` 不是生成器，不能产出一串数据。',
      error_undefined_variable: '`__name__` 还没定义就想用？嘎。',
      error_declared_identifier: '`__name__` 这个名字已经被占用了，换一个吧。',
      error_declarations_cant_resolve: '读不懂 `__type__` 这个声明，是不是写错名字了？',
      error_strict_no_statement: '严格模式下不能用 `with` 语句，删掉这个花招。',
      error_cant_resolve_ref_component: '找不到 `__type__` 这个引用的东西。',
      error_cant_convert_null: '无法把空值（undefined/null）变成对象，它现在就是空的。',
      error_need_object: '这里得要个对象（东西），别给个空的。',
      error_illegal_object_prototype: '对象只能从 `Object` 或 `null` 这里生出来，鸭鸭提醒。',
      error_no_prototype: '没有模板源头，继承关系断了。',
      error_cant_write_property_to_undefined: '空值里哪有什么属性 `__idx__`，改不了它。',
      error_cant_write_property_to_non_obj: '不是对象的东西哪来的属性 `__idx__`，省省吧。',
      error_function_isnt_constructor: '嘎！`__name__` 不是用来制造新东西的，别乱用。',
      error_write_protected_property: '属性 `__name__` 是受到保护的，动它不得。',
      error_read_protected_property: '`__name__` 是受保护的属性，不让外面看。',
      error_convert_value_failed: '`__orig__` 跟 `__new__` 八字不合，强行转不了类型。',
      error_convert_object_to_primitive: '东西变不回最基础的数值或文字，转换失败了。',
      error_first_argument_to_be_function: '`__fun__` 的第一个参数必须是函数，你塞的是啥？',
      error_write_non_writable: '这值铁了心不让改。',
      error_delete_nonconfigurable_object: '这玩意儿不能删除，别想删了它。',
      error_cant_access_get: '拿不到 `__name__`，可能被藏起来了。',
      error_base_obj_not_invokable: '这个对象不能当函数使，别在后面加括号调用了。',
      error_arg2_not_callable: '第二个参数必须是函数，你乱塞了别的东西。',
      error_reduce_empty_array_without_init: '空列表做 reduce 运算却没有初始值，嘎。',
      error_realm_prototype_not_realm: 'Realm 的原型不是 Realm，啥情况。',
      error_function_tostring_not_generic: '`toString` 这个方法不能乱用，用错对象了。',
      error_regex_on_non_regex: '在普通对象上调用了正则表达式的方法，错啦。',
      error_call_string_on_null: '在空值上调用 `String()`，这不闹吗？',
      error_wrong_type: '类型错了，鸭鸭挠头。',
      error_replace_callback_not_written: '替换的额外步骤还没写好，先别用。',
      error_right_hand_side_not_callable: '`__name__` 右边的部分不能调用，嘎。',
      error_segmentation_fault: '内存分配出了大问题（段错误）`__offset__`，鸭鸭也救不了。',
      error_no_arg_to_reference: '缺少参数，补上。',
      error_unimplemented_property: '这个属性的类型还没实现，鸭鸭无能为力。',
      error_unimplemented: '功能还没做，鸭鸭无奈。',
      error_cant_call_reference: '这个引用不能直接调用，拐个弯试试。',
      error_no_arg_to_dereference: '又缺参数了，好好数数。',
      error_try_dereference_non: '想释放一个不是指针的东西？这怎么释放。',
      error_no_arg_to_alloc: '`alloc` 函数要参数才能分配，你忘记给啦。',
    },
    ...
    apcsp_marketing: {
      ...
      course_outline_course_2: '计算机科学 2',
      course_outline_course_3: '计算机科学 3',
      course_outline_course_4: '计算机科学 4',
    ...
    hoc_2019: {
      ...
      have_a_class_code: '[AI_TRANSLATION]有班级码吗？',
    ...
    parents_landing_1: {
      ...
      subscription_plan: '[AI_TRANSLATION]会员计划',
      ...
      subscription_details: '[AI_TRANSLATION]所有会员都是按月计费，暂停、取消或恢复都没有费用。您的会员在购买前30天内是100%无风险的。如果您决定不继续，只需在购买后30天内<a href="mailto:classes@codecombat.com">联系我们</a>，我们将立即全额退款，毫无疑问。所有计划都会自动按同级别和计费周期续约，除非有所更改或取消。  ',
      ...
      ai_hints_details: '[AI_TRANSLATION]我们的老师提供了孩子需要的指导和支持，但他们不可能总是陪伴在侧。于是，我们创新的AI老师提示功能可以帮助孩子在课间继续学习。这个支持功能能评估代码，指出错误，并解释如何修复。最重要的是，它提供了理解"为什么"所需的所有背景信息，而不是提供全部解决方案。只有当前代码问题的帮助可用，学生们仍需通过各个级别的编码挑战。会员每天可获得<b>10次AI提示</b>，确保他们始终得到所需的支持。',
      //    faq_header: "FAQs",
      ...
      faq_a_4: '[AI_TRANSLATION]你的许可在购买前30天内是100%无风险的。如果你决定不继续使用，购买后的30天内<a href="mailto:classes@codecombat.com">联系我们</a>，我们会立即全额退款，绝不问任何问题。你也可以随时冻结你的许可，并在合适的时间重新激活。',
    ...
    teacher_dashboard: {
      ...
      skipped_desc: '学生无法游玩被跳过的关卡。这些关卡被标记为“可选”，以便学生仍能继续推进进度。',
      optional: '[AI_TRANSLATION]可选',
      optional_desc: '学生可以游玩这些内容，但不强制要求完成。',
      ...
      cinematics: '剧情视频',
      cinematics_tooltip: '<h3>过场动画</h3><p>通过角色之间引人入胜的互动对话，以叙事形式引入相关概念。</p><p class="small">属于<b>“引言”</b>环节的一部分，旨在以循序渐进、层层铺垫的方式介绍新概念。</p>',
      concepts_tooltip: '<h3>概念检测</h3><p>用于检测学生理解程度的形成性评估环节，形式多样，包括拖拽题和代码排序题等。</p><p class="small">属于<b>“引言”</b>环节的一部分，旨在以循序渐进、层层铺垫的方式介绍新概念。</p>',
      ozaria_practices_tooltip: '<h3>练习关卡</h3><p>一种游戏化体验，学生在其中通过解谜来完成英雄的使命，同时巩固所学的概念。</p>',
      challenges_tooltip: '<h3>挑战关卡</h3><p>一种游戏化体验，综合运用了学生此前已练习过的关键概念。</p>',
      capstones_tooltip: '<h3>综合项目关卡</h3><p>学生运用本章学到的关键概念，亲手创作游戏和故事。</p>',
      coco_practices_tooltip: '<h3>练习关卡</h3><p>此类关卡为可选内容，仅针对系统判定需要额外练习的学生显示。</p>',
      multiplayers_tooltip: '<h3>多人对战关卡</h3><p>学生可以与其他玩家进行竞技对战的关卡。</p>',
      mains_tooltip: '<h3>核心关卡</h3><p>一种游戏化体验，学生在其中通过解谜来完成英雄的使命，同时巩固所学的概念。</p>',
      learn_to_use_tooltip: '<h3>学习使用</h3><p>学生跟随引导步骤，学习如何撰写高效的 AI 提示词（Prompts），并通过结构化的练习来提升相关技能。</p>',
      practice_tooltip: '<h3>练习</h3><p>学生在教师的适度指导下运用提示词技巧，从而连接结构化学习与开放式创作。</p>',
      use_tooltip: '<h3>实际应用</h3><p>学生可以自由地调用 AI 模型，运用所学的提示词撰写技能进行开放式的实践。</p>',
      ai_capstone_tooltip: '<h3>AI 综合项目</h3><p>各模块结束时的总结性评估，要求学生综合运用该模块学到的所有提示词（prompting）技巧，从零开始构建一个项目。</p>',
      concept_checks: '概念测试',
      practice_level: '练习关卡',
      ...
      create_class_hackstack: '[AI_TRANSLATION]请创建一个新班级来访问 扣哒宇宙',
      add_club: '[AI_TRANSLATION]添加新俱乐部  ',
      test_student_only: '[AI_TRANSLATION](仅测试学生)  ',
      ready_to_review: '[AI_TRANSLATION]准备好审核',
      ozaria_hs_modal_title: '[AI_TRANSLATION]在CodeCombat上独家访问扣哒宇宙',
      ozaria_hs_modal_blurb: '[AI_TRANSLATION]教育工作者现在可以直接在 **[https://codecombat.com/teachers/classes]CodeCombat** 上访问 扣哒宇宙，使用与 Ozaria 相同的凭证。为了方便起见，您可以轻松地将您的课程从 Ozaria 导入到 CodeCombat。',
      ...
      this_project_is_remixed: '此项目为改编版。',
      ...
      solution_code: '示例解法',
      ai_evaluation: 'AI 评估',
      ai_evaluated_on: 'AI 评估时间',
      ai_eval_yes: 'AI 评估通过',
      ai_eval_no: 'AI 评估未通过',
      ai_eval_unsure: 'AI 评估不确定',
      ai_eval_unsure_desc: 'AI 评估系统无法确信学生是否已达成目标。',
      ai_struggling: '遇到困难',
      ai_struggling_desc: '学生不止一次选择了错误选项。',
      ai_unsafe_desc: '学生与 AI 的对话被标记为不安全，例如试图作弊、绕过 AI 或使用辱骂性语言。',
      ai_eval_status: 'AI 评估状态',
      ai_model: 'AI 模型',
      welcome_tour_title: '60 秒快速导览',
      welcome_tour_desc: '初看此页面可能会觉得内容繁多。让我们按顺序了解几个您实际会用到的功能：查找学生、查看进度以及布置作业。',
      all_students_title: '您的学生',
      all_students_desc: '班级里的所有学生都会显示在这一列中。点击任意学生，即可查看其个人详情与学习进度。',
      content_symbol_title: '各课内容概览',
      content_symbol_desc: '每个符号代表一项内容。将鼠标悬停其上可进行预览，或亲自试玩该关卡。图标形状标示了内容类型——请参阅上方的“内容指南”以了解各图标的含义。',
      progress_dot_title: '学生进度概况',
      progress_dot_desc: '每个圆点代表一名学生在该关卡的进度。圆点颜色显示其当前状态（图例见上方）。点击圆点即可查看该学生在何处遇到困难或表现出色。',
      assign_content_title: '布置任务',
      assign_content_desc: '选择学生，然后点击此处为他们分配新课程。这是让学生开始学习的步骤。',
      apply_licenses_title: '授予付费课程访问权限',
      apply_licenses_desc: '选择学生并应用许可证，以便他们解锁并学习付费内容。',
      lock_content_title: '锁定内容以控制进度',
      lock_content_desc: '将鼠标悬停在任意模块名称上即可显示黄色锁定图标——点击该图标可阻止学生在您允许之前继续学习后续模块。需要一次性锁定整个课程？请使用“锁定或跳过关卡”按钮。',
      tour_replay_title: '需要重温一下吗？',
      tour_replay_desc: '迷失方向了？随时点击此处重新观看本导览。',
      replay_tour: '观看导览',
      test_student_step_title: '以学生身份试用',
      test_student_step_desc: '切换到免费的测试学生账户，亲身体验学生所看到的课程——包括分配内容、游玩关卡和查看进度。完成后，点击导航栏中的“停止切换”即可返回您的教师账户。',
      add_students_step_title: '邀请学生加入班级',
      add_students_step_desc: '分享班级代码、发送加入链接、通过电子邮件邀请或与 Google Classroom 同步——点击此处查看学生加入并开始学习的所有方式。',
      teacher_toolkit_tour_desc: '在此查找入门指南、教育工作者资源和常见问题解答——助您在首次上课前做好充分准备所需的一切。',
      teacher_toolkit_tour_title: '您的教学工具包',
      curriculum_glossary: '课程术语表',
      curriculum_glossary_desc: '💡 刚接触本课程？以下是下方课程的术语速查：',
      curriculum_glossary_desc_hackstack: 'Intro: AI 导论, AI: 人工智能, ALG: 代数, CR: 职业准备, CYB: 网络安全, ELA: 英语语言艺术, CS: 计算机科学, EXP: 探索, SBOX: 沙盒',
      curriculum_glossary_desc_ozaria: 'CH: 章节',
      curriculum_glossary_desc_codecombat: 'CS: 计算机科学, GD: 游戏开发, WD: Web 开发',
      curriculum_glossary_desc_junior: 'JR: 初级',
      curriculum_glossary_close: '知道了，隐藏此项',
      assign_to_class: '分配给班级',
    },
    ...
    roblox_landing: {
      ...
      connect_button_list_item_1: '[AI_TRANSLATION]管理会员续费',
    ...
    ai: {
      ...
      hackstack_promotion_blurb: '[AI_TRANSLATION]不懂 AI？探索 <b>扣哒宇宙</b> ——最简单的 AI 入门路径。解锁 DeepSeek,通义千问和千问图片的潜力。这个创新工具提供动手 AI 培训，让创作变得轻松。',
    ...
    home_v3: {
      ...
      engaging_boxes_5_title: '[AI_TRANSLATION]扣哒宇宙',
    ...
    schools_page: {
      ...
      codecombat_ai_hackstack_text: '[AI_TRANSLATION]对于AI新手，我们提供 **扣哒宇宙**。这个创新工具不仅教学生如何使用AI，还提供了安全访问许多最新的大型语言模型(LLM)，包括ChatGPT-4、Claude、Stable Diffusion、DALL-E等。经过短时间的训练模式后，用户可以解锁工具的全部创意潜力，在几分钟内完成从提示到代码再到发布的项目。这个AI驱动的应用程序让用户可以生成游戏、艺术、网站、代码等。**教师每月可获得100个AI提示配额**， **每个学生每周有10个AI提示**，以创建多个AI项目。',
      ...
      student_acceleration_1_title: '[AI_TRANSLATION]扣哒宇宙',
    ...
    hackstack_page: {
      header: '通过 **扣哒宇宙** 学习、创作并加速成长',
      header_details: '我们携手合作，赋能学习者在任何学科领域安全地将创意变为现实。',
      header_details_teacher: '获取许可后，教师每月可获得 100 条提示词额度，学生每周可获得 30 条，助力在任何学科中实现创意。',
      accessible_safe_use: '无障碍、安全且负责任地使用 AI',
      learn_title: '学习',
      learn_description: '从**英语语言艺术**到**数学**和**科学**，学生将探索如何针对各学科创作安全且有效的提示词。通过 扣哒宇宙 的“学习场景”，在**广泛的学科领域**中掌握核心的提示工程（Prompt Engineering）技能。在此过程中，您的学生将亲身体验 DeepSeek、阿里千问等热门 AI 模型。',
      create_title: '创作',
      create_description: '在 扣哒宇宙 的 AI **沙盒环境**中将您最天马行空的创意变为现实。在这里，学生可以快速构建各类跨学科项目的原型。利用我们的成品课程，引导学生就 AI 的**负责任使用**及其作品的**伦理影响**进行深入讨论。这种全方位的方法不仅激发了创新，还培养了数字公民意识，让学生具备在数字时代蓬勃发展所需的技能和意识。',
      remix_title: '二创 (Remix)',
      remix_description: '通过自定义 扣哒宇宙 **社区库**中的众多项目，为创作过程注入强劲动力。“二创”功能不仅加速了个人进度，还培育了一个想法快速演进的**协作生态系统**。随着学生对彼此的作品进行再创作和改进，课堂的集体产出将达到新的创意高度，呈现出令人惊叹的学生驱动型创新成果。',
      privacy_title: '安全与隐私',
      privacy_subtitle: '我们的 AI 平台在激发学生好奇心与创造力的同时，提供您所需的隐私与安全保障。',
      data_title: '您的数据是安全的',
      data_description: '在将 AI 工具加入 扣哒宇宙 之前，我们会对其进行严格审查。如果不安全，我们绝不采用。我们还会筛选用户的提示词，确保其中不含任何个人身份信息（PII）。如果发现此类信息，我们会先将其替换为占位符，再提交给外部 AI 模型。此外，您有权锁定特定的 AI 工具，防止学生访问您认为不合适的模型。',
      moderation_title: '我们的监管实践',
      moderation_description: '我们监控用户提示词和 AI 生成内容，确保不含任何不当信息。您可以在 扣哒宇宙 教师管理面板中查看学生编写的每一条提示词。我们还提供现成的资源，帮助您和学生应对使用 AI 的复杂性，并为希望在学生使用 AI 时获得更多引导建议的教育者提供专业发展机会。',
      professional_development: '高质量的专业发展培训',
      professional_development_text: '我们为希望在课堂应用 AI 方面获得更多指导的人员提供专业发展（PD）机会。这些研讨会参考了 **[https://www.teachai.org/toolkit]Teach AI**、**[https://www.edsafeai.org/safe]EdSafe**、**[https://csteachers.org/k12standards/]CSTA** 以及 **[https://ai4k12.org/]AI4K12** 的 AI 标准，重点关注 AI 的安全与负责任使用。',
      ask_pd: '咨询 AI 专业发展培训',
      testimonials_1_quote: '“在实验不同模型、构思并推出首个 AI 程序时，那种活力和兴奋感真的令人振奋！我迫不及待想看到这些程序了。让我们共同努力，让每个人都能接触到 AI！”',
      testimonials_1_name: 'Vivienne Byrd',
      testimonials_1_title: '洛杉矶公共图书馆，STEAM 图书管理员及公民科学倡议项目负责人',
      try_it_free: '免费试用',
      faq_1_question: '我的学生多大年纪可以使用 扣哒宇宙？',
      faq_1_answer: '扣哒宇宙非常适合初中和高中阶段的学生。我们的安全与隐私实践让年轻用户（如您的学生）能够安全地与 AI 互动。如果您教授的是小学生，请**[mailto:team@codecombat.com]联系我们的团队**，了解更多关于 CodeCombat AI Junior 的信息，这是一个专为 K-5 学生设计的简单直观的多模态生成式 AI 平台。',
      faq_2_question: '我们如何安全且负责任地集成 AI？',
      faq_2_answer: '我们的 AI 技术坚持安全第一的原则，让学生和教育者都能放心使用。我们禁止后端 LLM（大语言模型）供应商使用您的聊天记录进行训练，并建立了针对不当内容的保护措施。这些措施包括过滤有害语言、保持学科相关性、保护个人信息以及引导学生识别 AI 可能存在的缺陷。此外，我们会记录 AI 聊天活动供老师监督，并遵循严格的数据隐私和安全协议。',
      faq_3_question: '扣哒宇宙使用哪些大语言模型 (LLM)？',
      faq_3_answer_1: 'DeepSeek：专为自然语言理解和生成任务设计的模型。',
      faq_3_answer_2: '阿里千问：专注于 AI 交互性能与安全性的语言模型。',
      faq_3_answer_3: '千问图片：根据文本描述生成图像的模型。',
      faq_3_answer_4: 'DALL-E: An image generation model that creates visuals based on text prompts.',
      faq_3_answer_5: '我们持续评估这些模型的性能与安全性，确保更新至最新的可用版本。',
      faq_4_question: '如何寻找替代资金来源？',
      faq_4_answer: '计算机科学教育已成为学生学业生涯的重要组成部分，然而，许多学校在获取必要资源以提供全面计算机科学课程方面面临挑战。在 CodeCombat，我们了解学校遇到的资金瓶颈，并热衷于帮助他们克服这些障碍。资助金（Grants）是宝贵的资源，但往往难以发现和申请。请查看我们的**[https://codecombat.com/grants]资助金申请全面指南**，或**[mailto:team@codecombat.com]咨询我们的团队**以了解更多信息。',
      faq_5_question: '如何开始使用？',
      faq_5_answer_1: '创建您的教师或管理员账户',
      faq_5_answer_2: '创建班级',
      faq_5_answer_3: '添加学生',
      faq_5_answer_4: '为您的班级解锁 扣哒宇宙',
      faq_5_answer_5: '轻松观看您的学生在快乐中学习 AI 知识',
      faq_6_question: '是否支持 Clever 和 Google 登录？',
      faq_6_answer: '我们提供 Clever 和 Google Classroom 的集成支持。查看我们的 **[https://codecombat.com/teachers/resources/clever-faq]Clever 集成常见问题解答** 以获取更多入门细节。如果您使用的是 Google Classroom，请务必使用 Google 单点登录 (SSO) 弹窗注册教师账户。如果您已有使用 Google 邮箱注册的账户，下次请通过 Google SSO 登录。在“创建班级”弹窗中，您会看到“链接 Google Classroom”的选项。目前我们仅支持通过 Google Classroom 导入名册。注意：您必须至少使用一次 Google SSO 进行注册或登录，才能看到 Google Classroom 的集成选项。',
      faq_7_question: '推荐的浏览器和操作系统',
      faq_7_answer: '待定 (TBA)',
      faq_8_question: '我可以获得多少条提示词额度？',
      faq_8_answer: '获取许可后，教师每月可获得 100 条提示词，学生每周可获得 30 条。个人高级版用户每月可获得 50 条提示词。',
      learn_more: '了解更多',
      promo_modal_title: '探索 扣哒宇宙',
      promo_modal_subtitle: '释放生成式 AI 的全部潜力',
      promo_modal_text: '**AI 新手？探索扣哒宇宙** —— 开启 AI 素养教育最简单的方式。解锁 **ChatGPT-4**、**Claude**、**Stable Diffusion** 和 **DALL-E** 等顶尖模型的力量。借助实用的工具，创作游戏、艺术品、网站和代码变得前所未有的简单。它是任何创意项目的完美伴侣，无需任何经验！',
      explore_hackstack: '探索扣哒宇宙',
      learn_1_text: '在安全的[NEWLINE]人工智能[NEWLINE]沙盒中玩耍',
      learn_2_text: '跨学科课程',
      learn_3_text: '提示工程',
      learn_4_text: '人工智能[NEWLINE]二创项目',
      learn_5_text: '伦理为中心[NEWLINE]的反思',
      learn_6_text: '可操作的[NEWLINE]数据',
      learn_7_text: '人工智能[NEWLINE]专业发展',
    },
    ...
    codequest_page: {
      ...
      core_curriculum_title_1: '扣哒宇宙生成式人工智能项目挑战',
    ...
    hackstack: {
      ...
      'HowItWorksPage_codecombat-ai-hackstack-is-an-all-in-one': '[AI_TRANSLATION]扣哒宇宙是一个集成 AI 工具，只需聊天就能创建游戏、艺术作品、歌曲、应用等。它为你运行一切，托管项目，并帮助编写代码。CORE 模式是免费的，通过多项选择提示教学。PRO+ 模式每月 $9.99 美元，提供自由格式的提示。项目是安全的，不会向大科技公司提供数据。这是由 CodeCombat 团队制作的，目的是让 AI 变得对所有人都易于接触。现在，让我们开始创作吧。  ',
      ...
      'HowItWorksPage_learn-anything-create-something-do-every': '[AI_TRANSLATION]用扣哒宇宙学习任何东西，创造某些东西，做所有事情。为所有人提供 AI 赋能！',
      ...
      'HowItWorksPage_no-worries-my-friend-i-have-the-keys-to-': '[AI_TRANSLATION]别担心，我的朋友！我有通往创意王国的钥匙。你可以通过单个扣哒宇宙账户访问所有最好的 AI 工具。',
      'HowItWorksPage_not-with-ai-hackstack-i-access-all-the-l': '[AI_TRANSLATION]不是 扣哒宇宙。我可以访问所有最新的模型，从 GPT-4 到 Stable Diffusion 以及中间的一切。',
      ...
      'HowItWorksPage_yeah-thats-why-those-are-free-they-feed-': '[AI_TRANSLATION]是的，这就是为什么这些是免费的。他们把你的数据输入到他们的下一个AI里，让它可以学会更好的表演说唱。但用我的话，他们不存储数据也不训练。所以如果你在学校，或者你未满18岁需要父母同意，或者你未满13岁，一般来说你是不能直接使用ChatGPT的。用扣哒宇宙的话，你是安全、可靠的，尽管安心使用吧。',
      ...
      'NewProjectPage_prompt-the-ai-to-create-websites-games-w': '[AI_TRANSLATION]用扣哒宇宙提示 AI 创建网站、游戏、网页应用、故事、艺术等等。',
      ...
      'creditMessage_creditcreditsleft-creditinitialcredits-c': '[AI_TRANSLATION]__creditCreditsLeft__ / __creditInitialCredits__ 剩余积分用于__durAmount____creditDurationKey__\n',
      creditMessage_the: '[AI_TRANSLATION]每',
      ...
      copied: '已复制!',
      copied_error: '复制出错!',
      NewScenarioPage_name: '显示名称',
      learning_modules: '学习模块',
      level_complete: '你做到了！本关已完成。继续你的AI之旅，挑战下一关。',
      run_code_tour_title: '准备好见证奇迹了吗？',
      run_code_tour_text: '按下“输出”按钮，观看你的项目运行起来。无需任何经验！',
      ...
      ready_to_review_helptext: '项目完成后，请标记此行。你的老师会看到你的项目已准备好进行审核。',
      ready_to_review_confirm_text: '准备提交？点击“确定”通知你的老师审核你的项目。',
      no_course_instances: '你没有任何课程实例。请联系你的老师以获取扣哒宇宙的访问权限。',
      restart_scenario_confirm: '您的进度将会丢失。您确定要重新开始吗？',
    },

    galaxy: {
      title: '欢迎来到扣哒宇宙',
      description: '探索全新世界，并使用 AI 助你一臂之力。',
      premium_only: '仅限高级会员',
      not_enrolled: '未注册',
      //    need_sign_up: "Sign up to access",
      locked_by_teacher: '已被教师锁定',
    },

    new_premium: {
      mastering_code: '**加入会员**掌握编程',
      unlock_passion: '解锁无限访问数百个编程冒险权限。在家以自己的节奏培养真实技能，应对引人入胜的挑战并进行探索。',
      boxes_title: '只需加入会员，即可访问所有游戏和项目',
      junior_title: 'CodeCombat Junior',
      junior_text: '我们旗舰级的K-5 少儿课程采用循序渐进的学习级别，以较慢的速度教授基本的编程概念。',
      codecombat_worlds_text: '与Roblox Education合作开发，此体验可加速您的编程能力，以创建令人惊叹的Roblox游戏和体验。',
      ...
      features_1: '完全访问所有[NEWLINE]学习冒险',
      features_2: '通过[NEWLINE]扣哒宇宙掌握人工智能',
      features_3: '解锁更多宝石、[NEWLINE]英雄和物品',
      features_4: '创建游戏、[NEWLINE]网站和应用程序',
      features_5: '更多支持[NEWLINE]和人工智能AI驱动的帮助',
      every_learner_different_learning_style: '**每个学习者都有独特的节奏和对技术的热情。我们引人入胜的基于游戏的学习计划提供了探索编程和人工智能的完美环境，即使概念变得更加高级，也能让您保持积极性和学习兴趣**',
      adapt_interests: '我们适应您的兴趣',
      carousel_items_1_title: '编程[NEWLINE]基础',
      carousel_items_1_text: '对于几乎没有或没有编程经验的学习者，大多数课程将从CodeCombat Junior开始，以建立基础技能，然后再过渡到CodeCombat以获得更深入的编程知识。扣哒宇宙将加速学习并展示编码和人工智能的实际应用。CodeCombat Worlds和AI League提供了额外的练习、创造和乐趣的机会。',
      carousel_items_2_text: '如果您热爱游戏并想创建游戏，我们以游戏开发为重点的课程非常适合您。您将首先使用CodeCombat构建交互式项目，然后在CodeCombat Worlds中将您的想法变为现实，您可以在Roblox平台上设计和发布真正的游戏。AI League通过加深您对游戏动态的理解来提供竞争优势，而扣哒宇宙则通过迭代开发帮助您改进和增强您的创作。',
      carousel_items_3_text: 'Web开发不断发展，保持领先地位至关重要。在本课程中，基础Web开发活动将在CodeCombat中进行，而CodeCombat Junior则为年轻的学习者提供了一个易于入门的起点。扣哒宇宙将作为构建和发布项目的主要平台，少量使用CodeCombat Worlds和AI League以引人入胜的方式加强关键的编码概念。',
      carousel_items_4_text: '电子竞技爱好者会喜欢这种学习体验的竞争精神。从CodeCombat Junior和CodeCombat开始，学习者将建立强大的编码基础，然后挑战我们的AI League全球电子竞技锦标赛，全年都有奖学金和奖品等你来拿。通过专注于创意编码和迭代，他们还将利用扣哒宇宙的力量来提升技能并获得竞争优势。',
      carousel_items_5_title: '人工智能素养',
      carousel_items_5_text: '人工智能正在塑造未来，能够驾驭其力量的人将解锁无限的机遇。这种学习体验从CodeCombat Junior和CodeCombat开始，扩展到扣哒宇宙，学习者将在安全可靠的环境中掌握制作有效人工智能提示和使用最新生成式人工智能工具的艺术。',
      cs_benefits: '计算机科学教育提供直接的好处，例如提高**解决问题的能力，提高数学能力**和加强**逻辑思维能力**，这些技能有助于在许多学科中取得成功。但学习不仅仅限于编码。它帮助学习者应对复杂的挑战，适应新的情况，并培养终身受益的成长心态。',
      our_solutions: '我们的解决方案旨在让您掌握当今必不可少的计算机科学技能，为**未来的数字时代**做好准备。',
      learning_code_challenging: '学习编码可能具有挑战，但您不必孤军奋战。我们创新的AI辅导功能提供实时指导，帮助您不断进步。它可以评估您的代码，突出显示错误，并解释如何修复它们，同时确保您理解每个解决方案背后的原理，而不仅仅是给出答案。由于AI辅导仅帮助您解决当前的编码挑战，您仍然需要批判性地思考并独立解决每个级别。会员每天可获得10个AI提示，为您提供保持自信学习所需的支持。',
      new_to_ai: '对于人工智能新手，我们提供**[/ai]扣哒宇宙**，这是一款创新的工具，可以教导学习者如何安全且负责任地使用人工智能。通过安全访问尖端人工智能模型，用户可以创建和试验人工智能驱动的项目。在短时间内，他们将释放人工智能的全部创造潜力，在几分钟内将提示转化为代码、游戏、艺术、网站等等。会员每月可获得50个提示，为您提供充足的机会来探索和使用人工智能进行构建。',
      premium_page_title: 'CodeCombat 会员',
    },

    parents_v2: {
      testimonials_1_quote: '[AI_TRANSLATION]我甚至无法开始解释自从 Luka 和你一起工作以来他在学术上发生的深刻变化。  ',
      testimonials_1_name: '[AI_TRANSLATION]玛丽娜 G.  ',
      testimonials_1_title: '家长',
      testimonials_2_quote: '我现在能做到以前做不到的一件事，就是真正相信自己可以编程。',
      testimonials_2_name: '学生',
      testimonials_2_title: '旧金山某中学',
      testimonials_3_quote: '即使课程每周六早上 7 点开始，我的儿子也兴奋得比我醒得还早！CodeCombat 为我的儿子提高编程技能开辟了一条道路。',
      testimonials_3_name: '[AI_TRANSLATION]Latthaphon Pohpon  ',
      testimonials_3_title: '家长',
      ...
      grid_most_popular: '最受欢迎',
      grid_best_value: '超值推荐',
      ...
      grid_self_paced_year_price: '$__price__ 年度',
      grid_self_paced_year_price_without_currency: '__price__ 年度',
      grid_personalized_instruction: '1对1个性化指导',
      grid_premium_access: '会员',
      grid_codecombat: 'CodeCombat',
      grid_ozaria: 'Ozaria',
      grid_ai_league: 'AI 编程比赛',
      grid_codecombat_worlds: 'CodeCombat Worlds',
      grid_ai_hackstack: '[AI_TRANSLATION]扣哒宇宙',
      ...
      grid_ai_hints_allowance: '[AI_TRANSLATION]扣哒宇宙每日提示限额***',
      grid_prompts_allowance: '[AI_TRANSLATION]扣哒宇宙每月提示限额***',
      ...
      subscriptions_billed: '会员为提前收费，可以暂停、取消或恢复，不收取额外费用。',
      ...
      why_game_based: '为什么基于游戏的学习有效',
      game_based_effective: '基于游戏的学习之所以如此有效，是因为它提供了一个安全的环境，在其中失败不会被恐惧，而是被视为成长和理解的预期机会。这种方法鼓励玩家从错误中学习并调整策略以取得成功。此外，游戏互动和动态的特性有助于年轻的学习者更有效地记住信息，因为他们是通过实践和动手经验来学习的。它积极地将他们带入学习过程，提高他们的积极性和乐趣。',
      how_integrate_ai: '我们如何安全且负责任地整合人工智能',
      ...
      instructors_offer_guidance: '[AI_TRANSLATION]我们的指导老师提供了孩子需要的指导和支持，但不能一直在身边。这时候，我们创新的AI老师提示功能可以帮助在课程之间继续学习。这个支持功能能够评估代码、指出错误，并解释如何修复。最重要的是，它提供了理解原因所需的所有背景，而不提供完整的解决方案。由于仅提供当前代码问题的帮助，学生仍然需要完成每个关卡的编码挑战。会员每天可获得10个AI提示，确保他们总是有需要的支持。\n',
      new_to_ai: '对于人工智能新手，我们提供 **[/ai]扣哒宇宙**。我们的讲师使用这个创新工具来教您的孩子如何安全且负责任地使用人工智能。该应用程序安全地访问许多最新的 LLM，包括 ChatGPT-4、Claude、Stable Diffusion、DALL·E 等。在与我们的讲师合作一小段时间后，您的孩子将释放该工具的全部创造潜力，从而在几分钟内实现从提示到代码再到发布项目的过程。这个人工智能驱动的应用程序使用户能够生成游戏、艺术、网站代码等。每个在线直播课程订阅者每月可获得 200 个提示额度来创建多个 AI 项目。',
      ...
      boxes_title: '[AI_TRANSLATION]成为 CodeCombat 会员，享受个性化指导和高级访问',
      ozaria_title: 'Ozaria',
      ozaria_text: '一个吸引人叙事式编程冒险，学习计算机科学的基础。',
      personalized_instruction: '一个吸引人的叙事式编程冒险，学习算机科学的基础。',
      codecombat_title: 'CodeCombat',
      codecombat_text: '一个基于游戏的计算机科学课程，包含 Web 开发、游戏开发和 AP CSP 考试准备。',
      ai_league_sports_title: '[AI_TRANSLATION]AI League Sports  ',
      ai_league_sports_text: '一个和真人同学做编程比赛的平台，鼓励在基于游戏的环境中进行创意编程。',
      codecombat_worlds_title: 'CodeCombat 世界',
      codecombat_worlds_text: '[AI_TRANSLATION]与 Roblox 教育合作开发，此体验加速您孩子的编程能力，以创造惊人的 Roblox 游戏和体验。  ',
      ai_hackstack_title: '[AI_TRANSLATION]扣哒宇宙',
      ...
      carousel_items_1_text: '[AI_TRANSLATION]对于没有编程经验的学生，大部分课堂将通过 Ozaria 来建立基础技能，然后通过 CodeCombat 来深化编程知识。扣哒宇宙将用于帮助加速孩子的编程能力，并展示他们新学技能的实际应用。CodeCombat Worlds 和 AI League 将提供偶尔的练习和创造性游戏机会。',
      carousel_items_2_title: '[AI_TRANSLATION]游戏[NEWLINE]开发',
      carousel_items_2_title_prefix: '[AI_TRANSLATION]**专注：**  ',
      carousel_items_2_text: '[AI_TRANSLATION]如果你的孩子喜欢游戏并想制作游戏，我们专注于游戏开发的课程将以 CodeCombat 为 核心进行初期的游戏开发活动和项目。在不久的将来，你的孩子将在 CodeCombat 世界构建和发布真实的游戏到 Roblox 平台。参加我们的 AI 联赛可以深入了解成功的游戏动力学和开发，而扣哒宇宙将是迭代游戏开发的强大工具。  ',
      carousel_items_3_title: '[AI_TRANSLATION]Web[NEWLINE]开发',
      carousel_items_3_title_prefix: '[AI_TRANSLATION]**专注：**  ',
      carousel_items_3_text: '[AI_TRANSLATION]面向网络的开发不断演变，保持领先很重要。在此课程中，最初的网络开发活动将在 CodeCombat 进行，而 Ozaria 将用于新手编程者。将广泛实施扣哒宇宙作为构建和发布到网络的平台，有限使用 CodeCombat Worlds 和 AI League 来帮助强化关键编程概念。  ',
      carousel_items_4_title: '[AI_TRANSLATION]竞技[NEWLINE]编程电竞  ',
      carousel_items_4_title_prefix: '[AI_TRANSLATION]**专注：**  ',
      carousel_items_4_text: '[AI_TRANSLATION]电竞爱好者一定会喜欢这个课程的竞争精神。在 CodeCombat 的基础上，你的孩子将全年参加我们的 AI 联赛全球电竞比赛，争夺奖学金和奖品。通过强调创意编程和迭代，你的孩子将学习如何使用我们的扣哒宇宙工具在比赛中提升自己的能力。  ',
      carousel_items_5_title: '[AI_TRANSLATION]AI[NEWLINE]Applications  ',
      carousel_items_5_title_prefix: '[AI_TRANSLATION]**专注：**  ',
      carousel_items_5_text: '[AI_TRANSLATION]AI无处不在，那些能利用其力量的人将能够最大化他们的潜力。这个课程重点从CodeCombat开始，但扣哒宇宙将帮助教授撰写最强AI提示的艺术，并在安全和安全的环境中使用所有最新的生成AI工具。内置在CodeCombat Worlds中的生成AI功能将提供另一个现实世界的机会，看看您的孩子可以用AI做什么。  ',
      ...
      faq_2_question: '讲师是如何与我的孩子匹配的？',
      faq_2_answer: '在最初的试听课之后，我们的团队会根据每个学生的经验水平、性格、兴趣和时间安排，仔细地将我们的在线讲师与他们匹配。',
      faq_3_question: '是否有学生年龄限制？',
      ...
      faq_4_question: '我需要什么样的设备才能加入课程？',
      ...
      faq_5_answer: '[AI_TRANSLATION]你的许可在购买前30天内是100%无风险的。如果由于任何原因你决定不继续，请在购买后30天内通过**[mailto:classes@codecombat.com]classes@codecombat.com**联系我们，我们会立即全额退款，无需解释。  ',
      faq_6_question: '如果我需要重新安排课程怎么办？',
      ...
      faq_7_answer: '[AI_TRANSLATION]我们提供暂停课程最多两周的选项。如果需要更长的休息时间，我们会暂停你的许可证，等你回来时重新安排课程。请注意，如果你的时间段内老师不再有空，我们可能需要为你找到新的上课时间。\n',
      ...
      faq_10_answer: '是的，一旦您的订阅安排好，您的学生每周都将与同一位讲师一起学习。偶尔可能会因为时间冲突需要安排代课老师。',
      ...
      faq_13_answer: '与其他编程教育平台不同，我们基于游戏的方法使用我们专有的游戏和技术来提供更具吸引力的体验和更有效的结果。我们开发了自己的基于 Web 的游戏和 Roblox 上完全沉浸式的体验，使学习编码和游戏创作更加有趣。',
    },
    ...
    junior_page: {
      ...
      promo_modal_text: '**通过专为 5-8 岁儿童设计的辅助式关卡开启他们的编程冒险之旅——无需阅读或打字！**他们将通过图标积木、单词积木、或并排显示简单的文本，并解决自适应挑战，让他们保持参与。可在 **平板电脑** 和 **iPad** 上无缝运行。',
    },
