module.exports = {
  ...
  translation: {
    ...
    subscribe: {
      ...
      feature_gems: '[AI_TRANSLATION]每月赚取 __gems__ 宝石 (__gems12__ 宝石/年)\n',
    ...
    special_offer: {
      ...
      course_prefix: '课程',
      //    course_suffix: "",
      licenses_activated_success: '[AI_TRANSLATION]许可证已成功激活！',
      license_code_used: '[AI_TRANSLATION]已使用许可证代码。',
    },
    ...
    codequest_page: {
      ...
      core_curriculum_title_21: '[AI_TRANSLATION]加州大学伯克利分校特邀讲师',
      core_curriculum_text_21: '[AI_TRANSLATION]当沉浸在这所古老大学的学术氛围中时，学生们将受到加州大学伯克利分校电气工程和计算机科学系代表的欢迎，他们将带领大家了解这里的计算机科学研究和前沿发展。学生将了解参与这些研究项目的感受以及可能实现的职业路径。',
      core_curriculum_title_22: '[AI_TRANSLATION]Google X - Moonshot Factory 特邀演讲者',
      core_curriculum_text_22: '[AI_TRANSLATION]2010年，Google创始人Larry Page和Sergey Brin决定成立公司一个新的部门，专门去从事那些疯狂、听起来像科幻小说的技术研发，这些技术有一天可能会让世界变得更加美好。经过10年的努力，X已经孵化了数百个不同的疯狂项目，其中很多已经成为独立的业务。听听这群多样化的发明家和企业家是如何构建和启动这些旨在改善数百万甚至数十亿人生活的技术吧。',
      core_curriculum_title_23: '[AI_TRANSLATION]Nick Winter，CodeCombat 首席执行官',
      core_curriculum_text_23: '[AI_TRANSLATION]Nick 是 CodeCombat 的创始人和首席执行官。他是教育科技行业的公认领导者，将教育热情和技术专长相结合，使编程学习变得更加容易和有趣。CodeCombat 之前，他共同创办了 Skritter，这是一个学习中文和日文字符的平台。Nick 致力于改革教育行业，让编程成为未来一代的基础技能。他的奉献和愿景继续激励并影响教育科技领域。',
      core_curriculum_title_24: '[AI_TRANSLATION]苹果科技开发工作坊',
      core_curriculum_text_24: '[AI_TRANSLATION]听风险投资家和科技领袖的亲身讲述，详细了解打造全球科技平台和成功商业计划的过程。这场互动演讲将揭开构建下一代伟大科技和如何启动它的面纱。  ',
      core_curriculum_heading_31: '[AI_TRANSLATION]旧金山和硅谷为学生提供了独特的机会  ',
      core_curriculum_heading_32: '[AI_TRANSLATION]在科技巨头体验生活',
      core_curriculum_heading_33: '[AI_TRANSLATION]和 ',
      core_curriculum_heading_34: '[AI_TRANSLATION]探索城市景点',
      ...
      cta_supporting: '[AI_TRANSLATION]计划中的系列活动的具体内容可能会有所变化。我们承诺尽可能及时通知您这些变化，尽管它们可能会在没有提前通知的情况下发生。',
      contact: '[AI_TRANSLATION]联系我们的团队',
      if_question: '[AI_TRANSLATION]如果你有任何问题\n',
      how_it_works: '[AI_TRANSLATION]如何运作',
      apply: '[AI_TRANSLATION]申请',
      apply_time: '[AI_TRANSLATION]一月-二月\n',
      apply_steps_1: '[AI_TRANSLATION]有兴趣参加的学生将填写申请表。',
      apply_steps_2: '[AI_TRANSLATION]可能需要进行技能评估或测试来确认你是否有能力参与。',
      //    confirm: "Confirm",
      confirm_time: '[AI_TRANSLATION]3月-4月',
      confirm_steps_1: '[AI_TRANSLATION]如果你被录取了，项目顾问会联系你确认更多细节。\n',
      confirm_steps_2: '[AI_TRANSLATION]你需要支付初始定金才能保留你在项目中的位置。',
      confirm_steps_3: '[AI_TRANSLATION]你的旅行将会被协调和预定。',
      confirm_steps_4: '[AI_TRANSLATION]所有参与者都需要签署责任豁免书。\n',
      travel: '[AI_TRANSLATION]旅行',
      //    travel_time: "July",
      travel_steps_1: '[AI_TRANSLATION]出发前你会收到一个详细的旅行包，里面包括你需要知道的所有信息。',
      travel_steps_2: '[AI_TRANSLATION]已安排好将参与者从机场接送到酒店，并在整个星期内往返活动场地。离开时也会安排返程接送到机场。',
      travel_steps_3: '[AI_TRANSLATION]全部套餐费用将在出行前支付，扣除初始定金。\n',
      ...
      frame_core_domestic_price_text_5: '[AI_TRANSLATION]不包括旅行或住宿费用。学生需自行前往每个活动地点参加',
      accessibility_title: '[AI_TRANSLATION]健康与安全注意事项',
      accessibility_text_1: '[AI_TRANSLATION]学生们将在我们的教育顾问团队的指导下，留在安全设施中。',
      accessibility_text_2: '[AI_TRANSLATION]所有带队老师和教育顾问都已完成背景调查。',
      accessibility_text_3: '[AI_TRANSLATION]所有设施都会通过安全、现场质量控制和清洁的审批。',
      accessibility_text_4: '[AI_TRANSLATION]目前没有因疫情或其他疾病的旅行限制。如果旅行限制重新实施或我们的团队认为参与者的健康有顾虑，体验可能会改变或取消。',
      //    faq: "Frequently Asked Questions",
      faq_q_1: '[AI_TRANSLATION]有年龄要求吗？',
      faq_a_1: '[AI_TRANSLATION]参与者必须年龄在13-17岁，并且能提供合法的旅行文件。\n',
      faq_q_2: '[AI_TRANSLATION]我可以带着孩子旅行吗？',
    ...
    hackstack: {
      ...
      modes: '[AI_TRANSLATION]模式 (复数)  ',
      tools: '[AI_TRANSLATION]工具（复数）',
      //    tasks: "Tasks",
