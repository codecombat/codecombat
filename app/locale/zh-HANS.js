module.exports = {
  ...
  translation: {
    ...
    premium_features: {
      ...
      ai_bot_description: '[AI_TRANSLATION]CodeCombat 的 AI 老师可以评估代码，指出错误并解释如何修复它们。最重要的是，它提供了所有理解"为什么"所需的背景信息，而不会提供完整的解决方案。在当前代码问题帮助的情况下，小朋友们仍需完成每一关的编程挑战。会员用户每天可获得 10 个 AI 提示配额，确保他们始终能获得所需支持。',
      list_ai_bot: '会员每天可获得10个 AI 提示',
      ai_bot_notice: '[AI_TRANSLATION]* AI老师的提示配额可能会变动。\n',
    },
