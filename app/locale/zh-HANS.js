module.exports = {
  ...
  translation: {
    ...
    codequest_page: {
      ...
      start_application: '[AI_TRANSLATION]启动应用程序',
      codequest: '[AI_TRANSLATION]CodeQuest',
      date: '[AI_TRANSLATION]日期',
      supporting_text: '[AI_TRANSLATION]加入我们独一无二的沉浸式教育体验，旨在激励和赋能下一代计算机科学创新者通过编程和人工智能。欢迎13至17岁的学生。',
      apply_now: '[AI_TRANSLATION]现在申请',
      insight: '[AI_TRANSLATION]一次富有洞察力的现实世界学习体验！',
      testimonials_heading: '[AI_TRANSLATION]这一罕见的机会将全球各地的学生聚集在一起。以下是学生体验的概览。',
      engaging_hackathongs: '[AI_TRANSLATION]参与互动的黑客松',
      insightful_speakers: '[AI_TRANSLATION]富有洞察力的演讲者',
      university_visits: '[AI_TRANSLATION]大学校园参观',
      silicon_valley_experience: '[AI_TRANSLATION]硅谷体验',
      content_title: '[AI_TRANSLATION]学生体验',
      core_curriculum_heading_1: '[AI_TRANSLATION]多个',
      core_curriculum_heading_2: '[AI_TRANSLATION]黑客马拉松竞赛',
      core_curriculum_heading_3: '[AI_TRANSLATION]设计用于',
      core_curriculum_heading_4: '[AI_TRANSLATION]激发创造力',
      core_curriculum_heading_5: '[AI_TRANSLATION]在编程和 ',
      core_curriculum_heading_6: '[AI_TRANSLATION]教授人工智能的实际应用',
      core_curriculum_title_1: '[AI_TRANSLATION]AI HackStack 项目挑战',
      core_curriculum_text_1: '[AI_TRANSLATION]首个专为AI新手设计的生成式AI伴侣工具，能让学生即时从文本到代码再到输出。<br /><br />参赛者将与其他学生配对，使用AI提示开发项目，并进行评判展示。',
      core_curriculum_title_2: '[AI_TRANSLATION]AI 联赛 CodeQuest 全球总决赛',
      core_curriculum_text_2: '[AI_TRANSLATION]一个史诗般的竞技编程电子竞技平台，鼓励在基于游戏的环境中进行创造性编程。<br /><br />参赛者将与其他学生合作，开发最优代码以智胜其他团队，收集一对一胜利并位居排行榜首位。',
      core_curriculum_heading_11: '[AI_TRANSLATION]黑客松将在 ',
      core_curriculum_heading_12: '[AI_TRANSLATION]著名大学',
      core_curriculum_heading_13: '[AI_TRANSLATION]为学生提供独特体验的机会',
      core_curriculum_heading_14: '[AI_TRANSLATION]沉浸',
      core_curriculum_heading_15: '[AI_TRANSLATION]在那里体验自我',
      core_curriculum_heading_16: '[AI_TRANSLATION]大学环境',
      core_curriculum_text_11: '[AI_TRANSLATION]加州大学伯克利分校以其先进的研究和创新而受到全球赞誉，提供全面严格的计算机科学课程。这些程序增强创造性问题解决技巧，并鼓励对计算理论有更深入的理解，装备个人成为快速发展的技术产业中的变革领导者。',
      core_curriculum_text_12: '[AI_TRANSLATION]斯坦福以科技和创新的全球领导者而闻名，提供强大的计算机科学项目，培养创新思维和对理论基础的深刻理解，准备个人成为计算机科学和技术领域的开拓性领袖。',
      core_curriculum_heading_21: '[AI_TRANSLATION]我们的演讲者名单提供的是',
      core_curriculum_heading_22: '[AI_TRANSLATION]无与伦比的洞察力',
      core_curriculum_heading_23: '[AI_TRANSLATION]进入追求计算机科学成功所需的内幕，并将帮助评判比赛。',
      ...
      core_curriculum_title_22: '[AI_TRANSLATION]谷歌X - 月球射击工厂特邀演讲嘉宾',
      ...
      core_curriculum_text_24: '[AI_TRANSLATION]亲自听取一组风险资本家和技术领导者的讲述，他们将详细介绍构建全球技术平台和创建成功商业计划的过程。这场互动演讲将揭开构建下一个伟大技术产品和如何推出它的幕后。',
      core_curriculum_heading_31: '[AI_TRANSLATION]旧金山和硅谷为学生们提供了独特的机会',
      core_curriculum_heading_32: '[AI_TRANSLATION]在科技巨头公司体验生活',
      core_curriculum_heading_33: '[AI_TRANSLATION]和',
      core_curriculum_heading_34: '[AI_TRANSLATION]探索城市的风景',
      core_curriculum_title_31: '[AI_TRANSLATION]参观谷歌总部和X-The Moonshot Factory',
      core_curriculum_text_31: '[AI_TRANSLATION]位于加利福尼亚州的山景城，谷歌校区提供了一个独特的机会，深入了解硅谷的创新心脏。学生将遇到异想天开的建筑，众多的协作工作空间，以及激发创造力的技术驱动艺术装置，提供了一窥在科技行业工作可能像什么的机会。这次独家游览将参观X - 月球射击工厂，看看谷歌内部这个创新团队如何创建激进的新技术来解决世界上一些最难的问题。',
      core_curriculum_title_32: '[AI_TRANSLATION]苹果公园总部参观 & 工作坊',
      core_curriculum_text_32: '[AI_TRANSLATION]苹果园区是创新科技巨头的全球总部，也是来旧金山必访的景点。学生将体验史蒂夫·乔布斯的“车库文化”，这种文化激励了苹果成为世界上最大的公司，并与风险投资家和科技领袖一起参加研讨会，第一手了解构建全球科技平台和创建自己的商业计划所需的条件。',
      core_curriculum_title_33: '[AI_TRANSLATION]旧金山游览',
      core_curriculum_text_33: '[AI_TRANSLATION]学生们有机会沉浸在旧金山多元而充满活力的魅力中。从标志性的金门大桥和历史悠久的阿尔卡特拉斯岛到繁忙的码头和宁静的公园，每个转角都充满冒险。访问旧金山是一次自然美景、城市精致和丰富文化遗产的迷人融合，承诺提供一次难忘的体验。',
      ...
      how_it_works: '[AI_TRANSLATION]工作原理',
      ...
      frame_heading_1: '[AI_TRANSLATION]紧凑的日程将用一系列的活动填满每一天。',
      frame_heading_2: '[AI_TRANSLATION]学习',
      ...
      schedule_day_title_3: '[AI_TRANSLATION]周三',
      schedule_day_title_4: '[AI_TRANSLATION]星期四',
      schedule_day_title_5: '[AI_TRANSLATION]周五',
      ...
      schedule_event_sub_title_1: '[AI_TRANSLATION]抵达',
      schedule_event_sub_title_2: '[AI_TRANSLATION]旅游',
      schedule_event_sub_title_3: '[AI_TRANSLATION]黑客松',
      schedule_event_sub_title_4: '[AI_TRANSLATION]游览与讲座',
      schedule_event_sub_title_6: '[AI_TRANSLATION]离开',
      frame_content_heading: '[AI_TRANSLATION]包含在大多数套餐选项中',
      frame_content_flight_title: '[AI_TRANSLATION]机票和本地交通',
      frame_content_flight_text: '[AI_TRANSLATION]乘坐主要航空公司的往返航班以及往返机场、酒店和活动地点的交通。',
      frame_content_hotel_title: '[AI_TRANSLATION]酒店住宿',
      frame_content_hotel_text: '[AI_TRANSLATION]所有酒店必须符合我们对质量、安全和清洁度的高标准。',
      frame_content_meal_title: '[AI_TRANSLATION]膳食',
      frame_content_meal_text: '[AI_TRANSLATION]每天至少三餐，以及整个活动期间随时可用的零食和水。',
      frame_cta_text: '[AI_TRANSLATION]下载时间表',
      frame_cta_supporting: '[AI_TRANSLATION]所有体验细节都可能发生变化。',
      frame_core_heading_1: '[AI_TRANSLATION]此机会面向 ',
      frame_core_heading_2: '[AI_TRANSLATION]国际的',
      ...
      frame_core_international_text: '[AI_TRANSLATION]包括三天黑客松的完整体验，多个大学校园体验，以及两天的旧金山和硅谷深度体验。',
      frame_core_international_price: '[AI_TRANSLATION]价格：$ 10,000',
      frame_core_international_price_text_1: '[AI_TRANSLATION]对于我们的',
      frame_core_international_price_text_2: '[AI_TRANSLATION]国际参与者',
      frame_core_international_price_text_3: '[AI_TRANSLATION]来自美国外部',
      frame_core_international_price_text_4: '[AI_TRANSLATION]包括航空旅行和住宿',
      frame_core_domestic_title_text: '[AI_TRANSLATION]国内（美国）：',
      frame_core_domestic_title_span: '[AI_TRANSLATION]3天',
      frame_core_domestic_text: '[AI_TRANSLATION]包括参加三天的黑客松活动，并提供多个大学校园体验。',
      frame_core_domestic_price: '[AI_TRANSLATION]价格：$3,750（早鸟价：如果在3/31之前预订，为$2,950）',
      frame_core_domestic_price_text_1: '[AI_TRANSLATION]对于',
      frame_core_domestic_price_text_2: '[AI_TRANSLATION]美国参与者',
      frame_core_domestic_price_text_3: '[AI_TRANSLATION]包括航空旅行和住宿',
      frame_core_domestic_price_2: '[AI_TRANSLATION]定价：$2,175（早鸟价格：$1,675，如果您在3/31之前预订）',
      ...
      faq_a_1: '[AI_TRANSLATION]参与者必须年龄在13-17岁之间，并能提供旅行的法律文件。',
      faq_q_2: '[AI_TRANSLATION]我可以和我的孩子一起旅行吗？',
      faq_a_2: '[AI_TRANSLATION]一些父母确实选择旅行，但活动、事件、旅行和住宿只为学生提供。',
      faq_q_3: '[AI_TRANSLATION]参与需要多少经验？',
      faq_a_3: '[AI_TRANSLATION]学生必须知道的只是任何一种语言的编程基础知识。由于我们将他们分成不同经验水平的团队，我们期望经验更多的学生支持那些经验较少的学生。',
      faq_q_4: '[AI_TRANSLATION]我应该带上我的笔记本电脑吗？',
      faq_a_4: '[AI_TRANSLATION]我们将提供参加黑客松所需的所有硬件和软件。虽然我们允许参与者使用个人电脑，但我们的团队可能无法完全支持或解决所有问题，因此我们推荐使用提供的设备。',
      faq_q_5: '[AI_TRANSLATION]我需要带什么身份证明材料吗？',
      faq_a_5_1: '[AI_TRANSLATION]国内 - 如果参与者单独旅行，我们会要求其父母或法定监护人填写一份紧急联系人表格，其中包括有关其孩子的识别信息。',
      faq_a_5_2: '[AI_TRANSLATION]全球 - 全球学生需要携带他们的护照（带有签证）。',
      faq_q_6: '[AI_TRANSLATION]我的孩子可以期待哪些住宿条件？',
      faq_a_6: '[AI_TRANSLATION]所有参与者和监护人将入住同一家酒店，参与者和监护人将有独立的住宿。参与者将与另一位参与者共用一个房间。工作人员绝不允许单独与参与者相处。希望陪同孩子的父母将共用一个房间。',
      faq_q_7: '[AI_TRANSLATION]如果我的孩子对某些食物过敏或有医疗需求怎么办？',
      faq_a_7: '[AI_TRANSLATION]与您孩子相关的任何健康问题应在紧急联系表中标明。',
      faq_q_8: '[AI_TRANSLATION]谁会负责监护我的孩子？',
      faq_a_8_1: '[AI_TRANSLATION]我们的承诺是把您的孩子置于我们能聘请到的最值得信任和最有能力的人身边——经认证的指导者和辅导员，他们非常适合照顾参与者的任务。每位工作人员都要经过严格的背景和参考调查；我们在筛选和选拔工作人员上所付出的努力是那个承诺的一部分。',
      faq_a_8_2: '[AI_TRANSLATION]我们的工作人员在一个可视的、受到严格审查的环境中与您的孩子一起工作，该环境具有许多内置的检查与平衡机制。指导者和辅导员受到关于行为的清晰、坚定的政策指导。他们的行为对同事和参与者是可见的。',
      faq_q_9: '[AI_TRANSLATION]你们有哪些常规的安全措施？',
      faq_a_9: '[AI_TRANSLATION]所有员工都会接受紧急情况和危机管理培训。',
      faq_q_10: '[AI_TRANSLATION]贵方的退款政策是什么？',
      faq_a_10: '[AI_TRANSLATION]在为参与者预订旅行之前，用以保留您位置的押金是可以退还的。一旦预订了旅行，我们将无法提供退款。',
      more_faq: '[AI_TRANSLATION]在我们的',
