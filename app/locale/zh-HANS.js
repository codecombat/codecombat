module.exports = {
  ...
  translation: {
    ...
    new_home: {
      ...
      game_based_blurb: '[AI_TRANSLATION]扣哒世界是全球广受欢迎的青少年人工智能代码编程学习平台，以PBL场景化和游戏化为特色。平台有6个等级和11个学习模块(含国际等级证书) ，支持Python, C++、JavaScript等程序语言教学和学习。AP权威认证， AI世青赛全球编程挑战活动指定竞赛平台。',
      get_started: '开启编程',
      global_title: '加入我们的全球学习者和教育者社区',
      global_subtitle1: '学习者',
      global_subtitle2: '行代码',
