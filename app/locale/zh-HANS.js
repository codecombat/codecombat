module.exports = {
  ...
  translation: {
    ...
    new_home: {
      ...
      hackstack_china_blurb: '支持生成式人工智能热门大语言模型DeepSeek, 通义千问，千问图片等学习课程和项目开发实践, 是编程进阶学习人工智能的优秀平台，支持斯坦福大学等世界名校研学活动。',
    ...
    play: {
      ...
      hackstack_button_hover: '使用 AI HackStack 编写代码和进行创作',
    ...
    ai: {
      ...
      hackstack_promotion_blurb: '[AI_TRANSLATION]不懂 AI？探索 <b>CodeCombat AI HackStack</b> ——最简单的 AI 入门路径。解锁 DeepSeek,通义千问和千问图片的潜力。这个创新工具提供动手 AI 培训，让创作变得轻松。',
    ...
    hackstack_page: {
      header: '通过 **AI HackStack** 学习、创作并加速成长',
      ...
      remix_description: '通过自定义 AI HackStack **社区库**中的众多项目，为创作过程注入强劲动力。“二创”功能不仅加速了个人进度，还培育了一个想法快速演进的**协作生态系统**。随着学生对彼此的作品进行再创作和改进，课堂的集体产出将达到新的创意高度，呈现出令人惊叹的学生驱动型创新成果。',
      privacy_title: '安全与隐私',
      privacy_subtitle: '我们的 AI 平台在激发学生好奇心与创造力的同时，提供您所需的隐私与安全保障。',
      data_title: '您的数据是安全的',
      data_description: '在将 AI 工具加入 AI HackStack 之前，我们会对其进行严格审查。如果不安全，我们绝不采用。我们还会筛选用户的提示词，确保其中不含任何个人身份信息（PII）。如果发现此类信息，我们会先将其替换为占位符，再提交给外部 AI 模型。此外，您有权锁定特定的 AI 工具，防止学生访问您认为不合适的模型。',
      moderation_title: '我们的监管实践',
      moderation_description: '我们监控用户提示词和 AI 生成内容，确保不含任何不当信息。您可以在 AI HackStack 教师管理面板中查看学生编写的每一条提示词。我们还提供现成的资源，帮助您和学生应对使用 AI 的复杂性，并为希望在学生使用 AI 时获得更多引导建议的教育者提供专业发展机会。',
      ...
      try_it_free: '免费试用',
      faq_1_question: '我的学生多大年纪可以使用 AI HackStack？',
      faq_1_answer: 'AI HackStack 非常适合初中和高中阶段的学生。我们的安全与隐私实践让年轻用户（如您的学生）能够安全地与 AI 互动。如果您教授的是小学生，请**[mailto:team@codecombat.com]联系我们的团队**，了解更多关于 CodeCombat AI Junior 的信息，这是一个专为 K-5 学生设计的简单直观的多模态生成式 AI 平台。',
      ...
      faq_3_question: 'AI HackStack 使用哪些大语言模型 (LLM)？',
      ...
      faq_5_answer_2: '创建班级',
      faq_5_answer_3: '添加学生',
      faq_5_answer_4: '为您的班级解锁 AI HackStack',
      ...
      learn_more: '了解更多',
      promo_modal_title: '探索 AI HackStack',
      promo_modal_subtitle: '释放生成式 AI 的全部潜力',
      promo_modal_text: '**AI 新手？探索 CodeCombat AI HackStack** —— 开启 AI 素养教育最简单的方式。解锁 **ChatGPT-4**、**Claude**、**Stable Diffusion** 和 **DALL-E** 等顶尖模型的力量。借助实用的工具，创作游戏、艺术品、网站和代码变得前所未有的简单。它是任何创意项目的完美伴侣，无需任何经验！',
      explore_hackstack: '探索 Hackstack',
    ...
    hackstack: {
      ...
      no_course_instances: '你没有任何课程实例。请联系你的老师以获取AI Hackstack的访问权限。',
      restart_scenario_confirm: '您的进度将会丢失。您确定要重新开始吗？',
    },

    galaxy: {
      title: '欢迎来到 HackStack Galaxy',
    ...
    new_premium: {
      ...
      features_2: '通过[NEWLINE]AI HackStack掌握人工智能',
      ...
      carousel_items_1_text: '对于几乎没有或没有编程经验的学习者，大多数课程将从CodeCombat Junior开始，以建立基础技能，然后再过渡到CodeCombat以获得更深入的编程知识。AI HackStack将加速学习并展示编码和人工智能的实际应用。CodeCombat Worlds和AI League提供了额外的练习、创造和乐趣的机会。',
      carousel_items_2_text: '如果您热爱游戏并想创建游戏，我们以游戏开发为重点的课程非常适合您。您将首先使用CodeCombat构建交互式项目，然后在CodeCombat Worlds中将您的想法变为现实，您可以在Roblox平台上设计和发布真正的游戏。AI League通过加深您对游戏动态的理解来提供竞争优势，而AI HackStack则通过迭代开发帮助您改进和增强您的创作。',
      carousel_items_3_text: 'Web开发不断发展，保持领先地位至关重要。在本课程中，基础Web开发活动将在CodeCombat中进行，而CodeCombat Junior则为年轻的学习者提供了一个易于入门的起点。AI HackStack将作为构建和发布项目的主要平台，少量使用CodeCombat Worlds和AI League以引人入胜的方式加强关键的编码概念。',
      carousel_items_4_text: '电子竞技爱好者会喜欢这种学习体验的竞争精神。从CodeCombat Junior和CodeCombat开始，学习者将建立强大的编码基础，然后挑战我们的AI League全球电子竞技锦标赛，全年都有奖学金和奖品等你来拿。通过专注于创意编码和迭代，他们还将利用AI HackStack的力量来提升技能并获得竞争优势。',
      carousel_items_5_title: '人工智能素养',
      carousel_items_5_text: '人工智能正在塑造未来，能够驾驭其力量的人将解锁无限的机遇。这种学习体验从CodeCombat Junior和CodeCombat开始，扩展到AI HackStack，学习者将在安全可靠的环境中掌握制作有效人工智能提示和使用最新生成式人工智能工具的艺术。',
      ...
      new_to_ai: '对于人工智能新手，我们提供**[/ai]AI HackStack**，这是一款创新的工具，可以教导学习者如何安全且负责任地使用人工智能。通过安全访问尖端人工智能模型，用户可以创建和试验人工智能驱动的项目。在短时间内，他们将释放人工智能的全部创造潜力，在几分钟内将提示转化为代码、游戏、艺术、网站等等。会员每月可获得50个提示，为您提供充足的机会来探索和使用人工智能进行构建。',
    ...
    parents_v2: {
      ...
      new_to_ai: '对于人工智能新手，我们提供 **[/ai]CodeCombat AI HackStack**。我们的讲师使用这个创新工具来教您的孩子如何安全且负责任地使用人工智能。该应用程序安全地访问许多最新的 LLM，包括 ChatGPT-4、Claude、Stable Diffusion、DALL·E 等。在与我们的讲师合作一小段时间后，您的孩子将释放该工具的全部创造潜力，从而在几分钟内实现从提示到代码再到发布项目的过程。这个人工智能驱动的应用程序使用户能够生成游戏、艺术、网站代码等。每个在线直播课程订阅者每月可获得 200 个提示额度来创建多个 AI 项目。',
