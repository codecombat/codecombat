module.exports = nativeDescription: "English", englishDescription: "English", translation:
  ...
  esper:
    ...
    error_didnt_make_generator: "`__name__` didnt make a generator."
    ...
    error_cant_write_property_to_undefined: "Can't write property of undefiend: `__idx__`."
    ...
    error_base_obj_not_invokable: "Base object not invokeable."
    error_arg2_not_callable: "Arg2 not callalble."
    ...
    error_no_arg_to_reference: "No argument to refrence."
    error_unimplemented_property: "Unimplemented property type."
    error_unimplemented: "Unimplemented."
    error_cant_call_reference: "Can't call refrence like that."
    error_no_arg_to_dereference: "No argument to derefrence."
    error_try_dereference_non: "Tried to derefrence non pointer."
