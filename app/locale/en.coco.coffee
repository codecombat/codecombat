module.exports = nativeDescription: "English", englishDescription: "English", translation:
  ...
  partners:
    ...
    esports_blurb: 'We are reinventing what an esport can be while engaging thousands of students to learn to code. Endemic esports mainstays like __hyperx__ and __respawn__ have supported the CodeCombat AI League from its inaugural season, building compelling promotional programs around this unique esport.'
    hyperx: 'HyperX'
    respawn: 'RESPAWN'
    ...
    equity_social_blurb: 'Not every partnership is built on the bottom line. As a mission-based organization we seek ways to give back as well. We work closely with foundations and other philanthropy partners to expand access to high-quality coding education.  Latin superstar Eugenio Derbez has helped us __reach_latinx__ with a partnership to engage students in this often underserved and underrepresented group. We also seek relationships with nonprofits and community-based organizations working with groups underrepresented in computer science and technology careers.'
