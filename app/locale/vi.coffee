...
#    editor_config_behaviors_description: "Autocompletes brackets, braces, and quotes."
  ...
  about:
    ...
    mission_description_2: "Thực tế thì, điều này cũng giúp cho bạn học nhanh hơn. Nhanh hơn RẤT NHIỀU. Bạn được thực hành thay vì chỉ đọc lý thuyết. Chúng tôi muốn đưa môi trường thực hành này đến với mọi ngôi trường và đến với <strong>mọi học viên</strong>, bởi vì mọi người đều cần có cơ hội biết đến sự nhiệm màu của lập trình."
...
#    josh_blurb: "Floor Is Lava"
    retrostyle_title: "Họa Sĩ Minh Họa"
    retrostyle_blurb: "RetroStyle Games"
    jose_title: "Âm Nhạc"
    jose_blurb: "Taking Off"
    community_title: "...và cộng đồng mã nguồn mở của chúng tối"
