...
#    tip_adding_orgres: "Rounding up ogres."
    ...
    tip_programming_not_about_computers: "Khoa học Máy tính không còn chỉ liên quan đến máy tính cũng giống như thiên văn học đối với kinh thiên văn vậy. - Edsger Dijkstra"
