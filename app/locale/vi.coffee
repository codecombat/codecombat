...
#    export_student_progress: "Export Student Progress (CSV)"
  ...
  classes:
    ...
    adventurer_summary: "Được phép dấn thân vào những màn chơi mới nhất (bao gồm cả những nội dung trả phí) một cách miễn phí trước một tuần và giúp chúng tôi tìm ra lỗi trước ngày ra mắt."
    scribe_title: "Thư kí"
    ...
    ambassador_summary: "Trò chuyện với những thành viện trong diễn đàn và trả lời những thắc mắc. Đoàn Đại Sứ của chúng tôi là bộ mặt đại diện cho CodeCombat tới thế giới."
...
#    join_url_slack: "public Slack channel"
    archmage_subscribe_desc: "Nhận email về những thông tin mới và cơ hội lập trình."
