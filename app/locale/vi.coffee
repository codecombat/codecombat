module.exports = nativeDescription: "Tiếng Việt", englishDescription: "Vietnamese", translation:
  ...
  new_home:
    title: "CodeCombat - Chơi game để học Python và JavaScript"
    meta_keywords: "CodeCombat, python, javascript, học lập trình qua game"
    meta_description: "Học lập trình thông qua chơi game. Học Python, JavaScript, và HTML trong lúc giải đố, tự thiết kế game và website."
...
#    see_example: "See example"
    slogan: "Cách vui nhất để học lập trình"
...
#    im_an_educator_description: "Teach Computer Science with CodeCombat"
    ...
    im_a_student: "Tôi là Học sinh / Sinh viên"
...
#    billion: "__num__ Billion"
  ...
  nav:
    ...
    map: "Bản đồ"
    play: "Chơi game"  # The top nav bar entry where players choose which levels to play
    community: "Cộng đồng người chơi"
    courses: "Khoá học"
    blog: "Blog"
    forum: "Diễn đàn"
    account: "Tài Khoản"
...
#    my_teachers: "My Teachers"
    ...
    help_pref: "Nếu cần hỗ trợ, hãy gửi email tới"
    help_suff: ", CodeCombat sẽ trả lời ngay!"
...
#    simulate_all: "Simulate All"
    ...
    locked: "Bị khoá"
    available: "Chọn được"
    skills_granted: "Các kỹ năng đi kèm"  # Property documentation details
    ...
    poll: "Bình chọn"  # Tooltip on poll button from /play
...
#    login: "Login"
    ...
    birthday: "Ngày sinh"
    login_switch: "Nếu đã có tài khoản rồi thì sao?"
...
#    tome_cast_button_update: "Update"
    ...
    tome_reload_method: "Lấy lại code mẫu và chơi lại từ đầu"
    hints: "Gợi ý"
#    videos: "Videos"
    hints_title: "Gợi ý số {{number}}"
    code_saved: "Đã lưu Code"
    keyboard_shortcuts: "Các phím tắt"
    skip_tutorial: "Không cần hướng dẫn (esc)"
    loading_start: "Bắt đầu"
...
#    score_display: "__scoreType__: __score__"
  ...
  inventory:
    equipped_item: "Đã mặc"
    required_purchase_title: "Bắt buộc"
    available_item: "Dùng được"
    restricted_title: "Không dùng được"
    should_equip: "(nháy đúp để mặc vào)"
    equipped: "(đã mặc)"
    locked: "(đã bị khoá)"
    restricted: "(không dùng được trong bài này)"
    equip: "Mặc vào"
    unequip: "Cởi ra"
...
#    list_clans: "Create private clans to invite your friends and compete on a group leaderboard"
  ...
  choose_hero:
    choose_hero: "Chọn Nhân Vật"
    programming_language: "Ngôn ngữ lập trình"
    programming_language_description: "Em muốn sử dụng ngôn ngữ lập trình nào?"
    default: "Mặc định"
    experimental: "Thử nghiệm"
    python_blurb: "Đơn giản nhưng hiệu quả, phù hợp với cả người mới học cũng như dân chuyên nghiệp."
    javascript_blurb: "Ngôn ngữ của thế giới web. (Khác với Java đấy nhé.)"
    coffeescript_blurb: "Cũng là JavaScript nhưng cú pháp súc tích hơn."
    lua_blurb: "Ngôn ngữ lập trình Game."
    java_blurb: "(Chỉ dành cho các tài khoản trả phí) Android và các ứng dụng doanh nghiệp."
    cpp_blurb: "(Chỉ dành cho các tài khoản trả phí) Lập trình game và các tính toán hiệu năng cao."
    status: "Trạng thái"
    weapons: "Vũ khí"
    weapons_warrior: "Kiếm - Tầm ngắn, Không có phép thuật"
    weapons_ranger: "Cung tên, Súng - Tầm xa, Không có phép thuật"
    weapons_wizard: "Đũa thần, Trượng - Tầm xa, Có phép thuật"
    attack: "Tấn công"  # Can also translate as "Attack"
    health: "Sức khoẻ"
    speed: "Tốc độ"
    regeneration: "Tự hồi phục"
    range: "Phạm vi"  # As in "attack or visual range"
    blocks: "Chống đỡ"  # As in "this shield blocks this much damage"
    backstab: "Đâm"  # As in "this dagger does this much backstab damage"
    skills: "Khả năng đặc biệt"
    attack_1: "Gây ra"
    attack_2: "khả năng sát thương bằng vũ khí của"
    attack_3: "."
    health_1: "Tăng" Gains 71% of listed Warrior armor health.
    health_2: "giáp của"
    health_3: "."
    ...
    speed_1: "Di chuyển với tốc độ"
    speed_2: "mét mỗi giây."
...
#    read_only: "read-only"
    action: ""
    spell: "Phù phép"
    action_name: "Tên kỹ năng"
    action_cooldown: "Tốn"
    action_specific_cooldown: "Chờ"
    action_damage: "Gây thương tích"
    action_range: "Phạm vi"
    action_radius: "Bán kính"
    action_duration: "Kéo dài"
    example: "Ví dụ"
    ex: "ví dụ"  # Abbreviation of "example"
    current_value: "Giá trị hiện tại"
    default_value: "Giá trị mặc định"
    parameters: "Tham số"
    required_parameters: "Các tham số bắt buộc"
    optional_parameters: "Các tham số không bắt buộc"
    returns: "Trả về"
    granted_by: "Có kỹ năng này là nhờ"
    still_undocumented: "Chưa có tài liệu cho kỹ năng này, xin lỗi em!"
  ...
  options:
    general_options: "Tùy Chỉnh" # Check out the Options tab in the Game Menu while playing a level
    volume_label: "Âm lượng"
    music_label: "Nhạc nền"
    music_description: "Bật/tắt nhạc nền."
    editor_config_title: "Điều chỉnh khu vực viết code"
    editor_config_livecompletion_label: "Tự động gợi ý"
    editor_config_livecompletion_description: "Hiển thị các gợi ý code khi đang viết lệnh."
    editor_config_invisibles_label: "Hiện ký tự ẩn"
    editor_config_invisibles_description: "Hiển thị các ký tự ẩn như dấu cách hoặc dấu tab."
    editor_config_indentguides_label: "Hiện chỉ dẫn lùi đầu dòng"
    editor_config_indentguides_description: "Hiển thị các đường dọc để giúp lùi đầu dòng dễ hơn."
    editor_config_behaviors_label: "Các hỗ trợ khác"
    editor_config_behaviors_description: "Tự động đóng ngoặc tròn, ngoặc nhọn, ngoặc đơn, ngoặc kép."
...
#    no_ranked_matches_post: " team! Play against some competitors and then come back here to get your game ranked."
    ...
    select_your_language: "Chọn ngôn ngữ lập trình!"
    tutorial_play: "Xem hướng dẫn"
...
#    bootstrap: "Bootstrap"
    break_statements: "Lệnh Break"
    classes: "Lớp"
    continue_statements: "Lệnh Continue"
...
#    xy_coordinates: "Coordinate Pairs"
    ...
    input_handling: "Xử lý dữ liệu đầu vào"
