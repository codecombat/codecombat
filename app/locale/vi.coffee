...
#    comparison_blurb: "Sharpen your skills with a CodeCombat subscription!"
    feature1: "$t(data.levelsCount)+ level căn bản qua $t(data.worldsCount) thế giới" # {change}
    feature2: "$t(data.heroesCount) <strong>nhât vật mới</strong> mạnh mẽ với những kĩ năng đặc biệt!" # {change}
