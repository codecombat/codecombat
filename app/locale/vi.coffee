...
#    list_clans: "Create private clans to invite your friends and compete on a group leaderboard"
  ...
  choose_hero:
    ...
    available_for_purchase: "Có thể mua được" # Shows up when you have unlocked, but not purchased, a hero in the hero store
    level_to_unlock: "Cấp độ tối thiểu:" # Label for which level you have to beat to unlock a particular hero (click a locked hero in the store to see)
    restricted_to_certain_heroes: "Bài này chỉ có một số nhân vật mới có thể chơi được."
