module.exports = nativeDescription: "Tiếng Việt", englishDescription: "Vietnamese", translation:
  ...
  new_home:
    ...
    codecombat_is: "CodeCombat là nền tảng <strong>giúp học sinh</strong> tiếp cận với bộ môn công nghệ thông tin Thông qua chơi game."
    our_courses: "Các khóa học của chúng tôi đã được thử nghiệm để <strong>triển khai trong lớp học</strong>, thậm chí gây được sự chú ý từ các giáo viên có ít hoặc không có kinh nghiệm lập trình."
    ...
    getting_students: "Cho phép học viên viết code ngay từ khởi đầu là vô cùng quan trọng trong việc làm quen với cú pháp và học cấu trúc lập trình."
    educator_resources: "Xây dựng bài giảng"
    course_guides: "và các khóa học"
    teaching_computer_science: "Việc dạy bộ môn công nghệ thông tin không nhất thiết yêu cầu một tấm bằng đắt tiền, vì chúng tôi đã cung cấp sẵn công cụ dành cho mọi giảng viên."
    ...
    forgot_learning: "Tôi nghĩ học viên thậm chí không để ý rằng họ đang học."
    ...
    excel: "Game cổ vũ"
    struggle: "những cố gắng tích cực"
    kind_of_struggle: "những sự cố gắng trong học tập thực sự dem lại sự cuốn hút và"
    motivating: "tạo động lực"
    not_tedious: "chứ không hề buồn chán."
    ...
    compared: "so sánh"
    conventional: "với phương pháp giảng dạy truyền thống, ta thấy sự khác biệt rõ ràng: chơi game giúp học sinh nhớ tốt hơn, tập trung tốt hơn và"
    perform_at_higher_level: "đạt được những thành tích cao hơn"
    feedback: "Việc chơi game cũng giúp học sinh tương tác để có thể phát triển tư duy một cách toàn diện hơn, thay vì chỉ biết đến lời giải “đúng” hay “không đúng”."
    real_game: "Game thật, code thật."
    great_game: "Một tựa game hay không chỉ cần những huy chương hay thành tích hào nhoáng - quan trọng hơn hết vẫn là hành trình trải nghiệm của người chơi, giải đáp những câu đố, và tự tin vượt qua thử thách."
    agency: "CodeCombat là trò chơi giúp người chơi những kĩ năng đó thông qua viết code, điều này giúp cho cả những người mới bắt đầu và những học viên trình độ nâng cao luyện tập khả năng lập trình thành thạo."
    ...
    courses_available_in: "Hiện có các khóa học giảng dạy JavaScript, Python, và Java (sắp ra mắt!)"
...
#    toggle_nav: "Toggle navigation"
    jobs: "Việc làm"
    schools: "Khư vực Trường Học"
    educator_wiki: "Wiki cho Giáo Viên"
    get_involved: "Tham Gia"
    open_source: "Mã nguồn mở (GitHub)"
    support: "Hỗ trợ"
    faqs: "FAQs"
    help_pref: "Cần trợ giúp? Hãy gửi email tới"
    help_suff: "và chúng tôi sẽ giúp bạn!"
  ...
  diplomat_suggestion:
    ...
    sub_heading: "Chúng tôi cần kỹ năng của bạn."
    pitch_body: "Chúng tôi xây dựng Codecombat bằng Tiếng Anh, tuy nhiên có rất nhiều bạn trẻ trên toàn thế giới đều muốn tham gia. Hãy các bạn trẻ Việt Nam cơ hội để tham gia chơi với nội dung Tiếng Việt, nếu như bạn có thể đọc và viết thành thạo cả 2 ngôn ngữ xin hãy đăng kí làm phiên dịch viên cho chúng tôi."
    missing_translations: "Bạn sẽ tiếp tục thấy nội dung Tiếng Anh cho đến khi nội dung được dịch hoàn toàn sang Tiếng Việt."
