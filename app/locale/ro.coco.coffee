...
#    code_line_number: "1 Billion"
  ...
  new_home:
    title_coco: "CodeCombat - Programare de jocuri pentru a învăța Python și JavaScript"
    title_ozar: "CodeCombat - Programare de jocuri pentru a învăța Python și JavaScript"
    meta_keywords_coco: "CodeCombat, python, javascript, programare de jocuri"
    meta_keywords_ozar: "CodeCombat, python, javascript, programare de jocuri"
    meta_description_coco: "Învață să scri cod prin programarea de unui joc. Învață Python, JavaScript, și HTML ca și când ai rezolva puzzle-uri și învață să îți faci propriile jocuri și site-uri web."
    meta_description_ozar: "Învață să scri cod prin programarea de unui joc. Învață Python, JavaScript, și HTML ca și când ai rezolva puzzle-uri și învață să îți faci propriile jocuri și site-uri web."
...
#    confirm_individual_blurb_without_email: "Write down your login information in case you need it later."
    ...
    teacher_students_can_start_now_coco: "Elevii vor putea să înceapă să joace primul curs, Introducere în informatică, immediat."
    teacher_students_can_start_now_ozar: "Elevii vor putea să înceapă să joace primul curs, Introducere în informatică, immediat."
    ...
    teacher_list_resource_hub_2_coco: "Ghidurile de curs"
    teacher_list_resource_hub_2_ozar: "Ghidurile de curs"
...
#    select_your_state: "Select your state"
  ...
  common:
    default_title_coco: "CodeCombat - Jocuri de scris cod pentru a învăța Python și JavaScript"
    default_title_ozar: "CodeCombat - Jocuri de scris cod pentru a învăța Python și JavaScript"
#    ozaria: "Ozaria"
    default_meta_description_coco: "Învață să scri cod prin programarea de unui joc. Învață Python, JavaScript, și HTML ca și când ai rezolva puzzle-uri și învață să îți faci propriile jocuri și site-uri web."
    default_meta_description_ozar: "Învață să scri cod prin programarea de unui joc. Învață Python, JavaScript, și HTML ca și când ai rezolva puzzle-uri și învață să îți faci propriile jocuri și site-uri web."
...
#    description_coming_soon: "Description coming soon"
  ...
  options:
    ...
    editor_config_title_coco: "Configurare editor"
    editor_config_title_ozar: "Configurare Editor"
