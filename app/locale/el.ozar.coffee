...
#    unit_complete: "Unit Complete"
    ...
    subtitle: "Ελέγξτε τις επισκοπήσεις των μαθημάτων και τα επίπεδα" # Flat style redesign {change}
...
#    revoke_selected_confirm: "Are you sure you want to revoke Licenses from all selected students?"
    ...
    view_project_gallery: "Προβολή Έκθεσης Εργασιών" # {change}
    ...
    level_label: "Επίπεδο:"
    time_played_label: "Χρόνος Παιξίματος:" # {change}
