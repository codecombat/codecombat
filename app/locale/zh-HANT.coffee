module.exports = nativeDescription: "繁體中文", englishDescription: "Chinese (Traditional)", translation:
  ...
  signup:
    ...
    sign_in: "登入"
    email_good: "可用Email"
    name_taken: "此名稱已被註冊！試試{{suggestedName}}?"
    ...
    individuals_or_parents: "私人帳戶＆家長"
    individual_type: "家長們應該在此為每個於課外學習編程的玩家們申請一個帳號。"
    signup_as_individual: "創建私人帳戶"
    enter_class_code: "輸入你的課程代碼"
    enter_birthdate: "輸入生日："
    parent_use_birthdate: "親愛的家長，請輸入您的生日"
    ask_teacher_1: "向老師詢問課程代碼為何"
    ask_teacher_2: "還不是課堂的一份子？創建一個"
    ask_teacher_3: "私人帳號"
    ask_teacher_4: " 而非反過來。"
    about_to_join: "您將會加入："
