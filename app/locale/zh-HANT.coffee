module.exports = nativeDescription: "繁體中文", englishDescription: "Chinese (Traditional)", translation:
  ...
  new_home:
    ...
    codecombat_is: "CodeCombat是一個給<strong>學生</strong>透過進行遊戲來學習電腦科學的平台。"   #"CodeCombat is a platform <strong>for students</strong> to learn computer science while playing through a real game."
    ...
    accessible_to: "無障礙的"
    everyone: "每一個人"
    democratizing: "使學習寫程式碼的過程民主化是我們的核心理念，每個人都應該有機會學習寫程式。"    #"Democratizing the process of learning coding is at the core of our philosophy. Everyone should be able to learn to code."
    forgot_learning: "我認為他們確實忘記了他們實際上學過什麼。"    #"I think they actually forgot that they were actually learning something."
    ...
    encourage: "遊戲是一個促進互動、發現及嘗試錯誤的媒介，一款好的遊戲可以試煉玩家並隨著時間精進技巧，這個過程與學生在學習中的經歷是同等重要的。"    #"Gaming is a medium that encourages interaction, discovery, and trial-and-error. A good game challenges the player to master skills over time, which is the same critical process students go through as they learn."
    excel: "遊戲在回報方面勝出" #"Games excel at rewarding"
    struggle: "良性競爭"#"productive struggle"
    kind_of_struggle: "競爭的種類反映在學習是否引人入勝，並且"#"the kind of struggle that results in learning that’s engaging and"
    ...
    compared: "相符的"
    conventional: "相較於傳統評定方式的差異很明顯，「遊戲在保存知識和保持專注上是有幫助的」。"    #"against conventional assessment methods, the difference is clear: games are better at helping students retain knowledge, concentrate and"
    perform_at_higher_level: "表現更高的成就水平"#"perform at a higher level of achievement"
    ...
    real_game: "這是一個真正的遊戲，伴隨著真正的寫入程式碼。"#"A real game, played with real coding."
    great_game: "一個很棒的遊戲不只有徽章和成就--它更是玩家的旅程、一個設計優良的謎題，以及藉由幫助和信心完成挑戰的能力。"    #    "A great game is more than just badges and achievements - it’s about a player’s journey, well-designed puzzles, and the ability to tackle challenges with agency and confidence."
    ...
    ffa: "對所有學生都是免費的"#"Free for all students"
    ...
    boast: "擁有足夠複雜的關卡，同樣的吸引玩家以及程式撰寫者。"    #"Boasts riddles that are complex enough to fascinate gamers and coders alike."
    ...
    class_in_box: "了解我們的classroom-in-a-box平台如何去融入您的課程表。"#"Learn how our classroom-in-a-box platform fits into your curriculum."
  ...
  code:
    if: "若" # Keywords--these translations show up on hover, so please translate them all, even if it's kind of long. (In the code editor, they will still be in English.)
    else: "其他則"
    elif: "其他則若"
    while: "當"
    loop: "迴圈"
  ...
  play_level:
    ...
    victory_no_progress_for_teachers: "老師不會保存進度，但是你可以將自己的帳號加入班級作為學生來保存。"    #"Progress is not saved for teachers. But, you can add a student account to your classroom for yourself."
    guide_title: "指南"
    ...
    tip_code_never_lies: "程式碼從不說謊，但註解偶爾會。 — Ron Jeffries"
    ...
    tip_google: "有一個您不能解決的問題？Google它！"
...
#    tip_internet_weather: "Just move to the internet, it's great here. We get to live inside where the weather is always awesome. - John Green"
    tip_nerds: "書呆子允許被愛填滿，像在椅子上跳上跳下不能控制自己般的喜歡。 - John Green"#"Nerds are allowed to love stuff, like jump-up-and-down-in-the-chair-can't-control-yourself love it. - John Green"
    tip_self_taught: "我自學了90%我學過的東西，這是很正常的! - Hank Green"#"I taught myself 90% of what I've learned. And that's normal! - Hank Green"
    tip_luna_lovegood: "別擔心，你只有跟我一樣理智。 - Luna Lovegood"#"Don't worry, you're just as sane as I am. - Luna Lovegood"
