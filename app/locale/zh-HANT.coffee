module.exports = nativeDescription: "繁體中文", englishDescription: "Chinese (Traditional)", translation:
  ...
  general:
    ...
    first_name: "名"
    last_name: "姓"
#    last_initial: "Last Initial" 中文姓名較少使用這個
    username: "使用者名稱"
    contact_us: "與我們聯繫"
    close_window: "關閉視窗"
    learn_more: "了解更多"
  ...
  play_game_dev_level:
    ...
    how_to_play_2: "點擊地圖任一處讓英雄移動至該地點。"
    how_to_play_3: "點擊食人魔來攻擊他們。"
    restart: "重置關卡"
    play: "開始玩關卡"
...
#    course_suffix: ""
  ...
  courses:
    ...
    not_enrolled: "您没有註冊這一個課程。"
    visit_pref: "請到這個"
    visit_suf: "網頁註冊。"
    select_class: "請選其中一個班級"
    unnamed: "*未命名*"
    select: "選擇"
    unnamed_class: "未命名的班級"
    edit_settings: "編輯班級設定"
    ...
    you_have1: "您擁有"
    you_have2: "個未使用的學生註冊碼"
    use_one: "用1個學生註冊碼到"
    use_multiple: "將註冊碼用在下列學生上:"
    already_enrolled: "已經招收"
    licenses_remaining: "註冊碼剩餘:"
    insufficient_enrollments: "學生註冊碼不足"
    ...
    complete: "完成"
    none: "無"
    play_campaign_title: "參加活動"
    play_campaign_description: "你已經可以進行下個步驟! 探索上百個具有挑戰性的關卡，學習進階的編成技巧，並且在多人競技場中競賽!"
    create_account_title: "建立一個帳號"
    create_account_description: "註冊一個免費的CodeCombat帳號並且取得更多的關卡、更多的編成技巧，以及更多的樂趣!"
    preview_campaign_title: "預覽活動"
    preview_campaign_description: "在註冊您的免費帳號之前，搶先體驗CodeCombat提供的完整內容。"
    arena: "競技場"
    arena_soon_title: "即將開放的競技場"
    arena_soon_description: "我們正在建立教室專用的多人競技場在最後的"
    not_enrolled1: "未被招收"
    not_enrolled2: "請求您的老師在下一個課程中招收您。"
    next_course: "下個課程"
    coming_soon1: "即將開放"
    coming_soon2: "我們正在努力為您製作更多的課程!"
    ...
    completed_hoc: "太令人驚訝了! 您已經完成了編程時光!"
    ready_for_more_header: "想要更多的課程嗎? 那就進入競技模式吧!"
    ready_for_more_1: "用寶石來解鎖新的物品!"
    ready_for_more_2: "全新的世界以及全新的挑戰"
    ready_for_more_3: "學習更多的程式語言!"
    saved_games: "儲存遊戲"
    hoc: "編程時光"
    my_classes: "現在的教室"
    ...
    start: "開始"
    last_level: "最後遊玩的關卡"
    welcome_to_hoc: "冒險者們，歡迎進入我們的編程時光!"
    logged_in_as: "用以下身分登入:"
    not_you: "不是您嗎?"
    welcome_back: "Hi 冒險者，觀迎回來!"
    continue_playing: "繼續進行遊戲"
    more_options: "更多選項:"
    option1_header: "用Email邀請學生"
    option1_body: "注意: 如果您的學生沒有Email，他們可以在建立學生帳號時輸入您特別的班級代碼取代Email地址。"
    thank_you_pref: "感謝您的購買! 您現在可以分配"
    thank_you_suff: "更多學生到付費課程中。"
    return_to_class: "回到教室"
    return_to_course_man: "回到課程管理。"
    students_not_enrolled: "學生們未被招收"
    total_all_classes: "所有班級的總計"
    how_many_enrollments: "您需要多少個額外的學生註冊碼呢?"
    each_student_access: "一旦學生被招收到付費課程中，每個學生將會取得2至4個課程。你可以獨立的分配每個課程給每位學生。"
    purchase_now: "現在購買"
    enrollments: "註冊碼"
    ...
    my_courses: "我的課程"
    classroom: "教室"
    use_school_email: "如果擁有學校Email的話請使用"
    unique_name: "一個沒有人使用的、獨一無二的名子"
    pick_something: "選擇一個您可以記住的"
    class_code: "班級代碼"
    optional_ask: "選項 - 請您的老師給您一個!"
    optional_school: "選項 - 您就讀哪一所學校?"
    start_playing: "開始遊戲"
    skip_this: "跳過這步，我將會晚一點建立帳號!"
    welcome: "歡迎"
    getting_started: "開始課程"
    download_getting_started: "下載引導手冊 [PDF]"
    getting_started_1: "點擊下方綠色的'建立新的班級'按鈕來建立一個新的班級。"
    getting_started_2: "您建立班級之後，點擊藍色的'加入學生'按鈕。"
    getting_started_3: "當學生註冊並加入您的班級，您將會在下方看到學生的進度。"
    educator_wiki_pref: "或者查看我們新的"
    educator_wiki_mid: "教育者 wiki"
    educator_wiki_suff: "在線上瀏覽引導手冊。"
    your_classes: "您的班級"
    no_classes: "還沒有任何班級!"
    create_new_class1: "建立新的班級"
    available_courses: "可取得的課程"
    unused_enrollments: "可使用的未啟動註冊碼:"
    students_access: "所有學生可以取得免費的計算機科學介紹。每位學生(只)需要一個註冊碼來進入付費CodeCombat課程。"
    active_courses: "啟動課程"
    no_students: "還沒有加入任何學生!"
    add_students1: "加入學生"
    view_edit: "觀看/編輯"
    students_enrolled: "已招收學生"
    students_assigned: "已指派學生"
    length: "長度:"
