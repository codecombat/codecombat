module.exports = nativeDescription: "繁體中文", englishDescription: "Chinese (Traditional)", translation:
  ...
  new_home:
    ...
    lesson_time: "課程時間："
    coming_soon: "敬請期待!"
    courses_available_in: "包含JavaScript, Python,和Java的課程(敬請期待!)"
    boast: "擁有足夠複雜的關卡，同時能吸引玩家以及程式撰寫者。"
    winning: "成功的結合RPG遊戲和程式設計作業，造就了對孩子有善且能樂在其中的教育環境。"
    run_class: "如今想要在學校進行一堂電腦科學的課程，您不再需要有電腦科學的背景。"
    teachers: "老師們!"
    teachers_and_educators: "老師及教育者們"
    class_in_box: "了解我們的盒中教室平台如何去融入您的課程表。"
    get_started: "準備開始"
    students: "學生們："
    join_class: "加入班級"
    role: "您扮演的角色"
    student_count: "學生的數量："
    start_playing_for_free: "免費開始遊玩!"
    students_and_players: "學生及玩家們"
    goto_classes: "進入我的班級"
    view_profile: "瀏覽我的帳號"
    view_progress: "瀏覽進度"
