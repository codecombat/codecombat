...
#    course_suffix: ""
  ...
  teacher:
    ...
    bulk_assign: "批量指派"
    assigned_msg_1: "{{numberAssigned}} 個學生被指派到 {{courseName}}。"
    assigned_msg_2: "{{numberEnrolled}} 個註冊碼需要使用。"
    assigned_msg_3: "您現在還有 {{remainingSpots}} 個可使用的註冊碼。"
    assign_course: "指派班級"
    not_assigned_modal_title: "班級未被指派"
    not_assigned_modal_starter_body_1: "這個課程需要一個啟動註冊碼。您沒有足夠多可用的啟動註冊碼來指派這個課程給所有 __selected__ 選擇的學生。"
    not_assigned_modal_starter_body_2: "購買啟動註冊碼來授予這個課程的存取。"
    ...
    not_assigned_modal_full_body_3: "請選擇少一點的學生，或是到 __supportEmail__ 取得幫助。"
