module.exports = nativeDescription: "繁體中文", englishDescription: "Chinese (Traditional)", translation:
  ...
  login:
    sign_up: "註冊"
    email_or_username: "Email帳號 或是 使用者名稱"
    log_in: "登入"
    logging_in: "登入中"
    log_out: "登出"
  ...
  signup:
    ...
    email_announcements: "接收通知了解CodeCombat中的新關卡和新功能!" 
    creating: "帳號建立中…"
    sign_up: "註冊"
    log_in: "登入"
    ...
    signup_as_individual: "創建私人帳號"
    enter_class_code: "輸入你的班級代碼"
    enter_birthdate: "輸入生日："
    parent_use_birthdate: "親愛的家長，請輸入您的生日"
    ask_teacher_1: "向老師詢問班級代碼為何"
    ask_teacher_2: "還不是班級的一份子嗎？那就創建一個吧"
    ask_teacher_3: "私人帳號"
    ask_teacher_4: " 相反的。"
    about_to_join: "您將會加入："
  ...
  general:
    ...
    first_name: "名"
    last_name: "姓"
#    last_initial: "Last Initial " 中文似乎沒有這個習慣
    username: "使用者名稱"
  ...
  subscribe:
    ...
    feature1: "__levelsCount__ 個以上的基本關卡遍佈在__worldsCount__個世界中" 
    ...
    unsubscribe_feedback_placeholder: "我們哪裡需要改進呢？"
    ...
    payment_methods_blurb1: "我們現有的付費方式有信用卡和支付寶。您也可以以{{three_month_price}}美元的價格PayPal至 nick@codecombat.com ，並註記您的帳號email來購買三個月的訂閱以及寶石，或是以${{year_price}}美元訂閱一年。" 
  ...
  skill_docs:
    ...
    default_value: "預設數值"
    parameters: "參數"
    required_parameters: "需要的參數"#"Required Parameters"
    optional_parameters: "選擇性參數"#"Optional Parameters"
    returns: "回傳"
    granted_by: "賦予"
  ...
  about:
    ...
    elliot_title: "合作經裡"
    elliot_blurb: "讀心師"
    lisa_title: "校園專家"#"School Specialist"
    lisa_blurb: "堅毅不拔的人"#"A gritty one"
    sean_title: "區域經理"
    ...
    jobs_benefit_9: "十年的公司期權"#"10-year option exercise window"
    jobs_benefit_10: "產假:10週給薪以及接下來6週55%的給薪"#"Maternity leave: 10 weeks paid, next 6 @ 55% salary"
    jobs_benefit_11: "陪產假:10週給薪"#"Paternity leave: 10 weeks paid"
    learn_more: "了解更多"
