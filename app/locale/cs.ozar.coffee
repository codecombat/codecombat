...
#    sign_in: "Sign In"
    ...
    sign_in_with_facebook: "Přihlásit přes Facebook" # {change}
    sign_in_with_gplus: "Přihlásit přes Google+" # {change}
...
#    login: "Login"
    ...
    signup_as_teacher: "Založit účet jako učitel" # {change}
    ...
    signup_as_student: "Založit účet jako student" # {change}
    ...
    write_this_down: "Zapište si:" # {change}
...
#    description_coming_soon: "Description coming soon"
  ...
  options:
    ...
    editor_config_title: "Konfigurace editoru" # {change}
    editor_config_livecompletion_label: "Živé automatické dokončování" # {change}
    ...
    editor_config_behaviors_label: "Chytré chování" # {change}
...
#    back_classroom: "Back to classroom"
    back_courses: "Zpět na moje kurzy" # {change}
