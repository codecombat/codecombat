module.exports = nativeDescription: "русский", englishDescription: "Russian", translation:
  ...
  ozaria_home:
    ...
    summary: "Озария - это курс информатики, приключенческая игра и сказочная история, в которой ученики овладеют потерянной магией программирования, чтобы спасти сказочный мир" 
