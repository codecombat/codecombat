module.exports = nativeDescription: "български език", englishDescription: "Bulgarian", translation:
  ...
  play_level:
    ...
    tip_hofstadters_law: "Закон на Хофщадтер: Всяка работа продължава повече от колкото се очаква, дори дори когато законът на Хофщадтер е взет в предвид."
    ...
    tip_control_destiny: "При истинският отворен код всеки има правото да контролира собствената си съдба. - Линус Торвалдс"
