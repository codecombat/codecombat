...
#    tip_hate_computers: "That's the thing about people who think they hate computers. What they really hate is lousy programmers. - Larry Niven"
  ...
  subscribe:
    ...
    parents_blurb1a: "Saper programmare i computer è una capacità essenziale che il vostro bambino utilizzerà senza dubbio da adulto. Entro il 2020, le competenze di base di creazione del software saranno necessarie nel 77% dei posti di lavoro, gli ingegneri del software sono molto richiesti in tutto il mondo. Lo sapevate che una laurea in informatica riscontra ottimi livelli retributivi?" #"Computer programming is an essential skill that your child will undoubtedly use as an adult. By 2020, basic software skills will be needed by 77% of jobs, and software engineers are in high demand across the world. Did you know that Computer Science is the highest-paid university degree?"
    parents_blurb2: "Per $9.99 USD/mese, il tuo bambino potrà affrontare nuove sfide ogni settimana e riceverà supporto personale via email da programmatori professionisti." #"For $9.99 USD/mo, your child will get new challenges every week and personal email support from professional programmers."
    parents_blurb3: "Nessun Rischio: 100% garanzia di rimborso, basta 1-click per cancellare l'iscrizione." #"No Risk: 100% money back guarantee, easy 1-click unsubscribe."
...
#    sale_extended: "*Existing subscriptions will be extended by 1 year."
    sale_feature_here: "Ecco cosa otterrai:" #"Here's what you'll get:"
    sale_feature2: "Guadagna l'accesso a 9 potenti <strong>nuovi eroi</strong> con abilità uniche!"#"Access to 9 powerful <strong>new heroes</strong> with unique skills!"
#    sale_feature4: "<strong>42,000 bonus gems</strong> awarded immediately!"
#    sale_continue: "Ready to continue adventuring?"
#    sale_limited_time: "Limited time offer!"
    sale_new_heroes: "Nuovi eroi!"#"New heroes!"
#    sale_title: "Back to School Sale"
    sale_view_button: "Abbonati per un anno per" #"Buy 1 year subscription for"
