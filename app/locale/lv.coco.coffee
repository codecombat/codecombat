...
#    code_line_number: "1 Billion"
  ...
  new_home:
    title_coco: "CodeCombat - Kodēšanas spēles Python un JavaScript apguvei"
    title_ozar: "CodeCombat - Kodēšanas spēles Python un JavaScript apguvei"
    meta_keywords_coco: "CodeCombat, python, javascript, Kodēšanas Spēles"
    meta_keywords_ozar: "CodeCombat, python, javascript, Kodēšanas Spēles"
