...
choose_hero:
   choose_hero: "Vyber svojho hrdinu" # "Choose Your Hero"
   programming_language: "Programovací jazyk" #"Programming Language"
   programming_language_description: "Aký programovací jazyk chceš použiť ? "#"Which programming language do you want to use?" default: "predvolený" #"Default"
   default: "Predvolený"
   experimental: "Experimentálny" #"Experimental"
   python_blurb: "Jednoduchý ale výkonný, skvelý pre začiatočníkov aj expertov" #"Simple yet powerful, great for beginners and experts."
   javascript_blurb: "Jazyk webových stránok. (Nie je to Java)" #"The language of the web. (Not the same as Java.)"
   coffeescript_blurb: "Krajšia syntax pre JavaScript" #"Nicer JavaScript syntax."
   clojure_blurb: "Moderný Lisp"#"A modern Lisp."
