module.exports = nativeDescription: "English", englishDescription: "English", translation:
  ...
  teacher:
    ...
    cie_ylt_python_principles: "CIE Youth Level Test Python Principles"
    cie_ylt_python_principles_desc: "Youth Level Test is the China Institute of Electronics to serve the needs of the national education reform and the improvement of the scientific quality of the people, with the goal of improving the overall information literacy and innovation ability of the youth of our country. Since 2011, the evaluation project of the information technology ability and quality of the national youth has been launched."
    ncre_python_principles: "NCRE Python Principles"
    ncre_python_principles_desc: "The National Computer Rank Examination (NCRE), approved by the former National Education Commission (now the Ministry of Education), sponsored by the Examination Center of the Ministry of Education, is socially oriented and used to test examinees’ computer application knowledge and skills."
