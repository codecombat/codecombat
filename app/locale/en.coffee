module.exports = nativeDescription: "English", englishDescription: "English", translation:
  ...
  teacher:
    ...
    solution_project_blurb: "Students are encouraged to build a creative project in this level. Please refer to curriculum guides in the Resource Hub for information on how to evaluate these projects."   # {change}
