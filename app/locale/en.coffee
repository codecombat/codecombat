module.exports = nativeDescription: "English", englishDescription: "English", translation:
  ...
  parents_landing_2:
    ...
    skills_they_can_share_details: "Students build real-world skills and create projects they can share with friends and family"
    help_when_needed: "Help When They Need It"
    help_when_needed_detail: "Using data, entry level has been built to be challenging, but never discouraging.  Students are supported with hints when they get stuck."
    ...
    critical_skills: "Building critical skills for the 21st centry"
    ...
    everything_they_need: "Everything they need to just start typing code on their own"
    ...
    advanced_concepts_6: "Math Library jOperations"
