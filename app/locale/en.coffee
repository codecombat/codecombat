module.exports = nativeDescription: "English", englishDescription: "English", translation:
  ...
  teacher:
    ...
    assigned_msg_3: "You have {{remainingSpots}} licenses remaining."
    assign_course: "Assign Course"
    not_assigned_modal_title: "Courses were not assigned"
    not_assigned_modal_body_1: "You do not have enough licenses to assign additional Courses to all {{selected}} selected students."
    not_assigned_modal_body_2: "You only have {{totalSpotsAvailable}} licenses ({{unenrolledStudents}} students did not have an active license)."
