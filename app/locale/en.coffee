module.exports = nativeDescription: "English", englishDescription: "English", translation:
  ...
  teacher:
    ...
    teacher_quest_teach_methods: "Teach your students to call methods."
    teacher_quest_teach_methods_step1: "<a href='http://files.codecombat.com/docs/resources/StudentQuickStartGuide.pdf'>Print out the Student Quick Start Guide in the Resource Hub.</a>"
    teacher_quest_teach_strings: "Teach your students <strong>strings</strong>."
    teacher_quest_teach_strings_step1: "<a href='/teachers/courses'>Play True Names as a teacher.</a>"
    teacher_quest_teach_loops: "Teach your students <strong>loops</strong>."
    teacher_quest_teach_loops_step1: "Use the <a href='http://files.codecombat.com/docs/resources/Course1PythonSyntaxGuide.pdf'>Loops Activity</a> in the <a href='http://files.codecombat.com/docs/resources/Course1PythonSyntaxGuide.pdf'>CS1 Curriculum guide</a>."
    teacher_quest_teach_variables: "Teach your students <strong>variables</strong>."
    teacher_quest_teach_variables_step1: "Print out the <a href='http://files.codecombat.com/docs/resources/Course1PythonSyntaxGuide.pdf'>Python Syntax guide</a> located in the <a href='/teachers/resources'>Resource Hub</a>."
    teacher_quest_kithgard_gates_100: "Get 100% of a class to Kithguard Gates."
    teacher_quest_kithgard_gates_100_step1: "Print out the <a href='http://files.codecombat.com/docs/resources/EngineeringCycleWorksheet.pdf'>Engineering Cycle Worksheet</a> in the <a href='/teachers/resources'>Resource Hub</a>."
    teacher_quest_wakka_maul_100: "Get your students through Wakka Maul."
    teacher_quest_wakka_maul_100_step1: "Read the <a href='/teachers/resources/arenas'>Arena Levels - Teacher Guide</a> in the <a href='/teachers/resources'>Resource Hub</a>."
    teacher_quest_reach_gamedev: "Get to new World (GameDev)"
    teacher_quest_reach_gamedev_step1: "<a href='/teachers/licenses'>Create a license request<a>."
