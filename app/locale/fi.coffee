...
#    auth_sign_up: "New to Ozaria? Create an Account"
    sign_up: "Luo Tili"
    email_or_username: "Käyttäjätunnus tai sähköposti" # {change}
#    or: "or"
    log_in: "Kirjaudu"
#    sign_in: "Sign In"
    ...
    sign_in_with_facebook: "Kirjaudu Facebook tunnuksilla" # {change}
    sign_in_with_gplus: "Kirjaudu G+ tunnuksilla" # {change}
...
#    teacher_email_announcements: "Keep me updated on new teacher resources, curriculum, and courses!"
    ...
    signup_as_teacher: "Luo Opettajan Tili" # {change}
    ...
    signup_as_student: "Luo Oppilaan Tili" # {change}
    ...
    write_this_down: "Kirjoita tämä ylös:" # {change}
...
#    description_coming_soon: "Description coming soon"
  ...
  options:
    ...
    editor_config_title: "Editorin asetukset" # {change}
    editor_config_livecompletion_label: "Automaattinen koodin täydennys" # {change}
    ...
    editor_config_behaviors_label: "Älykäät Toiminnot" # {change}
