...
export default { nativeDescription: "日本語", englishDescription: "Japanese", translation: {

  ozaria_home: {
    subtitle: "人を魅了するコンピューターサイエンス",
    heading_subtitle: "生徒のためのコーディング・アドベンチャーであり、コンピューターサイエンス教育のためのターンキー・ソリューションです。",
    item_list_p: "第1章を今すぐ無料でお試しください！",
    engaging_heading_corner: "生徒を惹きつけ、教師をサポートするソリューション",
    engaging_row1_h2: "簡単な導入",
    engaging_row1_p: "コーディングの経験がなくても、Ozariaを使えば、コンピュータサイエンスの全カリキュラムを教えることができます。すぐに使えるレッスンプランと直感的なダッシュボードで、初日から教える準備を整えることができます。",
    engaging_row2_h2: "没入感のあるゲーム性",
    engaging_row2_p: "生徒たちはアドベンチャーゲームに没頭し、ストーリーとともにコンピュータサイエンスの知識を深めていきます。この魅力的な学習環境の中で、生徒は遊びの力を使って実社会のスキルを身につけます。",
    engaging_row3_h2: "スタンダードに沿ったカリキュラム",
    engaging_row3_p: "OzariaはCSTAとISTEの基準を満たしており、生徒がコンピュータサイエンスのコアコンセプトを習得し、プログラミング思考スキルを身につけ、コンピュータサイエンスと日常生活の関連性を学ぶ中で、自信を持って教えることができます。",
    pd_blurb: "CSTA認定の__pd__コースで、コンピュータサイエンスを効果的に教えるスキルを身につけましょう。いつでも、どのデバイスからでも、最大40単位時間まで取得できます。",
    back_cta_1_a: "第1章を無料で試してみる",
    speech_bubble_testimonial_1_blockquote: "再び、あなたたちのチームがEdutainmentの至宝を達成しました。26年のベテラン中学校教育者として、コーディングを教えるためのより魅力的なリソースはないと思います。",
    core_curriculum_header: "コアコンピュータサイエンスカリキュラム",
    core_curriculum_p: "私たちは、学生が最もよく学ぶ方法に関する実証された理論と広範な証拠に基づいて、私たちの教育モデルを開発しました。",
    core_curriculum_carousel_item1_header: "接続を作成する",
    core_curriculum_carousel_item1_p: "すべてのモジュールの開始時に、私たちのキーレッスンスライドを使用して、生徒たちが新しいコンピュータサイエンスの概念と、日常生活からの関連例との関係を理解するのを助けます。",
    core_curriculum_carousel_item2_header: "意味を自分で作り出す",
    core_curriculum_carousel_item2_p: "次に、私たちのレッスンプランに組み込まれたアンプラグドやディスカッション活動を通じて、生徒たちに新しい概念のより深い理解を構築するように指導します。",
    core_curriculum_carousel_item3_header: "新しい概念を学ぶ",
    core_curriculum_carousel_item3_p: "学習サイクルの第3段階では、生徒たちはOzariaのストーリーでキャラクター同士の説明的な対話を通じて新しい概念を学びます。ナレーション、グラフィック、アニメーションにより、新しい情報を吸収することがさらにアクセスしやすく、楽しくなります。",
    core_curriculum_carousel_item4_header: "新しい知識を適用する",
    core_curriculum_carousel_item4_p: "次に、生徒たちは、サポートされたゲームレベルでさまざまな課題を解決するために、実際のPythonまたはJavaScriptを入力して学んだことを実践します。組み込みのヒントが生徒たちがバグを特定して修正するのを助け、より自信を持ってコーディングできるようになります。",
    core_curriculum_carousel_item5_header: "総括プロジェクト",
    core_curriculum_carousel_item5_p: "各章の終わりに、生徒たちは自分自身でゲームやストーリーを作成し、自分の新しいスキルや創造性を披露するための総括プロジェクトを通して挑戦されます。",
    core_curriculum_scope_sequence: "カリキュラムの範囲とシーケンスを見る",
    core_curriculum_sample_lesson_slides: "サンプルの授業スライドを見る",
    global_community_header: "グローバルコミュニティに参加する",
    global_community_row1_p: "学習者",
    global_community_row2_p: "コードの行数",
    global_community_row3_p: "教師",
    global_community_row4_p: "国",
    admin_dashboard_header: "包括的な教師＆管理ダッシュボード",
    admin_dashboard_p: "14万人以上の教育者コミュニティからのフィードバックを基に設計されたOzariaは、コンピューターサイエンスを教える上での課題に対処するためのツールとリソースを提供します。",
    admin_dashboard_row1_p: "直感的な教師ダッシュボードは、生徒向けの授業計画、ペースガイド、遠隔学習の戦略など、あなたのニーズをサポートするためのリソースにアクセスできます。",
    admin_dashboard_row2_p: "進捗状況ページでは、生徒の進捗状況を常にモニターし、彼らのパフォーマンスに関する貴重な情報を得て、介入が必要かどうかをすぐに判断することができます。",
    admin_dashboard_row3_a: "見積もりを依頼する",
    acodus_awards_a: "第1章を無料で試す",
    speech_bubble_testimonial_2_blockquote: "これまで見た中で最もアクセスしやすいプログラミングサイトです。私の生徒たちが共感できる使命と一致するOzariaのストーリーを評価しています。率直に言って、私はそれが大好きです。実際、先週末に認めたいと思ったほど長く遊んでしまいました！",
    shareable_resources_header: "共有可能なリソース",
    shareable_resources_p: "以下のリソースを学校にコンピューターサイエンスを導入する教師、管理者、その他の関係者と共有してください。",
    shareable_resources_a: "フライヤーをダウンロードする",
    back_cta_2_a: "第1章を無料で試す",
    faq_header: "よくある質問",
    faq_row1_header: "OzariaはCodeCombatとどのように関係していますか？",
    faq_row1_p: "Ozariaは、歴史上最も人気のあるコーディングゲームの1つであるCodeCombatの教室中心の進化形です。PythonとJavaScriptを学ぶ2000万人以上の学習者に教えた知見をもとにOzariaを構築しました。Ozariaは、新しい教育モデルと没入型のストーリー主導のナラティブを取り入れ、教室で実施されることを想定して、対面授業と遠隔学習の両方の設定で使用できるように設計されました。",
    faq_row2_header: "Ozariaはどの年齢層または学年に適していますか？",
    faq_row2_p: "OzariaはCSTAとISTEの中学校のコンピュータサイエンスの標準に合わせていますが、小学校高学年から高校生までの生徒が実践し、楽しんでいます。",
    faq_row3_header: "利用可能なすべてのユニットとリソースにアクセスするにはどれくらいかかりますか？",
    faq_row3_p_part1: "私たちは学校や地区のためにカスタマイズされたソリューションを提供し、使用例、コンテキスト、予算を理解するためにあなたと協力します。",
    faq_row3_p_part2: "詳細については、お問い合わせください！また、",
    faq_row3_p_part3: "資金調達リソースガイド",
    faq_row3_p_part4: "学校や地区のコンピューターサイエンスプログラムのための資金調達のためのソリューション",
    faq_row4_header: "Ozariaにプロジェクトベースの学習はありますか？",
    faq_row4_p: "はい。Ozariaには、各章の最後に共有できるCapstone Projectsが含まれており、生徒たちは自分自身のゲームを作成します。これらのプロジェクトは総括的な評価として機能し、生徒たちが同級生、友人、家族に自分の学びを表現し、証明する素晴らしい方法です。",
    faq_row5_header: "Ozariaを私のクラスの主要なカリキュラムとして使用できますか？",
    faq_row5_p: "もちろんです！コンピューターサイエンスのバックグラウンドがなくても、レッスンプランやソリューションガイドからプロジェクトの評価基準や組み込みの標準の整合性まで、Ozariaに必要なすべてが揃っています。",
    faq_row6_p_part1: "他に何か質問があれば、",
    see_faq_prefix: "私たちのヘルプセンターで",
    see_faq_link: "よくある質問をご覧ください",
    see_faq_suffix: "。",
    summary: "Ozariaは、生徒が自分たちの世界を救うために、失われた魔法をマスターするためのコンピューターサイエンスプログラム、冒険ゲーム、ファンタジー物語です。",
    value_prop1_h1: "エピックなストーリー、没入型のゲームプレイ。",
    value_prop1_h2: "より深い学習へのつながりを醸成",
    value_prop1_p: "Ozariaでは、生徒たちはコアなコンピューターサイエンスの概念をマスターしてゲーム内で進歩することになります。展開するストーリーは、生徒中心の強力な学習体験を作り出し、Ozariaの物語に投資する生徒たちの投資は、彼ら自身の学習旅行への投資と並行しています。",
    value_prop2_h1: "すべての生徒に内に秘めたヒーローを発見",
    value_prop2_h2: "遊びを通して実践的なスキルを身につける",
    value_prop2_p: "ゲームレベル、指導的なキャラクターの対話、カットシーンなどを含む緻密に設計されたコンテンツの進行を通じて、概念やスキルが紹介されます。生徒たちはPythonやJavaScriptをタイピングし、計算思考を用いて問題解決を行い、フォーマティブ評価を通して理解を示し、独自のプロジェクトを作成することで学んだことを適用します。",
    value_prop3_h1: "無料で旅を始める",
    value_prop3_p: "冒険を通じて教える無料コンテンツで、初級コンピューターサイエンスの概念をカバーし、実装ガイドやレッスンプランへのアクセスも提供しています。",
    projects_inspire_heading: "インスパイアするプロジェクト。エンパワーメントするリソース。",
    student_creativity: "生徒の創造力を解き放つ",
    student_creativity_paragraph: "各ユニットの最後には、学んだことを適用して、ゲームから自分で選ぶ冒険物語などのプロジェクトを作成します。段階的な目標を設定しながら、無限のアイデアを生み出すことができるように、生徒は自分の創造的アイデンティティを示すシェア可能で遊べる作品のポートフォリオを構築します。",
    teach_with_support: "サポートを受けながら教える",
    teach_with_support_paragraph: "Ozariaは教育者向けに作られています。カリキュラム全体の各ユニットには、学習目標、一般的な生徒の誤解、キーターム、CSTA標準を概説したレッスンプランがあります。さらに、包括的な教師向けダッシュボードがあり、生徒の進捗を追跡し、生徒のコードを確認することができます。",
    request_demo: "デモをリクエスト",
    im_an_educator: "私は教育者です",
    im_a_student: "私は生徒です",
    global_title: "学習者と教育者のグローバルコミュニティに参加しましょう",
    global_subtitle1: "学習者",
    global_subtitle2: "コードの行数",
    global_subtitle3: "教師",
    global_subtitle4: "国",
    sign_up: "サインアップ",
  ...
  new_home: {
    ...
    meta_keywords_coco: "CodeCombat, Python, Javascript, コーディングゲーム",
    meta_keywords_ozar: "CodeCombat, Python, Javascript, コーディングゲーム, コンピューターサイエンスプログラム, アドベンチャー, エピックストーリー",
...
//    meta_og_url: "https://codecombat.com"
    ...
    built_for_teachers_title: "教師のために作られたコーディングゲーム",
    built_for_teachers_blurb: "子供たちにコーディングを教えることは、しばしば圧倒的に感じることがあります。CodeCombatは、すべての教育者がJavaScriptやPythonといった最も人気のあるプログラミング言語で生徒にコードを教える手助けをします。6つのコンピューターサイエンスユニットを含む包括的なカリキュラムと、プロジェクトベースのゲーム開発やウェブ開発ユニットを通じて学習を強化することで、子供たちは基本的な構文から再帰までの道のりを進んでいきます。",
    built_for_teachers_subtitle1: "コンピューターサイエンス",
    built_for_teachers_subblurb1: "無料のコンピューターサイエンス入門コースから始めて、生徒はwhile/forループ、関数、アルゴリズムなどのコアなコーディング概念を習得します。",
    built_for_teachers_subtitle2: "ゲーム開発",
    built_for_teachers_subblurb2: "学習者は迷路を構築し、基本的な入力処理を使用して、友達や家族と共有できる独自のゲームをコーディングします。",
    built_for_teachers_subtitle3: "ウェブ開発",
    built_for_teachers_subblurb3: "HTML、CSS、jQueryを使用して、学習者はクリエイティブ力を発揮して独自のウェブページをプログラムし、クラスメートと共有するカスタムURLを作成します。",
    century_skills_title: "21世紀のスキル",
    century_skills_blurb1: "生徒はヒーローだけでなく、自分自身をレベルアップする",
    century_skills_quote1: "失敗することがありますが、それを修正するためのすべての方法を考え、もう一度試します。努力しなければここまでたどり着くことはできません。",
    century_skills_subtitle1: "批判的思考",
    century_skills_subblurb1: "自然に段階的により難しいレベルにスカフォールドされたコーディングパズルがあるため、CodeCombatのプログラミングゲームでは子供たちは常に批判的思考を練習しています。",
    century_skills_quote2: "みんなが迷路を作っていたので、「フラッグを取る」と思い、それをやりました。",
    century_skills_subtitle2: "創造力",
    century_skills_subblurb2: "CodeCombatは、生徒が自分たちのゲームやウェブページを作成して共有することで、創造力を発揮するように促します。",
    century_skills_quote3: "レベルで詰まったら、周りの人たちと一緒になって解決できるまで取り組んでいました。",
    century_skills_subtitle3: "協力",
    century_skills_subblurb3: "ゲームの中で、生徒たちは詰まったときに協力して解決し、ペアプログラミングガイドを使って一緒に作業する機会があります。",
    century_skills_quote4: "私はいつもビデオゲームをデザインし、コードの学習を目指していました。これが素晴らしいスタート地点になってくれています。",
    century_skills_quote4_author: "Joey、10年生",
    century_skills_subtitle4: "コミュニケーション",
    century_skills_subblurb4: "コーディングは、コンピューター自体とコミュニケーションを取り、最も効率的なコードを使ってアイデアを伝えるといった、新しい形式のコミュニケーションを子供たちに練習させます。",
    classroom_in_box_title: "私たちが目指すこと：",
    classroom_in_box_blurb1: "すべての生徒がコーディングが自分に向いていると信じるように関与する。",
    classroom_in_box_blurb2: "すべての教育者がコーディングを教える際に自信を持てるように支援する。",
    classroom_in_box_blurb3: "すべての学校のリーダーが世界クラスのコンピューターサイエンスプログラムを作成することにインスパイアする。",
    classroom_in_box_blurb4: "", // only for koudashijie.com
    click_here: "ここをクリック",
    creativity_rigor_title: "創造性と厳密性が出会う場所",
    creativity_rigor_subtitle1: "コーディングを楽しくし、実践的なスキルを教える",
    creativity_rigor_blurb1: "試行錯誤、批判的思考、創造性を促すゲームをプレイしながら、生徒たちは実際のPythonやJavaScriptを入力します。その後、プロジェクトベースのコースで独自のゲームやウェブサイトを開発することで、学んだコーディングスキルを実践に活かします。",
    creativity_rigor_subtitle2: "生徒のレベルに合わせて教える",
    creativity_rigor_blurb2: "CodeCombatの各レベルは、何百万ものデータポイントに基づいて段階的に構築され、各学習者に適応するように最適化されています。練習レベルとヒントが、生徒が詰まったときに助けとなり、チャレンジレベルでゲームを通じて生徒の学習を評価します。",
    creativity_rigor_subtitle3: "経験の有無に関わらず、すべての教師向けに作られています",
    creativity_rigor_blurb3: "CodeCombatの自己学習型、基準に沿ったカリキュラムは、誰でもコンピューターサイエンスを教えることができるようになります。CodeCombatは、教師に研修、教材、専用のサポートを提供し、教室で自信を持って成功を収めることができるようになります。",
...
//    featured_partners_blurb6: "Hour of Code Activity Partner"
    ...
    for_leaders_subblurb3: "中学校のコーディング選択科目、職業訓練教育（CTE）の進路、またはAPコンピューターサイエンスの原則クラスを構築したい場合、CodeCombatはあなたのニーズに合わせて調整されています。",
    for_leaders_subtitle4: "現実世界のスキル",
    for_leaders_subblurb4: "生徒は、50万以上のオープンコンピューティングの仕事に備えるコーディングチャレンジを通じて、根性を築き、成長のマインドセットを育てます。",
    for_teachers_title: "教師のために",
    for_teachers_blurb: "生徒の可能性を引き出すツール",
    for_teachers_subtitle1: "プロジェクトベースの学習",
    for_teachers_subblurb1: "生徒が自分のゲームやウェブページを開発するプロジェクトベースのコースで、創造力、問題解決能力、自信を促進します。",
    for_teachers_subtitle2: "先生向けダッシュボード",
    for_teachers_subblurb2: "生徒の進捗データを表示し、カリキュラムリソースを発見し、生徒の学習を促進するためのリアルタイムサポートにアクセスします。",
    for_teachers_subtitle3: "組み込みの評価",
    for_teachers_subblurb3: "フォーマティブおよびサマティブ評価を使用して、個別の指導を提供し、生徒が主要な概念を理解していることを確認します。",
    for_teachers_subtitle4: "自動差別化",
    for_teachers_subblurb4: "各生徒の学習ニーズに適応する練習レベルで、多様な教室のすべての学習者を引き付けます。",
    game_based_blurb: "CodeCombatは、生徒が実際のコードを入力し、キャラクターがリアルタイムで反応するゲームベースのコンピューターサイエンスプログラムです。",
    get_started: "はじめに",
    ...
    quotes_quote1: "オンラインのあらゆるプログラムを挙げてください。私は試しています。それらのどれもCodeCombatとOzariaには敵いません。生徒にコーディングを学ばせたい先生はここから始めてください！",
    quotes_quote2: "CodeCombatがどれだけ簡単で直感的にコンピューターサイエンスを学ぶことができるのかに驚きました。AP試験のスコアは私が予想したよりもはるかに高く、その理由はCodeCombatだと信じています。",
    quotes_quote3: "CodeCombatは、私の生徒たちに現実のコーディング能力を教える上で最も有益でした。私の夫はソフトウェアエンジニアで、私のプログラムをすべて試してきました。彼はこれをトップの選択肢としています。",
    quotes_quote4: "フィードバックは非常に肯定的であり、CodeCombatを中心にコンピューターサイエンスのクラスを構築しています。このプログラムは、エンターテイメントと指導が同時に行われるゲームスタイルのプラットフォームで、生徒たちを魅了します。CodeCombatの良い仕事を続けてください！",
    quotes_quote5: "クラスは毎週土曜日の朝7時に始まりますが、息子はとても興奮して私よりも早く目を覚まします！CodeCombatは、息子がコーディングスキルを向上させるための道筋を作ります。",
    quotes_quote5_author: "Latthaphon Pohpon（親）",
    see_example: "例を見る",
    slogan: "一番ステキなプログラミング学習ゲーム", // {change}
    slogan_power_of_play: "遊びの力を通じてコーディングを学ぶ",
    teach_cs1_free: "CS1を無料で教える",
    teachers_love_codecombat_title: "先生方はCodeCombatが大好き",
    teachers_love_codecombat_blurb1: "生徒たちがCodeCombatを使ってコーディングを学ぶのを楽しんでいると報告しています",
    teachers_love_codecombat_blurb2: "他のコンピューターサイエンスの先生にCodeCombatをお勧めするでしょう",
    teachers_love_codecombat_blurb3: "CodeCombatは、生徒たちの問題解決能力をサポートするのに役立っていると言います",
    teachers_love_codecombat_subblurb: "教育技術の研究ベースの指導と評価のリーダーであるMcREL Internationalと協力して。",
    top_banner_blurb: "保護者の方、ライブ講師と共にお子様にコーディングの才能と個別指導をプレゼントしましょう！",
    top_banner_summer_camp: "夏のコーディングキャンプの入会受付中です。1週間の仮想セッションがたったの$199から始まることについてお問い合わせください。",
    top_banner_blurb_pd: "現在、教育者向けのプロフェッショナル開発を提供しています。",
    top_banner_blurb_funding: "新: CARES法の資金調達リソースガイド、ESSERおよびGEER資金をCSプログラムに活用。",
    top_banner_blurb_maintenance: "アップグレードが来ます！予定されたメンテナンス: __maintenanceStartTime__から最大3時間。",
    top_banner_blurb_podcast: "新: 新しいポッドキャストEdTech AdventuresでEdTechの世界を探検しましょう。",
    top_banner_blurb_roblox: "新！CodeCombatがRobloxに登場！",
    top_banner_blurb_roblox_teachers: "新！CodeCombatはRoblox Educationと提携しました！",
    top_banner_blurb_roblox_players: "新！Robloxをプレイしながらコーディングを学びましょう！",
    top_banner_blurb_roblox_players_cta: "ベータ待機リストに参加",
    top_banner_blurb_live_online_classes_parents: "保護者の皆様！無料の体験クラスでお子様に今すぐコーディングを始めさせましょう。",
    top_banner_blurb_live_online_classes: "遊びによって推進されるライブオンラインのコーディングクラス！",
    top_banner_blurb_live_online_classes_cta: "無料の体験クラスにSign up！",
    top_banner_blurb_demo_day: "8月25日（木）午後4時（EDT）にデモデイウェビナーにご参加ください。",
    top_banner_blurb_demo_day_10_20: "10月20日（木）午後4時（CDT）にCodeCombat＆Ozariaのお化け屋敷デモにご参加ください。",
    top_banner_blurb_hoc_2022_12_01: "12月1日にHour of Codeウォークスルーにご参加ください！すべての新しいアクティビティを実装するために必要なものは__topBannerHereLink__です。",
    top_banner_blurb_hoc_2022_12_01_here: "ここ",
    top_banner_blurb_demo_day_2023_02_16: "ライブデモ！eスポーツを使ってコーディングを教える方法を見てみましょう。2月16日（木）午後2時（PST）にご参加ください。",
...
//    select_your_state: "Select your state"
    password_requirements: "4〜64文字、繰り返しを含めない",
//    invalid: "Invalid"
