module.exports = {
  ...
  translation: {
    ...
    new_home: {
      ...
      forgot_learning: '彼らは実際に何かを学んでいるということを、忘れてしまったのではないかと思います。',
      wanted_to_do: 'コーディングは私がずっとやりたかったことで、学校で学べるなんて思ってもみませんでした。',
      builds_concepts_up: 'CodeCombatが概念を積み上げていくやり方が好きです。本当に分かりやすくて、問題を解くのが楽しいです。',
    ...
    nav: {
      ...
      ozaria_dashboard: 'オザリアダッシュボード',
      ozaria_teacher_dashboard: 'オザリア教師用ダッシュボード',
      ozaria_admin_dashboard: 'オザリア管理者用ダッシュボード',
      codecombat_dashboard: 'コードコンバットダッシュボード',
      codecombat_teacher_dashboard: 'コードコンバット教師用ダッシュボード',
      codecombat_admin_dashboard: 'コードコンバット管理者用ダッシュボード',
      ...
      school_district_solutions: '学校＆学区向けソリューション',
      //    teacher_toolkit_preview: "Teacher Toolkit Preview",
      teacher_toolkit: '教師用ツール',
      efficacy_studies: '効果検証研究',
      success_stories: '成功事例',
      //    hoc: "Hour of Code & AI",
      grants_funding_resources: '助成金＆資金調達のリソース',
      //    accessibility: "Accessibility (ACR/VPAT)",
      request_quote_demo: 'デモや見積のリクエスト',
    ...
    new_home_faq: {
      what_programming_languages: '利用可能なプログラミング言語は何ですか？',
      python_and_javascript: '現在、Python、JavaScript、C++、Java、Luaをサポートしています。',
      why_python: 'どうしてPythonを選ぶべきですか？',
      why_python_blurb: 'Pythonは初心者にも学びやすく、Googleなどの大企業でも使用されています。特に若い学習者や初めてプログラミングを学ぶ人には、Pythonを強くお勧めします。',
      ...
      getting_started_3: '生徒を追加する',
      getting_started_4: '生徒たちが楽しみながらコーディングを学ぶ姿を見守るだけです',
      main_curriculum: 'CodeCombatまたはOzariaを主なカリキュラムとして使用できますか？',
      main_curriculum_blurb: 'もちろんです！CodeCombatやOzariaを主なコンピュータサイエンスのカリキュラムとして使用できるよう、教育専門家と協力して授業用カリキュラムや教材を作成しました。多くの学校でCodeCombatやOzariaをメインのカリキュラムとして導入しています。',
      clever_instant_login: 'CodeCombatやOzariaはClever Instant Loginをサポートしていますか？',
      clever_instant_login_blurb: 'はい！詳細は__clever__をご覧ください。',
    ...
    login: {
      ...
      already_have_account1: '既にCodeCombatの教師用、または生徒用アカウントをお持ちですか？',
      already_have_account2: 'そのアカウントを使って、Ozaria.comにサインインできます。',
      sign_into_ozaria: 'Ozaria.comにサインイン',
      individual_users_not_supported: 'Ozariaは教室専用です！引き続きプレイするにはCodeCombatをご利用ください！',
      accounts_merge_confirmation: 'このGoogleアカウントのメールアドレスに、関連付けられたアカウントがあります。これらのアカウントを統合しますか？',
      stop_spying: 'スパイ行為をやめる',
      stop_switching: '切り替えをやめる',
      test_as_student: '学生としてテスト',
    ...
    signup: {
      ...
      student_type_1: '楽しいゲームをプレイしながら、プログラミングを学ぼう！',
      student_type_2: 'クラスメイトと一緒にプレイしよう',
      student_type_3: 'アリーナで競争しよう',
      student_type_4: '自分のヒーローを選ぼう！',
      student_type_5: 'クラスコードを用意しておいてください！',
      signup_as_student: '学生アカウントを作成',
      individuals_or_parents: '個人プレイヤー & 保護者',
      individual_type: 'クラス外でプログラミングを学ぶプレイヤー向けです。保護者はこちらでアカウントを作成してください。',
      signup_as_individual: '個人としてサインアップ',
      enter_class_code: 'あなたのクラスコードを入力してください。',
      enter_birthdate: '生年月日を入力してください。',
      parent_use_birthdate: '保護者の方はご自身の生年月日を入力してください。',
      ask_teacher_1: 'クラスコードはあなたの先生に、確認してください。',
      ask_teacher_2: 'クラスに所属していませんか？以下から作成できます',
      ask_teacher_3: '個人アカウント',
      ...
      teacher_list_resource_hub_4: '教師用ツール',
    ...
    general: {
      ...
      hard: 'ハード',
      player: 'プレイヤー',
      player_rank: '[AI_TRANSLATION]ランク',
      warrior: '戦士',
      ranger: 'レンジャー',
      wizard: 'ウィザード',
      ...
      archived: 'アーカイブ済み',
      chat: 'チャット',
      chat_with_us: '私たちとチャットしましょう',
      email_us: 'メールを送ってください',
      sales: '営業',
      support: 'サポート',
      here: 'こちら',
      from: 'から',
    ...
    play_level: {
      ...
      problem_alert_need_help: '助けが必要ですか？',
      problem_alert_ask_the_ai: 'AIに質問します',
      //    ask_ai: "Ask AI",
      //    ask_ai_placeholder: "Enter your request here...",
      problem_alert_need_hint: 'ヒントが必要ですか？AIに助けを求めることができます。',
      time_current: '今:',
      time_total: '最大:',
      time_goto: '行く:',
      ...
      share_this_project: 'このプロジェクトを友達や家族とシェアします。',
      ready_to_share: 'あなたのプロジェクトを公開する用意はできていますか？',
    ...
    clans: {
      ...
      private: '(プライベート)',
      summary: '概要',
      average_rank: '[AI_TRANSLATION]平均ランク',
    ...
    teacher: {
      ...
      teacher_quest_add_students: '生徒を追加',
    ...
    teacher_ozaria_encouragement_modal: {
      title: 'オザリアを救うために、コンピュータサイエンスのスキルを磨きましょう。',
      sub_title: 'CodeCombatからの新しいアドベンチャーゲームにご招待します。',
      cancel: 'CodeCombatに戻る',
      accept: '最初のユニットを無料でお試ししましょう。',
      bullet1: '壮大なストーリーと没入型のゲームプレイを通じて、学生の学習意欲を深めます。',
      bullet2: 'コンピューターサイエンスの基礎、PythonまたはJavaScript、そして21世紀のスキルを教えます。',
      bullet3: '最終プロジェクトを通じて創造力を解放します。',
      bullet4: '専用のカリキュラムリソースで指導をサポートします。',
      you_can_return: 'あなたはいつでも、CodeCombatに戻ることができます。',
    },
    ...
    web_dev: {
      image_gallery_title: 'イメージギャラリー',
      select_an_image: '使用したい画像を選択してください。',
      scroll_down_for_more_images: 'もっと画像を見るにはスクロールしてください。',
      copy_the_url: '以下のURLをコピーしてください。',
    ...
    teacher_dashboard: {
      lock: 'ロック',
      unlock: 'ロック解除',
      lock_until_date: '指定日までロック',
      skip: 'スキップ',
      unskip: 'スキップ解除',
      make_optional: '任意設定にする',
      remove_optional: '任意設定を解除',
      until_date: '__date__まで',
      unassign: '割り当て解除',
      locked: 'ロック済',
      locked_by_previous: '前のレベルによりロック',
      locked_with_timeframe: 'ロック済',
      skipped: 'スキップ済',
      optional: '任意',
      assigned: '割り当て済',
      unlocked: 'ロック解除済',
      ...
      complete: '完了',
      progress: '進行中',
      choose_course: 'ドロップダウンからコース選択',
      teacher_locked_message: '次のレベルは先生によりロックされています',
      plan_your_class_title: 'クラスを計画',
      plan_your_class1: 'コース進行情報を見る',
      plan_your_class2: '授業スライドとアクティビティをプレビュー',
      plan_your_class3: '最初の章を無料で試す',
      click_dismiss: 'クリックして閉じる',
      track_progress: '進捗を確認',
      track_progress_desc: '作成したクラスにアクセスして、生徒の進捗を確認。',
      add_classes_title: 'クラスを追加',
      add_classes: 'クラスを追加して、最初の章から始めましょう！',
      all_classes: 'すべてのクラス',
      my_licenses: 'ライセンス',
      resource_hub: '教師用ツール',
      pd: '専門的なスキル開発',
      pd_short: 'PD',
      apcsp: 'APCSP',
      curriculum_guide: 'カリキュラムガイド',
      curriculum: 'カリキュラム',
      coming_soon: '近日公開！',
      add_class: '新しいクラスを追加',
      no_licenses_yet: 'まだライセンスがありません',
      req_licenses: 'ライセンスをリクエスト',
      license_ratio_used: '__totalUsedLicenses__ / __totalSpots__',
      licenses_applied: '適用済ライセンス',
      student_projects: '生徒プロジェクト',
      no_classes_yet: 'まだクラスがありません',
      exemplar_project: '模範プロジェクト',
      capstone_proj_for: '__courseName__の総仕上げプロジェクト',
      project_rubric: 'プロジェクト評価基準',
      select_chapter: '章を選択',
      select_course: 'コースを選択',
      concept_flag: 'コンセプトフラグ',
      support_learning: '学習を支援',
      concept_flag_desc: 'クラスの50%以上の生徒が3回以上コンセプトチェックをしました。',
      concept_flag_desc2: '生徒が3回以上コンセプトチェックをしました。',
      click_progress_dot_tip: 'ヒント: 進捗をクリックして詳細を表示',
      color_code: '色分け',
      content_guide: 'コンテンツガイド',
      story: 'ストーリー',
      cutscenes: 'カットシーン',
      cutscenes_tooltip: '<h3>カットシーン</h3><p>壮大なOzariaの物語について説明する短編動画です。</p>',
      cinematics: 'シネマティクス',
      ...
      concept_checks: 'コンセプトチェック',
      practice_level: '練習レベル',
      practice_levels: '練習レベル',
      extra_practice: '追加練習',
      challenge_levels: 'チャレンジレベル',
      capstone_levels: '総仕上げレベル',
      ...
      manage_class: 'クラスを管理',
      assign_content: 'コンテンツを割り当て',
      remove_students: '生徒を削除',
      revoke_licenses: 'ライセンスを取り消し',
      remaining_licenses: '__remaining__ ライセンス残り',
      start_date: '開始: __date__',
      end_date: '終了: __date__',
      license_questions: 'ライセンスの適用や取り消しに関する質問がありますか？',
      need_more_licenses: '追加のライセンスが必要ですか？ニーズに合ったソリューションをご提案します。',
      see_also_our: 'こちらもご覧ください',
      for_more_funding_resources: 'ESSERやGEERなどのCARES法資金の活用方法については',
      support_oz: 'support@ozaria.com',
      standards_alignment: '基準との整合性',
      standards_sample: 'この章でカバーされる基準のサンプル:',
      add_course_to_classroom: 'コースを追加',
      play_chapter: '章を再生',
      play_course: 'コースを再生',
      class_time_range: '授業時間（範囲）:',
      in_game_play_time: 'ゲーム内プレイ時間:',
      class_time: '授業時間',
      solution_guide: 'ソリューションガイド',
      module: 'モジュール',
      need_licenses_tooltip: '<h3>このコンテンツにアクセスするにはライセンスが必要です！</h3><p>詳細については、<a href="/teachers/licenses">マイライセンス</a>ページをご覧ください。</p>',
      lesson_slides_tooltip: '<h3>授業スライド</h3><p>モジュールの学習目標を生徒に伝えるための、ダウンロード可能な段階的なプレゼンテーションスライド</p>',
      project_rubric_tooltip: '<h3>プロジェクト評価基準</h3><p>総仕上げプロジェクト用のダウンロード・編集可能な評価基準</p>',
      exemplar_projects_tooltip: '<h3>模範プロジェクト</h3><p>総仕上げプロジェクトのライブビュー</p>',
      add_course_to_classroom_tooltip: '<h3>クラスにコースを追加</h3><p>このコースはまだクラスに追加されていません。追加するには、このボタンをクリックしてください。</p>',
      want_to_save_tooltip: '<h3>進捗を保存しますか？</h3><p>進捗を保存したい場合は、学生アカウントを作成するか、<i>アカウント / 学生としてテスト</i>に移動してOzariaを学生としてプレイしてください。</p>',
      want_to_save_tooltip_coco: '<h3>進捗を保存しますか？</h3><p>進捗を保存したい場合は、学生アカウントを作成するか、<i>アカウント / 学生としてテスト</i>に移動してCodeCombatを学生としてプレイしてください。</p>',
      intro_explain_tooltip: '<b>「イントロ」</b>は新しい概念を紹介したり、物語を段階的に進めるものです。通常、シネマティクスやコンセプトチェックが含まれます。',
      chapter_num: '章 __num__',
      read: '閲覧のみ',
      write: 'フルアクセス',
      read_blurb: '閲覧のみは、追加された教師がクラスや生徒の進捗を変更することなく閲覧することを許可します。',
      write_blurb: 'フルアクセスは、追加された教師がクラスを変更する権限を持ちます（生徒の追加/削除、章の割り当て、ライセンスの変更など）。',
      shared_with_none: 'このクラスは現在、他の教師と共有されていません。',
      shared_with: '共有先',
      share_info: '他の教師にクラスのアクセス権を与えるには、以下にメールアドレスを追加してください。',
      class_owner: 'クラスオーナー',
      share: '共有',
      add: '追加',
      note: 'メモ',
      lock_or_skip_levels: 'レベルのロックまたはスキップ',
      level_access_status_blurb: 'レベルをスキップすると、そのレベルは「ロック」と「任意」のステータスを持ちます。スキップを解除すると、両方のステータスが削除されます。',
      reset_progress: '進捗をリセット',
      export_progress: '進捗をエクスポート',
      assessments_tab: 'アセスメント',
      ai_hackstack_junior_tab: 'AIジュニア',
      switch_on: 'オン',
      switch_off: 'オフ',
      ai_league: 'AIリーグ',
      version_old: '旧バージョン',
      version_new: '新バージョン',
      dashboard_version: 'ダッシュボードバージョン',
      arena_days_left: 'シーズン __season__、__arenaName__ の残り日数:',
      arena_days_elapse: 'シーズン __season__、__arenaName__ が__time__に終了しました',
      global_stats_vs_team_stats: 'グローバル統計 vs チーム統計',
      global_stats: 'グローバル統計',
      show_stats_for_all_players_and_teams: 'すべてのプレイヤーとチームの統計を表示します。',
      team_stats: 'チーム統計',
      show_stats_for_individuals_playing_on_the_same_team: '同じチームでプレイしている個人の統計を表示します。',
      for_each_class_you_add_a_team_will_be_automatically_created_for_the_students_in_that_class: '各クラスを追加すると、そのクラスの生徒用にチームが自動的に作成されます。',
      view_team_page: 'チームページ',
      no_modifiers_changed: 'これらの生徒用レベルはすでに変更済',
      no_modifiers_changed_unlocks_skipped: '現在ロックされていないレベルのロック解除を試みたようです。選択したレベルがロックされている場合、前のレベルがロックされていることが原因です。進めるには、前のレベルを解除してください。',
      view_custom_league: 'カスタムリーグを表示',
      view_global_league: 'グローバルリーグを表示',
      refresh_progress: '進捗を更新',
      assign_content_first: 'コンテンツを生徒に割り当ててからアクセスレベルを調整してください',
      failed_attempts: '失敗回数',
      no_failed_attempts: '失敗なし',
      failed_attempts_subtext: '誤ったオプションを選択した回数',
      open_project: 'プロジェクトを開く',
      create_class_hackstack: 'AI HackStackにアクセスするには、新しいクラスを作成してください',
      add_club: '新しいクラブを追加',
      test_student_only: '（テスト用学生のみ）',
      ready_to_review: 'レビューの準備完了',
      ozaria_hs_modal_title: 'CodeCombatからAI Hackstackにアクセス',
      ozaria_hs_modal_blurb: '教師はOzariaと同じ資格情報を使用して、**[https://codecombat.com/teachers/ai-league]CodeCombat**からAI Hackstackに直接アクセスできます。Ozariaからクラスを簡単にインポートできます。',
      ozaria_ai_league_modal_title: 'CodeCombatからAI Leagueにアクセス',
      ozaria_ai_league_modal_blurb: '教師はOzariaと同じ資格情報を使用して、**[https://codecombat.com/teachers/ai-league]CodeCombat**からAI Leagueに直接アクセスできます。Ozariaからクラスを簡単にインポートできます。',
      completed_all_practice_levels: '生徒はすべての練習レベルを完了しました。',
      played_some_practice_levels: '生徒は練習レベルに取り組み始めました。',
      ai_league_start_title: 'AIリーグへようこそ!',
      ai_league_start_blurb: '初めてのクラス設定からトーナメント実施まで、スタートガイドの案内をご覧ください。',
      ai_league_curriculum_title: 'AIリーグカリキュラム',
      ai_league_curriculum_blurb: 'AIリーグアリーナ専用に設計されたカリキュラムガイドを入手して、競技プログラミングの概念と戦略的思考を教えましょう。',
      ai_league_custom_title: 'カスタムAIリーグトーナメント',
      ai_league_custom_blurb: 'オリジナルのトーナメントを作成して、生徒を引き付けましょう！コーディングアリーナのライブラリから選択し、クラス内や学校全体の競技会の日程を設定します。',
    ...
    home_v3: {
      mission_title: 'すべての人にコーディングとAIを身近なものにするという私たちの使命に参加しませんか。',
      mission_supporting_text: '私たちは、誰もが自分の可能性を実現し、より良い未来を形作るための高品質な教育ソリューションを提供することに取り組んでいます。',
      stat_card_1_text: '2,000万',
      stat_card_1_description: '学習に参加した生徒',
      stat_card_2_text: '10億',
      stat_card_2_description: 'コード行数',
      stat_card_3_text: '32万',
      stat_card_3_description: 'サポートされた教師',
      stat_card_4_text: '7万5千',
      stat_card_4_description: '到達した学校数',
      stat_card_5_text: '190以上',
      stat_card_5_description: '参加国',
      stat_card_6_text: '520万',
      stat_card_6_description: 'eスポーツプレイヤー',
      learn_to_code: '楽しみながら、**コーディング**と**AI**の使い方を学ぼう！',
      innovative_play_experiences: 'CodeCombatは、コンピュータサイエンスを楽しく身近にする革新的な体験の場を提供しています。',
      sign_up_today: '今すぐサインアップして、無料でゲームやリソースを体験しよう。',
      im_an_educator: '教育者です',
      im_a_parent: '保護者です',
      im_a_student: '生徒です',
      programming_languages: 'プログラミング言語 & AIツール',
      engaging_play_experiences: '魅力的なプレイ体験',
      for_younger_learners: '若い学習者向け',
      your_turnkey_solutions: 'オールインワンソリューション',
      trends_insights: 'トレンド & インサイト',
      awards_partners: '受賞歴 & パートナー',
      faq_visit_help_center: 'よくある質問の回答は**ヘルプセンター**をご覧ください。',
      contact_us: 'お問い合わせ',
      for_further_questions: 'さらに質問がある場合',
      education_partner: '教育[NEWLINE]パートナー',
      official_member: '公式[NEWLINE]メンバー',
      best_creativity_tool_for_students: '生徒向け[NEWLINE]最高の創造性ツール',
      official_partner: '公式[NEWLINE]パートナー',
      hour_of_code_activity_partner: 'Hour of Code[NEWLINE]活動パートナー',
      top_pick_for_learning: '学習のための[NEWLINE]トップピック',
      testimonals_1_title: '「以前はできなかったこと、それは実際にコーディングできると信じることです。」',
      testimonals_1_name: 'マウンテンリッジ中学校の生徒',
      testimonals_2_title: '「オンラインプログラムならどれでも試しました。でもCodeCombatとOzariaには敵いません。生徒にコーディングを教えたい教師は、ここから始めてください！」',
      testimonals_2_name: 'スコット・ベイリー, ボビー・デューク中学校',
      testimonals_3_title: '「ビデオゲームをデザインしたい、コーディングを学びたいという夢がずっとありました…これは素晴らしい出発点を与えてくれています。」',
      testimonals_3_name: 'ジョーイ, 10年生',
      testimonals_4_title: '「CodeCombatで私が一番好きなのは、コーディングを簡略化しないことです。生徒たちは実際のコードを書くことを学びながらも、楽しく取り組んでいます。」',
      testimonals_4_name: 'サンドラ・アールストロム, シェリダン郡学区 #2の教師',
      carousel_1_title: 'ゲームベース[NEWLINE]学習',
      carousel_1_text: '独自のアプローチにより、生徒たちは冒険の始まりから遊びながらコードを書き、アクティブな学習と成長思考を促進します。',
      carousel_2_title: 'テキストベース[NEWLINE]コーディング',
      carousel_2_text: '初心者向けに設計されたカスタムコードエンジンとインタプリタを使用し、Python、JavaScript、C++の実際のプログラミング言語をわかりやすく教えます。',
      carousel_3_title: 'プロジェクトベース[NEWLINE]評価',
      carousel_3_text: 'これらのプロジェクトでは、生徒が共有可能なゲームをコードする機会を提供します。評価基準を提供することで、キャップストーンプロジェクトを主要な総括評価として利用できます。',
      carousel_4_title: 'AI[NEWLINE]加速',
      carousel_4_text: 'AIを活用して学習を促進し、コーディング能力を向上させる方法を教えます。この強力な組み合わせは、あらゆるスキルレベルの創造的な可能性を解き放ちます。',
      carousel_5_title: '教育者の[NEWLINE]エンパワメント',
      carousel_5_text: 'クラスルームソリューションには、カリキュラムを実施し、成功を収めるために必要なすべてのサポートとリソースが備わっています。',
      carousel_6_title: '生徒の[NEWLINE]影響',
      carousel_6_text: '私たちの製品は2,000万以上の生徒がコンピュータサイエンスを楽しみながら学ぶのを助けました。批判的で自信に満ちた創造的な学習者として育つお手伝いをしています。経験に関係なく、すべての生徒がコンピュータサイエンスへの成功の道を実感できるよう支援します。',
      engaging_boxes_1_title: 'Ozaria クラスルーム',
      engaging_boxes_1_text: 'コンピュータサイエンスの基本を確立する物語ベースのコーディングアドベンチャー。',
      engaging_boxes_2_title: 'CodeCombat クラスルーム',
      engaging_boxes_2_text: 'コアコンセプトからWeb開発、ゲーム開発、**[https://codecombat.com/apcsp]AP CSP**まで構築された完全なCSカリキュラム。',
      engaging_boxes_3_title: 'CodeCombat Worlds on Roblox',
      engaging_boxes_3_text: 'Roblox Educationとのパートナーシップにより、このAI対応の体験は生徒のコーディング能力を大幅に向上させ、素晴らしいゲームや体験を作成するための実世界のプラットフォームを提供します。',
      engaging_boxes_4_title: 'CodeCombat AIリーグeスポーツ',
      engaging_boxes_4_text: '創造的なプログラミングを促進するゲームベースの環境での壮大な競技型コーディングeスポーツプラットフォーム。',
      engaging_boxes_5_title: 'CodeCombat AI HackStack',
      engaging_boxes_5_text: '学生のプライバシーと安全性に焦点を当てた、AI初心者向けに特別に設計された初の生成AIコンパニオンツール。シンプルさとパワーを融合させ、学生の能力を加速させ、創造的な可能性を解放します。',
      engaging_boxes_6_title: 'CodeCombat ホーム',
      engaging_boxes_6_text: '530以上のレベルとペット、プレミアム専用アイテム、ヒーローなどの独占機能にアクセスして、お子さまがコーディングの世界に完全に没頭できます。友達に挑戦するためのゲームをデザインしたり、共有するためのWebサイトやアプリを構築することもできます。',
      young_learners_1_title: 'CodeCombat Junior',
      young_learners_1_text: 'K-5の生徒向けに特別に設計された学習レベルの進行を特徴とし、基本的なコーディング概念をゆっくりしたペースで教えるフラッグシップカリキュラム。',
      young_learners_1_linkText: 'ベータ版にサインアップ',
      young_learners_2_title: 'AI Junior',
      young_learners_2_text: 'K-5の生徒向けに設計されたシンプルで直感的なプラットフォームで、マルチモーダル生成AIを紹介します。',
      young_learners_2_linkText: 'ベータ版にサインアップ',
      solutions_1_title: 'プロフェッショナルディベロップメント',
      solutions_1_text: 'すべての教師にコンピュータサイエンスを効果的に教えるためのスキル、知識、自信を与えることを目的としています。',
      solutions_1_middleText: '最大6単位の卒業単位を取得可能。',
      solutions_1_linkText: '今すぐ試す',
      solutions_2_title: 'AP CSP試験対策',
      solutions_2_text: '私たちは、AP® Computer Science Principles (AP CSP) のカリキュラムとプロフェッショナルディベロップメントの認定プロバイダーとして、College Boardに認識されています。AP CSPカリキュラムでは、AP試験の準備に役立つゲームベースのターンキーソリューションを提供しています。',
      solutions_2_linkText: '今すぐ試す',
      solutions_3_title: '助成金と資金調達情報',
      solutions_3_text: '学校が直面する資金調達の課題を理解し、これらの障害を克服するお手伝いをすることに情熱を注いでいます。助成金資金調達に関する包括的なガイドをご覧いただくか、チームにお問い合わせください。',
      solutions_4_title: '地区レベルのソリューション',
      solutions_4_text: '私たちの革新的なソリューションは、全国の地区がコンピュータサイエンスプログラムを拡大または開始するのを支援してきました。32万人以上の教育者コミュニティからのフィードバックを元に設計され、すべての生徒と教育者のニーズに応える応答性と柔軟性のあるカリキュラムを提供します。導入とスケールが簡単で、チームが教師に必要なトレーニングとサポートを提供します。',
      solutions_5_title: 'オンラインライブクラス',
      solutions_5_text: 'オンラインコーディングクラスは、ゲームプレイと個別指導の力を組み合わせ、子どもが愛する体験を提供します。自分のRobloxゲームをコーディングして公開することから、新しいビジネスのためのWebサイトを構築することまで、AIとコーディングで可能性を探ります。',
      solutions_6_title: 'CodeQuest',
      solutions_6_text: '他にはない没入型の教育体験に参加し、次世代のコンピュータサイエンス革新者を鼓舞し、エンパワーします。この貴重な機会では、世界中の学生が一堂に会し、一連のコーディングハッカソンに参加し、著名な講演者から学び、トップ大学や技術機関を訪問します。',
      solutions_6_linkText: 'さらに詳しく',
      solutions_7_title: 'パートナーソリューション',
      solutions_7_text: 'すべての人がアクセスでき、魅力的なコーディングを可能にするという使命に参加して、価値あるパートナーになりましょう。教育ビジネス、eスポーツスポンサー、国際的なディストリビューター、社会的影響組織を含む柔軟なパートナーシップ構造を提供します。パートナーは、使いやすいプログラム、実装リソース、トレーニングオプションへのアクセスを受けられ、成功と楽しみのある体験が可能です。',
      solutions_8_title: '図書館向けソリューション',
      solutions_8_text: '完全に自己ペースで自己指向型のデジタルリソースとして、CodeCombatは図書館に最適な統合を提供します。初心者から大学レベルのコーディング概念を習得したい人々まで、すべての学習者が高レベルのコーディング教育を体験するために必要なものを備えています。',
      learn_more_text: 'さらに詳しく',
      best_homeschool_curriculum: '最高のホームスクール[NEWLINE]カリキュラム',
      sign_up_free: '無料でサインアップ',
      try_it_now: '今すぐ試す',
      junior_modal_header: '新しいK-5カリキュラムを今すぐお試しください！',
      junior_modal_body: 'K-5クラスルームに最適なこの新しいカリキュラムには、アイコンを使ったリアルなコーディング、ドラッグ＆ドロップのブロック、テキストとの並行ブロック、または純粋にテキストベースのオプションが含まれています。また、タブレットで完全に利用可能で、すべての学習者をサポートするのが簡単です。',
