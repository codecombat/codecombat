module.exports = {
  ...
  translation: {
    ...
    teacher_dashboard: {
      ...
      complete: '完了',
      progress: '進行中',
      choose_course: 'ドロップダウンから選択',
      teacher_locked_message: '次のレベルは先生によりロックされています',
      plan_your_class_title: '初めてのクラスを計画',
      plan_your_class1: 'コース進行情報を見る',
      plan_your_class2: 'レッスンスライドと拡張アクティビティをプレビュー',
      plan_your_class3: '最初の章を無料で試す',
      click_dismiss: 'クリックして閉じる',
      track_progress: '進捗を追跡',
      track_progress_desc: '作成したクラスにアクセスして、生徒の詳細な進捗を確認。',
      ...
      concept_flag_desc: 'クラスの50%以上の生徒がコンセプトチェックを3回以上試みました。',
      concept_flag_desc2: '生徒がコンセプトチェックを3回以上試みました。',
      click_progress_dot_tip: 'ヒント: 進捗バブルをクリックして詳細を表示',
      color_code: '色分け',
      content_guide: 'コンテンツガイド',
      story: 'ストーリー',
      cutscenes: 'カットシーン',
      cutscenes_tooltip: '<h3>カットシーン</h3><p>壮大なOzariaの物語の一部を説明する短編動画です。</p>',
      cinematics: 'シネマティクス',
      ...
      class_time: '授業時間',
      solution_guide: '解答ガイド',
      module: 'モジュール',
      need_licenses_tooltip: '<h3>このコンテンツにアクセスするにはライセンスが必要です！</h3><p>詳細については、<a href="/teachers/licenses">マイライセンス</a>ページをご覧ください。</p>',
      lesson_slides_tooltip: '<h3>レッスンスライド</h3><p>モジュールの学習目標を生徒にガイドするための、ダウンロード可能なステップバイステップのプレゼンテーションスライド</p>',
      project_rubric_tooltip: '<h3>プロジェクト評価基準</h3><p>総仕上げプロジェクト用のダウンロード可能で編集可能な評価基準</p>',
      exemplar_projects_tooltip: '<h3>模範プロジェクト</h3><p>模範となる総仕上げプロジェクトのライブビュー</p>',
      ...
      no_modifiers_changed: 'これらの生徒用レベルはすでに変更済み',
      ...
      ai_league_start_blurb: '初めてのクラスの設定からトーナメントの実施まで、すべてを案内するスタートガイドをご覧ください。',
      ai_league_curriculum_title: 'AIリーグカリキュラム',
      ai_league_curriculum_blurb: 'AIリーグアリーナ専用に設計された包括的なカリキュラムガイドを入手して、競技プログラミングの概念と戦略的思考を教えましょう。',
