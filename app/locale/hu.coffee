module.exports = nativeDescription: "magyar", englishDescription: "Hungarian", translation:
  ...
  new_home:
    ...
    view_my_classes: "Saját osztályok megtekintése"
    ...
    teachers: "Tanárok"
    teachers_and_educators: "Tanárok és Oktatók"
    class_in_box: "Fedezd fel, hogyan illeszthető a tanrendbe ez az osztálytermi oktatásra kifejlesztett program."
    get_started: "Indítás"
    students: "Tanulók:"
    join_class: "Osztályhoz csatlakozás"
    role: "Szerepköröd:"
    student_count: "Tanulók száma:"
    start_playing_for_free: "Kezdd el az ingyenes játékot!"
    students_and_players: "Tanulók és Játékosok"
    ...
    form_select_role: "Válassz elsődleges szerepkört"
    form_select_range: "Válaszd ki az osztály méretét"
  ...
  play:
    ...
    campaign_old_multiplayer: "(Érvénytelen) Régi Többjátékos Arénák"
    campaign_old_multiplayer_description: "Egy hajdanvolt civilizáció emlékei. Ezekben a régebbi, többjátékos arénákban nem futtatható szimuláció."
  ...
  signup:
    ...
    create_header: "Fiók létrehozása"
  ...
  about:
    ...
    lisa_title: "Üzletfejlesztési képviselő"
  ...
  teachers:
    ...
    more_info_title: "Hol találhatok további információkat?"
    more_info_1: "Az"
  ...
  courses:
    ...
    not_enrolled: "Nem vagy beíratva erre a kurzusra."
    visit_pref: "A beiratkozáshoz, kérjük, látogasd meg ezt az oldalt:"
    visit_suf: "."
    select_class: "Válaszd ki az egyik osztályodat"
    unnamed: "*névtelen*"
    select: "Kiválasztás"
    unnamed_class: "Névtelen osztály"
    edit_settings: "osztály szerkesztése"
    edit_settings1: "Osztály szerkesztése"
    progress: "Osztály fejlődése"
    ...
    furthest_level: "Legmagasabb szintű teljesített pálya:"
    students: "Tanulók"
    students1: "tanulók"
    concepts: "Fogalmak"
    levels: "pályák"
    ...
    invite_students: "Hívd meg a tanítványaidat ebbe az osztályba."
    invite_link_header: "A kurzus linkje"
    invite_link_p_1: "Küldd el ezt a linket azoknak a tanulóknak, akiket be szeretnél íratni a kurzusra."
    invite_link_p_2: "Másik megoldásként akár mi is meghívhatjuk őket e-mailben:"
    capacity_used: "Betöltött helyek száma:"
    ...
    buy_course1: "Kurzus megvásárlása"
    ...
    or: "Vagy"
    topics: "Témák"
    hours_content: "Foglalkozás időtartama:"
    get_free: "Ingyenes kurzus beszerzése"
    enroll_paid: "Tanulók beíratása térítéses kurzusokra"
    you_have1: "Jelenleg"
    you_have2: "kiosztható tanulói licenced van"
    use_one: "1 tanulói licenc adása ennek a tanulónak:"
    use_multiple: "Tanulói licencek adása ezeknek a tanulóknak:"
    already_enrolled: "már be van íratva"
    licenses_remaining: "fennmaradó licencek:"
    insufficient_enrollments: "nincs elég tanulói licenced"
    ...
    enrolled_courses: "térítéses kurzusokra beíratott tanulók száma:"
    ...
    none: "Nincs"
    save: "Mentés"
    play_campaign_title: "Kampány indítása"
    ...
    description: "Leírás" # ClassroomSettingsModal
    ...
    learn_p: "Python elsajátítása"
    learn_j: "JavaScript elsajátítása"
  ...
  teacher:
    ...
    cant_assign_to_unenrolled: "A kurzust nem lehet olyan tanulókhoz rendelni, akik nincsenek beíratva."
    no_students_selected: "Nincsenek kiválasztott tanulók."
    guides_coming_soon: "Leírások hamarosan!" # Courses
    ...
    total_unenrolled: "Összes be nem íratott"
    ...
    num_enrollments_needed: "Igényelt licencek száma:"
    get_enrollments_blurb: " Segítünk osztályod, iskolád vagy lakóterületed igényeire szabott megoldást találni!"
    enroll_request_sent_blurb1: "Köszönjük! Kérésedet elküldtük."
    enroll_request_sent_blurb2: "Csapatunk hamarosan kapcsolatba lép veled, hogy segítsen egy diákjaidra szabott megoldást találni."
    enroll_request_sent_blurb3: "Kérjük írj a <a href='mailto:schools@codecombat.com'>schools@codecombat.com</a> címre, ha további kérdéseid vannak."
    request_sent: "Kérés elküldve."
    enrollment_status: "Beiratkozás állapota"
  ...
  editor:
    ...
    level_component_settings: "Beállítások"
  ...
  concepts:
    ...
    recursion: "Rekurzió"
    basic_html: "HTML-alapok" # TODO: these web-dev concepts will change, don't need to translate
