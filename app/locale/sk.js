module.exports = {
  ...
  translation: {
    ...
    general: {
      ...
      hard: 'Ťažká',
      player: 'Hráč',
      player_rank: '[AI_TRANSLATION]Hodnosť',
      warrior: 'Bojovník',
      ranger: 'Strelec',
      wizard: 'Mág',
    ...
    premium_features: {
      get_premium: 'Staň sa preplatiteľom hry <br>CodeCombat<br>',
    ...
    clans: {
      ...
      private: '(súkromný)',
      summary: 'Sumár',
      average_rank: '[AI_TRANSLATION]Priemerná hodnosť',
    ...
    achievements: {
      ...
      left_xp_prefix: '',
      left_xp_rank_infix: '[AI_TRANSLATION] do ďalšej hodnosti ',
      left_xp_postfix: '',
    },
