...
#    related_urls: "Related Links"
    ...
    resource_hub: "Κέντρο Υλικού" # {change}
...
#    confirm_individual_blurb_without_email: "Write down your login information in case you need it later."
    ...
    teacher_list_resource_hub_4: "Κέντρο Υλικού" # {change}
...
#    revoke_selected_confirm: "Are you sure you want to revoke Licenses from all selected students?"
    ...
    teacher_quest_teach_methods_step2: "Εκτυπώστε τον [Οδηγός Γρήγορης Εκκίνησης Μαθητή](https://files.codecombat.com/docs/resources/StudentQuickStartGuide.pdf) στο Κέντρο Υλικού." # {change}
    ...
    teacher_quest_wakka_maul_100_step2: "Δείτε στον [Οδηγό Αρένας](/teachers/resources/arenas) στο [Κέντρο Υλικού](/teachers/resources) για συμβουλές για το πως να έχετε μία επιτυχημένη μέρα στην αρένα." # {change}
    ...
    back_to_resource_hub: "Επιστροφή στο Κέντρο Υλικού" # {change}
