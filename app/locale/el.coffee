...
#    confirm_individual_blurb_without_email: "Write down your login information in case you need it later."
    ...
    teacher_students_can_start_now_coco: "Οι φοιτητές σας θα είναι σε θέση να ξεκινήσουν αμέσως το πρώτο μάθημα, Εισαγωγή στην Πληροφορική."
    teacher_students_can_start_now_ozar: "Οι φοιτητές σας θα είναι σε θέση να ξεκινήσουν αμέσως το πρώτο μάθημα, Εισαγωγή στην Πληροφορική."
    ...
    teacher_list_resource_hub_2_coco: "Οδηγούς Μαθημάτων"
    teacher_list_resource_hub_2_ozar: "Οδηγούς Μαθημάτων"
...
#    description_coming_soon: "Description coming soon"
  ...
  options:
    ...
    editor_config_title_coco: "Ρύθμιση συντάκτη κειμένου"
    editor_config_title_ozar: "Ρύθμιση συντάκτη κειμένου"
...
#    bdm_title: "Business Development Manager"
    community_subtitle: "Περισσότεροι από 500 συνεισφέροντες βοήθησαν στην οικοδόμηση του CodeCombat, με περισσότερες συμμετοχές κάθε εβδομάδα!" # {change}
    ...
    number_contributors: "Πάνω από 450 εθελοντές έχουν προσφέρει την υποστήριξή τους και το χρόνο τους σε αυτό το έργο." # {change}
...
#    license_code_used: "License Code used."
  ...
  teachers_quote:
    subtitle_coco: "Ξεκινήστε με τους μαθητές σας σε λιγότερο από μία ώρα. Θα μπορείτε να <strong>δημιουργήσετε μια τάξη, να προσθέσετε μαθητές και να παρακολουθήσετε την πρόοδό τους</strong> καθώς μαθαίνουν την επιστήμη των υπολογιστών."
    subtitle_ozar: "Ξεκινήστε με τους μαθητές σας σε λιγότερο από μία ώρα. Θα μπορείτε να <strong>δημιουργήσετε μια τάξη, να προσθέσετε μαθητές και να παρακολουθήσετε την πρόοδό τους</strong> καθώς μαθαίνουν την επιστήμη των υπολογιστών."
...
#    anything_else_helper: ""
    ...
    thanks_sub_header_coco: "Ευχαριστώ που εκφράσατε ενδιαφέρον για το CodeCombat για το σχολείο σας."
    thanks_sub_header_ozar: "Ευχαριστώ που εκφράσατε ενδιαφέρον για το CodeCombat για το σχολείο σας."
...
#    hoc_blurb3: "activity! Construct four different minigames to learn the basics of game development, then make your own!"
    ...
    back_courses_coco: "Πίσω στα μαθήματα μου"
    back_courses_ozar: "Πίσω στα μαθήματα μου"
    ...
    practice: "πρακτική"
    required: "απαιτητέ"
    welcome_to_courses_coco: " Εξερευνητές καλωσήρθατε στις Σειρές Μαθημάτων!"
    welcome_to_courses_ozar: " Εξερευνητές καλωσήρθατε στις Σειρές Μαθημάτων!"
...
#    view_videos: "view videos"
    ...
    ask_teacher_for_code_coco: "Ζήτα από το δάσκαλο σου, εάν έχει ένα κωδικό τάξης για το CodeCombat! Εάν έχει, πληκτρολόγησε τον παρακάτω:"
    ask_teacher_for_code_ozar: "Ζήτα από το δάσκαλο σου, εάν έχει ένα κωδικό τάξης για το CodeCombat! Εάν έχει, πληκτρολόγησε τον παρακάτω:"
    enter_c_code_coco: "<Πληκτρολόγησε Κωδικό Τάξης>"
    enter_c_code_ozar: "<Πληκτρολόγησε Κωδικό Τάξης>"
    join: "Σύνδεση"
...
#    minutes_per_class: "minutes per class"
    ...
    license_required_to_play_coco: "Ζητήστε από τον δάσκαλό σας να σας εκχωρήσει μια άδεια για να μπορείτε να συνεχίσετε να παίζετε CodeCombat!"
    license_required_to_play_ozar: "Ζητήστε από τον δάσκαλό σας να σας εκχωρήσει μια άδεια για να μπορείτε να συνεχίσετε να παίζετε CodeCombat!"
...
#    feedback_capstone: "The student will create a base project in Part 1. They will make creative updates based on peer feedback in Part 2. Here is a <a target=\"_blank\" rel=\"noopener\" href=\"https://docs.google.com/document/d/1itB0vY6WphjINQYJ9NHkILATcLLlYD3GDSg6FJg55OQ\">Peer Feedback Template</a> that you can share with your students."
    ...
    my_classes: "Οι Τάξεις Μου"
    courses_coco: "Οδηγοί Μαθημάτων"
    courses_ozar: "Οδηγοί Μαθημάτων"
...
#    view_student_code: "Click to view student code"
    select_course_coco: "Επέλεξε μάθημα για προβολή"
    select_course_ozar: "Επέλεξε μάθημα για προβολή"
...
#    hoc_meta_description: "Make your own game or code your way out of a dungeon! CodeCombat has four different Hour of Code activities and over 60 levels to learn code, play, and create."
    ...
    hoc_teacher_led_link_coco: "Σχέδια μαθήματος για την Εισαγωγή στην Πληροφορική"
    hoc_teacher_led_link_ozar: "Σχέδια μαθήματος για την Εισαγωγή στην Πληροφορική"
...
#    revoke_selected_confirm: "Are you sure you want to revoke Licenses from all selected students?"
    ...
    teacher_quest_teach_methods_step1: "Φτάσετε στο 75% τουλάχιστον μιας τάξης μέσω του πρώτου επιπέδου, Dungeons of Kithgard"
    teacher_quest_teach_methods_step2: "Εκτυπώστε τον [Οδηγός Γρήγορης Εκκίνησης Μαθητή](https://files.codecombat.com/docs/resources/StudentQuickStartGuide.pdf) στο Κέντρο Υλικού."
    teacher_quest_teach_strings: "Μην συμβουλεύετε μόνο τους μαθητές σας, διδάξετέ τους `συμβολοσειρές`."
    teacher_quest_teach_strings_step1: "Φτάσετε στο 75% τουλάχιστον μιας τάξης μέσω του True Names"
    teacher_quest_teach_strings_step2: "Χρησιμοποιήστε τον Επιλογέα Επιπέδου του Δασκάλου στη σελίδα [Οδηγοί Μαθημάτων](/teachers/courses) για να κάνετε επισκόπηση του True Names."
    teacher_quest_teach_loops: "Βάλτε τους μαθητές σας σε λούπα με `βρόχους`."
    teacher_quest_teach_loops_step1: "Φτάσετε στο 75% τουλάχιστον μιας τάξης μέσω του Fire Dancing."
    teacher_quest_teach_loops_step2: "Χρησιμοποιήστε την Loops Activity στο [Πληροφορική 1 Οδηγός Προγράμματος Μαθημάτων](/teachers/resources/cs1) για να ενισχύσετε αυτή την έννοια."
    teacher_quest_teach_variables: "Αλλάξτε το με τις `μεταβλητές`."
    teacher_quest_teach_variables_step1: "Φτάσετε στο 75% τουλάχιστον μιας τάξης μέσω του Known Enemy."
    ...
    teacher_quest_kithgard_gates_100_step1: "Φτάσετε στο 75% τουλάχιστον μιας τάξης μέσω του Kithgard Gates."
    teacher_quest_kithgard_gates_100_step2: "Κατευθύνετε τους μαθητές να επεξεργάζονται δύσκολα προβλήματα χρησιμοποιώντας το [Φύλλο Εργασίας Μηχανικού Κύκλου](https://files.codecombat.com/docs/resources/EngineeringCycleWorksheet.pdf)."
    teacher_quest_wakka_maul_100: "Προετοιμαστείτε για μονομαχία στο Τσεκουράτος Γουάκα."
    teacher_quest_wakka_maul_100_step1: "Φτάσετε στο 75% τουλάχιστον μιας τάξης μέσω του Wakka Maul."
