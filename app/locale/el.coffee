...
#    required: "You need to log in before you can go that way."
  ...
  play:
    ...
    campaign_beginner_description: "... στην οποία μπορείτε να μάθετε τη μαγεία του προγραμματισμού"
    campaign_dev: "Τυχαία δυσκολότερα επίπεδα"
    campaign_dev_description: "... στα οποία μπορείτε να εξερευνήσετε τις προγραμματιστικές διεπαφές, ενώ κάνετε κάτι λίγο πιο δύσκολο."
    campaign_multiplayer: "Αρένες Πολλαπλών Παικτών"
    campaign_multiplayer_description: "... στις οποίες μπορείτε να προγραμματίσετε σώμα με σώμα έναντι άλλων παικτών."
    campaign_player_created: "Δημιουργίες Παικτών"
    campaign_player_created_description: "... στις οποίες αγωνίζεστε εναντίον συναδέλφων <a href=\"/contribute#artisan\">Τεχνιτών</a>."
    campaign_classic_algorithms: "Κλασικοί Αλγόριθμοι"
    campaign_classic_algorithms_description: "... όπου μπορείτε να μάθετε τους πλέον γνωστούς αλγορίθμους της Πληροφορικής Επιστήμης."
    level_difficulty: "Δυσκολία: "
    play_as: "Παίξε ως"
    spectate: "Παρακολούθησε"
    players: "παίχτες"
