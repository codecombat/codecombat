...
#    daniela_blurb: "Creates stories"
    ...
    community_subtitle: "Περισσότεροι από 600 συνεισφέροντες βοήθησαν στην οικοδόμηση του CodeCombat, με περισσότερες συμμετοχές κάθε εβδομάδα!"
    ...
    number_contributors: "Πάνω από 600 εθελοντές έχουν προσφέρει την υποστήριξή τους και το χρόνο τους σε αυτό το έργο."
