...
#    slogan: "The most engaging game for learning programming."
    classroom_edition: "Έκδοση Τάξης:"
#    learn_to_code: "Learn to code:"
    learn_to_code: "Μάθε Κώδικα:"
#    play_now: "Play Now"
    play_now: "Παίξε Τώρα"
    im_a_teacher: "Είμαι Δάσκαλος"
    im_a_student: "Είμαι Μαθητής"
    learn_more: "Μάθε περισσότερα"
    classroom_in_a_box: "Μια ολοκληρωμένη λύση μαθημάτων για τη διδασκαλία της επιστήμης των υπολογιστών."
    codecombat_is: "Το CodeCombat είναι μια πλατφόρμα <strong>για μαθητές/τριες</strong> που θέλουν να μάθουν την επιστήμη των υπολογιστών παίζοντας με ένα πραγματικό παιχνίδι."
    our_courses: "Τα μαθήματά μας δοκιμάστηκαν ειδικά <strong>για να αποδίδουν άψογα στην τάξη</strong>, ακόμη και από δάσκαλους με λίγη ή καθόλου προγραμματιστική εμπειρία."
