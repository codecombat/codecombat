...
#    support_part2: "support@codecombat.com"
  ...
  premium_features:
    ...
    hero_blurb_1: "Du bekommst Zugang zu __premiumHeroesCount__ extrastarken Helden nur für Abonnenten! Nutze die nicht aufzuhaltende Macht von Okar Stompfoot, die tödliche Präzision von Naria von Blatt oder beschwöre \"hinreißende\" Skelette mit Nalfar Cryptor."
    hero_blurb_2: "Prämium-Krieger erschließen beeindruckende Kampfkünste wie Kampf-Schrei, Stampfen, und Feinde-wirbeln. Oder spiele als Waldläufer und nutze Tarntechnik, den Bogen, Messer und Fallen. Fordere Deine Fähigkeiten als wahrer Programmier-Zauberer heraus und entfessele ein mächtiges Aufgebot von  Ur-, Nekromantie- oder Elementar-Magie!"
    hero_caption: "Spannende neue Helden!"
    pet_blurb_1: "Lieblingstiere sind nicht nur hinreißende Begleiter, sie stellen auch einzigartige Funktionen und Methoden zur Verfügung. Der Babygreif kann über Hindernisse fliegen und dem Helden helfen, der Wolfswelpe kann Zaubertränke holen und der Puma kann sprechen!"
    ...
    list_items: "Rüste Dich aus mit Dingen, die nur für Abonnenten verfügbar sind, wie zum Beispiel Lieblingstieren"
