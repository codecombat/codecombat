module.exports = nativeDescription: "Deutsch (Deutschland)", englishDescription: "German (Germany)", translation:
  ...
  subscribe:
    ...
    kids_message_2: "Frag Deine Eltern"
...
#    support_part2: "support@codecombat.com"
  ...
  announcement:
    ...
    ball_name: "Roter quitschender Ball"
  ...
  premium_features:
    ...
    master_coder: "Werde Master Coder indem du heute noch ein Abonnement abschließt!"#"Become a Master Coder by subscribing today!"
    subscribe_now: "Aboniere heute"
    hero_blurb_1: "Du bekommst Zugang zu __premiumHeroesCount__ extrastarken Helden nur für Abonennten! Nutze die the nicht aufzuhaltende Macht von Okar Stompfoot, die tödliche Präzision von Naria von Blatt der beschwöre \"liebenswerte\" Skelette mit Nalfar Cryptor."
    hero_blurb_2: "Prämium Krieger erschließen beeindrucktende Kampfkünste wie Warcry, Stomp, und Hurl Enemy. Oder spiele als Waldläufer und nutze Tarntechnik, den Bogen, Messer und Fallen. Fordere Deine Fähigkeiten als wahrer Programmier-Zauberer heraus und entfessele ein mächtiges Aufgebot von  Ur-, Nekromantie- oder Elementar-Magie!"
    hero_caption: "Spannende neue Helden!"
    pet_blurb_1: "Lieblingstiere sind nicht nur hinreißende Begleiter, sie stellen auch einzigartige Funktionen und Methoden zur Verfügung. Der Babygreif kan über Hindernisse fliegen und dem Helden helfen, der Wolfswelpe kann Zaubertränke holen und der Puma kann sprechen!"
    pet_blurb_2: "Sammle alle Lieblingstiere und entdecke ihre einzigartigen Fähigkeiten"
    ...
    game_dev_caption: "Gestalte eigene Spiele und fordere Deine Freunde heraus!"
    ...
    list_heroes: "Schalte exklusive Helden frei, einschließlich der Waldläufer und Zauberer-Klassen"
    list_game_dev: "Erstelle Spiele und teile sie mit Freunden"
    list_web_dev: "Erstelle Webseiten und interaktive Apps"
    list_items: "Rüste Dich aus mit Dingen, die nur für Abonennten verfügbar sind, wie zum Beispiel Lieblingstieren"
    list_support: "Erhalte Prämium-Support der Dir hilft, Fehler in kompliziertem Code zu finden"
    list_clans: "Gründe private Clans um Deine Freunde einzuladen und führt eine Gruppen-Rangliste"
  ...
  teachers_quote:
    ...
    referrer_help: "zum Beispiel: von einem anderen Lehere, auf einer Konferenz, von deinen Schülern, Code.org, etc."
  ...
  teacher:
    ...
    revoke_license: "Lizenz zurücknehmen"
    ...
    gd1_guide_desc: "Benutze diese um Deine Schüler zu begleiten während sie in 5 Tagen ihr erstes, Spielprojekt erstellen, das geteilt werden kann."
    wd1: "Web Entwicklung 1"
    ...
    wd1_html_syntax_desc: "Referen auf einer Seite für HTML style Elemente, welche Studenten in Web Entwicklung 1 kennenlernen."
    wd1_css_syntax: "CSS Syntax-Anleitung"
    wd1_css_syntax_desc: "Referenz auf einer Seite für die CSS- und Style- Syntax, die Schüler in Web Entwicklung 1 lernen."
    wd2: "Web Entwicklung 2"
    wd2_jquery_syntax: "jQuery Funktionen Syntax-Anleitung"
    wd2_jquery_syntax_desc: "Referenz auf einer Seite für die jQuery-Funktionen, die Schüler in Web Entwicklung 2 kennenlernen."
    wd2_quizlet_worksheet: "Quizlet Planungs-Arbeitsblatt"
    wd2_quizlet_worksheet_instructions: "Anleitung und Beispiele ansehen"
    wd2_quizlet_worksheet_desc: "Bevor die Schüler am Ende von Web Entwicklung 2 ihr Test-Projekt erstellen, sollten sie die Fragen, Ergebnisse und Antworten mit Hilfe dieses Arbeitsbogens planen. Lehrer können die Anweisungen und Beispiele an die Schüler zur Bezugnahme verteilen."
    ...
    revoke_confirm: "Bist Du sicher die vollständige Lizenz von {{student_name}} zurückzuziehen? Die Lizenz kann dann einem anderen Schüler zugewiesen werden."
    ...
    remember_new_courses: "Neue Kurse können zugewiesen werden!"  #"Remember to assign new courses!"
    more_info: "Weitere Informationen"
    how_to_assign_courses: "Wie Kurse zugewiesen werden"
    select_students: "Studenten auswählen" #"Select Students"
    select_instructions: "Kreuze die Ankreuzfelder neben den Schülern an, denen Du Kurse zuweisen willst."
    choose_course: "Kursauswahl" #"Choose Course"
    ...
    push_projects: "Wir empfehlen,  Web Entwicklung 1 oder Spiele Entwicklung 1 zuzuweisen, nachdem die Schüler “Einführung in die Computerwissenschaft” beendet haben! Weitere Informationen über diese Kurse unter {{resource_hub}}." #"We recommend assigning Web Development 1 or Game Development 1 after students have finished Introduction to Computer Science! See our {{resource_hub}} for more details on those courses."
