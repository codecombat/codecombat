module.exports = nativeDescription: "Deutsch (Deutschland)", englishDescription: "German (Germany)", translation:
  ...
  teacher:
    ...
    cs5_curriculum_js: "Computerwissenschaft 5 - Curriculumsleitfaden (JavaScript)"
    cs5_curriculum_desc_js: "Umfang und Reihenfolge, Unterrichtspläne und mehr für Kurs 5-Klassen mit JavaScript."
    cs5_curriculum_py: "Computerwissenschaft 5 - Curriculumsleitfaden (Python)"
    ...
    teacher_quest: "Schritte zum Lehr-Erfolg" #"Teacher's Quest for Success"
#    quests_complete: "Quests Complete" 
    ...
    teacher_quest_teach_strings: "Zerreiße die Ketten und zeige deinen Schülern, wie Zeichenketten gehen."#"Don't string your students along, teach them `strings`."
    teacher_quest_teach_strings_step1: "Bringe 75% mindestens einer Klasse durch  __True Names__"
    teacher_quest_teach_strings_step2: "Benutze den Teacher Level Selector auf der [Course Guides](/teachers/courses) Seite für eine Vorschauf auf __True Names__."
    ...
    teacher_quest_wakka_maul_100_step2: "In [Arena Guide](/teachers/resources/arenas) im [Resource Hub](/teachers/resources) findest du Tipps wie du einen erfolgreichen Tag in der Arena gestaltest."
    teacher_quest_reach_gamedev: "Erkunde neue Welten!"
    teacher_quest_reach_gamedev_step1: "[Get licenses](/teachers/licenses) damit deine Stundenten neue Welten wie Spiele-Entwicklung Game Development and Web-Entwicklung entdecken können!"
    teacher_quest_done: "Wenn deine Studenten mehr programmieren wollen? Kontaktiere unsere [school specialists](mailto:schools@codecombat.com) noch heute!"
