...
#  share_progress_modal:
    blurb: "Du machst dich gut! Sag jemanden wie viel du mit CodeCombat gelernt hast." # "You’re making great progress! Tell someone how much you've learned with CodeCombat."
    email_invalid: "Diese Email Adresse ist ungültig." # "Email address invalid."
#    form_blurb: "Schreibe hier ihre Emailadresse rein und wir werden es ihnen zeigen." "Enter their email below and we’ll show them!"
