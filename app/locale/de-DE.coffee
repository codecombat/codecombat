...
#    loading_start_concept: "Start Concept Challenge"
    ...
    tip_open_source: "CodeCombat ist 100% quelloffen!" # {change}
...
#    if_else_if: "If/Else If Statements"
    ...
    if_statements_nested: "Verschachtelte If-Statements" # {change}
...
#    teacher_notified: "We've notified your teacher that you want to play more CodeCombat in your classroom!"
  ...
  legal:
    ...
    opensource_intro: "CodeCombat ist Free-to-Play und vollständig Open Source." # {change}
