module.exports = nativeDescription: "Deutsch (Deutschland)", englishDescription: "German (Germany)", translation:
  ...
  signup:
    ...
    teacher_students_can_start_now: "Gleich können Deine Schüler mit dem ersten Kurs, Einführung in die Computerwissenschaft, beginnen."
    ...
    teacher_list_resource_hub_5: "for Curriculumleitfäden, Aktivitäten und mehr!"
  ...
  premium_features:
    ...
    master_coder: "Werde Master Coder indem du heute noch ein Abonnement abschließt!"
...
#    cs5_curriculum_desc_py: "Scope and sequence, lesson plans, activities and more for Course 5 classes using Python."
    ...
    push_projects: "Wir empfehlen,  Web Entwicklung 1 oder Spiele Entwicklung 1 zuzuweisen, nachdem die Schüler “Einführung in die Computerwissenschaft” beendet haben! Weitere Informationen über diese Kurse unter {{resource_hub}}."
