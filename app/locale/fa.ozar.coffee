module.exports = nativeDescription: "فارسی", englishDescription: "Persian", translation:
  ...
  ozaria_home:
    subtitle: "علوم کامپیوتر که مجذوب کننده‌است"
    heading_subtitle: "یک ماجراجویی برنامه‌نویسی برای دانش‌آموزان و راه‌حل آماده به‌کار شما برای تدریس علوم کامپیوتر."
    item_list_p: "امروز فصل 1 را رایگان امتحان کنید!"
    engaging_heading_corner: "یک راهکار برای مشارکت دانش‌آموزان و حمایت از معلمان"
    engaging_row1_h2: "پیاده‌سازی آسان"
    engaging_row1_p: "حتی اگر تجربه برنامه‌نویسی نداشته باشید، با اوزاریا می‌توانید یک برنامه کامل آموزش علوم کامپیوتر را تدریس کنید. برنامه‌های آماده درسی و داشبورد شهودی ما، ابزارهای لازم را در اختیار شما قرار می‌دهد تا از روز اول آماده تدریس باشید."
    engaging_row2_h2: "گیم‌پلی همه جانبه"
    engaging_row2_p: "دانش‌آموزان در یک بازی ماجراجویی غوطه‌ور می‌شوند که در آن دانش علوم کامپیوتر آنها با پیشرفت داستان گسترش می‌یابد. در این محیط یادگیری جذاب، دانش‌آموزان با قدرت بازی، مهارت‌هایی برای دنیای واقعی کسب می‌کنند."
    engaging_row3_h2: "برنامه درسی همراستا با استانداردها"
    engaging_row3_p: "اوزاریا با استانداردهای CSTA و ISTE همراستا است، به شما امکان می‌دهد با اطمینان تدریس کنید در حالی که دانش‌آموزانتان مفاهیم اصلی علوم کامپیوتر را فرا می‌گیرند، مهارت‌های تفکر محاسباتی آنها توسعه می‌یابد و دربارهٔ ارتباط علوم کامپیوتر با زندگی روزمره‌شان می‌آموزند."
    pd_blurb: "با دوره خودآموز ما که اعتبار CSTA را دارد، مهارت‌های لازم برای تدریس موثر علوم کامپیوتر را فرا بگیرید. تا 40 ساعت اعتبار در هر زمان و از هر دستگاه(دیوایس هوشمند) کسب کنید."
    back_cta_1_a: "فصل 1 را رایگان امتحان کنید"
    speech_bubble_testimonial_1_blockquote: "تیم شما بار دیگر موفق به دستیابی به جام مقدس آموزش سرگرم‌کننده شده است. به نظر من با 26 سال سابقه تدریس در دوره متوسطه، هیچ منبعی جذاب‌تر از این برای آموزش کدنویسی وجود ندارد."
    core_curriculum_header: "برنامه درسی اصلی علوم کامپیوتر"
    core_curriculum_p: "ما مدل آموزشی خود را بر اساس نظریه‌های موفق و شواهد گسترده در مورد بهترین روش یادگیری دانش‌آموزان توسعه داده‌ایم."
    core_curriculum_carousel_item1_header: "ارتباطاتی برقرار کنید"
    core_curriculum_carousel_item1_p: "در شروع هر ماژول، از اسلایدهای آماده درس ما استفاده کنید تا به دانش‌آموزانتان کمک کنید ارتباط میان مفاهیم جدید علوم کامپیوتر و مثال‌های مرتبط از زندگی روزمره‌شان را برقرار کنند."
    core_curriculum_carousel_item2_header: "معنا و مفهوم خودت را بساز"
    core_curriculum_carousel_item2_p: "سپس، دانش‌آموزان را در درک عمیق‌تر مفاهیم جدید از طریق فعالیت‌های توسعه‌ای که در برنامه‌های درسی ما گنجانده شده‌اند، هدایت کنید."
    core_curriculum_carousel_item3_header: "آموزش مفاهیم تازه"
    core_curriculum_carousel_item3_p: "در مرحله سوم چرخه یادگیری، دانش‌آموزان شما از طریق گفتگوهای توضیحی بین شخصیت‌های داستان اوزاریا، مفاهیم جدیدی را فرا می‌گیرند. گویندگی، گرافیک‌ها و انیمیشن‌ها، یادگیری اطلاعات جدید را ساده‌تر و جذاب‌تر می‌کنند."
    core_curriculum_carousel_item4_header: "دانش جدید را به کار ببندید"
    core_curriculum_carousel_item4_p: "سپس، دانش‌آموزان شما آنچه را که یاد گرفته‌اند با تایپ کردن پایتون یا جاوا اسکریپت واقعی برای حل انواع چالش‌ها در سطوح بازی نردبامی، به کار می‌بندند. راهنمایی‌های داخلی به دانش‌آموزان کمک می‌کند تا باگ‌ها را شناسایی و رفع کنند، که این امر منجر به افزایش اعتماد به نفس در کدنویسی می‌شود."
    core_curriculum_carousel_item5_header: "پروژه نهایی"
    core_curriculum_carousel_item5_p: "در پایان هر فصل، دانش‌آموزان شما با چالشی مواجه می‌شوند تا با ارائه پروژه‌های جمع‌بندی که در آن بازی‌ها، داستان‌ها و غیره خودشان را می‌سازند، مهارت‌های جدید و خلاقیت خود را نشان دهند."
    core_curriculum_scope_sequence: "محدوده و ترتیب مطالب را ببینید"
    core_curriculum_sample_lesson_slides: "اسلایدهای نمونه درسی را ببینید"
    global_community_header: "به انجمن جهانی ما بپیوندید"
    global_community_row1_p: "دانش‌آموزان"
    global_community_row2_p: "خطوط کد"
    global_community_row3_p: "دبیران"
    global_community_row4_p: "کشورها"
    admin_dashboard_header: "داشبوردهای جامع معلم و مدیر"
    admin_dashboard_p: "طراحی شده با بازخورد از جامعه بیش از 140،000 معلم ما، اوزاریا چالش‌های تدریس علوم کامپیوتر را با ارائه ابزارها و منابع کاربردی برطرف می‌کند."
    admin_dashboard_row1_p: "داشبورد معلم ساده و راحته و به نقشه درس‌ها، راهنماهای آموزشی، روش‌های آموزش از راه دور و منابع دیگه که نیاز داری دسترسی میده تا نیازهای تو رو برآورده کنه."
    admin_dashboard_row2_p: "صفحه پیگیری پیشرفت به شما امکان می‌دهد به‌طور مداوم پیشرفت دانش‌آموزان را پایش کنید، اطلاعات ارزشمندی در مورد عملکرد آنها به دست آورید و بلافاصله مشخص کنید که آیا مداخله‌ای لازم است یا خیر."
    admin_dashboard_row3_a: "تقاضای قیمت کن"
    acodus_awards_a: "امروز فصل 1 رو رایگان امتحان کن!"
    speech_bubble_testimonial_2_blockquote: "این جذاب‌ترین سایت برنامه‌نویسیه که تا حالا دیدم. قصه‌ای که با اوزاریا همراهه رو قدر می‌دونم، چون با مأموریتی که شاگردام می‌تونن باهاش همذات‌پنداری کنن همخوانی داره. به راستی عاشقشم! در حقیقت، دیدم که آخر هفته گذشته خیلی بیشتر از چیزی که دوست دارم اعتراف کنم، بازیش کردم!"
    shareable_resources_header: "منابع قابل اشتراک‌گذاری"
    shareable_resources_p: "این منابع رو با معلما، مدیرا و بقیه افرادی که درگیر آوردن علوم کامپیوتر به مدرسهٔ شما یا بهتر کردن چیزایی که الان ارائه میشه هستن، به اشتراک بذارید."
    shareable_resources_a: "دانلود بروشور"
    back_cta_2_a: "امروز فصل 1 رو رایگان امتحان کن!"
    faq_header: "سوالات متداول"
    faq_row1_header: "اوزاریا چه ارتباطی با کدکامبت داره؟"
    faq_row1_p: "اوزاریا تکامل کلاس-محور کدکامبته، یکی از محبوب‌ترین بازی‌های کدنویسی تاریخه. ما اوزاریا رو بر اساس بینش‌های به دست اومده از آموزش بیش از ۲۰ میلیون یادگیرنده پایتون و جاوااسکریپت ساختیم. اوزاریا مدل‌های آموزشی جدید، یه داستان جذاب محوری و طراحی برای پیاده‌سازی تو کلاس‌ها، هم برای یادگیری حضوری و از راه دور رو اضافه کرده."
    faq_row2_header: "چه سن یا پایه‌هایی برای اوزاریا مناسبن؟"
    faq_row2_p: "اوزاریا با استانداردهای متوسطه انجمن معلمان علوم کامپیوتر و انجمن بین‌المللی تکنولوژی آموزشی همسو شده، ولی توسط دانش‌آموزایی از مقطع ابتدایی تا دبیرستان هم تجربه‌شده و ازش لذت بردن."
    faq_row3_header: "هزینه دسترسی به تمام واحدها و منابع موجود چقدره؟"
    faq_row3_p_part1: "ما راه حل‌ها رو بر اساس نیاز مدارس و مناطق شخصی‌سازی می‌کنیم و با شما کار می‌کنیم تا مورد استفاده، زمینه و بودجه رو درک کنیم."
    faq_row3_p_part2: " برای جزئیات بیشتر! ما همچنین ارائه میدیم یک "
    faq_row3_p_part3: "راهنمای منابع تأمین مالی"
    faq_row3_p_part4: " برای برنامه‌های علوم کامپیوتر مدارس و مناطق"
    faq_row4_header: "آیا اوزاریا یادگیری مبتنی بر پروژه داره؟"
    faq_row4_p: "بله. اوزاریا در پایان هر فصل پروژه‌های نهایی قابل اشتراک‌گذاری داره که دانش‌آموزا بازی‌های خودشون رو می‌سازن. این پروژه‌ها به عنوان ارزشیابی‌های جمع‌بندی عمل می‌کنن و راه‌های عالی برای بیان خود و نشون دادن یادگیری‌هاشون به هم‌کلاسی‌ها، دوستا و خانواده‌هاشون هستن."
    faq_row5_header: "می‌تونم اوزاریا رو به عنوان برنامه اصلی کلاسم استفاده کنم؟"
    faq_row5_p: "البته! اوزاریا هرچیزی رو که نیاز داری برای اجرای یه کلاس کامل علوم کامپیوتر داره، حتی اگه سابقه‌ای توی علوم کامپیوتر نداشته باشی. از برنامه‌های درسی و راهنماهای راه حل گرفته تا شاخص‌های پروژه و استانداردهای داخلی، همه اینجا هستن."
    faq_row6_p_part1: "اگه سوال دیگه‌ای داشتید لطفا "
    see_faq_prefix: "بیشتر ببینید"
    see_faq_link: "سوالات متداول توی مرکز راهنمای ما"
    see_faq_suffix: "."
    summary: "اوزاریا یه برنامه علوم کامپیوتره، یه بازی ماجراجویی و یه داستان فانتزی که دانش‌آموزا با یادگیری جادوی گم‌شده کدنویسی، دنیاشون رو نجات می‌دن."
    value_prop1_h1: "داستان حماسی. بازی فراگیر"
    value_prop1_h2: "الهام بخش ارتباطی عمیق تر با یادگیری"
    value_prop1_p: "تو اوزاریا، دانش‌آموزا خودشون رو غرق دنیای جدیدی می‌بینن که توش با یادگیری مفاهیم اصلی علوم کامپیوتر می‌تونن تو بازی پیشرفت کنن. داستان در حال گسترش یه تجربه یادگیری قدرتمند متمرکز بر دانش‌آموز ایجاد می‌کنه، به این صورت که سرمایه‌گذاری هر دانش‌آموز تو داستان اوزاریا، موازی سرمایه‌گذاری‌ای هست که تو مسیر یادگیری خودشون انجام می‌دن."
    value_prop2_h1: "کشف قهرمان درون هر دانش‌آموز"
    value_prop2_h2: "ساختن مهارت‌های واقعی از طریق بازی"
    value_prop2_p: "مفاهیم و مهارت‌ها از طریق یه پیشرفت محتوای طراحی شده با دقت معرفی می‌شن که شامل سطح‌های بازی، گفتگوهای آموزشی شخصیت‌ها، صحنه‌های فیلم و بیشتر. دانش‌آموزا یاد می‌گیرن پایتون یا جاوااسکریپت بنویسن، با استفاده از تفکر محاسباتی مسئله حل کنن، درکشون رو از طریق ارزشیابی‌های تکوینی نشون بدن و یادگیری‌هاشون رو با ساخت پروژه‌های خودشون به کار ببندن."
    value_prop3_h1: "سفرت رو رایگان شروع کن"
    value_prop3_p: "با محتوای رایگان که مفاهیم مقدماتی علوم کامپیوتر را پوشش می‌دهد، از طریق ماجراجویی تدریس کنید و به راهنماهای اجرایی و برنامه‌های درسی دسترسی داشته باشید."
    projects_inspire_heading: "پروژه‌هایی که الهام‌بخشن. منابعی که توانمند می‌کنن."
    student_creativity: "خلاقیت دانش‌آموزان رو آزاد کن"
    student_creativity_paragraph: "در پایان هر واحد، دانش‌آموزا چیزایی رو که یاد گرفتن رو با ساختن پروژه‌ها، از بازی‌ها گرفته تا داستان‌های انتخاب ماجراجویانه و بیشتر، به کار می‌بندن. این پروژه‌ها با اهداف پلکانی ساخته شدن ولی ایده‌پردازی بی‌نهایت رو امکان‌پذیر می‌کنن. دانش‌آموزا یه پرتفولیوی قابل اشتراک و قابل بازی از کاراشون می‌سازن که هویت خلاقشون رو نشون می‌ده."
    teach_with_support: "با حمایت تدریس کن"
    teach_with_support_paragraph: "اوزاریا برای آموزگارا ساخته شده. هر واحد در طول برنامه‌ی درسی یه برنامه‌ی درسی داره که اهداف یادگیری، تصورات اشتباه رایج دانش‌آموزا، واژگان کلیدی و استانداردهای CSTA رو توضیح می‌ده. علاوه بر این، یه داشبورد معلم جامع به معلم‌ها کمک می‌کنه تا پیشرفت دانش‌آموزا رو رصد کنن و کد دانش‌آموزا رو بررسی کنن."
    request_demo: "درخواست نسخه‌ی آزمایشی"
    im_an_educator: "من دبیر ام"
    im_a_student: "من دانشجو ام"
    global_title: "به انجمن جهانی دانش‌آموزان و دبیران ما بپیوندید"
    global_subtitle1: "دانش‌آموزان"
    global_subtitle2: "خطوط کد"
    global_subtitle3: "دبیران"
    global_subtitle4: "کشورها"
    sign_up: "ثبت‌نام"
    learner_number: "12 میلیون"
    code_line_number: "1 میلیارد"
