...
#    auth_sign_up: "New to Ozaria? Create an Account"
    sign_up: "계정 생성"
    email_or_username: "이메일 또는 사용자 이름" # {change}
#    or: "or"
    log_in: "로그인"
#    sign_in: "Sign In"
    logging_in: "로그인 중"
    ...
    finishing: "완료중.."
    sign_in_with_facebook: "페이스북으로 로그인" # {change}
    sign_in_with_gplus: "G+로 로그인" # {change}
...
#    classroom_not_found: "No classes exist with this Class Code. Check your spelling or ask your teacher for help."
    ...
    signup_as_teacher: " 교사용 계정 생성 " # {change}
    ...
    signup_as_student: " 학생용 계정 생성." # {change}
    ...
    write_this_down: " 이 정보를 적어두세요:" # {change}
    ...
    teacher_students_can_start_now: "당신의 학생들은 첫 수업 '전산학 개론'을 바로 진행할 수 있습니다." # {change}
    ...
    teacher_list_resource_hub_2: "게임 가이드." # {change}
...
#    description_coming_soon: "Description coming soon"
  ...
  options:
    ...
    editor_config_title: "에디터 설정" # {change}
    editor_config_livecompletion_label: "자동완성 활성화" # {change}
    ...
    editor_config_behaviors_label: "자동 기능" # {change}
...
#    student_email_invite_blurb: "Your students can also use class code <strong>__classCode__</strong> when creating a Student Account, no email required."
    ...
    back_classroom: "교실로 돌아가기" # {change}
...
#    minutes_per_class: "minutes per class"
    ...
    license_required_to_play: "선생님에게 라이선스를 허가 받고 코드 컴뱃을 계속 하세요! " # {change}
