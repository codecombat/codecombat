...
#    sys_requirements_7: "We help players learn through voiceover and sound effects, which will make classrooms noisy and distracting."
  ...
  community:
    ...
    thang_editor_suffix: "来改良 odeCombat中的原材料。让游戏中的东西可以被捡起来扔出去，改变游戏动画的指向，调整一些东西的生命值，或上传您自制的素材。"
    article_editor_prefix: "你在游戏中发现了错误了吗？想要自己设计一些指令吗？来看看我们的"
    article_editor_suffix: "来帮助玩家从游戏中学到更多的知识。"
    find_us: "通过这些站点联系我们"
    social_blog: "阅读CodeCombat 在 Sett上面的博客"
    social_discource: "在我们的论坛参与讨论"
    social_facebook: "关注 CodeCombat的Facebook 主页"
    social_twitter: "关注 CodeCombat的Twitter"
    social_gplus: "关注CodeCombat 的 Google+主页"
...
#    oreilly: "ebook of your choice"
  ...
  employers:
    ...
    everyone_looking_blurb: "忘了那20%的 LinkedIn InMain 回复率。每一个被我们列入这个站点的人希望找到他们的下一个位置以及将会回应你要求自我介绍的请求。"
    ...
    cost: "我们的收费多少？"
    cost_blurb: "我们只收取第一年薪资的15%并在前90天提供100%退款保障。我们不会对那些已经活跃于你公司进行面试的应征者收费。"
    candidate_name: "姓名"
