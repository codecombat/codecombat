module.exports = nativeDescription: "简体中文", englishDescription: "Chinese (Simplified)", translation:
  ...
  new_home:
    built_for_teachers_title: "一个由教师构建的编程游戏"
    built_for_teachers_blurb: "教孩子们编写代码往往会让人感到压力。CodeCombat帮助所有教育工作者教授学生如何用JavaScript或Python编写两种最流行的编程语言。通过包含六个计算机科学单元的综合课程、基于项目的游戏开发和Web开发单元来加强学习，孩子们将在从基本语法到递归的旅程中前进！"
    built_for_teachers_subtitle1: "计算机科学"
    built_for_teachers_subblurb1: "从我们免费的计算机科学入门课程开始，学生掌握核心编程概念，例如while / for循环、函数和算法。"
    built_for_teachers_subtitle2: "游戏开发"
    built_for_teachers_subblurb2: "学习构建迷宫并使用基本的输入处理来编写可以与朋友和家人共享的游戏。"
    built_for_teachers_subtitle3: "Web开发"
    built_for_teachers_subblurb3: "使用HTML、CSS和jQuery，学习者可以利用自定义URL编写自己的网页，与同学分享。"
    century_skills_title: "21世纪技能"
    century_skills_blurb1: "除了升级英雄，同时也提升自己"
    century_skills_quote1: "你陷入困境......所以你想找所有可能的方法来解决它，然后再试一次，直到完成。如果不努力，我和咸鱼有什么分别。"
    century_skills_subtitle1: "批判性思维"
    century_skills_subblurb1: "随着编程难度逐渐的增加会遇到越来越具有挑战性的关卡，CodeCombat的编程游戏确保孩子们总是在练习批判性思维。"
    century_skills_quote2: "其他人都在制造迷宫，所以我想'夺旗'，挑战他们的关卡，这就是我所做的。"
    century_skills_subtitle2: "创造力"
    century_skills_subblurb2: "CodeCombat鼓励学生分享自己设计的游戏与网页来展示他们的创造力。"
    century_skills_quote3: "如果我陷入困境了，我会和周围的人一起讨论，直到我们都能搞清楚。"
    century_skills_subtitle3: "协作"
    century_skills_subblurb3: "在整个游戏过程中，学生们有机会在遇到问题时进行协作，并使用我们的配对编程指南一起合作解决。"
    century_skills_quote4: "我一直有设计视频游戏和学习如何编程的愿望......这给了我一个很好的起点。"
    century_skills_subtitle4: "沟通"
    century_skills_subblurb4: "编程要求孩子们练习新的沟通方式，包括与计算机本身通信，并使用最有效的代码传达他们的想法。"
    classroom_in_box_title: "我们努力："
    classroom_in_box_blurb1: "让每个学生都参与进来，让他们相信学习编程是为了他们自己。"
    classroom_in_box_blurb2: "赋予任何教育工作者在教授编程时强大的信心。"
    classroom_in_box_blurb3: "激励所有学校领导者创建世界一流的计算机科学课程。"
    creativity_rigor_title: "创造力与严谨的结合"
    creativity_rigor_subtitle1: "打破次元墙，游戏技能具现化"
    creativity_rigor_blurb1: "鼓励学生在玩游戏时键入真正的Python和JavaScript来试错探索，培养批判性思维和创新精神。然后学生在基于项目的课程中运用学到的编程技能开发自己的游戏和网站。"
    creativity_rigor_subtitle2: "成功始于心动，成于行动"
    creativity_rigor_blurb2: "每个CodeCombat关卡都基于数百万的大数据进行搭建，并针对每个学习者进行了优化。练习关卡的提示可以在学生遇到困难时提供帮助，挑战关卡可以评估学生在整个游戏过程中的学习情况。"
    creativity_rigor_subtitle3: "轻松教学，无需经验"
    creativity_rigor_blurb3: "CodeCombat的自定进度，标准一致的课程使计算机科学教学成为可能。CodeCombat为教师提供培训、教学资源和专门支持，让他们在课堂上充满自信和成功。"
    featured_partners_title1: "精选"
    featured_partners_title2: "奖项&合作伙伴"
    featured_partners_blurb1: "CollegeBoard认可的提供者"
    featured_partners_blurb2: "学生最佳创意工具"
    featured_partners_blurb3: "学习的首选"
    featured_partners_blurb4: "Code.org官方合作伙伴"
    featured_partners_blurb5: "CSforAll官方会员"
    featured_partners_blurb6: "Hour of Code合作伙伴"
    for_leaders_title: "学校领导"
    for_leaders_blurb: "一个全面的、标准一致的计算机科学程序"
    for_leaders_subtitle1: "轻松实施"
    for_leaders_subblurb1: "基于网络的程序，无需IT支持。使用Google或Clever Single Sign-On（SSO）在5分钟内开始使用。"
    for_leaders_subtitle2: "完整编程课程"
    for_leaders_subblurb2: "标准化的课程，包括教学资源和专业发展，使任何教师都可以教授计算机科学。"
    for_leaders_subtitle3: "灵活用例"
    for_leaders_subblurb3: "无论您是想建立一所中学编程选修课程、CTE课程、还是AP计算机科学原理课程，CodeCombat都是根据您的需求量身定制的。"
    for_leaders_subtitle4: "真实世界技能"
    for_leaders_subblurb4: "学生通过编程挑战为他们准备500K +开放式计算工作，从而建立勇气并培养成长思维。"
    for_teachers_title: "教师"
    for_teachers_blurb: "解锁学生潜力的工具"
    for_teachers_subtitle1: "基于项目的学习"
    for_teachers_subblurb1: "促进学生开发自己的游戏和网页的基于项目的课程的创造力，解决问题和信心。"
    for_teachers_subtitle2: "教师仪表盘"
    for_teachers_subblurb2: "查看学生进度数据，发现课程资源，并获得实时支持，以增强学生的学习能力"
    for_teachers_subtitle3: "内置评估"
    for_teachers_subblurb3: "个性化教学，确保学生通过形成性和总结性评估来理解核心概念。"
    for_teachers_subtitle4: "自动分化"
    for_teachers_subblurb4: "让所有学习者参与多元化的课堂，练习水平适应每个学生的学习需求。"
    game_based_blurb: "CodeCombat是基于游戏的计算机科学课程，学生通过输入真实代码来看到他们的角色实时反应。"
    get_started: "开始吧"
    global_title: "加入我们的全球学习者和教育者社区"
    global_subtitle1: "学习者"
    global_subtitle2: "代码行"
    global_subtitle3: "教师"
    global_subtitle4: "国家"
    go_to_my_classes: "去我的班级"
    go_to_my_courses: "去我的课程"
    quotes_quote1: "我尝试过所有的在线教学程序，它们都没法与CodeCombat相提并论。对任何希望学生学习如何编程的教师......建议从这里开始！"
    quotes_quote2: " 我对CodeCombat学习计算机科学如此简单直接而感到惊讶。AP考试的分数远高于我的预期，我相信CodeCombat就是这种情况的原因。"
    quotes_quote3: "CodeCombat对于教我的学生真实编程能力是最有益的。我的丈夫是一名软件工程师，他已经测试了我所有的程序。然后他把这作为他的首选。"
    quotes_quote4: "反馈......非常积极，我们正在基于CodeCombat组织一个计算机科学课程。该项目真正让学生们参与到一个有趣的游戏式教学平台中。继续努力，CodeCombat ！"
    see_example: "查看示例"
    slogan: "最引人入胜的编程游戏。" # {change}
    teach_cs1_free: "学习<strong>计算机科学入门</strong>免费"
    teachers_love_codecombat_title: "教师们爱CodeCombat"
    teachers_love_codecombat_blurb1: "反馈他们的学生喜欢用CodeCombat来学习编程"
    teachers_love_codecombat_blurb2: "会向其他计算机科学教师推荐CodeCombat"
    teachers_love_codecombat_blurb3: "说CodeCombat帮助他们支持学生解决问题的能力"
    teachers_love_codecombat_subblurb: "与McREL International合作, 领导教育技术研究指导和评估。"
    try_the_game: "试试这个游戏"
  ...
  play:
    ...
    anon_signup_title_2: "教学版!"
    anon_signup_enter_code: "输入班级码:"
    anon_signup_ask_teacher: "没有? 问你的教师!"
    anon_signup_create_class: "想要创建班级?"
    anon_signup_setup_class: "创建一个班级, 添加学生, 然后监控学习进度!"
    anon_signup_create_teacher: "创建免费教师账号"
  ...
  signup:
    ...
    confirm_student_blurb: "记下信息避免忘记。你的教师也可随时帮你重置密码。"
    ...
    eu_confirmation_student: "如果你确定，询问你的教师"
...
#    videos: "Videos"
    ...
    tip_solve_then_write: "要先想清楚问题如何解决, 再进行编程的动作. - John Johnson"
...
#    wallOfDarkness_description: "Hide behind a wall of shadows to prevent the gaze of prying eyes."
  ...
  premium_features:
    ...
    hero_blurb_2: "高级战士可解锁惊人的武术技能，如Warcry、Stomp和Hurl Enemy。 或者玩游侠，使用隐形和弓箭、飞刀、陷阱！尝试用你的技能作为一个真正的编程教学，释放一个强大的原力、死灵或元素魔法阵列！"
  ...
  special_offer:
    ...
    great_for_clubs_description: "教师可以购买多达 __maxQuantityStarterLicenses__ 个学生入门许可证."
    ...
    license_limit_description: "教师最多可以购买 __maxQuantityStarterLicenses__ 个许可证. 你已经购买了 __quantityAlreadyPurchased__ 个. 如果你需要更多, 请联系 __supportEmail__. 学生入门许可证有效期为 __starterLicenseLengthMonths__ 个月."
...
#    hoc_blurb3: "activity! Construct four different minigames to learn the basics of game development, then make your own!"
    solutions_require_licenses: "拥有许可证的教师才可以激活关卡解决方案."
    unnamed_class: "班级未命名"
...
#    view_videos: "view videos"
    ...
    join_class: "加入班级"
    join_class_2: "加入班级"
    ask_teacher_for_code: "从你的教师那里领取CodeCombat班级代码！领取后请在下方输入："
    enter_c_code: "<输入班级代码>"
    join: "加入"
    joining: "加入课程中"
...
#    solution_project_blurb: "Students are encouraged to build a creative project in this level. Please refer to curriculum guides in the Resource Hub for information on how to evaluate these projects."
    ...
    teacher_account_explanation: "教师账号可以让你设立教室，当学生们学完课程后可以查看他们的进度，管理许可证以及查看相应的帮助文档以辅助构建课堂。"
...
#    revoke_confirm: "Are you sure you want to revoke a Full License from {{student_name}}? The license will become available to assign to another student."
    ...
    teacher_quest_teach_strings_step2: "使用 [课程指导](/teachers/courses) 页面上的教师关卡选择器预览 __True Names__"
...
#    sync_google_classroom: "Sync Google Classroom"
  ...
  share_licenses:
    ...
    shared_by: "分享自："
    add_teacher_label: "请准确地输入教师的邮箱："
    add_teacher_button: "添加教师"
...
#    footer: "When teachers revoke licenses from students, the licenses will be returned to the shared pool for other teachers in this group to use."
  ...
  sharing:
    game: "游戏"
    webpage: "网页"
    your_students_preview: "您的学生可以点击这里查看他们的完成项目，在教师预览中不可用。"
    ...
    copy_url: "复制 URL"
    share_with_teacher_email: "发送给你的教师"
  ...
  contribute:
    ...
    archmage_subscribe_desc: "通过电子邮件获得新的编程机会和公告。"
...
#    notify_teacher: "Notify Teacher"
    create_teacher_account: "创建免费的教师账号"
    enter_student_name: "你的名字:"
    enter_teacher_email: "你的教师的电子邮箱:"
...
#    dive_intro: "Computer science skills have a wide range of applications. Take a look at a few examples below!"
    ...
    dive_3_par2: "。我们与教师密切合作，设计和开发我们的内容，我们等不及让你的孩子学习。像CodeCombat这样的教育技术项目最好是由教师持续执行。帮助我们通过介绍您孩子的教师来建立这种联系!"
    mission: "我们的任务是教学和提高"
    ...
    mission2_copy: "2016年的一项调查显示，64%的3-5年级女生想学习编程。2015年需要的编程技能岗位有700万个。我们创建CodeCombat游戏是因为每个孩子都应该有机会去创造他们最好的未来。"
  ...
  parent_modal:
    ...
    name: "你的名字"
    parent_email: "你的邮箱"
    teacher_email: "你的教师的邮箱"
    message: "消息"
    custom_message: "我刚刚找到了CodeCombat，我想它对你的教室来说是个很棒的程序!它是一个符合标准课程的计算机科学学习平台。计算机知识是非常重要的，我认为这将是一个让学生学习编程的好方法。"
    send: "发送邮件"
