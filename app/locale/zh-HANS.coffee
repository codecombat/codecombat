module.exports = nativeDescription: "简体中文", englishDescription: "Chinese (Simplified)", translation:
  ...
  new_home:
    ...
    top_banner_blurb: "家长们，免费预约孩子的第一次在线直播编码课吧！"
    try_the_game: "免费试玩"
  ...
  about:
    ...
    matt_title: "联合创始人、CTO"
    lawrence_title: "客户成功经理"
    jane_title: "客户经理"
...
#    course_suffix: ""
  ...
  teacher:
    ...
    appreciation_week_blurb1: "2019年<strong>教师感谢周</strong>，我们提供免费的 1 周授权！<br />给 Rob Arevalo 发邮件（<a href=\"mailto:robarev@codecombat.com?subject=Teacher Appreciation Week\">robarev@codecombat.com</a>），主题为<strong>教师感谢周</strong>，并包含："
    appreciation_week_blurb2: "你想要的 1 周许可证的数量（每个学生 1 个）。"
    appreciation_week_blurb3: "您的 CodeCombat 教师账户电子邮件地址。"
    appreciation_week_blurb4: "您是想要第一周（5月6 - 10日）还是第二周（5月13 - 17日）的许可证？"
