module.exports = nativeDescription: "简体中文", englishDescription: "Chinese (Simplified)", translation:
  ...
  play_level:
    ...
    victory_bloc_cta: "遇见你的导师 – 了解 Bloc"
    guide_title: "指南"
  ...
  subscribe:
    ...
    parents_blurb1: "您的孩子已经玩了 __nLevels__ 关并且学习了编程基础. 请您为了培养他们的兴趣而给他们订阅, 他们能继续玩下去."
    parents_blurb1a: "不用怀疑计算机编程能力将是您的孩子作为一个成年人的基本技能。到2020年，77%的工作将会需要编码能力，并且软件工程师将在世界各地成为高需求职业。您知道计算机科学是收入最高的大学学位吗？"
    ...
    sale_blurb1: "包年订阅能节省 35%"
    sale_blurb2: "（和包月订阅价格 $120 相比）!"
    sale_button: "促销!"
    sale_button_title: "包年订阅能节省 35% 的费用"
    sale_click_here: "点击这里"
    sale_ends: "结束"
    sale_extended: "*已订阅用户会续期一年."
    sale_feature_here: "你将会获得这些:"
    sale_feature2: "可以使用 9 个强大的 <strong>新英雄</strong> 和各种技能!"
    sale_feature4: "立即取得 <strong>42,000 个额外的宝石</strong>!"
    sale_continue: "准备好继续探险吗?"
    sale_limited_time: "限时优惠!"
    sale_new_heroes: "新英雄!"
    sale_title: "开学促销"
    sale_view_button: "购买包年订阅："
    stripe_description: "每月订阅"
    stripe_description_year_sale: "包年订阅 (优惠 35%)"
  ...
  options:
    ...
    editor_config_default_language_description: "在开始新游戏前确认您要在这个等级的游戏中使用的编程语言。"
  ...
  teachers:
    ...
    intro_2: "无需经验!"
    free_title: "要多少钱?"
    cost_china: "CodeCombat的前5个关卡在中国是免费的，在这之后需花费每月9.99美元来访问我们架设在中国专属服务器上的180多个关卡。"
