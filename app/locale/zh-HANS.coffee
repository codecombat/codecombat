...
#    solve_then_write: "First, solve the problem. Then, write the code. - John Johnson"
  ...
  courses:
    ...
    visit_pref: "请到这个"
    visit_suf: "网页注册。"
    select_class: "请选其中一门课堂"
    unnamed: "*未命名*"
    select: "选择"
    unnamed_class: "课堂未命名"
    edit_settings: "编辑课堂设定"
    edit_settings1: "编辑课堂设定"
    progress: "课堂进度"
    add_students: "添加学生"
    stats: "统计"
    total_students: "学生人数："
    ...
    play_time: "游戏时间："
    completed: "完成："
    invite_students: "邀请学生加入此课堂。"
    invite_link_header: "参与课堂的縺结"
    invite_link_p_1: "把这个参与课堂的连结发给你的学生。" #this translation may need to change
    ...
    all_lang: "所有编程语言"
    show_progress: "向所有该课堂的人展示学生的进度" # translation may need to change
    creating_class: "课堂创建中..."
    ...
    enter_number_students: "输入该课堂的学生上限人数"
    name_class: "命名您的课堂"
    ...
    receive_code: "然后您会收到一个解锁码，把它分发给你的学生用来注册你的课堂。"
    free_trial: "老师可免费试用"
    ...
    answer1: "单人游戏是专为个人而设，而课程是专为课堂而设。"
