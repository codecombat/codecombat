...
#    teacher_vega_message: "Students are guided by these tutorial messages. In order to view these messages and to save your progress as you play through the game, please create a student account and play Ozaria as a student."
  ...
  login:
    ...
    sign_up: "注册"
    email_or_username: "邮箱或用户名" # {change}
    or: "或"
    log_in: "登录"
    sign_in: "登录"
    logging_in: "正在登录"
    ...
    finishing: "完成..."
    sign_in_with_facebook: "Facebook账号登录" # {change}
    sign_in_with_gplus: " Google+ 账号登录" # {change}
...
#    accounts_merge_confirmation: "There is an account associated with the email from this Google account. Would you like to merge these accounts?"
  ...
  signup:
    ...
    teacher_students_can_start_now: "学生准备就绪，开始计算机科学的授课吧！" # {change}
    ...
    teacher_list_resource_hub_2: "课程指南" # {change}
...
#    combo_not_all_concepts_used: "You used __complete__ out of the __total__ concepts possible to solve the challenge. Try to get all __total__ concepts next time!"
    ...
    reload_confirm: "重载所有"
    restart_really: "确定要重新开始？你会失去本关你写的所有代码"
    restart_confirm: "是的，重新开始"
    test_level: "测试关卡"
    victory: "胜利"
...
#    description_coming_soon: "Description coming soon"
  ...
  options:
    ...
    editor_config_title: "编辑器配置" # {change}
    editor_config_livecompletion_label: "实时代码补全" # {change}
    ...
    editor_config_behaviors_label: "智能匹配符号" # {change}
...
#    meta_description: "Our mission is to level computer science through game-based learning and make coding accessible to every learner. We believe programming is magic and want learners to be empowered to to create things from pure imagination."
    ...
    story_link: "历程"
    press_link: "联系方式"
    mission_title: "我们的愿景：让世上每个学生都有机会接触编程" # {change}
    mission_teach: "通过冒险故事进行教学"
    mission_desc_1: "在今天的世界里，孩子们被各种各样交互式娱乐平台所淹没，这也让他们变得更加投入。每一个和儿童相关的应用程序、视频、游戏及广告的开发目的是为了吸引和保持他们的注意力。在这种环境下，一个教育平台如果要取得成功，需要找到有效的方法保持孩子们关注度和激发他们创造性。"
    mission_desc_2: "我们坚信计算机科学学习可以变得生动有趣。编程应该像魔术一样富有魔力。程序设计应该赋能每一个孩子探索新的想法，他们可以根据想象力创造属于他们的世界，可以用全新的方法重新定义人们之间的交互。我们的目标是通过创造富有创造力和想象力的编程游戏，激发计算机科学本身固有的创造力和想象力。"
    mission_desc_3: "在过去的五年中，全球有超过1200万学习者通过我们的CodeCombat平台学习Python和JavaScript编程设计，CodeCombat已经成为编程教育历史上最受欢迎的编程游戏之一。"
...
#    retrostyle_blurb: "RetroStyle Games"
    ...
    story_statistic_1c: "已经通过CodeCombat开始了他们的编程之旅" # {change}
    ...
    jobs_title: "和我们一起工作，一起书写 CodeCombat 的历史！" # {change}
...
#    referrer_conference: "Conference (e.g. ISTE)"
    ...
    thanks_header: "申请已发送！"
    thanks_sub_header: "感谢您为您的学校表达对 CodeCombat 的兴趣。" # {change}
...
#    hoc_blurb3: "activity! Construct four different minigames to learn the basics of game development, then make your own!"
    ...
    back_classroom: "返回班级" # {change}
    back_courses: "回到我的课程" # {change}
    edit_details: "编辑课程详情"
    ...
    join_class: "加入班级" # {change}
    join_class_2: "加入班级"
    ask_teacher_for_code: "从你的老师那里领取CodeCombat班级代码！领取后请在下方输入：" # {change}
    enter_c_code: "<输入班级代码>" # {change}
    join: "加入"
    joining: "加入课程中"
    unit_complete: "已完成"
    play_arena: "玩竞技场"
    ...
    license_will_revoke: "该学生付费许可将被撤销，稍后可以分配给其他学生"
    keep_student: "保留学生"
    removing_user: "删除用户"
    ...
    license_required_to_play: "询问你的老师来注册一个许可证，之后你可以继续玩CodeCombat游戏！" # {change}
...
#    feedback_capstone: "The student will create a base project in Part 1. They will make creative updates based on peer feedback in Part 2. Here is a <a target=\"_blank\" rel=\"noopener\" href=\"https://docs.google.com/document/d/1itB0vY6WphjINQYJ9NHkILATcLLlYD3GDSg6FJg55OQ\">Peer Feedback Template</a> that you can share with your students."
    ...
    create_teacher_account: "创建老师账号" # {change}
...
#    concept_checked: "Concept checked:"
    ...
    assign_course: "分配课程" # {change}
#    removed_course_msg: "{{numberRemoved}} students were removed from {{courseName}}."
    remove_course: "移除课程" # {change}
    not_assigned_modal_title: "课程未分配" # {change}
...
#    not_assigned_modal_starter_body_2: "Purchase Starter Licenses to grant access to this course."
    not_assigned_modal_full_body_1: "本课程需要许可证才能使用。您没有足够的许可证, 因此无法将此课程分配给已选定的 __selected__ 名学生。" # {change}
    ...
    enrollments_blurb: "每个学生需要一个许可，以便在第一课程后访问后续内容。" # {change}
    ...
    how_to_apply_licenses_blurb_1: "当老师第一次将课程分配给学生时，我们将自动应用许可证。使用教室中的批量分配下拉菜单为所选学生分配课程:" # {change}
    how_to_apply_licenses_blurb_2: "我可以只申请许可而不分配课程吗?" # {change}
    ...
    getting_started: "入门"
    educator_faq: "常见问题"
    educator_faq_desc: "在您的学校或教室使用 CodeCombat 的常见问题。" # {change}
    teacher_getting_started: "老师入门指南"
    teacher_getting_started_desc: "第一次使用 CodeCombat ？下载此老师入门指南开始设置您的账号，创建第一个课堂并邀请学生参加第一门课程。" # {change}
...
#    revoke_confirm: "Are you sure you want to revoke a Full License from {{student_name}}? The license will become available to assign to another student."
    ...
    teacher_quest_teach_strings_step2: "使用 [课程指导](/teachers/courses) 页面上的老师关卡选择器预览 __True Names__" # {change}
