...
#    speed_1: "Moves at"
  ...
  about:
    ...
    why_paragraph_2_suffix: "这就是为什么CodeCombat是个多人游戏，而不是一个游戏化的编程课。你不停，我们就不停——但这次这是件好事。"
...
#    more_info_3: "is a good place to connect with fellow educators who are using CodeCombat."
  ...
  contact:
    ...
    recruitment_reminder: "用这张表格来联系你希望面试的求职者。但请记住如果你雇佣了他，CodeCombat会收取这位员工第一年工资的15%作为佣金。佣金需在雇佣此员工时就付清并且在之后的90天内如果此员工离职会100%退款。兼职，远程办公员工，合同工以及实习生都可免除此费用。" # Deprecated
...
#    priority: "Priority"
  ...
  contribute:
    ...
    diplomat_introduction_suf: "中得到了什么启发：那就是全世界的人都对很喜欢CodeCombat。我们召集了一群翻译者，希望能尽快地把网站上的信息翻译成各国文字。如果你对CodeCombat的内容很感兴趣，想让世界上的每一个人都有机会一同体验，就快来成为外交官吧。"
    ...
    ambassador_introduction: "这是一个正在成长的社区，而你将成为我们与世界的联结点。大家可以通过各种即时聊天平台、邮件、或是参与者众多的社交网络来认识及讨论我们的游戏。如果你喜欢帮助大家，一起参与各类项目，一起获得乐趣。与我们同行，一起感受CodeCombat的脉搏，绝对是一个适合你的职业。"
...
#    hero: "Hero"
  ...
  legal:
    ...
    opensource_description_center: "并做你想做的修改吧！CodeCombat是构筑在几十个开源项目之上的，然后我们都喜欢它们。看 "
    ...
    use_list_2: "如果用在网站上，将链接在使用的地方附近，比如图片下面，或者一个你放置其他 Creative Commons 署名和开源软件协议的专门页面。如果你的内容明确提到关于CodeCombat，那你就不需要额外署名。"
    art_paragraph_2: "如果你使用的内容不是由CodeCombat制作，而是由CodeCombat.com 上其他的用户制作的，那你应该给他们署名。如果相应资源的页面上有署名指示，那你应该遵循那些指示。"
    rights_title: "版权所有"
  ...
  account_profile:
    ...
    links_header: "个人网站链接"
    links_blurb: "链接任何你希望展示的网站或介绍，例如你的Github，你的LinkedIn，或是你的博客。"
    links_name: "链接名称"
