module.exports = nativeDescription: "简体中文", englishDescription: "Chinese (Simplified)", translation:
  ...
  nav:
    ...
    support: "支持"
    faqs: "常见问题"
    copyright_prefix: "版权所有"
    copyright_suffix: "本网站保留一切权利"
  ...
  play:
    ...
    get_course_for_class: "将游戏开发分享给你的同学们吧！"
    request_licenses: "联系学校的专家老师来获得更多信息"
    ...
    teacher_button: "教师按钮"
    get_more_codecombat: "获得更多DataCombat游戏的信息"
  ...
  signup:
    ...
    sign_in_to_continue: "登录或注册一个账号继续游戏"
    teacher_email_announcements: "让我不断更新教师资源和课程资源"
    creating: "账户创建中……"
    sign_up: "注册"
    log_in: "登录"
    ...
    finish: "完成"
    teacher_ready_to_create_class: "你已经准备好创建第一个班级"
    teacher_students_can_start_now: "你的学生已经可以开始第一堂课, 立即介绍计算机科学的相关知识吧"
    teacher_list_create_class: "在下一个界面中你可以创建一个新的班级"
    teacher_list_add_students: "通过点击“view class”链接来增加你的学生,然后你可以将URL或者班级代码发送给学生。如果他们有电子邮箱，你也可以通过电子邮箱邀请他们加入。"
    teacher_list_resource_hub_1: "退出"
    teacher_list_resource_hub_2: "课程指南"
    teacher_list_resource_hub_3: "关卡答疑"
    teacher_list_resource_hub_4: "资源库"
    teacher_list_resource_hub_5: "更多课程指南和活动的信息"
    ...
    want_codecombat_in_school: "你想一直玩CodeCombat编程游戏吗？"
...
#    combo_not_all_concepts_used: "You used __complete__ out of the __total__ concepts possible to solve the challenge. Try to get all __total__ concepts next time!"
    ...
    goals: "目标"
    goal: "目标"
    challenge_level_goals: "挑战关卡目标" #challenge_level_goals: "Challenge Level Goals"
...
#    combo_challenge_goal: "Challenge Level Goal"
    ...
    loading_start: "开始"
    loading_start_combo: "开始combo编程的挑战" #loading_start_combo: "Start Combo Challenge"
    loading_start_concept: "开始概念上的挑战" #loading_start_concept: "Start Concept Challenge"
    ...
    project_complete: "项目已经完成"
    share_this_project: "把你的项目分享给你的朋友或者家人"
    ready_to_share: "发布项目准备好了吗？"
...
#    score_display: "__scoreType__: __score__"
  ...
  earn_gems:
    prompt_title: "没有足够的宝石" #    prompt_title: "Not Enough Gems"
    prompt_body: "继续玩游戏可以获得更多宝石" #    prompt_body: "Keep playing to earn more!"
...
#    premium_already_subscribed: "You're already subscribed to Premium!"
  ...
  announcement:
    now_available: "现在可供用户使用"
    subscriber: "用户"
    cuddly_companions: "可爱的伙伴" # Pet Announcement Modal
    kindling_name: "点亮自然元素"
    kindling_description: "点亮自然元素仅仅想要让你白天和晚上保持温暖。真的，整天都会保持温暖！"
    griffin_name: "小格里芬（传说中的狮身鹰首兽）"
    griffin_description: "格里芬受人崇拜，具有狮子的身体和老鹰的头部"
    raven_name: "渡鸦（乌鸦的亲属）"
    raven_description: "渡鸦擅长帮你搜集充满健康的闪亮的瓶子。"
    mimic_name: "变种人"
    mimic_description: "变种人可以帮你搜集金币。把他们移动到金币上会增加你的金币。"
    cougar_name: "美洲狮"
    cougar_description: "美洲狮通过天天打呼噜获得一个博士学位"
    fox_name: "蓝狐"
    fox_description: "蓝狐很聪明，它喜欢在泥土和雪中挖掘。"
    pugicorn_name: "普吉哥"
    pugicorn_description: "普吉哥是一种稀有的生物，可以修炼法术！"
#    wolf_name: "Wolf Pup"
...
#    ritic_description: "Ritic the Cold. Trapped in Kelvintaph Glacier for countless ages, finally free and ready to tend to the ogres that imprisoned him."
    ice_block: "一块冰"
    ice_description: "似乎有什么东西被困在里面"
    blink_name: "眨眼"
    blink_description: "摩擦声在眨眼间消失，又重新出现，只留下一个影子。"
    shadowStep_name: "暗影步"
    shadowStep_description: "一个大师级刺客知道怎样在影子之间行走"
...
#    course_suffix: ""
  ...
  teachers_quote:
    ...
    college_plus: "大学以上"
    referrer: "您是怎么知道我们的？"
    referrer_help: "举个例子，从其他的老师，或者一个会议，或者你的学生，或者Code.org机构等等获取信息。"
  ...
  courses:
    ...
    solutions_require_licenses: "级别解决方案可供有许可证的教师使用。"
    unnamed_class: "班级未命名"
    edit_settings1: "编辑班级设定"
    add_students: "添加学生"
    stats: "统计"
    student_email_invite_blurb: "当创建一个学生账户，你的学生不必准备电子邮件，也可以使用班级代码<strong>classCode</strong>创建账户。"
    total_students: "学生人数："
    average_time: "平均游戏时间："
    total_time: "总计游戏时间："
...
#    gd1: "游戏开发 1"
#    gd1_guide: "游戏开发 1 - Project Guide"
#    gd1_guide_desc: "Use this to guide your students as they create their first shareable game project in 5 days."
#    gd1_rubric: "游戏开发 1 - Project Rubric"
#    gd1_rubric_desc: "Use this rubric to assess student projects at the end of 游戏开发 1."
#    gd2: "游戏开发 2"
#    gd2_curriculum: "游戏开发 2 - Curriculum Guide"
#    gd2_curriculum_desc: "Lesson plans for 游戏开发 2."
#    gd3: "游戏开发 3"
#    gd3_curriculum: "游戏开发 3 - Curriculum Guide"
#    gd3_curriculum_desc: "Lesson plans for 游戏开发 3."
...
#    unsubscribe_success: "Success"
  ...
  concepts:
    ...
    algorithm_average: "求平均值"
    algorithm_find_minmax: "计求最小值和最大值"
    algorithm_search_binary: "二进制算法查询"
    algorithm_search_graph: "绘图算法查询"
    algorithm_sort: "排序"
    algorithm_sum: "求和"
    arguments: "参数"
    arithmetic: "四则运算"
    array_2d: "二维数组"
    array_index: "数组下标"
    array_iterating: "循环遍历数组"
    array_literals: "数组字面量"
    array_searching: "数组中寻找"
    array_sorting: "数组排序"
    arrays: "数组"
    basic_css_rules: "基本CSS规则"
    basic_css_selectors: "基本CSS选择器"
    basic_html_attributes: "基本HTML属性"
    basic_html_tags: "基本HTML标签"
    basic_syntax: "基本语法"
    binary: "二进制"
    boolean_and: "求和（布尔运算中）"
    boolean_inequality: "不等于（布尔运算中）"
    boolean_equality: "相等（布尔运算）"
    boolean_greater_less: "大于/小于（布尔运算中）"
    boolean_logic_shortcircuit: "逻辑短路（布尔运算中）"
    boolean_not: "非（布尔运算中）"
    boolean_operator_precedence: "运算符优先级（布尔运算中）"
    boolean_or: "或者（布尔运算中）"
    boolean_with_xycoordinates: "坐标比较（布尔运算中）"
...
#    for_loops_range: "For Loops Range"
    functions: "函数"
    functions_parameters: "函数参数"
    functions_multiple_parameters: "多个函数参数"
    game_ai: "游戏AI"
    game_goals: "游戏目标"
...
#    stacks: "Data Structures - Stacks"
    strings: "字符串"
    strings_concatenation: "字符串串联"
    strings_substrings: "子字符串"
    trees: "数据树结构"
    variables: "变量"
    vectors: "向量"
    while_condition_loops: "包含坐标的while循环结构"
    while_loops_simple: "While循环结构"
    while_loops_nested: "嵌套循环结构"
    xy_coordinates: "笛卡尔坐标系（直角坐标系和斜坐标系总称）"
  ...
  anonymous_teacher:
    notify_teacher: "教师公告" #this section will allow teachers to create a free account
    create_teacher_account: "创建免费的教师账号"
    enter_student_name: "请输入你的学生的名字"
    enter_teacher_email: "请输入教师的邮箱"
    teacher_email_placeholder: "邮箱格式：teacher.email@example.com"
    student_name_placeholder: "请在此输入学生的名字"
    teachers_section: "教师"
    students_section: "学生"
    teacher_notified: "我们将会将你想要在教室中玩codecombat游戏的消息告诉你的老师"
...
# code_play_create_account_modal:#This section is only needed in US, UK, Mexico, India, and Germany
...
#    victory_sign_up: "Sign up & be entered to <strong>win $2,500</strong>"
  ...
  server_error: #server return error information
    email_taken: "该邮箱已经被注册，请更换邮箱"
    username_taken: "该用户名已经被使用，请更换用户名"

  esper:
    line_no: "第$1行: "
    uncaught: "未捕获$1" # $1 will be an error type, eg "Uncaught SyntaxError"
...
#    py_empty_block: "Empty $1. Put 4 spaces in front of statements inside the $2 statement."
    ...
    missing_semicolon: "语句缺失分号。"
    missing_quotes: "语句缺少引号。你可以使用`$1`的格式"
#    argument_type: "`$1`'s argument `$2` should have type `$3`, but got `$4`: `$5`."
#    argument_type2: "`$1`'s argument `$2` should have type `$3`, but got `$4`."
    target_a_unit: "目标单位"
    attack_capitalization: "攻击$1而不是$2。(请注意，大写字母非常重要)"
    empty_while: "这是一个空语句。在while循环结构中，你需要在语句前放置4个空格。"
#    line_of_site: "`$1`'s argument `$2` has a problem. Is there an enemy within your line-of-sight yet?"
    need_a_after_while: "在`$2`后需要加入`$1`。"
    too_much_indentation: "这行语句开头缩进太多"
