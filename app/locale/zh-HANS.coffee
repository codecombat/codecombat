...
#    ranking_completed_leves: "Completed levels"
    ...
    create_classroom_manually: "手动创建教室"
    classes: "班级"
...
#    subheader: "You can make your licenses available to other teachers in your organization. Each license can only be used for one student at a time."
    ...
    teacher_not_valid: "这不是一个有效的教师账户，室友教师账户可以分享许可证。"
    already_shared: "你已经把这些许可证分享给你教师了。"
...
#    unsubscribe_button: "Yes, unsubscribe"
  ...
  concepts:
    ...
    algorithm_average: "求平均值算法"
    algorithm_find_minmax: "求最大最小值算法"
    algorithm_search_binary: "二进制寻找算法"
    algorithm_search_graph: "寻找图算法"
    algorithm_sort: "排序算法"
    algorithm_sum: "求和算法"
    arguments: "参数"
    arithmetic: "四则运算"
...
#    xy_coordinates: "Coordinate Pairs"
  ...
  anonymous_teacher:
    ...
    teachers_section: "老师:"
    students_section: "学生:"
    teacher_notified: "我们已经把你想要在课堂上玩更多的CodeCombat游戏，通知到你的老师。"
...
#    client_code_description_prefix: "All client-side code for codecombat.com in the public GitHub repository and in the codecombat.com database, is licensed under the"
    ...
    cookies_message: "CodeCombat使用一些必要的和非必要的cookies."
    cookies_deny: "减少不必要的cookies"
