...
#  teachers_quote:
    ...
    phone_number: "联系电话"
    phone_number_help: "我们在何时可以联系您？"
    role_label: "您的职务"
    role_help: "选择您主要的职务"
    tech_coordinator: "技术指导"
    advisor: "指导教授"
    principal: "校长"
    superintendent: "教育负责人"
    parent: "家长"
    organization_label: "学校名称或地区"
    city: "市"
    state: "州／省"
    country: "国家"
    num_students_help: "您期望有多少学生参与CodeCombat?"
    education_level_label: "学生受教育程度"
    education_level_help: "可多选"
    elementary_school: "小学"
    high_school: "初中"
    please_explain: "其它"
    middle_school: "高中"
    college_plus: "大学或以上"
    anything_else: "其它我们应该知道的？"
    thanks_header: "谢谢您的申请表"
    thanks_p: "我们将尽快联系您。有问题？我们的电子邮件："
    thanks_anon: "登陆您的账户，获取两个免费的名额（当您的申请被批准，我们将通过邮件通知您，这个过程通常不会超过48个小时）。通常，第一个小时的内容是免费的，不限学生数量。"
    thanks_logged_in: "您有两个免费名额有待批准。您的申请被批准，我们将通过邮件通知您（通常在48小时之内）。并且通常，第一个小时的内容是免费的，不限学生数量。"
