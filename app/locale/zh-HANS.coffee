module.exports = nativeDescription: "简体中文", englishDescription: "Chinese (Simplified)", translation:
  ...
  play:
    ...
    campaign_classic_algorithms_description: "你所学过的最经典的算法"
    level_difficulty: "难度："
    play_as: "玩家身份"
    spectate: "旁观他人的游戏"
    players: "玩家"
  ...
  contact:
    ...
    recruitment_reminder: "通过此表联系希望面试的获选人。提示CodeCombat将收取第一年工资的15%作为中介费。若面试者没有被录用，此费用将在90天内退换。兼职，远程和合同员工不在此列。"
...
#    not_featured: "Not Featured"
    ...
    next: "下一个"
    next_city: "城市？"
    next_country: "选择你所在的国家"
    next_name: "名字？"
    next_short_description: "简短的自我介绍"
    next_long_description: "理想职位"
    next_skills: "列举至少5个技能"
#    next_work: "chronicle your work history."
#    next_education: "recount your educational ordeals."
    next_projects: "描述3个曾经参加过的项目"
    next_links: "添加任何个人链接"
#    next_photo: "add an optional professional photo."
#    next_active: "mark yourself open to offers to show up in searches."
    example_blog: "博客"
    example_personal_site: "个人网站"
    links_header: "个人链接"
