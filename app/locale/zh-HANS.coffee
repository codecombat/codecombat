...
#    pet_blurb_1: "Pets aren't just adorable companions, they also provide unique functionality and methods. The Baby Griffon can carry units through the air, the Wolf Pup plays catch with enemy arrows, the Cougar is fond of chasing ogres around, and the Mimic attracts coins like a magnet!"
    ...
    list_clans: "创建私人宗门邀请你的朋友加入,并与其它宗门在排行榜上进行竞争"
...
#    referrer_help: "For example: from another teacher, a conference, your students, Code.org, etc."
  ...
  clans:
    ...
    clans: "宗门"
    new_name: "新宗门的名字"
    new_description: "新宗门的描述"
    make_private: "设定宗门为私人宗门"
    subs_only: "只限订阅"
    create_clan: "创建新的宗门"
    private_preview: "预览"
    private_clans: "私人宗门"
    ...
    name: "名字"
    chieftain: "首领"
    edit_clan_name: "编辑宗门的名字"
    edit_clan_description: "编辑宗门的描述"
    edit_name: "编辑名字"
    ...
    playtime: "游戏时间"
    last_played: "最后玩了"
    leagues_explanation: "在宗门里与其他成员组成联盟一起参加下面的多人竞技场。"
    ...
    track_concepts8: "来加入"
    private_require_sub: "创建或加入私人宗门时需要具体描述。"
...
#    license_remaining: "license remaining"
    licenses_remaining: "剩余许可"
    one_license_used: "1 个许可已被使用"
    num_licenses_used: "__numLicensesUsed__ 个许可已被使用"
...
#    push_projects: "We recommend assigning Web Development 1 or Game Development 1 after students have finished Introduction to Computer Science! See our {{resource_hub}} for more details on those courses."
    ...
    teacher_quest_create_classroom: "添加课堂"
    ...
    teacher_quest_teach_strings: "不要让你的学生跟着走, 教他们 `strings`."
...
#    more_info: "More info"
  ...
  ladder:
    ...
    simulation_explanation_leagues: "你会主要给在你的宗门或者课程的同伴帮忙模拟游戏。"
    simulate_games: "模拟游戏！"
  ...
  user:
    ...
    favorite_postfix: "。"
    not_member_of_clans: "还不是任何一个宗门里的成员。"
  ...
  account_prepaid:
    ...
    purchase_code4: "订阅码适用于玩独立版CodeCombat的帐户，不能代替“课堂”版本的学生许可."
