module.exports = nativeDescription: "简体中文", englishDescription: "Chinese (Simplified)", translation:
  ...
  account_settings:
    ...
    email_notifications_summary: "管理有关你在CodeCombat相关活动的定制的自动通知邮件。"
    email_any_notes: "任何通知"
    email_any_notes_description: "取消接收所有活动提醒邮件"
    email_recruit_notes: "工作机会"
    email_recruit_notes_description: "如果你玩的真的很不错，我们可能会联系你并给你提供一个（更好的）工作。"
    ...
    sample_profile: "查看工作经历样本"
    view_profile: "浏览个人信息"

  account_profile:
    edit_settings: "编辑设置"
    done_editing_settings: "完成编辑"
    ...
    next_skills: "列出至少5项技能。"
    next_work: "列出你的工作经历。"
    next_education: "描述一下你的教育经历。"
