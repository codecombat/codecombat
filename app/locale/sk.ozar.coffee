...
#    auth_sign_up: "New to Ozaria? Create an Account"
    sign_up: "Vytvor účet"
    email_or_username: "Email alebo uživateľské meno" # {change}
#    or: "or"
    log_in: "Prihlás sa"
#    sign_in: "Sign In"
    ...
    finishing: "Finišujem"
    sign_in_with_facebook: "Prihlás sa s Facebookom" # {change}
    sign_in_with_gplus: "Prihlás sa s G+" # {change}
...
#    login: "Login"
    ...
    signup_as_teacher: "Zaregistruj sa ako učiteľ" # {change}
    ...
    signup_as_student: "Zaregistruj sa ako študent" # {change}
...
#    confirm_student_blurb: "Write down your information so that you don't forget it. Your teacher can also help you reset your password at any time."
    ...
    write_this_down: "Napíš si na papier:" # {change}
...
#    description_coming_soon: "Description coming soon"
  ...
  options:
    ...
    editor_config_title: "Konfigurácia editora" # {change}
    editor_config_livecompletion_label: "Živé automatické dokončovanie" # {change}
    ...
    editor_config_behaviors_label: "Chytré správanie" # {change}
...
#    learn_more: "Learn More"
    ...
    story_link: "Príbeh"
    press_link: "Pre tlač"
    mission_title: "Náš cieľ: Sprístupnenie programovania pre všetkých." # {change}
...
#    mission_desc_3: "Over the last six years, over twenty million people have learned to write Python and JavaScript using CodeCombat, making it one of the most popular coding games in history. Now, we are excited to launch Ozaria and expand on our commitment to inspire a new generation of students to learn computer science. Ozaria is an adventure game that places each learner at the center of a legendary story where they must save the world of Ozaria from impending darkness by mastering the lost magic of coding. As the narrative unfolds, a powerful student-centered learning experience is created - each student’s investment in Ozaria’s story paralleling the investment they are making in their own learning journey."
    ...
    team_values: "Ceníme si otvorený a zdvorilý dialóg, v ktorom vyhrá najlepšia myšlienka. Naše rozhodnutia sú založené na prieskume užívateľov. Všetci sú zainteresovaní na výsledku, od výkonného riaditeľa až po prispievateľov na  GitHube." # {change}
...
#    vpm_title: "VP, Marketing"
    ...
    story_statistic_1c: "svoju programátorskú dráhu vďaka CodeCombatu." # {change}
    ...
    jobs_title: "Pridaj sa ku nám a začni aj ty písať históriu CodeCombatu!" # {change}
...
#    join_class_2: "Join class"
    ask_teacher_for_code: "Vypýtaj si od učiteľa triedny kód! Potom ho vlož nižšie:"
    enter_c_code: "<Vlož triedny kód>"
    join: "Pridaj sa"
