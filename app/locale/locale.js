...
Object.defineProperties(module.exports, {
  load: {
    ...
    value(langCode) {
      ...
      const promises = [
        new Promise((accept, reject) => require('bundle-loader?lazy&name=[name]!locale/'+langCode)(localeData => accept(localeData))).then(localeData => {
      ...
      if ((firstBit !== langCode) && (this[firstBit] != null)) {
        promises.push(new Promise((accept, reject) => require('bundle-loader?lazy&name=locale/[name]!locale/'+firstBit)(localeData => accept(localeData))).then(localeData => {
  ...
  installVueI18n: {
    ...
    value() {
      ...
      const VueI18Next = { install(Vue, options) {
  ...
  mapFallbackLanguages: {
    ...
    value() {
      ...
      for (var code in module.exports) {
        if (code !== 'en') {
          var fallbacks = [];
