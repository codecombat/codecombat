module.exports = {
  ...
  translation: {
    ...
    general: {
      ...
      hard: 'Δύσκολο',
      player: 'Παίκτης',
      player_rank: '[AI_TRANSLATION]Βαθμίδα',
      warrior: 'Πολεμιστής',
      ranger: 'Καταδρομέας',
      wizard: 'Μάγος',
      first_name: 'Όνομα',
    ...
    premium_features: {
      get_premium: 'Πάρε <br>CodeCombat<br> Προνομιακό',
    ...
    clans: {
      ...
      private: '(ιδιωτική)',
      summary: 'Περίληψη',
      average_rank: '[AI_TRANSLATION]Μέση βαθμίδα',
    ...
    achievements: {
      ...
      left_xp_prefix: '',
      left_xp_rank_infix: '[AI_TRANSLATION] μέχρι τη βαθμίδα ',
      left_xp_postfix: '',
    },
