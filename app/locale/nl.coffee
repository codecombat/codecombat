module.exports = nativeDescription: "Nederlands", englishDescription: "Dutch", translation:
  ...
  special_offer:
    special_offer: "Specialr Aanbieding"
  ...
  courses:
    ...
    update_account_teachers_can: "Leraar accounts kunnen:"
    update_account_teachers_can1: "Klassen maken/beheren/toevoegen"
    update_account_teachers_can2: "Studenten cursussen toewijzen/inschrijven"
    update_account_teachers_can3: "Unlock alle cursussen om ze uit te proberen"
    update_account_teachers_can4: "Krijg toegang tot nieuwe functies alleen voor leraren"
    update_account_teachers_warning: "Waarschuwing: Je wordt verwijderd uit alle klassen waar aan je hebt deelgenomen en je kan niet meer spelen als student."
    ...
    update_account_students_can: "Leerling accounts kunnen:"
    ...
    update_account_confirm_update_student: "Weet je zeker dat je je account wilt updaten naar Student?"
    ...
    youve_been_invited_2: ", waar je zal leren "
    youve_been_invited_3: " met je klasgenoten in CodeCombat."
    by_joining_1: "Door deel te nemen aan "
    by_joining_2: "kan je helpen je wachtwoord te herstellen als je het vergeet of kwijtraakt. Je kan ook je email adres bevestigen zodat je zelf je wachtwoord kan herstellen!"
    ...
    select_your_hero_description: "Je kunt op elk moment wisselen van held door naar je Cursussen pagina te gaan en op \"Verander Held\" te klikken"
  ...
  teacher:
    ...
    no_students_yet_view_class: "Bekijk klas om studenten toe te voegen."
    ...
    progress_color_key: "Voortgang kleur code:"
...
#    kids_message_2: "Ask Your Parent"
    support_part1: "Heeft u hulp of informatie nodig over betalen? Email"
#    support_part2: "support@codecombat.com"
    support_part3: "om assistentie te verkijgen."
  ...
  teachers_quote:
    ...
    middle_school: "Middelbare school (onderbouw)"
    college_plus: "Hoger Onderwijs"
    referrer: "Hoe bent u met CodeCombat in contacgt gekomen?"
    referrer_help: "Bijvoorbeeld: van een andere docent, een voorlichting, een van uw studenten, Code.org, etc."
    anything_else: "Is er verder nog iets dat we moeten weten?"
    thanks_header: "Bedankt voor je demo-aanvraag!"
    thanks_sub_header: "Bedankt voor je interesse in CodeCombat."
    thanks_p: "Wij zullen spoedig contact met u opnemen. Vragen? Mail ons:" # {change}
  ...
  courses:
    ...
    change_hero: "Verander Held"
    web_dev_language_transition: "Alle klassen programmeren in HTML / Javascript voor deze cursus. Klassen die eerder Python hebben gebruikt zullen beginnen met extra JavaScript intro levels om de overgang te vergemakkelijken. Klassen die al met JavaScript werken slaan deze intro lessen over."
    course_membership_required_to_play: "Je moet onderdeel zijn van een cursus om dit level te spelen."
    license_required_to_play: "Vraag aan je docent om een licentie aan jouw account te koppelen om door te spelen."
  ...
  teacher:
    ...
    enroll_student: "Schrijf leerling in"
    apply_license: "Pas licentie toe"
    revoke_license: "Trek licentie in"
    course_progress: "Cursus voortgang"
    not_applicable: "n.v.t."
    edit: "wijzig"
    edit_2: "Wijzig"
    ...
    how_to_apply_licenses: "Hoe licenties toe te passen"
    ...
    credits: "licenties"
    starter_licenses: "starter licenties"
    ...
    educator_faq_desc: "Vaak gestelde vragen over het gebruik van CodeCombat in je klas of school."
    teacher_getting_started: "Leraar Aan De Slag Gids"
    teacher_getting_started_desc: "Nieuw bij CodeCombat? Download de Leraar Aan De Slag Gids om een account op te zetten, een klas te creëren en studenten uit te nodigen voor hun eerste cursus."
    student_getting_started: "Student Aan De Slag Gids"
    ...
    cs1_syntax_javascript_desc: "Spiekbriefje met referenties naar vaakgebruikte JavaScript syntax die studenten zullen leren in de Computer Science Introductie."
    coming_soon: "Binnenkort meer gidsen!"
    engineering_cycle_worksheet: "Ontwikkelcyclus-werkblad"
    engineering_cycle_worksheet_desc: "Gebruik dit werkblad om leerlingen de basis van de ontwikkelingscyclus te leren: Planning, Design, Implementatie en Debug. Verwijs naar het voltooide voorbeeld werkblad als richtlijn."
    ...
    arenas_curriculum: "Arena Levels - Docenten handleiding"
    arenas_curriculum_desc: "Instructies om 'Wakka Maul', 'Cross Bones' en 'Power Peak' multiplayer arena's met uw klas te spelen."
    ...
    no_email: "Leerling heeft geen emailadres ingevuld."
    student_profile: "Leerling Profiel"
    playtime_detail: "Speeltijd"
    student_completed: "Student is Klaas"
    student_in_progress: "Student in Bezig"
    class_average: "Klas Gemiddelde"
    ...
    revoke_confirm: "Weet je zeker dat je de volledige licentie van {{student_name}} wilt terug trekken? De Licentie zal beschikbaar worden voor een andere student."
    revoking: "Terug aan het trekken..."
  ...
  sharing:
    ...
    victory_course_share_game: "het spel spelen"
  ...
  concepts:
    ...
    if_statements_nested: "Geneste If Statemnts"
    ...
    place_game_objects: "Plaats spel object"
    construct_mazes: "Fabriceer doolhof"
    create_playable_game: "Maak een speel- en deelbaar spelobject."
    alter_existing_web_pages: "Pas bestaande webpagina's aan"
    create_sharable_web_page: "Maak een deelbare webpagina."
    basic_input_handling: "Basis invoer afhandeling"
    basic_game_ai: "Basic spelvijand (AI)"
    basic_javascript: "Basis JavaScript"
    basic_event_handling: "Basis 'Event Handling'"
  ...
  calendar:
    ...
    cs1_curriculum: "Introductie tot programmeren - Curriculum Gids"
    cs1_curriculum_desc: "Cursus 1: leertraject, lesplannen, activiteiten en meer."
    arenas_curriculum: "Arena Levels - Leraren Gids"
