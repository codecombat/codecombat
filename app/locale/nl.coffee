...
#    covid19_banner_blurb: "We are offering free access to our full curriculum to educators and schools affected by school closures."
    ...
    student: "Student"
    our_coding_programs: "Onze programmeerlessen"
...
#    ozaria_blurb: "An adventure game and Computer Science program where students master the lost magic of coding to save their world. Recommended for educators and students."
  ...
  login:
    ...
    accounts_merge_confirmation: "Er is een account gekoppeld aan het e-mailadres van dit Google account. Wil je deze accounts samenvoegen??"
  ...
  signup:
    ...
    password_requirements: "8 to 64 tekens zonder herhaling"
    invalid: "Ongeldig"
    invalid_password: "Ongeldig wachtwoord"
    with: "met"
    want_to_play_codecombat: "Nee, ik heb er geen maar ik wil CodeCombat spelen!"
    have_a_classcode: "Heb je een klassencode?"
    yes_i_have_classcode: "Ja, ik heb een klassencode!"
    enter_it_here: "Vul het hier in:"
...
#    vega_character: "Vega Character"
    ...
    fill_in_solution: "Vul oplossing in"
...
#  live_class:
    ...
    link: "Klaar om door te gaan met programmeren?"
...
#    join_paragraph: "Join the largest international Python AI coding tournament for all ages and compete for the top of the leaderboard! This month-long global battle starts August 1st and includes $5k worth of prizes and a virtual awards ceremony where we'll announce winners and recognize your coding skills."
    link: "Klik hier om te registeren en verder te lezen"
