module.exports = nativeDescription: "Nederlands", englishDescription: "Dutch", translation:
  ...
  play_level:
    ...
    multiplayer_hint: " Klik de link om alles te selecteren, druk dan op Apple-C of Ctrl-C om de link te kopiÃ«ren."
...
#    tip_reticulating: "Reticulating spines."
  ...
  editor:
    ...
    article_description: "Schrijf artikels die spelers een overzicht geven over programmeer concepten die kunnen gebruikt worden over een variÃ«teit van levels en campagnes."
    thang_title: "Thang Editor"
    thang_description: "Maak eenheden, beschrijf hun standaard logica, graphics en audio. Momenteel is enkel het importeren van vector graphics geÃ«xporteerd uit Flash ondersteund."
    level_title: "Level Editor"
    level_description: "Bevat de benodigdheden om scripts te schrijven, audio te uploaden en aangepaste logica te creÃ«ren om alle soorten levels te maken. Het is alles wat wij zelf ook gebruiken!"
  ...
  about:
    ...
    who_description_prefix: "hebben samen CodeCombat opgericht in 2013. We creÃ«erden ook "
    ...
    scott_description: "Extraordinaire programmeur, software ontwikkelaar, keukenprins en heer en meester van financiÃ«n. Scott is het meeste voor reden vatbaar."
  ...
  legal:
    ...
    privacy_description: "We zullen nooit jouw persoonlijke informatie verkopen. We willen in verloop van tijd geld verdienen dankzij aanwervingen, maar je mag op je beide oren slapen dat wij nooit jouw persoonlijke informatie zullen verspreiden aan geÃ¯nteresseerde bedrijven zonder dat jij daar expliciet mee akkoord gaat."
    ...
    rights_clarification: "Om het duidelijk te maken, iets dat beschikbaar is in de Level editor voor het maken van levels, valt onder de CC licentie. Terwijl de inhoud gemaakt met de Level Editor of geÃ¼pload in de loop van de creatie van de levels, hier niet onder vallen."
  ...
  contribute:
    ...
    adventurer_join_suf: "dus als je liever op deze manier wordt geÃ¯nformeerd, schrijf je daar in!"
    ...
    scribe_attribute_1: "Taalvaardigheid is praktisch alles wat je nodig hebt. Je moet niet enkel bedreven zijn in grammatica en spelling, maar ook moeilijke ideeÃ«n kunnen overbrengen aan anderen."
    ...
    diplomat_introduction_suf: "dan is het wel dat er een enorme belangstelling is voor CodeCombat in andere landen, vooral BraziliÃ«! We zijn een groep van vertalers aan het creÃ«ren dat ijverig de ene set woorden in de andere omzet om CodeCombat zo toegankelijk mogelijk te maken in de hele wereld. Als jij het leuk vindt glimpsen op te vangen van aankomende content en deze levels zo snel mogelijk naar je landgenoten te krijgen, dan is dit de klasse voor jou."
    diplomat_attribute_1: "Vloeiend Engels en de taal waar naar je wilt vertalen kunnen spreken. Wanneer je moeilijke ideeÃ«n wilt overbrengen, is het belangrijk beide talen goed te begrijpen!"
    ...
    ambassador_attribute_1: "Communicatieskills. Problemen die spelers hebben kunnen identificeren en ze helpen deze op te lossen. Verder zul je ook de rest van ons geÃ¯nformeerd houden over wat de spelers zeggen, wat ze leuk vinden, wat ze minder vinden en waar er meer van moet zijn!"
  ...
  multiplayer_launch:
    ...
    create_worlds: "en jouw eigen werelden creÃ«ren."
