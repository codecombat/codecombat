module.exports = nativeDescription: "Nederlands", englishDescription: "Dutch", translation:
  new_home:
    ...
    builds_concepts_up: "Ik vind het leuk hoe CodeCombat me concepten aanleert. Het is heel gemakkelijk te begrijpen en leuk om te ontdekken."
  ...
  nav:
    ...
    apcsp: "Algemene computerwetenschappen principes"
    parent: "Ouders"
  ...
  signup:
    complete_subscription: "Voltooi inschrijving"
    ...
    eu_confirmation: "I ga akkoord dat CodeCombat mijn data opslaat op servers in de VS."
    eu_confirmation_place_of_processing: "Leer meer over mogelijke risico's"
    eu_confirmation_student: "Als je niet zeker bent, vraag aan je leerkracht."
    eu_confirmation_individual: "Als je niet wilt dat je data wordt opgeslagen op onze servers in de VS, kan je altijd anoniem verder spelen zonder je code op te slaan."
  ...
  play_level:
    ...
    finished_hoc: "Ik ben klaar met mijn programmeer-uur"
    ...
    combo_challenge: "Combo Uitdaging"
    concept_challenge: "Concept Uitdaging"
    challenge_unlocked: "Challenge Unlocked"
    combo_challenge_unlocked: "Combo Uitdaging ontgrendeld"
    concept_challenge_unlocked: "Concept Uitdaging ontgrendeld"
    concept_challenge_complete: "Concept Uitdaging voltooid!"
    combo_challenge_complete: "Combo Uitdaging voltooid!"
    combo_challenge_complete_body: "Goed gedaan, het lijkt erop dat je goed op weg bent om __concept__ te begrijpen!"
    replay_level: "Herspeel Level"
    combo_concepts_used: "__complete__/__total__ Concepten gebruikt"
    combo_all_concepts_used: "Je hebt alle mogelijke concepten gebruikt om deze uitdaging op te lossen. Goed gedaan!"
    combo_not_all_concepts_used: "Je hebt __complete__ van de __total__ mogelijke concepten gebruikt om deze uitdaging op te lossen. Probeer om volgende keer alle __total__ concepten te gebruiken!"
...
#    combo_challenge_goal: "Challenge Level Goal"
    ...
    victory_hour_of_code_done_yes: "Ja, ik ben klaar met mijn programmeer-uur!"
...
#    daniela_blurb: "Creates stories"
  ...
  courses:
    ...
    solutions_require_licenses: "De oplossingen zijn beschikbaar voor leerkrachten met een licentie"
    unnamed_class: "Naamloze klas"
    edit_settings1: "Bewerk Klas Instellingen"
    add_students: "Voeg leerlingen toe"
    stats: "Statistieken"
    student_email_invite_blurb: "Je studenten kunnen klascode <strong>__classCode__</strong> gebruiken bij het aanmaken van een Studentenaccount, geen e-mailadres vereist."
    ...
    view_assessments: "Bekijk beoordeling"
...
#    hide_change_log: "Hide changes to this course's levels"
  ...
  teacher:
    ...
    click_student_code: "Klik hieronder op een level dat de leerling heeft gestart of voltooid om zijn code te bekijken."
    code: "__name__'s Code"
    complete_solution: "Volledige Oplossing"
    course_not_started: "Student heeft deze les nog niet gestart"
    no_code_yet: "Student heeft nog geen code geschreven voor dit level"
...
#    students_code_blurb: "A correct solution to each level is provided where appropriate. In some cases, it’s possible for a student to solve a level using different code. Solutions are not shown for levels the student has not started."
    ...
    revoke_licenses: "Alle licenties intrekken"
    ...
    view_student_code: "Klik om te code van de student te zien"
