...
#    hoc_meta_description: "Make your own game or code your way out of a dungeon! CodeCombat has four different Hour of Code activities and over 60 levels to learn code, play, and create."
    ...
    teacher_quest_kithgard_gates_100_step2: "Begeleid leerlingen om door moeilijke problemen heen te denken door de [Engineering Cycle Worksheet](http://files.codecombat.com/docs/resources/EngineeringCycleWorksheet.pdf)te gebruiken."
