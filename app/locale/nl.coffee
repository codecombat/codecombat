...
#  announcement:
    cuddly_companions: "Knuffelbare Kameraden!"
...
#    ball_description: "ball.squeak()"
    collect_pets: "Verzamel huisdieren voor jouw helden!"
    each_pet: "Elk huisdier heeft een unieke vaardigheid om jou te helpen!"
    upgrade_to_premium: "Wordt {{subscriber}} om huisdieren een uitrusting te kunnen geven."
    play_second_kithmaze: "Speel {{the_second_kithmaze}} om de wolvenpup vrij te spelen!"
    the_second_kithmaze: "Het Tweede Kithof"
    keep_playing: "KBlijf spelen om je eerste huisdier te vinden!"
    coming_soon: "Binnenkort beschikbaar"
  ...
  teacher:
    ...
    gd1: "Game Ontwikkeling 1"
    gd1_guide: "Game Ontwikkeling 1 - Handleiding"
    ...
    revoking: "Intrekken..."
    unused_licenses: "Je hebt nog ongebruikte licenties die je kunt gebruiken om leerlingen toe te wijzen aan nieuwe lesmodules."
    remember_new_courses: "Vergeet niet om nieuwe lesmodules toe te wijzen!"
    more_info: "Meer Informatie"
    how_to_assign_courses: "Hoe wijs je lesmodules toe"
    select_students: "Selecteer leerlingen"
    select_instructions: "Klik op het vakje naast iedere leerling aan wie je de lesmodule wil toewijzen."
    choose_course: "Selecteer lesmodule"
