...
#    code_line_number: "1 Billion"
  ...
  new_home:
    title_coco: "CodeCombat - Programmér spil mens du lærer Python og JavaScript"
    title_ozar: "CodeCombat - Programmér spil mens du lærer Python og JavaScript"
...
#    meta_keywords_ozar: "CodeCombat, python, javascript, Coding Games, Computer Science Program, Adventure, Epic Story"
    meta_description_coco: "Lær at skrive kode gennem et programmeringsspil. Lær Python, JavaScript og HTML mens du løser gåder og lær at lave dine egne spil og websider."
    meta_description_ozar: "Lær at skrive kode gennem et programmeringsspil. Lær Python, JavaScript og HTML mens du løser gåder og lær at lave dine egne spil og websider."
#    meta_og_url: "https://codecombat.com"
#    become_investor: "to become an investor in CodeCombat"
    built_for_teachers_title: "Et programmeringsspil henvendt til lærere"
    built_for_teachers_blurb: "At undervise børn i at programmere, kan nogle gange føles overvældende. CodeCombat hjælper alle lærere med at undervise elever i programmering af enten JavaScript eller Python - to af de mest populære programmeringssprog. Med udgangspunkt i et omfattende pensum, som inkluderer seks datalogi-moduler og som understøtter læring gennem projektbaseret spiludvikling og webudvikling, vil børnene komme på en rejse gående fra grundlæggende syntaks mod rekursion!"
    built_for_teachers_subtitle1: "Datalogi"
    built_for_teachers_subblurb1: "I vores gratis introduktionskursus lærer eleverne at mestre basale programmeringsprincipper som while/for løkker, funktioner og algoritmer."
    built_for_teachers_subtitle2: "Spiludvikling"
    built_for_teachers_subblurb2: "Eleverne lærer at bygge labyrinter og anvender grundlæggende input til at programmere deres egne spil, som kan deles med venner og familie."
    built_for_teachers_subtitle3: "Webudvikling"
    built_for_teachers_subblurb3: "Eleverne bliver udfordret på den kreative sans ved at anvende HTML, CSS og jQuery til at opbygge deres egne websider med en brugerdefineret URL, som kan deles med deres klassekammerater."
...
#    complete_subscription: "Complete Subscription"
    create_student_header: "Opret elev konto"
    create_teacher_header: "Opret lærer konto"
...
#    here: "here"
  ...
  play_level:
    back_to_map: "Tilbage til kort"
    directions: "Retninger"
    edit_level: "Rediger niveau"
    keep_learning: "Fortsæt med at lære"
    explore_codecombat: "Udforsk CodeCombat"
    finished_hoc: "Jeg er færdig med min time-med-kode"
    get_certificate: "Hent dit certifikat!"
    level_complete: "Niveau afsluttet"
...
#    victory_no_progress_for_teachers: "Progress is not saved for teachers. But, you can add a student account to your classroom for yourself."
    ...
    tome_cast_button_update: "Opdater"
...
#    description_coming_soon: "Description coming soon"
  ...
  options:
    ...
    editor_config_title_ozar: "Editor Konfiguration"
...
#    course_suffix: ""
  ...
  teachers_quote:
    subtitle_coco: "Få dine elever startet på mindre end en time. Du vil være i stand til at <strong>oprette en klasse, tilføje elever, og overvåge deres fremgang</strong> mens de lærer datalogi!"
    subtitle_ozar: "Få dine elever startet på mindre end en time. Du vil være i stand til at <strong>oprette en klasse, tilføje elever, og overvåge deres fremgang</strong> mens de lærer datalogi!"
...
#    back_classroom: "Back to classroom"
    back_courses_coco: "Tilbage til mine klasser"
    back_courses_ozar: "Tilbage til mine klasser"
...
#    practice: "practice"
#    required: "required"
    welcome_to_courses_coco: "Eventyrere, velkommen til Kurser!"
    welcome_to_courses_ozar: "Eventyrere, velkommen til Kurser!"
...
#    join_class_2: "Join class"
    ask_teacher_for_code_coco: "Spørg din lærer om du har en CodeCombat-klassekode! Hvis det er tilfældet, angiv den nedenfor:"
    ask_teacher_for_code_ozar: "Spørg din lærer om du har en CodeCombat-klassekode! Hvis det er tilfældet, angiv den nedenfor:"
    enter_c_code_coco: "<Indtast klassekode>"
    enter_c_code_ozar: "<Indtast klassekode>"
    join: "Følg"
