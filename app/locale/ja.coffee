...
#    accept_and_save: "Accept&Save"
  ...
  play_level:
    ...
    next_level: "次のレベル"
    combo_challenge: "コンボチャレンジ"
    concept_challenge: "コンセプトチャレンジ"
...
#    send: "Send Email"
  ...
  hoc_2018:
    ...
    about_copy: "CodeCombat はゲーム見たいなCSを教えてくれるプログラムです。CodeCombatはPythonとJavaScriptを教えてくれます。CodeCombatはちゃんとプログラミングコンセプトを教えながらみんながたのしめるようにできています。1.2千万人以上CodeCombatを使っています。"
    point1: "✓ ベースが分かりやすい"
    point2: "✓ 生徒に合うように調整する"
    point3: "✓ コンセプトのテストもある"
