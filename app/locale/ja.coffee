...
#    auth_sign_up: "New to Ozaria? Create an Account"
    sign_up: "アカウント登録"
    email_or_username: "Eメールまたはユーザー名" # {change}
#    or: "or"
    log_in: "ログイン"
#    sign_in: "Sign In"
    logging_in: "ログイン中"
    ...
    finishing: "仕上げ中"
    sign_in_with_facebook: "Facebookでログイン" # {change}
    sign_in_with_gplus: "Google+でログイン" # {change}
...
#    accounts_merge_confirmation: "There is an account associated with the email from this Google account. Would you like to merge these accounts?"
  ...
  signup:
    ...
    signup_as_teacher: "先生として登録" # {change}
...
#    description_coming_soon: "Description coming soon"
  ...
  options:
    ...
    editor_config_title: "エディターの設定" # {change}
    editor_config_livecompletion_label: "ライブオートコンプリート" # {change}
    ...
    editor_config_behaviors_label: "スマートビヘイビア" # {change}
...
#    learn_more: "Learn More"
    ...
    story_link: "ストーリー"
    press_link: "記事"
    mission_title: "私たちのミッション: プログラミングを地球上の学生にとどけること。" # {change}
