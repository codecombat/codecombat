...
#    score_display: "__scoreType__: __score__"
  ...
  buy_gems:
    ...
    pile_gems: "Een berg edelstenen"
    chest_gems: "Schatkist vol edelstenen"
  ...
  subscribe:
    ...
    thank_you_months_prefix: "Bedankt voor je steun in de voorbije"
    ...
    loading_info: "Abonnementsinformatie aan het laden..."
    ...
    was_free_until: "Je had een gratis inschrijving tot"
    managed_subs: "beheerde abonnementen"
...
#    anything_else_helper: ""
    ...
    finish_signup: "Voltooi je leerkrachten-account:"
    ...
    conversion_warning: "WAARSCHUWING: Je huidige account is een <em>Leerling Account</em>. Wanneer je dit formulier indient zal dit account worden omgezet naar een Leerkrachten Account."
    learn_more_modal: "Leerkrachten Accounts kunnen de voortgang van leerlingen te zien, inschrijvingen regelen en klaslokalen beheren. Leerkrachten Accounts kunnen niet in een klaslokaal ingeschreven staan - als je ingeschreven staat in een klas met dit account zul je niet langer als leerling toegang hebben tot die klas." # {change}
    create_account: "Maak een leerkrachten-account aan"
    create_account_subtitle: "Krijg toegang tot exclusieve hulpmiddelen voor leerkrachten door CodeCombat in de klas te gebruiken. <strong>Maak een klas aan</strong>, voeg leerlingen toe, en <strong>bekijk hun vooruitgang</strong>!"
    convert_account_title: "Verander in een leerkrachten-account"
    not: "niet"
  ...
  keyboard_shortcuts:
    ...
    scrub_playback: "Blader vooruit en achteruit door de tijd."
    single_scrub_playback: "Blader vooruit en achteruit door de tijd per beeld."
    scrub_execution: "Blader door de huidige betovering in uitvoering."
  ...
  courses:
    ...
    solutions_require_licenses: "Level-oplossingen zijn beschikbaar voor leerkrachten met licenties"
    ...
    enroll: "Inschrijven"
    enroll_paid: "Schrijf leerlingen in voor betalende cursussen"
    get_enrollments: "Licenties (bij)kopen?"
    change_language: "Verander de cursustaal"
    ...
    play_now_learn_1: "basissyntaxis om je karakter te besturen"
    ...
    ask_teacher_for_code: "Vraag je docent of je een CodeCombat klascode hebt! Zo ja, vul die dan hieronder in:"
    enter_c_code: "<voer klascode in>"
    join: "Doe mee"
    joining: "Doe mee met de klas"
    ...
    are_you_sure: "Ben je zeker dat je deze leerling uit de klas wilt verwijderen?"
    remove_description1: "De leerling zal toegang tot deze klas en toegewezen klassen verliezen. Vooruitgang en gameplay is NIET verloren, en de leerling kan ten allen tijde terug worden toegevoegd aan de klas."
    remove_description2: "De geactiveerde betaalde licentie zal niet worden terugbetaald."
    ...
    class_name: "Klasnaam"
    teacher_account_restricted: "Jouw account is een Leerkrachten Account, daarom heeft dit account geen toegang tot inhoud bedoeld voor leerlingen." # {change}
...
#    set_start_locked_level: "Set start locked level"
  ...
  teacher:
    ...
    click_student_code: "Klik hieronder op een willekeurig level dat de leerling is gestart of heeft voltooid om de code te bekijken die ze hebben geschreven"
...
#    appreciation_week_blurb4: "whether you'd like licenses for Week 1 (May 6-10) or Week 2 (May 13-17)"
    ...
    students_code_blurb: "Waar nodig wordt een juiste oplossing voor elk level geboden. In sommige gevallen is het mogelijk dat een leerling een level oplost met behulp van andere code. Oplossingen worden niet getoond voor levels die de leerling nog niet is gestart."
    ...
    class_join_url_blurb: "Nieuwe leerlingen kunnen deze link bezoeken terwijl ze ingelogd zijn om zich bij de klas aan te sluiten." # {change}
    add_students_manually: "Leerlingen Handmatig Toevoegen" # {change}
    bulk_assign: "Toewijzen in Bulk" # {change}
    assigned_msg_1: "{{numberAssigned}} leerlingen zitten bij {{courseName}}."
...
#    enrollment_explanation_5: "classes may be archived and licenses may be reused throughout the school year, so this view allows administrators to understand how many students truly participated in the program overall."
    ...
    teacher_quest: "Zoektocht van Leerkrachten naar Succes"
  ...
  teacher_ozaria_encouragement_modal:
    ...
    bullet1: "Verdiep de verbinding van de leerling met leren, door middel van een episch verhaal en meeslepende gameplay"
  ...
  share_licenses:
    ...
    add_teacher_button: "Voeg leerkracht toe"
    subheader: "Je kunt je eigen licenties beschikbaar maken voor andere leerkrachten in je organisatie. Elke licentie kan maar door één leerling tegelijk gebruikt worden."
    teacher_not_found: "Leerkracht niet gevonden. Zorg ervoor dat deze docent al een Leerkrachtenaccount heeft aangemaakt."
    teacher_not_valid: "Dit is geen geldig Leerkrachtenaccount. Alleen leerkrachten met een account kunnen licenties delen."
    ...
    teachers_using_these: "Leerkrachten die beschikking hebben over de licenties:"
    footer: "Wanneer leerkrachten licenties intrekken van leerling, kunnen de licenties weer gebruikt worden door andere leerkrachten die beschikking hebben over de licenties."
    you: "(jij)"
  ...
  sharing:
    ...
    share_with_teacher_email: "Stuur naar jouw docent"
  ...
  contribute:
    ...
    diplomat_join_suf_github: ", editeer het online, en dien een pull request in. Daarnaast kun je hieronder aanvinken dat je up-to-date gehouden wilt worden over de nieuwe internationale ontwikkelingen."
...
#    arena_title: "__arena__ | Multiplayer Arenas"
  ...
  impact:
    ...
    hero_subheading: "We geven leerkrachten zelfvertrouwen en inspireren leerlingen in het hele land"
...
#    partners_school_3: "Riverdale High School"
    ...
    teacher_spotlight: "Leerkracht & Leerling Spotlights"
...
#    too_many_login_failures: "There have been too many unsuccessful login attempts.  Please try again later."
  ...
  anonymous_teacher:
    notify_teacher: "Waarschuw docent"
    create_teacher_account: "Maak een gratis leerkrachten-account aan"
...
#    book_your_class: "Book Your Class"
  ...
  hoc:
    ...
    about_copy: "CodeCombat is een spel-gebaseerd computerwetenschappelijk programma voor het lesgeven in Python en JavaScript. CodeCombat's op standaarden gebaseerde leerplan / curriculum is opgebouwd rond een spel waar leerlingen gek op zijn. Meer dan 12 miljoen leerlingen hebben leren programmeren met CodeCombat!" # {change}
#    point1: "✓ Scaffolded"
...
#    acronym: "HOC"
  ...
  school_administrator:
    ...
    total_students: "totaal aantal leerlingen"
    active_students: "actieve leerlingen"
    ...
    students_stat_description: "Totaal leerlingenaccounts voor alle leerlingen in alle klaslokalen, ongeacht of ze licenties hebben aangevraagd."
    active_students_stat_description: "Actieve leerlingen telt het aantal leerlingen dat zich de afgelopen 60 dagen heeft aangemeld bij CodeCombat. "
