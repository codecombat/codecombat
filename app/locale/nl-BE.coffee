module.exports = nativeDescription: "Nederlands (België)", englishDescription: "Dutch (Belgium)", translation:
  ...
  choose_hero:
    ...
    attack_2: "Buiten categorie" # Missing context for acuratre translation. Used 'hors category' equivalent 
    attack_3: "Wapen schade."
    health_1: "Toename"
    health_2: "Buiten categorie" # Missing context for acuratre translation. Used 'hors category' equivalent
  ...
  skill_docs:
    ...
    returns: "Verdiensten" # Missing context for acuratre translation. Used 'return on investment' equivalent
  ...
  ladder:
    ...
    winners: "Winnaars"
    league: "Liga"
    red_ai: "AI rood" # "Rood AI Wint", at end of multiplayer match playback
  ...
  resources:
    ...
    achievement: "Prestatie"
    clas: "klas"
    play_counts: "Aantal Keren Gespeeld"
    feedback: "Feedback"
    ...
    course: "Cursus"
    courses: "Cursussen"
    course_instance: "Cursus Instantiee"
    course_instances: "Cursus Instanties"
