...
#    last_level: "Last level played"
    ...
    option1_body: "Studenten krijgen automatisch een uitnodiging voor deze klas, en zullen een account moeten aanmaken met een gebruikersnaam en wachtwoord." # {change}
