module.exports = {
  ...
  translation: {
    ...
    home_v3: {
      mission_title: '[AI_TRANSLATION]Únete a nosotros en nuestra misión de hacer que la programación y la IA sean accesibles para todos.',
      mission_supporting_text: '[AI_TRANSLATION]Estamos comprometidos a ofrecer soluciones educativas de alta calidad que empoderen a todos para darse cuenta de su potencial y ayudar a dar forma a un futuro mejor.',
      ...
      stat_card_2_description: '[AI_TRANSLATION]Líneas de Código',
      ...
      learn_to_code: '[AI_TRANSLATION]Aprende a **codificar** y usar **IA**, todo a través del **poder del juego**.',
      ...
      for_younger_learners: '[AI_TRANSLATION]Para los Más Jóvenes',
      your_turnkey_solutions: '[AI_TRANSLATION]Tus Soluciones Llave en Mano',
      trends_insights: '[AI_TRANSLATION]Tendencias y Perspectivas',
      ...
      education_partner: '[AI_TRANSLATION]Educación[SALTODELÍNEA]Socio',
      official_member: '[AI_TRANSLATION]Miembro[NEWLINE]Oficial',
      best_creativity_tool_for_students: '[AI_TRANSLATION]Mejor Herramienta Creativa[NEWLINE]Para Estudiantes',
      official_partner: '[AI_TRANSLATION]Socio Oficial[NEWLINE]',
      hour_of_code_activity_partner: '[AI_TRANSLATION]Hora del Código[NEWLINE]Socio de Actividad',
      top_pick_for_learning: '[AI_TRANSLATION]Primera Opción para[NEWLINE]Aprender',
      testimonals_1_title: '[AI_TRANSLATION]“Una cosa que ahora puedo hacer, que antes no podía, es realmente creer que puedo programar.”',
      testimonals_1_name: '[AI_TRANSLATION]Estudiante de la Escuela Secundaria Mountain Ridge',
      testimonals_2_title: '[AI_TRANSLATION]"Nombra cualquier programa en línea, lo he probado. Ninguno se compara con CodeCombat & Ozaria. Cualquier maestro que quiera que sus estudiantes aprendan a programar... comience aquí!"',
      testimonals_2_name: '[AI_TRANSLATION]Scott Baily, Escuela Secundaria Bobby Duke',
      testimonals_3_title: '[AI_TRANSLATION]"Siempre he tenido aspiraciones de diseñar videojuegos y aprender a codificar... esto me está dando un gran punto de partida."',
      testimonals_3_name: '[AI_TRANSLATION]Joey, 10° Grado',
      testimonals_4_title: '[AI_TRANSLATION]"Lo que más me gusta de CodeCombat es que no simplifica la codificación. Los estudiantes están aprendiendo a escribir código real, pero lo hacen de manera que se divierten."',
      testimonals_4_name: '[AI_TRANSLATION]Sandra Ahlstrom, Maestro, Distrito Escolar del Condado de Sheridan #2',
      ...
      carousel_2_title: '[AI_TRANSLATION]Programación[NEWLINE]Basada en Texto',
      carousel_2_text: '[AI_TRANSLATION]Nuestro motor de código personalizado e intérprete está diseñado para principiantes, enseñando los verdaderos lenguajes de programación Python, JavaScript y C++ utilizando términos amigables para principiantes.',
      carousel_3_title: '[AI_TRANSLATION]Evaluaciones Basadas en Proyectos[NEWLINE]',
      carousel_3_text: '[AI_TRANSLATION]Estos proyectos son una oportunidad para que los estudiantes codifiquen sus propios juegos compartibles. Proporcionamos rúbricas de evaluación para que puedas usar proyectos de final de carrera como tus principales evaluaciones sumativas.',
      carousel_4_title: '[AI_TRANSLATION]Aceleración[NEWLINE]de IA',
      carousel_4_text: '[AI_TRANSLATION]Enseñamos a los estudiantes cómo usar la IA para acelerar el aprendizaje y avanzar en sus habilidades de codificación. Esta poderosa combinación libera el potencial creativo de aquellos en todos los niveles de habilidad.',
      carousel_5_title: '[AI_TRANSLATION]Empoderamiento[NEWLINE]del Educador',
      carousel_5_text: '[AI_TRANSLATION]Nuestras soluciones para el aula están construidas con todo el apoyo y recursos que cualquier educador necesitaría para implementar el currículo y lograr resultados exitosos.',
      carousel_6_title: '[AI_TRANSLATION]Impacto en Estudiantes[NEWLINE]',
      carousel_6_text: '[AI_TRANSLATION]Nuestros productos han ayudado a más de 20 millones de estudiantes a disfrutar aprendiendo Ciencias de la Computación, enseñándoles a ser aprendices críticos, confiados y creativos. Involucramos a todos los estudiantes, independientemente de su experiencia, ayudándoles a darse cuenta de un camino hacia el éxito en la Informática.',
      engaging_boxes_1_title: '[AI_TRANSLATION]Aula Ozaria',
      ...
      engaging_boxes_2_text: '[AI_TRANSLATION]Un currículo completo de CS que parte desde conceptos básicos hasta el desarrollo web, desarrollo de juegos y **[https://codecombat.com/apcsp]AP CSP**.',
      engaging_boxes_3_title: '[AI_TRANSLATION]Mundos de CodeCombat en Roblox',
      engaging_boxes_3_text: '[AI_TRANSLATION]En asociación con Roblox Education, esta experiencia habilitada por IA potencia las habilidades de programación de los estudiantes y proporciona una plataforma real para crear juegos y experiencias asombrosos.',
      engaging_boxes_4_title: '[AI_TRANSLATION]Liga de Esports de CodeCombat AI',
      engaging_boxes_4_text: '[AI_TRANSLATION]Una plataforma épica de esports de codificación competitiva que fomenta la programación creativa en un entorno basado en juegos.',
      engaging_boxes_5_title: '[AI_TRANSLATION]HackStack de CodeCombat AI',
      engaging_boxes_5_text: '[AI_TRANSLATION]La primera herramienta complementaria de IA generativa específicamente diseñada para aquellos nuevos en la IA, con un enfoque en la privacidad y seguridad de los estudiantes. Mezclando simplicidad y potencia, la plataforma acelera las habilidades de los estudiantes y desata su potencial creativo.',
      engaging_boxes_6_title: '[AI_TRANSLATION]Inicio de CodeCombat',
      engaging_boxes_6_text: '[AI_TRANSLATION]Con acceso a más de 530 niveles y características exclusivas como mascotas, ítems solo para premium y héroes, tu hijo puede sumergirse completamente en el mundo de la codificación. Incluso pueden diseñar juegos para desafiar a sus amigos, construir sitios web y aplicaciones para compartir.',
      young_learners_1_title: '[AI_TRANSLATION]CodeCombat Jr.',
      young_learners_1_text: '[AI_TRANSLATION]Nuestro currículo estrella de K-5 presenta una progresión de niveles de aprendizaje que enseñan conceptos básicos de codificación a un ritmo más lento, diseñado específicamente para estudiantes de primaria.',
      young_learners_1_linkText: '[AI_TRANSLATION]Registrarse para Acceso Beta',
      young_learners_2_title: '[AI_TRANSLATION]AI HackStack Jr.',
      young_learners_2_text: '[AI_TRANSLATION]Presenta la AI generativa multimodal en una plataforma simple e intuitiva diseñada específicamente para estudiantes de K-5.',
      young_learners_2_linkText: '[AI_TRANSLATION]Registrarse para Acceso Beta',
      solutions_1_title: '[AI_TRANSLATION]Desarrollo Profesional',
      solutions_1_text: '[AI_TRANSLATION]Diseñado para empoderar a todos los profesores con las habilidades, conocimientos y confianza necesarios para enseñar informática de manera efectiva.',
      solutions_1_middleText: '[AI_TRANSLATION]Gana hasta 3 créditos de posgrado.',
      solutions_1_linkText: '[AI_TRANSLATION]Pruébalo ahora',
      solutions_2_title: '[AI_TRANSLATION]Preparaciones para el Examen AP CSP',
      solutions_2_text: '[AI_TRANSLATION]Somos reconocidos por el College Board como un proveedor avalado de currículum y desarrollo profesional para los Principios de Informática AP® (AP CSP). Nuestro currículum AP CSP proporciona herramientas basadas en juegos y listas para usar para preparar a los estudiantes para el examen AP.',
      solutions_2_linkText: '[AI_TRANSLATION]Pruébalo ahora',
      solutions_3_title: '[AI_TRANSLATION]Fuentes de Becas y Financiamiento',
      solutions_3_text: '[AI_TRANSLATION]Entendemos los obstáculos de financiamiento que enfrentan las escuelas y nos apasiona ayudar a superar estos desafíos. Consulta nuestra guía completa sobre financiación de subvenciones o habla con nuestro equipo para saber más.',
      solutions_4_title: '[AI_TRANSLATION]Soluciones a Nivel de Distrito',
      solutions_4_text: '[AI_TRANSLATION]Nuestras soluciones innovadoras han ayudado a distritos en todo el país a expandir o iniciar sus programas de informática. Diseñada con retroalimentación de nuestra comunidad de más de 320,000 educadores, nuestra solución integral proporciona un currículum receptivo y flexible que satisface las necesidades de todos los estudiantes y educadores. Es fácil de implementar y escalar con nuestro equipo proporcionando la capacitación y el soporte que sus maestros necesitan.',
      solutions_5_title: '[AI_TRANSLATION]Clases en Vivo Online',
      solutions_5_text: '[AI_TRANSLATION]Nuestras clases de codificación en línea combinan el poder del juego y la instrucción personalizada para una experiencia que a tu hijo le encantará. Desde codificar y publicar sus propios juegos de Roblox, hasta construir un sitio web para un nuevo negocio, tu hijo explorará todo lo que es posible con la IA y la codificación.',
      ...
      solutions_7_text: '[AI_TRANSLATION]Únete a nuestra misión para hacer que la programación sea accesible y atractiva para todos al convertirte en un socio valioso. Nuestras estructuras de asociación flexibles incluyen empresas educativas, patrocinadores de esports, distribuidores internacionales y organizaciones de impacto social. Los socios reciben acceso a nuestros programas fáciles de usar, recursos de implementación y opciones de entrenamiento para una experiencia exitosa y disfrutable.',
      solutions_8_title: '[AI_TRANSLATION]Soluciones para Bibliotecas',
      solutions_8_text: '[AI_TRANSLATION]Como un recurso digital completamente autodirigido y a su propio ritmo, CodeCombat es la mejor integración para bibliotecas que quieren empoderar a sus miembros de todas las edades para aprender a programar. Nuestra plataforma ofrece todo lo que los aprendices necesitan para experimentar una educación de codificación de alto nivel a través de un currículo basado en juegos exclusivamente emocionante. Perfecto para principiantes hasta aquellos que quieren dominar conceptos de codificación de nivel universitario.',
      learn_more_text: '[AI_TRANSLATION]Descubre Más',
      best_homeschool_curriculum: '[AI_TRANSLATION]Mejor Curriculum para Homeschooling[NEWLINE]',
      sign_up_free: '[AI_TRANSLATION]Regístrate Gratis',
      try_it_now: '[AI_TRANSLATION]Pruébalo ahora',
    },

    schools_page: {
      most_effective_computer_science_solution: '[AI_TRANSLATION]La solución de ciencias de la computación más efectiva para **escuelas**',
      our_comprehensive_implementation: '[AI_TRANSLATION]Nuestra implementación integral empodera a los profesores, involucra a los estudiantes y entrega resultados exitosos.',
      get_my_solution: '[AI_TRANSLATION]Obtén Mi Solución',
      let_us_craft_a_custom_program: '[AI_TRANSLATION]¡Permitámonos diseñar un programa a medida para usted!',
      flexible_standards_aligned_curriculum_title: '[AI_TRANSLATION]Un Currículo Flexible Alineado a Estándares',
      flexible_standards_aligned_curriculum_text: '[AI_TRANSLATION]Nuestro enfoque escalonado cubre los fundamentos de la informática hasta cursos avanzados y características **[https://codecombat.com/apcsp]AP CSP avalado por el College Board**, desarrollo web y de juegos. Construimos caminos personalizados para ofrecer una experiencia de aprendizaje personalizada que cumple con los **[https://codecombat.com/standards]estándares CSTA, ISTE y Common Core State Standards**. El currículo flexible ofrece la capacidad de enseñar Python, JavaScript, C++, Luau y más.',
      comprehensive_tools_resources_title: '[AI_TRANSLATION]Herramientas y Recursos Integrales',
      comprehensive_tools_resources_text: '[AI_TRANSLATION]El centro de recursos para profesores empodera a todos los educadores para enseñar desde el primer día. Accede fácilmente a planes de lecciones, diapositivas de lecciones para estudiantes, rúbricas, actividades de ampliación, proyectos de fin de curso y evaluaciones. Nuestras integraciones seguras de IA aceleran el potencial estudiantil y permiten a los educadores optimizar el tiempo de clase. Para la práctica y aplicación en el mundo real, ofrecemos esports de codificación competitivos, diseño de juegos Roblox y opciones de diseño web. Además, los educadores pueden controlar el ritmo de los estudiantes con funciones de asignación y bloqueo de contenido.',
      accessible_data_insights_title: '[AI_TRANSLATION]Datos e Informes Accesibles',
      accessible_data_insights_text: '[AI_TRANSLATION]Proporcionamos a los administradores la perspectiva que necesitan con datos de uso en tiempo real e informes de progreso a nivel de clase, escuela, distrito y estado. El seguimiento del progreso a nivel de estudiante permite a los educadores identificar fácilmente cuándo es necesaria la intervención y las evaluaciones integradas antes y después del módulo miden la comprensión del estudiante.',
      high_quality_professional_development_title: '[AI_TRANSLATION]Desarrollo Profesional de Alta Calidad',
      high_quality_professional_development_text: '[AI_TRANSLATION]**[https://csteachers.org/pd-opportunities/accredited-pd/]Avalado por la Asociación de Profesores de Informática (CSTA)**, el curso ofrece más de 44 horas de aprendizaje autodirigido, basado en la web y bajo demanda. El programa es a tu propio ritmo y está diseñado para adaptarse a cualquier agenda ocupada. El curso prepara a cualquier persona, con o sin experiencia docente, para implementar con éxito un currículo de CS.',
      earn_up_to_3_graduate_credits: '[AI_TRANSLATION]Gana hasta 3 créditos de posgrado con este curso.',
      request_a_demo: '[AI_TRANSLATION]Solicitar una demostración',
      maximize_your_impact: '[AI_TRANSLATION]Todas las herramientas para maximizar los resultados del aprendizaje',
      core_curriculum: '[AI_TRANSLATION]Currículo Básico',
      practice_enrichment: '[AI_TRANSLATION]Práctica y Enriquecimiento',
      student_acceleration_ap_csp: '[AI_TRANSLATION]Aceleración del Estudiante y AP CSP',
      young_learners: '[AI_TRANSLATION]Aprendices Jóvenes',
      funding_solutions: '[AI_TRANSLATION]Soluciones de Financiamiento',
      support_development: '[AI_TRANSLATION]Apoyo y Desarrollo',
      ai_support_acceleration_title: '[AI_TRANSLATION]Soporte y Aceleración de IA',
      ai_support_acceleration_text: '[AI_TRANSLATION]Utilizamos la IA para hacer el tiempo de enseñanza más efectivo. CodeCombat ahora soporta una función de pistas de IA que evalúa el código, señala errores y explica cómo solucionarlos. Lo más importante es que proporciona todo el contexto necesario para entender el porqué, sin revelar la solución completa. Los estudiantes aún necesitarán trabajar a través de cada desafío de codificación de nivel, pero ahora no necesitas detener la clase para abordar necesidades individuales. **Los profesores reciben una asignación de 100 pistas de IA por día** y **cada estudiante recibe 5 pistas de IA por día**, para asegurar que siempre tengan el apoyo que necesitan.',
      codecombat_ai_hackstack_text: '[AI_TRANSLATION]Para aquellos nuevos en IA, ofrecemos **CodeCombat AI HackStack**. Esta herramienta innovadora no solo enseña a los estudiantes cómo usar IA, sino que proporciona acceso seguro a muchos de los LLM más recientes, incluyendo ChatGPT-4, Claude, Stable Diffusion, DALL-E y otros. Después de un corto tiempo trabajando en el modo de entrenamiento, los usuarios desbloquean todo el potencial creativo de la herramienta, permitiendo proyectos de indicación-a-código-a-publicados en minutos. Esta aplicación potenciada por IA permite a los usuarios generar juegos, arte, sitios web, código y más. **Los profesores reciben una asignación de 100 indicaciones de IA por mes** y **cada estudiante recibe 10 indicaciones de IA por semana**, para crear múltiples proyectos de IA.',
      pathways_for_success: '[AI_TRANSLATION]Caminos para el Éxito',
      ...
      k: '[AI_TRANSLATION]K',
      icons_block_based: '[AI_TRANSLATION]Iconos y Basado en Bloques',
      introduction_to_ai: '[AI_TRANSLATION]Introducción a la IA',
      grade_1: '[AI_TRANSLATION]Grado 1',
      simple_ai_templates: '[AI_TRANSLATION]Plantillas Simples de IA',
      ...
      our_k_5_implementation_pathway: '[AI_TRANSLATION]Nuestro Camino de Implementación K-5 introducirá dos nuevas plataformas **amigables para principiantes** que incluyen CodeCombat Junior, nuestra currícula elemental insignia que presenta una progresión de niveles de aprendizaje que **enseñan conceptos básicos de programación a un ritmo más lento**, y AI HackStack Junior, una **herramienta AI multimodal** que permite a los estudiantes esbozar, escribir y diseñar sus propios productos digitales. Esta progresión escalonada permitirá a los estudiantes crecer con nuestro contenido inmersivo y explorar una amplia variedad de pensamiento computacional y conceptos de ciencias de la computación.',
      middle_school: '[AI_TRANSLATION]Escuela Intermedia',
      high_school: '[AI_TRANSLATION]Escuela Secundaria',
      ozaria: '[AI_TRANSLATION]Ozaria',
      ai_hackstack: '[AI_TRANSLATION]AI HackStack',
      ai_league: '[AI_TRANSLATION]Liga de IA',
      ...
      introduction_to_coding_esports: '[AI_TRANSLATION]Introducción a los Esports de Codificación',
      ...
      game_development: '[AI_TRANSLATION]Desarrollo de Juegos',
      open_ended_ai_projects: '[AI_TRANSLATION]Proyectos de IA Abiertos',
      middle_school_implementation: '[AI_TRANSLATION]Nuestra implementación en la escuela intermedia establece una **fundación de conceptos de codificación** con Ozaria, nuestro currículo central de Ciencias de la Computación. Esto eventualmente se expande a más voz y elección, donde los estudiantes **explorarán la codificación y la IA** a través de tres plataformas diversas. El **educador y los estudiantes pueden elegir** qué tan profundamente explorarán cada una de estas plataformas adicionales.',
      codecombat: '[AI_TRANSLATION]CodeCombat',
      ap_csp: '[AI_TRANSLATION]AP CSP',
      cs1_4_data_science_cybersecurity_exam_content: '[AI_TRANSLATION]CS1-4 [NEWLINE] Ciencia de Datos [NEWLINE] Ciberseguridad [NEWLINE] Contenido de Examen',
      advanced_cs: '[AI_TRANSLATION]CS Avanzado',
      cs5_6_gd1_3_wd1_2: '[AI_TRANSLATION]CS 5-6 [NUEVA LÍNEA] GD 1-3 [NUEVA LÍNEA] WD 1-2',
      advanced_game_development: '[AI_TRANSLATION]Desarrollo Avanzado de Juegos',
      advanced_ai_projects: '[AI_TRANSLATION]Proyectos Avanzados de IA',
      global_esports_tournament: '[AI_TRANSLATION]Torneo Global de Esports',
      first_year_high_school_curriculum: '[AI_TRANSLATION]El primer año de nuestro currículo de escuela secundaria se centra en **AP CS Principles**, que incluye nuestros cursos de CodeCombat, CS1−CS4 y contenido del currículo del examen como **Ciencia de Datos** y **Sistemas de Computación**. El año más avanzado permite a los estudiantes explorar más de nuestros **cursos avanzados de CS** y ofrece voz y elección en nuestras tres plataformas.',
      accessibility_representation_title: '[AI_TRANSLATION]Accesibilidad y Representación',
      accessibility_representation_text: '[AI_TRANSLATION]Nuestro diseño centrado en el estudiante encuentra a los estudiantes donde están y les proporciona el apoyo que necesitan. Las capacidades de aprendizaje presencial y remoto permiten a los estudiantes aprender en cualquier lugar y en cualquier momento. La accesibilidad de teclado, la compatibilidad completa con lectores de pantalla y el esquema de colores amigable para personas con daltonismo garantiza que todos puedan aprender a programar.',
      privacy_security_title: '[AI_TRANSLATION]Privacidad y Seguridad',
      privacy_security_text: '[AI_TRANSLATION]Tomamos la seguridad de los estudiantes, la ciberseguridad y la privacidad de datos seriamente, y seguimos las estrictas regulaciones de privacidad a nivel escolar incluyendo COPPA, FERPA, SOPIPA, California AB 1584, CalOPPA, Prácticas de Información Justas, CAN-SPAM, así como el GDPR. Todos los datos están almacenados de manera segura en Amazon Web Services en los EE. UU. Nuestras integraciones de IA tienen barreras de protección para la Información Personal Identificable y restringen el contenido sensible. El compartir proyectos está controlado y la comunicación entre pares está restringida. Están disponibles Acuerdos de Procesamiento de Datos, visite **https://codecombat.com/privacy** para más información.',
      ...
      testimonials_1_quote: '[AI_TRANSLATION]“Déjame aclarar esto primero. Recomiendo su producto porque es la mejor herramienta de enseñanza de programación actualmente en la Tierra.”',
      testimonials_1_name: '[AI_TRANSLATION]Seth Reichelson',
      testimonials_1_title: '[AI_TRANSLATION]Profesor de Informática AP, Lake Brantley High School. Ganador del premio White House Champion of Change',
      testimonials_2_quote: '[AI_TRANSLATION]"[Ozaria] es un currículo completo para la educación en ciencias de la computación, es impresionantemente completo, muy extenso [...] Tiene todo lo que necesitas [...] No sé si hemos visto algo con tantos recursos adicionales para ayudarte a enseñar bien."',
      testimonials_2_name: '[AI_TRANSLATION]Tanner Higgin',
      testimonials_2_title: '[AI_TRANSLATION]Directora Editorial - Contenido Educativo, Educación de Sentido Común',
      testimonials_2_full_review_text: '[AI_TRANSLATION]Revisión Completa Aquí',
      testimonials_3_quote: '[AI_TRANSLATION]“CodeCombat fue uno de los programas más fáciles de implementar que hemos probado y el compromiso de los estudiantes fue extremadamente alto. La forma en que el contenido está diseñado, se andamia perfectamente y permite a los estudiantes avanzar rápidamente hacia habilidades de programación de alto nivel mucho más allá de todo lo que podríamos haber esperado.”',
      ...
      testimonials_4_quote: '[AI_TRANSLATION]"Una cosa que ahora puedo hacer y que antes no podía hacer es creer realmente que puedo programar."',
      testimonials_4_title: '[AI_TRANSLATION]Estudiante de la Escuela Secundaria Mountain Ridge',
      testimonials_5_quote: '[AI_TRANSLATION]"CodeCombat ha transformado cómo enseño a programar... Utilizo los excelentes recursos para maestros incluidos Guías del Currículo, Guías de Proyectos y Soluciones. Usar CodeCombat me ha ayudado a enseñar conceptos bastante avanzados de una manera que los estudiantes disfrutan y comprenden. Lo que más me gusta de CodeCombat es que no simplifica la programación. Los estudiantes están aprendiendo a escribir código real, pero de una manera que se divierten haciéndolo."',
      testimonials_5_name: '[AI_TRANSLATION]Sandra Ahlstrom',
      testimonials_5_title: '[AI_TRANSLATION]Docente, Distrito Escolar del Condado de Sheridan #2',
      faq_1_question: '[AI_TRANSLATION]Lo que necesitas saber sobre los exámenes de certificación y AP CSP',
      faq_1_answer: '[AI_TRANSLATION]Los programas de Educación Técnica Profesional (CTE) en EE. UU. se enfocan en equipar a los estudiantes con habilidades valoradas por la industria y pueden conducir a una educación en escuelas técnicas o universidades. Dictados por leyes estatales y federales, los programas CTE deben ofrecer a los estudiantes créditos postgraduados, certificaciones de la industria o horas de pasantía. Mientras algunos campos, como la ciberseguridad, ofrecen exámenes de certificación valorados, otros, como la ingeniería de software, priorizan los títulos de cuatro años por sobre dichos exámenes. Sin embargo, aprobar el examen de Principios de Ciencias de la Computación AP sirve como una vía reconocida hacia el crédito postsecundario, permitiendo a los estudiantes evitar requisitos universitarios costosos y que consumen mucho tiempo. Para ayudar a preparar a los estudiantes, CodeCombat ofrece un **[https://codecombat.com/apcsp]curso de AP CSP**, respaldado por el College Board.',
      faq_2_question: '[AI_TRANSLATION]Cómo utilizamos la IA para apoyar a los educadores',
      faq_2_answer: '[AI_TRANSLATION]Utilizamos IA para hacer el tiempo de enseñanza más efectivo. Con el aumento del tamaño de las clases y el tiempo limitado para la instrucción personalizada, nuestro asistente de chat de nivel impulsado por IA es la herramienta perfecta para atender las preguntas individuales de tus estudiantes. Este poderoso ayudante puede evaluar código, señalar errores, explicar cómo corregirlos y proporcionar todo el contexto que necesitan para entender el "por qué". Y lo más importante, no les dará la solución. Con solo asistencia de la próxima línea disponible, los estudiantes aún necesitarán trabajar a través del desafío de codificación de cada nivel, pero ahora no necesitas detener la clase para abordar necesidades individuales.',
      faq_3_question: '[AI_TRANSLATION]Cómo integramos la IA de manera segura y responsable',
      faq_3_answer: '[AI_TRANSLATION]Nuestra tecnología de IA se adhiere a principios de seguridad primero, brindando confianza tanto a estudiantes como a educadores. No permitimos que nuestros proveedores de LLM entrenen sus chats y hemos establecido medidas de protección contra contenido inapropiado. Estas medidas incluyen filtrar lenguaje dañino, mantener el foco en temas relevantes, proteger información personal, y educar a los estudiantes sobre posibles trampas de la IA. Además, registramos la actividad de chat de IA para el monitoreo del profesor y mantenemos protocolos estrictos de privacidad y seguridad de datos.',
      faq_4_question: '[AI_TRANSLATION]Por qué la informática es importante',
      faq_4_answer: '[AI_TRANSLATION]La educación en ciencias de la computación ofrece beneficios inmediatos al impulsar las competencias de resolución de problemas, agudizar las habilidades matemáticas y fomentar el pensamiento lógico necesario para el éxito en otras materias escolares fundamentales. El aprendizaje va mucho más allá del código, mejorando la capacidad de los estudiantes para resolver problemas complejos y adaptarse a diferentes situaciones. Mira cómo Ozaria ayuda a hacer esas **[conexiones curriculares cruzadas](https://docs.google.com/presentation/d/1xcc1tw4k8oY9basXuxO0v_RU9z-Dr8ImvbvbuNvJeHA/edit#slide=id.g134a7e7c8f1_0_3)**. Nuestro currículo está diseñado para equipar a los estudiantes de hoy con las habilidades cruciales en ciencias de la computación que los prepararán para los trabajos digitales del mañana.',
      faq_5_question: '[AI_TRANSLATION]Por qué la enseñanza basada en juegos funciona',
      faq_5_answer: '[AI_TRANSLATION]El aprendizaje basado en juegos es tan efectivo porque proporciona un ambiente seguro donde no se teme al fracaso sino que se espera, ofreciendo una oportunidad para el crecimiento y la comprensión. Este enfoque anima a los estudiantes a aprender de sus errores y adaptar sus estrategias para el éxito. Además, la naturaleza interactiva y dinámica de los juegos ayuda a los estudiantes a retener la información más efectivamente, ya que están aprendiendo a través de experiencias prácticas y directas. Involucra activamente a los estudiantes en el proceso de aprendizaje, aumentando su motivación y disfrute.',
      faq_6_question: '[AI_TRANSLATION]Cómo encontrar fuentes de financiación alternativas',
      faq_6_answer: '[AI_TRANSLATION]La educación en informática se ha convertido en un componente vital del recorrido académico de un estudiante, sin embargo, muchas escuelas enfrentan desafíos para asegurar los recursos necesarios para proporcionar a sus estudiantes programas completos de ciencias de la computación. En CodeCombat, entendemos los obstáculos de financiamiento que las escuelas encuentran y nos apasiona ayudarlos a superar estas barreras. Las subvenciones pueden ser un recurso valioso pero difícil de descubrir y solicitar. Consulte nuestra **[https://codecombat.com/grants]guía completa para la financiación por subvenciones** o hable con nuestro equipo para obtener más información.',
      faq_7_question: '[AI_TRANSLATION]Cómo empezar',
      faq_7_answer_1: '[AI_TRANSLATION]Crea tu Cuenta de Maestro o Administrador',
      faq_7_answer_2: '[AI_TRANSLATION]Crear una clase',
      faq_7_answer_3: '[AI_TRANSLATION]Agregar estudiantes',
      faq_7_answer_4: '[AI_TRANSLATION]Siéntate y observa cómo tus estudiantes se divierten aprendiendo a programar',
      faq_8_question: '[AI_TRANSLATION]Soporte para inicio de sesión con Clever y Google',
      faq_8_answer: '[AI_TRANSLATION]Ofrecemos integración tanto con Clever como con Google Classroom. Consulta nuestras **[https://codecombat.com/teachers/resources/clever-faq]Preguntas Frecuentes sobre Integración con Clever** para más detalles sobre cómo comenzar. Si usas Google Classroom, asegúrate de usar el Modal de Inicio de Sesión Único (SSO) de Google para registrarte en tu cuenta de profesor. Si ya tienes una cuenta con tu correo de Google, usa el modal de SSO de Google para iniciar sesión la próxima vez. En el modal de Crear Clase, verás una opción para Vincular Google Classroom. Actualmente solo apoyamos el listado de clases a través de Google Classroom. Nota: debes usar el SSO de Google para registrarte o iniciar sesión al menos una vez para ver la opción de integración de Google Classroom.',
      faq_9_question: '[AI_TRANSLATION]Navegador y sistema operativo recomendados',
      faq_9_answer: '[AI_TRANSLATION]CodeCombat y Ozaria funcionan mejor en computadoras con al menos 4GB de RAM, en un navegador moderno como Chrome, Safari, Firefox o Edge. Los Chromebooks con 2GB de RAM pueden tener problemas gráficos menores en cursos posteriores. Se requiere un mínimo de 200 Kbps de ancho de banda por estudiante, aunque se recomienda 1+ Mbps.',
      core_curriculum_1_title: '[AI_TRANSLATION]Aula Ozaria',
      ...
      core_curriculum_2_text: '[AI_TRANSLATION]Un currículo de CS completo que construye desde conceptos básicos hasta el desarrollo web, desarrollo de juegos y **[http://codecombat.com/apcsp]AP CSP**.',
      core_curriculum_2_link_text: '[AI_TRANSLATION]Pruébalo ahora',
      practice_enrichment_1_title: '[AI_TRANSLATION]Liga de Esports de CodeCombat AI',
      practice_enrichment_1_text: '[AI_TRANSLATION]Una plataforma épica de esports de codificación competitiva que fomenta la programación creativa en un entorno basado en juegos.',
      ...
      practice_enrichment_2_text: '[AI_TRANSLATION]En asociación con Roblox Education, esta experiencia habilitada por IA potencia las habilidades de programación de los estudiantes y proporciona una plataforma real para crear juegos y experiencias asombrosos.',
      practice_enrichment_2_link_text: '[AI_TRANSLATION]Pruébalo ahora',
      student_acceleration_1_title: '[AI_TRANSLATION]HackStack de CodeCombat AI',
      student_acceleration_1_text: '[AI_TRANSLATION]La primera herramienta complementaria de IA generativa específicamente diseñada para aquellos nuevos en la IA, con un enfoque en la privacidad y seguridad de los estudiantes. Mezclando simplicidad y potencia, la plataforma acelera las habilidades de los estudiantes y desata su potencial creativo.',
      student_acceleration_1_link_text: '[AI_TRANSLATION]Pruébalo ahora',
      student_acceleration_2_title: '[AI_TRANSLATION]Preparaciones para el Examen AP CSP',
      student_acceleration_2_text: '[AI_TRANSLATION]Somos reconocidos por el College Board como un proveedor avalado de currículum y desarrollo profesional para los Principios de Informática AP® (AP CSP). Nuestro currículum AP CSP proporciona herramientas basadas en juegos y listas para usar para preparar a los estudiantes para el examen AP.',
      young_learners_1_title: '[AI_TRANSLATION]CodeCombat Jr.',
      young_learners_1_text: '[AI_TRANSLATION]Nuestro currículo estrella de K-5 presenta una progresión de niveles de aprendizaje que enseñan conceptos básicos de codificación a un ritmo más lento, diseñado específicamente para estudiantes de primaria.',
      young_learners_1_link_text: '[AI_TRANSLATION]Registrarse para Acceso Beta',
      young_learners_2_title: '[AI_TRANSLATION]AI HackStack Jr.',
      young_learners_2_text: '[AI_TRANSLATION]Presenta la AI generativa multimodal en una plataforma simple e intuitiva diseñada específicamente para estudiantes de K-5.',
      young_learners_2_link_text: '[AI_TRANSLATION]Registrarse para Acceso Beta',
      funding_solutions_1_title: '[AI_TRANSLATION]Fuentes de Becas y Financiamiento',
      funding_solutions_1_text: '[AI_TRANSLATION]Entendemos los obstáculos de financiamiento que enfrentan las escuelas y nos apasiona ayudar a superar estos desafíos. Consulta nuestra guía completa sobre financiación de subvenciones o habla con nuestro equipo para saber más.',
      funding_solutions_1_link_text: '[AI_TRANSLATION]Descubre Más',
      support_development_1_title: '[AI_TRANSLATION]Clases en Vivo Online',
      support_development_1_text: '[AI_TRANSLATION]¿Quieres proporcionar instrucción de alta calidad en CS, pero no tienes el personal para ejecutarlo? Nuestro equipo de instructores maestros puede proporcionar lecciones virtuales atractivas perfectas para programas dentro de la clase o después de la escuela.',
      support_development_1_link_text: '[AI_TRANSLATION]Registrarse para Acceso Beta',
      faq_header: '[AI_TRANSLATION]Preguntas Frecuentes',
      faq_see_more: '[AI_TRANSLATION]Vea más preguntas frecuentes en nuestro **[https://codecombat.zendesk.com/hc/es]centro de ayuda**.',
      trends_1_title: '[AI_TRANSLATION]¡La IA no está reemplazando la programación, la está acelerando!',
      trends_1_text: '[AI_TRANSLATION]Oficialmente hemos entrado a la era de la IA. Junto con el bombo y la exageración llega una ola de miedo e incertidumbre respecto al futuro de la ciencia de la computación. Videos de IA escribiendo código con entradas simples e historias de ingenieros reemplazados por bots de IA alimentaron una narrativa dramática pero, en última instancia, errónea. ¡La verdad es que la IA no está reemplazando la programación; la está acelerando!',
      trends_1_linkText: '[AI_TRANSLATION]Leer el Blog',
      trends_2_title: '[AI_TRANSLATION]Educación Técnica de Carreras con Pat Keeney',
      trends_2_text: '[AI_TRANSLATION]La Educación Técnica de Carrera (CTE) prepara a los estudiantes para convertirse en aprendices de por vida y les proporciona las habilidades y conocimientos que necesitan para tener éxito en sus futuras carreras. En este episodio, Pat Keeney, Campeón de CTE en McGraw Hill, comparte su experiencia',
