...
export default { nativeDescription: "Svenska", englishDescription: "Swedish", translation: {
...
//    code_line_number: "1 Billion"
  ...
  new_home: {
    title_coco: "CodeCombat - Kodspel för att läsa sig Python och JavaScript",
    title_ozar: "CodeCombat - Kodspel för att läsa sig Python och JavaScript",
//    title_cn_home: "CodeCombat|Python, Javascript"
    meta_keywords_coco: "CodeCombat, python, javascript, Kodspel",
    meta_keywords_ozar: "CodeCombat, python, javascript, Kodspel",
    meta_description_coco: "Lär dig att skriva kod genom att spela. Lär dig Python, JavaScript, och HTML medans du löser pussel och lär dig att skapa kodspel och websidor.",
    meta_description_ozar: "Lär dig att skriva kod genom att spela. Lär dig Python, JavaScript, och HTML medans du löser pussel och lär dig att skapa kodspel och websidor.",
...
//    classroom_in_box_blurb4: "" # only for koudashijie.com
    ...
    quotes_quote1: "Namnge ett program online, jag har provat det. Ingen av dem matchar CodeCombat. Alla lärare som vill att eleverna ska lära sig att koda ... börja här!", // {change}
...
//    related_urls: "Related Links"
    ...
    resource_hub: "Resurs Hub", // {change}
...
//    confirm_individual_blurb_without_email: "Write down your login information in case you need it later."
    ...
    teacher_students_can_start_now_coco: "Dina elever kommer kunna börja spela första kursen, Introduktion till datavetenskap, direkt.",
    teacher_students_can_start_now_ozar: "Dina elever kommer kunna börja spela första kursen, Introduktion till datavetenskap, direkt.",
    ...
    teacher_list_resource_hub_2_coco: "Kursguider",
    teacher_list_resource_hub_2_ozar: "Kursguider",
    teacher_list_resource_hub_3: "för lösningar till alla nivåer och",
    teacher_list_resource_hub_4: "Resurs Hub", // {change}
...
//    play_without_saving: "Play without saving"
  ...
  common: {
    default_title_coco: "CodeCombat - Kodningsspel för att lära dig Python och JavaScript",
    default_title_ozar: "CodeCombat - Kodningsspel för att lära dig Python och JavaScript",
//    ozaria: "Ozaria"
    default_meta_description_coco: "Lär dig skriva kod genom ett programmeringsspel. Lär dig Python, JavaScript och HTML när du löser pussel och lär dig att skapa dina egna kodningsspel och webbplatser.",
    default_meta_description_ozar: "Lär dig skriva kod genom ett programmeringsspel. Lär dig Python, JavaScript och HTML när du löser pussel och lär dig att skapa dina egna kodningsspel och webbplatser.",
...
//    description_coming_soon: "Description coming soon"
  ...
  options: {
    ...
    editor_config_title_coco: "Redigerarinställningar",
    editor_config_title_ozar: "Redigerarinställningar",
...
//    bdm_title: "Business Development Manager"
    community_subtitle: "Över 500 bidragsgivare har hjälpt till att bygga CodeCombat, med fler som ansluter varje vecka!", // {change}
    ...
    number_contributors: "Över 450 bidragsgivare har gett sitt stöd och tid till detta projekt.", // {change}
...
//    license_code_used: "License Code used."
  ...
  teachers_quote: {
    subtitle_coco: "Lär dig mer om CodeCombat med en interaktiv genomgång av produkten, prissättning och implementering!",
...
//    anything_else_helper: ""
    ...
    thanks_sub_header_coco: "Tack för att du uttryckte intresse för CodeCombat för din skola.",
