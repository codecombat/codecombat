...
#    related_urls: "Related Links"
    ...
    resource_hub: "Centre de Recursos" # {change}
...
#    confirm_individual_blurb_without_email: "Write down your login information in case you need it later."
    ...
    teacher_list_resource_hub_4: "Centre de Recursos" # {change}
...
#    capstone_solution: "Capstone Solution"
    ...
    solution_project_blurb: "Es recomana a l'alumnat que construeixi un projecte creatiu en aquest nivell. La solució que es proporciona a continuació compleix els requisits del nivell del projecte." # {change}
...
#    revoke_selected_confirm: "Are you sure you want to revoke Licenses from all selected students?"
    ...
    teacher_quest_teach_methods_step2: "Imprimir la [Guia d'introducció per l'alumnat](https://files.codecombat.com/docs/resources/StudentQuickStartGuide.pdf) del Centre de Recursos." # {change}
    ...
    teacher_quest_wakka_maul_100_step2: "Veure la [Guia del Camp de Joc](/teachers/resources/arenas) al [Centre de Recursos](/teachers/resources) per trobar idees sobre com fer un joc de camp amb èxit." # {change}
    ...
    back_to_resource_hub: "Tornar al Centre de Recursos" # {change}
