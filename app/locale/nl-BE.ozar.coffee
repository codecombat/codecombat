...
#    back_classroom: "Back to classroom"
    back_courses: "Terug naar mijn lessen" # {change}
...
#    view_project_gallery: "view my classmates' projects"
    join_class: "Vervoeg Een Klas" # {change}
#    join_class_2: "Join class"
    ask_teacher_for_code: "Vraag je docent als je een CodeCombat klasse code hebt! Zo ja, vul die hieronder in:" # {change}
    enter_c_code: "<Voer Klas Code In>" # {change}
    join: "Vervoeg"
