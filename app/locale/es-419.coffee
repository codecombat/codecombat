module.exports = nativeDescription: "Español (América Latina)", englishDescription: "Spanish (Latin America)", translation:
  home:
    ...
    no_ie: "CodeCombat no funciona en Internet Explorer 8 o versiones anteriores. ¡Lo sentimos!" # Warning that only shows up in IE8 and older
    ...
    play_campaign_version: "Jugar la Versión Campaña" # Shows up under big play button if you only play /courses
    old_browser: "Uh oh, su navegador es muy viejo para ejecutar CodeCombat. ¡Lo sentimos!" # Warning that shows up on really old Firefox/Chrome/Safari
    old_browser_suffix: "Puedes probar de todos modos, pero probablemente no funcione."
    ipad_browser: "Malas noticias: CodeCombat no funciona en el navegador del iPad. Buenas noticias: nuestra aplicación nativa para iPad está esperando la aprobación de Apple."
    campaign: "Campaña"
    ...
    or_ipad: "O descarguelo para iPad"
  ...
  diplomat_suggestion:
    ...
    sub_heading: "Necesitamos tus conocimientos lingüisticos."
    pitch_body: "Desarrollamos CodeCombat en inglés, pero ya tenemos jugadores de todo el mundo. Muchos de ellos quieren jugar en español porque no hablan inglés, así que si puedes hablar ambos, por favor considere inscribirse como un Diplomático y ayudar a traducir tanto el sitio web como todos los niveles de CodeCombat al español."
    missing_translations: "Hasta que podamos traducir todo al español, verás en inglés cuando el español no esté disponible."
    learn_more: "Aprende más sobre como ser un Diplomático"
  ...
  play:
    ...
    play_classroom_version: "Jugar la Versión del Aula" # Choose a level in campaign version that you also can play in one of your courses
    campaign_beginner: "Campaña para Principiante"
    awaiting_levels_adventurer_prefix: "Lanzamos nuevos niveles cada semana."
    awaiting_levels_adventurer: "Regístrate como un Aventurero"
    ...
    campaign_multiplayer_description: "... en las que tú código se enfrentará al de otros jugadores."
    campaign_old_multiplayer: "(Obsoleto) Antiguas Arenas Multijugador"
    campaign_old_multiplayer_description: "Reliquias de una era más civilizada. Ninguna simulación es ejecutada para estas antiguas arenas multijugador sin héroes."

  share_progress_modal:
    blurb: "¡Estás haciendo un gran progreso! Cuéntale a tus padre/madre cuánto has aprendido con CodeCombat."
    email_invalid: "Correo electrónico inválido."
    form_blurb: "¡Ingresa el correo electrónico de tu padre/madre y nosotros les mostraremos!"
  ...
  login:
    ...
    load_profile: "Cargar Perfil de G+ "
    finishing: "Finalizando"
    sign_in_with_facebook: "Ingresar con Facebook"
    sign_in_with_gplus: "Ingresar con G+"
  ...
  signup:
    ...
    sign_up: "Registrarse"
    log_in: "inicia sesión con contraseña"
    required: "Necesitas entrar a tu cuenta antes de poder seguir ese camino."
    login_switch: "¿Ya tienes una cuenta?"
    school_name: "Nombre de tu Escuela y tu Ciudad"
    optional: "opcional"
    school_name_placeholder: "Ejemplo: Secundario, Springfield, IL"
  ...
  general:
    ...
    submitter: "Emisor"
    submitted: "Enviado"
    commit_msg: "Mensaje (Commit)"
    version_history: "Historial de Versiones"
    version_history_for: "Historial de Versiones de: "
    select_changes: "Selecciona dos cambios más abajo para ver la diferencia"
    undo_prefix: "Deshacer"
    undo_shortcut: "(Ctrl+Z)"
    redo_prefix: "Rehacer"
    redo_shortcut: "(Ctrl+Shift+Z)"
    play_preview: "Reproducir previsualización del nivel actual"
    result: "Resultado"
    results: "Resultados"
  ...
  play_level:
    ...
    reload: "Reiniciar"
    reload_title: "¿Reiniciar Todo el Código?"
    reload_really: "¿Estás seguro de que quieres reiniciar este nivel al principio?"
    reload_confirm: "Reiniciar Todo"
    victory: "Victoria"
    victory_title_prefix: "¡"
    victory_title_suffix: " Completado!"
    victory_sign_up: "Regístrate para Guardar tu Progreso"
    victory_sign_up_poke: "¿Quieres guardar tu código? ¡Crea una cuenta gratuita!"
    ...
    victory_hour_of_code_done: "¿Has terminado?"
    ...
    victory_viking_code_school: "¡Santo cielo, este nivel que acabas de pasar era dificil! Si todavía no eres un desarrollador de software, deberías serlo. Haz conseguido una aceptación por vía rápida de la Viking Code School, donde puedes llevar tus habilidades al siguiente nivel y convertirte en un desarrollador web profesional en 14 semanas."
    ...
    time_total: "Máximo:"
    time_goto: "Ir a:"
    non_user_code_problem_title: "Imposible Cargar el Nivel"
    infinite_loop_title: "Bucle Infinito Detectado"
    infinite_loop_description: "El código inicial para construir el mundo nunca termina de ejecutarse. Probablemente es muy lento o tiene un bucle infinito. O puede que haya un bug. Puedes tratar ejecutando este código nuevamente o reiniciar el código a su estado por defecto. Si eso no lo arregla, por favor haznoslo saber."
    check_dev_console: "También puedes abrir la consola de desarrollo para ver que es lo que podría estar saliendo mal."
    check_dev_console_link: "(instrucciones)"
    infinite_loop_try_again: "Intentarlo de Nuevo"
    ...
    tip_scrub_shortcut: "Use Ctrl+[ y Ctrl+] para rebobinar y avanzar."
    tip_guide_exists: "Haga click en la guía, dentro del menú del juego (en la parte superior de la página), para obtener información útil."
    tip_open_source: "¡CodeCombat es 100% de código abierto!"
    tip_tell_friends: "¿Disfrutando CodeCombat? ¡Cuéntale a tus amigos acerca de nosotros!"
    ...
    tip_error_free: "Hay dos formas de escribir programas sin errores; sólo la tercera funciona. - Alan Perlis"
    tip_debugging_program: "Si depurar es el proceso de eliminar errores, entonces programar debe ser el proceso de colocarlos. - Edsger W. Dijkstra"
    ...
    tip_harry: "Ey un Hechicero, "
    tip_great_responsibility: "Con una gran habilidad de escribir código viene una gran responsabilidad de depuración."
    tip_munchkin: "Si no comes tus verduras, un enano vendrá por ti mientras duermes."
    tip_binary: "Hay solo 10 tipos de personas en el mundo: aquellas que entienden binario y las que no."
    tip_commitment_yoda: "Un programador debe tener el compromiso más profundo, la mente más seria. ~ Yoda"
    tip_no_try: "Hazlo. O no lo hagas. No lo intentes. - Yoda"
    ...
    tip_hardware_problem: "P: ¿Cuántos programadores son necesarios para cambiar una bombilla?  R: Ninguno, es un problema de hardware."
    tip_hofstadters_law: "Ley de Hofstadter: Siempre toma más tiempo del esperado, incluso cuando tienes en cuenta la Ley de Hofstadter."
    tip_premature_optimization: "La optimización prematura es la raíz de todo mal. - Donald Knuth"
    tip_brute_force: "Cuando estes dudando, usa la fuerza bruta. - Ken Thompson"
    tip_extrapolation: "Solo hay dos tipos de personas: aquellas que pueden extrapolar desde información incompleta..."
    tip_superpower: "Programar es la cosa más cercana que tenemos a un superpoder."
    tip_control_destiny: "En el verdadero código abierto, tienes el derecho de controlar tu propio destino. - Linus Torvalds"
    ...
    tip_reusable_software: "Antes de que el software sea reutilizable, primero tiene que ser utilizable."
    ...
    tip_source_code: "Quiero cambiar el mundo, pero ellos no me darían el código fuente."
    tip_javascript_java: "Java es a Javascript lo que móvil es a automóvil. - Chris Heilmann"
    tip_move_forward: "Hagas lo que hagas, siempre sigue hacia adelante. - Martin Luther King Jr."
    tip_google: "¿Tienes un problema que no puedes resolver? ¡Googléalo!"
    tip_adding_evil: "Agregando una pizca de maldad."
    tip_hate_computers: "Ese es el asunto acerca de las personas que piensan que odian las computadoras. Lo que odian en realidad es a los malos programadores. - Larry Niven"
    ...
    tip_free_your_mind: "Tienes que dejar ir todo, Neo. Miedo, dudas, e incredulidad. Libera tu mente. - Morpheus"
    tip_strong_opponents: "Incluso el oponente más fuerte siempre tiene una debilidad. - Itachi Uchiha"
    tip_paper_and_pen: "Antes de comenzar a programar, puedes siempre planificar con papel y birome."
  ...
  game_menu:
    ...
    options_caption: "Configurar ajustes"
  ...
  subscribe:
    ...
    feature1: "+110 niveles basicos a lo largo de 4 mundos"
    feature2: "¡10 <strong>héroes nuevos</strong> y poderosos con habilidades únicas!"
    feature3: "+80 niveles extras"
    feature4: "¡<strong>3500 gemas extras</strong> cada mes!"
    feature5: "Video tutoriales"
    feature6: "Soporte Premium vía correo electrónico"
    feature7: "<strong>Clanes</strong> Privados"
    free: "Gratis"
    month: "mes"
    must_be_logged: "Primero debes iniciar sesión. Por favor, crea una cuenta o inicia sesión desde el menú superior."
    subscribe_title: "Suscribirse"
    unsubscribe: "Dar de baja"
    confirm_unsubscribe: "Confirmar la baja"
    never_mind: "No te preocupes, aún así te quiero"
    thank_you_months_prefix: "Gracias por apoyarnos en estos ultimos"
    ...
    unsubscribe_feedback_placeholder: "O, ¿Qué es lo que hemos hecho?"
    parent_button: "Preguntale a tu padre/madre"
    parent_email_description: "Les mandaremos a ellos un email, así pueden comprarte la suscripción a CodeCombat."
    parent_email_input_invalid: "Correo electrónico invalido."
    parent_email_input_label: "Correo electrónico de tu padre/madre"
    parent_email_input_placeholder: "Ingresa el email de tu padre/madre"
    parent_email_send: "Enviar çorreo"
    parent_email_sent: "¡Correo enviado!"
    parent_email_title: "¿Cuál es el email de tu padre/madre?"
    parents: "Para Padres"
    parents_title: "Estimado Padre/Madre: Su hijo está aprendiendo a programar. ¿Le apoyaría para que continue?"
    parents_blurb1: "Su hijo ha jugado __NLevels__ niveles y ha aprendido conceptos básicos de programación. Ayudelo a cultivar sus interes y comprele una suscripción para que pueda seguir jugando."
    parents_blurb1a: "La Programación de Computadoras es una habilidad fundamental que su hijo usará indudablemente cuando sea adulto. Para el 2020, serán requeridas habilidades básicas en software  por el 77% de los empleos, y los ingenieros de software son altamente demandados alrededor del mundo. ¿Sabía que Informática es el título universitario mejor pago?"
    parents_blurb2: "Por ${{price}} USD/mes, su hijo obtendrá nuevos desafíos cada semana y soporte personal vía correo electrónico de programadores profesionales."
    parents_blurb3: "Sin Riesgo: Garantía del 100% al devolverle su dinero, fácil darse de baja con 1-click."
    payment_methods: "Metodos de Pago"
    payment_methods_title: "Metodos de Pago Aceptados"
    payment_methods_blurb1: "Actualmente aceptamos tarjetas de credito y Alipay. Tambíen puedes usar PayPal por {{three_month_price}} USD a nick@codecombat con tu cuenta de email anotada para adquirir una suscripción de tres meses y gemas, o ${{year_price}} por un año."
    payment_methods_blurb2: "Si necesitas una forma de pago alternativa, por favor contactese"
    sale_button: "¡Venta!"
    sale_button_title: "Ahorre $21 al adquirir una suscripción anual"
    stripe_description: "Suscripción Mensual"
    stripe_description_year_sale: "Suscripción Anual (${{discount}} de descuento)"
    ...
    will_be_cancelled: "Cancelado el"
    currently_free: "Actualmente tienes una suscripción gratuita"
    currently_free_until: "Actualmente tienes una suscripción gratuita hasta el"
    was_free_until: "Tuviste una suscripción gratuita hasta el"
  ...
  choose_hero:
    ...
    programming_language_description: "¿Cuál lenguaje de programación quieres usar?"
    default: "Por Defecto"
    experimental: "Experimental"
    python_blurb: "Simple pero poderoso, excelente para novatos y expertos."
    javascript_blurb: "El lenguaje de la web. (No es lo mismo que Java)."
    coffeescript_blurb: "Sintaxis más bonita que Javascript."
    clojure_blurb: "Un Lisp moderno."
    lua_blurb: "Lenguaje de scripting para juegos."
    io_blurb: "Simple pero oscuro."
    status: "Estado"
    hero_type: "Tipo"
    weapons: "Armas"
    weapons_warrior: "Espadas - Corto Alcance, Sin Magia"
    weapons_ranger: "Ballestas, Armas de Fuego - Largo Alcance, Sin Magia"
    ...
    restricted_to_certain_heroes: "Sólo algunos héroes pueden jugar este nivel."
  ...
  skill_docs:
    ...
    action_specific_cooldown: "Reutilización"
    action_damage: "Daño"
  ...
  options:
    ...
    music_label: "Música"
    music_description: "Música de fondo encendida/apagada."
    editor_config_title: "Configuración del Editor"
    editor_config_keybindings_label: "Atajos de Teclado"
    editor_config_keybindings_default: "Default (Ace)"
    editor_config_keybindings_description: "Añade atajos de teclado adicionales de los editores conocidos."
    editor_config_livecompletion_label: "Autocompletado en Tiempo Real"
    editor_config_livecompletion_description: "Muestra sugerencias de autocompletado mientras escribes."
    editor_config_invisibles_label: "Mostrar Elementos Invisibles"
    editor_config_invisibles_description: "Visualiza elementos invisibles como espacios o tabulaciones."
    editor_config_indentguides_label: "Mostrar Guías de Indentado"
    ...
    editor_config_behaviors_description: "Autocompleta corchetes, paréntesis y comillas."
  ...
  about:
    ...
    why_paragraph_2_prefix: "De eso se trata la programación. Tiene que ser divertido. No divertido como"
    why_paragraph_2_italic: "¡yay una medalla!"
    why_paragraph_2_center: "sino más bien como:"
    why_paragraph_2_italic_caps: "¡NO MAMÁ, TENGO QUE TERMINAR EL NIVEL!"
    why_paragraph_2_suffix: "Por eso CodeCombat es un juego multijugador, no un curso con lecciones gamificadas. No pararemos hasta que tú no puedas parar -- pero esta vez, eso será algo bueno."
    why_paragraph_3: "Si te vas a enganchar a algún juego, que sea este y conviértete en uno de los magos de la era tecnológica."
    press_title: "Blogeros/Prensa"
    press_paragraph_1_prefix: "¿Quieres escribir sobre nosotros? Sientete libre de descargar y usar todos los recursos incluídos en nuestro"
    press_paragraph_1_link: "paquete de prensa"
    press_paragraph_1_suffix: ". Todos los logos e imágenes pueden ser usados sin contactarnos de forma directa."
    team: "Equipo"
    ...
    rob_blurb: "Programa cosas y esas cosas"
    ...
    josh_blurb: "El Piso es de Lava"
    retrostyle_title: "Ilustración"
    retrostyle_blurb: "Juegos Retro"
    jose_title: "Música"
    jose_blurb: "Despegando"
    carlos_title: "Representante Regional, Brasil"
  ...
  teachers:
    ...
    more_info_1: "Nuestro"
    more_info_2: "foro de maestros"
    more_info_3: "es un buen lugar para contactarse con sus colegas educadores que esten usando CodeCombat."

  teachers_survey:
    title: "Encuesta para Maestros"
    must_be_logged: "Primero debes iniciar sesión. Por favor, crea una cuenta o inicia sesión desde el menú superior."
    retrieving: "Obteniendo información..."
    being_reviewed_1: "Su aplicación para una suscripción gratuita está siendo"
