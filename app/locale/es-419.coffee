module.exports = nativeDescription: "Español (América Latina)", englishDescription: "Spanish (Latin America)", translation:
  ...
  new_home:
    built_for_teachers_title: "Un Juego de Codificación Construido con Maestros en Mente"
    built_for_teachers_blurb: "Enseñar a los niños a codificar puede ser abrumador. CodeCombat ayuda a todos los educadores a enseñar a los estudiantes cómo codificar en JavaScript o Python, dos de los lenguajes de programación más populares. Con un plan de estudios comprensivo que incluye seis unidades de ciencias de computación, y refuerza el aprendizaje a través de unidades en el desarrollo de juegos y desarrollo web basados en proyectos, los niños progresarán en un viaje desde la sintaxis básica hasta la recursión!"
    built_for_teachers_subtitle1: "Ciencias de Computación"
    built_for_teachers_subblurb1: "Comenzando con nuestro curso gratuito de Introducción a las Ciencias de Computación, los estudiantes dominan los conceptos básicos de codificación, tales como bucles de while / for, funciones y algoritmos."
    built_for_teachers_subtitle2: "Desarrollo de Juegos"
    built_for_teachers_subblurb2: "Los alumnos construyen laberintos y utilizan el manejo de entrada básico para codificar sus propios juegos que pueden compartir con amigos y familiares."
...
#    creativity_rigor_blurb2: "Every CodeCombat level is scaffolded based on millions of data points and optimized to adapt to each learner. Practice levels and hints help students when they get stuck, and challenge levels assess students' learning throughout the game."
    creativity_rigor_subtitle3: "Construido para todos profesores, independientemente de la experiencia"
#    creativity_rigor_blurb3: "CodeCombat’s self-paced, standards-aligned curriculum makes teaching computer science possible for everyone. CodeCombat equips teachers with the training, instructional resources, and dedicated support to feel confident and successful in the classroom."
    ...
    featured_partners_blurb3: "La Mejor Selección para el Aprendizaje"
    ...
    for_leaders_blurb: "Un Programa Comprensiva de Ciencias de Computación Alineado con los Estándares"
    for_leaders_subtitle1: "Implementación Fácil"
#    for_leaders_subblurb1: "A web-based program that requires no IT support. Get started in under 5 minutes using Google or Clever Single Sign-On (SSO)."
    for_leaders_subtitle2: "Plan Completa de Estudios de Codificación"
...
#    for_teachers_subblurb3: "Personalize instruction and ensure students understand core concepts with formative and summative assessments."
    for_teachers_subtitle4: "Diferenciacion Automatica"
...
#    login: "Login"
    ...
    teacher_type_2: "Configura a tu clase"
    teacher_type_3: "Accesa guías de cursos"
    teacher_type_4: "Ve el progreso de estudiante"
    signup_as_teacher: "Iniciar sesión como Maestro"
    student_type_1: "Aprende a programar mientras que juegas un juego atractivo"
    student_type_2: "Jugar con tu clase"
    student_type_3: "Compite in arenas"
