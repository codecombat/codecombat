...
#    auth_sign_up: "New to Ozaria? Create an Account"
    sign_up: "Criar Conta"
    email_or_username: "Email ou nome de usuário" # {change}
#    or: "or"
    log_in: "Entrar"
#    sign_in: "Sign In"
    logging_in: "Entrando"
    ...
    sign_in_with_facebook: "Conectar com o Facebook" # {change}
    sign_in_with_gplus: "Conectar com o G+" # {change}
...
#    login: "Login"
    ...
    signup_as_teacher: "Cadastrar Professor" # {change}
    ...
    signup_as_student: "Cadastrar Estudante" # {change}
    ...
    write_this_down: "Anote isto:" # {change}
    ...
    teacher_students_can_start_now: "Seus estudantes poderão começar a jogar o primeiro curso, Introdução a Ciência da Computação, imediatamente" # {change}
    ...
    teacher_list_resource_hub_2: "Guias de Curso" # {change}
...
#    description_coming_soon: "Description coming soon"
  ...
  options:
    ...
    editor_config_title: "Configurações do Editor" # {change}
    editor_config_livecompletion_label: "Autocompletar durante a escrita" # {change}
    ...
    editor_config_behaviors_label: "Comportamentos Inteligentes" # {change}
...
#    meta_description: "Our mission is to level computer science through game-based learning and make coding accessible to every learner. We believe programming is magic and want learners to be empowered to to create things from pure imagination."
    ...
    story_link: "História"
    press_link: "Contato"
    mission_title: "Nossa missão: fazer programação acessível para todos os estudantes." # {change}
...
#    shubhangi_title: "Senior Software Engineer"
    ...
    story_statistic_1c: "Começaram sua jornada de programação através do CodeCombat" # {change}
    ...
    jobs_title: "Venha trabalhar conosco e ajudar a escrever a história do CodeCombat!" # {change}
...
#    referrer_conference: "Conference (e.g. ISTE)"
    ...
    thanks_sub_header: "Obrigado por manifestar interesse no CodeCombat para sua escola." # {change}
...
#    meta_description: "Join a Clan or build your own community of coders. Play multiplayer arena levels and level up your hero and your coding skills."
  ...
  courses:
    ...
    back_classroom: "Voltar para minha turma" # {change}
    back_courses: "Voltar aos meus cursos" # {change}
    ...
    welcome_to_page: "Painel do Estudante" # {change}
    ...
    join_class: "JUNTE - SE A UMA TURMA" # {change}
    join_class_2: "Se juntar a turma"
    ask_teacher_for_code: "Pergunte ao seu professor se você tem o código de uma turma do CodeCombat! Se sim, insira - o abaixo:" # {change}
    enter_c_code: "<Insira o código da turma>" # {change}
    join: "Junte-se"
...
#    unit_complete: "Unit Complete"
    ...
    subtitle: "Rever overview e níveis do curso" # {change}
    ...
    license_required_to_play: "Peça ao seu professor para atribuir uma licença a você para que você possa continuar a jogar CodeCombat!" # {change}
...
#    feedback_capstone: "The student will create a base project in Part 1. They will make creative updates based on peer feedback in Part 2. Here is a <a target=\"_blank\" rel=\"noopener\" href=\"https://docs.google.com/document/d/1itB0vY6WphjINQYJ9NHkILATcLLlYD3GDSg6FJg55OQ\">Peer Feedback Template</a> that you can share with your students."
    ...
    create_teacher_account: "Crie uma Conta do Professor" # {change}
...
#    unit_progress: "Unit Progress"
    ...
    select_course: "Selecione curso para visualizar" # {change}
    ...
    bulk_assign: "Selecionar turma" # {change}
    ...
    assign_course: "Atribuir Curso" # {change}
    removed_course_msg: "{{numberRemoved}} alunos foram removidos de {{courseName}}."
    remove_course: "Remover curso" # {change}
    not_assigned_modal_title: "Cursos não foram atribuídos" # {change}
    ...
    not_assigned_modal_full_body_1: "Este curso necessita de uma licença completa. Você não tem Licenças Completas suficientes disponíveis para atribuir este curso a todos os __selected__ alunos selecionados." # {change}
    ...
    enrollments_blurb: "Os alunos são obrigados a ter uma licença para acessar qualquer conteúdo após o primeiro curso." # {change}
    ...
    how_to_apply_licenses_blurb_1: "Quando um professor atribui um curso a um aluno pela primeira vez, aplicamos automaticamente uma licença. Use a lista de atribuição em massa em sua sala de aula para atribuir um curso a alunos selecionados:" # {change}
    how_to_apply_licenses_blurb_2: "Ainda posso aplicar uma licença sem atribuir um curso?" # {change}
    ...
    educator_faq_desc: "Perguntas frequentes sobre o uso do CodeCombat em sua sala de aula ou escola." # {change}
    teacher_getting_started: "Guia de Iniciação do Professor"
    teacher_getting_started_desc: "Novo no CodeCombat? Faça o download deste Guia de primeiros passos do professor para configurar sua conta, criar sua primeira turma e convidar os alunos para o primeiro curso." # {change}
...
#    hoc_meta_description: "Make your own game or code your way out of a dungeon! CodeCombat has four different Hour of Code activities and over 60 levels to learn code, play, and create."
    ...
    teacher_quest_teach_strings_step2: "Use o seletor de nível de professor na página [Course Guides](/teachers/courses) para prever __True Names__." # {change}
    ...
    view_project_gallery: "Visualizar galeria de projetos" # {change}
    ...
    level_label: "Nível:"
    time_played_label: "Tempo jogado:" # {change}
