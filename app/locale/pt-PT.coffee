...
#    autorun_description: "Control automatic code execution."
    ...
    editor_config_level_language_description: "Defina a linguagem de programação para este nível em particular."
    editor_config_default_language_label: "Linguagem de Programação Predefinida"
    editor_config_default_language_description: "Defina a linguagem de programação na qual deseja programar aquando do começo de novos níveis."
