...
#    subscribe_modal_title: "CodeCombat Premium"
    comparison_blurb: "Aperfeiçoa as tuas habilidades com uma subscrição do CodeCombat!" # {change}
...
#    premium: "Premium" # Make sure the following feature translations don't go onto two lines
    feature1: "__levelsCount__+ níveis básicos dispersos por __worldsCount__ mundos" # {change}
    feature2: "__heroesCount__ <strong>heróis novos</strong> e poderosos com habilidades únicas!" # {change}
    feature3: "__bonusLevelsCount__+ níveis de bónus" # {change}
    feature4: "<strong>{{gems}} gemas de bónus</strong> por mês!" # {change}
...
#    team_values: "We value open and respectful dialog, where the best idea wins. Our decisions are grounded in customer research and our process is focused on delivering tangible results for them. Everyone is hands-on, from our CEO to our GitHub contributors, because we value growth and learning in our team."
    ...
    robin_title: "Pesquisa e Projeção de 'UX'" # {change}
...
#    not: "Not"
  ...
  courses:
    ...
    completed: "Completos:"
    invite_students: "Convida estudantes para entrarem nesta turma."
    invite_link_header: "Ligação para entrar no curso"
    invite_link_p_1: "Dá esta ligação a estudantes que gostarias que entrassem no curso."
...
#    designed_to: "Courses are designed to introduce computer science concepts using CodeCombat's fun and engaging environment. CodeCombat levels are organized around key topics to encourage progressive learning, over the course of 5 hours."
    ...
    enter_code: "Introduz um código de desbloqueio para entrares numa turma existente"
