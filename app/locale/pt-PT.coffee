module.exports = nativeDescription: "Português (Portugal)", englishDescription: "Portuguese (Portugal)", translation:
  ...
  new_home:
    ...
    built_for_teachers_blurb: "Ensinar crianças a programar pode tornar-se esmagador. CodeCombat ajuda todos os educadores a ensinar estudantes como programar em JavaScript e Python, duas das mais populares linguagens de programação. Com um currículo completo que inclui seis unidades de ciência da computação e reforça a aprendizagem através de unidades de desenvolvimento de jogos e páginas web como projeto-base, as crianças irão progredir através de uma aventura que começa na sintaxe básica e termina na recursão!"
    ...
    century_skills_quote1: "Fazes uma asneira... então depois pensas em todas as possibilidades para a resolver, e tentas outra vez. Eu não tería conseguido chegar aqui sem tentar arduamente."
    century_skills_subtitle1: "Pensamento Crítico"
    century_skills_subblurb1: "Com puzzles de código cuja armação é construída em níveis de dificuldade crescente, a programação do jogo CodeCombat assegura que as crianças estão continuamente a praticar o seu pensamento crítico."
...
#    classroom_in_box_blurb4: ""
    ...
    creativity_rigor_blurb2: "Cada nível em CodeCombat é estruturado com base em milhões de pontos de dados e optimizado para se adaptar a cada estudante. Níveis onde os alunos podem praticar e dicas, dão uma ajuda quando ficam presos, níveis de desafio avaliam a aprendizagem dos estudantes ao longo do jogo."
    creativity_rigor_subtitle3: "Construído para todos os professores, independentemente da sua experiência"
    creativity_rigor_blurb3: "O currículo autogerido e alinhado com as normas da CodeCombat torna possível o ensino da Ciência da Computação para todos. CodeCombat equipa os professores com a formação, recursos instrucionais e apoio dedicado para se sentirem confiantes e bem sucedidos na sala de aula."
    ...
    for_leaders_title: "Para os Líderes Escolares"
    for_leaders_blurb: "Um programa informático abrangente e alinhado com as normas"
    ...
    for_leaders_subblurb2: "Um currículo alinhado com padrões, com recursos instrucionais e desenvolvimento profissional para permitir a qualquer professor ensinar ciência da computação."
    for_leaders_subtitle3: "Casos de Utilização Flexível"
    for_leaders_subblurb3: "Quer pretenda adquirir conhecimento em programação, compatíveis com o Ensino Preparatório e ou o Ensino Técnico e Profissional, o CodeCombat é adaptado às suas necessidades."
    for_leaders_subtitle4: "Habilidades para o Mundo Real"
    for_leaders_subblurb4: "Os estudantes constroem coragem e desenvolvem uma mentalidade de crescimento através de desafios de programação que os preparam para os empregos disponíveis em programação."
    ...
    for_teachers_subblurb2: "Ver dados sobre o progresso dos alunos, descobrir recursos curriculares, e aceder a apoio em tempo real para capacitar a aprendizagem dos alunos."
    for_teachers_subtitle3: "Avaliações incorporadas"
    for_teachers_subblurb3: "Personalizar a instrução e assegurar que os alunos compreendem conceitos centrais com avaliações formativas e sumativas."
    ...
    game_based_blurb: "CodeCombat é um programa informático baseado em jogos onde os estudantes escrevem código real e vêem as suas personagens reagir em tempo real."
    get_started: "Começar"
    ...
    quotes_quote1: "Diga o nome de qualquer programa online, já o experimentei. Nenhum deles se compara ao CodeCombat. Qualquer professor que queira que os seus alunos aprendam a programar... comece aqui!"
    quotes_quote2: "Fiquei surpreendido com a facilidade e intuitividade com que o CodeCombat torna a aprendizagem da ciência da computação. As notas no exame foram muito mais altas do que eu esperava e acredito que CodeCombat é a razão pela qual assim foi."
    quotes_quote3: "CodeCombat tem sido o mais benéfico para ensinar aos meus alunos capacidades de programação da vida real. O meu marido é engenheiro de software e já testou todos os meus programas. Ele colocou isto como a sua melhor escolha."
    quotes_quote4: "O feedback ... tem sido tão positivo que estamos a estruturar uma aula de ciência da computação em torno do CodeCombat. O programa envolve realmente os alunos com uma plataforma de estilo de jogo que é divertida e instrutiva ao mesmo tempo. Continuem o bom trabalho, CodeCombat!"
    ...
    teachers_love_codecombat_blurb3: "Dizer que o CodeCombat ajuda-os a apoiar as capacidades de resolução de problemas dos estudantes"
    ...
    im_an_educator: "Sou um Educador/Formador"
    ...
    game_based: "Quando os sistemas de aprendizagem baseados em jogos são"
    compared: "comparado com"
    conventional: "contra os métodos convencionais de avaliação, a diferença é clara: os jogos são melhores para ajudar os estudantes a reter o conhecimento, concentrar-se e"
    perform_at_higher_level: "ter um nível de realização superior"
    feedback: "Os jogos também fornecem feedback em tempo real que permite aos estudantes ajustar o seu caminho de solução e compreender conceitos de forma mais holística, em vez de se limitarem apenas a respostas "correctas" ou "incorrectas"."
    real_game: "Um jogo a sério, jogado com código a sério."
    great_game: "Um grande jogo é mais do que apenas medalhas e realizações - é sobre a jornada de um jogador, puzzles bem concebidos, e a capacidade de enfrentar desafios com competência e confiança."
    agency: "CodeCombat é um jogo que dá aos jogadores essa competência e confiança com o nosso robusto motor de código digitado, que ajuda tanto os principiantes como os estudantes avançados a escrever um código válido e adequado."
    ...
    get_started_subtitle: "Organize uma aula, acrescente os seus alunos e acompanhe o seu progresso à medida que aprendem ciência da computação."
    request_demo: "Pedir uma Demonstração"
    request_quote: "Pedir um orçamento"
    setup_a_class: "Configurar uma Turma"
    have_an_account: "Tens uma conta?"
    logged_in_as: "Atualmente tens sessão iniciada como"
    computer_science: "Os nossos cursos de auto-gestão cobrem desde a sintaxe básica a conceitos avançados"
    ...
    winning: "Uma combinação vencedora de jogabilidade de RPG e trabalhos de casa em programação que faz com que a educação amiga das crianças seja legitimamente agradável."
    ...
    student: "Estudante"
    our_coding_programs: "Os nossos métodos de programação"
    codecombat: "CodeCombat"
    ozaria: "Ozaria"
    codecombat_blurb: "O nosso original jogo de programação. Recomendado para pais, indivíduos, educadores, e estudantes que queiram experimentar um dos jogos de codificação mais amados do mundo."
    ozaria_blurb: "Um jogo de aventura e programa de Ciência da Computação onde os estudantes dominam a magia perdida da programação para salvar o seu mundo. Recomendado para educadores e estudantes."
...
#    browser_recommendation: "For the best experience we recommend using the latest version of Chrome. Download the browser here!"
  ...
  play:
    ...
    meta_description: "Aprender programação com um jogo de codificação para principiantes. Aprende Python ou JavaScript enquanto resolves labirintos, fazes os teus próprios jogos, e sobes de nível. Desafia os teus amigos em níveis de arena multiplayer!"
