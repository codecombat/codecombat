...
#    team_values: "We value open and respectful dialog, where the best idea wins. Our decisions are grounded in customer research and our process is focused on delivering tangible results for them. Everyone is hands-on, from our CEO to our GitHub contributors, because we value growth and learning in our team."
    ...
    nolan_title: "Gestor de Território" # {change}
    lisa_title: "Especialista em Escolas" # {change}
    sean_title: "Gestor de Território"
    liz_title: "Gestora de Território"
    jane_title: "Gestor de Parcerias" # {change}
    david_title: "Gestor de Sucesso do Consumidor" # {change}
...
#    play_now_learn_4: "how to defeat an ogre (important life skills!)"
    ...
    view_levels: "ver todos os níveis do curso" # {change}
