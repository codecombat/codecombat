...
#    to_assign: "to assign paid courses."
    ...
    practice: "연습"
    required: "필수"
    welcome_to_courses: "모험가분들, 코스에 오신걸 환영합니다!"
    ready_to_play: "플레이하실 준비가 되셨나요?"
    start_new_game: "새 게임 시작"
    play_now_learn_header: "배움을 위해 지금 플레이하세요"
    play_now_learn_1: "당신의 캐릭터를 움직이기 위한 기본 문법"
    play_now_learn_2: "성가신 퍼즐들을 풀기위한 while loops"
    play_now_learn_3: "행동들을 커스터마이징하기위한 문자열들과 변수들"
    play_now_learn_4: "도깨비를 물리치는 방법 (중요한 라이프 스킬들!)"
#    welcome_to_page: "My Student Dashboard"
    my_classes: "현재 수업들"
    class_added: "Class successfully added!"
    view_map: "지도 보기"
    view_videos: "비디오 보기"
    view_project_gallery: "친구의 프로젝트들 보기"
