module.exports = nativeDescription: "한국어", englishDescription: "Korean", translation:
  ...
  about:
    ...
    press_title: "블로거/프레스"
    press_paragraph_1_prefix: "우리에 대해 쓰기를 원하십니까? 자유롭게 다운로드하고 우리가 포함시킨 리소스를 사용하세요"
    press_paragraph_1_link: "프레스 패킷"
    press_paragraph_1_suffix: ". 모든 로고 및 이미지는 저희에게 직접 연락 없이 사용할 수있습니다."
    team: "팀"
  ...
  teachers_survey:
    title: "교사 설문 조사"
    must_be_logged: "먼저 로그인해야합니다. 계정을 만들거나 위의 메뉴에서 로그인하십시오."
    retrieving: "정보 검색 ..."
    being_reviewed_1: "무료 평가판에 대한 응용 프로그램이 되고 있습니다"
    being_reviewed_2: "검토됨."
    approved_1: "무료 평가판에 대한 응용 프로그램이 있었습니다"
    approved_2: "승인됨!"
    approved_4: "이제는 학생을 등록 할 수 있습니다"
    approved_5: "코스"
    approved_6: "페이지."
    denied_1: "무료 평가판에 대한 응용 프로그램이 있습니다"
    denied_2: "거절됨."
    contact_1: "연락해주세요."
    contact_2: "더 질문이있는 경우."
    description_1: "우리는 교사들에게 무료 평가판을 제공합니다.당신은 지불 과정에 학생을 등록 할 수 있으며 2개의 무료 티켓이 재학생에게 제공됩니다."
    description_1b: "당신은 더 많은 정보를 우리로 부터 찾을 수 있습니다"
    description_2: "선생님"
    description_3: "페이지."
    description_4: "간단한 설문 조사를 작성하고 우리는 당신에게 설치 방법을 이메일로 보내 드리겠습니다."
    email: "이메일 주소"
    school: "학교 이름"
    location: "도시 이름"
    age_students: "학생의 나이는 몇살입니까?"
    under: "아래"
    other: "또 다른:"
    amount_students: "얼마나 많은 학생을 가르쳤습니까?"
    hear_about: "당신은 코드컴뱃에 대해 어떻게 알게 되셨습니까 ?"
    fill_fields: "모든 필드를 작성하십시오."
    thanks: "감사합니다! 우리는 곧 당신에게 설치 지침 을 보내드립니다."
