...
#    sign_in: "Sign In"
    ...
    finishing: "الانتهاء"
    sign_in_with_facebook: "سجل الدخول بواسطة فيسبوك" # {change}
    sign_in_with_gplus: "سجل الدخول بواسطة غوغل بلس" # {change}
...
#    level_status_skipped: "Skipped"
   level_status_complete: "اكتمل"
#    level_status_unlocked: "Unlocked"
   level_status_optional: "اختياري"
...
#    wallOfDarkness_description: "Hide behind a wall of shadows to prevent the gaze of prying eyes."
   ...
   x_announcement: "__x__ إشعارات"
   x_announcements: "__x__ إشعارات"
   x_announcement_with_unread: "__x__ إشعارات (__y__ غير مقروء)"
   x_announcements_with_unread: "__x__ إشعارات (__y__ غير مقروء)"
   see_more: "أنظر __unread__ إشعارات أخرى غير مقروءة"
   mark_read: "علِّمه كمقروء"
   read_all: "قراءة الكل"
   more_announcements: "المزيد من الإشعارات..."
...
#    left_xp_postfix: ""
  ...
  account:
   ...
   payments_title: "مدفوعات"
   subscription_title: "إشتراك"
   invoices_title: "فواتير"
   prepaids_title: "مدفوعات المسبقة"
   payments: "مدفوعات"
   prepaid_codes: "رموز مدفوعة مسبقًا"
   purchased: "تم الشراء"
   subscribe_for_gems: "إشترك لتحصل على جواهر"
   subscription: "إشتراك"
   invoices: "فواتير"
#    service_apple: "Apple"
   service_web: "الويب"
   ...
   card: "بطاقة"
   status_unsubscribed_active: "أنت لست مشتركًا ولن يتم فوترتك، ولكن حسابك مازال نشط حاليًا."
   status_unsubscribed: "احصل على مستويات جديدة، وأبطال، وعناصر، وجواهر إضافية بالاشتراك في CodeCombat!"
   not_yet_verified: "لم يتم التحقق بعد."
   resend_email: "يرجى الحفظ أولاً ثم إعادة إرسال البريد الإلكتروني"
   email_sent: "تم إرسال البريد الإلكتروني! يُرجى التحقق من صندوق الوارد الخاص بك."
   verifying_email: "جارٍ التحقق من عنوان بريدك الإلكتروني..."
   successfully_verified: "لقد قمت بالتحقق من عنوان بريدك الإلكتروني بنجاح!"
   verify_error: "حدث خطأ ما أثناء التحقق من عنوان بريدك الإلكتروني :("
   unsubscribe_from_marketing: "إلغاء اشتراك __email__ من جميع رسائل التسويق الخاصة بـ CodeCombat؟"
   unsubscribe_button: "نعم, ألغِ الاشتراك"
   unsubscribe_failed: "فشل"
   unsubscribe_success: "نجاح"
