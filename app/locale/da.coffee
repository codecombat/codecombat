module.exports = nativeDescription: "dansk", englishDescription: "Danish", translation:
  ...
  nav:
    ...
    request_quote: "Anmod om et citat"
  ...
  about:
    ...
    jobs_benefit_3: "Fleksibilitet ved at arbejde hjemmefra"
  ...
  teachers_quote:
    ...
    thanks_anon: "Log ind eller lav en konto for at oprette en klasse, tilføje dine elever, og overvåge deres fremgang mens de lærer datalogi."
    thanks_logged_in: "Opret en klasse, tilføj dine elever og overvåg deres fremgang mens de lærer datalogi."
  ...
  community:
    ...
    social_hipchat: "Chat med os i den offentlige CodeCombat Slack-kanal"
  ...
  courses:
    ...
    additional_resources_2_suff: "at få to gratis tilmeldinger til resten af ​​vores betalte kurser."
    additional_resources_3_pref: "Besøg vores"
    additional_resources_3_mid: "Lærer Forum"
    additional_resources_3_suff: "at få kontakt med ligesindede undervisere, der bruger CodeCombat."
    additional_resources_4_pref: "Check vores"
    additional_resources_4_mid: "Skolernes Side"
    additional_resources_4_suff: "at lære mere om CodeCombat klasseværelsestilbud."
    educator_wiki_pref: "Eller tjek vores nye"
    educator_wiki_mid: "underviser wiki"
    educator_wiki_suff: "at gennemse guiden online."
  ...
  contribute:
    ...
    join_url_hipchat: "åben Slack-kanal"
