...
#    see_example: "See example"
    slogan: "Den mest engagerende måde at lære datalogi."
...
#    im_an_educator: "I'm an Educator"
    ...
    learn_more: "Lær mere"
    learn_more_caps: "Lær Mere"
    classroom_in_a_box: "En klasseværelsespakkeløsning til at undervise datalogi."
    codecombat_is: "CodeCombat er en platform <strong>for studerende</strong> til at lære datalogi, mens de spiller et rigtigt spil."
    our_courses: "Vores kurser er specifikt spiltestet <strong>til at udmærke sig i et klasseværelsesmiljø</strong>, selv af lærere med lille eller ingen forudgående programmeringserfaring."
    watch_how: "Se hvordan CodeCombat ændrer den måde folk lærer datalogi."
...
#    builds_concepts_up: "I like how CodeCombat builds the concepts up. It's really easy to understand and fun to figure it out."
    ...
    request_demo: "Anmod om en demo"
    request_quote: "Anmod om et tilbud"
    setup_a_class: "Opsæt klasse"
    have_an_account: "Har du allerede en konto?"
    logged_in_as: "Du er i øjeblikket logget ind som"
    computer_science: "Vores kurser dækker fra grundlæggende syntax til avancerede begreber" # {change} missing self-paced
...
#    apcsp: "AP CS Principles"
    parent: "Forældre"
    browser_recommendation: "For at få den bedste oplevelse anbefaler vi den seneste version af Chrome. Download browseren her!"
  ...
  play:
    title: "Spil CodeCombat niveauer - Lær Python, JavaScript, og HTML"
#    meta_description: "Learn programming with a coding game for beginners. Learn Python or JavaScript as you solve mazes, make your own games, and level up. Challenge your friends in multiplayer arena levels!"
    level_title: "__level__ - Lær at programmere i Python, JavaScript, HTML"
    video_title: "__video__ | Video niveau"
    game_development_title: "__level__ | Spiludvikling"
    web_development_title: "__level__ | Webudvikling"
    anon_signup_title_1: "CodeCombat har en"
    anon_signup_title_2: "klasseværelse udgave!"
    anon_signup_enter_code: "Indtast klassekode:"
    anon_signup_ask_teacher: "Har du ikke en? Spørg din lærer!"
    anon_signup_create_class: "Vil du oprette en klasse?"
    anon_signup_setup_class: "Indstil en klasse, tilføj dine studerende og få overblik over fremskridt!"
    anon_signup_create_teacher: "Opret din gratis lærer konto"
...
#    cpp_blurb: "(Subscriber Only) Game development and high performance computing."
    ...
    level_to_unlock: "Niveau for at låse op:" # Label for which level you have to beat to unlock a particular hero (click a locked hero in the store to see)
    restricted_to_certain_heroes: "Kun visse helte kan spille dette niveau."
