module.exports = {
  ...
  translation: {
    ...
    home_v3: {
      mission_title: '[AI_TRANSLATION]加入我们，使编程和人工智能对所有人都可访问。',
      mission_supporting_text: '[AI_TRANSLATION]Мы стремимся предоставить высококачественные образовательные решения, которые дают каждому возможность осознать свой потенциал и помочь формировать лучшее будущее.',
      stat_card_1_text: '[AI_TRANSLATION]20 миллионов',
      stat_card_1_description: '[AI_TRANSLATION]参与的学生',
      ...
      stat_card_4_description: '[AI_TRANSLATION]达到的学校数量',
      ...
      stat_card_6_description: '[AI_TRANSLATION]Игроки в киберспорте',
      learn_to_code: '[AI_TRANSLATION]Учиться **программировать** и использовать **ИИ**, всё через **силу игры**.',
      innovative_play_experiences: '[AI_TRANSLATION]我们创造创新的玩乐体验，使计算机科学吸引人并对所有人开放。',
      im_an_educator: '[AI_TRANSLATION]Я - образовательный работник',
      im_a_parent: '[AI_TRANSLATION]Я - Родитель',
      im_a_student: '[AI_TRANSLATION]Я студент',
      programming_languages: '[AI_TRANSLATION]Языки программирования и инструменты искусственного интеллекта',
      engaging_play_experiences: '[AI_TRANSLATION]Захватывающие игровые переживания',
      for_younger_learners: '[AI_TRANSLATION]针对年幼的学习者',
      your_turnkey_solutions: '[AI_TRANSLATION]Ваши Поворотные Решения',
      trends_insights: '[AI_TRANSLATION]Тренды и инсайты',
      awards_partners: '[AI_TRANSLATION]Награды и партнёры',
      faq_visit_help_center: '[AI_TRANSLATION]Для ответов на часто задаваемые вопросы посетите наш **центр помощи**.',
      contact_us: '[AI_TRANSLATION]Свяжитесь с нами',
      for_further_questions: '[AI_TRANSLATION]Для дополнительных вопросов',
      education_partner: '[AI_TRANSLATION]Образовательный[NEWLINE]партнер',
      official_member: '[AI_TRANSLATION]Официальный[NEWLINE]Член',
      best_creativity_tool_for_students: '[AI_TRANSLATION]Лучший инструмент творчества[NEWLINE]для студентов',
      official_partner: '[AI_TRANSLATION]Официальный партнер',
      hour_of_code_activity_partner: '[AI_TRANSLATION]Партнер Деятельности "Час Кодирования"[NEWLINE]',
      top_pick_for_learning: '[AI_TRANSLATION]Лучший Выбор для[NEWLINE]Обучения',
      testimonals_1_title: '[AI_TRANSLATION]“我现在能做的一件事，之前做不到的，就是真正相信我可以编程。”',
      testimonals_1_name: '[AI_TRANSLATION]Студент Средней школы Маунтин Ридж',
      testimonals_2_title: '[AI_TRANSLATION]"Назовите любую онлайн программу, я их все испробовал. Ни одна из них не сравнится с CodeCombat & Ozaria. Любой учитель, желающий научить своих студентов программированию... начните с этого!"',
      testimonals_2_name: '[AI_TRANSLATION]Скотт Бэйли, Средняя школа Бобби Дьюк',
      testimonals_3_title: '[AI_TRANSLATION]"Я всегда мечтал о дизайне видеоигр и обучении программированию... это дает мне отличную отправную точку."',
      testimonals_3_name: '[AI_TRANSLATION]Джои, 10-й класс',
      testimonals_4_title: '[AI_TRANSLATION]"Что мне больше всего нравится в CodeCombat, так это то, что оно не упрощает программирование. Студенты учатся писать настоящий код, делая это таким образом, что им весело."',
      testimonals_4_name: '[AI_TRANSLATION]Сандра Алстрём, учитель, школьный округ округа Шеридан №2',
      carousel_1_title: '[AI_TRANSLATION]Обучение Через Игры[NEWLINE]',
      carousel_1_text: '[AI_TRANSLATION]通过我们独特的方法，学生们从冒险的一开始就在玩乐中接受学习并编写代码，促进积极学习和成长心态。',
      carousel_2_title: '[AI_TRANSLATION]Текстовое[NEWLINE]программирование',
      carousel_2_text: '[AI_TRANSLATION]Наша специальная система кодирования и интерпретатор разработаны для начинающих, обучая истинному программированию на Python, JavaScript и C++ с использованием понятной, дружелюбной к новичкам терминологии.',
      carousel_3_title: '[AI_TRANSLATION]Проектно-ориентированные[NEWLINE]оценки',
      carousel_3_text: '[AI_TRANSLATION]Эти проекты - возможность для учеников запрограммировать собственные игры, которыми они могут поделиться. Мы предоставляем критерии оценки, чтобы вы могли использовать проекты Capstone в качестве основной итоговой оценки.',
      carousel_4_title: '[AI_TRANSLATION]AI加速',
      carousel_4_text: '[AI_TRANSLATION]Мы обучаем студентов использованию ИИ для ускорения обучения и повышения их навыков программирования. Это мощное сочетание разблокирует творческий потенциал людей на каждом уровне навыков.',
      carousel_5_title: '[AI_TRANSLATION]Уполномочивание образователей',
      carousel_5_text: '[AI_TRANSLATION]Наши решения для классов созданы со всей необходимой поддержкой и ресурсами, которые могут потребоваться любому образовательному работнику для реализации учебной программы и достижения успешных результатов.',
      carousel_6_title: '[AI_TRANSLATION]Влияние на учеников',
      carousel_6_text: '[AI_TRANSLATION]Наши продукты помогли более чем 20 миллионам студентов получить удовольствие от изучения компьютерных наук, научив их критическому мышлению, уверенности и творчеству. Мы вовлекаем всех учащихся, независимо от их опыта, помогая им увидеть путь к успеху в компьютерных науках.',
      engaging_boxes_1_title: '[AI_TRANSLATION]Класс Ozaria',
      engaging_boxes_1_text: '[AI_TRANSLATION]Повествовательное приключение по программированию, закладывающее основы информатики.',
      engaging_boxes_2_title: '[AI_TRANSLATION]CodeCombat для Классов',
      engaging_boxes_2_text: '[AI_TRANSLATION]一个完整的CS课程体系，从核心概念一直延伸到网页开发、游戏开发和 **[https://codecombat.com/apcsp]AP CSP**。',
      engaging_boxes_3_title: '[AI_TRANSLATION]Миры CodeCombat на Roblox',
      engaging_boxes_3_text: '[AI_TRANSLATION]В партнёрстве с Roblox Education, это взаимодействие с ИИ значительно улучшает способности студентов в программировании и предоставляет реальную платформу для создания удивительных игр и опыта.',
      engaging_boxes_4_title: '[AI_TRANSLATION]Лига электронных спортов CodeCombat AI',
      engaging_boxes_4_text: '[AI_TRANSLATION]Эпическая платформа для соревновательного программирования в игровой среде, которая стимулирует креативное программирование.',
      engaging_boxes_5_title: '[AI_TRANSLATION]CodeCombat ИИ HackStack',
      engaging_boxes_5_text: '[AI_TRANSLATION]Первый инструмент генеративного ИИ, специально созданный для новичков в ИИ с акцентом на приватность и безопасность студентов. Сочетание простоты и мощности платформа ускоряет способности студентов и раскрывает их творческий потенциал.',
      engaging_boxes_6_title: '[AI_TRANSLATION]Домашняя страница CodeCombat',
      engaging_boxes_6_text: '[AI_TRANSLATION]С доступом к более чем 530 уровням и эксклюзивным функциям, таким как питомцы, предметы только для премиум-пользователей и герои, ваш ребенок сможет полностью погрузиться в мир программирования. Они даже могут создавать игры, чтобы бросить вызов своим друзьям, строить веб-сайты и приложения для общего доступа.',
      young_learners_1_title: '[AI_TRANSLATION]CodeCombat для младших классов',
      young_learners_1_text: '[AI_TRANSLATION]Наш флагманский учебный план для K-5 включает последовательность уровней обучения, которые на более медленном темпе обучают основам программирования, специально разработанные для учеников начальной школы.',
      young_learners_1_linkText: '[AI_TRANSLATION]Зарегистрируйтесь для Получения Бета-Доступа',
      young_learners_2_title: '[AI_TRANSLATION]AI HackStack Jr.',
      young_learners_2_text: '[AI_TRANSLATION]Вводит мульти-модальный генеративный AI на простой и интуитивно понятной платформе, специально разработанной для учащихся K-5.',
      young_learners_2_linkText: '[AI_TRANSLATION]Зарегистрируйтесь для Получения Бета-Доступа',
      solutions_1_title: '[AI_TRANSLATION]Профессиональное Развитие',
      solutions_1_text: '[AI_TRANSLATION]Создано для того, чтобы дать всем учителям необходимые навыки, знания и уверенность в эффективном преподавании информатики.',
      solutions_1_middleText: '[AI_TRANSLATION]Заработайте до 3 учебных кредитов.',
      solutions_1_linkText: '[AI_TRANSLATION]Попробуйте сейчас',
      solutions_2_title: '[AI_TRANSLATION]Подготовка к экзамену AP CSP',
      solutions_2_text: '[AI_TRANSLATION]Мы признаны College Board как официальный поставщик учебной программы и профессиональной подготовки для AP® Computer Science Principles (AP CSP). Наша программа AP CSP предоставляет игровые и готовые инструменты для подготовки учащихся к экзамену AP.',
      solutions_2_linkText: '[AI_TRANSLATION]Попробуйте сейчас',
      solutions_3_title: '[AI_TRANSLATION]赠款和资金来源',
      solutions_3_text: '[AI_TRANSLATION]Мы понимаем, с какими финансовыми трудностями сталкиваются школы, и нам небезразлично помочь преодолеть эти препятствия. Ознакомьтесь с нашим подробным руководством по получению грантов или поговорите с нашей командой, чтобы узнать больше.',
      solutions_4_title: '[AI_TRANSLATION]Решения для Уровня Округов',
      solutions_4_text: '[AI_TRANSLATION]Наши инновационные решения помогли школьным округам по всей стране расширить или начать свои программы информатики. Разработанные с учетом отзывов из нашего сообщества более 320 000 педагогов, наше комплексное решение предлагает отзывчивую и гибкую учебную программу, которая удовлетворяет потребности всех студентов и педагогов. Его легко внедрить и масштабировать с поддержкой нашей команды, предоставляющей обучение и поддержку ваших учителей.',
      solutions_5_title: '[AI_TRANSLATION]Прямые Онлайн-Классы',
      solutions_5_text: '[AI_TRANSLATION]Наши онлайн-курсы программирования сочетают в себе мощь игрового процесса и персонализированного обучения, создавая опыт, который ваш ребенок полюбит. От создания и публикации собственных игр в Roblox до создания веб-сайта для нового бизнеса, ваш ребенок исследует все возможности, которые открывают ИИ и программирование.',
      solutions_6_title: '[AI_TRANSLATION]CodeQuest',
      solutions_6_text: '[AI_TRANSLATION]Присоединяйтесь к нам для уникального образовательного опыта, который не имеет аналогов, предназначенного вдохновлять и расширять возможности следующего поколения новаторов в области информатики. Эта редкая возможность собирает студентов со всего мира для участия в серии хакатонов по программированию, обучения у заметных спикеров и посещения лучших университетов и технологических организаций.',
      solutions_6_linkText: '[AI_TRANSLATION]Узнать Больше',
      solutions_7_title: '[AI_TRANSLATION]Партнерские решения',
      solutions_7_text: '[AI_TRANSLATION]Присоединяйтесь к нашей миссии сделать программирование доступным и увлекательным для всех, став ценным партнером. Наши гибкие формы партнерства включают образовательные организации, спонсоров киберспорта, международных дистрибьюторов и организации социального влияния. Партнеры получают доступ к нашим легко используемым программам, ресурсам для внедрения и вариантам обучения для успешного и приятного опыта.',
      solutions_8_title: '[AI_TRANSLATION]图书馆解决方案',
      solutions_8_text: '[AI_TRANSLATION]Являясь полностью самостоятельным и независимым цифровым ресурсом, CodeCombat является лучшим вариантом для библиотек, желающих предоставить своим членам всех возрастов возможность научиться программировать. Наша платформа предлагает все необходимое для того, чтобы ощутить высококачественное обучение программированию через уникальную и увлекательную игровую учебную программу. Идеально подходит для начинающих и до тех, кто хочет овладеть концепциями программирования уровня колледжа.',
      learn_more_text: '[AI_TRANSLATION]Узнать Больше',
      best_homeschool_curriculum: '[AI_TRANSLATION]Лучшая домашняя[NEWLINE]программа обучения',
      sign_up_free: '[AI_TRANSLATION]Регистрация Бесплатно',
      try_it_now: '[AI_TRANSLATION]Попробуйте сейчас',
    },

    schools_page: {
      most_effective_computer_science_solution: '[AI_TRANSLATION]Самое эффективное решение для обучения информатике **в школах**',
      our_comprehensive_implementation: '[AI_TRANSLATION]我们的全面实施赋能教师，吸引学生，并取得成功的成果。',
      get_my_solution: '[AI_TRANSLATION]Получите моё решение',
      let_us_craft_a_custom_program: '[AI_TRANSLATION]Мы подготовим для вас индивидуальную программу!',
      flexible_standards_aligned_curriculum_title: '[AI_TRANSLATION]Гибкая программа, соответствующая стандартам',
      flexible_standards_aligned_curriculum_text: '[AI_TRANSLATION]Наш поэтапный подход охватывает основы компьютерных наук до продвинутых курсов и включает **[https://codecombat.com/apcsp] поддерживаемый College Board AP CSP**, разработку веб-сайтов и игр. Мы создаем индивидуальные пути для предоставления персонализированного обучения, которое соответствует **[https://codecombat.com/standards] стандартам CSTA, ISTE и Common Core State Standards**. Гибкая учебная программа позволяет обучать Python, JavaScript, C++, Luau и многому другому.',
      comprehensive_tools_resources_title: '[AI_TRANSLATION]Комплекс инструментов и ресурсов',
      comprehensive_tools_resources_text: '[AI_TRANSLATION]Центр ресурсов для учителей дает возможность каждому преподавателю начать обучение с первого дня. Простой доступ к планам уроков, презентациям для учеников, рубрикам, дополнительным активностям, итоговым проектам и оценкам. Наши безопасные интеграции с ИИ ускоряют потенциал учащихся и позволяют учителям оптимизировать учебное время. Для практики и применения в реальных условиях мы предлагаем соревнования по программированию, дизайн игр в Roblox и варианты веб-дизайна. Кроме того, преподаватели могут контролировать темп обучения студентов с помощью функций назначения и блокировки контента.',
      accessible_data_insights_title: '[AI_TRANSLATION]Доступ к данным и аналитике',
      accessible_data_insights_text: '[AI_TRANSLATION]Мы предоставляем администраторам необходимую информацию с помощью данных о реальном использовании и отчетов о прогрессе на уровне класса, школы, района и штата. Отслеживание прогресса учащихся на уровне отдельного студента позволяет образовательным работникам легко определять, когда требуется вмешательство, а встроенные оценки до и после модуля измеряют понимание учащимися.',
      high_quality_professional_development_title: '[AI_TRANSLATION]Профессиональное развитие высокого качества',
      high_quality_professional_development_text: '[AI_TRANSLATION]**[https://csteachers.org/pd-opportunities/accredited-pd/]Одобрено Ассоциацией учителей информатики (CSTA)**, курс предлагает более 44 часов самостоятельного обучения в интернете по запросу. Программа рассчитана на индивидуальное темп обучения и спроектирована так, чтобы подходить любому загруженному графику. Курс готовит любого человека, независимо от наличия опыта в обучении, к успешному внедрению учебной программы по информатике.',
      earn_up_to_3_graduate_credits: '[AI_TRANSLATION]За этот курс можно заработать до 3 учебных кредитов.',
      request_a_demo: '[AI_TRANSLATION]Запросить демонстрацию',
      ...
      practice_enrichment: '[AI_TRANSLATION]Практика и Углубление',
      student_acceleration_ap_csp: '[AI_TRANSLATION]Ускорение Обучения Студентов и AP CSP ',
      young_learners: '[AI_TRANSLATION]Молодые Учащиеся',
      funding_solutions: '[AI_TRANSLATION]Решения для Финансирования',
      ...
      ai_support_acceleration_text: '[AI_TRANSLATION]Мы используем ИИ, чтобы сделать учебное время более эффективным. Теперь в CodeCombat есть функция подсказок с ИИ, которая оценивает код, указывает на ошибки и объясняет, как их исправить. Что самое важное, она предоставляет весь контекст, необходимый для понимания причин, не раскрывая полного решения. Студентам все еще нужно будет проработать каждый уровень программирования, но теперь вам не нужно останавливать занятия, чтобы помочь каждому в отдельности. **Учителя получают лимит в 100 подсказок с ИИ в день** и **каждый студент получает 5 подсказок с ИИ в день**, чтобы они всегда имели необходимую поддержку.',
      codecombat_ai_hackstack_text: '[AI_TRANSLATION]Для новичков в ИИ мы предлагаем **CodeCombat AI HackStack**. Этот инновационный инструмент не только учит студентов использованию ИИ, но и обеспечивает безопасный доступ к самым последним LLM, включая ChatGPT-4, Claude, Stable Diffusion, DALL-E и другие. После короткого знакомства с режимом обучения пользователи разблокируют полный творческий потенциал инструмента, позволяя за считанные минуты переходить от запроса к коду к опубликованным проектам. Это приложение на базе ИИ позволяет пользователям создавать игры, искусство, веб-сайты, код и многое другое. **Учителя получают лимит в 100 заросов ИИ в месяц** и **каждый студент получает 10 запросов ИИ в неделю**, чтобы создавать множество проектов на базе ИИ.',
      pathways_for_success: '[AI_TRANSLATION]Пути к успеху',
      for_your_custom_pathway: '[AI_TRANSLATION]Для вашего индивидуализированного пути',
      elementary_school: '[AI_TRANSLATION]Начальная школа',
      codecombat_jr: '[AI_TRANSLATION]CodeCombat для младших классов',
      ai_hacksstack_jr: '[AI_TRANSLATION]AI HacksStack Jr.',
      codecombat_worlds: '[AI_TRANSLATION]Миры CodeCombat',
      k: '[AI_TRANSLATION]K',
      icons_block_based: '[AI_TRANSLATION]Иконки и Блочное программирование',
      ...
      block_based: '[AI_TRANSLATION]Блок-ориентированное',
      grade_4: '[AI_TRANSLATION]4 класс',
      block_based_text: '[AI_TRANSLATION]Блоки и текст',
      grade_5: '[AI_TRANSLATION]5 класс',
      text: '[AI_TRANSLATION]Текст',
      our_k_5_implementation_pathway: '[AI_TRANSLATION]Наш путь внедрения для K-5 представит две новые платформы, дружественные к начинающим, которые включают CodeCombat Junior, наш флагманский учебный курс начального уровня с последовательностью обучающих уровней, **обучающих основам кодирования в более медленном темпе**, и AI HackStack Junior, **мультимодальный инструмент ИИ**, который позволяет студентам рисовать, писать и проектировать свои собственные цифровые продукты. Эта каркасная последовательность позволит студентам развиваться вместе с нашим погружающим контентом и исследовать широкий спектр понятий вычислительного мышления и информатики.',
      middle_school: '[AI_TRANSLATION]Средняя школа',
      high_school: '[AI_TRANSLATION]高中',
      ozaria: '[AI_TRANSLATION]Ozaria',
      ai_hackstack: '[AI_TRANSLATION]ИИ HackStack',
      ai_league: '[AI_TRANSLATION]AI Лига',
      grade_6: '[AI_TRANSLATION]6 класс',
      introduction_to_coding: '[AI_TRANSLATION]编码入门',
      introduction_to_luau_coding: '[AI_TRANSLATION]Введение в программирование на Lua',
      introduction_to_coding_esports: '[AI_TRANSLATION]Введение в Киберспорт по Программированию',
      ...
      competitive_coding_arenas: '[AI_TRANSLATION]Соревновательные арены по программированию',
      ...
      open_ended_ai_projects: '[AI_TRANSLATION]Открытые проекты по искусственному интеллекту',
      middle_school_implementation: '[AI_TRANSLATION]Наша программа для средних школ закладывает **основу концепций программирования** с Ozaria, нашей основной программой по информатике. Затем это расширяется до большего выбора и возможностей, где ученики будут **изучать программирование и ИИ** на трёх разных платформах. **Учитель и ученики могут выбирать**, насколько глубоко они хотят исследовать каждую из этих дополнительных платформ.',
      codecombat: '[AI_TRANSLATION]CodeCombat',
      ap_csp: '[AI_TRANSLATION]AP CSP',
      cs1_4_data_science_cybersecurity_exam_content: '[AI_TRANSLATION]CS1-4 [NEWLINE] Data Science [NEWLINE] Кибербезопасность [NEWLINE] Содержание экзамена',
      advanced_cs: '[AI_TRANSLATION]Продвинутый курс компьютерных наук',
      cs5_6_gd1_3_wd1_2: '[AI_TRANSLATION]Компьютерные науки 5-6 [NEWLINE] Графика и дизайн 1-3 [NEWLINE] Веб-разработка 1-2',
      advanced_game_development: '[AI_TRANSLATION]Продвинутая Разработка Игр',
      advanced_ai_projects: '[AI_TRANSLATION]Продвинутые проекты по ИИ',
      global_esports_tournament: '[AI_TRANSLATION]Международный турнир по киберспорту',
      first_year_high_school_curriculum: '[AI_TRANSLATION]我们高中课程的第一年重点是 **AP CS 原则**，其中包括我们的CodeCombat课程，CS1-CS4 和考试课程内容，比如 **数据科学** 和 **计算系统**。较高级的年份允许学生探索更多的 **高级CS课程**，并在我们的三个平台中提供选择权和发言权。',
      accessibility_representation_title: '[AI_TRANSLATION]Доступность и представительность',
      accessibility_representation_text: '[AI_TRANSLATION]Наш дизайн, ориентированный на учеников, встречает их там, где они находятся, и предоставляет необходимую поддержку. Возможности обучения как вживую, так и дистанционно позволяют ученикам учиться в любом месте и в любое время. Доступность для управления с клавиатуры, полная совместимость с экранными читалками и цветовая схема, удобная для цветовосприятия, гарантируют, что каждый может научиться программировать.',
      privacy_security_title: '[AI_TRANSLATION]Конфиденциальность и безопасность',
      privacy_security_text: '[AI_TRANSLATION]Мы серьезно относимся к безопасности учащихся, кибербезопасности и защите данных, и следуем строгим школьным нормам конфиденциальности, включая COPPA, FERPA, SOPIPA, California AB 1584, CalOPPA, Принципы защиты информации, CAN-SPAM, а также GDPR. Все данные надежно хранятся на Amazon Web Services в США. наши интеграции AI имеют защиту для защиты Личной идентифицируемой информации и ограничения чувствительного контента. Распространение проектов контролируется, и связь между участниками ограничена. Соглашения о обработке данных доступны, посетите **https://codecombat.com/privacy** для получения дополнительной информации.',
      contact_our_team: '[AI_TRANSLATION]Свяжитесь с нашей командой',
      for_turnkey_solutions: '[AI_TRANSLATION]Ваше решение "под ключ"',
      testimonials_1_quote: '[AI_TRANSLATION]“Давайте я сразу все проясню. Я рекомендую ваш продукт, потому что сейчас это лучший инструмент для обучения программированию на Земле.”',
      testimonials_1_name: '[AI_TRANSLATION]Сет Рейчелсон',
      testimonials_1_title: '[AI_TRANSLATION]Учитель информатики AP, Средняя школа Лейк Брантли. Победитель программы "Чемпион перемен" Белого дома',
      testimonials_2_quote: '[AI_TRANSLATION]"[Ozaria] - это полноценная учебная программа по информатике, она действительно впечатляет, очень обширна [...] Здесь есть всё, что нужно [...] Не думаю, что мы видели что-то подобное с таким количеством дополнительных материалов для качественного обучения."',
      testimonials_2_name: '[AI_TRANSLATION]Таннер Хиггин',
      testimonials_2_title: '[AI_TRANSLATION]Редакционный директор - Учебный контент, Common Sense Education',
      testimonials_2_full_review_text: '[AI_TRANSLATION]Полный Обзор Здесь',
      testimonials_3_quote: '[AI_TRANSLATION]"CodeCombat была одной из самых лёгких в реализации программ, которые мы тестировали, и уровень вовлечённости студентов был очень высок. Так как контент организован, он идеально поддерживает обучение и позволяет студентам быстро перейти к изучению высокоуровневых навыков программирования, далеко выходящих за рамки наших ожиданий."',
      testimonials_3_name: '[AI_TRANSLATION]Стив Конг',
      testimonials_3_title: '[AI_TRANSLATION]Специалист по инструкционным услугам, школьный округ Риверсайд',
      testimonials_4_quote: '[AI_TRANSLATION]"Одно, что я теперь могу делать, чего не мог делать раньше, - это действительно верить, что я могу кодировать."',
      testimonials_4_title: '[AI_TRANSLATION]Студент Средней школы Маунтин Ридж',
      testimonials_5_quote: '[AI_TRANSLATION]«CodeCombat изменил мой подход к преподаванию программирования... Я использую отличные учебные ресурсы, включая Руководства по учебной программе, Руководства по проектам и Решения. Использование CodeCombat помогло мне преподавать достаточно сложные концепции таким образом, что ученики получают удовольствие от процесса и понимают материал. Что мне больше всего нравится в CodeCombat, так это то, что оно не упрощает кодирование. Студенты учатся писать настоящий код, но делают это так, что это доставляет им удовольствие».',
      testimonials_5_name: '[AI_TRANSLATION]Сандра Алстрем',
      testimonials_5_title: '[AI_TRANSLATION]Учитель, Школьный округ округа Шеридан №2',
      faq_1_question: '[AI_TRANSLATION]Что вам нужно знать о сертификационных экзаменах и AP CSP',
      faq_1_answer: '[AI_TRANSLATION]Программы карьерного технического образования (CTE) в США нацелены на оснащение студентов востребованными на рынке навыками и могут вести к обучению в профессионально-техническом училище или колледже. В соответствии с государственными и федеральными законами, программы CTE должны предлагать студентам зачет после окончания учебы, индустриальные сертификации или часы стажировки. В то время как в некоторых областях, таких как кибербезопасность, ценятся экзамены на сертификацию, в других, например, в программной инженерии, отдают предпочтение четырехлетнему образованию перед такими экзаменами. Тем не менее, сдача экзамена по принципам компьютерных наук AP служит признанным путем к получению после среднего образовательного кредита, позволяя студентам обходить дорогие и времязатратные требования колледжа. Чтобы помочь подготовить студентов, CodeCombat предлагает **[https://codecombat.com/apcsp]курс AP CSP**, одобренный Колледжем Борд.',
      faq_2_question: '[AI_TRANSLATION]Как мы используем ИИ для поддержки образователей',
      faq_2_answer: '[AI_TRANSLATION]Мы используем ИИ, чтобы сделать учебное время более эффективным. С увеличением размеров классов и ограниченным временем на персонализированное обучение, наш помощник на уровне, работающий на ИИ, является идеальным инструментом для ответов на индивидуальные вопросы ваших учеников. Этот мощный помощник может оценивать код, указывать на ошибки, объяснять, как их исправить, и предоставлять весь необходимый контекст для понимания "почему". И что самое важное, он не будет давать им готовое решение. Поскольку доступна только помощь на уровне следующей строки, ученикам все еще нужно будет проработать каждый уровень программирования, но теперь вам не нужно останавливать занятие, чтобы удовлетворить индивидуальные потребности.',
      faq_3_question: '[AI_TRANSLATION]我们如何安全负责地整合人工智能',
      faq_3_answer: '[AI_TRANSLATION]Наша технология ИИ соблюдает принципы безопасности в первую очередь, обеспечивая доверие как студентов, так и преподавателей. Мы не разрешаем нашим поставщикам LLM тренировать ваши чаты и установили защитные меры против неприемлемого контента. Эти меры включают в себя фильтрацию вредоносного языка, сосредоточение внимания на актуальных темах, защиту личной информации и обучение студентов потенциальным опасностям ИИ. Более того, мы ведем журнал активности чата ИИ для мониторинга учителями и соблюдаем строгие протоколы конфиденциальности данных и безопасности.',
      faq_4_question: '[AI_TRANSLATION]Почему информатика важна',
      faq_4_answer: '[AI_TRANSLATION]Образование в области информатики обеспечивает немедленные преимущества повышения компетенций в решении проблем, уточнения математических способностей и стимулирует логическое мышление, необходимое для успеха в других ключевых школьных предметах. Обучение выходит за рамки программирования, повышая способность учащихся решать сложные задачи и адаптироваться к различным ситуациям. Смотрите, как Ozaria помогает создавать эти **[https://docs.google.com/presentation/d/1xcc1tw4k8oY9basXuxO0v_RU9z-Dr8ImvbvbuNvJeHA/edit#slide=id.g134a7e7c8f1_0_3]межпредметные связи**. Наша учебная программа разработана так, чтобы снабдить сегодняшних учеников важнейшими навыками информатики, которые подготовят их к цифровым профессиям завтра.',
      faq_5_question: '[AI_TRANSLATION]Почему игровое обучение работает',
      faq_5_answer: '[AI_TRANSLATION]Игровое обучение настолько эффективно, потому что создаёт безопасную среду, где не боятся неудач, а ожидают их, предоставляя возможность для роста и понимания. Этот подход поощряет студентов извлекать уроки из своих ошибок и адаптировать свои стратегии для успеха. К тому же интерактивный и динамический характер игр помогает студентам эффективнее усваивать информацию, поскольку обучение проходит через практический, наглядный опыт. Он активно вовлекает студентов в процесс обучения, повышая их мотивацию и интерес.',
      faq_6_question: '[AI_TRANSLATION]Как найти альтернативные источники финансирования',
      faq_6_answer: '[AI_TRANSLATION]Образование в области информатики стало важной составляющей академического пути студента, однако многие школы сталкиваются с трудностями в обеспечении своих учеников комплексными программами по информатике. В CodeCombat мы понимаем финансовые препятствия, с которыми сталкиваются школы, и стремимся помочь им преодолеть эти трудности. Гранты могут быть ценным ресурсом, но их сложно найти и получить. Ознакомьтесь с нашим подробным **[https://codecombat.com/grants]руководством по получению грантов** или обратитесь к нашей команде для дополнительной информации.',
      faq_7_question: '[AI_TRANSLATION]Как начать',
      faq_7_answer_1: '[AI_TRANSLATION]Создайте учительский или административный аккаунт',
      faq_7_answer_2: '[AI_TRANSLATION]Создайте класс',
      faq_7_answer_3: '[AI_TRANSLATION]Добавить студентов',
      faq_7_answer_4: '[AI_TRANSLATION]Сидите сложа руки и наблюдайте, как ваши ученики с удовольствием учатся программировать',
      faq_8_question: '[AI_TRANSLATION]Поддержка входа через Clever и Google',
      faq_8_answer: '[AI_TRANSLATION]我们提供Clever和Google Classroom整合。查看我们的 **[https://codecombat.com/teachers/resources/clever-faq]Clever整合常见问题** 获取更多关于如何开始的详细信息。如果您使用Google Classroom，请确保使用Google单点登录(SSO)模态框注册教师账号。如果您已使用Google电子邮件拥有账户，请下次使用Google SSO模态框登录。在创建班级模态框中，您将看到链接Google Classroom的选项。我们目前仅通过Google Classroom支持花名册。注意：您必须至少使用Google SSO注册或登录一次，以便看到Google Classroom整合选项。',
      faq_9_question: '[AI_TRANSLATION]推荐的浏览器和操作系统',
      faq_9_answer: '[AI_TRANSLATION]CodeCombat и Ozaria лучше всего работают на компьютерах с минимум 4ГБ оперативной памяти, в современном браузере, таком как Chrome, Safari, Firefox или Edge. Chromebook с 2ГБ оперативной памяти могут испытывать небольшие графические проблемы на более поздних курсах. Требуется минимум 200 Кбит/с пропускной способности на студента, хотя рекомендуется 1+ Мбит/с.',
      core_curriculum_1_title: '[AI_TRANSLATION]Класс Ozaria',
      core_curriculum_1_text: '[AI_TRANSLATION]Повествовательное приключение по программированию, закладывающее основы информатики.',
      core_curriculum_1_link_text: '[AI_TRANSLATION]Попробуйте сейчас',
      core_curriculum_2_title: '[AI_TRANSLATION]CodeCombat для Классов',
      core_curriculum_2_text: '[AI_TRANSLATION]Полный учебный курс по информатике, который начинается с основ и продолжается до веб-разработки, разработки игр и **[http://codecombat.com/apcsp]AP CSP**.',
      core_curriculum_2_link_text: '[AI_TRANSLATION]Попробуйте сейчас',
      practice_enrichment_1_title: '[AI_TRANSLATION]Лига электронных спортов CodeCombat AI',
      practice_enrichment_1_text: '[AI_TRANSLATION]Эпическая платформа для соревновательного программирования в игровой среде, которая стимулирует креативное программирование.',
      ...
      practice_enrichment_2_text: '[AI_TRANSLATION]В партнёрстве с Roblox Education, это взаимодействие с ИИ значительно улучшает способности студентов в программировании и предоставляет реальную платформу для создания удивительных игр и опыта.',
      ...
      student_acceleration_1_text: '[AI_TRANSLATION]Первый инструмент генеративного ИИ, специально созданный для новичков в ИИ с акцентом на приватность и безопасность студентов. Сочетание простоты и мощности платформа ускоряет способности студентов и раскрывает их творческий потенциал.',
      ...
      student_acceleration_2_text: '[AI_TRANSLATION]Мы признаны College Board как официальный поставщик учебной программы и профессиональной подготовки для AP® Computer Science Principles (AP CSP). Наша программа AP CSP предоставляет игровые и готовые инструменты для подготовки учащихся к экзамену AP.',
      young_learners_1_title: '[AI_TRANSLATION]CodeCombat для младших классов',
      young_learners_1_text: '[AI_TRANSLATION]Наш флагманский учебный план для K-5 включает последовательность уровней обучения, которые на более медленном темпе обучают основам программирования, специально разработанные для учеников начальной школы.',
      young_learners_1_link_text: '[AI_TRANSLATION]Зарегистрируйтесь для Получения Бета-Доступа',
      young_learners_2_title: '[AI_TRANSLATION]AI HackStack Jr.',
      young_learners_2_text: '[AI_TRANSLATION]Вводит мульти-модальный генеративный AI на простой и интуитивно понятной платформе, специально разработанной для учащихся K-5.',
      young_learners_2_link_text: '[AI_TRANSLATION]Зарегистрируйтесь для Получения Бета-Доступа',
      funding_solutions_1_title: '[AI_TRANSLATION]赠款和资金来源',
      funding_solutions_1_text: '[AI_TRANSLATION]Мы понимаем, с какими финансовыми трудностями сталкиваются школы, и нам небезразлично помочь преодолеть эти препятствия. Ознакомьтесь с нашим подробным руководством по получению грантов или поговорите с нашей командой, чтобы узнать больше.',
      funding_solutions_1_link_text: '[AI_TRANSLATION]Узнать Больше',
      support_development_1_title: '[AI_TRANSLATION]Прямые Онлайн-Классы',
      support_development_1_text: '[AI_TRANSLATION]Хотите предоставить качественное обучение информатике, но у вас нет персонала для его реализации? Наша команда опытных инструкторов может предоставить увлекательные виртуальные уроки, идеально подходящие для использования в классе или в послешкольных программах.',
      support_development_1_link_text: '[AI_TRANSLATION]Зарегистрируйтесь для Получения Бета-Доступа',
      faq_header: '[AI_TRANSLATION]Часто задаваемые вопросы',
      faq_see_more: '[AI_TRANSLATION]Для более частых вопросов смотрите наш **[https://codecombat.zendesk.com/hc/en-us]центр помощи**.',
      trends_1_title: '[AI_TRANSLATION]Искусственный интеллект не заменяет программирование, он ускоряет его!',
      trends_1_text: '[AI_TRANSLATION]Мы официально вступили в эру искусственного интеллекта. Наряду с ажиотажем и преувеличениями приходит волна страха и неопределённости относительно будущего информатики. Видео, где ИИ пишет код с простыми вводными данными, и истории о том, как инженеров заменяют боты на ИИ, способствовали созданию драматичного, но в конечном итоге ошибочного нарратива. Правда в том, что ИИ не заменяет кодирование; он ускоряет его!',
      trends_1_linkText: '[AI_TRANSLATION]Читать блог',
      trends_2_title: '[AI_TRANSLATION]职业技术教育与Pat Keeney',
      trends_2_text: '[AI_TRANSLATION]Программы карьерного технического образования (CTE) готовят учеников стать учащимися на всю жизнь и предоставляют им навыки и знания, необходимые для успеха в их будущей карьере. В этом эпизоде Пэт Кини, сторонник CTE в McGraw Hill, делится своим опытом',
      trends_2_linkText: '[AI_TRANSLATION]Послушайте подкаст',
      learn_more_text: '[AI_TRANSLATION]Узнать Больше',
      your_turnkey_solutions: '[AI_TRANSLATION]Ваши Поворотные Решения',
      free_teacher_account: '[AI_TRANSLATION]Бесплатный аккаунт для учителей',
      trial_the_curriculum: '[AI_TRANSLATION]Протестируйте учебную программу со своими студентами сегодня!',
