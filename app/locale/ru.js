module.exports = {
  ...
  translation: {
    ...
    home_v3: {
      mission_title: '[AI_TRANSLATION]Присоединяйтесь к нашей миссии по обеспечению доступности программирования и ИИ для всех.',
      mission_supporting_text: '[AI_TRANSLATION]Мы стремимся предоставлять высококачественные образовательные решения, которые помогают каждому осознать свой потенциал и способствовать созданию лучшего будущего.',
      stat_card_1_text: '[AI_TRANSLATION]20 миллионов',
      stat_card_1_description: '[AI_TRANSLATION]Заинтересованные ученики',
      stat_card_2_text: '[AI_TRANSLATION]1 Миллиард',
      stat_card_2_description: '[AI_TRANSLATION]Строки кода',
      stat_card_3_text: '[AI_TRANSLATION]320,000',
      stat_card_3_description: '[AI_TRANSLATION]Поддержка Учителей',
      stat_card_4_text: '[AI_TRANSLATION]75,000',
      stat_card_4_description: '[AI_TRANSLATION]Школы, в которых была введена программа',
      stat_card_5_text: '[AI_TRANSLATION]190+',
      stat_card_5_description: '[AI_TRANSLATION]Страны',
      stat_card_6_text: '[AI_TRANSLATION]5.2 миллиона',
      stat_card_6_description: '[AI_TRANSLATION]Игроки в Киберспорт',
      learn_to_code: '[AI_TRANSLATION]Учиться **кодировать** и использовать **ИИ**, всё через **силу игры**.',
      innovative_play_experiences: '[AI_TRANSLATION]Мы создаем инновационные игровые переживания, чтобы сделать информатику привлекательной и доступной для всех.',
      im_an_educator: '[AI_TRANSLATION]Я преподаватель',
      im_a_parent: '[AI_TRANSLATION]Я - родитель',
      im_a_student: '[AI_TRANSLATION]Я Студент',
      programming_languages: '[AI_TRANSLATION]Языки программирования и инструменты ИИ',
      engaging_play_experiences: '[AI_TRANSLATION]Увлекательные игровые опыты',
      for_younger_learners: '[AI_TRANSLATION]Для младших учащихся',
      your_turnkey_solutions: '[AI_TRANSLATION]Ваши готовые решения',
      trends_insights: '[AI_TRANSLATION]Тенденции и Взгляды',
      awards_partners: '[AI_TRANSLATION]Награды и Партнеры',
      faq_visit_help_center: '[AI_TRANSLATION]Для ответов на часто задаваемые вопросы посетите наш **центр помощи**.',
      contact_us: '[AI_TRANSLATION]Связаться с нами',
      for_further_questions: '[AI_TRANSLATION]Для дальнейших вопросов',
      education_partner: '[AI_TRANSLATION]Образовательный[NEWLINE]Партнер',
      official_member: '[AI_TRANSLATION]Официальный[NEWLINE]Член',
      best_creativity_tool_for_students: '[AI_TRANSLATION]Лучший инструмент для развития креативности учеников[NEWLINE]',
      official_partner: '[AI_TRANSLATION]Официальный[NEWLINE]партнер',
      hour_of_code_activity_partner: '[AI_TRANSLATION]Час Кода[NEWLINE]Партнер Мероприятия',
      top_pick_for_learning: '[AI_TRANSLATION]Лучший выбор для[NEWLINE]Обучения',
      testimonals_1_title: '[AI_TRANSLATION]“Одно, что я теперь могу делать, чего не мог раньше, это действительно верить, что я могу программировать.”',
      testimonals_1_name: '[AI_TRANSLATION]Студент средней школы Mountain Ridge',
      testimonals_2_title: '[AI_TRANSLATION]"Назовите любую программу онлайн, я попробовал ее. Ни одна из них не сравнится с CodeCombat & Ozaria. Любой учитель, который хочет, чтобы его ученики научились программировать... начните с этого!"',
      testimonals_2_name: '[AI_TRANSLATION]Скотт Бейли, средняя школа Бобби Дьюк',
      testimonals_3_title: '[AI_TRANSLATION]"Я всегда мечтал заниматься дизайном видеоигр и изучением программирования... это дает мне отличную отправную точку."',
      testimonals_3_name: '[AI_TRANSLATION]Джои, 10-ый Класс',
      testimonals_4_title: '[AI_TRANSLATION]"Что мне больше всего нравится в CodeCombat, так это то, что программа не упрощает кодирование. Студенты учатся писать реальный код, при этом делая это таким образом, чтобы им было весело.”',
      testimonals_4_name: '[AI_TRANSLATION]Сандра Альстром, учитель, школьный округ округа Шеридан №2',
      carousel_1_title: '[AI_TRANSLATION]Игровое[NEWLINE]Обучение',
      carousel_1_text: '[AI_TRANSLATION]Благодаря нашему уникальному подходу, ученики с восторгом учатся, играя и пиша код с самого начала их приключения, способствуя активному обучению и формированию менталитета роста.',
      carousel_2_title: '[AI_TRANSLATION]Текстовое программирование[NEWLINE]Кодирование',
      carousel_2_text: '[AI_TRANSLATION]Наш собственный кодовый движок и интерпретатор предназначены для новичков, обучают настоящему программированию на Python, JavaScript и C++ с использованием понятных для начинающих терминов.',
      carousel_3_title: '[AI_TRANSLATION]Проектно-Ориентированные[NEWLINE]Оценки',
      carousel_3_text: '[AI_TRANSLATION]Эти проекты предоставляют студентам возможность самостоятельно создать свои собственные игры, которыми они могут поделиться. Мы предоставляем рубрики оценки, чтобы вы могли использовать капстоун-проекты в качестве основной итоговой оценки.',
      carousel_4_title: '[AI_TRANSLATION]ИИ[NEWLINE]Ускорение',
      carousel_4_text: '[AI_TRANSLATION]Мы учим студентов использовать ИИ для ускорения обучения и продвижения их навыков программирования. Это мощное сочетание открывает творческий потенциал для людей любого уровня навыков.',
      carousel_5_title: '[AI_TRANSLATION]Расширение полномочий педагогов',
      carousel_5_text: '[AI_TRANSLATION]Наши решения для классов созданы со всей необходимой поддержкой и ресурсами, которые могут потребоваться учителю для внедрения учебной программы и достижения успешных результатов.',
      carousel_6_title: '[AI_TRANSLATION]Влияние на студентов[NEWLINE]Влияние',
      carousel_6_text: '[AI_TRANSLATION]Наши продукты помогли более чем 20 миллионам студентов с удовольствием изучать информатику, научив их критически мыслить, быть уверенными и творческими учениками. Мы вовлекаем всех студентов, независимо от их опыта, помогая им найти путь к успеху в информатике.',
      engaging_boxes_1_title: '[AI_TRANSLATION]Классная Комната Ozaria',
      engaging_boxes_1_text: '[AI_TRANSLATION]Нарративное приключение в кодировании, закладывающее основы информатики.',
      engaging_boxes_2_title: '[AI_TRANSLATION]Класс CodeCombat',
      engaging_boxes_2_text: '[AI_TRANSLATION]Полный учебный курс по информатике, который начинается с основных концепций и проходит через веб-разработку, разработку игр и **[https://codecombat.com/apcsp]AP CSP**.',
      engaging_boxes_3_title: '[AI_TRANSLATION]Миры CodeCombat на Roblox',
      engaging_boxes_3_text: '[AI_TRANSLATION]В партнерстве с Roblox Education, это ИИ-оптимизированное взаимодействие существенно улучшает способности учеников в программировании и предоставляет реальную платформу для создания удивительных игр и опытов.',
      engaging_boxes_4_title: '[AI_TRANSLATION]Киберспортивная лига CodeCombat AI',
      engaging_boxes_4_text: '[AI_TRANSLATION]Великолепная платформа для соревновательного программирования, которая поощряет творческое программирование в игровой среде.',
      engaging_boxes_5_title: '[AI_TRANSLATION]CodeCombat AI HackStack',
      engaging_boxes_5_text: '[AI_TRANSLATION]Первый инструмент генеративного AI, специально созданный для тех, кто впервые познаёт AI, с акцентом на конфиденциальность и безопасность студентов. Объединяя простоту и мощь, платформа ускоряет способности студентов и освобождает их творческий потенциал.',
      engaging_boxes_6_title: '[AI_TRANSLATION]Главная Страница CodeCombat',
      engaging_boxes_6_text: '[AI_TRANSLATION]Имея доступ более чем к 530 уровням и эксклюзивным функциям, таким как питомцы, предметы только для премиум-пользователей и герои, ваш ребенок сможет полностью погрузиться в мир программирования. Они даже могут создавать игры, чтобы бросить вызов своим друзьям, строить сайты и приложения для обмена.',
      young_learners_1_title: '[AI_TRANSLATION]CodeCombat Jr.',
      young_learners_1_text: '[AI_TRANSLATION]Наш флагманский учебный курс K-5 включает в себя последовательность уровней обучения, которые обучают основам программирования в более медленном темпе, специально разработанные для учащихся начальной школы.',
      young_learners_1_linkText: '[AI_TRANSLATION]Зарегистрируйтесь для получения доступа к бета-версии',
      young_learners_2_title: '[AI_TRANSLATION]AI HackStack Jr.',
      young_learners_2_text: '[AI_TRANSLATION]Вводит многомодальный генеративный ИИ на простой и интуитивно понятной платформе, разработанной специально для студентов с K-5 классов.',
      young_learners_2_linkText: '[AI_TRANSLATION]Зарегистрируйтесь для получения доступа к бета-версии',
      solutions_1_title: '[AI_TRANSLATION]Профессиональное развитие',
      solutions_1_text: '[AI_TRANSLATION]Создано, чтобы предоставить всем учителям навыки, знания и уверенность в эффективном преподавании информатики.',
      solutions_1_middleText: '[AI_TRANSLATION]Получите до 3 зачетных единиц.',
      solutions_1_linkText: '[AI_TRANSLATION]Попробуйте сейчас',
      solutions_2_title: '[AI_TRANSLATION]Подготовка к экзамену AP CSP',
      solutions_2_text: '[AI_TRANSLATION]Мы признаны College Board как одобренный провайдер учебной программы и профессионального развития для AP® Computer Science Principles (AP CSP). Наша учебная программа AP CSP предлагает игровые и готовые к использованию инструменты для подготовки учащихся к экзамену AP.',
      solutions_2_linkText: '[AI_TRANSLATION]Попробуйте сейчас',
      solutions_3_title: '[AI_TRANSLATION]Источники грантов и финансирования',
      solutions_3_text: '[AI_TRANSLATION]Мы понимаем, с какими финансовыми препятствиями сталкиваются школы, и с энтузиазмом стремимся помочь их преодолеть. Ознакомьтесь с нашим подробным руководством по грантовому финансированию или поговорите с нашей командой, чтобы узнать больше.',
      solutions_4_title: '[AI_TRANSLATION]CodeCombat',
      solutions_4_text: '[AI_TRANSLATION]Наши инновационные решения помогли школьным округам по всей стране расширить или начать свои программы компьютерных наук. Будучи разработанными с учетом отзывов от нашего сообщества из более чем 320 000 педагогов, наше комплексное решение предлагает гибкую учебную программу, которая удовлетворяет потребности всех учащихся и педагогов. Её легко внедрить и масштабировать, а наша команда предоставляет необходимую подготовку и поддержку для ваших учителей.',
      solutions_5_title: '[AI_TRANSLATION]Живые онлайн-классы',
      solutions_5_text: '[AI_TRANSLATION]Наши онлайн-уроки программирования объединяют мощь игрового процесса и индивидуализированного обучения для незабываемого опыта вашего ребенка. От кодирования и публикации собственных игр Roblox до создания сайта для нового бизнеса, ваш ребенок исследует все возможности, которые открывает ИИ и программирование.',
      solutions_6_title: '[AI_TRANSLATION]CodeQuest',
      solutions_6_text: '[AI_TRANSLATION]Присоединяйтесь к нам для образовательного опыта, не сравнимого ни с чем другим, предназначенного вдохновлять и уполномочивать следующее поколение новаторов в области компьютерных наук. Эта уникальная возможность собирает студентов со всего мира для участия в серии хакатонов по программированию, изучения у ведущих спикеров и посещения ведущих университетов и технологических организаций.',
      solutions_6_linkText: '[AI_TRANSLATION]Узнать больше',
      solutions_7_title: '[AI_TRANSLATION]Партнерские Решения',
      solutions_7_text: '[AI_TRANSLATION]Присоединяйтесь к нашей миссии сделать программирование доступным и увлекательным для всех, став ценным партнёром. Наши гибкие структуры партнёрства включают образовательные компании, спонсоров eSports, международных дистрибьюторов и организации социального воздействия. Партнёры получают доступ к нашим легко используемым программам, ресурсам для реализации и вариантам обучения для успешного и приятного опыта.',
      solutions_8_title: '[AI_TRANSLATION]Решения для библиотек',
      solutions_8_text: '[AI_TRANSLATION]В качестве полностью самостоятельного и направляемого пользователями цифрового ресурса, CodeCombat является лучшим вариантом для библиотек, желающих предоставить своим членам всех возрастов возможность научиться программировать. Наша платформа предлагает всё необходимое для получения образования в области программирования высокого уровня через уникально увлекательную, игровую учебную программу. Идеально подходит для начинающих и до тех, кто хочет овладеть концепциями программирования уровня колледжа.',
      learn_more_text: '[AI_TRANSLATION]Узнать больше',
      best_homeschool_curriculum: '[AI_TRANSLATION]Лучшая домашняя[NEWLINE]учебная программа',
      sign_up_free: '[AI_TRANSLATION]Зарегистрироваться бесплатно',
      try_it_now: '[AI_TRANSLATION]Попробуйте сейчас',
    },

    schools_page: {
      most_effective_computer_science_solution: '[AI_TRANSLATION]Самое Эффективное Решение По Информатике Для **Школ**',
      our_comprehensive_implementation: '[AI_TRANSLATION]Наша комплексная реализация дает возможность учителям властвовать, привлекает учащихся и обеспечивает успешные результаты.',
      get_my_solution: '[AI_TRANSLATION]Получить Мое Решение',
      let_us_craft_a_custom_program: '[AI_TRANSLATION]Давайте Создадим Для Вас Индивидуальную Программу!',
      flexible_standards_aligned_curriculum_title: '[AI_TRANSLATION]Гибкая учебная программа, соответствующая стандартам',
      flexible_standards_aligned_curriculum_text: '[AI_TRANSLATION]Наш пошаговый подход охватывает основы информатики от базовых курсов до продвинутых и включает **[https://codecombat.com/apcsp]AP CSP, одобренный College Board**, веб- и разработку игр. Мы строим индивидуальные траектории для предоставления персонализированного обучения, соответствующего **[https://codecombat.com/standards]стандартам CSTA, ISTE и Common Core State Standards**. Гибкая учебная программа предлагает возможность преподавания на Python, JavaScript, C++, Luau и других языках.',
      comprehensive_tools_resources_title: '[AI_TRANSLATION]Комплексные инструменты и ресурсы',
      comprehensive_tools_resources_text: '[AI_TRANSLATION]Хаб ресурсов для учителей дает всем педагогам возможность приступить к обучению с первого дня. Легкий доступ к планам уроков, презентациям к урокам для студентов, рубрикам, дополнительным занятиям, капстоун-проектам и оценкам. Наши безопасные интеграции ИИ ускоряют потенциал студентов и позволяют педагогам оптимизировать учебное время. Для практики и применения в реальном мире мы предлагаем соревнования по программированию в формате киберспорта, дизайн игр в Roblox и веб-дизайн. Кроме того, педагоги могут контролировать темп обучения студентов с помощью функций назначения и блокировки контента.',
      accessible_data_insights_title: '[AI_TRANSLATION]Доступные Данные и Аналитика',
      accessible_data_insights_text: '[AI_TRANSLATION]Мы предоставляем администраторам необходимую информацию в реальном времени с помощью данных об использовании и отчетов о прогрессе на уровне класса, школы, района и штата. Отслеживание прогресса учеников на уровне студентов позволяет образовательным работникам легко определять, когда необходимо вмешательство, и встроенные предварительные и послепроцессные оценки измеряют понимание материала студентами.',
      high_quality_professional_development_title: '[AI_TRANSLATION]Качественное профессиональное развитие',
      high_quality_professional_development_text: '[AI_TRANSLATION]**[https://csteachers.org/pd-opportunities/accredited-pd/]Поддерживается Ассоциацией Учителей Информатики (CSTA)**, курс предлагает более 44 часов самостоятельного обучения в вебе, доступного по требованию. Программа предоставляется в индивидуальном темпе и разработана для вписывания в любой напряженный график. Курс подготавливает любого человека, с опытом преподавания или без, к успешному внедрению учебной программы по информатике.',
      earn_up_to_3_graduate_credits: '[AI_TRANSLATION]Получите до 3 зачетных единиц с этим курсом.',
      request_a_demo: '[AI_TRANSLATION]Запросить Демо',
      maximize_your_impact: '[AI_TRANSLATION]Все инструменты для максимизации результатов обучения',
      core_curriculum: '[AI_TRANSLATION]Основная учебная программа',
      practice_enrichment: '[AI_TRANSLATION]Практика и Обогащение',
      student_acceleration_ap_csp: '[AI_TRANSLATION]Ускорение Обучения Студентов & AP CSP',
      //    young_learners: "Young Learners",
      funding_solutions: '[AI_TRANSLATION]Решения финансирования',
      support_development: '[AI_TRANSLATION]Поддержка и Развитие',
      ai_support_acceleration_title: '[AI_TRANSLATION]Поддержка и ускорение с помощью ИИ',
      ai_support_acceleration_text: '[AI_TRANSLATION]Мы используем ИИ для более эффективного использования учебного времени. CodeCombat теперь поддерживает функцию подсказок ИИ, которая оценивает код, указывает на ошибки и объясняет, как их исправить. Самое главное, она предоставляет весь необходимый контекст для понимания причин ошибок, не раскрывая при этом всего решения. Ученикам всё ещё нужно будет проработать каждое уровневое задание по кодированию, но теперь вам не нужно останавливать занятие, чтобы помочь каждому индивидуально. **Учителя получают дневную норму в 100 подсказок ИИ**, а **каждый ученик получает 5 подсказок ИИ в день**, чтобы у них всегда была необходимая поддержка.',
      codecombat_ai_hackstack_text: '[AI_TRANSLATION]Для тех, кто новичок в ИИ, мы предлагаем **CodeCombat AI HackStack**. Этот инновационный инструмент не только обучает студентов использованию ИИ, но и предоставляет безопасный доступ к многим последним LLM, включая ChatGPT-4, Claude, Stable Diffusion, DALL-E и другие. После всего лишь короткого времени работы в учебном режиме, пользователи разблокируют полный творческий потенциал инструмента, позволяя создавать проекты от запроса к коду к публикации всего за минуты. Это приложение на базе ИИ позволяет пользователям генерировать игры, искусство, веб-сайты, код и многое другое. **Учителя получают лимит в 100 запросов ИИ в месяц** и **каждый студент получает 10 запросов ИИ в неделю**, чтобы создавать многочисленные ИИ-проекты.',
      pathways_for_success: '[AI_TRANSLATION]Пути к успеху',
      for_your_custom_pathway: '[AI_TRANSLATION]Для Вашего Индивидуального Пути',
      elementary_school: '[AI_TRANSLATION]Начальная школа',
      codecombat_jr: '[AI_TRANSLATION]CodeCombat Jr.',
      ai_hacksstack_jr: '[AI_TRANSLATION]AI HackStack Jr.',
      codecombat_worlds: '[AI_TRANSLATION]Миры CodeCombat',
      k: '[AI_TRANSLATION]Молодые студенты',
      icons_block_based: '[AI_TRANSLATION]Иконки и блоковое программирование',
      introduction_to_ai: '[AI_TRANSLATION]Введение в ИИ',
      grade_1: '[AI_TRANSLATION]1 Класс',
      simple_ai_templates: '[AI_TRANSLATION]Простые шаблоны ИИ',
      grade_2: '[AI_TRANSLATION]2 класс',
      complex_ai_templates: '[AI_TRANSLATION]Сложные Шаблоны ИИ',
      explorations: '[AI_TRANSLATION]Исследования',
      grade_3: '[AI_TRANSLATION]3 класс',
      block_based: '[AI_TRANSLATION]Блочное программирование',
      grade_4: '[AI_TRANSLATION]4 класс',
      block_based_text: '[AI_TRANSLATION]Блочное и Текстовое Программирование',
      grade_5: '[AI_TRANSLATION]5 класс',
      text: '[AI_TRANSLATION]Текст',
      our_k_5_implementation_pathway: '[AI_TRANSLATION]Наш путь внедрения для K-5 представит две новые **платформы, дружелюбные к начинающим**, включая CodeCombat Junior, наш флагманский учебный курс начального уровня, предлагающий прогрессивное обучение, которое **обучает базовым концепциям программирования в более медленном темпе**, и AI HackStack Junior, **мультимодальный инструмент ИИ**, позволяющий студентам рисовать, писать и разрабатывать свои собственные цифровые продукты. Это поэтапное продвижение позволит студентам развиваться вместе с нашим погруженным контентом и исследовать широкий спектр мышления в области вычислительной техники и понятий информатики.',
      middle_school: '[AI_TRANSLATION]Средняя школа',
      high_school: '[AI_TRANSLATION]Старшая школа',
      ozaria: '[AI_TRANSLATION]Ozaria',
      ai_hackstack: '[AI_TRANSLATION]AI HackStack',
      ai_league: '[AI_TRANSLATION]AI League',
      grade_6: '[AI_TRANSLATION]6 класс',
      ...
      introduction_to_coding_esports: '[AI_TRANSLATION]K',
      grade_7: '[AI_TRANSLATION]7 класс',
      ...
      ai_scenarios: '[AI_TRANSLATION]Сценарии ИИ',
      competitive_coding_arenas: '[AI_TRANSLATION]Арены Конкурентного Программирования',
      grade_8: '[AI_TRANSLATION]8 класс',
      functions_data: '[AI_TRANSLATION]Функции и данные',
      game_development: '[AI_TRANSLATION]Разработка Игр',
      open_ended_ai_projects: '[AI_TRANSLATION]Проекты с открытым исходным кодом ИИ',
      middle_school_implementation: '[AI_TRANSLATION]Наша реализация в средней школе закладывает **основу понятий кодирования** с Ozaria, нашей основной учебной программой по информатике. Это впоследствии расширяется до более широких возможностей выбора, где студенты будут **изучать кодирование и ИИ** на трех разных платформах. **Учитель и ученики могут выбирать**, насколько глубоко они будут изучать каждую из этих дополнительных платформ.',
      codecombat: '[AI_TRANSLATION]Введение в киберспортивное программирование',
      ap_csp: '[AI_TRANSLATION]AP CSP',
      cs1_4_data_science_cybersecurity_exam_content: '[AI_TRANSLATION]CS1-4 [NEWLINE] Data Science [NEWLINE] Кибербезопасность [NEWLINE] Экзаменационные материалы',
      advanced_cs: '[AI_TRANSLATION]Продвинутый курс информатики',
      ...
      global_esports_tournament: '[AI_TRANSLATION]Международный киберспортивный турнир',
      first_year_high_school_curriculum: '[AI_TRANSLATION]Первый год нашей программы для старших классов ориентирован на **AP CS Principles**, который включает наши курсы CodeCombat, CS1−CS4 и экзаменационный контент, такой как **Data Science** и **Computing Systems**. Более продвинутый год позволяет студентам исследовать наши **продвинутые CS курсы** и предлагает выбор среди наших трех платформ.',
      accessibility_representation_title: '[AI_TRANSLATION]Доступность и Репрезентативность',
      accessibility_representation_text: '[AI_TRANSLATION]Наш дизайн, ориентированный на студентов, встречает их там, где они находятся, и предоставляет необходимую поддержку. Возможности обучения как в очной, так и в дистанционной форме позволяют студентам учиться в любом месте и в любое время. Доступность для использования клавиатуры, полная совместимость с ридерами экрана и цветовая схема, удобная для цветовосприятия, гарантируют, что каждый может научиться программировать.',
      privacy_security_title: '[AI_TRANSLATION]Конфиденциальность и Безопасность',
      privacy_security_text: '[AI_TRANSLATION]Мы серьезно относимся к безопасности студентов, кибербезопасности и конфиденциальности данных, и следуем строгим регуляциям конфиденциальности, включая COPPA, FERPA, SOPIPA, California AB 1584, CalOPPA, Fair Information Practices, CAN-SPAM, а также GDPR. Все данные надежно хранятся на Amazon Web Services в США. Наши интеграции с ИИ имеют защитные механизмы для защиты личной идентифицируемой информации и ограничения чувствительного контента. Обмен проектами контролируется, а коммуникация между сверстниками ограничена. Договоры о обработке данных доступны, посетите **https://codecombat.com/privacy** для получения дополнительной информации.',
      contact_our_team: '[AI_TRANSLATION]Связаться С Нашей Командой',
      for_turnkey_solutions: '[AI_TRANSLATION]Для вашего готового решения',
      testimonials_1_quote: '[AI_TRANSLATION]«Позвольте мне сначала это ясно выразить. Я рекомендую ваш продукт, потому что это лучший инструмент для обучения программированию, который существует на Земле на данный момент.»',
      testimonials_1_name: '[AI_TRANSLATION]Сет Рейхельсон',
      testimonials_1_title: '[AI_TRANSLATION]Учитель информатики AP, Lake Brantley High School. Победитель премии White House Champion of Change',
      testimonials_2_quote: '[AI_TRANSLATION]"[Ozaria] представляет собой полный учебный курс по информатике, это действительно впечатляет, очень обширно [...] В нём есть всё, что вам нужно [...] Не думаю, что мы видели что-то подобное с таким количеством дополнительных материалов для качественного обучения."',
      testimonials_2_name: '[AI_TRANSLATION]Таннер Хиггин',
      testimonials_2_title: '[AI_TRANSLATION]Редакционный директор - Учебное содержание, Common Sense Education',
      testimonials_2_full_review_text: '[AI_TRANSLATION]Полный обзор здесь',
      testimonials_3_quote: '[AI_TRANSLATION]“CodeCombat был одной из самых легких в реализации программ, которые мы внедряли, и участие студентов было чрезвычайно высоким. Способ, которым спроектировано содержание, идеально поддерживает и позволяет студентам быстро переходить к программированию высокого уровня, далеко за пределами всего, что мы могли надеяться.”',
      testimonials_3_name: '[AI_TRANSLATION]Стив Конг',
      testimonials_3_title: '[AI_TRANSLATION]Специалист по учебным услугам, школьный округ Риверсайд',
      testimonials_4_quote: '[AI_TRANSLATION]"Теперь я могу верить в то, что действительно могу программировать, что раньше было для меня невозможно."',
      testimonials_4_title: '[AI_TRANSLATION]Студент средней школы Mountain Ridge',
      testimonials_5_quote: '[AI_TRANSLATION]“CodeCombat полностью преобразил мои методы преподавания программирования... Я использую отличные учебные ресурсы, включая Руководства по учебной программе, Руководства по проектам и Решения. Использование CodeCombat помогло мне обучать довольно продвинутым концепциям таким образом, что студентам это нравится и они понимают. Что мне больше всего нравится в CodeCombat, так это то, что он не упрощает кодирование. Студенты учатся писать настоящий код, делая это так, что им это весело.”',
      testimonials_5_name: '[AI_TRANSLATION]Сандра Альстрём',
      testimonials_5_title: '[AI_TRANSLATION]Учитель, школьный округ округа Шеридан №2',
      faq_1_question: '[AI_TRANSLATION]Что вам нужно знать о экзаменах по сертификации и AP CSP',
      faq_1_answer: '[AI_TRANSLATION]Программы профессионально-технического образования (CTE) в США нацелены на подготовку студентов к востребованным в промышленности навыкам и могут привести к обучению в технических школах или колледжах. Согласно законам штата и федеральным законам, программы CTE должны предлагать студентам послевузовской кредит, профессиональные сертификаты или часы стажировки. Хотя в некоторых областях, таких как кибербезопасность, ценятся сертификационные экзамены, другие, такие как программная инженерия, отдают предпочтение четырёхлетнему образованию перед такими экзаменами. Однако сдача экзамена AP по принципам компьютерных наук является признанным путём к получению кредитов после окончания школы, что позволяет студентам обойти дорогостоящие и времязатратные требования колледжа. Чтобы помочь студентам подготовиться, CodeCombat предлагает **[https://codecombat.com/apcsp]курс AP CSP**, одобренный Колледжем Борда.',
      faq_2_question: '[AI_TRANSLATION]Как мы используем ИИ для поддержки педагогов',
      faq_2_answer: '[AI_TRANSLATION]Мы используем ИИ для более эффективного использования учебного времени. С увеличением размера классов и ограниченным временем для индивидуализированных занятий наш ИИ-помощник для чата на уровне становится идеальным инструментом для решения индивидуальных вопросов учащихся. Этот мощный помощник может оценить код, указать на ошибки, объяснить, как их исправить, и предоставить все необходимые контексты для понимания "почему". И что самое важное, он не даст решения. Так как доступна только помощь с следующей строкой кода, учащимся все равно придется самостоятельно прорабатывать задания на каждом уровне, но теперь вам не нужно останавливать урок, чтобы ответить на индивидуальные вопросы.',
      faq_3_question: '[AI_TRANSLATION]Как мы безопасно и ответственно интегрируем ИИ',
      faq_3_answer: '[AI_TRANSLATION]Наша технология ИИ придерживается принципов безопасности в первую очередь, обеспечивая уверенность как студентам, так и преподавателям. Мы не разрешаем нашим провайдерам LLM на бэкенде тренировать ваши чаты и установили защитные меры против неприемлемого контента. Эти меры включают фильтрацию вредного языка, сосредоточение внимания на релевантных темах, защиту личной информации и обучение студентов потенциальным подводным камням ИИ. Более того, мы регистрируем активность чата ИИ для мониторинга учителем и поддерживаем строгие протоколы конфиденциальности данных и безопасности.',
      faq_4_question: '[AI_TRANSLATION]Почему информатика важна',
      faq_4_answer: '[AI_TRANSLATION]Образование в области компьютерных наук предоставляет немедленные преимущества в виде повышения умений решения проблем, уточнения математических способностей и поощрения логического мышления, необходимого для успеха в других основных школьных предметах. Обучение выходит далеко за рамки кодирования, повышая способность студентов решать сложные задачи и адаптироваться к различным ситуациям. Смотрите, как Ozaria помогает создавать эти **[https://docs.google.com/presentation/d/1xcc1tw4k8oY9basXuxO0v_RU9z-Dr8ImvbvbuNvJeHA/edit#slide=id.g134a7e7c8f1_0_3]междисциплинарные связи**. Наша учебная программа разработана, чтобы снабдить студентов сегодня ключевыми навыками компьютерных наук, которые подготовят их к цифровым рабочим местам завтра.',
      faq_5_question: '[AI_TRANSLATION]Почему игровая форма обучения работает',
      faq_5_answer: '[AI_TRANSLATION]Обучение на основе игр настолько эффективно, поскольку предоставляет безопасную среду, где не боятся неудач, а ожидают их, предлагая возможность для роста и понимания. Такой подход побуждает учащихся учиться на своих ошибках и адаптировать свои стратегии для успеха. Более того, интерактивная и динамичная природа игр помогает учащимся эффективнее запоминать информацию, поскольку они обучаются через практический, наглядный опыт. Это активно вовлекает студентов в процесс обучения, повышая их мотивацию и удовольствие.',
      faq_6_question: '[AI_TRANSLATION]Как найти альтернативные источники финансирования',
      faq_6_answer: '[AI_TRANSLATION]Образование в области информационных технологий стало важным этапом в академическом пути студента, однако многие школы сталкиваются с проблемой обеспечения своих студентов полноценными программами обучения информатике. В CodeCombat мы понимаем, с какими финансовыми трудностями сталкиваются школы, и стремимся помочь им преодолеть эти препятствия. Гранты могут стать ценным ресурсом, но их сложно найти и получить. Ознакомьтесь с нашими подробными **[https://codecombat.com/grants]руководствами по получению грантов** или свяжитесь с нашей командой, чтобы узнать больше.',
      faq_7_question: '[AI_TRANSLATION]Как Начать',
      faq_7_answer_1: '[AI_TRANSLATION]Создайте аккаунт учителя или администратора',
      faq_7_answer_2: '[AI_TRANSLATION]Создать класс',
      faq_7_answer_3: '[AI_TRANSLATION]Добавить учеников',
      faq_7_answer_4: '[AI_TRANSLATION]Проследите, чтобы ваши ученики весело учились программировать',
      faq_8_question: '[AI_TRANSLATION]Поддержка входа через Clever и Google',
      faq_8_answer: '[AI_TRANSLATION]Мы предлагаем интеграцию как с Clever, так и с Google Classroom. Ознакомьтесь с нашим **[https://codecombat.com/teachers/resources/clever-faq]FAQ по интеграции с Clever** для получения более подробной информации о том, как начать работу. Если вы используете Google Classroom, обязательно используйте модальное окно Google Single Sign-On (SSO) для регистрации учетной записи учителя. Если у вас уже есть учетная запись с использованием вашей электронной почты Google, используйте модальное окно Google SSO для входа в следующий раз. В модальном окне создания класса вы увидите опцию привязки Google Classroom. В настоящее время мы поддерживаем только составление списков через Google Classroom. Обратите внимание: вы должны использовать Google SSO для регистрации или входа хотя бы один раз, чтобы увидеть опцию интеграции с Google Classroom.',
      faq_9_question: '[AI_TRANSLATION]Рекомендуемые браузер и операционная система',
      faq_9_answer: '[AI_TRANSLATION]CodeCombat и Ozaria лучше всего работают на компьютерах с минимум 4 Гб ОЗУ, в современных браузерах, таких как Chrome, Safari, Firefox или Edge. На Chromebook с 2 Гб ОЗУ в более поздних курсах могут возникнуть незначительные графические проблемы. Минимальная пропускная способность на ученика составляет 200 Кбит/с, хотя рекомендуется 1+ Мбит/с.',
      core_curriculum_1_title: '[AI_TRANSLATION]Классная Комната Ozaria',
      core_curriculum_1_text: '[AI_TRANSLATION]Нарративное приключение в кодировании, закладывающее основы информатики.',
      core_curriculum_1_link_text: '[AI_TRANSLATION]Попробуйте сейчас',
      core_curriculum_2_title: '[AI_TRANSLATION]Класс CodeCombat',
      core_curriculum_2_text: '[AI_TRANSLATION]Полная учебная программа по CS, начиная с основных понятий и заканчивая веб-разработкой, разработкой игр и **[http://codecombat.com/apcsp]AP CSP**.',
      core_curriculum_2_link_text: '[AI_TRANSLATION]Попробуйте сейчас',
      practice_enrichment_1_title: '[AI_TRANSLATION]Киберспортивная лига CodeCombat AI',
      practice_enrichment_1_text: '[AI_TRANSLATION]Великолепная платформа для соревновательного программирования, которая поощряет творческое программирование в игровой среде.',
      practice_enrichment_1_link_text: '[AI_TRANSLATION]Попробуйте сейчас',
      practice_enrichment_2_title: '[AI_TRANSLATION]Миры CodeCombat на Roblox',
      practice_enrichment_2_text: '[AI_TRANSLATION]В партнерстве с Roblox Education, это ИИ-оптимизированное взаимодействие существенно улучшает способности учеников в программировании и предоставляет реальную платформу для создания удивительных игр и опытов.',
      ...
      student_acceleration_1_text: '[AI_TRANSLATION]Первый инструмент генеративного AI, специально созданный для тех, кто впервые познаёт AI, с акцентом на конфиденциальность и безопасность студентов. Объединяя простоту и мощь, платформа ускоряет способности студентов и освобождает их творческий потенциал.',
      student_acceleration_1_link_text: '[AI_TRANSLATION]Попробуйте сейчас',
      student_acceleration_2_title: '[AI_TRANSLATION]Подготовка к экзамену AP CSP',
      student_acceleration_2_text: '[AI_TRANSLATION]Мы признаны College Board как одобренный провайдер учебной программы и профессионального развития для AP® Computer Science Principles (AP CSP). Наша учебная программа AP CSP предлагает игровые и готовые к использованию инструменты для подготовки учащихся к экзамену AP.',
      young_learners_1_title: '[AI_TRANSLATION]CodeCombat Jr.',
      young_learners_1_text: '[AI_TRANSLATION]Наш флагманский учебный курс K-5 включает в себя последовательность уровней обучения, которые обучают основам программирования в более медленном темпе, специально разработанные для учащихся начальной школы.',
      young_learners_1_link_text: '[AI_TRANSLATION]Зарегистрируйтесь для получения доступа к бета-версии',
      young_learners_2_title: '[AI_TRANSLATION]AI HackStack Jr.',
      young_learners_2_text: '[AI_TRANSLATION]Вводит многомодальный генеративный ИИ на простой и интуитивно понятной платформе, разработанной специально для студентов с K-5 классов.',
      young_learners_2_link_text: '[AI_TRANSLATION]Зарегистрируйтесь для получения доступа к бета-версии',
      funding_solutions_1_title: '[AI_TRANSLATION]Источники грантов и финансирования',
      funding_solutions_1_text: '[AI_TRANSLATION]Мы понимаем, с какими финансовыми препятствиями сталкиваются школы, и с энтузиазмом стремимся помочь их преодолеть. Ознакомьтесь с нашим подробным руководством по грантовому финансированию или поговорите с нашей командой, чтобы узнать больше.',
      funding_solutions_1_link_text: '[AI_TRANSLATION]Узнать больше',
      support_development_1_title: '[AI_TRANSLATION]Живые онлайн-классы',
      support_development_1_text: '[AI_TRANSLATION]Хотите предложить качественное обучение информатике, но у вас нет персонала для его реализации? Наша команда мастер-инструкторов может предоставить увлекательные виртуальные уроки, идеально подходящие для программ в классе или после школы.',
      support_development_1_link_text: '[AI_TRANSLATION]Зарегистрируйтесь для получения доступа к бета-версии',
      faq_header: '[AI_TRANSLATION]Часто Задаваемые Вопросы',
      faq_see_more: '[AI_TRANSLATION]Смотрите больше часто задаваемых вопросов в нашем **[https://codecombat.zendesk.com/hc/en-us]центре помощи**.',
      trends_1_title: '[AI_TRANSLATION]ИИ не заменяет программирование, он ускоряет его!',
      trends_1_text: '[AI_TRANSLATION]Мы официально вступили в эру ИИ. Вместе с ажиотажем и преувеличениями приходит волна страха и неопределенности относительно будущего информатики. Видеоролики, в которых ИИ пишет код с простыми вводными, и истории об инженерах, замененных ботами ИИ, подпитывают драматический, но в итоге неверный нарратив. Правда в том, что ИИ не заменяет кодирование; он ускоряет его!',
      trends_1_linkText: '[AI_TRANSLATION]Читать блог',
      trends_2_title: '[AI_TRANSLATION]Профессионально-техническое образование с Пэт Кини',
      trends_2_text: '[AI_TRANSLATION]Профессиональное техническое образование (CTE) готовит студентов к постоянному самообучению и предоставляет им умения и знания, необходимые для успеха в будущей карьере. В этом эпизоде Пат Кини, сторонник CTE в McGraw Hill, делится своим опытом.',
      trends_2_linkText: '[AI_TRANSLATION]Слушать подкаст',
      learn_more_text: '[AI_TRANSLATION]Узнать больше',
      your_turnkey_solutions: '[AI_TRANSLATION]Ваши готовые решения',
      free_teacher_account: '[AI_TRANSLATION]Бесплатный Аккаунт Для Учителей',
      trial_the_curriculum: '[AI_TRANSLATION]Опробуйте учебную программу со своими учениками уже сегодня!',
