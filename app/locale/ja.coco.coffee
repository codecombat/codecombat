...
#    code_line_number: "1 Billion"
  ...
  new_home:
    title_coco: "CodeCombat - PythonとJavaScriptを学ぶコーディングゲーム"
    title_ozar: "CodeCombat - PythonとJavaScriptを学ぶコーディングゲーム"
...
#    meta_keywords_ozar: "CodeCombat, python, javascript, Coding Games, Computer Science Program, Adventure, Epic Story"
    meta_description_coco: "プログラミングゲームを通してコードを学ぼう。Python、JavaScript、HTMLをパズルを解くように学んで、あなた自身のゲームやウェブサイト作りを学びましょう。"
    meta_description_ozar: "プログラミングゲームを通してコードを学ぼう。Python、JavaScript、HTMLをパズルを解くように学んで、あなた自身のゲームやウェブサイト作りを学びましょう。"
...
#    description_coming_soon: "Description coming soon"
  ...
  options:
    ...
    editor_config_title_coco: "エディターの設定"
    editor_config_title_ozar: "エディターの設定"
