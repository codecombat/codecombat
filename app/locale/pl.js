module.exports = {
  ...
  translation: {
    ...
    ozaria_home: {
      subtitle: "Informatyka, która wciąga",
      heading_subtitle: "Przygoda z kodowaniem dla uczniów i gotowe rozwiązanie dla nauczania informatyki.",
      item_list_p: "Wypróbuj Rozdział 1 za darmo już dziś!",
      engaging_heading_corner: "Rozwiązanie, które angażuje uczniów i wspiera nauczycieli",
      engaging_row1_h2: "Łatwa implementacja",
      engaging_row1_p: "Nawet bez doświadczenia w programowaniu możesz prowadzić pełny program nauczania informatyki dzięki Ozaria. Nasze gotowe do użycia plany lekcji i intuicyjny panel będą narzędziami, których potrzebujesz, aby być gotowym do nauczania od pierwszego dnia.",
      engaging_row2_h2: "Immersyjna rozgrywka",
      engaging_row2_p: "Uczniowie są zaangażowani w grę przygodową, w której ich wiedza z zakresu informatyki rośnie wraz z fabułą. W tym angażującym środowisku nauki uczniowie rozwijają realne umiejętności dzięki sile zabawy.",
      engaging_row3_h2: "Program zgodny ze standardami",
      engaging_row3_p: "Ozaria spełnia standardy CSTA i ISTE, umożliwiając pewne nauczanie, podczas którego uczniowie opanowują kluczowe koncepcje z zakresu informatyki, rozwijają umiejętności myślenia obliczeniowego i uczą się o znaczeniu informatyki w ich codziennym życiu.",
      pd_blurb: "Naucz się skutecznie nauczać informatyki dzięki naszemu samodzielnie realizowanemu kursowi certyfikowanemu przez CSTA. Zarób do 40 godzin kredytowych w dowolnym czasie i z dowolnego urządzenia.",
      back_cta_1_a: "Wypróbuj Rozdział 1 za Darmo",
      speech_bubble_testimonial_1_blockquote: "Twój zespół ponownie osiągnął Święty Graal edutainmentu. Moim zdaniem jako nauczyciel z 26-letnim doświadczeniem w gimnazjum, nie ma bardziej angażującego źródła do nauki programowania.",
      core_curriculum_header: "Podstawowy program nauczania informatyki",
      core_curriculum_p: "Opracowaliśmy nasz model instruktażowy na podstawie sprawdzonych teorii i szerokiego zakresu dowodów na temat tego, jak uczniowie najlepiej się uczą.",
      core_curriculum_carousel_item1_header: "Nawiąż połączenia",
      core_curriculum_carousel_item1_p: "Na początku każdego modułu wykorzystaj nasze gotowe do użycia slajdy lekcyjne, aby pomóc uczniom nawiązać związek między nowymi koncepcjami informatycznymi a odpowiednimi przykładami z ich codziennego życia.",
      core_curriculum_carousel_item2_header: "Budowanie własnego znaczenia",
      core_curriculum_carousel_item2_p: "Następnie prowadź swoich uczniów w budowaniu głębszego zrozumienia nowych koncepcji poprzez działania bez komputera i dyskusje, które są częścią naszych planów lekcji.",
      core_curriculum_carousel_item3_header: "Nauka nowych koncepcji",
      core_curriculum_carousel_item3_p: "W trzecim etapie cyklu nauki twoi uczniowie poznają nowe koncepcje dzięki dialogowi ekspozycyjnemu między postaciami w historii Ozaria. Dubbing, grafika i animacje ułatwiają przyswajanie nowych informacji, sprawiając, że nauka jest jeszcze bardziej dostępna i przyjemna.",
      core_curriculum_carousel_item4_header: "Zastosowanie nowej wiedzy",
      core_curriculum_carousel_item4_p: "Następnie Twoi uczniowie zastosują to, czego się nauczyli, pisząc w Pythonie lub JavaScript, aby rozwiązać różnorodne wyzwania na poziomach gry. Wbudowane wskazówki pomagają uczniom zidentyfikować i naprawić błędy, co prowadzi do większej pewności siebie w programowaniu.",
      core_curriculum_carousel_item5_header: "Projekt podsumowujący",
      core_curriculum_carousel_item5_p: "Na koniec każdego rozdziału Twoi uczniowie zostaną postawieni przed wyzwaniem zaprezentowania nowych umiejętności i wyrażenia swojej kreatywności poprzez projekty podsumowujące, w ramach których będą tworzyć własne gry, opowieści i więcej.",
      core_curriculum_scope_sequence: "Zobacz zakres i sekwencję",
      core_curriculum_sample_lesson_slides: "Zobacz przykładowe slajdy lekcyjne",
      global_community_header: "Dołącz do naszej globalnej społeczności",
      global_community_row1_p: "Uczniowie",
      global_community_row2_p: "Linie kodu",
      global_community_row3_p: "Nauczyciele",
      global_community_row4_p: "Kraje",
      admin_dashboard_header: "Kompleksowe panele nauczycielskie i administracyjne",
      admin_dashboard_p: "Zaprojektowane na podstawie opinii naszej społeczności ponad 140 000 edukatorów, Ozaria adresuje wyzwania nauczania informatyki, dostarczając narzędzi i zasobów, które działają.",
      admin_dashboard_row1_p: "Intuicyjny Panel Nauczyciela zapewnia dostęp do planów lekcji dla uczniów, przewodników tempo, strategii nauczania zdalnego i innych zasobów wspierających Twoje potrzeby.",
      admin_dashboard_row2_p: "Strona Monitorowania Postępów pozwala śledzić postępy uczniów na bieżąco, uzyskiwać cenne informacje na temat ich osiągnięć i natychmiastowo identyfikować potrzebę interwencji.",
      admin_dashboard_row3_a: "Poproś o wycenę",
      acodus_awards_a: "Wypróbuj Rozdział 1 za Darmo",
      speech_bubble_testimonial_2_blockquote: "To najbardziej dostępna strona do nauki programowania, jaką widziałem do tej pory. Doceniam historię, która towarzyszy Ozaria, ponieważ jest zgodna z misją, którą moi uczniowie mogą sobie współczuć. Szczerze mówiąc, uwielbiam to. W rzeczywistości zdarzyło mi się grać znacznie dłużej niż chciałem przyznać w zeszły weekend!",
      shareable_resources_header: "Zasoby do udostępniania",
      shareable_resources_p: "Udostępnij poniższe zasoby nauczycielom, administratorom i innym osobom zaangażowanym w wprowadzanie informatyki do Twojej szkoły lub rozwijanie już istniejących ofert.",
      shareable_resources_a: "Pobierz ulotkę",
      back_cta_2_a: "Wypróbuj Rozdział 1 za Darmo",
      faq_header: "Najczęściej zadawane pytania",
      faq_row1_header: "W jaki sposób Ozaria jest powiązana z CodeCombat?",
      faq_row1_p: "Ozaria to ewolucja CodeCombat, jednej z najpopularniejszych gier do nauki programowania w historii, skoncentrowana na klasie. Zbudowaliśmy Ozaria na podstawie wglądów uzyskanych dzięki nauczaniu ponad 20 milionów uczniów Pythona i JavaScript. Ozaria łączy nowe modele pedagogiczne, immersyjną opowieść i została zaprojektowana do stosowania zarówno w klasach, jak i nauczaniu zdalnym.",
      faq_row2_header: "Jakie są odpowiednie dla Ozaria wieki lub klasy?",
      faq_row2_p: "Ozaria jest zgodna ze standardami CSTA i ISTE dotyczącymi informatyki w gimnazjum, ale była praktykowana i cieszyła się uznaniem zarówno w szkołach podstawowych, jak i średnich.",
      faq_row3_header: "Ile kosztuje dostęp do wszystkich dostępnych jednostek i zasobów?",
      faq_row3_p_part1: "Dostosowujemy rozwiązania dla szkół i dystryktów, współpracując z Tobą, aby zrozumieć Twoje potrzeby, kontekst i budżet. ",
      faq_row3_p_part2: " dla dalszych szczegółów! Oferujemy również ",
      faq_row3_p_part3: "przewodnik po źródłach finansowania",
      faq_row3_p_part4: " na programy CS dla szkół i dystryktów.",
      faq_row4_header: "Czy Ozaria posiada uczenie się poprzez projektowanie?",
      faq_row4_p: "Tak. Ozaria zawiera udostępniane projekty końcowe na zakończenie każdego rozdziału, w których uczniowie tworzą własne gry. Projekty te pełnią funkcję ocen sumatywnych i są doskonałym sposobem na wyrażenie siebie przez uczniów i demonstrowanie swoich osiągnięć kolegom, przyjaciołom i rodzinie.",
      faq_row5_header: "Czy mogę używać Ozaria jako głównego programu nauczania mojej klasy?",
      faq_row5_p: "Oczywiście! Ozaria zawiera wszystko, czego potrzebujesz, aby prowadzić pełną klasę informatyki, nawet jeśli nie masz doświadczenia w informatyce. Od planów lekcji i przewodników po rozwiązania po oceny projektów i wbudowane dostosowanie do standardów, wszystko jest tutaj.",
      faq_row6_p_part1: "Jeśli masz inne pytania, proszę ",
      see_faq_prefix: "Zobacz więcej",
      see_faq_link: "najczęściej zadawanych pytań w naszym centrum pomocy",
      see_faq_suffix: ".",
      summary: "Ozaria to program informatyczny, gra przygodowa i fantastyczna historia, w której uczniowie opanowują zaginioną magię kodowania, aby ocalić swój świat.",
      value_prop1_h1: "Epicka historia. Immersyjna rozgrywka.",
      value_prop1_h2: "Inspiruj głębsze połączenie z nauką",
      value_prop1_p: "W Ozaria uczniowie znajdują się w nowym świecie, gdzie opanowują kluczowe koncepcje informatyczne, aby rozwijać się w grze. Rozwijająca się narracja tworzy potężne doświadczenie nauki skoncentrowanej na uczniu, gdzie inwestycja ucznia w historię Ozaria równa się inwestycji w ich własną drogę nauki.",
      value_prop2_h1: "Odkryj bohatera w każdym uczniu",
      value_prop2_h2: "Budowanie prawdziwych umiejętności przez grę",
      value_prop2_p: "Koncepcje i umiejętności są wprowadzane za pomocą starannie zaprojektowanego postępu treści, który obejmuje poziomy gier, dialogi instruktażowe postaci, sceny przerywnikowe i wiele więcej. Uczniowie uczą się pisania w Pythonie lub JavaScript, rozwiązywania problemów z użyciem myślenia obliczeniowego, demonstrują swoje zrozumienie poprzez oceny formatywne i stosują to, czego się nauczyli, tworząc własne projekty.",
      value_prop3_h1: "Rozpocznij swoją podróż za darmo",
      value_prop3_p: "Nauczaj poprzez przygodę dzięki darmowej zawartości obejmującej podstawowe koncepcje informatyczne, oraz dostępem do przewodników implementacyjnych i planów lekcji.",
      projects_inspire_heading: "Projekty, które inspirują. Zasoby, które umożliwiają.",
      student_creativity: "Uwolnij kreatywność ucznia",
      student_creativity_paragraph: "Na końcu każdej jednostki uczniowie stosują to, czego się nauczyli, tworząc projekty, od gier po opowieści z możliwością wyboru własnej przygody i wiele więcej. Zbudowane z etapowymi celami, pozwalające na nieograniczoną ideację, uczniowie tworzą udostępnialny i grywalny portfolio prac, które prezentują ich kreatywną tożsamość.",
      teach_with_support: "Naucz z wsparciem",
      teach_with_support_paragraph: "Ozaria jest przeznaczona dla edukatorów. Każda jednostka w programie nauczania ma plan lekcji, który opisuje cele nauczania, powszechne błędy uczniów, kluczowe terminy i standardy CSTA. Ponadto, kompleksowy panel nauczycielski pomaga nauczycielom śledzić postępy uczniów i sprawdzać kod uczniów.",
      request_demo: "Poproś o Demo",
      im_an_educator: "Jestem Edukatorem",
      im_a_student: "Jestem Uczniem",
      global_title: "Dołącz do naszej globalnej społeczności uczniów i edukatorów",
      global_subtitle1: "Uczniowie",
      global_subtitle2: "Linie kodu",
      global_subtitle3: "Nauczyciele",
      global_subtitle4: "Kraje",
      sign_up: "Zarejestruj się",
      individual_account_warning: "Jesteś zalogowany jako __name__, co jest indywidualnym kontem. Ozaria jest przeznaczona wyłącznie dla kont nauczycielskich i uczniowskich; czy potrzebujesz zaktualizować swoje konto?",
      learner_number: "12 Milionów",
      code_line_number: "1 Miliard",
      dei_initiatives: "Jakie inicjatywy Ozaria podejmuje, aby zapewnić różnorodność, równość i inkluzję w grze?",
      dei_initiatives_blurb: "Ozaria dedykuje się promowaniu różnorodności, równości i inkluzji (DEI) w grze. Poprzez różnorodne przedstawienie postaci, równe szanse i inkluzywne środowisko, Ozaria akceptuje różnice i promuje przyjemne doświadczenia dla graczy z różnych środowisk i zdolności. Odkryj naszą __deipage__, aby dowiedzieć się więcej o naszym zaangażowaniu i inicjatywach w zakresie DEI w Ozaria.",
      dei_page: "stronę DEI",
      ozaria_efficacy: "Jak Ozaria mierzy i demonstruje swoją skuteczność w poprawie wyników nauczania w klasie?",
      ozaria_efficacy_blurb: "Priorytetem dla nas jest skuteczność poprzez praktyki oparte na dowodach i ocenę. Nasza __efficacypage__ oferuje szczegółowe statystyki, prawdziwe cytaty nauczycieli i przekonujące studia przypadków, które demonstrują przełomowy wpływ Ozaria. Tworząc znaczące doświadczenia edukacyjne i stosując praktyki oparte na dowodach, projektujemy treści, które dostarczają najważniejszych wyników dla nauczycieli i uczniów.",
      efficacy_page: "stronę skuteczności",
      social_learning: "Czy Ozaria promuje uczenie się społeczne i emocjonalne (SEL)?",
      social_learning_blurb: "Tak! Ozaria aktywnie integruje społeczne i emocjonalne uczenie się (SEL) do swojego programu nauczania. Poprzez zintegrowane z gry działania, uczniowie rozwijają kluczowe umiejętności takie jak podejmowanie decyzji, samoświadomość, zarządzanie sobą, świadomość społeczna, umiejętności interpersonalne i odpowiedzialne podejmowanie decyzji. Możesz dowiedzieć się więcej o naszej filozofii na naszej __selpage__.",
      sel_page: "stronie SEL",
    },
    ...
    new_home: {
      ...
      top_banner_blurb_pd: "Oferujemy teraz rozwój zawodowy dla edukatorów.",
      top_banner_blurb_funding: "Nowość: Przewodnik po źródłach finansowania ACT CARES dotyczących funduszy ESSER i GEER na programy CS.",
      top_banner_blurb_maintenance: "Aktualizacje nadchodzą! Planowane prace konserwacyjne: do 3 godzin rozpoczynające się o __maintenanceStartTime__.",
      top_banner_blurb_podcast: "NOWOŚĆ: Odkryj świat EdTech dzięki naszemu nowemu podcastowi EdTech Adventures.",
      top_banner_blurb_roblox: "NOWOŚĆ! CodeCombat wchodzi na Roblox!",
      top_banner_blurb_roblox_teachers: "NOWOŚĆ! CodeCombat nawiązał współpracę z Roblox Education!",
      top_banner_blurb_roblox_players: "NOWOŚĆ! Naucz się kodować grając w Roblox!",
      top_banner_blurb_roblox_players_cta: "Dołącz do listy oczekujących na beta testy",
      top_banner_blurb_live_online_classes_parents: "RODZICE! Zacznij uczyć swoje dziecko kodowania już dziś dzięki darmowej lekcji próbnej.",
      top_banner_blurb_live_online_classes: "Żywe lekcje online z kodowania napędzane grą!",
      top_banner_blurb_live_online_classes_cta: "Zapisz się na darmową lekcję próbną!",
      top_banner_blurb_demo_day: "Dołącz do nas na webinarium demonstracyjnym w czwartek, 25 sierpnia o godzinie 16:00 EDT.",
      top_banner_blurb_demo_day_10_20: "Dołącz do nas na duchowy pokaz CodeCombat & Ozaria w czwartek, 20 października o godzinie 16:00 CDT.",
      top_banner_blurb_hoc_2022_12_01: "Dołącz do nas 1 grudnia na nasze Godziny Kodu! Wszystko, czego potrzebujesz do wdrożenia naszych całkowicie nowych aktywności __topBannerHereLink__",
      top_banner_blurb_hoc_2022_12_01_here: "TUTAJ",
      top_banner_blurb_demo_day_2023_02_16: "NA ŻYWO! Zobacz, jak możesz użyć esportu do nauki kodowania. Dołącz do nas w czwartek, 16 lutego o godzinie 14:00 PST.",
      ...
      im_a_parent_description: "Odkryj nasze lekcje online z kodowania",
      ...
      educator: 'Nauczyciel',
      student: 'Uczeń',
      go_to_my_dashboard: "Idź do menu głównego",
      ...
      codecombat_home_blurb: "codecombatHome oferuje Twojemu dziecku zabawną i angażującą metodę rozwijania umiejętności programowania. Dzięki dostępowi do ponad 530 poziomów oraz ekskluzywnym funkcjom, takim jak zwierzęta domowe, przedmioty dostępne tylko dla użytkowników premium oraz bohaterowie, Twoje dziecko może całkowicie zanurzyć się w świecie programowania. Mogą nawet projektować gry, aby wyzwać swoich przyjaciół, tworzyć strony internetowe i aplikacje do udostępniania oraz tworzyć prywatne zespoły do rywalizacji na grupowej liście liderów, wszystko to w bezpiecznym i interaktywnym środowisku, które wspiera naukę i socjalizację.",
      codecombat_home: "Strona główna CodeComba",
      for_educators: 'Dla nauczycieli',
      for_parents: 'Dla rodziców',
      for_everyone: 'Dla wszystkich',
      for_students: "Dla uczniów",
      for_individuals: "Dla jednostek",
      for_libraries: "Dla bibliotek",
      for_partners: "Dla partnerów",
      for_partners_title: "Współpracuj z CodeCombat",
      for_partners_blurb: "Dołącz do naszej misji, aby uczynić programowanie dostępnym i interesującym dla wszystkich, stając się cennym partnerem CodeCombat. Struktury naszych partnerstw obejmują firmy edukacyjne, sponsory esportu, międzynarodowych dystrybutorów i partnerów działających na rzecz społecznego wpływu. Partnerzy mają dostęp do naszych łatwych w użyciu programów, zasobów do wdrażania oraz opcji szkoleniowych, zapewniających udane i przyjemne doświadczenia.",
      for_partners_button: "Odkryj partnerstwa",
      for_libraries_title: "Integracja z bibliotekami",
      for_libraries_blurb: "Jako całkowicie samodzielne i samodzielnie kierowane cyfrowe źródło, CodeCombat jest idealną integracją dla bibliotek, które chcą umożliwić swoim członkom w każdym wieku naukę programowania. Nasza platforma oferuje wszystko, czego uczący się potrzebują do doświadczenia edukacji kodowania na wysokim poziomie za pomocą unikalnie ekscytującego, opartego na grach programu nauczania. Idealne dla uczących się od trzeciej klasy aż po dorosłych, którzy chcą opanować koncepcje kodowania na poziomie college'u.",
      for_libraries_button: "Odkryj biblioteki",
      ...
      billion: '__num__ Miliard',
      meta_keywords_podcast: "CodeCombat, python, javascript, Coding Games, podcast, edtech",
      coco_worlds_header: "CodeCombat Worlds",
      coco_worlds_description: "Rozpocznij przygodę z kodowaniem w 3D w Roblox, gdzie możesz programować zwierzęta, grać z przyjaciółmi i tworzyć gry, jednocześnie ucząc się. Dołącz do społeczności CodeCombat i uwolnij swoją kreatywność w metawersum!",
      coco_worlds_button: "Odkryj światy CodeCombat"
    },

    nav: {
      aiyouth: "Młodzież z AI",
      ...
      related_urls: "Przeładuj odnośniki",
      ...
      parent: 'Rodzice',
      faq: "FAQ",
      return_coco: "Powrót do CodeCombat",
      classes: "Klasy",
      term_of_service: "Warunki korzystania",
      esports: 'E-sporty',
      ...
      ozaria_dashboard: 'Ozaria Dashboard',
         ozaria_teacher_dashboard: "Panel Nauczyciela Ozaria",
    ozaria_admin_dashboard: "Panel Administratora Ozaria",
    codecombat_dashboard: 'Panel CodeCombat',
    codecombat_teacher_dashboard: "Panel Nauczyciela CodeCombat",
    codecombat_admin_dashboard: "Panel Administratora CodeCombat",
    professional_development: 'Doskonalenie zawodowe',
    new: 'Nowe!',
    admin: 'Administrator',
    api_dashboard: 'Panel API',
    funding_resources_guide: 'Przewodnik po źródłach finansowania',
    partnerships: "Partnerstwa",
    podcast: "Nasz podcast",
    dashboard: "Panel",
    products: "Produkty",
    live_online_classes: "Żywe lekcje online",
    codecombat_home: "CodeCombat Home",
    libraries: "Biblioteki",
    codecombat_worlds_on_roblox: "Światy CodeCombat w Roblox",
    pricing: "Cennik",
    help_center: "Centrum pomocy",
    research_efficacy: "Badania - Skuteczność",
    research_impact: "Badania - Wpływ",
    terms: "Warunki",
    podcast_simple: "Podcast",
    create_free_account: "Utwórz darmowe konto",
    school_district_solutions: "Rozwiązania dla szkół i dystryktów",
    teacher_toolkit_preview: "Podgląd zestawu narzędzi dla nauczycieli",
    teacher_toolkit: "Zestaw narzędzi dla nauczycieli",
    efficacy_studies: "Studia skuteczności",
    success_stories: "Historie sukcesu",
    hoc: "Godzina kodu",
    grants_funding_resources: "Granty i źródła finansowania",
    request_quote_demo: "Zapytaj o prezentację lub wycenę",
    coco_junior_beta: "CodeCombat Junior (Beta)",
    ap_csp: "AP CSP",
    ai_league_esports: "Liga AI Esports",
    ai_hackstack_beta: "AI HackStack (Beta)",
    ai_junior_beta: "AI Junior (Beta)",
    premium_self_paced: "Płatny samodzielny",
    codequest: "CodeQuest",
    library_solutions: "Rozwiązania dla bibliotek",
    partner_solutions: "Rozwiązania partnerskie",
    teaching_solutions: "Rozwiązania nauczania",
    play2: "Graj",
    my_dashborads: "Moje panele",
    resources: "Zasoby",
    curriculum: "Program nauczania",
    company: "Firma",
    coco_home_description: "Z dostępem do wszystkich 530 poziomów oraz ekskluzywnych funkcji, takich jak zwierzęta domowe, przedmioty dostępne tylko dla subskrybentów i bohaterowie, każdy może całkowicie zanurzyć się w świecie kodowania.",
    coco_classroom_description: "Pełny program nauczania informatyki, który buduje od podstawowych koncepcji poprzez rozwój stron internetowych, tworzenie gier i AP CSP.",
    coco_junior_description: "Nasz flagowy program nauczania K-5 zawiera progresję poziomów nauczania, które uczą podstawowych koncepcji kodowania w wolniejszym tempie, specjalnie zaprojektowane dla uczniów szkół podstawowych.",
    oz_classroom_description: "Zaklęta narracyjna przygoda kodowania, która ustanawia podstawy informatyki.",
    ap_csp_description: "Zatwierdzony przez College Board, nasz program AP CSP oferuje narzędzia oparte na grach i gotowe do użycia, przygotowujące uczniów do egzaminu AP.",
    ai_league_description: "Epicka platforma esportowa do rywalizacyjnego programowania, która promuje kreatywną praktykę programowania w środowisku opartym na grach.",
    roblox_description: "Ta MMORPG uczy kodowania Lua i zapewnia platformę do tworzenia niesamowitych gier i doświadczeń w rzeczywistym świecie.",
    ai_hackstack_description: "Pierwsze generatywne narzędzie AI, specjalnie zaprojektowane dla początkujących w dziedzinie AI, z naciskiem na prywatność i bezpieczeństwo uczniów.",
    ai_junior_description: "Wprowadza wielomodalne generatywne AI w prostą i intuicyjną platformę zaprojektowaną specjalnie dla uczniów K-5.",
    learning_options: "Opcje nauki",
    ...
    new_home_faq: {
      ...
      see_faq_prefix: "Zobacz więcej",
      see_faq_link: "Często zadawane pytania w naszym centrum pomocy",
      see_faq_suffix: ".",
      ai_bot_faq_title: "Co to jest AI Level Help Bot i jakie są środki zapewnienia bezpieczeństwa?",
      ai_bot_faq_blurb: "AI Chat Level Help Bot w CodeCombat umożliwia uczącym się korzystanie z wskazówek napędzanych przez sztuczną inteligencję do wyzwań związanych z programowaniem, zapewniając prowadzone, ale niezależne doświadczenie nauki. Bezpieczeństwo jest priorytetem, ponieważ AI filtrowuje dane osobowe i jest szkolone do obsługi nieodpowiednich żądań."
    },
    ...
    play: {
      ...
      back_to_ozaria: "Powrót do ozaria.com",
      customize_hero: "Dostosuj bohatera",
      account_settings: "Ustawienia konta",
      back_to_tutorial: "Powrót do samouczka",
      teacher_vega_message: "Uczniowie są prowadzeni przez te komunikaty samouczkowe. Aby zobaczyć te komunikaty i zapisać postępy podczas gry, utwórz konto ucznia i graj w Ozarię jako uczeń.",
      beta_levels_on: "poziomy beta włączone",
      beta_levels_turn_off: "wyłącz",
      confirm_m7_off: "Czy na pewno chcesz wyłączyć poziomy beta?",
      play_codecombat: "Graj w CodeCombat",
      play_codecombat_junior: "Graj w CodeCombat Junior",
      want_more_hints: "Chcesz więcej wskazówek?"
    },
    ...
    login: {
      auth_sign_up: "Nowy użytkownik Ozarii? Stwórz konto",
      ...
      already_have_account1: "Posiadasz już konto nauczyciela lub ucznia w CodeCombat?",
      already_have_account2: "Możesz się zalogować na Ozaria.com używając tego konta.",
      sign_into_ozaria: "Zaloguj się na Ozaria.com",
      individual_users_not_supported: "Ozaria jest przeznaczona wyłącznie dla sal lekcyjnych! Odwiedź CodeCombat, aby kontynuować grę!",
      accounts_merge_confirmation: 'Istnieje już konto z mailem z tego konta Google. Czy chciałbyś je połączyć?',
      stop_spying: "Przestań szpiegować",
      stop_switching: "Przestań przełączać",
      test_as_student: "Testuj jako uczeń",
      gplus_linked: "Konto Google połączone pomyślnie",
      plus_link_error: "Błąd połączenia konta Google",
      email_or_username_or_library: "E-mail lub nazwa użytkownika lub numer karty bibliotecznej"
     },
    ...
    signup: {
      ...
      create_account_to_submit_multiplayer: "Utwórz darmowe konto, aby klasyfikować swojego AI w grze wieloosobowej i eksplorować całą grę!",
      ...
      activation_code_used: "Kod aktywacyjny został już użyty. Sprawdź pisownię lub poproś nauczyciela o pomoc.",
      ...
      confirm_individual_blurb_without_email: "Zapisz swoje dane logowania na wypadek potrzeby.",
      ...
      request_class_code: "Uczniowie, poproście nauczyciela o Kod Klasy, aby utworzyć konto!",
      educators_create_account: "Edukatorzy, załóżcie konto Nauczyciela, aby uzyskać dostęp do pierwszej jednostki za darmo!",
      looking_for_classroom: "Szukanie klasy...",
      create_your_educator_account: "Utwórz swoje konto edukatora",
      educator_signup_list_1_title: "Zobacz, co widzą Twoi uczniowie:",
      educator_signup_list_1_desc: "Przetestuj każdy poziom gry w pierwszej jednostce",
      educator_signup_list_2_title: "Zobacz zasoby dla nauczycieli:",
      educator_signup_list_2_desc: "Dostęp do zakresu i sekwencji, lekcji i więcej",
      educator_signup_list_3_title: "Zobacz, jak rosną Twoi uczniowie:",
      educator_signup_list_3_desc: "Wypróbuj pierwszą jednostkę z klasą za darmo",
      signup_with_email: "Zarejestruj się przez e-mail",
      already_have_account: "Masz już konto w CodeCombat lub Ozaria",
      select_your_role: "Wybierz swoją rolę",
      select_your_state: "Wybierz swój plan",
      ...
      play_without_saving: "Graj bez zapisywania",
    },
    ...
    common: {
      default_title_coco: "CodeCombat - Gry programistyczne do nauki Pythona i JavaScript",
      default_title_ozar: "Ozaria - Informatyka, która wciąga",
      ozaria: "Ozaria",
      default_meta_description_coco: "Nauka kodu poprzez gry programistyczne. Naucz się Pythona, JavaScript i HTML rozwiązując łamigłówki oraz ucząc się tworzyć własne gry i strony internetowe.",
      default_meta_description_ozar: "Ozaria to program z zakresu informatyki, gra przygodowa i fantastyczna opowieść, w której uczniowie opanowują zagubioną magię kodowania, aby ocalić swój świat.",
      back: 'Wstecz',
      ...
      table_of_contents: "Tabela zawartości",
      intro: 'Wprowadzenie',
      saving: 'Zapisywanie...',
      sending: 'Wysyłanie...',
      send: 'Wyślij',
    ...
    general: {
      ...
      withdrawn: 'Wycofano',
      accept: 'Akceptuj',
      accept_and_save: "Akceptuj i Zapisz",
      reject: 'Odrzuć',
      withdraw: 'Wycofaj',
    ...
    play_level: {
      ...
      level_complete_at: "Poziom ukończony o ",
      completed_level: 'Ukończony poziom:',
      course: 'Kurs:',
      done: 'Zrobione',
      next_level: 'Następny poziom',
      combo_challenge: "Wyzwanie kombinacyjne",
      concept_challenge: "Wyzwanie koncepcyjne",
      challenge: "Wyzwanie",
      challenge_unlocked: 'Odblokowano wyzwanie',
      combo_challenge_unlocked: "Odblokowane wyzwanie kombinacyjne",
      concept_challenge_unlocked: "Odblokowane wyzwanie koncepcyjne",
      concept_challenge_complete: "Wyzwanie koncepcyjne ukończone!",
      combo_challenge_complete: "Wyzwanie kombinacyjne ukończone!",
      combo_challenge_complete_body: "Świetna robota, wygląda na to, że świetnie radzisz sobie z zrozumieniem __concept__!",
      replay_level: 'Powtórz poziom',
      combo_concepts_used: "__complete__/__total__ użytych koncepcji",
      combo_all_concepts_used: "Użyłeś wszystkich możliwych koncepcji, aby rozwiązać wyzwanie. Świetna robota!",
      combo_not_all_concepts_used: "Użyłeś __complete__ z __total__ możliwych koncepcji, aby rozwiązać wyzwanie. Spróbuj następnym razem użyć wszystkich __total__ koncepcji!",
      ...
      goals: 'Cele',
      goal: 'Cel',
      challenge_level_goals: "Cele poziomu wyzwań",
      challenge_level_goal: "Cel poziomu wyzwań",
      concept_challenge_goals: "Cele wyzwań koncepcyjnych",
      combo_challenge_goals: "Cele poziomu wyzwań",
      concept_challenge_goal: "Cel wyzwań koncepcyjnych",
      combo_challenge_goal: "Cel poziomu wyzwań",
      running: 'Symulacja...',
      success: 'Sukces!',
      ...
      chat_placeholder: "Potrzebujesz pomocy z kodowaniem? Porozmawiaj z AI. (eksperymentalne!)",
      chat_fix_show: "Pokaż mi",
      chat_fix_hide: "Ukryj",
      ...
      problem_alert_need_help: "Potrzebujesz pomocy?",
      problem_alert_ask_the_ai: "Zapytaj AI",
      problem_alert_need_hint: "Potrzebujesz wskazówki? Możesz poprosić AI o pomoc.",
      time_current: 'Teraz:',
      ...
      non_user_code_problem_description: "Początkowy kod do budowania świata nigdy nie zakończył działania z powodu błędu: <pre>__error__</pre> Możesz spróbować ponownie uruchomić ten kod lub zresetować go do stanu domyślnego. Jeśli to nie rozwiąże problemu, daj nam znać.",
      ...
      already_published_prefix: "Twoje zmiany zostały opublikowane w galerii klasy.",
      already_published_suffix: "Kontynuuj eksperymentowanie i ulepszanie tego projektu lub zobacz, co zbudowała reszta Twojej klasy! Twoje zmiany zostaną automatycznie zapisane i udostępnione Twoim kolegom z klasy.",
      view_gallery: 'Zobacz galerię',
      project_published_noty: "Twój poziom został opublikowany!",
      keep_editing: "Kontynuuj edytowanie",
      learn_new_concepts: "Ucz się nowych koncepcji",
      watch_a_video: "Obejrzyj film o __concept_name__",
      concept_unlocked: "Odblokowano koncepcję",
      use_at_least_one_concept: "Użyj przynajmniej jednej koncepcji: ",
      command_bank: "Bank komend",
      learning_goals: "Cele edukacyjne",
      start: "Start",
      vega_character: "Postać Vega",
      capella_character: "Postać Capella",
      octans_character: "Postać Octans",
      click_to_continue: "Kliknij, aby kontynuować",
      fill_in_solution: "Wypełnij rozwiązanie",
      toggle_solution: "Przełącz rozwiązanie",
      play_as_humans: "Graj jako Czerwoni",
      play_as_ogres: "Graj jako Niebiescy",
      changed: "Ostatnio edytowane ",
      team_humans: "Czerwoni",
      team_ogres: "Niebiescy",
      watch_game: "Obserwuj",
      share_your_project: "Udostępnij swój projekt",
      keep_editing_your_project: "Zawsze możesz kontynuować edycję swojego projektu, nawet po jego udostępnieniu.",
      copy_url: "Skopiuj URL",
      level_status: "Status",
      level_status_locked: "Zablokowany",
      level_status_in_progress: "W trakcie",
      level_status_skipped: "Pominięty",
      level_status_complete: "Ukończony",
      level_status_unlocked: "Odblokowany",
      level_status_optional: "Opcjonalny",
      level_type_practice: "Ćwiczenie",
      level_type_challenge: "Wyzwanie",
      level_type_level: "Poziom",
      level_type_cutscene: "Scenka przerywnikowa",
      level_type_capstone: "Kamień milowy",
      level_type_intro: "Wprowadzenie",
      level_type_practice_level: "Poziom ćwiczeń",
      level_type_challenge_level: "Poziom wyzwania",
      level_type_cutscene_level: "Poziom scenki przerywnikowej",
      level_type_capstone_level: "Poziom kamienia milowego",
      level_type_capstone_project: "Projekt kamienia milowego",
      level_type_intro_level: "Poziom wprowadzenia",
      content_type_avatar: "Wybór awatara",
      content_type_cinematic: "Kinematografia",
      content_type_interactive: "Sprawdzenie koncepcji",
      content_type_arena: "Arena",
      feedback: "Opinie",
      ask_teacher_for_help: "Zapytaj nauczyciela o pomoc",
      ask_teacher_for_help_offline: "Twój nauczyciel jest obecnie niedostępny",
      not_enough_credits_bot: "Ups! Wygląda na to, że masz za mało zapytań. Subskrybuj teraz i uzyskaj potrzebne zapytania do wspierającego AI wsparcia, którego potrzebujesz!",
      not_enough_credits_interval: "Brak kredytów na __interval__. Zużyto __amount__ kredytów.",
      not_enough_credits_interval_multiple: "Brak kredytów na __duration__ __interval__. Zużyto __amount__ kredytów.",
      create_account_to_get_credits: "Utwórz konto, aby otrzymać darmowe kredyty na korzystanie z AI powered support!",
      ask_teacher_for_credits: "Poproś nauczyciela o licencję AI Hackstack.",
      get_credits: "Uzyskaj kredyty",
      get_ai_hs_license: "Uzyskaj licencję AI Hackstack",
    },
    ...
    amazon_hoc: {
      title: "Kontynuuj naukę z Amazonem!",
      congrats: "Gratulacje za pokonanie tego wymagającego Godziny Kodowania!",
      educate_1: "Teraz możesz kontynuować naukę kodowania i komputingu w chmurze dzięki programowi AWS Educate, ekscytującemu i darmowemu programowi od Amazona dla uczniów i nauczycieli. Z AWS Educate możesz zdobywać odznaki, ucząc się podstaw chmury oraz nowoczesnych technologii takich jak gry, rzeczywistość wirtualna i Alexa.",
      educate_2: "Dowiedz się więcej i zarejestruj się tutaj",
      future_eng_1: "Możesz także spróbować stworzyć własną umiejętność na Alexa dotyczącą faktów szkolnych",
      future_eng_2: "tutaj",
      future_eng_3: "(nie wymagane urządzenie). Ta aktywność z Alexą jest oferowana przez program",
      future_eng_4: "Amazon Future Engineer",
      future_eng_5: ", który tworzy możliwości nauki i pracy dla uczniów K-12 w Stanach Zjednoczonych, którzy chcą studiować informatykę.",
    },
    live_class: {
      title: "Dziękujemy!",
      content: "Niesamowite! Właśnie uruchomiliśmy zajęcia na żywo online.",
      link: "Gotowy, aby posunąć się naprzód w swoim programowaniu?",
    },

    code_quest: {
      great: "Świetnie!",
      join_paragraph: "Dołącz do największego międzynarodowego turnieju kodowania AI w Pythonie dla wszystkich grup wiekowych i rywalizuj o pierwsze miejsce na liście liderów! Ten miesięczny globalny pojedynek rozpoczyna się 1 sierpnia i obejmuje nagrody o wartości 5000 USD oraz wirtualną ceremonię wręczenia nagród, podczas której ogłosimy zwycięzców i uhonorujemy Twoje umiejętności programowania.",
      link: "Kliknij tutaj, aby się zarejestrować i dowiedzieć się więcej",
      global_tournament: "Międzynarodowy Turniej",
      register: "Zarejestruj się",
      date: "1 sierpnia - 31 sierpnia",
    },
    ...
    game_menu: {
      ...
      change_langugae_caption: "Wybierz język",
      change_language_tab: "Język",
      options_caption: 'Ustaw opcje',
      my_code_caption: "Szybkie opcje kodu",
    ...
    subscribe_for_gems: {
      ...
      prompt_body: "Zapisz się na Premium, aby zdobyć klejnoty i uzyskać dostęp do jeszcze więcej poziomów!",
    },
    ...
    subscribe: {
      ...
      confirmation: "Gratulacje! Subskrybujesz teraz Premium CodeCombat!",
      premium_already_subscribed: "Jesteś już subskrybentem Premium!",
      ...
      stripe_yearly_description: "Subskrypcja roczna",
      buy_now: 'Kup teraz!',
      ...
      feature_level_access: "Dostęp do ponad 500 poziomów",
      feature_heroes: 'Ekskluzywni bohaterowie',
      feature_learn: 'Naucz się tworzyć gry i strony internetowe!',
      feature_languages: "Otrzymaj wszystkie wspierane języki",
      feature_aiyouth: "",
      feature_gems: "Zdobyj __gems__ gemów/mo (__gems12__ gems/yr)",
      month_price: '$__price__/miesiąc',
      month_price_without_currency: "__price__/mo",
      first_month_price: "Tylko $__price__ za pierwszy miesiąc",
      lifetime: 'Dożywotnia subskrypcja',
      lifetime_price: '$__price__',
      year_subscription: 'Roczna subskrypcja',
      year_price: '$__price__/rok',
      year_price_without_currency: "__price__/rok",
      support_part1: 'Potrzebujesz pomocy? Jeśli masz jakieś pytania, to napisz do nas na',
      support_part2: 'support@codecombat.com',
      go_prepaid: "Kliknij tutaj po zeskanowaniu kodu i zakupieniu",
      forever: "Na zawsze",
      subscription_status: "Status Twojej Subskrypcji",
      currently_not_free: "Nie masz jeszcze subskrypcji.",
      online_classes: "Kursy Online",
      feature_ai_level_bot: "Przyspiesz naukę dzięki wsparciu AI",
      sure_buy_as_parent: "Czy na pewno chcesz mieć dostęp premium dla siebie zamiast dla swojego dziecka?"   
    },
    ...
    announcement: {
      ...
      ritic_description: "Ritic the Cold. Uwięziony w Lodowcu Kelvintaph przez niezliczone wieki, wreszcie wolny i gotowy, by zająć się ogrami, którzy go uwięzili.",
      ice_block: "Blok lodu",
      ice_description: "Wygląda na to, że wewnątrz jest coś uwięzione...",
      blink_name: "Migawka",
      blink_description: "Ritic znika i pojawia się w mgnieniu oka, zostawiając tylko cień.",
      shadowStep_name: "Skok w Cień",
      shadowStep_description: "Mistrzowski zabójca wie, jak poruszać się między cieniami.",
      tornado_name: "Tornado",
      tornado_description: "Dobrze mieć przycisk resetowania, gdy ktoś odkryje twoją tożsamość.",
      wallOfDarkness_name: "Ściana Ciemności",
      wallOfDarkness_description: "Schowaj się za ścianą cieni, aby uniknąć wzroku ciekawskich oczu.",
      notifications: "Powiadomienia",
      x_announcement: "__x__ Powiadomienie",
      x_announcements: "__x__ Powiadomienia",
      x_announcement_with_unread: "__x__ Powiadomienie (__y__ nieprzeczytane)",
      x_announcements_with_unread: "__x__ Powiadomienia (__y__ nieprzeczytane)",
      see_more: "Zobacz __unread__ więcej nieprzeczytanych powiadomień",
      mark_read: "Oznacz jako przeczytane",
      read_all: "Przeczytaj wszystkie",
      more_announcements: "więcej powiadomień...",
      
    },

    avatar_selection: {
      pick_an_avatar: "Wybierz awatara, który będzie cię reprezentować jako gracza",
      select_avatar_title: "Wybierz Awatara Gracza",
    },

    premium_features: {
      get_premium: 'Kup<br>CodeCombat<br>Premium',
      master_coder: 'Zapisz się już dziś i zostań mistrzem kodu!',
      paypal_redirect: "Zostaniesz przekierowany do PayPal, aby ukończyć proces subskrypcji.",
      ...
      hero_blurb_2: "Premium Warriors odblokowują imponujące umiejętności bojowe, takie jak Wojenny Krzyk, Stąpnięcie i Rzut Wrogiem. Lub zagraj jako Strażnik, używając kamuflażu i łuków, rzucając nożami, stawiając pułapki! Spróbuj swoich sił jako prawdziwy Czarodziej kodowania i uwolnij potężny arsenał pierwotnej, nekromantycznej lub elementarnej magii!",
      ...
      ai_bot_learning: "Wsparcie oparte na sztucznej inteligencji dla przyspieszenia wyników nauki!",
      ai_bot_description: "Funkcja wskazówek opartych na sztucznej inteligencji CodeCombat może ocenić kod, wskazać błędy i wyjaśnić, jak je naprawić. Co najważniejsze, zapewnia wszelkie potrzebne konteksty do zrozumienia, dlaczego coś jest źle, nie podając jednak całkowitego rozwiązania. Dzięki dostępnemu jedynie do problemów związanych z kodem wsparciu młodzi uczniowie muszą nadal pracować nad każdym wyzwaniem kodowania na poziomie. Subskrybenci Premium otrzymują dziennie <b>10 podpowiedzi AI</b>, aby zawsze mieć potrzebne wsparcie.",
      list_ai_bot: "Subskrybenci Premium otrzymują dziennie 10 podpowiedzi AI",
      ai_bot_notice: "* Stawki podpowiedzi AI mogą ulec zmianie.",      
    },
    ...
    choose_hero: {
      ...
      cpp_blurb: "(Tylko dla subskrybentów) Tworzenie gier i obliczenia wysokiej wydajności.",
      code_format: "Format kodu",
      text_code: "Kod tekstowy",
      blocks_and_code: "Bloki i kod",
      blocks_text: "Bloki i tekst",
      blocks_icons: "Bloki (ikony)",
      text_code_blurb: "Pisz kod tekstowy w prawdziwym edytorze kodu",
      blocks_and_code_blurb: "Bloki i kod obok siebie",
      blocks_text_blurb: "Przeciągnij i upuść bloki dla tabletów lub młodszych uczniów",
      blocks_icons_blurb: "Ikony bloków dla telefonów lub przedczytających",      
      status: 'Status',
      weapons: 'Bronie',
    ...
    char_customization_modal: {
      heading: "Dostosuj swojego bohatera",
      body: "Ciało",
      name_label: "Imię bohatera",
      hair_label: "Kolor włosów",
      skin_label: "Kolor skóry",
    },    
    ...
    skill_docs: {
      ...
      still_undocumented: "Jeszcze nieudokumentowane, przepraszamy.",
      description_coming_soon: "Opis wkrótce będzie dostępny",      
    },
    ...
    options: {
      ...
      editor_config_wide_editor_label: "Włącz szeroki edytor",
      editor_config_wide_editor_description: "Zwiększ szerokość edytora jak w starym stylu",
      editor_config_screen_reader_mode_label: "Włącz tryb czytnika ekranowego",
      editor_config_screen_reader_mode_label_disable: "Wyłącz tryb czytnika ekranowego",
      editor_config_screen_reader_mode_description: "Wyświetl poziomy w formie tekstowej zamiast wizualnej.",
      editor_config_livecompletion_disabled_by_teacher: "Twoja nauczycielka wyłączyła automatyczne uzupełnianie kodu.",
    },

    about: {
      title: "O CodeCombat - Zachęcanie uczniów, wspieranie nauczycieli, inspiracja do tworzenia",
      meta_description: "Nasza misja to podnoszenie poziomu nauki informatyki poprzez naukę opartą na grach oraz uczynienie programowania dostępnym dla każdego ucznia. Wierzymy, że programowanie to magia i chcemy, aby uczący się mieli możliwość tworzenia rzeczy z czystej wyobraźni.",
      learn_more: "Dowiedz się więcej",      
      ...
      csr_title: "Przedstawiciel ds. sukcesu klienta",
      csm_title: "Kierownik sukcesu klienta",
      scsm_title: "Starszy kierownik sukcesu klienta",
      ae_title: "Kierownik ds. konta",
      sae_title: "Starszy kierownik ds. konta",
      sgd_title: "Starszy programista gier",
      gd_title: "Programista gier",
      dois_title: "Dyrektor ds. sprzedaży wewnętrznej",
      ism_title: "Kierownik sprzedaży wewnętrznej",
      sism_title: "Starszy kierownik sprzedaży wewnętrznej",
      shan_title: "Sprzedaż wewnętrzna, Europa",
      run_title: "Kierownik operacji, CodeCombat Greater China",
      lance_title: "Kierownik technologii, CodeCombat Greater China",
      zhiran_title: "Kierownik programu nauczania, CodeCombat Greater China",
      yuqiang_title: "Kierownik innowacji, CodeCombat Greater China",
      swe_title: "Inżynier oprogramowania",
      sswe_title: "Starszy inżynier oprogramowania",
      css_title: "Specjalista wsparcia klienta",
      am_cs_title: "Zastępca kierownika ds. sukcesu klienta",
      css_qa_title: "Specjalista ds. wsparcia klienta / QA",
      maya_title: "Starszy programista curriculum",
      bill_title: "Dyrektor generalny, CodeCombat Greater China",
      pvd_title: "Projektant produktu i wizualny",
      spvd_title: "Starszy projektant produktu i wizualny",
      daniela_title: "Kierownik marketingu",
      mm_title: "Kierownik marketingu",
      bobby_title: "Starszy projektant gier",
      brian_title: "Starszy menedżer projektów gier",
      stephanie_title: "Specjalista wsparcia klienta",
      sdr_title: "Przedstawiciel ds. rozwoju sprzedaży",
      bd_pr_title: "Przedstawiciel ds. rozwoju biznesu i partnerstw",
      retrostyle_title: 'Ilustracje',
      retrostyle_blurb: 'RetroStyle Games',
      community_title: "...oraz nasza społeczność 'open-source'",
      lgd_title: "Główny projektant gier",
      oa_title: "Asystent operacyjny",
      ac_title: "Koordynator administracyjny",
      sac_title: "Starszy koordynator administracyjny",
      oss_title: "Specjalista wsparcia operacyjnego",
      ea_title: "Asystent wykonawczy",
      om_title: "Menedżer operacyjny",
      som_title: "Starszy menedżer operacyjny",
      sales_om_title: "Menedżer operacji sprzedażowych",
      pe_title: "Główny inżynier",
      mo_title: "Menedżer operacji",
      smo_title: "Starszy menedżer operacji",
      do_title: "Dyrektor operacyjny",
      vp_o_title: "Wiceprezes ds. operacji",
      scd_title: "Starszy programista curriculum",
      lcd_title: "Główny programista curriculum",
      cd_title: "Programista curriculum",
      sem_title: "Starszy menedżer edukacji",
      de_title: "Dyrektor edukacji",
      vpm_title: "Wiceprezes ds. marketingu",
      vps_title: "Wiceprezes ds. sprzedaży",
      vpsm_title: "Wiceprezes ds. sprzedaży i marketingu",
      oi_title: "Instruktor online",
      m_oi_title: "Menedżer instrukcji online",
      aoim_title: "Zastępca menedżera instruktorów online",
      bdm_title: "Menedżer ds. rozwoju biznesu",      
      ...
      press_subtitle: "lub odwiedź naszą stronę prasową pod adresem",
    ...
    teachers: {
      ...
      google_classroom_disabled_text: "Aby połączyć się z Google Classroom, zaloguj się za pomocą Google SSO",
      select_class: "Wybierz klasę",
      programming_language: "Język programowania",
      programming_language_edit_desc: "Nie można zmienić języka, gdy uczniowie już dołączą do klasy. Zalecamy utworzenie nowej klasy dla tych samych uczniów.",
      programming_language_edit_desc_new: "Zmiana języka programowania spowoduje ukrycie postępów uczniów w poprzednim języku i będą musieli zacząć od nowa w nowym języku. Zalecamy utworzenie nowej klasy dla tych samych uczniów.",
      add_a_class: "Dodaj nową klasę",
      select_desired_lang: "Wybierz pożądany język dla swojej klasy",
      elementary: "Szkoła podstawowa",
      middle: "Gimnazjum",
      high_school: "Liceum",
      class_name: "Nazwa klasy",
      grades: "Klasy",
      select_all_that_apply: "Zaznacz wszystkie odpowiednie",
      class_info_modal_sub_title: "Zaproszenie uczniów do dołączenia do twojej klasy wysyłając im:",
      class_url: "Adres URL klasy",
      class_url_desc: "Udostępnij URL, aby uczniowie mogli dołączyć do twojej klasy po rejestracji",
      class_code: "Kod klasy",
      class_code_desc: "Uczniowie mogą wprowadzić ten kod podczas rejestracji na stronie",
      invite_by_email: "Zaproś przez e-mail",
      regenerate_class_code: "Generuj ponownie",
      invite_modal_sub_title: "Oddziel każdy adres e-mail nową linią lub przecinkami",
      no_new_students_imported: "Nie zaimportowano nowych uczniów",
      error_in_importing_classrooms: "Błąd podczas importowania klas",
      error_in_importing_students: "Błąd podczas importowania uczniów",
      classroom_items_description: "Określa, czy uczniowie powinni zdobywać klejnoty i wyposażenie podczas rozgrywki.",
      classroom_live_completion: "Określa, czy w tej klasie ma być włączone automatyczne uzupełnianie kodu. Wyłączone: wyłącza uzupełnianie dla wszystkich poziomów. Włączone: pozwala uczniom wybrać. Zalecamy pozostawienie tej opcji włączonej.",
      code_formats: "Formaty kodu (beta)",
      code_formats_description: "Określa, które formaty kodu mogą wybierać uczniowie.",
      default_code_format: "Domyślny format kodu",
      default_code_format_description: "Format kodu, którym uczniowie zaczną.",
      not_allow_to_solution: "# Licenses needed to view solutions",
      classroom_level_chat: "Wskazówki AI Level",
      classroom_level_chat_blurb: "Określa, czy uczniowie mogą prosić o wskazówki AI i wyjaśnienia błędów.",
      classroom_level_chat_option_free_form: "Wolny formularz",
      classroom_level_chat_option_fixed_prompt_only: "Tylko stałe pytanie",
      classroom_level_chat_option_none: "Brak czatu",      
    },

    no_licenses_page: {
      are_your_students_ready: "Czy Twoi uczniowie są podekscytowani i gotowi na więcej nauki?",
      once_students_have_completed: "Po ukończeniu Rozdziału 1 uczniowie będą potrzebować licencji, aby kontynuować swoją podróż przez następny rozdział i dalej.",
      get_licenses: "Uzyskaj Licencje",
      get_full_access_to_ozaria: "Uzyskaj Pełny Dostęp do Ozarii",
      unlock_all: "Odblokuj wszystko powyżej plus wsparcie nauczycieli",
      unlock_all_dsa: "Odblokuj wszystko powyżej plus wsparcie potrzebne nauczycielom",
      comprehensive_dashboards: "Kompleksowe pulpity nauczycielskie i administratorskie",
      lesson_plans_rubrics_guides: "Plan lekcji, rubryki projektowe, przewodniki rozwiązania i więcej",
      dedicated_customer_success_manager: "Dedykowany menedżer sukcesu klienta",
      automatic_access: "Automatyczny dostęp do nowych treści i funkcji",
      license_quote: "\"Moim zdaniem, jako weteran szkolnictwa średniego z 26-letnim doświadczeniem, nie ma bardziej angażującego źródła nauczania programowania.\"",
      join_our_community: "Dołącz do naszej społeczności",
      join_our_community_desc: "Ponad 12 milionów osób nauczyło się programować w Pythonie i JavaScript używając CodeCombat. Teraz zapraszamy Cię do dołączenia do naszej społeczności ponad 82 000 nauczycieli i 25 000 szkół z Ozarią, przeznaczoną dla edukatorów, którzy chcą zainspirować nową generację uczniów do nauki informatyki.",
      teach_real_typed_code: "Naucz prawdziwego, pisemnego kodu",
      teach_real_typed_code_desc: "Uczniowie uczą się Pythona i JavaScript, dwóch najbardziej popularnych języków programowania, i rozwijają umiejętności XXI wieku, które przygotują ich do każdej kariery.",
      support_student_progress: "Wsparcie dla postępu uczniów",
      support_student_progress_desc: "Odblokowanie danych z ocen formacyjnych i sumacyjnych z Kontroli Koncepcji, Poziomów i Projektów Kapitałowych w celu wsparcia postępu uczniów.",
      creative_projects: "Projekty kreatywne",
      creative_projects_desc: "Zainspiruj wyobraźnię i uwolnij kreatywność uczniów dzięki projektom kapitałowym, takim jak w Rozdziale 2, gdzie uczniowie projektują własną grę fabularną.",
      looking_for_engaging: "Szukasz angażującego programu nauczania informatyki?",
      licenses_are_required: "Licencje są wymagane, aby uczniowie mogli kontynuować swoją podróż poza Rozdziałem 1.",
      real_world_skills: "Umiejętności rzeczywiste",
      real_world_skills_desc: "Uczniowie uczą się pisemnego Pythona i JavaScriptu, dwóch najbardziej popularnych języków programowania, i wzmacniają swoje umiejętności myślenia krytycznego, kreatywności i odporności, przygotowując się do każdej kariery.",
      personalized_learning: "Personalizowana nauka i zróżnicowana instrukcja",
      personalized_learning_desc: "Uczniowie uczą się koncepcji we własnym tempie. Poziomy zwiększają trudność, zapewniając wbudowane wskazówki, które promują wytrwałość i determinację.",
      flexible_curriculum: "Elastyczny, zgodny z normami programowymi program nauczania",
      flexible_curriculum_desc: "100% program nauczania zgodny z CSTA, który można łatwo dostosować do dowolnego harmonogramu, scenariusza lub środowiska.",
      resources_to_support: "Zasoby wspierające nauczycieli",
      resources_to_support_desc: "Plany lekcji, dodatkowe zajęcia, przewodniki programowe i inne materiały instrukcyjne zaprojektowane z myślą o pracy zdalnej i hybrydowej.",
      actionable_insights: "Praktyczne wnioski dla edukatorów",
      actionable_insights_desc: "Wzbogać edukatorów intuicyjnymi danymi na temat postępów uczniów i ocenami, które umożliwiają różnicowanie nauczania.",
    },
    special_offer: {
      ...
      course_prefix: 'Kurs',
      course_suffix: '',
      licenses_activated_success: "Licencje zostały pomyślnie aktywowane!",
      license_code_used: "Kod licencji został użyty.",
    },
    ...
    teachers_quote: {
      ...
      teacher_account_details: "Szczegóły Konta Nauczyciela",
      ...
      referrer_default: "Wybierz jedną z opcji",
      referrer_conference: "Konferencja (np. ISTE)",
      referrer_hoc: "Code.org/Godzina Kodowania",
      referrer_teacher: "Nauczyciel",
      referrer_admin: "Administrator",
      referrer_student: "Uczeń",
      referrer_pd: "Szkolenia/Zajęcia zawodowe",
      referrer_web: "Google",
      referrer_other: "Inne",
      ...
      not: 'Nie jesteś',
      full_name_required: "Imię i nazwisko wymagane",
    },
    ...
    contact: {
      ...
      faq_prefix: 'Jest też',
      faq: 'FAQ',
      faq_suffix: " w celu uzyskania dodatkowej pomocy.",
      prefer_email_prefix: "Jeśli wolisz, możesz wysłać e-mail do ",
      prefer_email_suffix: " zamiast tego.",
      ...
      ooo_blurb: "Zespół CodeCombat będzie poza biurem od 5 czerwca do 9 czerwca, a w tym czasie będzie mieć ograniczony dostęp do e-maili. Odpowiemy na Twoje zapytanie tak szybko, jak to możliwe. Prosimy o uznanie przewidywanego czasu oczekiwania."
    },
    ...
    account_settings: {
      ...
      temp_password_expired: "Twoje tymczasowe hasło wygasło.",
      ...
      connect_roblox_tab: "Połącz z Roblox",
      connect_roblox_button: "Połącz",
      re_connect_roblox_button: "Połącz inne konto",
      disconnect_roblox_button: "Rozłącz",
      roblox_connected: "Twoje konto <strong>__username__</strong> jest połączone z Roblox.",
      roblox_not_connected: "Połącz swoje konto CodeCombat z Roblox.",
      roblox_disconnect_confirm: "Czy na pewno chcesz rozłączyć swoje konto Roblox?",
      god_mode: 'TRYB BOGA',
      ...
      switch_new_teacher_dashboard: "Wypróbuj nową tablicę nauczycielską",
      view_trial_class_bookings: "Zobacz rezerwacje próbne"
    },
    ...
    cinematic: {
      click_anywhere_continue: "Kliknij aby kontynuować",
      instructional_tooltip: "Kliknij te przyciski strzałek, aby przejść do przodu i do tyłu. Możesz również używać klawiszy strzałek na klawiaturze, aby to samo zrobić."
    },
    ...
    clans: {
      title: "Dołącz do klanów CodeCombat - Ucz się programowania w Pythonie, JavaScript i HTML",
      clan_title: "__clan__ - Dołącz do klanów CodeCombat i ucz się programowania",
      meta_description: "Dołącz do klanu lub stwórz własną społeczność programistów. Graj w wieloosobowe poziomy arenowe i zdobywaj punkty doświadczenia zarówno dla bohatera, jak i umiejętności programowania.",
      clan: 'Klan',
      clans: 'Klany',
