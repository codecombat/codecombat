...
#    district_na: "Enter N/A if not applicable"
    ...
    learn_more_modal: "Учитељски налози на CodeCombat-у имају могућност посматрања напретка ученика, додељивања уписа и управљања учионицама. Учитељски налози не могу бити део учионице - ако си тренутно уписан у разред преко овог налога, нећеш више моћи да му приступиш кад ажурираш у Учитељски Налог." # {change}
...
#    get_access: "to get individual access to all courses for evalutaion purposes."
    ...
    you_have1: "Имаш"
    you_have2: "неискоришћених плаћених уписа" # {change}
    use_one: "Искористи 1 плаћени упис за" # {change}
    use_multiple: "Искористи плаћене уписе за следеће ученике:" # {change}
...
#    educator_wiki_suff: "to browse the guide online."
    ...
    unused_enrollments: "Доступни неискоришћени уписи:" # {change}
