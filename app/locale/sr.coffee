...
#    see_example: "See example"
    slogan: "Најзанимљивија игра за учење програмирања." # {change}
...
#    prompt_body: "Subscribe to Premium to get gems and access to even more levels!"
  ...
  about:
    ...
    community_subtitle: "Преко 600 сарадника је помогло да се изгради CodeCombat и још њих се придружује сваке недеље!" # {change}
    ...
    number_contributors: "Преко 600 сарадника је дало своју подршку и време овом пројекту."
