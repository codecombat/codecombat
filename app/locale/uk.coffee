...
#    daniela_blurb: "Creates stories"
    ...
    community_subtitle: "Більше 600 помічників допомогли створити CodeCombat, і кожного тижня приєднуються нові!"
    ...
    number_contributors: "Більше 600 вкладників надали свою підтримку та час, щоб підтримати цей проект."
