module.exports = nativeDescription: "Українська", englishDescription: "Ukrainian", translation:
  ...
  play_level:
    ...
    tip_adding_orgres: "Оточуємо оґрів."
    ...
    tip_internet_weather: "Просто переходь в інтернет - тут чодово. Ми будемо жити всередині, де завжди відмінна погода. - Джон Ґрін"
    tip_nerds: "Ботанам дозволяють любити речі, кталту стрибаю-від-радості-на-стільчику-і-не-контролюю-себе, люблю це. - Джон Ґрін"
    tip_self_taught: "Я навчав 90% того що навчився. І це нормально! - Ханг Ґрін"
    tip_luna_lovegood: "Не хвилюся, ти так само при здоровому глузді як і я. - Луна Ловерґуд"
    tip_good_idea: "Найкращий спосіб мати гарну ідею - це мати багато ідей. - Лінус Паулінг"
    tip_programming_not_about_computers: "Комп'ютерні науки стільки ж про комп'ютери, як астрономія про телескопи. - Едґстер Дейкстра"
...
#    number_contributors: "Over 450 contributors have lent their support and time to this project."
    ...
    story_subtitle: "З 2013-го року, CodeCombat перетворилас з набору ескізів у живу, процвітаючу гру."
