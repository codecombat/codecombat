module.exports = nativeDescription: "Українська", englishDescription: "Ukrainian", translation:
  ...
  play_level:
    ...
    tip_programming_not_about_computers: "Комп'ютерна наука є наукою про комп'ютери не больше, аніж астрономія — наукою про телескопи. - Едсгер Дейкстра"
  ...
  subscribe:
    ...
    comparison_blurb: "Відточіть свої навички з підпискою <strong>CodeCombat Преміум</strong>!"
    ...
    feature1: "__levelsCount__+ базових рівнів для вивчення Python, JavaScript, Lua чи CoffeeScript"
    feature2: "Розблокуйте <strong>__heroesCount__ могутніх нових героїв</strong>, в тому числі магів і рейнджерів"
    feature3: "<strong>__bonusLevelsCount__+ преміум рівнів</strong>, з новими рівнями щомісяця"
    ...
    feature_game_dev: "Створюйте ігри для своїх друзів, щоб грати у наших <strong>світах гейм-розробки</strong>"
    feature_web_dev: "Створюйте сайти та додатки на HTML, CSS та jQuery у наших <strong>світах веб-розробки</strong>"
    free: "Безкоштовно"
    month: "місяць"
...
#    jobs_benefit_9: "10-year option exercise window"
    ...
    jobs_custom_description: "Захоплюєтесь CodeCombat, але не бачите вакансії, що підходить для вашої кваліфікації? Напишіть нам і покажіть як, на вашу думку, ви можете допомогти нашій команді. Ми раді з вами зв'язатися!"
  ...
  special_offer:
    ...
    three_great_courses: "Три чудових курси включено в початковій ліцензію:"
    license_limit_description: "Вчителі можуть купити до __maxQuantityStarterLicenses__ початкових ліцензій. Ви вже купили __quantityAlreadyPurchased__. Якщо вам потрібно більше, напишіть на __supportEmail__. Початкові ліцензії активні напротязі __starterLicenseLengthMonths__ місяців."
    ...
    wd1_description: "представляє основи HTML і CSS у процесі навчання навичкам, необхідним для учнів, щоб створювати перші веб-сторінки."
    gd1_description: "використовує вже знайомий учням синтакс, щоб показати їм, як створювати та ділитися їх власними рівнями гри."
  ...
  teachers_quote:
    ...
    approve_funds: "Затверджую фонди"
  ...
  courses:
    ...
    enter_here: "<уведіть код розблокування тут>"
  ...
  teacher:
    ...
    teacher_account_explanation: "Акаунт вчителя CodeCombat дозволяє налаштовувати класи, спостерігати за прогресом учнів, керувати ліцензіями та отримати доступ до ресурсів, що допоможуть у створенні вашого навчального плану."
    ...
    class_code_blurb: "Учні можуть долучитись до вашого класу за допомогою цього Коду Класу. При створенні учнівського акаунту з Кодом Класу вводити email не обов'язково."
    ...
    not_assigned_modal_starter_body_1: "Цей курс вимагає початкової ліцензію. У вас недостатньо початкових ліцензій, щоб призначити цей курс до всіх __selected__ обраних учнів."
    not_assigned_modal_starter_body_2: "Придбайте початкові ліцензії, щоб надати доступ до цього курсу."
    not_assigned_modal_full_body_1: "Цей курс вимагає повної ліцензії. У вас недостатньо повних ліцензій для призначення цього курсу до всіх __selected__ обраних учнів."
    ...
    wd2_quizlet_worksheet: "планування опитувальника Worksheet"
    ...
    hoc_self_led_desc: "Учні можуть самостійно зіграти два туторіали Година Коду CodeCombat"
...
#    tournament_blurb_ace_of_coders: "Battle it out in the frozen glacier in this domination-style mirror match! The tournament began on Wednesday, September 16 and will run until Wednesday, October 14 at 5PM PDT. Check out the details"
  ...
  account_prepaid:
    ...
    purchase_code1: "Коди підписки можна використати, щоб додати час преміум підписки одному чи більше акаунтам для домашньої версії CodeCombat."
    purchase_code2: "Кожен акаунт CodeCombat може використати певний Код підписки лише раз."
    purchase_code3: "Місяці кодів підписки буде додано до кінця будь-якої існуючої в акаунту підписки."
    purchase_code4: "Коди підписки є для акаунтів, які грають у домашню версію CodeCombat, їх не можна використи замість учнівських ліцензій для класної версії."
