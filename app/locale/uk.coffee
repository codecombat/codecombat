...
#    string: "string"
  ...
  about:
    ...
    mission_description_2: "Виявляється що це дозволяє їм також і навчатися скоріше. ЗНАЧНО скоріше. Це як спілкуватися замість читати підручники. Ми хочемо донести цю розмову до кожної школи і до <strong>кодного учня</strong>, тому що коден повинен мати шанс навчитися магії програмування."
...
#    character_art: "Character Art"
    download_all: "Завантажити все All"
    previous: "Попереднє"
...
#    tournament_blurb_ace_of_coders: "Battle it out in the frozen glacier in this domination-style mirror match! The tournament began on Wednesday, September 16 and will run until Wednesday, October 14 at 5PM PDT. Check out the details"
  ...
  account:
    ...
    email_sent: "Email надіслато! Перевірте вашу поштову скриньку."
...
#    purchase_code5: "For more information on Student Licenses, reach out to"
    ...
    redeem_codes: "Викупити код підписки a Subscription Code"
