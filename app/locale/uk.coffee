...
#    required: "required"
    ...
    view_levels: "переглянути всі рівні курсу" # {change}
...
#    unsubscribe_success: "Success"
  ...
  account_prepaid:
    ...
    purchase_code4: "Коди підписки існують для акаунтів, які грають у домашню версію CodeCombat, їх не можна використи замість учнівських ліцензій для класної версії."
