...
#    tip_mulan: "Believe you can, then you will. - Mulan"
  ...
  play_game_dev_level:
    ...
    how_to_play_title: "Як грати:"
    how_to_play_1: "Використовуйте мишку щоб керувати героєм!"
    how_to_play_2: "Клікніть де-небудь на карті щоб рухатись до того місця."
    how_to_play_3: "Клікніть на огрів щоб атакувати їх."
    ...
    back_to_coding: "Повернутись до коду"
  ...
  subscribe:
    ...
    feature1: "__levelsCount__+ основних рівнів на просторах __worldsCount__ світів"
    feature2: "__heroesCount__ могутніх <strong>нових героїв</strong> з унікальними здібностями!"
    feature3: "__bonusLevelsCount__+ бонусних рівнів"
...
#    character_art: "Character Art"
  ...
  teachers:
    ...
    who_for_1: "Ми рекомендуємо CodeCombat для учнів старше 9 років. Попередній досвід програмування не потрібен. Дизайн CodeCombat розроблено щоб зацікавити як хлопчиків, так і дівчаток."
    who_for_2: "Наша система курсів дозволяє вчителям налаштовувати класи, слідкувати за прогресом та давати додаткові матеріали учням за допомогою спеціального інтерфейсу."
...
#    no_purchaser_role: "No role in purchase decisions"
  ...
  courses:
    ...
    you_have1: "У вас є"
    you_have2: "невикористаних учнівських ліцензій"
    use_one: "Використати 1 учнівську ліцензію для"
    use_multiple: "Використати ліцензії для наступних учнів:"
    already_enrolled: "вже зараховано"
    licenses_remaining: "залишилось ліцензій:"
    insufficient_enrollments: "недостатньо учнівських ліцензій"
    ...
    enrolled_courses: "зараховано до платних курсів:"
    ...
    complete: "Завершити"
    none: "Жоден"
    play_campaign_title: "Грати в кампанію"
    play_campaign_description: "Ви готові до наступного кроку! Досліджуйте сотні рівнів, вивчайте просунуті навички програмування та змагайтесь на багатокористувацьких аренах!"
    create_account_title: "Створити акаунт"
    create_account_description: "Зареєструйте БЕЗКОШТОВНИЙ акаунт в CodeCombat та отримайте доступ до більшої кількості рівнів, навичок та розваг!"
    preview_campaign_title: "Попередній перегляд кампанії"
    preview_campaign_description: "Перед створенням БЕЗКОШТОВНОГО акаунту можете одним оком глянути на все, що пропонує CodeCombat."
    arena: "Арена"
    arena_soon_title: "Арена скоро буде"
    arena_soon_description: "Ми працюємо над створенням багатокористувацької арени для класів в кінці"
    not_enrolled1: "Не зараховано"
    not_enrolled2: "Попросіть, щоб ваш вчитель зарахував вас на наступний курс."
    next_course: "Наступний курс"
    coming_soon1: "Очікуйте скоро"
    coming_soon2: "Ми старанно працюємо, створюючи нові курси для вас!"
    ...
    completed_hoc: "Чудово! Ви завершили курс Години Коду!"
    ready_for_more_header: "Готові до більшого? Зіграйте в режим кампанії!"
    ready_for_more_1: "Використайте самоцвіти щоб розблокувати нові речі!"
    ready_for_more_2: "Грайте в нові світи та рівні"
    ready_for_more_3: "Вчіть ще більше програмування!"
    saved_games: "Збережені ігри"
    hoc: "Година Коду"
    ...
    welcome_to_hoc: "Шукачі пригод, ласкаво просимо до Години Коду!"
    logged_in_as: "Ви увійшли як:"
    not_you: "Це не ви?"
    welcome_back: "Вітаємо, шукач пригод, з поверненням!"
    ...
    thank_you_pref: "Дякуємо за покупку! Тепер ви можете призначити на"
    thank_you_suff: "більше учнів на платні курси."
    return_to_class: "Повернутись до класної кімнати"
    return_to_course_man: "Повернутись до керування курсом."
    students_not_enrolled: "учнів не зараховано"
    total_all_classes: "Всього у всіх класах"
    how_many_enrollments: "Скільки додаткових учнівських ліцензій вам потрібно?"
    each_student_access: "Кожен учень в класі отримає доступ до курсів 2-4, як тільки його буде зараховано на платні курси. Ви можете призначити кожен курс для кожного учня індивідуально."
    purchase_now: "Придбати зараз"
    enrollments: "ліцензії"
    ...
    use_school_email: "використайте email вашої школи, якщо він у вас є"
    unique_name: "унікальне ім'я, яке ще ніхто не обрав"
    pick_something: "виберіть щось, що ви зможете запам'ятати"
    class_code: "Код класу"
    optional_ask: "необов'язково - отримайте у вашого вчителя!"
    optional_school: "необов'язково - до якої школи ви ходите?"
    start_playing: "Розпочати гру"
    skip_this: "Пропустити це, я створю акаунт пізніше!"
    welcome: "Ласкаво просимо"
    getting_started: "Початок роботи з курсами"
    download_getting_started: "Завантажити путівник початківця [PDF]"
    getting_started_1: "Створіть новий клас клікнувши на зелену кнопку 'Створити новий клас' нижче."
    getting_started_2: "Як тільки ви створили клас, клікніть на синю кнопку 'Додати учнів'."
    getting_started_3: "Ви побачите прогрес учнів внизу, коли вони зареєструються та приєднаються до вашого класу."
    educator_wiki_pref: "Або ознайомтесь з нашою новою"
    educator_wiki_mid: "учительською вікі"
    educator_wiki_suff: "щоб переглянути путівник онлайн."
    your_classes: "Ваші класи"
    no_classes: "Поки що немає класів!"
    create_new_class1: "створити новий клас"
    available_courses: "Доступні курси"
    unused_enrollments: "Доступно невикористаних ліцензій:"
    students_access: "Всі учні мають безкоштовний доступ до Вступу до комп'ютерних наук. Необхідно одну ліцензію для кожного учня, щоб призначити їх до платних курсів CodeCombat. Для одного учня не потрібно кілька ліцензій для доступу до всіх платних курсів."
    active_courses: "активні курси"
    no_students: "Поки що немає учнів!"
    add_students1: "додати учнів"
    view_edit: "перегляд/редагування"
    students_enrolled: "учнів зараховано"
    students_assigned: "учнів призначено"
    length: "Довжина:"
    ...
    print_guide: "Роздрукувати інструкцію (PDF)"
    ...
    learn_p: "Вчити Python"
    learn_j: "Вчити JavaScript"
  ...
  teacher:
    ...
    not_assigned_modal_body_1: "У вас немає достатньо ліцензій, щоб призначити додаткові курси для всіх {{selected}} обраних учнів."
    not_assigned_modal_body_2: "У вас є лише {{totalSpotsAvailable}} доступних ліцензій ({{unenrolledStudents}} учнів не мають активних ліцензій)."
    not_assigned_modal_body_3: "Будь ласка, оберіть менше учнів або напишіть на {{email}}, щоб отримати допомогу."
    ...
    guides_coming_soon: "Путівники будуть вже скоро!" # Courses
    ...
    credits_available: "Доступно ліцензій"
    total_unique_students: "Всього учнів"
    total_enrolled_students: "Зараховані учні"
    unenrolled_students: "Незараховані учні"
    add_enrollment_credits: "Додати ліцензії"
    purchasing: "Придбання..."
    purchased: "Куплено!"
    purchase_now: "Придбати зараз"
    how_to_enroll: "Як зарахувати учнів?"
    how_to_apply_licenses: "Як застосовувати ліцензії?"
    bulk_pricing_blurb: "Купуєте для більш ніж 25 учнів? Зв'яжіться з нами, щоб обговорити наступні кроки."
    total_unenrolled: "Всього незарахованих"
    ...
    enrollment_status: "Статус зарахування"
...
#    view_arena_ladder: "View Arena Ladder"
    ...
    unlock_resources: "Розблокуйте більше ресурсів!"
    unlock_resources_desc: "Отримайте доступ до додаткових путівників додаючи учнівські ліцензії до вашого акаунту. Щоб розпочати, зробіть запит на демо сьогодні."
    request_demo: "Запит демо"
    student_overview: "Огляд"
    student_email: "Учнівський email"
