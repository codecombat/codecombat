...
#    top_banner_blurb_demo_day_2023_02_16: "LIVE DEMO! See how you can use esports to teach coding. Join us Thursday February 16th at 2:00 pm PST."
    ...
    im_an_parent: "Батько або мати"
    im_a_parent_description: "Відвідайте наші онлайн-класи для вивчення мов програмування"
    im_an_educator: "Я викладач"
    im_an_educator_description: "Навчайте інформатику разом з CodeCombat"
    im_a_teacher: "Я вчитель"
    im_a_student: "Я учень"
    im_a_student_description: "Вивчайте інформатику разом зі своїм класом"
    im_an_individual: "Вивчаю для себе"
    im_an_individual_description: "Грайте вдома для вивчення поза класом"
    learn_more: "Дізнатися більше"
    check_it_out: "Перевір це!"
    ...
    builds_concepts_up: "Мені подобається, концепція CodeCombat навчатися граючи. Це дійсно легко і дуже цікаво."
...
#    request_quote: "Request a Quote"
    ...
    educator: "Викладач"
    student: "Учень"
    go_to_my_dashboard: "Перейти до головної панелі"
...
#    ozaria_china_blurb: ""
    ...
    explore_codecombat: "Досліджуй CodeCombat"
    explore_ai_league: "Досліджуй AI League"
    explore_ozaria: "Досліджуй Озарію"
    explore_online_classes: "Досліджуй онлайн класи"
    explore_pd: "Досліджуй професійну розробку"
...
#    online_classes_blurb: "Our online coding classes combine the power of gameplay and personalized instruction for an experience your child will love. With both private or group options available, this is remote learning that works."
    for_educators: "Для викладачів"
    for_parents: "Для батьків"
    for_everyone: "Для всіх"
    for_students: "Для студентів"
    for_individuals: "Для тих, хто вивчає самостійно"
#    what_our_customers_are_saying: "What Our Customers Are Saying"
    game_based_learning: "Навчання засноване на грі"
...
#    confirm_individual_blurb_without_email: "Write down your login information in case you need it later."
    ...
    teacher_list_resource_hub_4: "Хаб Ресурсів" # {change}
...
#    bdm_title: "Business Development Manager"
    community_subtitle: "Більше 500 помічників допомогли створити CodeCombat, і кожного тижня приєднуються нові!" # {change}
    ...
    number_contributors: "Більше 450 вкладників надали свою підтримку та час, щоб підтримати цей проект." # {change}
    ...
    jobs_benefit_4: "Необмежена відпустка" # {change}
...
#    status_partly_expires: "Partly expires on {{date}}"
    ...
    resource_hub: "Хаб ресурсів" # {change}
