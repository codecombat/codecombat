...
#    accounts_merge_confirmation: "There is an account associated with the email from this Google account. Would you like to merge these accounts?"
  ...
  signup:
    ...
    create_student_header: "Creëer leerling account"
...
#    login: "Login"
    ...
    birthday: "Verjaardag"
    parent_email_blurb: "We weten dat je niet kan wachten om te leren programmeren &mdash; wij hebben er ook zin in! Je ouders krijgen een e-mail met verdere instructies over hoe ze een account voor je kunnen maken. E-mail {{email_link}} als je nog vragen hebt."
...
#    activation_code_used: "The activation code has been used. Check your spelling or ask your teacher for help."
    ...
    account_exists: "Dit e-mailadres bestaat al:" # {change}
    sign_in: "Log in"
    email_good: "E-mail ziet er goed uit!"
    name_taken: "Gebruikersnaam bestaat al! Probeer {{suggestedName}}?"
    name_available: "Gebruikersnaam beschikbaar!"
    name_is_email: "Gebruikersnaam mag geen e-mail zijn"
    ...
    teacher_type_3: "Krijg toegang tot de cursusgidsen"
    teacher_type_4: "Bekijk voortgang leerlingen"
    signup_as_teacher: "Registreer als een docent" # {change}
    ...
    enter_parent_email: "Vul het e-mailadres van je ouders in:"
    parent_email_error: "Er ging iets mis bij het verzenden van de e-mail. Controleer het e-mailadres en probeer het nog eens."
    parent_email_sent: "We hebben een e-mail gestuurd met instructies voor het aanmaken van een account. Vraag je ouders hun e-mail te checken."
    ...
    confirm_individual_blurb: "Schrijf je login gegevens op voor het geval je ze later nog eens nodig hebt. Bevestig je e-mailadres zodat je je account kan herstellen, mocht je ooit je wachtwoord vergeten - check je inbox!"
#    confirm_individual_blurb_without_email: "Write down your login information in case you need it later."
    ...
    dont_use_our_email_silly: "Zet hier niet je eigen e-mailadres neer, maar die van je ouders!"
...
#    challenge: "Challenge"
    ...
    combo_challenge_unlocked: "Combo Challenge Vrijgespeeld"
    concept_challenge_unlocked: "Concept Challenge Vrijgespeeld"
    ...
    challenge_level_goal: "Challenge Level Doelen"
    concept_challenge_goals: "Concept Challenge Doelen"
    combo_challenge_goals: "Challenge Level Doelen"
    concept_challenge_goal: "Concept Challenge Doelen"
    combo_challenge_goal: "Challenge Level Doelen"
    running: "Afspelen..."
    success: "Gelukt!"
...
#    meta_description: "Our mission is to level computer science through game-based learning and make coding accessible to every learner. We believe programming is magic and want learners to be empowered to to create things from pure imagination."
    ...
    story_link: "Verhaal"
    press_link: "Pers"
    mission_title: "Onze missie: maak programmeren toegankelijk voor elke student op aarde." # {change}
...
#    hoc_blurb3: "activity! Construct four different minigames to learn the basics of game development, then make your own!"
    ...
    purchase_enrollments: "Koop licenties"
...
#    feedback_capstone: "The student will create a base project in Part 1. They will make creative updates based on peer feedback in Part 2. Here is a <a target=\"_blank\" rel=\"noopener\" href=\"https://docs.google.com/document/d/1itB0vY6WphjINQYJ9NHkILATcLLlYD3GDSg6FJg55OQ\">Peer Feedback Template</a> that you can share with your students."
    ...
    create_teacher_account: "Maak Docentenaccount aan" # {change}
...
#    unit_progress: "Unit Progress"
    ...
    view_student_code: "Klik om de code van de leerling te bekijken"
    ...
    students_not_assigned: "Leerlingen niet toegewezen aan {{courseName}}"
    ...
    class_join_url_blurb: "Nieuwe leerlingen kunnen deze link bezoeken terwijl ze ingelogd zijn om zich bij de klas aan te sluiten."
...
#    status_partly_expires: "Partly expires on {{date}}"
    ...
    pacing_guides_middle: "Stap-voor-stap gids onderbouw Middelbare school"
...
#    assessments_curriculum_desc: "Learn how to use Challenge Levels and Combo Challenge levels to assess students' learning outcomes."
    ...
    cs1_pairprogramming: "Programmeeractiviteiten voor duo's."
...
#    revoke_selected_confirm: "Are you sure you want to revoke Licenses from all selected students?"
    ...
    teacher_quest_done: "Wil je dat je leerlingen nog meer leren? Neem contact op met onze [schoolspecialisten](mailto:product@codecombat.eu) today!"
    ...
    view_project_gallery: "Bekijk de Projectgalerij" # {change}
    ...
    explain_open_ended: "NB: Leerlingen worden aangemoedigd om dit level creatief op te lossen — een mogelijke oplossing wordt hieronder weergegeven."
    level_label: "Level:"
    time_played_label: "Speeltijd:" # {change}
...
#    description3: "All the actionable insights educators need at a glance, such as student progress and concept understanding."
  ...
  share_licenses:
    ...
    add_teacher_label: "Vul het juiste e-mailadres van de docent in:"
...
#    shared_pool_label: "Teachers in your shared pool:"
  ...
  sharing:
    ...
    share_with_teacher_email: "Stuur naar jouw leraar"
...
#    prepaids_title: "Prepaids"
    ...
    verify_error: "Er is iets mis gegaan bij het bevestigen van je e-mailadres :("
...
#    reused_password: "Password cannot be reused"
  ...
  esper:
    line_no: "Regel $1: "
    uncaught: "Fouttype $1" # $1 will be an error type, eg "Uncaught SyntaxError"
...
#    syllabus: "AP CS Principles Syllabus"
    syllabus_description: "Gebruik dit hulpmiddel om het CodeCombat-curriculum (leerplan) te plannen voor uw informaticales. Begrippen worden niet vertaald naar het Nederlands."
