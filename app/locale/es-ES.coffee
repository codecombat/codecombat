...
#    built_for_teachers_subblurb2: "Learners construct mazes and use basic input handling to code their own games that can be shared with friends and family."
    ...
    built_for_teachers_subblurb3: "Usando HTML, CSS, and jQuery, los estudiante ejercitan sus músculos de creatividad para programar sus propias páginas web con una URL personalizada para compartir con sus compañeros de clase."
    century_skills_title: "Habilidades del siglo XXI"
    century_skills_blurb1: "Los estudiantes no solo suben de nivel a su Heroe, ellos mismos suben de nivel"
