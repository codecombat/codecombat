module.exports = nativeDescription: "español (ES)", englishDescription: "Spanish (Spain)", translation:
  new_home:
    ...
    our_courses: "Nuestros cursos han sido específicamente evaluados <strong> para sobresalir en el aula </strong>, incluso por maestros con poca o ninguna experiencia de programación previa."
...
#    courses_available_in: "Courses are available in JavaScript and Python. Web Development courses utilize HTML, CSS, jQuery, and Bootstrap."
    boast: "Cuenta con enigmas que son lo suficientemente complejos para fascinar tanto a los jugadores como a los codificadores."
#    winning: "A winning combination of RPG gameplay and programming homework that pulls off making kid-friendly education legitimately enjoyable."
#    run_class: "Everything you need to run a computer science class in your school today, no CS background required."
    goto_classes: "Ir a Mis clases"
   view_profile: "Ver mi perfil"
    view_progress: "Ver el Progreso"
