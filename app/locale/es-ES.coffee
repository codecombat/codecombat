module.exports = nativeDescription: "español (ES)", englishDescription: "Spanish (Spain)", translation:
  new_home:
    ...
    wanted_to_do: " Programar es algo que siempre he querido hacer, nunca pensé que sería capaz de aprenderlo en la escuela."
...
#    agency: "CodeCombat is a game that gives players that agency and confidence with our robust typed code engine, which helps beginner and advanced students alike write proper, valid code."
    request_demo_title: "¡Consigue que tus estudiantes empiecen hoy!"
    request_demo_subtitle: "Solicita una demostración y haz que tus estudiantes empiecen en menos de una hora."
    get_started_title: "Configura tu clase hoy"
    get_started_subtitle: "Establece una clase, añade a tus estudiantes, y supervisa su progreso a medida que aprenden informática."
    ...
    show_me_lesson_time: "Muéstrame las estimación de tiempo para la lección:"
    ...
    boast: "Cuenta con enigmas que son lo suficientemente complejos para fascinar tanto a los jugadores como a los programadores."
    winning: "Una combinación ganadora de juego RPG y tareas de programación que hacen que la educación de los niños sea razonablemente agradable."
#    run_class: "Everything you need to run a computer science class in your school today, no CS background required."
  ...
  play:
    ...
    subscriber_heroes: "¡Suscríbete hoy mismo para desbloquear inmediatamente Amara, Hushbaum y Hattori!"
    subscriber_gems: "¡Suscríbete hoy mismo para comprar este héroe con gemas!"
...
#    play_classroom_version: "Play Classroom Version" # Choose a level in campaign version that you also can play in one of your courses
    ...
    brain_pop_challenge: "¡Desafíate a jugar de nuevo usando un lenguaje de programación diferente!"
    replay: "Repetición"
    back_to_classroom: "Vuelve a Clase"
...
#    nil: "nil"
  ...
  signup:
    ...
    create_individual_header: "Crer Cuenta Individual"
    ...
    optional: "opcional"
    school_name_placeholder: "Ejemplo Escuela Secundaria, Springfield, IL"
...
#    classroom_not_found: "No classes exist with this Class Code. Check your spelling or ask your teacher for help."
    ...
    sign_in: "Registrarse"
    email_good: "¡El correo electrónico parece correcto!"
    name_taken: "¡Nombre de usuario ya usado! ¿Has probado {{suggestedName}}?"
    name_available: "¡Nombre de usuario disponible!"
    name_is_email: "El nombre de usuario no puede ser un correo electrónico"
    choose_type: "Elige tu tipo de cuenta:"
    teacher_type_1: "¡Enseña a programar usando CodeCombat!"
    teacher_type_2: "Configura tu clase"
    teacher_type_3: "Acceder a las guías de los cursos"
    teacher_type_4: "Ver el progreso del estudiante"
    signup_as_teacher: "Registrarse como profesor"
    student_type_1: "¡Aprende a programar mientras juegas a un juego atractivo!"
    student_type_2: "Juega con tu clase"
#    student_type_3: "Compete in arenas"
    student_type_4: "¡Selecciona a tu héroe!"
    student_type_5: "¡Ten listo su Código de Clase!"
    signup_as_student: "Registrarse como estudiante"
    individuals_or_parents: "Individuos y Padres"
    individual_type: "Para los jugadores que aprenden a programar fuera de clase. Los padres deben registrarse para obtener una cuenta aquí."
    signup_as_individual: "Registrarse como Individuo"
    enter_class_code: "Ingresa tu Código de Clase"
    enter_birthdate: "Ingresa tu fecha de nacimiento:"
    parent_use_birthdate: "Padres, usen su propia fecha de nacimiento."
    ask_teacher_1: "Pídele a tu maestro tu Código de Clase."
    ask_teacher_2: "¿No formas parte de una clase? Crea una "
    ask_teacher_3: "Cuenta Individual"
    ask_teacher_4: " en su lugar."
    about_to_join: "Estás a punto de unirte:"
    enter_parent_email: "Introduce la dirección de correo electrónico de tus padres:"
    parent_email_error: "Se ha producido un error al intentar enviar el correo electrónico. Comprueba la dirección de correo electrónico y vuelve a intentarlo."
    parent_email_sent: "Hemos enviado un correo electrónico con instrucciones adicionales sobre cómo crear una cuenta. Pídele a tus padres que revisen la bandeja de entrada."
    account_created: "¡Cuenta Creada!"
    confirm_student_blurb: "Anota tu información para que no la olvides. Tu profesor también puede ayudarte a restablecer tu contraseña en cualquier momento."
    confirm_individual_blurb: "Anota tu información de inicio de sesión por si la necesitas más tarde. Verifica tu correo electrónico para que puedas recuperar tu cuenta en el caso de que alguna vez olvides la contraseña - ¡comprueba tu bandeja de entrada!"
    write_this_down: "Escribe esto:"
    start_playing: "¡Empieza a jugar!"
    sso_connected: "Conectado correctamente con:"
    select_your_starting_hero: "Selecciona tu Héroe Inicial:"
    you_can_always_change_your_hero_later: "Siempre puedes cambiar a tu héroe más tarde"
    finish: "Terminar"
    teacher_ready_to_create_class: "¡Estás listo para crear tu primera clase!"
    teacher_students_can_start_now: "Tus estudiantes podrán comenzar a jugar el primer curso, Introducción a la Informática, de inmediato."
    teacher_list_create_class: "En la siguiente pantalla podrás crear una nueva clase."
    teacher_list_add_students: "Añade a los alumnos a la clase haciendo clic en el enlace Ver Clase. Después envía a tus alumnos el Código de Clase o la URL. También puedes invitarlos por correo electrónico si ya tienen direcciones."
    teacher_list_resource_hub_1: "¡Revisar las"
    teacher_list_resource_hub_2: "Guías del Curso"
    teacher_list_resource_hub_3: "para las soluciones de cada nivel y el"
    teacher_list_resource_hub_4: "Centro de Recursos"
    teacher_list_resource_hub_5: "para las guías curriculares, actividades y mucho más!"
    teacher_additional_questions: "¡Eso es! Si necesitas ayuda adicional o tienes preguntas, comunícate con __supportEmail__."
    dont_use_our_email_silly: "¡No pongas nuestro correo electrónico aquí! Pon el correo electrónico de tus padres."
  ...
  common:
    ...
    valid_phone: "Ingresa un número de teléfono válido."
...
#  play_game_dev_level:
    ...
    play: "Jugar Nivel"
    play_more_codecombat: "Jugar más CodeCombat"
    default_student_instructions: "¡Haz clic para controlar a tu héroe y ganar el juego!"
...
#    premium: "Premium" # Make sure the following feature translations don't go onto two lines
    ...
    parents_blurb3: "Sin riesgo: 100% garantía de devolución de dinero, cancela tu suscripción con un simple clic."
...
#    writable: "writable" # Hover over "attack" in Your Skills while playing a level to see most of this
  ...
  about:
    main_title: "Si quieres aprender a programar, necesitas escribir (mucho) código."
    main_description: "En CodeCombat, nuestro trabajo es asegurarnos de que estás haciendo esto con una sonrisa en tu cara."
    mission_link: "Misión"
    team_link: "Equipo"
    story_link: "Historia"
    press_link: "Prensa"
...
#    cat_blurb: "Airbender"
    ...
    maka_title: "Defensor del Cliente"
    maka_blurb: "Narrador"
...
#    jose_blurb: "Taking Off"
    community_title: "...y nuestra comunidad de código abierto"
    community_subtitle: "¡Más de 500 colaboradores han ayudado a construir CodeCombat, con más uniones cada semana!"
    community_description_3: "CodeCombat es una"
...
#    jobs_custom_contact_2: "introducing yourself and we might get in touch in the future!"
    contact_title: "Prensa y Contacto"
#    contact_subtitle: "Need more information? Get in touch with us at"
    screenshots_title: "Imágenes del Juego"
...
#    gd1_description: "uses syntax students are already familiar with to show them how to build and share their own playable game levels."
    see_an_example_project: "ver un ejemplo de proyecto"
...
#    education_level_help: "Choose as many as apply."
    ...
    referrer: "¿Cómo has sabido de nosotros?"
...
#    convert_account_title: "Update to Teacher Account"
  ...
  versions:
    ...
    submitting_patch: "Envío de Parche..."
    cla_prefix: "Para guardar los cambios, primero debes aceptar nuestro"
    cla_url: "CLA"
    cla_suffix: "."
    cla_agree: "De acuerdo"
    owner_approve: "Algún propietario deberá aprobarlo antes de que tus cambios sean visibles."
  ...
  account_settings:
    ...
    file_size_limit: "(tamaño máximo del archivo: 1MB)"
