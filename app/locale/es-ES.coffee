module.exports = nativeDescription: "español (ES)", englishDescription: "Spanish (Spain)", translation:
  ...
  new_home:
    title: "CodeCombat - Programando juegos para aprender Python y Javascript"
    meta_keywords: "CodeCombat, python, javascript, Juegos de programación"
#    meta_description: "Learn typed code through a programming game. Learn Python, JavaScript, and HTML as you solve puzzles and learn to make your own coding games and websites."
    meta_og_url: "https://codecombat.com"
    become_investor: "para hacerse inversor CodeCombat"
    built_for_teachers_title: "Un Juego de Programación Construido Teniendo en Cuenta a los Profesores."
    built_for_teachers_blurb: "Enseñar a los niños a programar puede ser abrumador. CodeCombat ayuda a todos los educadores a enseñar cómo programar en JavaScript o Python, dos de los lenguajes de programación más populares. Con un plan de estudios comprensivo que incluye seis temarios de Informática, y refuerza el aprendizaje a través de temarios de desarrollo de videojuegos y desarrollo web basados en proyectos, los niños progresarán en un viaje desde la sintaxis básica hasta la recursión!"
    built_for_teachers_subtitle1: "Informática"
    built_for_teachers_subblurb1: "Comenzando con nuestro curso gratuito de Introducción a la Informática, los estudiantes dominan los conceptos básicos de programación, tales como bucles de while / for, funciones y algoritmos."
    built_for_teachers_subtitle2: "Desarrollo de Videojuegos"
    built_for_teachers_subblurb2: "Los alumnos construyen laberintos y gesionan dispositivos de entrada básicos para programar sus propios videojuegos que pueden compartir con amigos y familiares."
    ...
    century_skills_blurb1: "Los estudiantes no solo suben de nivel a su Héroe, suben ellos también"
...
#    century_skills_subblurb4: "Coding requires kids to practice new forms of communication, including communicating with the computer itself and conveying their ideas using the most efficient code."
    ...
    classroom_in_box_blurb1: "Enganchar a todos los estudiantes para que confíen que la programación es para ellos."
    classroom_in_box_blurb2: "Empoderar a todos los educadores para que se sienta seguro al enseñar a programar."
    classroom_in_box_blurb3: "Inspirar a todos los colegios para crear un programa de informática a nivel mundial."
    click_here: "Haz clic aquí"
    creativity_rigor_title: "Donde la Creatividad se encuentra con el Rigor"
    creativity_rigor_subtitle1: "Hacer la programación divertida y enseñar habilidades del mundo real"
    creativity_rigor_blurb1: "Los estudiantes escriben Python y Javascript reales mientras juegan videojuegos que promueven la prueba y error, el pensamiento crítico y la creatividad. Los estudiantes aplican las luego las habilidades aprendidas para desarrollar sus propios juegos y páginas web en cursos basados en proyectos."
...
#    featured_partners_title2: "Premios y Partners"
...
#    request_quote: "Request a Quote"
    ...
    educator: "Educator"
    student: "Estudiante"
    our_coding_programs: "Nuestros programas"
    codecombat: "CodeCombat"
    ozaria: "Ozaria"
    codecombat_blurb: "Nuestro juego de programación original. Recomendado para padres, individuos, educadores y estudiantes que quieren experimentar uno de los juegos de programación más queridos del mundo."
    ozaria_blurb: "Un juego de aventuras y un curso de informática donde los estudiantes dominan la magia perdida de la programación para salvar el mundo. Recomendado para educadores y estudiantes."
  ...
  nav:
    ...
    parent: "Padres"
    browser_recommendation: "Para la mejor experiencia recomendamos la última versión de Chrome. Descárgalo aquí!"
...
#    accounts_merge_confirmation: "There is an account associated with the email from this Google account. Would you like to merge these accounts?"
  ...
  signup:
    ...
    sign_in_to_continue: "Accede o crea una cuenta para continuar"
    teacher_email_announcements: "¡Mantenme informado sobre nuevos recursos para profesores, currículo, y cursos!"
    ...
    birthday: "Cumpleaños"
    parent_email_blurb: "Sabemos que no puedes esperar a aprender a programar &mdash; ¡Nosotros también estamos emocionados! Tus padres recibirán un correo con más instrucciones de cómo crearte una cuenta. Enviad un correo a {{email_link}} si tenéis alguna duda."
    classroom_not_found: "No existen clases con ese Código de Clase. Comprueba que está bien escrito o pide ayuda a tu profesor."
    checking: "Comprobando..."
    account_exists: "Este correo electrónico ya está en uso:"
    sign_in: "Iniciar Sesión"
    email_good: "¡El email parece bueno!"
    name_taken: "¡El nombre de usuario ya está cogido! ¿Pruebas con {{suggestedName}}?"
    ...
    student_type_3: "Compite en el ring"
    student_type_4: "¡Elige tu héroe!"
    student_type_5: "¡Prepara tu Código de Clase!"
    signup_as_student: "Iniciar sesión como Estudiante"
    individuals_or_parents: "Individuos o Padres"
    individual_type: "Para jugadores aprendiendo a programar fuera de una clase. Los padres deberían crear una cuenta aquí."
    signup_as_individual: "Inscribirse como Individuo"
    enter_class_code: "Indica tu Código de Clase"
...
#    cpp_blurb: "(Subscriber Only) Game development and high performance computing."
    ...
    skills: "Habilidades"
    attack_1: "Proporciona"
    attack_2: "de la lista"
    attack_3: "daño de arma."
    health_1: "Proporciona"
    health_2: "de la lista"
    health_3: "poder de armadura."
    speed_1: "Se mueve a"
...
#  char_customization_modal:
    heading: "Personaliza tu Héroe"
    body: "Cuerpo"
    name_label: "Nombre del Héroe"
    hair_label: "Color del Pelo"
    skin_label: "Color de la Piel"

  skill_docs:
    function: "función" # skill types
    method: "método"
    snippet: "trozo de código"
    number: "número"
    array: "array"
    object: "objeto"
    string: "cadena"
    ...
    still_undocumented: "Todavía sin documentar, lo sentimos."
  ...
  about:
    title: "Acerca de CodeCombat - Enganchando Estudiantes, Empoderando Profesores, Inspirando la Creación"
    meta_description: "Nuestra misión es la informática a través del aprendizaje basado en el juego y hacer la programación accesible a cualquier aprendiz. Creemos que la programación es mágica y queremos que los aprendices se empoderen creando cosas a partir de la pura imaginación."
    learn_more: "Saber más"
    main_title: "Si quieres aprender a programar, necesitas escribir código (un montón)."
    main_description: "En CodeCombat, nuestro trabajo es asegurarnos de que lo haces con una sonrisa en la cara."
    mission_link: "Misión"
    team_link: "Equipo"
    story_link: "Historia"
    press_link: "Prensa"
...
#    full_name_required: "First and last name required"
  ...
  versions:
    ...
    submitting_patch: "Enviando Parche..."
...
#  cinematic:
    click_anywhere_continue: "clic en cualquier lugar para continuar"
...
#    course_title: "Course Editor"
    ...
    thang_spritesheets: "Hojas de cálculo"
    ...
    level_tab_thangs_search: "Buscar objetos"
    add_components: "Agregar Componentes"
    component_configs: "Configuraciones de Componentes"
    config_thang: "Doble clic para configurar un objeto"
    delete: "Borrar"
    duplicate: "Duplicar"
...
#    achievement_query_goals: "Key achievement off of level goals"
    ...
    add_system_title: "Añadir Sistemas al Nivel"
    done_adding: "No añadir más"
...
#    tournament_blurb_ace_of_coders: "Battle it out in the frozen glacier in this domination-style mirror match! The tournament began on Wednesday, September 16 and will run until Wednesday, October 14 at 5PM PDT. Check out the details"
    ...
    awaiting_tournament_blurb: "El ring del torneo no está activo ahora."
    tournament_end_desc: "El torneo se ha terminado, gracias por jugar"
  ...
  account:
    ...
    prepaids_title: "Prepagos"
    payments: "Pagos"
    prepaid_codes: "Código prepagados"
    purchased: "Adquirido"
    subscribe_for_gems: "Suscribirse para joyas"
    ...
    not_yet_verified: "Sin verificar."
    resend_email: "Reenviar correo"
    email_sent: "¡Correo enviado! Comprueba tu bandeja de entrada."
    verifying_email: "Verificando tu dirección de correo..."
    successfully_verified: "¡Dirección de correo verificada correctamente!"
    verify_error: "Algo ha fallado al verificar tu correo :("
    unsubscribe_from_marketing: "¿Dar de baja __email__ de todos los correos publicitarios de CodeCombat?"
    unsubscribe_button: "Sí, darse de baja"
    unsubscribe_failed: "Error"
    unsubscribe_success: "Hecho"
...
#  ozaria_chrome:
    ...
    sound_on: "Sonido On"
    back_to_map: "Regresar al Mapa"
    level_options: "Opciones del Nivel"
    restart_level: "Reiniciar el Nivel"
...
#  interactives:
    phenomenal_job: "¡Excelente trabajo!"
    try_again: "¡Uups!, inténtalo de nuevo!"
    select_statement_left: "¡Uups!, selecciona una instrucción de la izquierda antes de darle a \"Enviar.\""
    fill_boxes: "¡Uups!, asegúrate de rellenar todas las cajas antes de darle a \"Enviar.\""
