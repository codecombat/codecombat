module.exports = {
  ...
  translation: {
    ...
    teacher_dashboard: {
      ...
      coco_practices_tooltip: '<h3>Practice Level</h3><p>Game-play in which students are practicing concepts while solving puzzles to complete their hero\'s quest. They are optional and only appears for the students that the system think needs extra practice.</p>',
      multiplayers_tooltip: '<h3>Multiplayer Level</h3><p>Levels which students can play against others.</p>',
      mains_tooltip: '<h3>Main Level</h3><p>Levels are required to complete for the certificates.</p>',
      learn_to_use_tooltip: '<h3>Learn To Use</h3><p>AI Projects that shows different prompts to the student to learn.</p>',
      use_tooltip: '<h3>Use</h3><p>AI Projects that allows students to freely use the AI Model.</p>',
