module.exports = {
  ...
  translation: {
    ...
    parents_v2: {
      ...
      step_box_2_subtitle: 'Engage',
      step_box_2_footer_text: 'What kind of loops exist in the real world?',
      step_box_3_title: 'Live Instructions',
      step_box_3_subtitle: 'Engage',
      step_box_3_footer_text: 'What kind of loops exist in the real world?',
      step_box_4_title: 'Live Instructions',
      step_box_4_subtitle: 'Engage',
      step_box_4_footer_text: 'What kind of loops exist in the real world?',
      ...
      signup_description: 'Or, **Sign up for a self-paced access**',
      homeschool_solution: 'Looking for a homeschool solution',
      teach_child: 'If you plan to teach your child, we can provide a turnkey solution that empowers you to deliver our curriculum in your own home. We provide all the teaching resources needed for you and your child to succeed including course solution guides. Contact our team to learn more - email **classes@codecombat.com** to connect with a learning advisor.',
      ...
      get_prepared_for_ap_csp_exam: '**Get prepared for the AP CSP exam**',
      ...
      faq_5_answer: 'Your subscription purchase is 100% risk-free within the first 30 days. If for any reason you decide not to continue, simply contact us at classes@codecombat.com within 30 days of purchase and we will promptly refund 100% of your purchase, no questions asked.',
      faq_6_question: 'What if I need to reschedule a class?',
      faq_6_answer: "Once you have booked a weekly class with us, we have reserved time in our schedule exclusively for you, so we require 48 hours' advance notice for rescheduling classes. You can reschedule your class by emailing classes@codecombat.com. Classes missed or canceled with less than 48 hours' notice will not be rescheduled or refunded.",
      ...
      faq_9_answer: 'We offer discounts for siblings and group classes. We do not arrange or assign group classes, but if you have a group of students looking to work together, we will facilitate a group class for them. Please reach out to classes@codecombat.com for questions about specific pricing details.',
