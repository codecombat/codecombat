module.exports = {
  ...
  translation: {
    ...
    ozaria_home: {
      ...
      engaging_row4_h2: '(used in zh-HANS)',
      engaging_row4_p: '(used in zh-HANS)',
      speaker_name_1: '(used in zh-HANS)',
      speaker_position_1: '(used in zh-HANS)',
      speaker_name_2: '(used in zh-HANS)',
      speaker_position_2: '(used in zh-HANS)',
      global_community_row1_header: '(used in zh-HANS)',
      global_community_row2_header: '(used in zh-HANS)',
      global_community_row3_header: '(used in zh-HANS)',
      global_community_row4_header: '(used in zh-HANS)',
      btn_download_pre: '(used in zh-HANS)',
      btn_download_flyer: '(used in zh-HANS)',
    ...
    new_home: {
      ...
      meta_keywords_cn_home: '(used in zh-HANS)',
      ...
      meta_description_cn_home: '(used in zh-HANS)',
      ...
      classroom_in_box_blurb4: '(used in zh-HANS)', // only for koudashijie.com
      ...
      slogan_subtitle: '(used in zh-HANS)',
      ...
      ozaria_china_blurb: '(used in zh-HANS)',
      hackstack_china_blurb: '(used in zh-HANS)',
      try_codecombat: 'Try CodeCombat',
      try_ozaria: 'Try Ozaria',
      try_hackstack: '(used in zh-HANS)',
    ...
    new_home_faq: {
      ...
      mobile_question: '(used in zh-HANS)',
      mobile_question_blurb: '(used in zh-HANS)',
    ...
    play_level: {
      ...
      credits_zero: 'Out of credits.',
      credits_zero_until_day: 'Out of credits until tomorrow.',
      credits_zero_until_week: 'Out of credits until next week.',
      credits_zero_until_month: 'Out of credits until next month.',
    ...
    choose_hero: {
      ...
      java_blurb: 'Android and enterprise.',
      cpp_blurb: 'Game development and high performance computing.',
    ...
    teachers: {
      ...
      select_initial_course: 'Recommended Courses',
      course_title_junior: 'CodeCombat Junior: Block & Text Code',
      'course_title_introduction-to-computer-science': 'CodeCombat: Intro to Computer Science',
      'course_title_intro-to-ai': 'AI HackStack: Intro to AI',
      'course_title_chapter-1-sky-mountain': 'Ozaria: Chapter 1 – Sky Mountain',
      free_course_blurb_junior: 'Supports pre-readers with mobile-friendly drag-and-drop icons, then progresses to drag-and-drop text, side-by-side blocks and code, and finally written text code.',
      'free_course_blurb_introduction-to-computer-science': 'Start with core computer science concepts and progress through a full CS curriculum including web development, game development, AP CSP, and more.',
      'free_course_blurb_intro-to-ai': 'School-safe AI learning that starts with foundational AI skills, then lets teachers choose subject-specific courses in AI literacy, cybersecurity, algebra, and more.',
      'free_course_blurb_chapter-1-sky-mountain': 'A narrative coding adventure that establishes the fundamentals of computer science through story-driven, guided learning.',
    ...
    courses: {
      ...
      more_options: 'Advanced Settings',
    ...
    polls: {
      priority: 'Priority', // Polls feature is gone (GD-868), but editor/resource/table.pug reuses this key
    },
    ...
    user: {
      ...
      certificate_ai_prompts: 'AI Prompts',
      certificate_for: 'For',
    ...
    concepts: {
      ...
      application_programming_interface: 'Application Programming Interface (APIs)',
      arguments: 'Arguments',
      ...
      career_technical_student_organizations: 'Career-Technical Student Organizations (CTSOs)',
      ...
      defining_functions: 'Defining Functions',
      ...
      forks: 'Forks',
      frequency: 'Frequency',
      function_tables: 'Function Tables',
      functions: 'Functions',
      ...
      integers: 'Integers',
      integrated_development_environments: 'Integrated Development Environments (IDEs)',
      ...
      large_language_model: 'Large Language Model (LLM)',
      ...
      parameters: 'Parameters',
      passwords: 'Passwords',
      penetration_test_reports: 'Penetration Test Reports',
      ...
      proofs: 'Proofs',
      properties: 'Properties',
      properties_attributes: 'Properties / Attributes',
      ...
      training_and_testing: 'Training and Testing',
      ...
      variables: 'Variables',
      vectors: 'Vectors',
      version_control_software: 'Version Control Software',
    ...
    payments: {
      ...
      billing_portal_btn_desc: 'Cancel Subscription',
      before_you_go: 'Before You Go',
      before_you_go_desc: "You'll lose access to your premium benefits when your subscription ends.",
      unexplored_solutions: 'Unexplored solutions',
      ai_credits_remaining: 'AI credits remaining',
      premium_levels_available: 'Premium levels still available to explore',
      access_until: "You'll continue to have access until __date__",
      keep_subscription: 'Keep My Subscription',
      continue_cancel: 'Continue to Cancellation',
    ...
    hackstack: {
      ...
      hint_tap_to_continue: 'Tap anywhere to continue',
      ...
      credit_wall_nudge_hook_free: 'Three mini-games are open in Latent Space — each one shows a piece of how AI works.',
