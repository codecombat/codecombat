module.exports = nativeDescription: "Português (Brasil)", englishDescription: "Portuguese (Brazil)", translation:
  new_home:
   	title: "CodeCombat - Jogos de codificação para aprender Python e JavaScript"
    meta_keywords: "CodeCombat, python, javascript, jogos de codificação"
    meta_description: "Aprenda código digitado através de um jogo de programação. Aprenda Python, JavaScript e HTML enquanto resolve quebra-cabeças e aprende a criar seus próprios jogos de codificação e websites."
   	meta_og_url: "https://codecombat.com"
    become_investor: "para se tornar um investidor no CodeCombat"
    ...
    century_skills_quote4: "Sempre tive aspirações de criar videogames e aprender a codificar ... isso está me dando um excelente ponto de partida."
		century_skills_quote4_author: "Joey, 2ª ano do Ensino Médio"
    ...
    quotes_quote5: "Embora a aula comece todos os sábados às 7h, meu filho está tão animado que acorda antes de mim! O CodeCombat cria um caminho para meu filho aprimorar suas habilidades de codificação."
    quotes_quote5_author: "Latthaphon Pohpon, Pai"
    see_example: "Veja alguns exemplos"
    slogan: "A maneira mais cativante de aprender ciência da computação"
    slogan_power_of_play: "Aprenda a codificar através do poder do jogo"
...
#    top_banner_blurb_maintenance: "Upgrades coming! Scheduled maintenance: up to 3 hours starting at __maintenanceStartTime__."
    ...
    im_a_parent_description: "Explore nossas aulas de codificação online ao vivo"
    im_an_educator: "Eu sou um professor(a)"
    im_an_educator_description: "Ensine Ciência da Computação com CodeCombat"
    im_a_teacher: "Eu sou um professor(a)"
    im_a_student: "Eu sou um Aluno"
    im_a_student_description: "Aprenda Ciência da Computação com sua turma"
    im_an_individual: "Eu sou um indivíduo"
    im_an_individual_description: "Jogue em casa, fora do ambiente de aula"
    ...
    computer_science: "Nossos cursos autoguiados abrangem desde a sintaxe básica até os conceitos avançados"
    ...
    explore_ai_league: "Explorar a Liga de IA"
    explore_ozaria: "Explorar Ozaria"
    explore_online_classes: "Explorar Online Classes"
    explore_pd: "Explorar Desenvolvimento Profissional"
    new_adventure_game_blurb: "Ozaria é nosso novo jogo de aventura e sua solução pronta para o ensino de Ciência da Computação. Nossos __slides__ voltados para o aluno e as anotações para o professor tornam o planejamento e a apresentação de aulas mais fáceis e rápidos."
    lesson_slides: "slides de aula"
...
#    meta_description: "Join a Clan or build your own community of coders. Play multiplayer arena levels and level up your hero and your coding skills."
  ...
  courses:
    ...
    welcome_to_courses: "Aventureiros, bem vindos aos Cursos!" # {change}
...
#    hoc_meta_description: "Make your own game or code your way out of a dungeon! CodeCombat has four different Hour of Code activities and over 60 levels to learn code, play, and create."
    ...
    hoc_teacher_led_link: "Planos de Aulas de Intrudução à Ciências da Computação" # {change}
