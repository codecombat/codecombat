...
#    purchase_code5: "For more information on Student Licenses, reach out to"
  ...
  coppa_deny:
    text1: "Nie możesz się doczekań kiedy zaczniesz?"
    text2: "Rodzice muszą założyć konto dla ciebie! Napisz team@codecombat.com jeśli masz jakiekolwiek pytania."
    close: "Zamknij okno"
  ...
  concepts:
    advanced_css_rules: "Zaawansowany CSS reguły"
    advanced_css_selectors: "Zaawansowany CSS selektory"
    advanced_html_attributes: "Zaawansowany HTML atrybuty"
    advanced_html_tags: "Zaawansowany HTML tagi"
