...
#    daniela_blurb: "Creates stories"
    ...
    community_subtitle: "Ponad 600 kontrybutorów pomogło stworzyć CodeCombat i liczba ta cały czas rośnie!"
    ...
    number_contributors: "Ponad 600 kontrybutorów poświęciło swoją wiedzę i czas, aby wspomóc nasz projekt."
