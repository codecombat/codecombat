...
#    purchased: "Purchased"
  ...
  subscribe:
    ...
    comparison_blurb: "Popraw swoje umiejętności z subskrypcją <strong>CodeCombat Premium</strong>!" # {change}
...
#    event_handlers: "Event Handlers"
    for_loops: "Pętle 'for'"
    for_loops_nested: "Pętle 'for' zagnieżdżone"
