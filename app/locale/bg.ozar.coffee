...
#    see_example: "See example"
    slogan: "Най-завладяващата игра за учене на програмиране." # {change}
...
#    watch_how: "Watch how CodeCombat is transforming the way people learn computer science."
    ...
    forgot_learning: "Мисля, че те всъщност забравиха, че всъщност учат нещо." # {change}
...
#    sign_in: "Sign In"
    ...
    sign_in_with_facebook: "Вписване чрез Facebook" # {change}
    sign_in_with_gplus: "Вписване чрез G+" # {change}
...
#    loading_start_concept: "Start Concept Challenge"
    ...
    tip_open_source: "CodeCombat e 100% проект с отворен код!" # {change}
...
#    description_coming_soon: "Description coming soon"
  ...
  options:
    ...
    editor_config_title: "Конфигурация на редактора" # {change}
