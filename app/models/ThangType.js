...
module.exports = (ThangType = (function () {
  ThangType = class ThangType extends CocoModel {
    ...
    isSilhouettedItem () {
      ...
      if (tier != null) {
        return this.levelRequiredForItem() > me.rank()
      }
    ...
    levelRequiredForItem () {
      ...
      const playerLevel = me.constructor.rankForTier(playerTier)
      // console.log 'Level required for', @get('name'), 'is', playerLevel, 'player tier', playerTier, 'because it is itemTier', itemTier, 'which is normally level', me.constructor.rankForTier(itemTier)
      return playerLevel
    }
