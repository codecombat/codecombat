  ...
  <div class="footer">
    ...
    <div class="footer__policies">
      <div class="footer__policy">
        <div class="footer__policy__heading">Class reschedule & cancellation policy</div>
      ...
      <div class="footer__policy">
        <div class="footer__policy__heading">30 day money back guarantee</div>
        <div class="footer__policy__subheading">
      ...
      <div class="footer__policy">
        <div class="footer__policy__heading">CodeCombat Holiday Details</div>
        <div class="footer__policy__subheading">
