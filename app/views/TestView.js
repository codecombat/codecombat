...
const paymentGroupsApi = require('core/api/payment-group')
    ...
    static runTests (specFiles, demosOn, view) {
      ...
      return describe('Client', function () {
        beforeEach(function () {
          ...
          spyOn(api.users, 'setCountryGeo').and.returnValue(Promise.resolve())
          spyOn(paymentGroupsApi, 'getPaymentGroupFromProduct').and.returnValue(Promise.resolve([]))
