    ...
    onClickSaveProductInfo(e) {
      ...
      return this.esportsProducts.forEach((product, i) => {
        if (product.productOptions.id === productId) {
          ...
          product.startDate = moment.timezone.tz(productStartDate, this.timeZone).toISOString();
          product.endDate = moment.timezone.tz(productEndDate, this.timeZone).toISOString();
