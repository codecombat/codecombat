...
import loadingScreenTemplate from 'app/templates/core/loading';
import loadingErrorTemplate from 'app/templates/core/loading-error';
import 'app/styles/core/loading-error.sass';
import auth from 'core/auth';
import ViewVisibleTimer from 'core/ViewVisibleTimer';
...
export default CocoView = (function() {
  CocoView = class CocoView extends Backbone.View {
    ...
    onClickContactModal(e) {
      ...
      const openDirectContactModal = () => {
        const DirectContactModal = require('ozaria/site/views/core/DirectContactModal').default;
