...
module.exports = (ChatSearchView = (function() {
  ChatSearchView = class ChatSearchView extends SearchView {
    static initClass() {
      ...
      this.prototype.projection = ['message.startDate', 'message.endDate', 'kind', 'example', 'releasePhase', 'context.levelName', 'message.sender.name', 'message.text'];
      this.prototype.page = 'chat';
      this.prototype.canMakeNew = false;
      this.prototype.limit = 1000;
