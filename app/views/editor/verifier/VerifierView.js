...
module.exports = (VerifierView = (function () {
  VerifierView = class VerifierView extends RootView {
    ...
    onClickGoButton (e) {
      ...
      this.testLanguages = []
      for (const codeLanguage of Array.from(this.codeLanguages)) {
    ...
    rerunFailedTests () {
      ...
      if (!this.tasksToRerun.length || (this.cores === 1)) {
        console.log(((() => {
          const result = []
          for (test of Array.from(this.tests)) {
