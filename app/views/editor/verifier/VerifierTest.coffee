...
module.exports = class VerifierTest extends CocoClass
  constructor: (@levelID, @updateCallback, @supermodel) ->
    super()
  ...
  load: ->
    ...
    @levelLoader = new LevelLoader supermodel: @supermodel, levelID: @levelID, headless: true, fakeSessionConfig: {codeLanguage: 'python', callback: @configureSession}
  ...
  register: ->
    #@listenToOnce @god, 'infinite-loop', @onInfiniteLoop  # TODO: have one of these
