  ...
  ThangsTabView = class ThangsTabView extends CocoView {
    ...
    onSpriteMouseUp(e) {
      ...
      for (var singleSelected of Array.from(selected)) {
        ...
        var path = `${this.pathForThang(thang)}/components/original=${positionComponent.original}`;
    ...
    rotateSelectedThangTo(radians) {
      return (() => {
        ...
        for (var singleSelected of Array.from(this.gameUIState.get('selected'))) {
          ...
          var positionComponent = _.find(this.getThangByID(selectedThang.id).components || [], c => Array.from(LevelComponent.positionIDs).includes(c.original));
          if (!positionComponent) { continue; }
          result.push(this.modifySelectedThangComponentConfig(selectedThang, positionComponent.original, component => {
    ...
    resizeSelectedThangBy(xDir, yDir) {
      return (() => {
        ...
        for (var singleSelected of Array.from(this.gameUIState.get('selected'))) {
          ...
          result.push(this.modifySelectedThangComponentConfig(selectedThang, shapeComponent.original, component => {
    ...
    toggleSelectedThangCollision() {
      return (() => {
        ...
        for (var singleSelected of Array.from(this.gameUIState.get('selected'))) {
          ...
          result.push(this.modifySelectedThangComponentConfig(selectedThang, collisionComponent.original, component => {
