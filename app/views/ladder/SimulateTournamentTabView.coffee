...
module.exports = class SimulateTabView extends CocoView
  ...
  simulateNextGame: ->
    unless @simulator
      @simulator = new Simulator levelID: @options.level.get('slug'), leagueID: @options.leagueID, singleLadder: @options.level.isType('ladder'), levelOriginal: @options.level.get('original'), tournament: true, tournamentID: @options.tournamentID
