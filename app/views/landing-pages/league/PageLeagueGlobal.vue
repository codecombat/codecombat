  ...
  <main id="page-league-global">
    ...
    <div v-if="championshipActive" class="row text-center">
      ...
      <div class="col-lg-6 section-space" style="text-align: left;">
        <div>
          <img class="img-responsive" src="/images/pages/league/farmscape-blitz.png" loading="lazy" style="max-height: 200px; float: right; margin: 0 15px 15px;" alt="" />
          <h1 class="subheader1" style="margin-bottom: 32px;"><span class="esports-green">Season 8 </span><span class="esports-aqua">Final </span><span class="esports-aqua">Arena </span><span class="esports-pink">Now </span><span class="esports-purple">Live!</span></h1>
        </div>
        <p>{{ $t('league.season8_announcement_1') }}</p>
...
style="background-color: #30EFD3;" />{{ $t('league.free_2') }}</li>
          <li>
<span
class="bullet-point"
