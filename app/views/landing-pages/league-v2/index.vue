<template>
  <div id="page-league">
    <div class="container">
      <header-component :show-cubes-image="false" class="container__header">
        <template #header-text>
          <h1 class="text-h1">
            <mixed-color-label :text="$t('league_v2.headline')" />
          </h1>
          <p class="text-24">
            {{ $t('league_v2.subhead') }}
          </p>
        ...
        <template #image>
          <content-box :main-image-bg="false">
            <template #image>
              <video-box
                video-id="d0ea8486d87f3d998564fd48445bc965"
              />
            </template>
          </content-box>
        </template>
...
import StatsComponent from '../../schools/StatsComponent.vue'
import CustomTable from '../../schools/CustomTable.vue'
