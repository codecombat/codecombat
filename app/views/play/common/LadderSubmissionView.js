...
module.exports = (LadderSubmissionView = (function () {
  LadderSubmissionView = class LadderSubmissionView extends CocoView {
    ...
    getRenderData () {
      ...
      const submitDate = this.session != null ? this.session.get('submitDate') : undefined
      if (submitDate) { ctx.lastSubmitted = moment(submitDate).fromNow() }
      return ctx
    }
    ...
    rankSession (e) {
      ...
      const success = () => {
        ...
        if (this.destroyed) {
          this.session = (this.level = (this.mirrorSession = (this.submittingInProgress = undefined)))
        }
      }
        ...
        success: () => {
          ...
          // Also submit the mirrorSession after the main session submits successfully.
            ...
            ajaxOptions.success = () => {
              ...
              return tempMirrorSession.save(patch, {
                patch: true,
                type: 'PUT',
                success () {
