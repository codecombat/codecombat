    ...
    load() {
      ...
      if (this.courseInstanceID) {
        ...
        return fetchAceConfig.then(classroom => {
          ...
          this.classroomAceConfig.blocks = (classroom.aceConfig != null ? classroom.aceConfig.blocks : undefined) != null ? (classroom.aceConfig != null ? classroom.aceConfig.blocks : undefined) : blocksDefault;
          if (this.tome != null) {
