...
module.exports = (ImageGalleryModal = (function() {
  ImageGalleryModal = class ImageGalleryModal extends ModalView {
    static initClass() {
      ...
      this.prototype.template = require('app/templates/play/level/modal/image-gallery-modal');
    ...
    getRenderData() {
      return _.merge(super.getRenderData(...arguments), { utils });
    }

    initialize() {
      this.state = new State();
      return this.listenTo(this.state, 'all', () => {
    ...
    onClickImageListItem(e) {
      const selectedUrl = $(e.currentTarget).data('portrait-url');
      return this.state.set({ selectedUrl });
    }
