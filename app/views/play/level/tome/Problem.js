...
const { translateErrorMessage } = require('lib/aether_utils');
...
module.exports = (Problem = (function() {
  Problem = class Problem {
    ...
    translate(msg, errorCode, i18nParams) {
      ...
      return translateErrorMessage({message: msg, errorCode, i18nParams, spokenLanguage: $.i18n.t('language'), staticTranslations, translateFn});
    }
  };
  Problem.initClass();
  return Problem;
