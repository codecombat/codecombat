...
`
    ...
    updateLines() {
      ...
      if (screenLineCount !== this.lastScreenLineCount) {
        ...
        const minHeight = Math.min(maxHeight, Math.min(gameHeight, Math.max(windowHeight, 600)) - spellPaletteHeight - minHeightOffset);
        ...
        this.ace.setOptions({minLines: lines, maxLines: lines});
    ...
    highlightEntryPoints() {
      ...
      const commentStart = commentStarts[this.spell.language] || '//';
