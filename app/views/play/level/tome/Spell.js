  ...
  Spell = class Spell {
    ...
    constructor(options) {
      ...
      if (this.canRead()) {  // We can avoid creating these views if we'll never use them.
        this.view = new SpellView({spell: this, level: options.level, session: this.session, otherSession: this.otherSession, worker: this.worker, god: options.god, supermodel: this.supermodel, levelID: options.levelID, classroomAceConfig: options.classroomAceConfig, spectateView: this.spectateView, courseID: options.courseID});
