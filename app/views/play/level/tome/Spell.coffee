...
module.exports = class Spell
  ...
  constructor: (options) ->
    ...
    if @canRead()  # We can avoid creating these views if we'll never use them.
      @view = new SpellView {spell: @, level: options.level, session: @session, otherSession: @otherSession, worker: @worker, god: options.god, @supermodel, levelID: options.levelID, classroomACE: options.classroomACE}
