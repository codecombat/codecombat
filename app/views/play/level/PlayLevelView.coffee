...
module.exports = class PlayLevelView extends RootView
  ...
  insertSubviews: ->
    ...
    @insertSubView new ChatView({@levelID, sessionID: @session.id, @session, aceConfig: @classroomAceConfig, aiChatType: @level.get('aiChatType'), aiAssistantSystemPrompt: @level.get('aiAssistantSystemPrompt')})
  ...
  shouldSimulate: ->
    ...
    endSimulateDate = new Date('2025-06-10')
    @simulateAILeagueFinals = currentDate.getTime() < endSimulateDate.getTime()
    @simulateAILeagueLevelOriginalId = '679b1495454eb6d46f27e050' # use any of championship or regular - doesn't matter
