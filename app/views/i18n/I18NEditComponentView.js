...
module.exports = (I18NEditComponentView = (function () {
  I18NEditComponentView = class I18NEditComponentView extends I18NEditModelView {
    ...
    buildTranslationList () {
      ...
      for (let propDocIndex = 0; propDocIndex < propDocs.length; propDocIndex++) {
        ...
        const propDoc = propDocs[propDocIndex]
        ...
        if (i18n = propDoc.returns != null ? propDoc.returns.i18n : undefined) {
          ...
          const d = propDoc.returns.description
          if (_.isObject(d)) {
        ...
        if (propDoc.args) {
          for (let argIndex = 0; argIndex < propDoc.args.length; argIndex++) {
            const argDoc = propDoc.args[argIndex]
            if (i18n = argDoc.i18n) {
