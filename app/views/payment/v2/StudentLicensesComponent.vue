...
export default {
  ...
  async created () {
    ...
    if (features.china || (prepaids && ((prepaids.pending.length + prepaids.empty.length + prepaids.available.length) > 0)) || ['cambodia', 'viet-nam', 'vietnam', 'japan'].includes(me.get('country'))) {
