        ...
        <div class="heading-row">
          ...
          <div class="tecmilenio-info" v-else-if="isTecmilenioPartner">
            <p class="tecmilenio-info-txt">
              Tecmilenio se asoció con CodeCombat para ofrecer educación en codificación programación en Python  basada en juegos por el precio con descuento de $12.52 USD. Todos los estudiantes de Tecmilenio que reciban este enlace deben comprar el software CodeCombat.
            </p>
            <p class="tecmilenio-info-txt">
              En siguiente página, se le pedirá que ingrese el correo del estudiante de Tecmilenio. Ejemplo: al02962166@tecmilenio.mx. Asegúrese de que esta información sea correcta, ya que nos permite saber que ha pagado por su licencia el estudiante.
            </p>
          </div>
