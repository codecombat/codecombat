...
_.extend CourseSchema.properties,
  ...
  cstaStandards: { type: 'object', title: 'CSTA standards', properties: {
    name: { type: 'string', title: 'Name' }
    description: { type: 'string', title: 'Description' }
  }}
  modules: { type: 'object', title: 'Modules', description: 'Relevant for information displayed on curriculum guides in teacher dashboard', properties: {
