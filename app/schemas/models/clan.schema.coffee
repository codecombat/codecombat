...
_.extend ClanSchema.properties,
  ...
  metadata: c.object({
    ...
    districtClanId: c.objectId( title: 'District Clan' )
    schoolId: c.objectId( title: 'School' )
    districtId: c.objectId( title: 'District' )
    cleverSchoolId: c.stringID( title: 'Clever School' )
