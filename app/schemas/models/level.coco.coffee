...
_.extend LevelSchema.properties,
  ...
  difficulty: { type: 'integer', title: 'Difficulty', description: 'Difficulty of this level - normally used to show difficulty in starts from 1 to 5', minimum: 1, maximum: 5 }
