  ...
  ozariaHeroConfig: c.object(
    {
      ...
      avatar: c.object({
        ...
        levelThangTypeId: c.stringID(links: [{rel: 'db', href: '/db/thang.type/{($)}/version'}], title: 'Avatar ThangType', description: 'The in-level avatar thangType original Id', format: 'thang-type'),
