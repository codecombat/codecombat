concepts = [
  ...
  {concept: 'arguments', name: 'Arguments', description: 'Using arguments when calling a function', automatic: true}
  {concept: 'arithmetic', name: 'Arithmetic', description: 'Adding, subtracting, multiplication or dividing.', automatic: true}
  {concept: 'array_2d', name: '2D Array', description: 'Two-dimensional arrays. Arrays containing arrays.', automatic: true}
  {concept: 'array_index', name: 'Array Indexing', description: 'Using indexes to access elements of an array.', automatic: true}
  ...
  {concept: 'array_literals', name: 'Array Literals', description: 'Constructing an array using [] notation.', automatic: true}
  ...
  {concept: 'basic_syntax', name: 'Basic Syntax', description: 'Writing code of any sort.', automatic: true}
  {concept: 'binary', name: 'Binary', description: 'Implementations of binary, (0b001100, toString(2))', automatic: 'Sometimes'}
  {concept: 'boolean_and', name: 'Boolean And', description: 'Using boolean and/&&.', automatic: true}
  {concept: 'boolean_equality', name: 'Boolean Equality', description: 'Using == and !=.', automatic: true}
  {concept: 'boolean_greater_less', name: 'Boolean Greater/Less', description: 'Using >, >=, <, and <=.', automatic: 'Maybe, use in for loops confuses the issue'}
  ...
  {concept: 'boolean_not', name: 'Boolean Not', description: 'Using boolean not/!.', automatic: 'Unsure, depends on if we teach !blah for null checks'}
  ...
  {concept: 'boolean_or', name: 'Boolean Or', description: 'Using boolean or/||.', automatic: true}
  {concept: 'bootstrap', name: 'Bootstrap', description: 'Webpage structure involves Bootstrap in some way.', automatic: true}
  {concept: 'break_statements', name: 'Break Statements', description: 'Using the break statement.', automatic: true}
  {concept: 'classes', name: 'Classes', description: 'Defining a class.', automatic: true}
  {concept: 'continue_statements', name: 'Continue Statements', description: 'Using the continue statement.', automatic: true}
  ...
  {concept: 'for_loops', name: 'For Loops', description: 'Using a for-loop.', automatic: true}
  {concept: 'for_loops_nested', name: 'Nested For Loops', description: 'Using a for-loop inside another for-loop.', automatic: true}
  {concept: 'for_loops_range', name: 'For Loops Range', description: 'If the level focuses on ranges outside of 0 to arr.length.', automatic: 'Yes, but dubious as far JS is concerned'}
  {concept: 'functions', name: 'Functions', description: 'Defining functions.', automatic: true}
  ...
  {concept: 'if_else_statements', name: 'If/Else Statements', description: 'Using elif/else if statements.', automatic: true}
  {concept: 'if_statements', name: 'If Statements', description: 'Using if statements.', automatic: true}
  {concept: 'if_statements_nested', name: 'Nested If Statemnts', description: 'Using if statements inside other if statements.', automatic: true}
  {concept: 'indexing', name: 'Array Indexes', description: 'Accessing specific elements using indexes.', automatic: true}
  ...
  {concept: 'length', name: 'Array Length', description: 'If the length of an array or string is checked.', automatic: true}
  {concept: 'math_geometry', name: 'Geometry', description: 'Finding the perimeter, or area of things.', automatic: false}
  {concept: 'math_operations', name: 'Math Library Operations', description: 'Using Math library operations like Math.sqrt, Math.pow', automatic: true}
  {concept: 'math_trigonometry', name: 'Trigonometry', description: 'Using Math.sin/Math.cos/Math.tan', automatic: true}
  {concept: 'object_literals', name: 'Object Literals', description: 'Creating Object Literals (Python Dictionaries)', automatic: true}
  {concept: 'parameters', name: 'Parameters', description: 'Functions in this level have parameters.', automatic: '??'}
  {concept: 'property_access', name: 'Accessing Properties', description: 'An object\'s properties are accessed (pos, gold)', automatic: true}
  {concept: 'property_assignment', name: 'Assigning Properties', description: 'Assigning to an object\'s properties. (obj.pos.x = 10)', automatic: true}
  ...
  {concept: 'return_statements', name: 'Return Statements', description: 'Using the return statement.', automatic: true}
  {concept: 'stacks', name: 'Data Structures - Stacks', description: 'Implementations of the stack data structure.', automatic: false}
  {concept: 'strings', name: 'Strings', description: 'Using string literals.', automatic: 'Yes, assuming this means string literals.'}
  ...
  {concept: 'strings_substrings', name: 'Substring', description: 'Using substr or substring.', automatic: true}
  {concept: 'trees', name: 'Data Structures - Trees', description: 'Implementations of the tree data structure.', automatic: false}
  {concept: 'variables', name: 'Variables', description: 'Storing data in variables.', automatic: true}
  {concept: 'vectors', name: 'Vectors', description: 'Using Vectors, like new Vector() or common Vector methods like rotate, magnitude, dot, heading, normalize, and limit', automatic: true}
  {concept: 'while_condition_loops', name: 'While Loops with Conditionals', description: 'While loops with a breaking conditional.', automatic: true}
  {concept: 'while_loops_simple', name: 'While Loops', description: 'Simple while-true loops.', automatic: true}
  {concept: 'while_loops_nested', name: 'Nested While Loops', description: 'While loops inside other while loops.', automatic: true}
  {concept: 'xy_coordinates', name: 'Cartesian Coordinates', description: 'This level uses XY coordinates to navigate: any time we use a method .*XY or use variables or properties named x or y', automatic: true}
]
