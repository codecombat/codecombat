...
CodeCombat 是一款使用真实代码和定制化学习曲线的编程学习游戏。它也是无须专业背景的老师开展计算机科学课程的教学工具。
...
可以。学生在登录注册时选择学生的账号类型，然后使用老师发放的“班级码”加入班级就可以了。更多关于如何将学生加入班级请参见[教学指引](/teachers/resources/getting-started)。
...
更多内容，请参见[教师上手指南](/teachers/resources/getting-started)
