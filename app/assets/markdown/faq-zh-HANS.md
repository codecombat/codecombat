...
与CodeCombat相比，奥佳睿具有更强的故事驱动力，因为每个学习者都可以定制他们自己的英雄，并且他们会发现只有掌握了失传的编码魔法，才能从即将来临的黑暗中拯救奥佳睿世界。不断发展的叙事创造了丰富了以学生为中心的学习体验，每位同学在奥佳睿故事中的投入，相当于他们在创造自己的学习路径。
...
以上每个步骤的具体说明，请参阅[教师入门指南](/teachers/resources/getting-started-zh-HANS)。
...
### 概念挑战关卡还会保留吗？
序章（《天山》）将不会出现概念挑战关卡。但是，概念挑战关卡将会出现在付费章节中，第一章《月光舞者》以及后续章节。
...
在概念挑战关卡将有多种解决方案，关卡将从以下两个方面评估：
1. 完成游戏目标
2. 包含必要的游戏结构框架设计

教师通过概念挑战关卡，可以了解学生在指定任务中学生项目设计完成情况，并给予学生关卡设计的反馈意见。例如，如果一个概念挑战评估 IF条件语句，概念挑战关卡将细分成以下三个核心知识点：
1. 用正确的程序句法写出 if/else条件语句
2. 使用准确的条件语句进行测试
3. 实现关卡所有的目标

教师会收到反馈信息，了解学生是否完成所有的目标

### 如何评估我的学生对概念的掌握情况？
概念挑战关卡将出现在第一个付费章节（《月光舞者》）及以后的章节中，序章章节《天山》将不会有概念挑战关卡。我们会通过互动模块的测试题和剧场情景来系统评估学生掌握情况，我们后续将开发教师面板，教师们可以看到学生的评估数据。互动模块会提供很多正式的评估内容，学生在学习编程概念介绍内容后，系统会出现互动模块的弹出窗口，学生必须完成这些互动模块评估才能进入到下一个关卡学习。

同时，我们还将发布每一个章节顶点项目的评估规则介绍。每一个章节的结尾都有顶点项目，顶点项目是对学生在本章节知识掌握的一项综合评估。我们将为教师提供清晰的评估规则，便于教师掌握学生的掌握情况。

### 如果学生已经掌握了一些基础概念，他们那是否可以跳出前面比较容易的关卡？
不能。我们强烈建议那些了解基础概念的学生最好也完成所有的关卡，这对于他们对知识巩固非常有帮助。这些精心设计的关卡采用结构化方式循序渐进地介绍程序核心概念，这对于学生准备高阶阶段更难的算法单元学习非常重要。

培训机构和学校教师可以根据他们的教学目的选择相应的单元/章节，但是我们推荐您的学生按照我们建议的顺序学习掌握这些章节。

### 当学生完成关卡后，他是否可以在新的关卡回顾上一个关卡所学内容？
学生可以在剧院模式和交互测试题中回顾之前学习的概念。剧院模式会帮助学生复习之前他们学习的内容，他们也会在这些关卡中继续学习巩固这些概念。

### 如何查看我的学生在关卡中写的代码？
教师可以通过班级教室的单元进度标签对照学生关卡代码和奥佳睿参考代码，系统会就学生完成情况给予绿色圆圈（关卡完成）或者黄色圆圈（关卡进展中）分别展示。

### 我从哪里可以看到所有关卡的答案？
每一个关卡的参考答案会出现在教师面板的[单元教学指导](/teachers/units)页面 - 教师可以在那里查看参考代码，查看单元所有内容，查看每一个关卡JavaScript或Python的方案指南。

所有老师都可以访问序章章节《天山》。如果教师账号里有付费学生许可，他们可以访问所有的付费章节。

### 如果我要学习所有单元和内容，费用是多少？
我们为编程机构和学校提供定制化解决方案，详细了解您的教学需求、学生规模和整体预算情况。如果您有任何需求，请联系CodeCombat中国团队china@codecombat.com，我们有专业的老师为您答疑解惑。

### 教师如果像学生那样查看关卡内容是否需要购买许可证？
不需要，教师可以访问单元指南页面预览和体验所有的教学关卡，他们只需要通过下拉菜单就可以访问相应的关卡，不需要付费。

### 许可证可以提供哪些内容？
一个许可证可以帮助一位学生访问除了免费序章单元《天山》的所有课程。对于奥佳睿学习者来说，当学生完成序章模块学习以后，许可证可以帮助学生访问余下的所有付费章节，以及CodeCombat所有的付费内容。我们将开发更多的奥佳睿相关内容，奥佳睿平台也会成为教学版的首选平台，学生将从序章《天山》模块开始学起。

### 在编程机构或者学校决定购买之前，我们是否提供免费单元给他们试用？
当然有！序章章节《天山》是免费的，不需要学生许可证即可学习。根据学生的年龄和之前的编程知识水平不同，这个单元可以学习1-2小时。《天山》章节没有学生上限，不论是编程机构还是学校，都欢迎免费使用！

### 如果我只需要开一学期的课程，而不是一整年的话，我如何购买许可证？
标准付费学生许可证的期限是1年，我们可以按照学期或者季度进行调整，如果有任何特殊需求，请联系CodeCombat中国团队china@codecombat，我们有专业的教学顾问为您答疑解惑。
