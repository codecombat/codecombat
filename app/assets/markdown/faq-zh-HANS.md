...
* [AP CSP和扣哒世界又有什么关系呢？](#header-28)
* [怎么通过扣哒世界教授AP计算机科学原理？](#header-29)



### 什么是扣哒世界？

扣哒世界是一款真实代码编程和个性化学习的场景化功能教学产品。它也是无须专业背景的老师开展计算机科学课程的教学工具。

### 扣哒世界适宜的年龄层如何？
扣哒世界适于8岁以上的所有年龄段。

### 扣哒世界适宜的开课年级如何？
我们推荐在三年级及以上的班级教学 扣哒世界。
...
**为何选择JavaScript？**
JavaScript 是网页开发语言，几乎所有的网站都使用到 JavaScript 的相关开发技术。你可以在扣哒世界里的Web网站开发选择学习 JavaScript。同时扣哒世界让您可以在基于 Python 和基于 JavaScript 网页开发的学习间简单高效地转换。

对新手而言，Python 的句法比 JavaScript 的句法更友好，上手更容易。所以，如果你不知从哪个语言开始学习，我们建议你先学Python。

### 扣哒世界可以独立成为课程本身么？
当然！扣哒世界的团队花了大量的时间与计算机教育专家咨询合作，才得出了您现在看到的扣哒世界课程大纲和教学材料。更加人性化的是，这些大纲和教学材料是特别针对先前没有计算机科学专业背景的计算机老师而特别优化设计的。在全球，扣哒世界被大量学校采用作为主要的计算机科学教学教案。
...
[china@扣哒世界.com](mailto:china@扣哒世界.com?subject=) 详细咨询！

### 学生许可证提供哪些内容？
每一个学生许可证可以为一位学生开启打开所有课程内容的权限。没有学生许可证的用户只可以进入试用课程《计算机科学入门》（CS1）。

### 我想先试用在决定是否花钱，扣哒世界有没有给教育工作者提供免费的试用课程呢？
必须的！我们的新产品[奥佳睿](https://aojiarui.com)第一章《天山》的课程不需要任何许可证即可进行，您可以使用扣哒世界的教师账户登录，创建新班级使用。该试用课程内容时长在3-4 小时左右，取决于您的学生的年龄和编程知识方面的背景。

扣哒世界《计算机科学1》CS1开放前6关免费体验试用。可以支持1-2个课时的内容。

欢迎大家踊跃尝试该试用课程，且该课程不限制加入学生的数量。
...
### 班级里学生的计算机科学基础背景参差不齐，扣哒世界如何帮助我解决这一教学难题？
许多老师在班级里都会遇到来自学生的个性化需求，你并不是一个人。扣哒世界通过给学生提供真实的个性化学习体验来解决这个问题。
...
**上手关卡**
当学生对特定的概念不理解时，练习关卡提供更多内容帮助他们练手。扣哒世界会智能地感知到学生是否卡在某一关，扣哒世界会针对这一情况给学生更多针对此技巧的练习机会直到学生获得质的进步。这一功能给每一位学生提供了个性化的学习体验，对于已经理解的概念，学生可以快速通过，而在觉得困难的概念上得到更多锻炼。
...
### 学生可以在 扣哒世界里创造并分享自己的项目么？
扣哒世界中的游戏设计和网站开发课程全都是基于项目的形式。其深得老师和学生的喜爱就是因为他们在项目中能真正地成为“创造者”。在这些课程的最后，学生还能够把这些作品的链接分享到朋友圈等社交媒体上。
...
**游戏设计**
有什么比玩游戏更有趣呢？做一个属于你自己的游戏！在 扣哒世界的游戏设计课程中，学生会学习如何制作一个 扣哒世界酷炫风格的游戏关卡并且把这些关卡分享给他的朋友和家人，让他们用鼠标和键盘来体验学生设计的游戏！随着学习的不断推进，学生们会解锁更多的用来设计更复杂的关卡谜题的工具，通过不断练习，成为明日的游戏设计师。每个课程的终期项目也是可以对外分享出去的。
老师可以在[课程指引](/teachers/courses)页面预览所有网站开发和游戏设计课程的关卡。

### 如果能力允许，学生能否跳过前期的简单基础关卡？
即使学生已经了解了相关概念，我们强烈建议都一关一关来，这样可以帮他们巩固基础。扣哒世界的关卡是旨在逻辑性地辅助学生建立信心并取得进步而精心设计的。循序渐进地进行也有助于学生习惯 扣哒世界的使用体验，和游戏性里的基本逻辑。只有这样，学生才能了解如何解决更复杂的进阶课程。老师可以自由地安排课程进度，但我们建议老师按照我们提供的课程顺序进行教学，以获得最佳教学成果。
...
扣哒世界通过“挑战关卡”的形式来对学生进行阶段性的评价。挑战关卡需要学生在“计算机科学课程”中逐步解锁。教师可以在每个“班级”的“评价”标签里查看学生的评价表现。
...
### 作为教师，我如何查看学生的闯关代码？
教师可以在某个“班级”的“课程进度”标签内点击任何学生的绿色（挑战完成）或黄色（挑战进行中）标点来将学生的关卡代码与 扣哒世界的攻略代码进行比较。
