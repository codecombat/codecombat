...
#modal-base-flat
  #hoc-interstitial-modal.modal-content.style-flat
    .modal-header
      ...
      h4(data-i18n="hoc_interstitial.welcome")
    .modal-body
      .row(v-if="showVideo")
        .hoc-video
      ...
      .row.buttons
        .col-xs-6
          button.btn.btn-lg.btn-navy(v-on:click="clickTeacher" data-i18n="hoc_interstitial.educator")
          p(data-i18n="hoc_interstitial.show_resources")
        .col-xs-6
          button.btn.btn-lg.btn-navy(v-on:click="clickStudent" data-i18n="hoc_interstitial.student")
          p(data-i18n="hoc_interstitial.ready_to_code")
</template>
