...
module.exports = class SpellView extends CocoView
    ...
    @aceSession.addDynamicMarker
      update: (_, markerLayer, session, config) =>
        ...
        for row in [0..@aceSession.getLength()]
          ...
          """
          contentNode = new DOMParser().parseFromString(html, 'text/html')

          indentVisualMarker = contentNode.body.firstChild
          ...
          parentNode.appendChild(indentVisualMarker)
  ...
  guessWhetherFinished: (aether) ->
    ...
    if (endOfLine or beginningOfLine) and not incompleteThis
      @preload()
