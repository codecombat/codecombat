...
export default {
  ...
  computed: {
    ...
    showClassInfo () {
      return this.componentName === COMPONENT_NAMES.MY_CLASSES_SINGLE || this.componentName === COMPONENT_NAMES.STUDENT_PROJECTS || this.componentName === COMPONENT_NAMES.STUDENT_ASSESSMENTS || this.componentName === COMPONENT_NAMES.AI_HACKSTACK_JUNIOR
    },
    allClassrooms () {
