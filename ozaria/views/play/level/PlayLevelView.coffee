...
# subviews
LevelLoadingView = require 'app/views/play/level/LevelLoadingView'
ProblemAlertView = require 'app/views/play/level/tome/ProblemAlertView'
TomeView = require 'app/views/play/level/tome/TomeView'
ChatView = require 'app/views/play/level/LevelChatView' # TODO: Consider removing.
HUDView = require 'app/views/play/level/LevelHUDView'
LevelDialogueView = require 'app/views/play/level/LevelDialogueView'
ControlBarView = require 'app/views/play/level/ControlBarView'
LevelPlaybackView = require 'app/views/play/level/LevelPlaybackView'
GoalsView = require 'app/views/play/level/LevelGoalsView'
LevelFlagsView = require 'app/views/play/level/LevelFlagsView'
GoldView = require 'app/views/play/level/LevelGoldView'
GameDevTrackView = require 'app/views/play/level/GameDevTrackView'
DuelStatsView = require 'app/views/play/level/DuelStatsView'
VictoryModal = require 'app/views/play/level/modal/VictoryModal'
HeroVictoryModal = require 'app/views/play/level/modal/HeroVictoryModal'
CourseVictoryModal = require 'app/views/play/level/modal/CourseVictoryModal'
PicoCTFVictoryModal = require 'app/views/play/level/modal/PicoCTFVictoryModal'
HoC2018VictoryModal = require 'views/special_event/HoC2018VictoryModal'
InfiniteLoopModal = require 'app/views/play/level/modal/InfiniteLoopModal'
LevelSetupManager = require 'lib/LevelSetupManager'
ContactModal = require 'views/core/ContactModal'
HintsView = require 'app/views/play/level/HintsView'
SurfaceContextMenuView = require 'app/views/play/level/SurfaceContextMenuView'
HintsState = require 'app/views/play/level/HintsState'
WebSurfaceView = require 'app/views/play/level/WebSurfaceView'
SpellPaletteView = require 'app/views/play/level/tome/SpellPaletteView'
